...
Data must be synced first with the sync command.`,
  ...
  eia-pp-cli analytics --type messages

  # Group by a field
  eia-pp-cli analytics --type messages --group-by author_id

  # Top 10 most frequent values
  eia-pp-cli analytics --type messages --group-by channel_id --limit 10 --json`,
