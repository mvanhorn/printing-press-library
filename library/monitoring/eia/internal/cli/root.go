...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "eia-pp-cli",
		Short: "Manage eia resources via the eia API",
		Long: `Manage eia resources via the eia API.
...
Run 'eia-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("eia-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'eia-pp-cli profile list')")
	...
	rootCmd.AddCommand(newElectricityCmd(flags))
	rootCmd.AddCommand(newNaturalGasCmd(flags))
	...
	rootCmd.AddCommand(newPetroleumPromotedCmd(flags))
	rootCmd.AddCommand(newSedsPromotedCmd(flags))
	rootCmd.AddCommand(newSteoPromotedCmd(flags))
	rootCmd.AddCommand(newVersionCliCmd())
	// EIA novel commands: top-level series mirror and CO2 group.
	rootCmd.AddCommand(newSeriesCmd(flags))
	rootCmd.AddCommand(newCo2Cmd(flags))
