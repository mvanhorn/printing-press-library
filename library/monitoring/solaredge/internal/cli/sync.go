...
Resource scoping:
  ...
  solaredge-pp-cli sync

  # Sync specific resources only
  solaredge-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  solaredge-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  solaredge-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  solaredge-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  solaredge-pp-cli sync --latest-only`,
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "api-version":
		return db.UpsertApiVersion(data)
	case "equipment":
		return db.UpsertEquipment(data)
	case "site":
...
func responsePathForResource(resource, path string) []string {
	...
	case "accounts\x00/accounts/list":
		return []string{"accounts.list"}
	case "equipment\x00/equipment/{siteId}/{serialNumber}/data":
		return []string{"data"}
	case "equipment\x00/equipment/{siteId}/list":
		return []string{"list"}
	case "equipment\x00/equipment/{siteId}/sensors":
		return []string{"SiteSensors"}
	case "site\x00/site/{siteId}/currentPowerFlow":
		return []string{"siteCurrentPowerFlow"}
	case "site\x00/site/{siteId}/dataPeriod":
		return []string{"dataPeriod"}
	case "site\x00/site/{siteId}/details":
		return []string{"details"}
	case "site\x00/site/{siteId}/energy":
		return []string{"energy"}
	case "site\x00/site/{siteId}/energyDetails":
		return []string{"energyDetails"}
	case "site\x00/site/{siteId}/Inventory":
		return []string{"Inventory"}
	case "site\x00/site/{siteId}/overview":
		return []string{"overview"}
	case "site\x00/site/{siteId}/power":
		return []string{"power"}
	case "site\x00/site/{siteId}/powerDetails":
		return []string{"powerDetails"}
	case "site\x00/site/{siteId}/sensors":
		return []string{"siteSensors"}
	case "site\x00/site/{siteId}/storageData":
		return []string{"storageData"}
	case "site\x00/site/{siteId}/timeFrameEnergy":
		return []string{"timeFrameEnergy"}
	case "sites\x00/sites/{siteIds}/dataPeriod":
		return []string{"dataPeriod.list"}
	case "sites\x00/sites/{siteIds}/energy":
		return []string{"energy.list"}
	case "sites\x00/sites/list":
		return []string{"Sites.list"}
	case "sites\x00/sites/{siteIds}/overview":
		return []string{"overview.list"}
	case "sites\x00/sites/{siteIds}/power":
		return []string{"power.list"}
	case "sites\x00/sites/{siteIds}/timeFrameEnergy":
		return []string{"timeFrameEnergy.list"}
	}
	return nil
}
