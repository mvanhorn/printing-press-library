...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "solaredge-pp-cli",
		Short: `Solaredge CLI — Every SolarEdge Monitoring API endpoint, plus local history that answers questions the API itself can't.`,
		Long: `Solaredge CLI — Every SolarEdge Monitoring API endpoint, plus local history that answers questions the API itself can't.
...
Health check: run 'solaredge-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("solaredge-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'solaredge-pp-cli profile list')")
	...
	rootCmd.AddCommand(newApiVersionCmd(flags))
