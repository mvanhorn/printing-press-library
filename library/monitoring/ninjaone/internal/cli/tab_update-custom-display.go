...
func newTabUpdateCustomDisplayCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "update-custom-display <roleId>",
		Short:       "Using this API it is possible to configure tabs to be hidden for roles and their children",
		Example:     "  ninjaone-pp-cli tab update-custom-display 42",
		Annotations: map[string]string{"pp:endpoint": "tab.update-custom-display", "pp:method": "PATCH", "pp:path": "/v2/tab/role/{roleId}/visibility"},
