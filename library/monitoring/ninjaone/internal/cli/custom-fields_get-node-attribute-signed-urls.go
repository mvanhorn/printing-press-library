...
func newCustomFieldsGetNodeAttributeSignedUrlsCmd(flags *rootFlags) *cobra.Command {
	var flagEntityType string

	cmd := &cobra.Command{
		Use:         "get-node-attribute-signed-urls <entityId>",
		Short:       "Get custom field signed urls",
		Example:     "  ninjaone-pp-cli custom-fields get-node-attribute-signed-urls 42 --entity-type NODE",
