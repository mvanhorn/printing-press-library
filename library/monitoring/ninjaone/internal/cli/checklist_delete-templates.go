...
func newChecklistDeleteTemplatesCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "delete-templates",
		Short:       "Deletes checklist templates by id",
		Example:     "  ninjaone-pp-cli checklist delete-templates",
		Annotations: map[string]string{"pp:endpoint": "checklist.delete-templates", "pp:method": "POST", "pp:path": "/v2/checklist/templates/delete"},
