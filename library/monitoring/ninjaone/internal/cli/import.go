...
but do not stop the import.`,
  ...
  ninjaone-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  ninjaone-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | ninjaone-pp-cli import <resource> --input -`,
