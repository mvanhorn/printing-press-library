...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "ninjaone-pp-cli",
		Short: `Ninjaone CLI — Every NinjaOne endpoint plus fleet-wide cross-org commands the org-scoped console can't give you.`,
		Long: `Ninjaone CLI — Every NinjaOne endpoint plus fleet-wide cross-org commands the org-scoped console can't give you.
...
Health check: run 'ninjaone-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("ninjaone-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'ninjaone-pp-cli profile list')")
	...
	rootCmd.AddCommand(newDeviceCmd(flags))
	...
	rootCmd.AddCommand(newItamCmd(flags))
	rootCmd.AddCommand(newKnowledgebaseCmd(flags))
	rootCmd.AddCommand(newNoderoleCmd(flags))
	...
	rootCmd.AddCommand(newQueriesCmd(flags))
	rootCmd.AddCommand(newRelatedItemsCmd(flags))
	rootCmd.AddCommand(newSoftwareLicenseCmd(flags))
	rootCmd.AddCommand(newTabCmd(flags))
	rootCmd.AddCommand(newTagCmd(flags))
	rootCmd.AddCommand(newTicketingCmd(flags))
	rootCmd.AddCommand(newUserCmd(flags))
	rootCmd.AddCommand(newVulnerabilityCmd(flags))
	...
	rootCmd.AddCommand(newNovelAlertClearCmd(flags))
	rootCmd.AddCommand(newNovelAlertFlappersCmd(flags))
	rootCmd.AddCommand(newNovelAlertStormsCmd(flags))
	rootCmd.AddCommand(newNovelCfHygieneCmd(flags))
	rootCmd.AddCommand(newNovelPatchGapsCmd(flags))
	rootCmd.AddCommand(newNovelPatchStuckCmd(flags))
	rootCmd.AddCommand(newNovelPatchSweepCmd(flags))
	rootCmd.AddCommand(newNovelStaleDevicesCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newActivitiesPromotedCmd(flags))
	rootCmd.AddCommand(newAlertPromotedCmd(flags))
	rootCmd.AddCommand(newAlertsPromotedCmd(flags))
	rootCmd.AddCommand(newAttachmentsPromotedCmd(flags))
	rootCmd.AddCommand(newAutomationPromotedCmd(flags))
	rootCmd.AddCommand(newDeviceCustomFieldsPromotedCmd(flags))
	rootCmd.AddCommand(newDevicesDetailedPromotedCmd(flags))
	rootCmd.AddCommand(newGroupsPromotedCmd(flags))
	rootCmd.AddCommand(newLocationsPromotedCmd(flags))
	rootCmd.AddCommand(newNinjaonePublicJobsPromotedCmd(flags))
	rootCmd.AddCommand(newOrganizationsDetailedPromotedCmd(flags))
	rootCmd.AddCommand(newRolesPromotedCmd(flags))
	rootCmd.AddCommand(newSoftwareProductsPromotedCmd(flags))
	rootCmd.AddCommand(newStagedDevicePromotedCmd(flags))
