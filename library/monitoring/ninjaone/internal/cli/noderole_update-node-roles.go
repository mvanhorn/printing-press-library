...
func newNoderoleUpdateNodeRolesCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "update-node-roles",
		Aliases:     []string{"update"},
		Short:       "Update multiple node roles",
		Example:     "  ninjaone-pp-cli noderole update-node-roles",
		Annotations: map[string]string{"pp:endpoint": "noderole.update-node-roles", "pp:method": "PATCH", "pp:path": "/v2/noderole"},
