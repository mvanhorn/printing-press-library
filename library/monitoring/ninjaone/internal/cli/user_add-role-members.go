...
func newUserAddRoleMembersCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "add-role-members <roleId>",
		Aliases:     []string{"update"},
		Short:       "Add members to user role",
		Example:     "  ninjaone-pp-cli user add-role-members 42",
		Annotations: map[string]string{"pp:endpoint": "user.add-role-members", "pp:method": "PATCH", "pp:path": "/v2/user/role/{roleId}/add-members"},
