...
Resource scoping:
  ...
  ninjaone-pp-cli sync

  # Sync specific resources only
  ninjaone-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  ninjaone-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  ninjaone-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  ninjaone-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  ninjaone-pp-cli sync --latest-only`,
...
func resourceSupportsPagination(resource string) bool {
	...
	case "backup":
		return true
	case "backup-integrity-check-jobs":
		return true
	case "custom-fields":
		return true
	case "devices":
		return true
	case "devices-detailed":
		return true
	case "itam":
		return true
	case "itam-asset-relationship-relations":
		return true
	case "locations":
		return true
	...
	case "organizations":
		return true
	case "organizations-detailed":
		return true
	case "queries":
		return true
	case "queries-antivirus-status":
		return true
	case "queries-antivirus-threats":
		return true
	case "queries-backup-usage":
		return true
	case "queries-computer-systems":
		return true
	case "queries-custom-fields":
		return true
	case "queries-custom-fields-detailed":
		return true
	case "queries-device-health":
		return true
	case "queries-logged-on-users":
		return true
	case "queries-network-interfaces":
		return true
	case "queries-operating-systems":
		return true
	case "queries-os-patch-installs":
		return true
	case "queries-os-patches":
		return true
	case "queries-policy-overrides":
		return true
	case "queries-processors":
		return true
	case "queries-raid-controllers":
		return true
	case "queries-raid-drives":
		return true
	case "queries-scoped-custom-fields":
		return true
	case "queries-scoped-custom-fields-detailed":
		return true
	case "queries-software":
		return true
	case "queries-software-patch-installs":
		return true
	case "queries-software-patches":
		return true
	case "queries-volumes":
		return true
	case "queries-windows-services":
		return true
	case "software-license":
		return true
	case "ticketing-app-user-contact":
		return true
	}
	return false
}
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "backup":
		return db.UpsertBackup(data)
	case "billing":
		return db.UpsertBilling(data)
	case "checklist":
		return db.UpsertChecklist(data)
	case "contact":
		return db.UpsertContact(data)
	case "contacts":
		return db.UpsertContacts(data)
	case "custom-fields":
		return db.UpsertCustomFields(data)
	case "device":
		return db.UpsertDevice(data)
	case "device_activities":
		return db.UpsertDeviceActivities(data)
	case "device_alerts":
		return db.UpsertDeviceAlerts(data)
	case "device_custom_fields":
		return db.UpsertDeviceCustomFields(data)
	case "dashboard_url":
		return db.UpsertDashboardUrl(data)
	case "decommission":
		return db.UpsertDecommission(data)
	case "disks":
		return db.UpsertDisks(data)
	case "jobs":
		return db.UpsertJobs(data)
	case "last_logged_on_user":
		return db.UpsertLastLoggedOnUser(data)
	case "maintenance":
		return db.UpsertMaintenance(data)
	case "network_interfaces":
		return db.UpsertNetworkInterfaces(data)
	case "os_patch_installs":
		return db.UpsertOsPatchInstalls(data)
	case "os_patches":
		return db.UpsertOsPatches(data)
	case "owner":
		return db.UpsertOwner(data)
	case "patch":
		return db.UpsertPatch(data)
	case "policy":
		return db.UpsertPolicy(data)
	case "processors":
		return db.UpsertProcessors(data)
	case "reboot":
		return db.UpsertReboot(data)
	case "script":
		return db.UpsertScript(data)
	case "scripting":
		return db.UpsertScripting(data)
	case "software":
		return db.UpsertSoftware(data)
	case "software_patch_installs":
		return db.UpsertSoftwarePatchInstalls(data)
	case "software_patches":
		return db.UpsertSoftwarePatches(data)
	case "volumes":
		return db.UpsertVolumes(data)
	case "windows_service":
		return db.UpsertWindowsService(data)
	case "windows_services":
		return db.UpsertWindowsServices(data)
	case "document-templates":
		return db.UpsertDocumentTemplates(data)
	case "archive":
		return db.UpsertArchive(data)
	case "restore":
		return db.UpsertRestore(data)
	case "device_ids":
		return db.UpsertDeviceIds(data)
	case "itam":
		return db.UpsertItam(data)
	case "knowledgebase":
		return db.UpsertKnowledgebase(data)
	case "noderole":
		return db.UpsertNoderole(data)
	case "organization":
		return db.UpsertOrganization(data)
	case "checklists_from_templates":
		return db.UpsertChecklistsFromTemplates(data)
	case "organization_custom_fields":
		return db.UpsertOrganizationCustomFields(data)
	case "organization_devices":
		return db.UpsertOrganizationDevices(data)
	case "document":
		return db.UpsertDocument(data)
	case "documents":
		return db.UpsertDocuments(data)
	case "end_users":
		return db.UpsertEndUsers(data)
	case "location":
		return db.UpsertLocation(data)
	case "organization_locations":
		return db.UpsertOrganizationLocations(data)
	case "organization_policies":
		return db.UpsertOrganizationPolicies(data)
	case "template":
		return db.UpsertTemplate(data)
	case "condition":
		return db.UpsertCondition(data)
	case "queries":
	...
	case "software-license":
		return db.UpsertSoftwareLicense(data)
	case "assignments":
		return db.UpsertAssignments(data)
	case "tab":
		return db.UpsertTab(data)
	case "end_user":
		return db.UpsertEndUser(data)
	case "tab_organization":
		return db.UpsertTabOrganization(data)
	case "role":
		return db.UpsertRole(data)
	case "tag":
		return db.UpsertTag(data)
	case "ticketing":
		return db.UpsertTicketing(data)
	case "user":
		return db.UpsertUser(data)
	case "vulnerability":
		return db.UpsertVulnerability(data)
	default:
...
func defaultSyncResources() []string {
	return []string{
		...
		"document-templates",
		"itam",
		"itam-asset-relationship-relations",
		"knowledgebase",
		"knowledgebase-global-articles",
		"knowledgebase-organization-articles",
		"locations",
		"organization",
		...
		"queries-operating-systems",
		"queries-os-patch-installs",
		"queries-os-patches",
		"queries-policy-overrides",
		"queries-processors",
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		...
		"backup":                                "/v2/backup/jobs",
		"backup-integrity-check-jobs":           "/v2/backup/integrity-check-jobs",
		"billing":                               "/v2/billing/accounts",
		"billing-agreements":                    "/v2/billing/agreements",
		"billing-invoices":                      "/v2/billing/invoices",
		"billing-products":                      "/v2/billing/products",
		"checklist":                             "/v2/checklist/templates",
		"contacts":                              "/v2/contacts",
		"custom-fields":                         "/v2/custom-fields",
		"devices":                               "/v2/devices",
		"devices-detailed":                      "/v2/devices-detailed",
		"document-templates":                    "/v2/document-templates",
		"itam":                                  "/v2/itam/asset-relationship/types",
		"itam-asset-relationship-relations":     "/v2/itam/asset-relationship/relations",
		"knowledgebase":                         "/v2/knowledgebase/folder",
		"knowledgebase-global-articles":         "/v2/knowledgebase/global/articles",
		"knowledgebase-organization-articles":   "/v2/knowledgebase/organization/articles",
		"locations":                             "/v2/locations",
		"organization":                          "/v2/organization/documents",
		"organization-checklists":               "/v2/organization/checklists",
		"organizations":                         "/v2/organizations",
		"organizations-detailed":                "/v2/organizations-detailed",
		"queries":                               "/v2/queries/disks",
		"queries-antivirus-status":              "/v2/queries/antivirus-status",
		"queries-antivirus-threats":             "/v2/queries/antivirus-threats",
		"queries-backup-usage":                  "/v2/queries/backup/usage",
		"queries-computer-systems":              "/v2/queries/computer-systems",
		"queries-custom-fields":                 "/v2/queries/custom-fields",
		"queries-custom-fields-detailed":        "/v2/queries/custom-fields-detailed",
		"queries-device-health":                 "/v2/queries/device-health",
		"queries-logged-on-users":               "/v2/queries/logged-on-users",
		"queries-network-interfaces":            "/v2/queries/network-interfaces",
		"queries-operating-systems":             "/v2/queries/operating-systems",
		"queries-os-patch-installs":             "/v2/queries/os-patch-installs",
		"queries-os-patches":                    "/v2/queries/os-patches",
		"queries-policy-overrides":              "/v2/queries/policy-overrides",
		"queries-processors":                    "/v2/queries/processors",
		"queries-raid-controllers":              "/v2/queries/raid-controllers",
		"queries-raid-drives":                   "/v2/queries/raid-drives",
		"queries-scoped-custom-fields":          "/v2/queries/scoped-custom-fields",
		"queries-scoped-custom-fields-detailed": "/v2/queries/scoped-custom-fields-detailed",
		"queries-software":                      "/v2/queries/software",
		"queries-software-patch-installs":       "/v2/queries/software-patch-installs",
		"queries-software-patches":              "/v2/queries/software-patches",
		"queries-volumes":                       "/v2/queries/volumes",
		"queries-windows-services":              "/v2/queries/windows-services",
		"related-items":                         "/v2/related-items",
		"software-license":                      "/v2/software-license/licenses",
		"tag":                                   "/v2/tag",
		"ticketing":                             "/v2/ticketing/statuses",
		"ticketing-app-user-contact":            "/v2/ticketing/app-user-contact",
		"user":                                  "/v2/user/roles",
		"user-end-users":                        "/v2/user/end-users",
		"user-technicians":                      "/v2/user/technicians",
		"vulnerability":                         "/v2/vulnerability/scan-groups",
	}
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "assignments", ParentTable: "software-license", ParentIDParam: "licenseId", PathTemplate: "/v2/software-license/{licenseId}/assignments", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "licenseId", Field: "id"},
		}},
		{Name: "organization_devices", ParentTable: "organization", ParentIDParam: "id", PathTemplate: "/v2/organization/{id}/devices", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
	}
}
