...
func newOrganizationUpdateChecklistsCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "update-checklists",
		Short:       "Updates multiple organization checklists",
		Example:     "  ninjaone-pp-cli organization update-checklists",
		Annotations: map[string]string{"pp:endpoint": "organization.update-checklists", "pp:method": "PUT", "pp:path": "/v2/organization/checklists"},
