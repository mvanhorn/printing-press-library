...
func newChecklistUpdateTemplatesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:       "Updates multiple checklist templates",
		Example:     "  ninjaone-pp-cli checklist update-templates",
		Annotations: map[string]string{"pp:endpoint": "checklist.update-templates", "pp:method": "PUT", "pp:path": "/v2/checklist/templates"},
