...
func newBackupGetIntegrityCheckJobsCmd(flags *rootFlags) *cobra.Command {
	var flagDf string
	var flagDdf string
	var flagSf string
	var flagPtf string
	...
	cmd := &cobra.Command{
		Use:         "get-integrity-check-jobs",
		Aliases:     []string{"list"},
		Short:       "Returns a list of integrity check jobs.",
		Example:     "  ninjaone-pp-cli backup get-integrity-check-jobs",
		Annotations: map[string]string{"pp:endpoint": "backup.get-integrity-check-jobs", "pp:method": "GET", "pp:path": "/v2/backup/integrity-check-jobs", "mcp:read-only": "true"},
