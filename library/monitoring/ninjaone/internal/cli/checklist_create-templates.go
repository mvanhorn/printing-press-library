...
func newChecklistCreateTemplatesCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "create-templates",
		Short:       "Creates multiple checklist templates",
		Example:     "  ninjaone-pp-cli checklist create-templates",
		Annotations: map[string]string{"pp:endpoint": "checklist.create-templates", "pp:method": "POST", "pp:path": "/v2/checklist/templates"},
