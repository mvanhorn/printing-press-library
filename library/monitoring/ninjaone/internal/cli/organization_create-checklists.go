...
func newOrganizationCreateChecklistsCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "create-checklists",
		Short:       "Creates multiple organization checklists",
		Example:     "  ninjaone-pp-cli organization create-checklists",
		Annotations: map[string]string{"pp:endpoint": "organization.create-checklists", "pp:method": "POST", "pp:path": "/v2/organization/checklists"},
