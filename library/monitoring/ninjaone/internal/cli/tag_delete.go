...
func newTagDeleteCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "delete",
		Short:       "Delete Asset Tags having the provided ids",
		Example:     "  ninjaone-pp-cli tag delete",
		Annotations: map[string]string{"pp:endpoint": "tag.delete", "pp:method": "POST", "pp:path": "/v2/tag/delete"},
