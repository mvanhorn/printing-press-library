...
func newItamCreateAssetRelationshipCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "create-asset-relationship",
		Aliases:     []string{"create"},
		Short:       "Creates one or more relationships between assets. Returns both successful creations and any failures.",
		Example:     "  ninjaone-pp-cli itam create-asset-relationship",
		Annotations: map[string]string{"pp:endpoint": "itam.create-asset-relationship", "pp:method": "POST", "pp:path": "/v2/itam/asset-relationship"},
