...
func newRelatedItemsCreateForEntity1Cmd(flags *rootFlags) *cobra.Command {
	var flagEntityType string
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "create-for-entity-1 <entityId>",
		Short:       "Create multiple relations between two entities",
		Example:     "  ninjaone-pp-cli related-items create-for-entity-1 42 --entity-type ORGANIZATION",
		Annotations: map[string]string{"pp:endpoint": "related-items.create-for-entity-1", "pp:method": "POST", "pp:path": "/v2/related-items/entity/{entityType}/{entityId}/relations"},
