...
func newUserRemoveRoleMembersCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "remove-role-members <roleId>",
		Short:       "Remove users from user role",
		Example:     "  ninjaone-pp-cli user remove-role-members 42",
		Annotations: map[string]string{"pp:endpoint": "user.remove-role-members", "pp:method": "PATCH", "pp:path": "/v2/user/role/{roleId}/remove-members"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !flags.dryRun && statusCode >= 200 && statusCode < 300 && (partialFailure == nil || flags.allowPartialFailure) {
				writeMutationResponseToStore(cmd.Context(), "user", data, "members")
			}
