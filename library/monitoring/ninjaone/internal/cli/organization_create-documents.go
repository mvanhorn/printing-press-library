...
func newOrganizationCreateDocumentsCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "create-documents",
		Short:       "Creates organization documents and returns the documents created",
		Example:     "  ninjaone-pp-cli organization create-documents",
		Annotations: map[string]string{"pp:endpoint": "organization.create-documents", "pp:method": "POST", "pp:path": "/v2/organization/documents"},
