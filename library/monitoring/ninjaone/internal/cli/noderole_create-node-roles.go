...
func newNoderoleCreateNodeRolesCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "create-node-roles",
		Aliases:     []string{"create"},
		Short:       "Create multiple node roles",
		Example:     "  ninjaone-pp-cli noderole create-node-roles",
		Annotations: map[string]string{"pp:endpoint": "noderole.create-node-roles", "pp:method": "POST", "pp:path": "/v2/noderole"},
