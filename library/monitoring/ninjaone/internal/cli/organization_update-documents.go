...
func newOrganizationUpdateDocumentsCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "update-documents",
		Short:       "Updates organization documents and returns the documents updated",
		Example:     "  ninjaone-pp-cli organization update-documents",
		Annotations: map[string]string{"pp:endpoint": "organization.update-documents", "pp:method": "PATCH", "pp:path": "/v2/organization/documents"},
