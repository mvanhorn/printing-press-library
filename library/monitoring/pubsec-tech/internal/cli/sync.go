...
Exit codes & warnings:
  ...
  pubsec-tech-pp-cli sync

  # Sync specific resources only
  pubsec-tech-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  pubsec-tech-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  pubsec-tech-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  pubsec-tech-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  pubsec-tech-pp-cli sync --latest-only`,
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/pubsec-tech-pp-cli/data.db)")
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"agencies":            "/api/v2/references/toptier_agencies/",
		"awards":              "/api/v2/subawards/",
		"entities":            "/entity-information/v3/entities",
		"recipients":          "/api/v2/recipient/duns/",
		"references":          "/api/v2/references/naics/",
		"references-glossary": "/api/v2/references/glossary/",
	}
