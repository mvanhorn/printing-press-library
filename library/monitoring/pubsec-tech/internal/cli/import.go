...
but do not stop the import.`,
  ...
  pubsec-tech-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  pubsec-tech-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | pubsec-tech-pp-cli import <resource> --input -`,
