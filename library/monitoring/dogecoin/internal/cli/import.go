...
but do not stop the import.`,
  ...
  dogecoin-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  dogecoin-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | dogecoin-pp-cli import <resource> --input -`,
