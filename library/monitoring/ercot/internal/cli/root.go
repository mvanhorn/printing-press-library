...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "ercot-pp-cli",
		Short: "Manage ercot resources via the ercot API",
		Long: `Manage ercot resources via the ercot API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'ercot-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("ercot-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'ercot-pp-cli profile list')")
	...
	rootCmd.AddCommand(newNp3910ErCmd(flags))
	rootCmd.AddCommand(newNp3911ErCmd(flags))
	rootCmd.AddCommand(newNp3965ErCmd(flags))
	rootCmd.AddCommand(newNp3966ErCmd(flags))
	rootCmd.AddCommand(newNp3990ExCmd(flags))
	rootCmd.AddCommand(newNp4196MCmd(flags))
	rootCmd.AddCommand(newNp4197MCmd(flags))
	...
	rootCmd.AddCommand(newErcotPublicClientVersionPromotedCmd(flags))
	rootCmd.AddCommand(newNp3233CdPromotedCmd(flags))
	rootCmd.AddCommand(newNp3565CdPromotedCmd(flags))
	rootCmd.AddCommand(newNp3566CdPromotedCmd(flags))
	rootCmd.AddCommand(newNp3991ExPromotedCmd(flags))
	rootCmd.AddCommand(newNp4159CdPromotedCmd(flags))
	rootCmd.AddCommand(newNp4179CdPromotedCmd(flags))
	rootCmd.AddCommand(newNp4183CdPromotedCmd(flags))
	rootCmd.AddCommand(newNp4188CdPromotedCmd(flags))
	rootCmd.AddCommand(newNp4190CdPromotedCmd(flags))
	rootCmd.AddCommand(newNp4191CdPromotedCmd(flags))
	rootCmd.AddCommand(newNp433CdPromotedCmd(flags))
	rootCmd.AddCommand(newNp4523CdPromotedCmd(flags))
	rootCmd.AddCommand(newNp4732CdPromotedCmd(flags))
	rootCmd.AddCommand(newNp4733CdPromotedCmd(flags))
	rootCmd.AddCommand(newNp4737CdPromotedCmd(flags))
	rootCmd.AddCommand(newNp4738CdPromotedCmd(flags))
	rootCmd.AddCommand(newNp4742CdPromotedCmd(flags))
	rootCmd.AddCommand(newNp4743CdPromotedCmd(flags))
	rootCmd.AddCommand(newNp4745CdPromotedCmd(flags))
	rootCmd.AddCommand(newNp4746CdPromotedCmd(flags))
	rootCmd.AddCommand(newNp6322CdPromotedCmd(flags))
	rootCmd.AddCommand(newNp6345CdPromotedCmd(flags))
	rootCmd.AddCommand(newNp6346CdPromotedCmd(flags))
	rootCmd.AddCommand(newNp6787CdPromotedCmd(flags))
	rootCmd.AddCommand(newNp6788CdPromotedCmd(flags))
	rootCmd.AddCommand(newNp686CdPromotedCmd(flags))
	rootCmd.AddCommand(newNp6905CdPromotedCmd(flags))
	rootCmd.AddCommand(newNp6970CdPromotedCmd(flags))
