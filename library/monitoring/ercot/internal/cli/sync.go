...
Resource scoping:
  ...
  ercot-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  ercot-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  ercot-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  ercot-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  ercot-pp-cli sync --latest-only`,
...
func defaultSyncResources() []string {
	return []string{
		...
		"np3-566-cd",
		"np3-910-er",
		"np3-910-er-2d-agg-gen-summary",
		"np3-910-er-2d-agg-gen-summary-houston",
		"np3-910-er-2d-agg-gen-summary-north",
		"np3-910-er-2d-agg-gen-summary-south",
		"np3-910-er-2d-agg-gen-summary-west",
		"np3-910-er-2d-agg-load-summary",
		"np3-910-er-2d-agg-load-summary-houston",
		"np3-910-er-2d-agg-load-summary-north",
		"np3-910-er-2d-agg-load-summary-south",
		"np3-910-er-2d-agg-load-summary-west",
		"np3-910-er-2d-agg-out-sched",
		"np3-910-er-2d-agg-out-sched-houston",
		"np3-910-er-2d-agg-out-sched-north",
		"np3-910-er-2d-agg-out-sched-south",
		"np3-910-er-2d-agg-out-sched-west",
		"np3-911-er",
		"np3-911-er-2d-agg-as-offers-ecrsm",
		"np3-911-er-2d-agg-as-offers-ecrss",
		"np3-911-er-2d-agg-as-offers-offns",
		"np3-911-er-2d-agg-as-offers-regdn",
		"np3-911-er-2d-agg-as-offers-regup",
		"np3-911-er-2d-agg-as-offers-rrsffr",
		"np3-911-er-2d-agg-as-offers-rrspfr",
		"np3-911-er-2d-agg-as-offers-rrsufr",
		"np3-911-er-2d-cleared-dam-as-ecrsm",
		"np3-911-er-2d-cleared-dam-as-ecrss",
		"np3-911-er-2d-cleared-dam-as-nspin",
		"np3-911-er-2d-cleared-dam-as-regdn",
		"np3-911-er-2d-cleared-dam-as-regup",
		"np3-911-er-2d-cleared-dam-as-rrsffr",
		"np3-911-er-2d-cleared-dam-as-rrspfr",
		"np3-911-er-2d-cleared-dam-as-rrsufr",
		"np3-911-er-2d-self-arranged-as-ecrsm",
		"np3-911-er-2d-self-arranged-as-ecrss",
		"np3-911-er-2d-self-arranged-as-nspin",
		"np3-911-er-2d-self-arranged-as-nspnm",
		"np3-911-er-2d-self-arranged-as-regdn",
		"np3-911-er-2d-self-arranged-as-regup",
		"np3-911-er-2d-self-arranged-as-rrsffr",
		"np3-911-er-2d-self-arranged-as-rrspfr",
		"np3-911-er-2d-self-arranged-as-rrsufr",
		"np3-965-er",
		"np3-965-er-60-hdl-ldl-man-override",
		"np3-965-er-60-load-res-data-in-sced",
		"np3-965-er-60-sced-dsr-load-data",
		"np3-965-er-60-sced-qse-self-arranged-as",
		"np3-965-er-60-sced-smne-gen-res",
		"np3-966-er",
		"np3-966-er-60-dam-energy-bid-awards",
		"np3-966-er-60-dam-energy-only-offer-awards",
		"np3-966-er-60-dam-energy-only-offers",
		"np3-966-er-60-dam-gen-res-as-offers",
		"np3-966-er-60-dam-gen-res-data",
		"np3-966-er-60-dam-load-res-as-offers",
		"np3-966-er-60-dam-load-res-data",
		"np3-966-er-60-dam-ptp-obl-bid-awards",
		"np3-966-er-60-dam-ptp-obl-bids",
		"np3-966-er-60-dam-ptp-obl-opt",
		"np3-966-er-60-dam-ptp-obl-opt-awards",
		"np3-966-er-60-dam-qse-self-as",
		"np3-990-ex",
		"np3-990-ex-60-sasm-gen-res-as-offer-awards",
		"np3-990-ex-60-sasm-load-res-as-offer-awards",
		"np3-990-ex-60-sasm-load-res-as-offers",
		"np3-991-ex",
		"np4-159-cd",
		"np4-179-cd",
		"np4-183-cd",
		...
		"np4-191-cd",
		"np4-196-m",
		"np4-196-m-dam-price-corrections-eblmp",
		"np4-196-m-dam-price-corrections-mcpc",
		"np4-197-m",
		"np4-197-m-rtm-price-corrections-eblmp",
		"np4-197-m-rtm-price-corrections-shadow",
		"np4-197-m-rtm-price-corrections-soglmp",
		"np4-197-m-rtm-price-corrections-sogprice",
		"np4-197-m-rtm-price-corrections-splmp",
		"np4-33-cd",
		"np4-523-cd",
		"np4-732-cd",
		"np4-733-cd",
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		...
		"np3-565-cd":                                  "/np3-565-cd/lf_by_model_weather_zone",
		"np3-566-cd":                                  "/np3-566-cd/lf_by_model_study_area",
		"np3-910-er":                                  "/np3-910-er/2d_agg_dsr_loads",
		"np3-910-er-2d-agg-gen-summary":               "/np3-910-er/2d_agg_gen_summary",
		"np3-910-er-2d-agg-gen-summary-houston":       "/np3-910-er/2d_agg_gen_summary_houston",
		"np3-910-er-2d-agg-gen-summary-north":         "/np3-910-er/2d_agg_gen_summary_north",
		"np3-910-er-2d-agg-gen-summary-south":         "/np3-910-er/2d_agg_gen_summary_south",
		"np3-910-er-2d-agg-gen-summary-west":          "/np3-910-er/2d_agg_gen_summary_west",
		"np3-910-er-2d-agg-load-summary":              "/np3-910-er/2d_agg_load_summary",
		"np3-910-er-2d-agg-load-summary-houston":      "/np3-910-er/2d_agg_load_summary_houston",
		"np3-910-er-2d-agg-load-summary-north":        "/np3-910-er/2d_agg_load_summary_north",
		"np3-910-er-2d-agg-load-summary-south":        "/np3-910-er/2d_agg_load_summary_south",
		"np3-910-er-2d-agg-load-summary-west":         "/np3-910-er/2d_agg_load_summary_west",
		"np3-910-er-2d-agg-out-sched":                 "/np3-910-er/2d_agg_out_sched",
		"np3-910-er-2d-agg-out-sched-houston":         "/np3-910-er/2d_agg_out_sched_houston",
		"np3-910-er-2d-agg-out-sched-north":           "/np3-910-er/2d_agg_out_sched_north",
		"np3-910-er-2d-agg-out-sched-south":           "/np3-910-er/2d_agg_out_sched_south",
		"np3-910-er-2d-agg-out-sched-west":            "/np3-910-er/2d_agg_out_sched_west",
		"np3-911-er":                                  "/np3-911-er/2d_agg_as_offers_onns",
		"np3-911-er-2d-agg-as-offers-ecrsm":           "/np3-911-er/2d_agg_as_offers_ecrsm",
		"np3-911-er-2d-agg-as-offers-ecrss":           "/np3-911-er/2d_agg_as_offers_ecrss",
		"np3-911-er-2d-agg-as-offers-offns":           "/np3-911-er/2d_agg_as_offers_offns",
		"np3-911-er-2d-agg-as-offers-regdn":           "/np3-911-er/2d_agg_as_offers_regdn",
		"np3-911-er-2d-agg-as-offers-regup":           "/np3-911-er/2d_agg_as_offers_regup",
		"np3-911-er-2d-agg-as-offers-rrsffr":          "/np3-911-er/2d_agg_as_offers_rrsffr",
		"np3-911-er-2d-agg-as-offers-rrspfr":          "/np3-911-er/2d_agg_as_offers_rrspfr",
		"np3-911-er-2d-agg-as-offers-rrsufr":          "/np3-911-er/2d_agg_as_offers_rrsufr",
		"np3-911-er-2d-cleared-dam-as-ecrsm":          "/np3-911-er/2d_cleared_dam_as_ecrsm",
		"np3-911-er-2d-cleared-dam-as-ecrss":          "/np3-911-er/2d_cleared_dam_as_ecrss",
		"np3-911-er-2d-cleared-dam-as-nspin":          "/np3-911-er/2d_cleared_dam_as_nspin",
		"np3-911-er-2d-cleared-dam-as-regdn":          "/np3-911-er/2d_cleared_dam_as_regdn",
		"np3-911-er-2d-cleared-dam-as-regup":          "/np3-911-er/2d_cleared_dam_as_regup",
		"np3-911-er-2d-cleared-dam-as-rrsffr":         "/np3-911-er/2d_cleared_dam_as_rrsffr",
		"np3-911-er-2d-cleared-dam-as-rrspfr":         "/np3-911-er/2d_cleared_dam_as_rrspfr",
		"np3-911-er-2d-cleared-dam-as-rrsufr":         "/np3-911-er/2d_cleared_dam_as_rrsufr",
		"np3-911-er-2d-self-arranged-as-ecrsm":        "/np3-911-er/2d_self_arranged_as_ecrsm",
		"np3-911-er-2d-self-arranged-as-ecrss":        "/np3-911-er/2d_self_arranged_as_ecrss",
		"np3-911-er-2d-self-arranged-as-nspin":        "/np3-911-er/2d_self_arranged_as_nspin",
		"np3-911-er-2d-self-arranged-as-nspnm":        "/np3-911-er/2d_self_arranged_as_nspnm",
		"np3-911-er-2d-self-arranged-as-regdn":        "/np3-911-er/2d_self_arranged_as_regdn",
		"np3-911-er-2d-self-arranged-as-regup":        "/np3-911-er/2d_self_arranged_as_regup",
		"np3-911-er-2d-self-arranged-as-rrsffr":       "/np3-911-er/2d_self_arranged_as_rrsffr",
		"np3-911-er-2d-self-arranged-as-rrspfr":       "/np3-911-er/2d_self_arranged_as_rrspfr",
		"np3-911-er-2d-self-arranged-as-rrsufr":       "/np3-911-er/2d_self_arranged_as_rrsufr",
		"np3-965-er":                                  "/np3-965-er/60_sced_gen_res_data",
		"np3-965-er-60-hdl-ldl-man-override":          "/np3-965-er/60_hdl_ldl_man_override",
		"np3-965-er-60-load-res-data-in-sced":         "/np3-965-er/60_load_res_data_in_sced",
		"np3-965-er-60-sced-dsr-load-data":            "/np3-965-er/60_sced_dsr_load_data",
		"np3-965-er-60-sced-qse-self-arranged-as":     "/np3-965-er/60_sced_qse_self_arranged_as",
		"np3-965-er-60-sced-smne-gen-res":             "/np3-965-er/60_sced_smne_gen_res",
		"np3-966-er":                                  "/np3-966-er/60_dam_energy_bids",
		"np3-966-er-60-dam-energy-bid-awards":         "/np3-966-er/60_dam_energy_bid_awards",
		"np3-966-er-60-dam-energy-only-offer-awards":  "/np3-966-er/60_dam_energy_only_offer_awards",
		"np3-966-er-60-dam-energy-only-offers":        "/np3-966-er/60_dam_energy_only_offers",
		"np3-966-er-60-dam-gen-res-as-offers":         "/np3-966-er/60_dam_gen_res_as_offers",
		"np3-966-er-60-dam-gen-res-data":              "/np3-966-er/60_dam_gen_res_data",
		"np3-966-er-60-dam-load-res-as-offers":        "/np3-966-er/60_dam_load_res_as_offers",
		"np3-966-er-60-dam-load-res-data":             "/np3-966-er/60_dam_load_res_data",
		"np3-966-er-60-dam-ptp-obl-bid-awards":        "/np3-966-er/60_dam_ptp_obl_bid_awards",
		"np3-966-er-60-dam-ptp-obl-bids":              "/np3-966-er/60_dam_ptp_obl_bids",
		"np3-966-er-60-dam-ptp-obl-opt":               "/np3-966-er/60_dam_ptp_obl_opt",
		"np3-966-er-60-dam-ptp-obl-opt-awards":        "/np3-966-er/60_dam_ptp_obl_opt_awards",
		"np3-966-er-60-dam-qse-self-as":               "/np3-966-er/60_dam_qse_self_as",
		"np3-990-ex":                                  "/np3-990-ex/60_sasm_gen_res_as_offers",
		"np3-990-ex-60-sasm-gen-res-as-offer-awards":  "/np3-990-ex/60_sasm_gen_res_as_offer_awards",
		"np3-990-ex-60-sasm-load-res-as-offer-awards": "/np3-990-ex/60_sasm_load_res_as_offer_awards",
		"np3-990-ex-60-sasm-load-res-as-offers":       "/np3-990-ex/60_sasm_load_res_as_offers",
		"np3-991-ex":                                  "/np3-991-ex/60_cop_all_updates",
		"np4-159-cd":                                  "/np4-159-cd/load_distribution_factors",
		"np4-179-cd":                                  "/np4-179-cd/total_as_service_offers",
		"np4-183-cd":                                  "/np4-183-cd/dam_hourly_lmp",
		"np4-188-cd":                                  "/np4-188-cd/dam_clear_price_for_cap",
		"np4-190-cd":                                  "/np4-190-cd/dam_stlmnt_pnt_prices",
		"np4-191-cd":                                  "/np4-191-cd/dam_shadow_prices",
		"np4-196-m":                                   "/np4-196-m/dam_price_corrections_spp",
		"np4-196-m-dam-price-corrections-eblmp":       "/np4-196-m/dam_price_corrections_eblmp",
		"np4-196-m-dam-price-corrections-mcpc":        "/np4-196-m/dam_price_corrections_mcpc",
		"np4-197-m":                                   "/np4-197-m/rtm_price_corrections_spp",
		"np4-197-m-rtm-price-corrections-eblmp":       "/np4-197-m/rtm_price_corrections_eblmp",
		"np4-197-m-rtm-price-corrections-shadow":      "/np4-197-m/rtm_price_corrections_shadow",
		"np4-197-m-rtm-price-corrections-soglmp":      "/np4-197-m/rtm_price_corrections_soglmp",
		"np4-197-m-rtm-price-corrections-sogprice":    "/np4-197-m/rtm_price_corrections_sogprice",
		"np4-197-m-rtm-price-corrections-splmp":       "/np4-197-m/rtm_price_corrections_splmp",
		"np4-33-cd":                                   "/np4-33-cd/dam_as_plan",
		"np4-523-cd":                                  "/np4-523-cd/dam_system_lambda",
		...
		"np4-742-cd":                                  "/np4-742-cd/wpp_hrly_actual_fcast_geo",
		"np4-743-cd":                                  "/np4-743-cd/wpp_actual_5min_avg_values_geo",
		"np4-745-cd":                                  "/np4-745-cd/spp_hrly_actual_fcast_geo",
		"np4-746-cd":                                  "/np4-746-cd/spp_actual_5min_avg_values_geo",
		"np6-322-cd":                                  "/np6-322-cd/sced_system_lambda",
		"np6-345-cd":                                  "/np6-345-cd/act_sys_load_by_wzn",
		"np6-346-cd":                                  "/np6-346-cd/act_sys_load_by_fzn",
		"np6-787-cd":                                  "/np6-787-cd/lmp_electrical_bus",
		"np6-788-cd":                                  "/np6-788-cd/lmp_node_zone_hub",
		"np6-86-cd":                                   "/np6-86-cd/shdw_prices_bnd_trns_const",
		"np6-905-cd":                                  "/np6-905-cd/spp_node_zone_hub",
		"np6-970-cd":                                  "/np6-970-cd/rtd_lmp_node_zone_hub",
	}
