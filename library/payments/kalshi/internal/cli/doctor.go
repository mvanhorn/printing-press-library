		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if cfg != nil {
				...
				if header == "" {
					...
					report["auth_hint"] = "export KALSHI_TRADE_MANUAL_KALSHI_ACCESS_KEY=<your-key>"
				} else {
			...
			authEnvSet := 0
			authEnvChecked++
			if os.Getenv("KALSHI_TRADE_MANUAL_KALSHI_ACCESS_KEY") != "" {
				authEnvSet++
			}
			if authEnvSet == 0 {
			...
			if cfg != nil && cfg.BaseURL != "" {
				...
				if clientErr != nil {
					...
					if authHeader == "" {
						...
						authHeaders["KALSHI-ACCESS-KEY"] = authHeader
						authHeaders["User-Agent"] = "kalshi-pp-cli"
