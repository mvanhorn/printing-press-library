...
Exit codes & warnings:
  ...
  partitaiva24-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  partitaiva24-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  partitaiva24-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  partitaiva24-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  partitaiva24-pp-cli sync --latest-only`,
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "fiscal_year":
		return db.UpsertFiscalYear(data)
	case "income":
		return db.UpsertIncome(data)
	case "invoices":
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		...
		"corrispettivi":           "/user/corrispettivi",
		"customers":               "/user/customers",
		"docs":                    "/user/docs",
		"esterometro":             "/user/foreign-mgmt",
		"events":                  "/user/events",
		"f24":                     "/user/f24",
		"income":                  "/user/income-invoices",
		"invoices":                "/user/invoices",
		"notifications":           "/user/notifications",
		"notifications-broadcast": "/user/notifications/broadcast",
		"settings":                "/user/settings",
		"subscriptions":           "/user/subscriptions",
		"subscriptions-gateways":  "/user/subscription/gateways",
		"tickets":                 "/user/tickets",
		"tickets-categories":      "/user/tickets/categories",
	}
