...
func newCustomersListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  partitaiva24-pp-cli customers list",
		Annotations: map[string]string{"pp:endpoint": "customers.list", "pp:method": "GET", "pp:path": "/user/customers", "mcp:read-only": "true"},
