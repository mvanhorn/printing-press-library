...
but do not stop the import.`,
  ...
  partitaiva24-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  partitaiva24-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | partitaiva24-pp-cli import <resource> --input -`,
