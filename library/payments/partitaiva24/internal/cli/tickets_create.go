...
func newTicketsCreateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  partitaiva24-pp-cli tickets create --category example-value",
		Annotations: map[string]string{"pp:endpoint": "tickets.create", "pp:method": "POST", "pp:path": "/user/ticket"},
	...
	cmd.Flags().StringVar(&bodyBody, "body", "", "")
