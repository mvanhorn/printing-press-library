# Partitaiva24 Printed CLI Agent Guide

This directory is a generated `partitaiva24-pp-cli` printed CLI. It was produced by [CLI Printing Press](https://github.com/mvanhorn/cli-printing-press), so treat systemic fixes as upstream Printing Press fixes first. Keep local edits narrow and document why a generated-tree patch belongs here.
...
```bash
partitaiva24-pp-cli doctor --json
partitaiva24-pp-cli agent-context --pretty
```

Use runtime discovery instead of relying on a copied command list:

```bash
partitaiva24-pp-cli which "<capability>" --json
partitaiva24-pp-cli <command> --help
```
...
```bash
partitaiva24-pp-cli <command> --agent
```
...
```bash
partitaiva24-pp-cli <command> --help
partitaiva24-pp-cli <command> --dry-run --agent
```
