...
large datasets as it has no memory pressure.`,
  ...
  simplefin-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  simplefin-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  simplefin-pp-cli export <resource> --format jsonl | jq '.id'`,
