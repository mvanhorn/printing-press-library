...
const (
	journalSessionEnvVar   = "ROBINHOOD_AGENTIC_LEARN_SESSION"
	journalNoLearnEnvVar   = "ROBINHOOD_AGENTIC_NO_LEARN"
	journalNoCaptureEnvVar = "ROBINHOOD_AGENTIC_LEARN_NO_CAPTURE"
)
