...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("ROBINHOOD_AGENTIC_STATE_DIR", "")
	t.Setenv("ROBINHOOD_AGENTIC_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		...
		"robinhood-agentic-pp-cli help items",
		"robinhood-agentic-pp-cli sync",
		"robinhood-agentic-pp-cli profile list",
		"robinhood-agentic-pp-cli feedback list",
		"robinhood-agentic-pp-cli which",
		"robinhood-agentic-pp-cli agent-context",
		"robinhood-agentic-pp-cli completion bash",
		"robinhood-agentic-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"robinhood-agentic-pp-cli recall",
		"robinhood-agentic-pp-cli learnings",
		"robinhood-agentic-pp-cli teach-pattern",
		"robinhood-agentic-pp-cli teach-lookup",
		"robinhood-agentic-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("robinhood-agentic-pp-cli")); err == nil {
