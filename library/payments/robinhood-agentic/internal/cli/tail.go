...
native streaming instead of polling.`,
  ...
  robinhood-agentic-pp-cli tail --interval 10s

  # Tail a specific resource
  robinhood-agentic-pp-cli tail messages --interval 5s

  # Pipe to jq for filtering
  robinhood-agentic-pp-cli tail events --interval 30s | jq 'select(.type == "error")'`,
