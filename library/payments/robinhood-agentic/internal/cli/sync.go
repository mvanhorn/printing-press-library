...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/payments/robinhood-agentic/internal/learn/lookups"
...
Resource scoping:
  ...
  robinhood-agentic-pp-cli sync

  # Sync specific resources only
  robinhood-agentic-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  robinhood-agentic-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  robinhood-agentic-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  robinhood-agentic-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  robinhood-agentic-pp-cli sync --latest-only`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if dbPath == "" {
				dbPath = defaultDBPath("robinhood-agentic-pp-cli")
			}
...
func syncResourceSinceParam(resource string) string {
	switch resource {
	case "market-get-earnings-calendar":
		return "start_date"
	case "market-get-equity-historicals":
		return "start_time"
	case "market-get-equity-technical-indicators":
		return "start_time"
	}
	return ""
}
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "scans":
		return db.UpsertScans(data)
	case "watchlists":
		return db.UpsertWatchlists(data)
	default:
...
func defaultSyncResources() []string {
	return []string{
		"market",
		"options",
		"options-get-option-instruments",
		"options-get-option-watchlist",
		"scans",
		"watchlists",
		"watchlists-get-popular-watchlists",
	}
}
...
func knownSyncResourceNames() []string {
	names := []string{
		"accounts",
		"equities",
		"equities-get-equity-positions",
		"equities-get-equity-tax-lots",
		"market",
		"market-get-earnings-calendar",
		"market-get-earnings-results",
		"market-get-equity-fundamentals",
		"market-get-equity-historicals",
		"market-get-equity-quotes",
		"market-get-equity-technical-indicators",
		"market-get-equity-tradability",
		"market-get-financials",
		"market-get-index-quotes",
		"options",
		"options-get-option-instruments",
		"options-get-option-orders",
		"options-get-option-positions",
		"options-get-option-quotes",
		"options-get-option-watchlist",
		"portfolio",
		"scans",
		"watchlists",
		"watchlists-get-popular-watchlists",
		"watchlists-get-watchlist-items",
	}
	return names
}
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{ // #nosec G101 -- endpoint paths, not credentials.
		...
		"equities":                               "/tools/get_equity_orders",
		"equities-get-equity-positions":          "/tools/get_equity_positions",
		"equities-get-equity-tax-lots":           "/tools/get_equity_tax_lots",
		"market":                                 "/tools/get_indexes",
		"market-get-earnings-calendar":           "/tools/get_earnings_calendar",
		"market-get-earnings-results":            "/tools/get_earnings_results",
		"market-get-equity-fundamentals":         "/tools/get_equity_fundamentals",
		"market-get-equity-historicals":          "/tools/get_equity_historicals",
		"market-get-equity-quotes":               "/tools/get_equity_quotes",
		"market-get-equity-technical-indicators": "/tools/get_equity_technical_indicators",
		"market-get-equity-tradability":          "/tools/get_equity_tradability",
		"market-get-financials":                  "/tools/get_financials",
		"market-get-index-quotes":                "/tools/get_index_quotes",
		"options":                                "/tools/get_option_chains",
		"options-get-option-instruments":         "/tools/get_option_instruments",
		"options-get-option-orders":              "/tools/get_option_orders",
		"options-get-option-positions":           "/tools/get_option_positions",
		"options-get-option-quotes":              "/tools/get_option_quotes",
		"options-get-option-watchlist":           "/tools/get_option_watchlist",
		"portfolio":                              "/tools/get_pnl_trade_history",
		"scans":                                  "/tools/get_scans",
		"watchlists":                             "/tools/get_watchlists",
		"watchlists-get-popular-watchlists":      "/tools/get_popular_watchlists",
		"watchlists-get-watchlist-items":         "/tools/get_watchlist_items",
	}
...
func responsePathForResource(resource, path string) []string {
	...
	case "accounts\x00/tools/get_accounts":
		return []string{"data.accounts"}
	case "equities\x00/tools/cancel_equity_order":
		return []string{"data"}
	case "equities\x00/tools/get_equity_orders":
		return []string{"data.orders"}
	case "equities\x00/tools/place_equity_order":
		return []string{"data.order"}
	case "equities\x00/tools/get_equity_positions":
		return []string{"data.positions"}
	case "equities\x00/tools/review_equity_order":
		return []string{"data"}
	case "equities\x00/tools/get_equity_tax_lots":
		return []string{"data.lots"}
	case "market\x00/tools/get_equity_price_book":
		return []string{"data"}
	case "market\x00/tools/get_earnings_calendar":
		return []string{"data.events"}
	case "market\x00/tools/get_earnings_results":
		return []string{"data.results"}
	case "market\x00/tools/get_financials":
		return []string{"data.results"}
	case "market\x00/tools/get_equity_fundamentals":
		return []string{"data.results"}
	case "market\x00/tools/get_equity_historicals":
		return []string{"data.results"}
	case "market\x00/tools/get_index_quotes":
		return []string{"data.quotes"}
	case "market\x00/tools/get_indexes":
		return []string{"data.indexes"}
	case "market\x00/tools/get_equity_technical_indicators":
		return []string{"data.results"}
	case "market\x00/tools/get_equity_quotes":
		return []string{"data.results"}
	case "market\x00/tools/search":
		return []string{"data.results"}
	case "market\x00/tools/get_equity_tradability":
		return []string{"data.results"}
	case "options\x00/tools/cancel_option_order":
		return []string{"data"}
	case "options\x00/tools/get_option_chains":
		return []string{"data.chains"}
	case "options\x00/tools/get_option_instruments":
		return []string{"data.instruments"}
	case "options\x00/tools/get_option_orders":
		return []string{"data.orders"}
	case "options\x00/tools/place_option_order":
		return []string{"data.order"}
	case "options\x00/tools/get_option_positions":
		return []string{"data.positions"}
	case "options\x00/tools/get_option_quotes":
		return []string{"data.results"}
	case "options\x00/tools/review_option_order":
		return []string{"data"}
	case "options\x00/tools/get_option_level_upgrade_info":
		return []string{"data"}
	case "options\x00/tools/get_option_watchlist":
		return []string{"data.items"}
	case "options\x00/tools/add_option_to_watchlist":
		return []string{"data"}
	case "options\x00/tools/remove_option_from_watchlist":
		return []string{"data"}
	case "portfolio\x00/tools/get_pnl_trade_history":
		return []string{"data.trades"}
	case "portfolio\x00/tools/get_realized_pnl":
		return []string{"data"}
	case "portfolio\x00/tools/get_portfolio":
		return []string{"data"}
	case "scans\x00/tools/create_scan":
		return []string{"data"}
	case "scans\x00/tools/get_scans":
		return []string{"data.scans"}
	case "scans\x00/tools/run_scan":
		return []string{"data.results"}
	case "scans\x00/tools/update_scan_config":
		return []string{"data"}
	case "scans\x00/tools/update_scan_filters":
		return []string{"data"}
	case "scans\x00/tools/get_scanner_filter_specs":
		return []string{"data"}
	case "watchlists\x00/tools/add_to_watchlist":
		return []string{"data"}
	case "watchlists\x00/tools/create_watchlist":
		return []string{"data"}
	case "watchlists\x00/tools/follow_watchlist":
		return []string{"data"}
	case "watchlists\x00/tools/get_watchlist_items":
		return []string{"data.items"}
	case "watchlists\x00/tools/get_watchlists":
		return []string{"data.watchlists"}
	case "watchlists\x00/tools/get_popular_watchlists":
		return []string{"data.lists"}
	case "watchlists\x00/tools/remove_from_watchlist":
		return []string{"data"}
	case "watchlists\x00/tools/unfollow_watchlist":
		return []string{"data"}
	case "watchlists\x00/tools/update_watchlist":
		return []string{"data"}
	}
	return nil
}
