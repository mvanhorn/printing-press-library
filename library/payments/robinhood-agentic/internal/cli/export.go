...
large datasets as it has no memory pressure.`,
  ...
  robinhood-agentic-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  robinhood-agentic-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  robinhood-agentic-pp-cli export <resource> --format jsonl | jq '.id'`,
