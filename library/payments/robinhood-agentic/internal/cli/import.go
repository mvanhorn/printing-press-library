...
but do not stop the import.`,
  ...
  robinhood-agentic-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  robinhood-agentic-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | robinhood-agentic-pp-cli import <resource> --input -`,
