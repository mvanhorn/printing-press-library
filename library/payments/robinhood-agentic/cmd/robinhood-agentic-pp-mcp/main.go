...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/payments/robinhood-agentic/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("ROBINHOOD_AGENTIC_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "robinhood-agentic-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
