...
Data must be synced first with the sync command.`,
  ...
  monarch-pp-cli analytics --type messages

  # Group by a field
  monarch-pp-cli analytics --type messages --group-by author_id

  # Top 10 most frequent values
  monarch-pp-cli analytics --type messages --group-by channel_id --limit 10 --json`,
