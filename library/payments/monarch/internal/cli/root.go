...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "monarch-pp-cli",
		Short: `Monarch Money CLI with local SQLite store, offline search, and agent-native output across accounts, transactions, budgets, goals, and cashflow.`,
		Long: `Monarch Money CLI with local SQLite store, offline search, and agent-native output across accounts, transactions, budgets, goals, and cashflow.

Add --agent to any command for JSON output + non-interactive mode.
Run 'monarch-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("monarch-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'monarch-pp-cli profile list')")
