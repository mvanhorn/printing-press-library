...
Exit codes & warnings:
  ...
  monarch-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  monarch-pp-cli sync --full

  # Parallel sync with 8 workers
  monarch-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  monarch-pp-cli sync --latest-only`,
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/monarch-pp-cli/data.db)")
