...
but do not stop the import.`,
  ...
  monarch-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  monarch-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | monarch-pp-cli import <resource> --input -`,
