...
func buildAgentDiscoveryContext() *agentContextDiscovery {
	return &agentContextDiscovery{
		...
		TargetURL:     "https://dps.psx.com.pk/",
		EntryCount:    235,
		APIEntryCount: 12,
		...
		CandidateCommands: []string{
			"create_calendar — Derived from observed POST /calendar traffic.",
			"list_KSE100 — Derived from observed GET /timeseries/int/KSE100 traffic.",
			"list_OGDC — Derived from observed GET /timeseries/int/OGDC traffic.",
			"list_symbols — Derived from observed GET /symbols traffic.",
			"list_top_10_sectors — Derived from observed GET /data/top-10-sectors traffic.",
		},
	}
}
