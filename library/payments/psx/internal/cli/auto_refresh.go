...
var readCommandResources = map[string][]string{
	"psx-pp-cli circuit-breakers":        {"circuit-breakers"},
	"psx-pp-cli circuit-breakers list":   {"circuit-breakers"},
	"psx-pp-cli circuit-breakers get":    {"circuit-breakers"},
	"psx-pp-cli circuit-breakers search": {"circuit-breakers"},
	"psx-pp-cli debt":                    {"debt"},
	"psx-pp-cli debt list":               {"debt"},
	"psx-pp-cli debt get":                {"debt"},
	"psx-pp-cli debt search":             {"debt"},
	"psx-pp-cli eligible-scrips":         {"eligible-scrips"},
	"psx-pp-cli eligible-scrips list":    {"eligible-scrips"},
	"psx-pp-cli eligible-scrips get":     {"eligible-scrips"},
	"psx-pp-cli eligible-scrips search":  {"eligible-scrips"},
	"psx-pp-cli indices":                 {"indices"},
	"psx-pp-cli indices list":            {"indices"},
	"psx-pp-cli indices get":             {"indices"},
	"psx-pp-cli indices search":          {"indices"},
	"psx-pp-cli screener":                {"screener"},
	"psx-pp-cli screener list":           {"screener"},
	"psx-pp-cli screener get":            {"screener"},
	"psx-pp-cli screener search":         {"screener"},
	"psx-pp-cli sectors":                 {"sectors"},
	"psx-pp-cli sectors list":            {"sectors"},
	"psx-pp-cli sectors get":             {"sectors"},
	"psx-pp-cli sectors search":          {"sectors"},
	"psx-pp-cli symbols":                 {"symbols"},
	"psx-pp-cli symbols list":            {"symbols"},
	"psx-pp-cli symbols get":             {"symbols"},
	"psx-pp-cli symbols search":          {"symbols"},
}
...
func autoRefreshIfStale(ctx context.Context, flags *rootFlags, resources []string) (meta cliutil.FreshnessMeta) {
	...
	if err := runAutoRefresh(refreshCtx, flags, db, resources); err != nil {
		fmt.Fprintf(os.Stderr, "warning: using stale psx-pp-cli cache (refresh failed: %v)\n", err)
