...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"psx-pp-cli auth login",
		"psx-pp-cli doctor",
		"psx-pp-cli help items",
		"psx-pp-cli sync",
		"psx-pp-cli profile list",
		"psx-pp-cli feedback list",
		"psx-pp-cli which",
		"psx-pp-cli agent-context",
		"psx-pp-cli completion bash",
		"psx-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"psx-pp-cli teach",
		"psx-pp-cli recall",
		"psx-pp-cli learnings",
		"psx-pp-cli teach-pattern",
		"psx-pp-cli teach-lookup",
		"psx-pp-cli items list",
	}
