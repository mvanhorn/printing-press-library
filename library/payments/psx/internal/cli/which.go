...
var whichIndex = []whichEntry{
	{Command: "actions", Description: "See every announcement, payout, AGM date and circuit-breaker event for the symbols you track, in one place.", Group: "Cross-surface joins", WhyItMatters: "Reach for this when the question is 'did anything happen to my names', instead of running four searches and merging them by hand."},
	{Command: "diff", Description: "Show what changed in price, volume and valuation metrics between two synced snapshots.", Group: "Local state that compounds", WhyItMatters: "Use this when the user asks what moved since last week rather than what the price is right now."},
	{Command: "watchlist", Description: "Keep a saved symbol set and price it on demand, with change measured from the day you added each name.", Group: "Local state that compounds", WhyItMatters: "Use this to give an otherwise stateless market portal a memory of which names the user actually cares about."},
	{Command: "unusual", Description: "Find names trading abnormally against their own trailing history, not just the day's biggest movers.", Group: "Baselines the portal never keeps", WhyItMatters: "Use this to separate a genuine volume spike from a name that always trades that way."},
	{Command: "rotation", Description: "Rank sectors by movement over a window and name the constituents that drove each move.", Group: "Baselines the portal never keeps", WhyItMatters: "Use this for 'what is leading and lagging, and why' instead of a bare current-volume ranking."},
	{Command: "drift", Description: "Trace one symbol's PE, dividend yield, market cap or free float across time.", Group: "Local state that compounds", WhyItMatters: "Use this when the question is about the trajectory of a multiple, not its current value."},
	{Command: "basis", Description: "Compare futures-board prices against the regular spot board to see premium or discount per symbol.", Group: "Cross-surface joins", WhyItMatters: "Use this for carry and roll questions that require crossing PSX's separate market boards."},
	{Command: "docs search", Description: "Search PSX regulatory documents, listing guides and notices by keyword, with last-updated dates.", Group: "Cross-surface joins", WhyItMatters: "Use this to locate the governing PSX rule, guide or notice for a question instead of browsing the corporate site by hand."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  psx-pp-cli which "stale tickets"
  psx-pp-cli which "bottleneck"
  psx-pp-cli which --limit 1 "send message"
  psx-pp-cli which                                # list the full capability index`,
