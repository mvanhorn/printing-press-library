...
Exit codes & warnings:
  ...
  accounting-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  accounting-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  accounting-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  accounting-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  accounting-pp-cli sync --latest-only`,
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/accounting-pp-cli/data.db)")
...
func defaultSyncResources() []string {
	return []string{
		"external",
		"external-v2-bank-accounts",
		"external-v2-bank-establishments",
		"external-v2-billing-subscriptions",
		"external-v2-categories",
		"external-v2-category-groups",
		"external-v2-changelogs-customer-invoices",
		"external-v2-changelogs-customers",
		"external-v2-changelogs-ledger-entry-lines",
		"external-v2-changelogs-products",
		"external-v2-changelogs-quotes",
		"external-v2-changelogs-supplier-invoices",
		"external-v2-changelogs-suppliers",
		"external-v2-changelogs-transactions",
		"external-v2-commercial-documents",
		"external-v2-customer-invoice-templates",
		"external-v2-customer-invoices",
		"external-v2-customers",
		"external-v2-file-attachments",
		"external-v2-fiscal-years",
		"external-v2-gocardless-mandates",
		"external-v2-journals",
		"external-v2-ledger-accounts",
		"external-v2-ledger-attachments",
		"external-v2-ledger-entries",
		"external-v2-ledger-entry-lines",
		"external-v2-pa-registrations",
		"external-v2-pro-account-mandate-migrations",
		"external-v2-pro-account-mandates",
		"external-v2-products",
		"external-v2-purchase-requests",
		"external-v2-quotes",
		"external-v2-sepa-mandates",
		"external-v2-supplier-invoices",
		"external-v2-suppliers",
		"external-v2-transactions",
		"external-v2-webhook-subscription",
	}
}
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"external":                                   "/api/external/v2/me",
		"external-v2-bank-accounts":                  "/api/external/v2/bank_accounts",
		"external-v2-bank-establishments":            "/api/external/v2/bank_establishments",
		"external-v2-billing-subscriptions":          "/api/external/v2/billing_subscriptions",
		"external-v2-categories":                     "/api/external/v2/categories",
		"external-v2-category-groups":                "/api/external/v2/category_groups",
		"external-v2-changelogs-customer-invoices":   "/api/external/v2/changelogs/customer_invoices",
		"external-v2-changelogs-customers":           "/api/external/v2/changelogs/customers",
		"external-v2-changelogs-ledger-entry-lines":  "/api/external/v2/changelogs/ledger_entry_lines",
		"external-v2-changelogs-products":            "/api/external/v2/changelogs/products",
		"external-v2-changelogs-quotes":              "/api/external/v2/changelogs/quotes",
		"external-v2-changelogs-supplier-invoices":   "/api/external/v2/changelogs/supplier_invoices",
		"external-v2-changelogs-suppliers":           "/api/external/v2/changelogs/suppliers",
		"external-v2-changelogs-transactions":        "/api/external/v2/changelogs/transactions",
		"external-v2-commercial-documents":           "/api/external/v2/commercial_documents",
		"external-v2-customer-invoice-templates":     "/api/external/v2/customer_invoice_templates",
		"external-v2-customer-invoices":              "/api/external/v2/customer_invoices",
		"external-v2-customers":                      "/api/external/v2/customers",
		"external-v2-file-attachments":               "/api/external/v2/file_attachments",
		"external-v2-fiscal-years":                   "/api/external/v2/fiscal_years",
		"external-v2-gocardless-mandates":            "/api/external/v2/gocardless_mandates",
		"external-v2-journals":                       "/api/external/v2/journals",
		"external-v2-ledger-accounts":                "/api/external/v2/ledger_accounts",
		"external-v2-ledger-attachments":             "/api/external/v2/ledger_attachments",
		"external-v2-ledger-entries":                 "/api/external/v2/ledger_entries",
		"external-v2-ledger-entry-lines":             "/api/external/v2/ledger_entry_lines",
		"external-v2-pa-registrations":               "/api/external/v2/pa_registrations",
		"external-v2-pro-account-mandate-migrations": "/api/external/v2/pro_account/mandate_migrations",
		"external-v2-pro-account-mandates":           "/api/external/v2/pro_account/mandates",
		"external-v2-products":                       "/api/external/v2/products",
		"external-v2-purchase-requests":              "/api/external/v2/purchase_requests",
		"external-v2-quotes":                         "/api/external/v2/quotes",
		"external-v2-sepa-mandates":                  "/api/external/v2/sepa_mandates",
		"external-v2-supplier-invoices":              "/api/external/v2/supplier_invoices",
		"external-v2-suppliers":                      "/api/external/v2/suppliers",
		"external-v2-transactions":                   "/api/external/v2/transactions",
		"external-v2-webhook-subscription":           "/api/external/v2/webhook_subscription",
	}
