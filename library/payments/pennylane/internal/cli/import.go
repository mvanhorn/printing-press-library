...
but do not stop the import.`,
  ...
  accounting-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  accounting-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | accounting-pp-cli import <resource> --input -`,
