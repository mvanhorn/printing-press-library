...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  accounting-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  accounting-pp-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"external", "external-v2-bank-accounts", "external-v2-bank-establishments", "external-v2-billing-subscriptions", "external-v2-categories", "external-v2-category-groups", "external-v2-changelogs-customer-invoices", "external-v2-changelogs-customers", "external-v2-changelogs-ledger-entry-lines", "external-v2-changelogs-products", "external-v2-changelogs-quotes", "external-v2-changelogs-supplier-invoices", "external-v2-changelogs-suppliers", "external-v2-changelogs-transactions", "external-v2-commercial-documents", "external-v2-customer-invoice-templates", "external-v2-customer-invoices", "external-v2-customers", "external-v2-file-attachments", "external-v2-fiscal-years", "external-v2-gocardless-mandates", "external-v2-journals", "external-v2-ledger-accounts", "external-v2-ledger-attachments", "external-v2-ledger-entries", "external-v2-ledger-entry-lines", "external-v2-pa-registrations", "external-v2-pro-account-mandate-migrations", "external-v2-pro-account-mandates", "external-v2-products", "external-v2-purchase-requests", "external-v2-quotes", "external-v2-sepa-mandates", "external-v2-supplier-invoices", "external-v2-suppliers", "external-v2-transactions", "external-v2-webhook-subscription"}
			totalSynced := 0
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  accounting-pp-cli workflow status

  # Show status as JSON
  accounting-pp-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("accounting-pp-cli")
			}
