...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "accounting-pp-cli",
		Short: "Pennylane CLI with AR aging, cash runway, VAT preview, and FEC validation",
		Long: `Pennylane CLI with AR aging, cash runway, VAT preview, and FEC validation.
...
Run 'accounting-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("accounting-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'accounting-pp-cli profile list')")
	...
	rootCmd.AddCommand(newExternalCmd(flags))
	...
	rootCmd.AddCommand(newCashCmd(flags))
	rootCmd.AddCommand(newVATCmd(flags))
	rootCmd.AddCommand(newAuditCmd(flags))
	rootCmd.AddCommand(newClientsCmd(flags))
	rootCmd.AddCommand(newFECCmd(flags))
	rootCmd.AddCommand(newYearEndCmd(flags))
	rootCmd.AddCommand(newInvoiceNovelCmd(flags))
	rootCmd.AddCommand(newAPCmd(flags))
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("accounting-pp-cli %s\n", version)
		},
	}
}
