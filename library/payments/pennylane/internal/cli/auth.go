...
func newAuthCmd(flags *rootFlags) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "auth",
		Short: "Manage authentication for Accounting",
	}
...
func newAuthLoginCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			tokenURL := "https://app.pennylane.com/oauth/oauth/token"
	...
	cmd.Flags().StringVar(&clientID, "client-id", os.Getenv("ACCOUNTING_CLIENT_ID"), "OAuth2 client ID")
	cmd.Flags().StringVar(&clientSecret, "client-secret", os.Getenv("ACCOUNTING_CLIENT_SECRET"), "OAuth2 client secret")
