# American Express Offers Printed CLI Agent Guide

This directory is a generated `american-express-offers-pp-cli` printed CLI. It was produced by [CLI Printing Press](https://github.com/mvanhorn/cli-printing-press), so treat systemic fixes as upstream Printing Press fixes first. Keep local edits narrow and document why a generated-tree patch belongs here.
...
```bash
american-express-offers-pp-cli doctor --json
american-express-offers-pp-cli agent-context --pretty
```

Use runtime discovery instead of relying on a copied command list:

```bash
american-express-offers-pp-cli which "<capability>" --json
american-express-offers-pp-cli <command> --help
```
...
```bash
american-express-offers-pp-cli <command> --agent
```
...
```bash
american-express-offers-pp-cli <command> --help
american-express-offers-pp-cli <command> --dry-run --agent
```
