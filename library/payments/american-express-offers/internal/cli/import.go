...
but do not stop the import.`,
  ...
  american-express-offers-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  american-express-offers-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | american-express-offers-pp-cli import <resource> --input -`,
