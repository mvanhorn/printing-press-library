...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "american-express-offers-pp-cli",
		Short: "List card-linked offers, savings, and rewards on your American Express card",
		Long: `Manage american-express-offers resources via the american-express-offers API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'american-express-offers-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("american-express-offers-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'american-express-offers-pp-cli profile list')")
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		Use:   "version",
		Short: "Print the american-express-offers-pp-cli version",
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("american-express-offers-pp-cli %s\n", version)
		},
	}
}
