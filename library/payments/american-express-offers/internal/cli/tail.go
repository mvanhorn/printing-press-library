...
native streaming instead of polling.`,
  ...
  american-express-offers-pp-cli tail --interval 10s

  # Tail a specific resource
  american-express-offers-pp-cli tail messages --interval 5s

  # Pipe to jq for filtering
  american-express-offers-pp-cli tail events --interval 30s | jq 'select(.type == "error")'`,
