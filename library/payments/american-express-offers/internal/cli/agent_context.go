...
func buildAgentContext(rootCmd *cobra.Command) agentContext {
	...
	return agentContext{
		...
		CLI: agentContextCLI{
			Name:        "american-express-offers-pp-cli",
...
func buildAgentDiscoveryContext() *agentContextDiscovery {
	return &agentContextDiscovery{
		...
		TargetURL:     "https://apigw.americanexpress.com/servicing/v1/contact_management/chats/polls/inquiry_results",
		EntryCount:    2241,
		APIEntryCount: 543,
		...
		CandidateCommands: []string{
			"create_FAM2kB — Derived from observed POST /CDH_JN/e/b/HUzGnmcaKw2T/h7YE6GDrirh0kmYG/Xmlu/SQlrIE/FAM2kB traffic.",
			"create_Targeting.php — Derived from observed POST /{id}/Targeting.php traffic.",
			"create_beacon — Derived from observed POST /beacon traffic.",
			"create_errors — Derived from observed POST /_/report/errors traffic.",
			"create_events — Derived from observed POST /personalization/v2/customers/treatments/events traffic.",
			"create_inquiry_results — Derived from observed POST /servicing/v1/contact_management/chats/inquiry_results traffic.",
			"get_Asset.php — Derived from observed GET /{id}/Asset.php traffic.",
			"list_axp_personalized_marketing.json — Derived from observed GET /cdaas/one-app/modules/axp-personalized-marketing/1.28.0/en-us/axp-personalized-marketing.json traffic.",
		},
	}
}
