...
func TestUpsertBatch_PopulatesApproveTable(t *testing.T) {
	...
	items := []json.RawMessage{
		json.RawMessage(`{"id": "test-001", "disbursements_id": "test-parent-001"}`),
		json.RawMessage(`{"id": "test-002", "disbursements_id": "test-parent-001"}`),
		json.RawMessage(`{"id": "test-003", "disbursements_id": "test-parent-001"}`),
	}
...
func TestUpsertBatch_TypedFailureDoesNotStrandApproveGeneric(t *testing.T) {
	...
	// Items deliberately omit "disbursements_id" so the typed NOT NULL
	// constraint fires.
	items := []json.RawMessage{
	...
	if typed != 0 {
		t.Fatalf("approve count = %d, want 0 (typed insert violated NOT NULL on %q)", typed, "disbursements_id")
	}
}
...
func TestUpsertBatch_TypedFailureDoesNotStrandCancelGeneric(t *testing.T) {
	...
	if typed != 0 {
		t.Fatalf("cancel count = %d, want 0 (typed insert violated NOT NULL on %q)", typed, "payments_id")
	}
}
...
func TestUpsertBatch_TypedFailureDoesNotStrandStatusGeneric(t *testing.T) {
	...
	if typed != 0 {
		t.Fatalf("status count = %d, want 0 (typed insert violated NOT NULL on %q)", typed, "payments_id")
	}
}
...
func TestUpsertBatch_TypedFailureDoesNotStrandVerifyGeneric(t *testing.T) {
	...
	if typed != 0 {
		t.Fatalf("verify count = %d, want 0 (typed insert violated NOT NULL on %q)", typed, "payments_id")
	}
}
