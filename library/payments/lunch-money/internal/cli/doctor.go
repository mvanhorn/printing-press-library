		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if cfg != nil {
				...
				if header == "" {
					...
					report["auth_hint"] = "export LUNCHMONEY_ACCESS_TOKEN=<your-key>"
			...
			if os.Getenv("LUNCHMONEY_ACCESS_TOKEN") != "" {
				authEnvSet = append(authEnvSet, "LUNCHMONEY_ACCESS_TOKEN")
				...
				authEnvRequiredMissing = append(authEnvRequiredMissing, "LUNCHMONEY_ACCESS_TOKEN")
			}
			...
			if os.Getenv("LUNCHMONEY_TOKEN") != "" {
				authEnvSet = append(authEnvSet, "LUNCHMONEY_TOKEN")
			} else if authConfigured {
				authSource, _ := report["auth_source"].(string)
				if authSource == "" {
					authSource = "config"
				...
				authEnvRequiredMissing = append(authEnvRequiredMissing, "LUNCHMONEY_TOKEN")
			}
			if os.Getenv("LUNCHMONEY_API_TOKEN") != "" {
				authEnvSet = append(authEnvSet, "LUNCHMONEY_API_TOKEN")
			} else if authConfigured {
				authSource, _ := report["auth_source"].(string)
				if authSource == "" {
					authSource = "config"
				...
				authEnvRequiredMissing = append(authEnvRequiredMissing, "LUNCHMONEY_API_TOKEN")
			}
			if os.Getenv("LUNCH_MONEY_API_KEY") != "" {
				authEnvSet = append(authEnvSet, "LUNCH_MONEY_API_KEY")
			} else if authConfigured {
				authSource, _ := report["auth_source"].(string)
				if authSource == "" {
					authSource = "config"
				...
				authEnvRequiredMissing = append(authEnvRequiredMissing, "LUNCH_MONEY_API_KEY")
			}
			switch {
