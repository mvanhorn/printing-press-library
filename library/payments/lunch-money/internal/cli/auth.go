...
func newAuthSetupCmd(_ *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			fmt.Fprintln(w, "  export LUNCHMONEY_ACCESS_TOKEN=\"<your-token>\"")
			fmt.Fprintln(w, "  export LUNCHMONEY_API_KEY=\"<your-token>\"")
			fmt.Fprintln(w, "  export LUNCHMONEY_TOKEN=\"<your-token>\"")
			fmt.Fprintln(w, "  export LUNCHMONEY_API_TOKEN=\"<your-token>\"")
			fmt.Fprintln(w, "  export LUNCH_MONEY_API_KEY=\"<your-token>\"")
	...
	return &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !authed {
				...
				fmt.Fprintln(w, "  export LUNCHMONEY_ACCESS_TOKEN=\"your-token-here\"")
				fmt.Fprintln(w, "  export LUNCHMONEY_API_KEY=\"your-token-here\"")
				fmt.Fprintln(w, "  export LUNCHMONEY_TOKEN=\"your-token-here\"")
				fmt.Fprintln(w, "  export LUNCHMONEY_API_TOKEN=\"your-token-here\"")
				fmt.Fprintln(w, "  export LUNCH_MONEY_API_KEY=\"your-token-here\"")
...
func newAuthLogoutCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			envStillSet := ""
			if envStillSet == "" && os.Getenv("LUNCHMONEY_ACCESS_TOKEN") != "" {
				envStillSet = "LUNCHMONEY_ACCESS_TOKEN"
			}
			if envStillSet == "" && os.Getenv("LUNCHMONEY_API_KEY") != "" {
				envStillSet = "LUNCHMONEY_API_KEY"
			}
			if envStillSet == "" && os.Getenv("LUNCHMONEY_TOKEN") != "" {
				envStillSet = "LUNCHMONEY_TOKEN"
			}
			if envStillSet == "" && os.Getenv("LUNCHMONEY_API_TOKEN") != "" {
				envStillSet = "LUNCHMONEY_API_TOKEN"
			}
			if envStillSet == "" && os.Getenv("LUNCH_MONEY_API_KEY") != "" {
				envStillSet = "LUNCH_MONEY_API_KEY"
			}
