...
but do not stop the import.`,
  ...
  stripe-pp-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  stripe-pp-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | stripe-pp-pp-cli import <resource> --input -`,
