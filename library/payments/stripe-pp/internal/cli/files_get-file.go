...
func newFilesGetFileCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-file",
		Short:       "Retrieves the details of an existing file object. After you supply a unique file ID, Stripe returns the...",
		Example:     "  stripe-pp-pp-cli files get-file example-value",
