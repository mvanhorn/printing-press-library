...
// handleAtRiskSubscriptionsBeforeRenewals runs the at_risk_subscriptions_before_renewals recipe intent: List active subscriptions tied to expired or unconfirmed payment methods so you can fix cards before they churn.
func handleAtRiskSubscriptionsBeforeRenewals(ctx context.Context, req mcplib.CallToolRequest) (*mcplib.CallToolResult, error) {
