...
func TestDeclaredAPISurfaceReachable(t *testing.T) {
	expected := []string{
		...
		"customers payment-methods customers-get",
		"customers tax-profiles",
		"customers tax-profiles customers-create",
		"customers tax-profiles customers-delete",
		"customers tax-profiles customers-update",
		"customers update",
		"discounts",
		"discounts create",
		"discounts delete",
		...
		"invoices list",
		"invoices mark-paid",
		"invoices mark-paid invoices",
		"invoices payment-link",
		"invoices payment-link invoices-get",
		"invoices payments",
		"invoices payments invoices-apply",
		"invoices reminders",
		"invoices reminders invoices-send",
		"invoices try-payment",
		"invoices try-payment invoices",
		"invoices update",
		"payment-concepts",
		"payment-concepts create",
		"payment-concepts get-by-id",
		"payment-concepts list",
		"payment-concepts update",
		"payment-methods",
		"payment-sessions",
		"payment-sessions create",
		"payment-sessions get-by-id",
		"payments",
		"payments create",
		"payments get-by-id",
		"payments list",
		"payments receipt",
		"payments receipt payments-send",
		"refunds",
		"setup-sessions",
		"subscriptions",
		...
		"tax-invoices",
		"tax-invoices cancel",
		"tax-invoices cancel tax-invoices",
		"tax-invoices create",
		"tax-invoices get-by-id",
		"tax-invoices list",
		"webhook-events",
		"webhook-events retry",
		"webhook-events retry webhook-events",
		"webhooks",
		"webhooks create",
		"webhooks delete",
		"webhooks get-by-id",
