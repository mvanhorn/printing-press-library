...
large datasets as it has no memory pressure.`,
  ...
  quentli-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  quentli-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  quentli-pp-cli export <resource> --format jsonl | jq '.id'`,
