...
func newWebhooksListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list",
		Short:       "Returns webhook endpoints for the organization.",
		Example:     "  quentli-pp-cli webhooks list",
	...
	cmd.Flags().StringVar(&flagFilter, "filter", "", "A `qs`-encoded `webhookFilter` object.")
	...
	cmd.Flags().StringVar(&flagOrderBy, "order-by", "", "A `qs`-encoded `webhookOrderBy` object.")
