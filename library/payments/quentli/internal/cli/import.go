...
but do not stop the import.`,
  ...
  quentli-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  quentli-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | quentli-pp-cli import <resource> --input -`,
