...
func newCustomersListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list",
		Short:       "Returns customers.",
		Example:     "  quentli-pp-cli customers list",
	...
	cmd.Flags().StringVar(&flagFilter, "filter", "", "A `qs`-encoded `customerFilter` object.")
	...
	cmd.Flags().StringVar(&flagOrderBy, "order-by", "", "A `qs`-encoded `customerOrderBy` object.")
