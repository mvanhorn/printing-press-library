...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"quentli-pp-cli auth login",
		"quentli-pp-cli doctor",
		"quentli-pp-cli help items",
		"quentli-pp-cli sync",
		"quentli-pp-cli profile list",
		"quentli-pp-cli feedback list",
		"quentli-pp-cli which",
		"quentli-pp-cli agent-context",
		"quentli-pp-cli completion bash",
		"quentli-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"quentli-pp-cli recall",
		"quentli-pp-cli learnings",
		"quentli-pp-cli teach-pattern",
		"quentli-pp-cli teach-lookup",
		"quentli-pp-cli items list",
	}
