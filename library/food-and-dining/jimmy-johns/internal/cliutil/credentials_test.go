...
func resetCredentialEnv(t *testing.T) (home, configPath string) {
	...
	for _, name := range []string{
		"JIMMY_JOHNS_CONFIG",
		"JIMMY_JOHNS_CONFIG_DIR",
		"JIMMY_JOHNS_DATA_DIR",
		"JIMMY_JOHNS_STATE_DIR",
		"JIMMY_JOHNS_CACHE_DIR",
		"JIMMY_JOHNS_HOME",
		"XDG_CONFIG_HOME",
		"XDG_DATA_HOME",
		"XDG_STATE_HOME",
	...
	return home, filepath.Join(home, ".config", "jimmy-johns-pp-cli", "config.toml")
}
...
func TestCorruptCredentialsFallsBackToLegacyConfig(t *testing.T) {
	...
	credentialsPath := filepath.Join(home, ".local", "share", "jimmy-johns-pp-cli", "credentials.toml")
...
func TestAuthWriteScrubsLegacyConfigWhenRelocated(t *testing.T) {
	...
	activeConfigPath := filepath.Join(newConfigDir, "jimmy-johns-pp-cli", "config.toml")
	...
	credsPath := filepath.Join(newDataDir, "jimmy-johns-pp-cli", "credentials.toml")
