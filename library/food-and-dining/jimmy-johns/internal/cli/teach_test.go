...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("JIMMY_JOHNS_STATE_DIR", "")
	t.Setenv("JIMMY_JOHNS_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"jimmy-johns-pp-cli auth login",
		"jimmy-johns-pp-cli doctor",
		"jimmy-johns-pp-cli help items",
		"jimmy-johns-pp-cli sync",
		"jimmy-johns-pp-cli profile list",
		"jimmy-johns-pp-cli feedback list",
		"jimmy-johns-pp-cli which",
		"jimmy-johns-pp-cli agent-context",
		"jimmy-johns-pp-cli completion bash",
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"jimmy-johns-pp-cli recall",
		"jimmy-johns-pp-cli learnings",
		"jimmy-johns-pp-cli teach-pattern",
		"jimmy-johns-pp-cli teach-lookup",
		"jimmy-johns-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("jimmy-johns-pp-cli")); err == nil {
