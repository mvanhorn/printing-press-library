...
type Config struct {
	...
	CookunityToken   string          `toml:"token"`
}

func Load(configPath string) (*Config, error) {
	cfg := &Config{
		BaseURL: "https://subscription.cookunity.com",
	}
	...
	// Env var overrides
	if v := os.Getenv("COOKUNITY_TOKEN"); v != "" {
		cfg.CookunityToken = v
		cfg.markEnvOverride("CookunityToken")
		cfg.AuthSource = "env:COOKUNITY_TOKEN"
		cfg.CredentialSource = "env:COOKUNITY_TOKEN"
	}
	...
	if v := os.Getenv("COOKUNITY_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("COOKUNITY_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "cookunity-pp-cli", "config.toml"), nil
}
...
func (c *Config) AuthHeader() string {
	...
	replacements := map[string]string{
		"token":           token,
		"COOKUNITY_TOKEN": c.CookunityToken,
	}
...
func (c *Config) credentials() *cliutil.Credentials {
	return &cliutil.Credentials{
		...
		CookunityToken: c.CookunityToken,
	}
}
...
func (c *Config) applyCredentials(creds *cliutil.Credentials) {
	...
	c.CookunityToken = creds.CookunityToken
}
...
func (c *Config) SaveCredential(token string) error {
	...
	c.updateFileConfigField("AccessToken")
	c.CookunityToken = token
	delete(c.envOverrides, "CookunityToken")
	c.updateFileConfigField("CookunityToken")
	if err := c.saveCredentialsFirst(); err != nil {
		return err
	}
	return c.save()
...
func (c *Config) configForSave() Config {
	out := *c
	if c.fileConfig != nil {
		if c.envOverrides["CookunityToken"] {
			out.CookunityToken = c.fileConfig.CookunityToken
		}
	}
...
func (c *Config) updateFileConfigField(field string) {
	...
	case "CookunityToken":
		c.fileConfig.CookunityToken = c.CookunityToken
	}
}
