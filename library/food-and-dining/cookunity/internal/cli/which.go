...
var whichIndex = []whichEntry{
	{Command: "plan", Description: "Auto-build a set of meals that collectively hit your protein, calorie, budget, and diet targets — offline, in one command.", Group: "Local planning that compounds", WhyItMatters: "Reach for this when the user wants a week's worth of meals meeting nutrition or budget constraints instead of hand-picking dishes."},
	{Command: "drift", Description: "See exactly which meals were added, removed, or repriced between two weekly menus.", Group: "Local planning that compounds", WhyItMatters: "Use this to track what changed on the new menu without re-scanning 300+ dishes by hand."},
	{Command: "value", Description: "Rank meals by nutritional value per dollar (protein-per-dollar, calories-per-dollar) computed from the local mirror.", Group: "Local planning that compounds", WhyItMatters: "Pick this when the user cares about maximizing protein or calories per dollar across the menu."},
	{Command: "favorites", Description: "Show which of your favorited meals are actually on the current week's menu.", Group: "Agent-native menu queries", WhyItMatters: "Use this first after a menu drop to see if the user's liked meals are back."},
	{Command: "compare", Description: "Side-by-side macro, price, chef, and allergen comparison of two or more meals.", Group: "Agent-native menu queries", WhyItMatters: "Reach for this to decide between specific candidate meals the user already has in mind."},
	{Command: "chefs", Description: "Leaderboard of chefs by dish count, average rating, average price, and cuisines on the current menu.", Group: "Agent-native menu queries", WhyItMatters: "Use this to explore the menu by chef or find highly-rated chefs."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  cookunity-pp-cli which "stale tickets"
  cookunity-pp-cli which "bottleneck"
  cookunity-pp-cli which --limit 1 "send message"
  cookunity-pp-cli which                                # list the full capability index`,
