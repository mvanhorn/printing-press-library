...
large datasets as it has no memory pressure.`,
  ...
  cookunity-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  cookunity-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  cookunity-pp-cli export <resource> --format jsonl | jq '.id'`,
