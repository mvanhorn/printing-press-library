...
func RegisterIntents(s *server.MCPServer) {
	s.AddTool(
		mcplib.NewTool("compare_two_meals_head_to_head",
			mcplib.WithDescription("Prints a side-by-side macro/price/chef/allergen comparison of the two meal ids."),
		...
		handleCompareTwoMealsHeadToHead,
	)
}

// handleCompareTwoMealsHeadToHead runs the compare_two_meals_head_to_head recipe intent: Prints a side-by-side macro/price/chef/allergen comparison of the two meal ids.
func handleCompareTwoMealsHeadToHead(ctx context.Context, req mcplib.CallToolRequest) (*mcplib.CallToolResult, error) {
