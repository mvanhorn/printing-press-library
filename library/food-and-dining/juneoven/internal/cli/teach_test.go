...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("JUNEOVEN_STATE_DIR", "")
	t.Setenv("JUNEOVEN_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"juneoven-pp-cli auth login",
		"juneoven-pp-cli doctor",
		"juneoven-pp-cli help items",
		"juneoven-pp-cli sync",
		"juneoven-pp-cli profile list",
		"juneoven-pp-cli feedback list",
		"juneoven-pp-cli which",
		"juneoven-pp-cli agent-context",
		"juneoven-pp-cli completion bash",
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"juneoven-pp-cli recall",
		"juneoven-pp-cli learnings",
		"juneoven-pp-cli teach-pattern",
		"juneoven-pp-cli teach-lookup",
		"juneoven-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("juneoven-pp-cli")); err == nil {
