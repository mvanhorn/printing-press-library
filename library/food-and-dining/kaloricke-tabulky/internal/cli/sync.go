...
Resource scoping:
  ...
  kaloricke-tabulky-pp-cli sync

  # Sync specific resources only
  kaloricke-tabulky-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  kaloricke-tabulky-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  kaloricke-tabulky-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  kaloricke-tabulky-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  kaloricke-tabulky-pp-cli sync --latest-only`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if dbPath == "" {
				dbPath = defaultDBPath("kaloricke-tabulky-pp-cli")
			}
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/kaloricke-tabulky-pp-cli/data.db)")
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"achievements":        "/statistic/analysis/achievements/get",
		"favorite":            "/user/settings/favorite/activity",
		"favorite-foodstuff":  "/user/settings/favorite/foodstuff",
		"meal":                "/user/settings/meal/list",
		"notifications":       "/site/messages",
		"notifications-inapp": "/user/messages/inapp",
		"session":             "/session/keepalive",
		"stats":               "/home/user/count",
		"stats-count":         "/home/diary/count",
	}
