...
but do not stop the import.`,
  ...
  kaloricke-tabulky-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  kaloricke-tabulky-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | kaloricke-tabulky-pp-cli import <resource> --input -`,
