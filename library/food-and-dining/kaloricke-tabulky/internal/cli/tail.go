...
native streaming instead of polling.`,
  ...
  kaloricke-tabulky-pp-cli tail --interval 10s

  # Tail a specific resource
  kaloricke-tabulky-pp-cli tail messages --interval 5s

  # Pipe to jq for filtering
  kaloricke-tabulky-pp-cli tail events --interval 30s | jq 'select(.type == "error")'`,
