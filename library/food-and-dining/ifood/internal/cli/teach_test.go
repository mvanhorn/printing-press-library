...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"ifood-pp-cli auth login",
		"ifood-pp-cli doctor",
		"ifood-pp-cli help items",
		"ifood-pp-cli sync",
		"ifood-pp-cli profile list",
		"ifood-pp-cli feedback list",
		"ifood-pp-cli which",
		"ifood-pp-cli agent-context",
		"ifood-pp-cli completion bash",
		"ifood-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"ifood-pp-cli teach",
		"ifood-pp-cli recall",
		"ifood-pp-cli learnings",
		"ifood-pp-cli teach-pattern",
		"ifood-pp-cli teach-lookup",
		"ifood-pp-cli items list",
	}
