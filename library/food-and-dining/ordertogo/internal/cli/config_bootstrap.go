  ...
  ordertogo-pp-cli config bootstrap-from-capture --capture .captured-real-order.json --dry-run`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			set := map[string]string{
				...
				"billing_address1":    pc.BillingAddress1,
				"billing_address2":    pc.BillingAddress2,
				"billing_city":        pc.BillingCity,
				"billing_state":       pc.BillingState,
			...
			summary := map[string]any{
				...
				"billing_address1":    maskCard(pc.BillingAddress1),
				"billing_address2":    maskCard(pc.BillingAddress2),
				"billing_city":        maskCard(pc.BillingCity),
				"billing_state":       maskCard(pc.BillingState),
				"device_id":           pc.DeviceID,
				"mobile_id":           pc.MobileID,
