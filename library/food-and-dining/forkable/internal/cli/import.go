...
but do not stop the import.`,
  ...
  forkable-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  forkable-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | forkable-pp-cli import <resource> --input -`,
