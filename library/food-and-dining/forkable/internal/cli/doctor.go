...
func newDoctorCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `  forkable-pp-cli doctor
  forkable-pp-cli doctor --json
  forkable-pp-cli doctor --fail-on warn
  forkable-pp-cli doctor --fail-on stale`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if cfg != nil {
				...
				if header == "" {
					...
					report["auth_hint"] = "forkable-pp-cli auth login --chrome"
				} else {
					authConfigured = true
					report["auth"] = "configured (browser session)"
					report["auth_source"] = cfg.AuthSource
					report["auth_domain"] = "forkable.com"
				}
			}
			...
			if cfg != nil && cfg.BaseURL != "" {
				...
				if clientErr != nil {
					...
					if authHeader == "" {
						...
						authHeaders["Origin"] = "https://forkable.com"
						authHeaders["Referer"] = "https://forkable.com/mc/"
						authHeaders["User-Agent"] = "forkable-pp-cli"
						verifyPath := "/api/v2/csrf_token"
