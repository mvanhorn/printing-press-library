...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"forkable-pp-cli auth login",
		"forkable-pp-cli doctor",
		"forkable-pp-cli help items",
		"forkable-pp-cli sync",
		"forkable-pp-cli profile list",
		"forkable-pp-cli feedback list",
		"forkable-pp-cli which",
		"forkable-pp-cli agent-context",
		"forkable-pp-cli completion bash",
		"forkable-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"forkable-pp-cli recall",
		"forkable-pp-cli learnings",
		"forkable-pp-cli teach-pattern",
		"forkable-pp-cli teach-lookup",
		"forkable-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("forkable-pp-cli")); err == nil {
