...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/food-and-dining/foodpanda/internal/cliutil/testenv"
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"foodpanda-pp-cli auth login",
		"foodpanda-pp-cli doctor",
		"foodpanda-pp-cli help items",
		"foodpanda-pp-cli sync",
		"foodpanda-pp-cli profile list",
		"foodpanda-pp-cli feedback list",
		"foodpanda-pp-cli which",
		"foodpanda-pp-cli agent-context",
		"foodpanda-pp-cli completion bash",
		"foodpanda-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"foodpanda-pp-cli recall",
		"foodpanda-pp-cli learnings",
		"foodpanda-pp-cli teach-pattern",
		"foodpanda-pp-cli teach-lookup",
		"foodpanda-pp-cli items list",
	}
