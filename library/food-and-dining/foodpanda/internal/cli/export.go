...
large datasets as it has no memory pressure.`,
  ...
  foodpanda-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  foodpanda-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  foodpanda-pp-cli export <resource> --format jsonl | jq '.id'`,
