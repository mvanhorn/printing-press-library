...
func TestAuthErrorHelpers(t *testing.T) {
	...
	// Fixture values use the "your-...-here" synthetic form so the publish
	// secret scanner does not read this redaction test as a real leaked token.
	got := SanitizeErrorBody("token sk-abcdefghi Bearer abc.def key=secretvalue token=your-token-here")
