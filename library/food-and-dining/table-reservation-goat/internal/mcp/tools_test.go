...
func TestMCPPathResolutionMatchesCLIResolverWithHomeEnv(t *testing.T) {
	...
	t.Setenv("TABLE_RESERVATION_GOAT_HOME", root)
...
func TestMCPPathResolutionMatchesCLIResolverWithPlatformDefaults(t *testing.T) {
	...
	if want := filepath.Join(home, ".config", "table-reservation-goat-pp-cli", "config.toml"); cfg.Path != want {
	...
	if want := filepath.Join(home, ".local", "share", "table-reservation-goat-pp-cli", "data.db"); gotDB != want {
...
func resetMCPPathEnv(t *testing.T) string {
	...
	for _, name := range []string{
		"TABLE_RESERVATION_GOAT_CONFIG",
		"TABLE_RESERVATION_GOAT_CONFIG_DIR",
		"TABLE_RESERVATION_GOAT_DATA_DIR",
		"TABLE_RESERVATION_GOAT_STATE_DIR",
		"TABLE_RESERVATION_GOAT_CACHE_DIR",
		"TABLE_RESERVATION_GOAT_HOME",
		"XDG_CONFIG_HOME",
		"XDG_DATA_HOME",
		"XDG_STATE_HOME",
		"XDG_CACHE_HOME",
...
func TestMCPRegisterToolsPreservesTypedSpecialTools(t *testing.T) {
	s := server.NewMCPServer("table-reservation-goat", "test")
	RegisterTools(s)
