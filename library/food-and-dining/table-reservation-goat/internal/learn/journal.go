...
const (
	journalSessionEnvVar   = "TABLE_RESERVATION_GOAT_LEARN_SESSION"
	journalNoLearnEnvVar   = "TABLE_RESERVATION_GOAT_NO_LEARN"
	journalNoCaptureEnvVar = "TABLE_RESERVATION_GOAT_LEARN_NO_CAPTURE"
)
