...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("TABLE_RESERVATION_GOAT_STATE_DIR", "")
	t.Setenv("TABLE_RESERVATION_GOAT_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"table-reservation-goat-pp-cli auth login",
		"table-reservation-goat-pp-cli doctor",
		"table-reservation-goat-pp-cli help items",
		"table-reservation-goat-pp-cli sync",
		"table-reservation-goat-pp-cli profile list",
		"table-reservation-goat-pp-cli feedback list",
		"table-reservation-goat-pp-cli which",
		"table-reservation-goat-pp-cli agent-context",
		"table-reservation-goat-pp-cli completion bash",
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"table-reservation-goat-pp-cli recall",
		"table-reservation-goat-pp-cli learnings",
		"table-reservation-goat-pp-cli teach-pattern",
		"table-reservation-goat-pp-cli teach-lookup",
		"table-reservation-goat-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("table-reservation-goat-pp-cli")); err == nil {
