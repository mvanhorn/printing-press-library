...
Run sync first to populate the local search index.`,
  ...
  table-reservation-goat-pp-cli search "status"

  # Force local search explicitly
  table-reservation-goat-pp-cli search "status" --data-source local
  # Search a specific resource type locally
  table-reservation-goat-pp-cli search "status" --type availability --data-source local
  # JSON output for piping
  table-reservation-goat-pp-cli search "status" --json --limit 20`,
