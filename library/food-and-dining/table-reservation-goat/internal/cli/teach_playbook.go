...
agents can record playbooks without a file on disk.`,
		Example: `  table-reservation-goat-pp-cli teach-playbook \
...
Disabling: pass --no-learn or set ` + noLearnEnvVar + `=true.`,
		Example: `  table-reservation-goat-pp-cli playbook amend \
...
func newPlaybookListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     `  table-reservation-goat-pp-cli playbook list --agent`,
