...
func newFilesUploadCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:       "Upload image files to the canvas",
		Example:     "  excalidraw-mcp-pp-cli files upload",
		Annotations: map[string]string{"pp:endpoint": "files.upload", "pp:method": "POST", "pp:path": "/api/files"},
