...
native streaming instead of polling.`,
  ...
  excalidraw-mcp-pp-cli tail --interval 10s

  # Tail a specific resource
  excalidraw-mcp-pp-cli tail messages --interval 5s

  # Pipe to jq for filtering
  excalidraw-mcp-pp-cli tail events --interval 30s | jq 'select(.type == "error")'`,
