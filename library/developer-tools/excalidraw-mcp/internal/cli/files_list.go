...
func newFilesListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list",
		Short:       "List image files on the canvas",
		Example:     "  excalidraw-mcp-pp-cli files list",
		Annotations: map[string]string{"pp:endpoint": "files.list", "pp:method": "GET", "pp:path": "/api/files", "mcp:read-only": "true"},
