...
but do not stop the import.`,
  ...
  excalidraw-mcp-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  excalidraw-mcp-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | excalidraw-mcp-pp-cli import <resource> --input -`,
