# Ori Printed CLI Agent Guide

This directory is a generated `ori-pp-cli` printed CLI. It was produced by [CLI Printing Press](https://github.com/mvanhorn/cli-printing-press), so treat systemic fixes as upstream Printing Press fixes first. Keep local edits narrow and document why a generated-tree patch belongs here.
...
ori-pp-cli agent-context --pretty
```

Use runtime discovery instead of relying on a copied command list:

```bash
ori-pp-cli which "<capability>" --json
ori-pp-cli <command> --help
```
...
```bash
ori-pp-cli <command> --help
ori-pp-cli <command> --dry-run --agent
```
