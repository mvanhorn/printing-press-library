...
large datasets as it has no memory pressure.`,
  ...
  ori-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  ori-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  ori-pp-cli export <resource> --format jsonl | jq '.id'`,
