...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "awwwards-pp-cli",
		Short: `Query Awwwards jury scores, palettes, and tech stacks from a local SQLite mirror - multi-filter search, trend deltas, and one-shot design briefings the site itself can't do.`,
		Long: `Query Awwwards jury scores, palettes, and tech stacks from a local SQLite mirror - multi-filter search, trend deltas, and one-shot design briefings the site itself can't do.
...
Health check: run 'awwwards-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("awwwards-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'awwwards-pp-cli profile list')")
	...
	rootCmd.AddCommand(newInspectCmd(flags))
	rootCmd.AddCommand(newMirrorCmd(flags))
	rootCmd.AddCommand(newNovelContextPackCmd(flags))
	rootCmd.AddCommand(newNovelElementsTopCmd(flags))
	rootCmd.AddCommand(newNovelPaletteMatchCmd(flags))
	rootCmd.AddCommand(newNovelStudioCmd(flags))
