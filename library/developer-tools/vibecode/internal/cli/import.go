...
but do not stop the import.`,
  ...
  vibecode-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  vibecode-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | vibecode-pp-cli import <resource> --input -`,
