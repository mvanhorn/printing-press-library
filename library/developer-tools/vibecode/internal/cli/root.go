...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "vibecode-pp-cli",
		Short: `Every Vibecode feature, plus offline sync, cross-project search, and deployment drift detection`,
		Long: `Every Vibecode feature, plus offline sync, cross-project search, and deployment drift detection
...
Health check: run 'vibecode-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("vibecode-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'vibecode-pp-cli profile list')")
	...
	rootCmd.AddCommand(newDeploymentAuthCmd(flags))
	rootCmd.AddCommand(newDeploymentDomainCmd(flags))
	rootCmd.AddCommand(newDeploymentLinksCmd(flags))
	rootCmd.AddCommand(newDeploymentSubdomainCmd(flags))
	rootCmd.AddCommand(newDeploymentsCmd(flags))
	rootCmd.AddCommand(newProjectsCmd(flags))
	rootCmd.AddCommand(newSandboxLinksCmd(flags))
	...
	rootCmd.AddCommand(newYoloPromotedCmd(flags))
