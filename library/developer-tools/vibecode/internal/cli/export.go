...
large datasets as it has no memory pressure.`,
  ...
  vibecode-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  vibecode-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  vibecode-pp-cli export <resource> --format jsonl | jq '.id'`,
