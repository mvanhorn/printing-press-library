...
func newProjectsCreateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  vibecode-pp-cli projects create --platform example-value",
	...
	cmd.Flags().StringVar(&bodyPlatform, "platform", "", "Project platform type (webapp, mobile, openclaw)")
	cmd.Flags().StringVar(&bodyDescription, "description", "", "Project description/purpose")
