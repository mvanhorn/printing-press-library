...
func newStylesListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list",
		Short:       "List visual-style pages",
		Example:     "  name-that-ui-pp-cli styles list",
		Annotations: map[string]string{"pp:endpoint": "styles.list", "pp:method": "GET", "pp:path": "/styles", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolveReadWithStrategyResponsePathAndJSONGuard(cmd.Context(), c, flags, "auto", "styles", true, path, params, nil, "", false, cmd.ErrOrStderr())
			if err != nil {
