...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("NAME_THAT_UI_STATE_DIR", "")
	t.Setenv("NAME_THAT_UI_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"name-that-ui-pp-cli auth login",
		"name-that-ui-pp-cli doctor",
		"name-that-ui-pp-cli help items",
		"name-that-ui-pp-cli sync",
		"name-that-ui-pp-cli profile list",
		"name-that-ui-pp-cli feedback list",
		"name-that-ui-pp-cli which",
		"name-that-ui-pp-cli agent-context",
		"name-that-ui-pp-cli completion bash",
		"name-that-ui-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"name-that-ui-pp-cli recall",
		"name-that-ui-pp-cli learnings",
		"name-that-ui-pp-cli teach-pattern",
		"name-that-ui-pp-cli teach-lookup",
		"name-that-ui-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("name-that-ui-pp-cli")); err == nil {
