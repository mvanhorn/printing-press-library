...
// parsing. Shape at v5 removes unimplemented traffic-derived write candidates.
...
func newAgentContextCmd(rootCmd *cobra.Command) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Long: `Outputs a machine-readable description of commands, flags, and public access mode so
...
func buildAgentDiscoveryContext() *agentContextDiscovery {
	return &agentContextDiscovery{
		...
		TargetURL:     "https://namethatui.com/",
		EntryCount:    221,
		APIEntryCount: 17,
