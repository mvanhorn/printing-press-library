...
func Load(configPath string) (*Config, error) {
	...
	if v := os.Getenv("NAME_THAT_UI_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("NAME_THAT_UI_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "name-that-ui-pp-cli", "config.toml"), nil
}
