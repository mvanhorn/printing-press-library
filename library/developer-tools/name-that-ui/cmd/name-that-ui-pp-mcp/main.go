...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/developer-tools/name-that-ui/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("NAME_THAT_UI_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "name-that-ui-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
