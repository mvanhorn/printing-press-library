...
but do not stop the import.`,
  ...
  jsonplaceholder-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  jsonplaceholder-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | jsonplaceholder-pp-cli import <resource> --input -`,
