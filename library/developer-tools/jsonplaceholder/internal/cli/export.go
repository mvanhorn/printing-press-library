...
large datasets as it has no memory pressure.`,
  ...
  jsonplaceholder-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  jsonplaceholder-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  jsonplaceholder-pp-cli export <resource> --format jsonl | jq '.id'`,
