...
func Execute() error {
	...
	rootCmd := &cobra.Command{
		Use:   "jsonplaceholder-pp-cli",
		Short: "Manage jsonplaceholder resources via the jsonplaceholder API",
		Long: `Manage jsonplaceholder resources via the jsonplaceholder API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'jsonplaceholder-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("jsonplaceholder-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'jsonplaceholder-pp-cli profile list')")
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("jsonplaceholder-pp-cli %s\n", version)
		},
	}
}
