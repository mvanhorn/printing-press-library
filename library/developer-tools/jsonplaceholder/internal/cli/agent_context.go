...
func buildAgentDiscoveryContext() *agentContextDiscovery {
	return &agentContextDiscovery{
		...
		CandidateCommands: []string{
			"get_posts — Derived from observed GET /posts/{id} traffic.",
			"get_users — Derived from observed GET /users/{id} traffic.",
			"list_albums — Derived from observed GET /albums traffic.",
			"list_comments — Derived from observed GET /comments traffic.",
			"list_posts — Derived from observed GET /posts traffic.",
			"list_users — Derived from observed GET /users traffic.",
		},
	}
}
