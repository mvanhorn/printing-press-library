...
Exit codes & warnings:
  ...
  cre-owner-pp-cli sync

  # Sync specific resources only
  cre-owner-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  cre-owner-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  cre-owner-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  cre-owner-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  cre-owner-pp-cli sync --latest-only`,
