...
but do not stop the import.`,
  ...
  cre-owner-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  cre-owner-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | cre-owner-pp-cli import <resource> --input -`,
