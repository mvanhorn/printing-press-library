...
large datasets as it has no memory pressure.`,
  ...
  cre-owner-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  cre-owner-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  cre-owner-pp-cli export <resource> --format jsonl | jq '.id'`,
