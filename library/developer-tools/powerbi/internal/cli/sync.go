...
Exit codes & warnings:
  ...
  powerbi-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  powerbi-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  powerbi-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  powerbi-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  powerbi-pp-cli sync --latest-only`,
