...
large datasets as it has no memory pressure.`,
  ...
  powerbi-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  powerbi-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  powerbi-pp-cli export <resource> --format jsonl | jq '.id'`,
