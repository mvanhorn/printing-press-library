...
but do not stop the import.`,
  ...
  powerbi-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  powerbi-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | powerbi-pp-cli import <resource> --input -`,
