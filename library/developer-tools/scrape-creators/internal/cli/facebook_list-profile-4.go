...
func newFacebookListProfile4Cmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list-profile-4",
		Short:       "Fetches up to 10 reels per request from a public Facebook page. Each reel includes id, url, view_count, description,...",
		Example:     "  scrape-creators-pp-cli facebook list-profile-4",
		Annotations: map[string]string{"pp:endpoint": "facebook.list-profile-4", "mcp:read-only": "true"},
