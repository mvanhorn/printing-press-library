...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"scrape-creators-pp-cli auth login",
		"scrape-creators-pp-cli doctor",
		"scrape-creators-pp-cli help items",
		"scrape-creators-pp-cli sync",
		"scrape-creators-pp-cli profile list",
		"scrape-creators-pp-cli feedback list",
		"scrape-creators-pp-cli which",
		"scrape-creators-pp-cli agent-context",
		"scrape-creators-pp-cli completion bash",
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"scrape-creators-pp-cli recall",
		"scrape-creators-pp-cli learnings",
		"scrape-creators-pp-cli teach-pattern",
		"scrape-creators-pp-cli teach-lookup",
		"scrape-creators-pp-cli items list",
	}
