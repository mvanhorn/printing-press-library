...
func newFacebookListGroup2Cmd(flags *rootFlags) *cobra.Command {
	var flagUrl string
	...
	cmd := &cobra.Command{
		...
		Example:     "  scrape-creators-pp-cli facebook list-group-2",
		Annotations: map[string]string{"pp:endpoint": "facebook.list-group-2", "pp:method": "GET", "pp:path": "/v1/facebook/group/posts", "mcp:read-only": "true"},
	...
	cmd.Flags().StringVar(&flagSortBy, "sort-by", "", "How to sort the posts. Defaults to CHRONOLOGICAL. (one of: TOP_POSTS, RECENT_ACTIVITY, CHRONOLOGICAL, CHRONOLOGICAL_LISTINGS)")
