...
func newInstagramListUser5Cmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  scrape-creators-pp-cli instagram list-user-5 --handle example-value",
		Annotations: map[string]string{"pp:endpoint": "instagram.list-user-5", "pp:method": "GET", "pp:path": "/v2/instagram/user/posts", "mcp:read-only": "true"},
