...
const (
	journalSessionEnvVar   = "SCRAPE_CREATORS_LEARN_SESSION"
	journalNoLearnEnvVar   = "SCRAPE_CREATORS_NO_LEARN"
	journalNoCaptureEnvVar = "SCRAPE_CREATORS_LEARN_NO_CAPTURE"
)
