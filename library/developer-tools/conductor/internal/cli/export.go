...
large datasets as it has no memory pressure.`,
  ...
  conductor-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  conductor-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  conductor-pp-cli export <resource> --format jsonl | jq '.id'`,
