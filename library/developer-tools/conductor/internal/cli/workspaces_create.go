...
func newWorkspacesCreateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "create",
		Short:       "Creates a cloud workspace and first session",
		Example:     "  conductor-pp-cli workspaces create",
		Annotations: map[string]string{"pp:endpoint": "workspaces.create", "pp:method": "POST", "pp:path": "/v0/workspaces"},
