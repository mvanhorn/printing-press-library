...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/developer-tools/conductor/internal/cliutil/testenv"
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"conductor-pp-cli auth login",
		"conductor-pp-cli doctor",
		"conductor-pp-cli help items",
		"conductor-pp-cli sync",
		"conductor-pp-cli profile list",
		"conductor-pp-cli feedback list",
		"conductor-pp-cli which",
		"conductor-pp-cli agent-context",
		"conductor-pp-cli completion bash",
		"conductor-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"conductor-pp-cli recall",
		"conductor-pp-cli learnings",
		"conductor-pp-cli teach-pattern",
		"conductor-pp-cli teach-lookup",
		"conductor-pp-cli items list",
	}
