...
var whichIndex = []whichEntry{
	...
	{Command: "run", Description: "Launch, monitor, and collect the final transcript and deep link with explicit timeout rules.", Group: "Bounded agent orchestration", WhyItMatters: "Use this when the caller needs a complete Conductor task receipt, not just a launched workspace."},
	{Command: "plan-implement", Description: "Keep a planner or reviewer session separate from the implementation session in one workspace.", Group: "Bounded agent orchestration", WhyItMatters: "Use this when implementation should start from an explicit plan without mixing planner and coder context."},
	{Command: "daily-report", Description: "Return recent Conductor session rows and mechanical activity totals from transcript search.", Group: "Transcript operations", WhyItMatters: "Use this for a compact, deterministic activity feed that another agent can analyze."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  conductor-pp-cli which "stale tickets"
  conductor-pp-cli which "bottleneck"
  conductor-pp-cli which --limit 1 "send message"
  conductor-pp-cli which                                # list the full capability index`,
