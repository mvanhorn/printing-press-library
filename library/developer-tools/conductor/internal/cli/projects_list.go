...
func newProjectsListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list",
		Short:       "List projects.",
		Example:     "  conductor-pp-cli projects list --limit 20 --agent",
		Annotations: map[string]string{"pp:endpoint": "projects.list", "pp:method": "GET", "pp:path": "/v0/projects", "mcp:read-only": "true"},
