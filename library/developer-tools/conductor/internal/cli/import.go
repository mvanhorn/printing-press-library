...
but do not stop the import.`,
  ...
  conductor-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  conductor-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | conductor-pp-cli import <resource> --input -`,
