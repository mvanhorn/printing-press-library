...
func handleContext(_ context.Context, _ mcplib.CallToolRequest) (*mcplib.CallToolResult, error) {
	ctx := map[string]any{
		"api":         "supabase",
		"description": "Supabase API generated from the OpenAPI specification. Visit [https://supabase.com/docs](https://supabase.",
		...
		"command_mirror_capabilities": []map[string]string{
			...
			{"name": "RLS-aware schema introspection", "command": "pgrst schema", "description": "Fetch the per-project PostgREST OpenAPI from the Management API and list tables, columns, types", "rationale": "", "via": "mcp-command-mirror"},
