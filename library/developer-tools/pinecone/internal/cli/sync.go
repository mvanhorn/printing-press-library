...
Exit codes & warnings:
  ...
  pinecone-pp-cli sync --resources channels,messages
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "indexes_backups", ParentTable: "indexes", ParentIDParam: "index_name", PathTemplate: "/indexes/{index_name}/backups", KeyField: ""},
	}
}
