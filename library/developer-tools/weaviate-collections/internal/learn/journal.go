...
const (
	journalSessionEnvVar   = "WEAVIATE_COLLECTIONS_LEARN_SESSION"
	journalNoLearnEnvVar   = "WEAVIATE_COLLECTIONS_NO_LEARN"
	journalNoCaptureEnvVar = "WEAVIATE_COLLECTIONS_LEARN_NO_CAPTURE"
)
