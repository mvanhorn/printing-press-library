...
func newTenantsCreateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:       "Creates one or more new tenants for a specified collection (`className`).",
		Example:     "  weaviate-collections-pp-cli tenants create example-resource",
		Annotations: map[string]string{"pp:endpoint": "tenants.create", "pp:method": "POST", "pp:path": "/schema/{className}/tenants"},
