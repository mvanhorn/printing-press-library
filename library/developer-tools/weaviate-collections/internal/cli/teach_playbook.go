...
agents can record playbooks without a file on disk.`,
		Example: `  weaviate-collections-pp-cli teach-playbook \
...
Disabling: pass --no-learn or set ` + noLearnEnvVar + `=true.`,
		Example: `  weaviate-collections-pp-cli playbook amend \
...
func newPlaybookListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     `  weaviate-collections-pp-cli playbook list --agent`,
