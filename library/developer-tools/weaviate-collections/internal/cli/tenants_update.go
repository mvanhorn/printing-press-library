...
func newTenantsUpdateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:       "Updates the activity status (e.g., `ACTIVE`, `INACTIVE`, etc.",
		Example:     "  weaviate-collections-pp-cli tenants update example-resource",
		Annotations: map[string]string{"pp:endpoint": "tenants.update", "pp:method": "PUT", "pp:path": "/schema/{className}/tenants"},
