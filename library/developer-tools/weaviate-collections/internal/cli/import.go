...
but do not stop the import.`,
  ...
  weaviate-collections-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  weaviate-collections-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | weaviate-collections-pp-cli import <resource> --input -`,
