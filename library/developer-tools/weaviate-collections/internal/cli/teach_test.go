...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("WEAVIATE_COLLECTIONS_STATE_DIR", "")
	t.Setenv("WEAVIATE_COLLECTIONS_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"weaviate-collections-pp-cli auth login",
		"weaviate-collections-pp-cli doctor",
		"weaviate-collections-pp-cli help items",
		"weaviate-collections-pp-cli sync",
		"weaviate-collections-pp-cli profile list",
		"weaviate-collections-pp-cli feedback list",
		"weaviate-collections-pp-cli which",
		"weaviate-collections-pp-cli agent-context",
		"weaviate-collections-pp-cli completion bash",
		"weaviate-collections-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"weaviate-collections-pp-cli recall",
		"weaviate-collections-pp-cli learnings",
		"weaviate-collections-pp-cli teach-pattern",
		"weaviate-collections-pp-cli teach-lookup",
		"weaviate-collections-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("weaviate-collections-pp-cli")); err == nil {
