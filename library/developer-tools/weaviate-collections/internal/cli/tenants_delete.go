...
func newTenantsDeleteCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "delete <className>",
		Short:       "Deletes one or more specified tenants from a collection (`className`).",
		Example:     "  weaviate-collections-pp-cli tenants delete example-resource",
		Annotations: map[string]string{"pp:endpoint": "tenants.delete", "pp:method": "DELETE", "pp:path": "/schema/{className}/tenants"},
