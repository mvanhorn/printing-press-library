...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  weaviate-collections-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  weaviate-collections-pp-cli workflow archive --full`,
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  weaviate-collections-pp-cli workflow status

  # Show status as JSON
  weaviate-collections-pp-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("weaviate-collections-pp-cli")
			}
