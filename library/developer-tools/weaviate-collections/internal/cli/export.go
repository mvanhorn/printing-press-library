...
large datasets as it has no memory pressure.`,
  ...
  weaviate-collections-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  weaviate-collections-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  weaviate-collections-pp-cli export <resource> --format jsonl | jq '.id'`,
