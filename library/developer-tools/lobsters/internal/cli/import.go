...
but do not stop the import.`,
  ...
  lobsters-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  lobsters-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | lobsters-pp-cli import <resource> --input -`,
