# Lobsters Printed CLI Agent Guide

This directory is a generated `lobsters-pp-cli` printed CLI. It was produced by [CLI Printing Press](https://github.com/mvanhorn/cli-printing-press), so treat systemic fixes as upstream Printing Press fixes first. Keep local edits narrow and document why a generated-tree patch belongs here.
...
lobsters-pp-cli agent-context --pretty
```

Use runtime discovery instead of relying on a copied command list:

```bash
lobsters-pp-cli which "<capability>" --json
lobsters-pp-cli <command> --help
```
...
```bash
lobsters-pp-cli <command> --help
lobsters-pp-cli <command> --dry-run --agent
```
