...
but do not stop the import.`,
  ...
  virustotal-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  virustotal-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | virustotal-pp-cli import <resource> --input -`,
