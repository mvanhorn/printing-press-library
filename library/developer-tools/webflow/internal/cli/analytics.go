...
Data must be synced first with the sync command.`,
  ...
  webflow-pp-cli analytics --type messages

  # Group by a field
  webflow-pp-cli analytics --type messages --group-by author_id

  # Top 10 most frequent values
  webflow-pp-cli analytics --type messages --group-by channel_id --limit 10 --json`,
