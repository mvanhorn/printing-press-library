...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/developer-tools/webflow/internal/learn/lookups"
...
Resource scoping:
  ...
  webflow-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  webflow-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  webflow-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  webflow-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  webflow-pp-cli sync --latest-only`,
...
func determinePaginationDefaults(resource string) paginationDefaults {
	...
	case "components/components_dom":
		return paginationDefaults{
			cursorParam: "offset",
			cursorType:  "offset",
			limitParam:  "limit",
	...
	case "components/components_properties":
		return paginationDefaults{
			cursorParam: "offset",
			cursorType:  "offset",
			limitParam:  "limit",
	...
	case "sites/sites_form_submissions":
		return paginationDefaults{
			cursorParam: "offset",
			cursorType:  "offset",
			limitParam:  "limit",
	...
	case "sites_forms/sites_forms_submissions":
		return paginationDefaults{
			cursorParam: "offset",
			cursorType:  "offset",
			limitParam:  "limit",
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "form-submissions":
		return db.UpsertFormSubmissions(data)
	case "forms":
	...
	case "pages_custom_code":
		return db.UpsertPagesCustomCode(data)
	case "dom":
		return db.UpsertDom(data)
	case "sites":
		return db.UpsertSites(data)
	case "activity_logs":
		return db.UpsertActivityLogs(data)
	case "sites_asset_folders":
		return db.UpsertSitesAssetFolders(data)
	case "sites_assets":
		return db.UpsertSitesAssets(data)
	case "sites_collections":
		return db.UpsertSitesCollections(data)
	case "comments":
		return db.UpsertComments(data)
	case "components":
		return db.UpsertComponents(data)
	case "sites_custom_code":
		return db.UpsertSitesCustomCode(data)
	case "custom_domains":
		return db.UpsertCustomDomains(data)
	case "custom_fonts":
		return db.UpsertCustomFonts(data)
	case "ecommerce":
		return db.UpsertEcommerce(data)
	case "sites_form_submissions":
		return db.UpsertSitesFormSubmissions(data)
	case "sites_forms":
		return db.UpsertSitesForms(data)
	case "integrations":
		return db.UpsertIntegrations(data)
	case "orders":
		return db.UpsertOrders(data)
	case "sites_pages":
		return db.UpsertSitesPages(data)
	case "plan":
	...
	case "redirects":
		return db.UpsertRedirects(data)
	case "registered_scripts":
		return db.UpsertRegisteredScripts(data)
	case "robots_txt":
		return db.UpsertRobotsTxt(data)
	case "sites_webhooks":
		return db.UpsertSitesWebhooks(data)
	case "well_known":
	...
	case "workspaces_sites":
		return db.UpsertWorkspacesSites(data)
	default:
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{ // #nosec G101 -- endpoint paths, not credentials.
		"audit-logs":  "/workspaces/{workspace_id_or_slug}/audit_logs",
		"dom":         "/pages/{page_id}/dom",
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "activity_logs", ParentTable: "sites", ParentIDParam: "site_id", PathTemplate: "/sites/{site_id}/activity_logs", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.site", PathParams: []dependentPathParamDef{
			{Param: "site_id", Field: "id"},
		}},
		{Name: "comments", ParentTable: "sites", ParentIDParam: "site_id", PathTemplate: "/sites/{site_id}/comments", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.site", PathParams: []dependentPathParamDef{
			{Param: "site_id", Field: "id"},
		}},
		{Name: "components", ParentTable: "sites", ParentIDParam: "site_id", PathTemplate: "/sites/{site_id}/components", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.site", PathParams: []dependentPathParamDef{
			{Param: "site_id", Field: "id"},
		}},
		{Name: "custom_fonts", ParentTable: "sites", ParentIDParam: "site_id", PathTemplate: "/sites/{site_id}/custom_fonts", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.site", PathParams: []dependentPathParamDef{
			{Param: "site_id", Field: "id"},
		}},
		{Name: "orders", ParentTable: "sites", ParentIDParam: "site_id", PathTemplate: "/sites/{site_id}/orders", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.site", PathParams: []dependentPathParamDef{
			{Param: "site_id", Field: "id"},
		}},
		{Name: "products", ParentTable: "sites", ParentIDParam: "site_id", PathTemplate: "/sites/{site_id}/products", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "site_id", Field: "id"},
		}},
		{Name: "sites_assets", ParentTable: "sites", ParentIDParam: "site_id", PathTemplate: "/sites/{site_id}/assets", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.site", PathParams: []dependentPathParamDef{
			{Param: "site_id", Field: "id"},
		}},
		{Name: "sites_custom_code", ParentTable: "sites", ParentIDParam: "site_id", PathTemplate: "/sites/{site_id}/custom_code/blocks", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "site_id", Field: "id"},
		}},
		{Name: "sites_form_submissions", ParentTable: "sites", ParentIDParam: "site_id", PathTemplate: "/sites/{site_id}/form_submissions", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.site", PathParams: []dependentPathParamDef{
			{Param: "site_id", Field: "id"},
		}},
		{Name: "sites_forms", ParentTable: "sites", ParentIDParam: "site_id", PathTemplate: "/sites/{site_id}/forms", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.site", PathParams: []dependentPathParamDef{
			{Param: "site_id", Field: "id"},
		}},
		{Name: "sites_pages", ParentTable: "sites", ParentIDParam: "site_id", PathTemplate: "/sites/{site_id}/pages", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.site", PathParams: []dependentPathParamDef{
			{Param: "site_id", Field: "id"},
		}},
		{Name: "comments_replies", ParentTable: "comments", ParentIDParam: "comment_thread_id", PathTemplate: "/sites/{site_id}/comments/{comment_thread_id}/replies", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "site_id", Field: "sites_id"},
			{Param: "comment_thread_id", Field: "id"},
		}},
		{Name: "components_dom", ParentTable: "components", ParentIDParam: "component_id", PathTemplate: "/sites/{site_id}/components/{component_id}/dom", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "site_id", Field: "sites_id"},
			{Param: "component_id", Field: "id"},
		}},
		{Name: "components_properties", ParentTable: "components", ParentIDParam: "component_id", PathTemplate: "/sites/{site_id}/components/{component_id}/properties", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "site_id", Field: "sites_id"},
			{Param: "component_id", Field: "id"},
		}},
		{Name: "sites_forms_submissions", ParentTable: "sites_forms", ParentIDParam: "form_id", PathTemplate: "/sites/{site_id}/forms/{form_id}/submissions", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "site_id", Field: "sites_id"},
			{Param: "form_id", Field: "id"},
		}},
	}
}
...
var reconcileTypedTables = map[string]string{
	...
	"orders":                 "orders",
	"pages":                  "pages",
	"pages_custom_code":      "pages_custom_code",
	"plan":                   "plan",
	"products":               "products",
	"publish":                "publish",
	"redirects":              "redirects",
	...
	"sites":                  "sites",
	"sites_asset_folders":    "sites_asset_folders",
	"sites_assets":           "sites_assets",
	"sites_collections":      "sites_collections",
	"sites_custom_code":      "sites_custom_code",
	"sites_form_submissions": "sites_form_submissions",
	"sites_forms":            "sites_forms",
	"sites_pages":            "sites_pages",
	"sites_webhooks":         "sites_webhooks",
	"submissions":            "submissions",
	"token":                  "token",
	"webhooks":               "webhooks",
	"well_known":             "well_known",
	"workspaces_sites":       "workspaces_sites",
}
...
func responsePathForResource(resource, path string) []string {
	...
	case "asset-folders\x00/asset_folders/{asset_folder_id}":
		return []string{"assets"}
	case "assets\x00/assets/{asset_id}":
		return []string{"variants"}
	case "collections\x00/collections/{collection_id}":
		return []string{"fields"}
	case "sites\x00/sites/{site_id}":
		return []string{"customDomains"}
	case "sites\x00/sites":
		return []string{"sites"}
	}
	return nil
}
