...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("WEBFLOW_STATE_DIR", "")
	t.Setenv("WEBFLOW_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"webflow-pp-cli auth login",
		"webflow-pp-cli doctor",
		"webflow-pp-cli help items",
		"webflow-pp-cli sync",
		"webflow-pp-cli profile list",
		"webflow-pp-cli feedback list",
		"webflow-pp-cli which",
		"webflow-pp-cli agent-context",
		"webflow-pp-cli completion bash",
		"webflow-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"webflow-pp-cli recall",
		"webflow-pp-cli learnings",
		"webflow-pp-cli teach-pattern",
		"webflow-pp-cli teach-lookup",
		"webflow-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("webflow-pp-cli")); err == nil {
