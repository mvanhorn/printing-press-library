...
func newCollectionsItemsPublishCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "publish <collection_id>",
		Short:       "Publish an item or multiple items. Required scope | `cms:write`",
		Example:     "  webflow-pp-cli collections items publish 580e63fc8c9a982ac9b8b745",
		Annotations: map[string]string{"pp:endpoint": "items.publish", "pp:method": "POST", "pp:path": "/collections/{collection_id}/items/publish"},
