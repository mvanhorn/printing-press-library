...
but do not stop the import.`,
  ...
  crates-io-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  crates-io-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | crates-io-pp-cli import <resource> --input -`,
