...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "crates-io-pp-cli",
		Short: "Manage crates-io resources via the crates-io API",
		Long: `Manage crates-io resources via the crates-io API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'crates-io-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("crates-io-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'crates-io-pp-cli profile list')")
...
func (f *rootFlags) newClient() (*client.Client, error) {
	...
	c.DryRun = f.dryRun
	c.NoCache = f.noCache
	c.UserAgent = fmt.Sprintf("crates-io-pp-cli/%s", version)
	return c, nil
}
