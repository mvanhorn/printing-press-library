...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  crates-io-pp-cli which "stale tickets"
  crates-io-pp-cli which "bottleneck"
  crates-io-pp-cli which --limit 1 "send message"
  crates-io-pp-cli which                                # list the full capability index`,
