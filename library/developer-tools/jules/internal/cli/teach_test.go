...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"jules-pp-cli auth login",
		"jules-pp-cli doctor",
		"jules-pp-cli help items",
		"jules-pp-cli sync",
		"jules-pp-cli profile list",
		"jules-pp-cli feedback list",
		"jules-pp-cli which",
		"jules-pp-cli agent-context",
		"jules-pp-cli completion bash",
		"jules-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"jules-pp-cli teach",
		"jules-pp-cli recall",
		"jules-pp-cli learnings",
		"jules-pp-cli teach-pattern",
		"jules-pp-cli teach-lookup",
		"jules-pp-cli items list",
	}
