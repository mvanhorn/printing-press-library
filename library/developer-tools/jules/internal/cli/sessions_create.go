...
func newSessionsCreateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  jules-pp-cli sessions create --prompt example-value",
	...
	cmd.Flags().StringVar(&bodyAutomationMode, "automation-mode", "", "Automation mode")
	cmd.Flags().StringVar(&bodyPrompt, "prompt", "", "Prompt")
	cmd.Flags().BoolVar(&bodyRequirePlanApproval, "require-plan-approval", false, "Require plan approval")
	cmd.Flags().StringVar(&bodySourceContext, "source-context", "", "Source context")
