...
large datasets as it has no memory pressure.`,
  ...
  jules-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  jules-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  jules-pp-cli export <resource> --format jsonl | jq '.id'`,
