...
Resource scoping:
  ...
  jules-pp-cli sync --resources sessions,sources

  # Full resync (ignore previous checkpoint)
  jules-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  jules-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  jules-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  jules-pp-cli sync --latest-only`,
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "activities", ParentTable: "sessions", ParentIDParam: "sessionId", PathTemplate: "/sessions/{sessionId}/activities", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "sessionId", Field: "id"},
		}},
	}
}
