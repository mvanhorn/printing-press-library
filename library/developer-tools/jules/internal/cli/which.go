...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  jules-pp-cli which "stale tickets"
  jules-pp-cli which "bottleneck"
  jules-pp-cli which --limit 1 "send message"
  jules-pp-cli which                                # list the full capability index`,
