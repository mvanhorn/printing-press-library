...
type Config struct {
	...
	DnsmadeeasyApiKey    string          `toml:"api_key"`
	DnsmadeeasyApiSecret string          `toml:"api_secret"`
}
...
func Load(configPath string) (*Config, error) {
	...
	// Env var overrides
	if v := os.Getenv("DNSMADEEASY_API_KEY"); v != "" {
		cfg.DnsmadeeasyApiKey = v
		cfg.markEnvOverride("DnsmadeeasyApiKey")
		cfg.AuthSource = "env:DNSMADEEASY_API_KEY"
		cfg.CredentialSource = "env:DNSMADEEASY_API_KEY"
	}
	if v := os.Getenv("DNSMADEEASY_API_SECRET"); v != "" {
		cfg.DnsmadeeasyApiSecret = v
		cfg.markEnvOverride("DnsmadeeasyApiSecret")
		cfg.AuthSource = "env:DNSMADEEASY_API_SECRET"
		cfg.CredentialSource = "env:DNSMADEEASY_API_SECRET"
	}
	...
	if v := os.Getenv("DNSMADEEASY_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("DNSMADEEASY_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "dnsmadeeasy-pp-cli", "config.toml"), nil
}
...
func (c *Config) AuthHeader() string {
	...
	if c.DnsmadeeasyApiKey != "" {
		return applyAuthFormat("{api_key}", map[string]string{
			"api_key":             c.DnsmadeeasyApiKey,
			"DNSMADEEASY_API_KEY": c.DnsmadeeasyApiKey,
			"token":               c.DnsmadeeasyApiKey,
		})
	}
	if c.DnsmadeeasyApiSecret != "" {
		return applyAuthFormat("{api_key}", map[string]string{
			"api_secret":             c.DnsmadeeasyApiSecret,
			"DNSMADEEASY_API_SECRET": c.DnsmadeeasyApiSecret,
			"token":                  c.DnsmadeeasyApiSecret,
		})
	}
	return ""
}
...
func (c *Config) credentials() *cliutil.Credentials {
	return &cliutil.Credentials{
		...
		DnsmadeeasyApiKey:    c.DnsmadeeasyApiKey,
		DnsmadeeasyApiSecret: c.DnsmadeeasyApiSecret,
	}
}
...
func (c *Config) applyCredentials(creds *cliutil.Credentials) {
	...
	c.DnsmadeeasyApiKey = creds.DnsmadeeasyApiKey
	c.DnsmadeeasyApiSecret = creds.DnsmadeeasyApiSecret
}
...
func (c *Config) SaveCredential(token string) error {
	...
	c.updateFileConfigField("AccessToken")
	c.DnsmadeeasyApiKey = token
	delete(c.envOverrides, "DnsmadeeasyApiKey")
	c.updateFileConfigField("DnsmadeeasyApiKey")
	if err := c.saveCredentialsFirst(); err != nil {
		return err
	}
	return c.save()
...
func (c *Config) ClearTokens() error {
	...
	c.updateFileConfigField("DnsmadeeasyApiKey")
	c.DnsmadeeasyApiSecret = ""
	delete(c.envOverrides, "DnsmadeeasyApiSecret")
	c.updateFileConfigField("DnsmadeeasyApiSecret")
	if c.AgentcookieManagedByExternalStore() {
		c.markAgentcookieManaged()
...
func (c *Config) configForSave() Config {
	out := *c
	if c.fileConfig != nil {
		if c.envOverrides["DnsmadeeasyApiKey"] {
			out.DnsmadeeasyApiKey = c.fileConfig.DnsmadeeasyApiKey
		}
		if c.envOverrides["DnsmadeeasyApiSecret"] {
			out.DnsmadeeasyApiSecret = c.fileConfig.DnsmadeeasyApiSecret
		}
	}
...
func (c *Config) updateFileConfigField(field string) {
	...
	case "DnsmadeeasyApiKey":
		c.fileConfig.DnsmadeeasyApiKey = c.DnsmadeeasyApiKey
	case "DnsmadeeasyApiSecret":
		c.fileConfig.DnsmadeeasyApiSecret = c.DnsmadeeasyApiSecret
	}
}
