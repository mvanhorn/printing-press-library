...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "dnsmadeeasy-pp-cli",
		Short: `Every DNS Made Easy operation, plus a local record store that makes cross-zone search, drift detection, and 'where is this IP used' instant and offline.`,
		Long: `Every DNS Made Easy operation, plus a local record store that makes cross-zone search, drift detection, and 'where is this IP used' instant and offline.
...
See README.md or the bundled SKILL.md for recipes.`,
	...
	rootCmd.SetVersionTemplate("dnsmadeeasy-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'dnsmadeeasy-pp-cli profile list')")
	...
	rootCmd.AddCommand(newNovelSyncRecordsCmd(flags))
	rootCmd.AddCommand(newNovelAcmePurgeCmd(flags))
	rootCmd.AddCommand(newNovelBulkApplyCmd(flags))
	...
	rootCmd.AddCommand(newNovelWhereUsedCmd(flags))
