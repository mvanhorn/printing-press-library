...
but do not stop the import.`,
  ...
  dnsmadeeasy-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  dnsmadeeasy-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | dnsmadeeasy-pp-cli import <resource> --input -`,
