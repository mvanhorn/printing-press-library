...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/developer-tools/buildalert/internal/mcp"
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "buildalert-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
