...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "buildalert-pp-cli",
		Short: `Pull your BuildAlert dashboard offline — every matched planning lead, transaction, and ROI metric queryable via SQL/FTS, JSON-pipeable, and ZAZU-aware.`,
		Long: `Pull your BuildAlert dashboard offline — every matched planning lead, transaction, and ROI metric queryable via SQL/FTS, JSON-pipeable, and ZAZU-aware.
...
Run 'buildalert-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("buildalert-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'buildalert-pp-cli profile list')")
	...
	rootCmd.AddCommand(newLeadsPromotedCmd(flags))
	rootCmd.AddCommand(newLetterTemplatesPromotedCmd(flags))
	rootCmd.AddCommand(newTrackingPromotedCmd(flags))
	rootCmd.AddCommand(newTransactionsPromotedCmd(flags))
	rootCmd.AddCommand(newZazuDiffCmd(flags))
	rootCmd.AddCommand(newPendingLettersCmd(flags))
	rootCmd.AddCommand(newLetterConflictCmd(flags))
	rootCmd.AddCommand(newCoverageCmd(flags))
	rootCmd.AddCommand(newRoiPerLeadCmd(flags))
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("buildalert-pp-cli %s\n", version)
		},
	}
}
