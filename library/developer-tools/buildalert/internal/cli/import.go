...
but do not stop the import.`,
  ...
  buildalert-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  buildalert-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | buildalert-pp-cli import <resource> --input -`,
