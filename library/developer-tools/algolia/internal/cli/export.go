...
large datasets as it has no memory pressure.`,
  ...
  algolia-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  algolia-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  algolia-pp-cli export <resource> --format jsonl | jq '.id'`,
