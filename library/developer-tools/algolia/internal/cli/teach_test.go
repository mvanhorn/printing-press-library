...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"algolia-pp-cli auth login",
		"algolia-pp-cli doctor",
		"algolia-pp-cli help items",
		"algolia-pp-cli sync",
		"algolia-pp-cli profile list",
		"algolia-pp-cli feedback list",
		"algolia-pp-cli which",
		"algolia-pp-cli agent-context",
		"algolia-pp-cli completion bash",
		"algolia-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"algolia-pp-cli recall",
		"algolia-pp-cli learnings",
		"algolia-pp-cli teach-pattern",
		"algolia-pp-cli teach-lookup",
		"algolia-pp-cli items list",
	}
