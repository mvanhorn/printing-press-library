...
but do not stop the import.`,
  ...
  algolia-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  algolia-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | algolia-pp-cli import <resource> --input -`,
