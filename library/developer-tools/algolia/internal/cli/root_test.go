...
func TestDeclaredAPISurfaceReachable(t *testing.T) {
	expected := []string{
		"clusters",
		"clusters assign-user-id",
		"clusters batch-assign-user-ids",
		"clusters get-top-user-ids",
		"clusters get-user-id",
		"clusters has-pending-mappings",
		"clusters list",
		"clusters list-user-ids",
		"clusters remove-user-id",
		"clusters search-user-ids",
		"dictionaries",
		"dictionaries batch",
		"dictionaries batch dictionary-entries",
		"dictionaries get-dictionary-languages",
		"dictionaries get-dictionary-settings",
		"dictionaries search",
		"dictionaries search dictionary-entries",
		"dictionaries set-dictionary-settings",
		"indexes",
		"indexes add-or-update-object",
		"indexes batch",
		"indexes batch batch",
		"indexes browse",
		"indexes browse browse",
		"indexes clear",
		"indexes clear objects",
		"indexes delete-by-query",
		"indexes delete-by-query delete-by",
		"indexes delete-index",
		"indexes delete-object",
		"indexes facets",
		"indexes facets search-for-values",
		"indexes get-object",
		"indexes get-objects",
		"indexes list-indices",
		"indexes multiple-batch",
		"indexes operation",
		"indexes operation index",
		"indexes partial",
		"indexes partial update-object",
		"indexes query",
		"indexes query search-single-index",
		"indexes rules",
		"indexes rules clear",
		"indexes rules delete",
		"indexes rules get",
		"indexes rules save",
		"indexes rules save-indexes",
		"indexes rules search",
		"indexes save-object",
		"indexes search",
		"indexes settings",
		"indexes settings get",
		"indexes settings set",
		"indexes synonyms",
		"indexes synonyms clear",
		"indexes synonyms delete",
		"indexes synonyms get",
		"indexes synonyms save",
		"indexes synonyms save-indexes",
		"indexes synonyms search",
		"indexes task",
		"indexes task get",
		"keys",
		"keys add-api",
		...
		"keys list-api",
		"keys restore",
		"keys restore api-key",
		"keys update-api",
		"logs",
		"security",
		"security append-source",
		"security delete-source",
		"security get-sources",
		"security replace-sources",
		"task",
	}
