...
func newSecurityReplaceSourcesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:       "Replaces the list of allowed sources.",
		Example:     "  algolia-pp-cli security replace-sources",
		Annotations: map[string]string{"pp:endpoint": "security.replace-sources", "pp:method": "PUT", "pp:path": "/1/security/sources"},
