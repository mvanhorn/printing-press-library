...
but do not stop the import.`,
  ...
  alphavantage-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  alphavantage-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | alphavantage-pp-cli import <resource> --input -`,
