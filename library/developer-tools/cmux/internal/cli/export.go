...
large datasets as it has no memory pressure.`,
  ...
  cmux-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  cmux-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  cmux-pp-cli export <resource> --format jsonl | jq '.id'`,
