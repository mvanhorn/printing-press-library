# n8n Printed CLI Agent Guide

This directory is a generated `n8n-pp-cli` printed CLI. It was produced by [CLI Printing Press](https://github.com/mvanhorn/cli-printing-press), so treat systemic fixes as upstream Printing Press fixes first. Keep local edits narrow and document why a generated-tree patch belongs here.
...
```bash
n8n-pp-cli doctor --json
n8n-pp-cli agent-context --pretty
```

Use runtime discovery instead of relying on a copied command list:

```bash
n8n-pp-cli which "<capability>" --json
n8n-pp-cli <command> --help
```
...
```bash
n8n-pp-cli <command> --help
n8n-pp-cli <command> --dry-run --agent
```
