...
large datasets as it has no memory pressure.`,
  ...
  n8n-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  n8n-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  n8n-pp-cli export <resource> --format jsonl | jq '.id'`,
		Args: cobra.MinimumNArgs(1),
		RunE: func(cmd *cobra.Command, args []string) error {
			validResources := map[string]bool{
				"community-packages": true,
				"credentials":        true,
				"data-tables":        true,
				"discover":           true,
				"executions":         true,
