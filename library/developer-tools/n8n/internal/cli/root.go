...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "n8n-pp-cli",
		Short: "Every n8n feature from the terminal — workflow management, execution triage, GitOps sync, multi-instance health, and analytics no other tool ships.",
		Long: `Every n8n feature from the terminal — workflow management, execution triage, GitOps sync, multi-instance health, and analytics no other tool ships.
...
Run 'n8n-pp-cli doctor' to verify auth and connectivity.
Set N8N_API_KEY and N8N_BASE_URL to authenticate (Settings > API > Create an API key).`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("n8n-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'n8n-pp-cli profile list')")
	...
	rootCmd.AddCommand(newCommunityPackagesCmd(flags))
	...
	rootCmd.AddCommand(newSourceControlPromotedCmd(flags))
