...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/developer-tools/n8n/internal/cli"
	"github.com/mvanhorn/printing-press-library/library/developer-tools/n8n/internal/client"
	"github.com/mvanhorn/printing-press-library/library/developer-tools/n8n/internal/cliutil"
	"github.com/mvanhorn/printing-press-library/library/developer-tools/n8n/internal/config"
	"github.com/mvanhorn/printing-press-library/library/developer-tools/n8n/internal/mcp/cobratree"
		...
		if err != nil {
			...
			case strings.Contains(msg, "HTTP 400") && cliutil.LooksLikeAuthError(msg):
				return mcplib.NewToolResultError("authentication error: " + cliutil.SanitizeErrorBody(msg) +
					...
					"\n      Set your API key: export N8N_API_KEY=<your-key>" +
					"\n      See API docs: https://docs.n8n.io/api/" +
					"\n      Run 'n8n-pp-cli doctor' to check auth status."), nil
			case strings.Contains(msg, "HTTP 401"):
				return mcplib.NewToolResultError("authentication failed: " + cliutil.SanitizeErrorBody(msg) +
					"\nhint: check your token." +
					"\n      Set it with: export N8N_API_KEY=<your-key>" +
					"\n      See API docs: https://docs.n8n.io/api/" +
					"\n      Run 'n8n-pp-cli doctor' to check auth status."), nil
...
func newMCPClient() (*client.Client, error) {
	...
	cfgPath := filepath.Join(home, ".config", "n8n-pp-cli", "config.toml")
...
func dbPath() string {
	home, _ := os.UserHomeDir()
	return filepath.Join(home, ".local", "share", "n8n-pp-cli", "data.db")
}
...
func handleContext(_ context.Context, _ mcplib.CallToolRequest) (*mcplib.CallToolResult, error) {
	ctx := map[string]any{
		"api":         "n8n",
		"description": "Every n8n feature from the terminal — workflow management, execution triage, GitOps sync, multi-instance health,...",
		"archetype":   "payments",
		"tool_count":  78,
		// tool_surface tells agents which surface a capability lives on.
		"tool_surface": "MCP exposes typed endpoint tools plus a runtime mirror of user-facing CLI commands. Endpoint tools keep typed schemas; command-mirror tools shell out to the companion n8n-pp-cli binary.",
		"auth": map[string]any{
			"type": "bearer_token",
		...
		"resources": []map[string]any{
			...
			},
			{
				...
				"endpoints":   []string{"create", "delete", "get", "get-id", "get-schema", "update"},
				"syncable":    true,
				"searchable":  true,
			},
			{
			...
			},
			{
				...
				"endpoints":   []string{"create", "delete", "get", "get-id", "list", "update"},
				"syncable":    true,
				"searchable":  true,
			},
		},
