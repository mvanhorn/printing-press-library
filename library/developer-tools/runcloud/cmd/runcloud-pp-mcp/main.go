...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/developer-tools/runcloud/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "runcloud-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
