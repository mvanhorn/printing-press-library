...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "runcloud-pp-cli",
		Short: `Runcloud CLI — Fleet-wide visibility for RunCloud v3 — every SSL cert, PHP version, blocked IP, and SSH key across the whole workspace…`,
		Long: `Runcloud CLI — Fleet-wide visibility for RunCloud v3 — every SSL cert, PHP version, blocked IP, and SSH key across the whole workspace…
...
Health check: run 'runcloud-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("runcloud-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'runcloud-pp-cli profile list')")
	...
	rootCmd.AddCommand(newAgencyClientServersCmd(flags))
	rootCmd.AddCommand(newAgencyClientsCmd(flags))
	rootCmd.AddCommand(newAgencyPackagesCmd(flags))
	rootCmd.AddCommand(newAgencyTeamsCmd(flags))
	rootCmd.AddCommand(newBackupsCmd(flags))
	rootCmd.AddCommand(newCronJobsCmd(flags))
	rootCmd.AddCommand(newDatabaseUsersCmd(flags))
	rootCmd.AddCommand(newDatabasesCmd(flags))
	rootCmd.AddCommand(newDomainsCmd(flags))
	rootCmd.AddCommand(newExternalKeysCmd(flags))
	rootCmd.AddCommand(newFail2banCmd(flags))
	rootCmd.AddCommand(newFirewallCmd(flags))
	rootCmd.AddCommand(newGitCmd(flags))
	rootCmd.AddCommand(newInstallersCmd(flags))
	rootCmd.AddCommand(newServersCmd(flags))
	rootCmd.AddCommand(newServicesCmd(flags))
	rootCmd.AddCommand(newSshKeysCmd(flags))
	rootCmd.AddCommand(newSslCmd(flags))
	rootCmd.AddCommand(newSslAdvancedCmd(flags))
	rootCmd.AddCommand(newStaticCmd(flags))
	rootCmd.AddCommand(newSupervisorCmd(flags))
	rootCmd.AddCommand(newSystemUsersCmd(flags))
	rootCmd.AddCommand(newWebappsCmd(flags))
	...
	rootCmd.AddCommand(newAgencyAccountPromotedCmd(flags))
	rootCmd.AddCommand(newRuncloudhubPromotedCmd(flags))
	rootCmd.AddCommand(newS3StoragePromotedCmd(flags))
	rootCmd.AddCommand(newServerLogsPromotedCmd(flags))
	rootCmd.AddCommand(newWafPromotedCmd(flags))
	rootCmd.AddCommand(newVersionCliCmd())
	// Hand-authored fleet-wide audits and agency workflows. These wrap the
	// generated endpoint commands with cross-resource queries against the
	// local synced store plus a multi-step agency-onboarding chain.
	rootCmd.AddCommand(newFleetCmd(flags))
	rootCmd.AddCommand(newWhoisFleetCmd(flags))
	rootCmd.AddCommand(newAgencyCmd(flags))
