...
but do not stop the import.`,
  ...
  runcloud-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  runcloud-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | runcloud-pp-cli import <resource> --input -`,
