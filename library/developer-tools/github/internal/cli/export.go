...
large datasets as it has no memory pressure.`,
  ...
  github-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  github-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  github-pp-cli export <resource> --format jsonl | jq '.id'`,
