...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  github-pp-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"advisories", "app", "classrooms", "codes-of-conduct", "container", "docker", "emojis", "events", "gists", "gitignore", "installation", "issues", "licenses", "marketplace-listing", "maven", "notifications", "npm", "nuget", "organizations", "repositories", "rubygems", "search", "user", "users", "versions",  }
			totalSynced := 0
