...
but do not stop the import.`,
  ...
  wordpress-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  wordpress-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | wordpress-pp-cli import <resource> --input -`,
