...
type rootFlags struct {
	...
	// invocation. Mirrors the WORDPRESS_NO_LEARN env var.
	noLearn bool
...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "wordpress-pp-cli",
		Short: `Wordpress CLI — WP-CLI-grade control over any WordPress site through plain HTTPS — no SSH, no server-side plugin, one static binary.`,
		Long: `Wordpress CLI — WP-CLI-grade control over any WordPress site through plain HTTPS — no SSH, no server-side plugin, one static binary.
...
Health check: run 'wordpress-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("wordpress-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'wordpress-pp-cli profile list')")
	rootCmd.PersistentFlags().StringVar(&flags.deliverSpec, "deliver", "", "Route output to a sink: stdout (default), file:<path>, webhook:<url>")
	rootCmd.PersistentFlags().Float64Var(&flags.rateLimit, "rate-limit", 0, "Max requests per second (0 to disable)")
	registerWordPressGlobalFlags(rootCmd)
	...
	rootCmd.AddCommand(newAbilitiesCmd(flags))
	rootCmd.AddCommand(newApplicationPasswordsCmd(flags))
	rootCmd.AddCommand(newBlockPatternsCmd(flags))
	rootCmd.AddCommand(newBlockRevisionsCmd(flags))
	rootCmd.AddCommand(newBlockTypesCmd(flags))
	rootCmd.AddCommand(newBlocksCmd(flags))
	rootCmd.AddCommand(newCategoriesCmd(flags))
	rootCmd.AddCommand(newCommentsCmd(flags))
	rootCmd.AddCommand(newFontCollectionsCmd(flags))
	rootCmd.AddCommand(newFontFacesCmd(flags))
	rootCmd.AddCommand(newFontFamiliesCmd(flags))
	rootCmd.AddCommand(newGlobalStylesCmd(flags))
	rootCmd.AddCommand(newGlobalStylesRevisionsCmd(flags))
	rootCmd.AddCommand(newMediaCmd(flags))
	rootCmd.AddCommand(newMenuItemsCmd(flags))
	rootCmd.AddCommand(newMenuLocationsCmd(flags))
	rootCmd.AddCommand(newMenusCmd(flags))
	rootCmd.AddCommand(newNavigationCmd(flags))
	rootCmd.AddCommand(newNavigationRevisionsCmd(flags))
	rootCmd.AddCommand(newOembedCmd(flags))
	rootCmd.AddCommand(newPageRevisionsCmd(flags))
	rootCmd.AddCommand(newPagesCmd(flags))
	rootCmd.AddCommand(newPatternCategoriesCmd(flags))
	rootCmd.AddCommand(newPluginsCmd(flags))
	rootCmd.AddCommand(newPostRevisionsCmd(flags))
	rootCmd.AddCommand(newPostsCmd(flags))
	rootCmd.AddCommand(newSettingsCmd(flags))
	rootCmd.AddCommand(newSidebarsCmd(flags))
	rootCmd.AddCommand(newSiteHealthCmd(flags))
	rootCmd.AddCommand(newStatusesCmd(flags))
	rootCmd.AddCommand(newTagsCmd(flags))
	rootCmd.AddCommand(newTaxonomiesCmd(flags))
	rootCmd.AddCommand(newTemplatePartRevisionsCmd(flags))
	rootCmd.AddCommand(newTemplatePartsCmd(flags))
	rootCmd.AddCommand(newTemplateRevisionsCmd(flags))
	rootCmd.AddCommand(newTemplatesCmd(flags))
	rootCmd.AddCommand(newThemesCmd(flags))
	rootCmd.AddCommand(newUsersCmd(flags))
	rootCmd.AddCommand(newWidgetTypesCmd(flags))
	rootCmd.AddCommand(newWidgetsCmd(flags))
	rootCmd.AddCommand(newWpTypesCmd(flags))
	...
	rootCmd.AddCommand(newNovelCapsCmd(flags))
	rootCmd.AddCommand(newNovelDiagnoseCmd(flags))
	rootCmd.AddCommand(newNovelFleetCmd(flags))
	rootCmd.AddCommand(newNovelOrphansCmd(flags))
	rootCmd.AddCommand(newNovelQueueCmd(flags))
	rootCmd.AddCommand(newNovelSchemaCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newBatchPromotedCmd(flags))
	rootCmd.AddCommand(newBlockDirectoryPromotedCmd(flags))
	rootCmd.AddCommand(newBlockRendererPromotedCmd(flags))
	rootCmd.AddCommand(newBlocksAutosavesPromotedCmd(flags))
	rootCmd.AddCommand(newMenuItemsAutosavesPromotedCmd(flags))
	rootCmd.AddCommand(newNavigationAutosavesPromotedCmd(flags))
	rootCmd.AddCommand(newPagesAutosavesPromotedCmd(flags))
	rootCmd.AddCommand(newPatternDirectoryPromotedCmd(flags))
	rootCmd.AddCommand(newPostsAutosavesPromotedCmd(flags))
	rootCmd.AddCommand(newTemplatePartsAutosavesPromotedCmd(flags))
	rootCmd.AddCommand(newTemplatesAutosavesPromotedCmd(flags))
	rootCmd.AddCommand(newWpSearchPromotedCmd(flags))
