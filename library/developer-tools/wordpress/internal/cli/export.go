...
large datasets as it has no memory pressure.`,
  ...
  wordpress-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  wordpress-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  wordpress-pp-cli export <resource> --format jsonl | jq '.id'`,
