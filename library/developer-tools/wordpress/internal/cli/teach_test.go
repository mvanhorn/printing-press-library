...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("WORDPRESS_STATE_DIR", "")
	t.Setenv("WORDPRESS_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"wordpress-pp-cli auth login",
		"wordpress-pp-cli doctor",
		"wordpress-pp-cli help items",
		"wordpress-pp-cli sync",
		"wordpress-pp-cli profile list",
		"wordpress-pp-cli feedback list",
		"wordpress-pp-cli which",
		"wordpress-pp-cli agent-context",
		"wordpress-pp-cli completion bash",
		"wordpress-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"wordpress-pp-cli recall",
		"wordpress-pp-cli learnings",
		"wordpress-pp-cli teach-pattern",
		"wordpress-pp-cli teach-lookup",
		"wordpress-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("wordpress-pp-cli")); err == nil {
