...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "bls-pp-cli",
		Short: `Fetch U.S. labor and economic time-series from BLS with offline series search, a curated macro snapshot, the release calendar, and footnote decoding.`,
		Long: `Fetch U.S. labor and economic time-series from BLS with offline series search, a curated macro snapshot, the release calendar, and footnote decoding.
...
Health check: run 'bls-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("bls-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'bls-pp-cli profile list')")
	...
	rootCmd.AddCommand(newInflationCmd(flags))
