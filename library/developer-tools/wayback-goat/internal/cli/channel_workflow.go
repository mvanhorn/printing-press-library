...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  wayback-goat-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  wayback-goat-pp-cli workflow archive --full`,
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  wayback-goat-pp-cli workflow status

  # Show status as JSON
  wayback-goat-pp-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("wayback-goat-pp-cli")
			}
