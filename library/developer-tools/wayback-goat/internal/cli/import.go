...
but do not stop the import.`,
  ...
  wayback-goat-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  wayback-goat-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | wayback-goat-pp-cli import <resource> --input -`,
