...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "wayback-goat-pp-cli",
		Short: "Manage wayback-goat resources via the wayback-goat API",
		Long: `Manage wayback-goat resources via the wayback-goat API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'wayback-goat-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("wayback-goat-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'wayback-goat-pp-cli profile list')")
	...
	rootCmd.AddCommand(newCdxPromotedCmd(flags))
	// Hand-written analytic: digest-diff content-change feed over CDX captures.
