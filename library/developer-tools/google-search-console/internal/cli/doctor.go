...
func newDoctorCmd(flags *rootFlags) *cobra.Command {
  ...
  google-search-console-pp-cli doctor --fail-on warn`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if os.Getenv("GOOGLE_SEARCH_CONSOLE_OAUTH2C") != "" {
				authEnvSet = append(authEnvSet, "GOOGLE_SEARCH_CONSOLE_OAUTH2C")
			} else {
				authEnvRequiredMissing = append(authEnvRequiredMissing, "GOOGLE_SEARCH_CONSOLE_OAUTH2C")
			}
			switch {
