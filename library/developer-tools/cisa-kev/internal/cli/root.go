...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "cisa-kev-pp-cli",
		Short: "Manage cisa-kev resources via the cisa-kev API",
		Long: `Manage cisa-kev resources via the cisa-kev API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'cisa-kev-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("cisa-kev-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'cisa-kev-pp-cli profile list')")
	...
	rootCmd.AddCommand(newVulnsCmd(flags))
