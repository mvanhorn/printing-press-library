...
but do not stop the import.`,
  ...
  cisa-kev-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  cisa-kev-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | cisa-kev-pp-cli import <resource> --input -`,
