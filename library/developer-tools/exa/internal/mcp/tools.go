...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/developer-tools/exa/internal/cli"
	"github.com/mvanhorn/printing-press-library/library/developer-tools/exa/internal/client"
	"github.com/mvanhorn/printing-press-library/library/developer-tools/exa/internal/cliutil"
	"github.com/mvanhorn/printing-press-library/library/developer-tools/exa/internal/config"
	"github.com/mvanhorn/printing-press-library/library/developer-tools/exa/internal/mcp/cobratree"
		...
		if err != nil {
			...
			case strings.Contains(msg, "HTTP 400") && cliutil.LooksLikeAuthError(msg):
				return mcplib.NewToolResultError("authentication error: " + cliutil.SanitizeErrorBody(msg) +
					...
					"\n      Set your API key: export EXA_TOKEN=<your-key>" +
					"\n      Run 'exa-pp-cli doctor' to check auth status."), nil
			case strings.Contains(msg, "HTTP 401"):
				return mcplib.NewToolResultError("authentication failed: " + cliutil.SanitizeErrorBody(msg) +
					"\nhint: check your token." +
					"\n      Set it with: export EXA_TOKEN=<your-key>" +
					"\n      Run 'exa-pp-cli doctor' to check auth status."), nil
...
func newMCPClient() (*client.Client, error) {
	...
	cfgPath := filepath.Join(home, ".config", "exa-pp-cli", "config.toml")
...
func dbPath() string {
	home, _ := os.UserHomeDir()
	return filepath.Join(home, ".local", "share", "exa-pp-cli", "data.db")
}
...
func handleContext(_ context.Context, _ mcplib.CallToolRequest) (*mcplib.CallToolResult, error) {
	ctx := map[string]any{
		...
		"resources": []map[string]any{
			...
			{
				"name":        "neural_search",
				"description": "Manage neural search",
