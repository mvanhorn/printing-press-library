...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "exa-pp-cli",
		Short: "Manage exa resources via the exa API",
		Long: `Manage exa resources via the exa API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'exa-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'exa-pp-cli profile list')")
	...
	rootCmd.AddCommand(newNeuralSearchPromotedCmd(flags))
