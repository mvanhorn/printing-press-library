...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "attempts", ParentTable: "webhooks", ParentIDParam: "id", PathTemplate: "/v0/webhooks/{id}/attempts", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "items", ParentTable: "websets", ParentIDParam: "webset", PathTemplate: "/v0/websets/{webset}/items", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "webset", Field: "webset"},
		}},
		{Name: "runs", ParentTable: "monitors", ParentIDParam: "id", PathTemplate: "/monitors/{id}/runs", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
	}
}
