...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "apptweak-pp-cli",
		Short: `Apptweak CLI — Every AppTweak endpoint in a local-first CLI — keyword rank fan-outs, competitor metadata diffs, and review mining that…`,
		Long: `Apptweak CLI — Every AppTweak endpoint in a local-first CLI — keyword rank fan-outs, competitor metadata diffs, and review mining that…
...
Health check: run 'apptweak-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("apptweak-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'apptweak-pp-cli profile list')")
	...
	rootCmd.AddCommand(newChartsCmd(flags))
	rootCmd.AddCommand(newKeywordsCmd(flags))
	rootCmd.AddCommand(newUtilsCmd(flags))
