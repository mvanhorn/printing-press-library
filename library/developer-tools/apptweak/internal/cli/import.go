...
but do not stop the import.`,
  ...
  apptweak-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  apptweak-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | apptweak-pp-cli import <resource> --input -`,
