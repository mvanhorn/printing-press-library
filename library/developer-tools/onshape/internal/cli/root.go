...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "onshape-pp-cli",
		Short: "Onshape CLI with document search, part inspection, assembly browsing, geometry export, and offline sync",
		Long: `Onshape CLI with document search, part inspection, assembly browsing, geometry export, and offline sync.

Browse and export Onshape documents, parts, assemblies, and versions from the terminal.
Sync locally for offline search and analytics.
...
Run 'onshape-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("onshape-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'onshape-pp-cli profile list')")
	...
	rootCmd.AddCommand(newAssembliesCmd(flags))
	...
	rootCmd.AddCommand(newElementsPromotedCmd(flags))
