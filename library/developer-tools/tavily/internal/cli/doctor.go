...
func newDoctorCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `  tavily-pp-cli doctor
  tavily-pp-cli doctor --json
  tavily-pp-cli doctor --fail-on warn`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if cfg != nil {
				...
				if header == "" {
					...
					report["auth_hint"] = "export TAVILY_API_KEY=<your-key>"
					report["auth_key_url"] = "https://app.tavily.com"
				} else {
					authConfigured = true
			...
			if os.Getenv("TAVILY_API_KEY") != "" {
				authEnvSet = append(authEnvSet, "TAVILY_API_KEY")
				...
				authEnvRequiredMissing = append(authEnvRequiredMissing, "TAVILY_API_KEY")
			}
			switch {
