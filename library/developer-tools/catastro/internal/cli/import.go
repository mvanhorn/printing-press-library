...
but do not stop the import.`,
  ...
  catastro-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  catastro-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | catastro-pp-cli import <resource> --input -`,
