...
but do not stop the import.`,
  ...
  dbt-cloud-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  dbt-cloud-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | dbt-cloud-pp-cli import <resource> --input -`,
