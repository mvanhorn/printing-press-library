...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/developer-tools/dbt-cloud/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "dbt-cloud-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
