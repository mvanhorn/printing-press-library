...
Resource scoping:
  ...
  stac-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  stac-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  stac-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  stac-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  stac-pp-cli sync --latest-only`,
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "collections_items", ParentTable: "collections", ParentIDParam: "collectionId", PathTemplate: "/collections/{collectionId}/items", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "collectionId", Field: "id"},
		}},
	}
}
