...
func newOperatorsFlightsGetOperatorArrivedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  flight-goat-pp-cli operators flights get-operator-arrived UAL",
		Annotations: map[string]string{"pp:endpoint": "flights.get-operator-arrived", "pp:method": "GET", "pp:path": "/operators/{id}/flights/arrivals", "mcp:read-only": "true"},
