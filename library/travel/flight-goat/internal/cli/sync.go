...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/travel/flight-goat/internal/learn/lookups"
...
func determinePaginationDefaults(resource string) paginationDefaults {
	...
	case "airports/airports_flights":
		return paginationDefaults{
			cursorParam: "cursor",
			cursorType:  "cursor",
			limitParam:  "limit",
	...
	case "operators/operators_flights":
		return paginationDefaults{
			cursorParam: "cursor",
			cursorType:  "cursor",
			limitParam:  "limit",
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "airports_canonical":
		return db.UpsertAirportsCanonical(data)
	case "delays":
		return db.UpsertDelays(data)
	case "airports_flights":
		return db.UpsertAirportsFlights(data)
	case "nearby":
	...
	case "flights_canonical":
		return db.UpsertFlightsCanonical(data)
	case "intents":
	...
	case "operators_canonical":
		return db.UpsertOperatorsCanonical(data)
	case "operators_flights":
		return db.UpsertOperatorsFlights(data)
	case "schedules":
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{ // #nosec G101 -- endpoint paths, not credentials.
		"airports":                 "/airports",
		"airports-delays":          "/airports/delays",
		"airports-nearby":          "/airports/nearby",
		"alerts":                   "/alerts",
		"flights":                  "/flights/search/count",
		"flights-search-advanced":  "/flights/search/advanced",
		"flights-search-positions": "/flights/search/positions",
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "airports_flights", ParentTable: "airports", ParentIDParam: "id", PathTemplate: "/airports/{id}/flights", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.airport", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "code"},
		}},
		{Name: "airports_flights", ParentTable: "airports", ParentIDParam: "id", PathTemplate: "/airports/{id}/flights/arrivals", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.airport", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "code"},
		}},
		{Name: "airports_flights", ParentTable: "airports", ParentIDParam: "id", PathTemplate: "/airports/{id}/flights/departures", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.airport", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "code"},
		}},
		{Name: "airports_flights", ParentTable: "airports", ParentIDParam: "id", PathTemplate: "/airports/{id}/flights/scheduled_arrivals", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.airport", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "code"},
		}},
		{Name: "airports_flights", ParentTable: "airports", ParentIDParam: "id", PathTemplate: "/airports/{id}/flights/scheduled_departures", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.airport", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "code"},
		}},
		{Name: "operators_flights", ParentTable: "operators", ParentIDParam: "id", PathTemplate: "/operators/{id}/flights", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.operator", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "code"},
		}},
		{Name: "operators_flights", ParentTable: "operators", ParentIDParam: "id", PathTemplate: "/operators/{id}/flights/arrivals", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.operator", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "code"},
		}},
		{Name: "operators_flights", ParentTable: "operators", ParentIDParam: "id", PathTemplate: "/operators/{id}/flights/enroute", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.operator", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "code"},
		}},
		{Name: "operators_flights", ParentTable: "operators", ParentIDParam: "id", PathTemplate: "/operators/{id}/flights/scheduled", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.operator", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "code"},
		}},
		{Name: "weather", ParentTable: "airports", ParentIDParam: "id", PathTemplate: "/airports/{id}/weather/observations", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.airport", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "code"},
		}},
	}
}
...
func responsePathForResource(resource, path string) []string {
	...
	case "airports\x00/airports":
		return []string{"airports"}
	case "airports\x00/airports/delays":
		return []string{"delays"}
	case "airports\x00/airports/nearby":
		return []string{"airports"}
	case "alerts\x00/alerts":
		return []string{"alerts"}
	case "disruption-counts\x00/disruption_counts/{entity_type}":
		return []string{"entities"}
	case "flights\x00/flights/{ident}":
		return []string{"flights"}
	case "flights\x00/flights/search/advanced":
		return []string{"flights"}
	case "flights\x00/flights/search/positions":
		return []string{"positions"}
	case "flights\x00/flights/search":
		return []string{"flights"}
	case "foresight\x00/foresight/flights/{ident}":
		return []string{"flights"}
	case "foresight\x00/foresight/flights/search/advanced":
		return []string{"flights"}
	case "history\x00/history/aircraft/{registration}/last_flight":
		return []string{"flights"}
	case "history\x00/history/flights/{ident}":
		return []string{"flights"}
	case "history\x00/history/flights/{id}/route":
		return []string{"fixes"}
	case "history\x00/history/flights/{id}/track":
		return []string{"positions"}
	case "operators\x00/operators":
		return []string{"operators"}
	case "schedules\x00/schedules/{date_start}/{date_end}":
