...
func newAirportsGetAllCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-all",
		Aliases:     []string{"list"},
		Short:       "Returns the ICAO identifiers of all known airports.",
		Example:     "  flight-goat-pp-cli airports get-all",
		Annotations: map[string]string{"pp:endpoint": "airports.get-all", "pp:method": "GET", "pp:path": "/airports", "mcp:read-only": "true"},
