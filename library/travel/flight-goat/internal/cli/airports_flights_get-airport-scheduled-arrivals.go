...
func newAirportsFlightsGetAirportScheduledArrivalsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  flight-goat-pp-cli airports flights get-airport-scheduled-arrivals IAH",
		Annotations: map[string]string{"pp:endpoint": "flights.get-airport-scheduled-arrivals", "pp:method": "GET", "pp:path": "/airports/{id}/flights/scheduled_arrivals", "mcp:read-only": "true"},
