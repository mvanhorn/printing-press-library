...
func newFlightsGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  flight-goat-pp-cli flights get UAL1234-1234567890-airline-0123",
		Annotations: map[string]string{"pp:endpoint": "flights.get", "pp:method": "GET", "pp:path": "/flights/{ident}", "mcp:read-only": "true"},
