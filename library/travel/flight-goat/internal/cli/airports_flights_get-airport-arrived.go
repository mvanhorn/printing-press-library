...
func newAirportsFlightsGetAirportArrivedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:       "Returns flights that have arrived at an airport, orderd by `actual_on` descending.",
		Example:     "  flight-goat-pp-cli airports flights get-airport-arrived IAH",
		Annotations: map[string]string{"pp:endpoint": "flights.get-airport-arrived", "pp:method": "GET", "pp:path": "/airports/{id}/flights/arrivals", "mcp:read-only": "true"},
