...
func newHistoryGetFlightCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:       "Returns historical flight info status summary for a registration, ident, or fa_flight_id.",
		Example:     "  flight-goat-pp-cli history get-flight UAL1234-1234567890-airline-0123",
		Annotations: map[string]string{"pp:endpoint": "history.get-flight", "pp:method": "GET", "pp:path": "/history/flights/{ident}", "mcp:read-only": "true"},
