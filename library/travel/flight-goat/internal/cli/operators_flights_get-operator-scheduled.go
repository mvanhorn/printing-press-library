...
func newOperatorsFlightsGetOperatorScheduledCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:       "Returns flights for this operator that are scheduled to depart or have recently been cancelled",
		Example:     "  flight-goat-pp-cli operators flights get-operator-scheduled UAL",
		Annotations: map[string]string{"pp:endpoint": "flights.get-operator-scheduled", "pp:method": "GET", "pp:path": "/operators/{id}/flights/scheduled", "mcp:read-only": "true"},
