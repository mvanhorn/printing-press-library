...
func newAirportsGetDelaysForAllCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:       "Returns a list of airports with delays.",
		Example:     "  flight-goat-pp-cli airports get-delays-for-all",
		Annotations: map[string]string{"pp:endpoint": "airports.get-delays-for-all", "pp:method": "GET", "pp:path": "/airports/delays", "mcp:read-only": "true"},
