...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("FLIGHT_GOAT_STATE_DIR", "")
	t.Setenv("FLIGHT_GOAT_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"flight-goat-pp-cli auth login",
		"flight-goat-pp-cli doctor",
		"flight-goat-pp-cli help items",
		"flight-goat-pp-cli sync",
		"flight-goat-pp-cli profile list",
		"flight-goat-pp-cli feedback list",
		"flight-goat-pp-cli which",
		"flight-goat-pp-cli agent-context",
		"flight-goat-pp-cli completion bash",
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"flight-goat-pp-cli recall",
		"flight-goat-pp-cli learnings",
		"flight-goat-pp-cli teach-pattern",
		"flight-goat-pp-cli teach-lookup",
		"flight-goat-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("flight-goat-pp-cli")); err == nil {
