...
func newOperatorsFlightsGetOperatorEnrouteCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:       "Returns flights for this operator that have departed and are currently en route, ordered by `estimated_on` ascending.",
		Example:     "  flight-goat-pp-cli operators flights get-operator-enroute UAL",
		Annotations: map[string]string{"pp:endpoint": "flights.get-operator-enroute", "pp:method": "GET", "pp:path": "/operators/{id}/flights/enroute", "mcp:read-only": "true"},
