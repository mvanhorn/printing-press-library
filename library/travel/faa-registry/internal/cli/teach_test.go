...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("FAA_REGISTRY_STATE_DIR", "")
	t.Setenv("FAA_REGISTRY_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"faa-registry-pp-cli auth login",
		"faa-registry-pp-cli doctor",
		"faa-registry-pp-cli help items",
		"faa-registry-pp-cli sync",
		"faa-registry-pp-cli profile list",
		"faa-registry-pp-cli feedback list",
		"faa-registry-pp-cli which",
		"faa-registry-pp-cli agent-context",
		"faa-registry-pp-cli completion bash",
		"faa-registry-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"faa-registry-pp-cli recall",
		"faa-registry-pp-cli learnings",
		"faa-registry-pp-cli teach-pattern",
		"faa-registry-pp-cli teach-lookup",
		"faa-registry-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("faa-registry-pp-cli")); err == nil {
