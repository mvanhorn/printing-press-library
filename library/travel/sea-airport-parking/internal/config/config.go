...
func Load(configPath string) (*Config, error) {
	cfg := &Config{
		BaseURL: "https://reservesea.portseattle.org",
	}
	...
	if v := os.Getenv("SEA_AIRPORT_PARKING_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("SEA_AIRPORT_PARKING_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "sea-airport-parking-pp-cli", "config.toml"), nil
}
