...
agents can record playbooks without a file on disk.`,
		Example: `  sea-airport-parking-pp-cli teach-playbook \
...
Disabling: pass --no-learn or set ` + noLearnEnvVar + `=true.`,
		Example: `  sea-airport-parking-pp-cli playbook amend \
...
func newPlaybookListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     `  sea-airport-parking-pp-cli playbook list --agent`,
