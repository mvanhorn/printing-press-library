...
var whichIndex = []whichEntry{
	{Command: "sweep", Description: "Search a flexible date window for the cheapest or any-available Reserved stay.", Group: "Ranging over dates", WhyItMatters: "Reach for this when the trip dates are soft and the agent needs the single best-priced open option."},
	{Command: "watch", Description: "Poll a sold-out or target date range until Reserved opens up (or drops below a price), then notify.", Group: "Ranging over dates", WhyItMatters: "Reach for this when a peak-date range is sold out and the user must grab a space the instant it frees up."},
	{Command: "history", Description: "List every recorded quote snapshot for a date range: price, availability, promo, captured time.", Group: "Ranging over time", WhyItMatters: "Reach for this when the agent needs the raw recorded time series for a range before reasoning about it."},
	{Command: "drift", Description: "Summarize how a range's price and availability moved across stored snapshots: first vs latest, min/max, sold-out flips.", Group: "Ranging over time", WhyItMatters: "Reach for this to tell whether today's price for a range is high or low relative to its own history."},
	{Command: "calendar", Description: "Render price and open/sold-out across many entry days for a fixed-length stay.", Group: "Ranging over dates", WhyItMatters: "Reach for this to eyeball which entry days in a month are open and how price varies day to day."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  sea-airport-parking-pp-cli which "stale tickets"
  sea-airport-parking-pp-cli which "bottleneck"
  sea-airport-parking-pp-cli which --limit 1 "send message"
  sea-airport-parking-pp-cli which                                # list the full capability index`,
