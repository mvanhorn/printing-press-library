...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("SEA_AIRPORT_PARKING_STATE_DIR", "")
	t.Setenv("SEA_AIRPORT_PARKING_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"sea-airport-parking-pp-cli auth login",
		"sea-airport-parking-pp-cli doctor",
		"sea-airport-parking-pp-cli help items",
		"sea-airport-parking-pp-cli sync",
		"sea-airport-parking-pp-cli profile list",
		"sea-airport-parking-pp-cli feedback list",
		"sea-airport-parking-pp-cli which",
		"sea-airport-parking-pp-cli agent-context",
		"sea-airport-parking-pp-cli completion bash",
		"sea-airport-parking-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"sea-airport-parking-pp-cli recall",
		"sea-airport-parking-pp-cli learnings",
		"sea-airport-parking-pp-cli teach-pattern",
		"sea-airport-parking-pp-cli teach-lookup",
		"sea-airport-parking-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("sea-airport-parking-pp-cli")); err == nil {
