...
func TestMCPPathResolutionMatchesCLIResolverWithHomeEnv(t *testing.T) {
	...
	t.Setenv("SEA_AIRPORT_PARKING_HOME", root)
...
func TestMCPPathResolutionMatchesCLIResolverWithPlatformDefaults(t *testing.T) {
	...
	if want := filepath.Join(home, ".config", "sea-airport-parking-pp-cli", "config.toml"); cfg.Path != want {
	...
	if want := filepath.Join(home, ".local", "share", "sea-airport-parking-pp-cli", "data.db"); gotDB != want {
...
func resetMCPPathEnv(t *testing.T) string {
	...
	for _, name := range []string{
		"SEA_AIRPORT_PARKING_CONFIG",
		"SEA_AIRPORT_PARKING_CONFIG_DIR",
		"SEA_AIRPORT_PARKING_DATA_DIR",
		"SEA_AIRPORT_PARKING_STATE_DIR",
		"SEA_AIRPORT_PARKING_CACHE_DIR",
		"SEA_AIRPORT_PARKING_HOME",
		"XDG_CONFIG_HOME",
		"XDG_DATA_HOME",
		"XDG_STATE_HOME",
		"XDG_CACHE_HOME",
...
func TestMCPRegisterToolsPreservesTypedSpecialTools(t *testing.T) {
	s := server.NewMCPServer("sea-airport-parking", "test")
	RegisterTools(s)
