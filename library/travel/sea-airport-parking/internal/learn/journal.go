...
const (
	journalSessionEnvVar   = "SEA_AIRPORT_PARKING_LEARN_SESSION"
	journalNoLearnEnvVar   = "SEA_AIRPORT_PARKING_NO_LEARN"
	journalNoCaptureEnvVar = "SEA_AIRPORT_PARKING_LEARN_NO_CAPTURE"
)
