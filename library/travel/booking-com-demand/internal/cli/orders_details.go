...
func newOrdersDetailsCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "details",
		Short:       "This endpoint returns basic information for orders filtered according to the input.",
		Example:     "  booking-com-demand-pp-cli orders details",
		Annotations: map[string]string{"pp:endpoint": "orders.details", "pp:method": "POST", "pp:path": "/orders/details"},
