...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "booking-com-demand-pp-cli",
		Short: `Booking Com Demand CLI — Every Booking.com Demand API feature, plus offline search, price drift detection, and review-based property ranking tha…`,
		Long: `Booking Com Demand CLI — Every Booking.com Demand API feature, plus offline search, price drift detection, and review-based property ranking tha…
...
Health check: run 'booking-com-demand-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("booking-com-demand-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'booking-com-demand-pp-cli profile list')")
	...
	rootCmd.AddCommand(newAccommodationsCmd(flags))
	rootCmd.AddCommand(newCarsCmd(flags))
	rootCmd.AddCommand(newCommonCmd(flags))
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("booking-com-demand-pp-cli %s\n", version)
		},
	}
}
