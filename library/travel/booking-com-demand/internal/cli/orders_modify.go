...
func newOrdersModifyCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "modify",
		Short:       "Use this endpoint to modify certain aspects of an accommodation order, such as credit card details, checkin/checkout...",
		Example:     "  booking-com-demand-pp-cli orders modify",
		Annotations: map[string]string{"pp:endpoint": "orders.modify", "pp:method": "POST", "pp:path": "/orders/modify"},
