...
func newOrdersDetailsFlightsCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "details-flights",
		Short:       "Use this endpoint to retrieve detailed information for one or more flight orders. - You can request car order...",
		Example:     "  booking-com-demand-pp-cli orders details-flights",
		Annotations: map[string]string{"pp:endpoint": "orders.details-flights", "pp:method": "POST", "pp:path": "/orders/details/flights"},
