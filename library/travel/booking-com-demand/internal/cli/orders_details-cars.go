...
func newOrdersDetailsCarsCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "details-cars",
		Short:       "This endpoint returns car order details, sorted by `bookingDate` in descending order",
		Example:     "  booking-com-demand-pp-cli orders details-cars",
		Annotations: map[string]string{"pp:endpoint": "orders.details-cars", "pp:method": "POST", "pp:path": "/orders/details/cars"},
