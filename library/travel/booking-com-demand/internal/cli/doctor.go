...
func newDoctorCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `  booking-com-demand-pp-cli doctor
  booking-com-demand-pp-cli doctor --json
  booking-com-demand-pp-cli doctor --fail-on warn`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if cfg != nil {
				...
				if header == "" {
					...
					report["auth_hint"] = "export BOOKING_COM_DEMAND_BEARER_AUTH=<your-key>"
				} else {
					authConfigured = true
			...
			if os.Getenv("BOOKING_COM_DEMAND_BEARER_AUTH") != "" {
				authEnvSet = append(authEnvSet, "BOOKING_COM_DEMAND_BEARER_AUTH")
				...
				authEnvRequiredMissing = append(authEnvRequiredMissing, "BOOKING_COM_DEMAND_BEARER_AUTH")
			}
			switch {
