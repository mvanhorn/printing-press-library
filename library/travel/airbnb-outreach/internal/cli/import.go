...
but do not stop the import.`,
  ...
  airbnb-outreach-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  airbnb-outreach-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | airbnb-outreach-pp-cli import <resource> --input -`,
