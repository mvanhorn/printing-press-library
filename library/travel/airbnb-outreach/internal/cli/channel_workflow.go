...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  airbnb-outreach-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  airbnb-outreach-pp-cli workflow archive --full`,
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  airbnb-outreach-pp-cli workflow status

  # Show status as JSON
  airbnb-outreach-pp-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("airbnb-outreach-pp-cli")
			}
