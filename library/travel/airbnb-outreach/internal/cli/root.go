...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		...
		Short: `Airbnb CLI — Script Airbnb's real logged-in surface — search stays, contact hosts with templated messages and photos, and keep an of…`,
		Long: `Airbnb CLI — Script Airbnb's real logged-in surface — search stays, contact hosts with templated messages and photos, and keep an of…
...
Health check: run 'airbnb-outreach-pp-cli doctor' to verify auth and connectivity.
