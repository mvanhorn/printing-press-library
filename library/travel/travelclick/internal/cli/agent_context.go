...
func buildAgentDiscoveryContext() *agentContextDiscovery {
	return &agentContextDiscovery{
		...
		TargetURL:     "https://api.travelclick.com/ibe-shop/v1/hotel/102306/avail",
		EntryCount:    5,
		APIEntryCount: 5,
		...
		CandidateCommands: []string{
			"create_multi_room — Derived from observed POST /ibe-shop/v1/hotel/{hotel_id}/basicavail/multi-room traffic.",
			"get_TEST123 — Derived from observed GET /ibe-codes/v1/hotel/{hotel_id}/specialcodes/corporate/TEST123 traffic.",
			"get_avail — Derived from observed GET /ibe-shop/v1/hotel/{hotel_id}/avail traffic.",
			"get_info — Derived from observed GET /ibe-entity/v1/hotel/{hotel_id}/info traffic.",
		},
	}
}
