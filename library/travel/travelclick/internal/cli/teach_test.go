...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"travelclick-pp-cli auth login",
		"travelclick-pp-cli doctor",
		"travelclick-pp-cli help items",
		"travelclick-pp-cli sync",
		"travelclick-pp-cli profile list",
		"travelclick-pp-cli feedback list",
		"travelclick-pp-cli which",
		"travelclick-pp-cli agent-context",
		"travelclick-pp-cli completion bash",
		"travelclick-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"travelclick-pp-cli recall",
		"travelclick-pp-cli learnings",
		"travelclick-pp-cli teach-pattern",
		"travelclick-pp-cli teach-lookup",
		"travelclick-pp-cli items list",
	}
