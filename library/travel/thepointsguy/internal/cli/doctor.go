...
func newDoctorCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `  thepointsguy-pp-cli doctor
  thepointsguy-pp-cli doctor --json
  thepointsguy-pp-cli doctor --fail-on warn
  thepointsguy-pp-cli doctor --fail-on stale`,
			...
			if cfg != nil && cfg.BaseURL != "" {
				...
				if clientErr != nil {
					...
					if authHeader == "" {
						...
						if suggestion != "" {
							report["credentials"] = fmt.Sprintf("present, not verified. Run `%s %s` to confirm the token works end-to-end.", "thepointsguy-pp-cli", suggestion)
						} else {
