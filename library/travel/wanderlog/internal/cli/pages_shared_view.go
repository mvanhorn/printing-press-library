...
func newPagesSharedViewCmd(flags *rootFlags) *cobra.Command {

	cmd := &cobra.Command{
		Use:         "shared-view <view_key> <slug>",
		Short:       "Fetch a public shared itinerary page",
		Example:     "  wanderlog-pp-cli pages shared-view your-token-here example-value",
		Annotations: map[string]string{"pp:endpoint": "pages.shared_view", "pp:method": "GET", "pp:path": "/view/{view_key}/{slug}/shared", "mcp:read-only": "true"},
