...
func Load(configPath string) (*Config, error) {
	cfg := &Config{
		BaseURL: "https://www.doyouspain.com",
	}
	...
	if v := os.Getenv("RENTALCARSPAIN_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("RENTALCARSPAIN_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "rentalcarspain-pp-cli", "config.toml"), nil
}
