...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("RENTALCARSPAIN_STATE_DIR", "")
	t.Setenv("RENTALCARSPAIN_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"rentalcarspain-pp-cli auth login",
		"rentalcarspain-pp-cli doctor",
		"rentalcarspain-pp-cli help items",
		"rentalcarspain-pp-cli sync",
		"rentalcarspain-pp-cli profile list",
		"rentalcarspain-pp-cli feedback list",
		"rentalcarspain-pp-cli which",
		"rentalcarspain-pp-cli agent-context",
		"rentalcarspain-pp-cli completion bash",
		"rentalcarspain-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"rentalcarspain-pp-cli recall",
		"rentalcarspain-pp-cli learnings",
		"rentalcarspain-pp-cli teach-pattern",
		"rentalcarspain-pp-cli teach-lookup",
		"rentalcarspain-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("rentalcarspain-pp-cli")); err == nil {
