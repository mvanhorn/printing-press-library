...
func newDoctorCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `  rentalcarspain-pp-cli doctor
  rentalcarspain-pp-cli doctor --json
  rentalcarspain-pp-cli doctor --fail-on warn
  rentalcarspain-pp-cli doctor --fail-on stale`,
			...
			if cfg != nil && cfg.BaseURL != "" {
				...
				if clientErr != nil {
					...
					if authHeader == "" {
						...
						if suggestion != "" {
							report["credentials"] = fmt.Sprintf("present, not verified. Run `%s %s` to confirm the token works end-to-end.", "rentalcarspain-pp-cli", suggestion)
						} else {
