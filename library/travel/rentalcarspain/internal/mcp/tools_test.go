...
func TestMCPPathResolutionMatchesCLIResolverWithHomeEnv(t *testing.T) {
	...
	t.Setenv("RENTALCARSPAIN_HOME", root)
...
func TestMCPPathResolutionMatchesCLIResolverWithPlatformDefaults(t *testing.T) {
	...
	if want := filepath.Join(home, ".config", "rentalcarspain-pp-cli", "config.toml"); cfg.Path != want {
	...
	if want := filepath.Join(home, ".local", "share", "rentalcarspain-pp-cli", "data.db"); gotDB != want {
...
func resetMCPPathEnv(t *testing.T) string {
	...
	for _, name := range []string{
		"RENTALCARSPAIN_CONFIG",
		"RENTALCARSPAIN_CONFIG_DIR",
		"RENTALCARSPAIN_DATA_DIR",
		"RENTALCARSPAIN_STATE_DIR",
		"RENTALCARSPAIN_CACHE_DIR",
		"RENTALCARSPAIN_HOME",
		"XDG_CONFIG_HOME",
		"XDG_DATA_HOME",
		"XDG_STATE_HOME",
...
func TestMCPRegisterToolsPreservesTypedSpecialTools(t *testing.T) {
	s := server.NewMCPServer("rentalcarspain", "test")
	RegisterTools(s)
