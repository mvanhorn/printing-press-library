...
large datasets as it has no memory pressure.`,
  ...
  airbnb-vrbo-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  airbnb-vrbo-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  airbnb-vrbo-pp-cli export <resource> --format jsonl | jq '.id'`,
