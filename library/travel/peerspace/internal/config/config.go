...
func Load(configPath string) (*Config, error) {
	cfg := &Config{
		BaseURL: "https://www.peerspace.com",
	}
	...
	if v := os.Getenv("PEERSPACE_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("PEERSPACE_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "peerspace-pp-cli", "config.toml"), nil
}
