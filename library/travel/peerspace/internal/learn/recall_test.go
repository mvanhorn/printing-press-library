...
func TestScanPII_EmailAndPhoneShapes(t *testing.T) {
	...
	cases := []struct {
		...
		{"email", "orders placed by user@example.com yesterday", []string{PIIRuleEmail}},
		{"email with plus tag", "tickets from user@example.com", []string{PIIRuleEmail}},
		...
		{"both", "email user@example.com or call 555-123-4567", []string{PIIRuleEmail, PIIRulePhone}},
