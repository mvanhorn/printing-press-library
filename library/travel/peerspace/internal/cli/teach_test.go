...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("PEERSPACE_STATE_DIR", "")
	t.Setenv("PEERSPACE_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"peerspace-pp-cli auth login",
		"peerspace-pp-cli doctor",
		"peerspace-pp-cli help items",
		"peerspace-pp-cli sync",
		"peerspace-pp-cli profile list",
		"peerspace-pp-cli feedback list",
		"peerspace-pp-cli which",
		"peerspace-pp-cli agent-context",
		"peerspace-pp-cli completion bash",
		"peerspace-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"peerspace-pp-cli recall",
		"peerspace-pp-cli learnings",
		"peerspace-pp-cli teach-pattern",
		"peerspace-pp-cli teach-lookup",
		"peerspace-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("peerspace-pp-cli")); err == nil {
...
func TestTeachCommand_PIIEmailWarnsAndSucceeds(t *testing.T) {
	...
	stdout, stderr, err := runRootArgs(t,
		"teach",
		"--query", "orders placed by user@example.com last week",
