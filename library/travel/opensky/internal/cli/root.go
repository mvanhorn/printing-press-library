...
type rootFlags struct {
	...
	// invocation. Mirrors the OPENSKY_NO_LEARN env var.
	noLearn       bool
	selectFields  string
	configPath    string
	homePath      string
...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "opensky-pp-cli",
		Short: "Manage opensky resources via the opensky API",
		Long: `Manage opensky resources via the opensky API.
...
Run 'opensky-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("opensky-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'opensky-pp-cli profile list')")
