...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  opensky-pp-cli which "stale tickets"
  opensky-pp-cli which "bottleneck"
  opensky-pp-cli which --limit 1 "send message"
  opensky-pp-cli which                                # list the full capability index`,
