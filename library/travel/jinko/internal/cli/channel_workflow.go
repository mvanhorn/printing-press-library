...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  jinko-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  jinko-pp-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"devplatform", "devplatform-users", "devplatform-users-me", "devplatform-users-me-keys", "devplatform-users-me-usage", "travelers"}
			totalSynced := 0
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  jinko-pp-cli workflow status

  # Show status as JSON
  jinko-pp-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("jinko-pp-cli")
			}
