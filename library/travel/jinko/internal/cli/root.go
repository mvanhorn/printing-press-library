...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "jinko-pp-cli",
		Short: "Manage jinko resources via the jinko API",
		Long: `Manage jinko resources via the jinko API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'jinko-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("jinko-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'jinko-pp-cli profile list')")
	...
	rootCmd.AddCommand(newDevplatformCmd(flags))
	...
	rootCmd.AddCommand(newShoppingCartCmd(flags))
	rootCmd.AddCommand(newTravelersCmd(flags))
