...
large datasets as it has no memory pressure.`,
  ...
  jinko-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  jinko-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  jinko-pp-cli export <resource> --format jsonl | jq '.id'`,
