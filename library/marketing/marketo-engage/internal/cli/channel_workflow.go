...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  marketo-engage-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  marketo-engage-pp-cli workflow archive --full`,
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  marketo-engage-pp-cli workflow status

  # Show status as JSON
  marketo-engage-pp-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("marketo-engage-pp-cli")
			}
