...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "marketo-engage-pp-cli",
		Short: "Manage marketo-engage resources via the marketo-engage API",
		Long: `Manage marketo-engage resources via the marketo-engage API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'marketo-engage-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("marketo-engage-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'marketo-engage-pp-cli profile list')")
	...
	rootCmd.AddCommand(newActivitiesJsonPromotedCmd(flags))
	rootCmd.AddCommand(newCampaignPromotedCmd(flags))
	rootCmd.AddCommand(newCampaignsJsonPromotedCmd(flags))
	rootCmd.AddCommand(newLeadPromotedCmd(flags))
	rootCmd.AddCommand(newLeadsJsonPromotedCmd(flags))
	rootCmd.AddCommand(newListsJsonPromotedCmd(flags))
