...
but do not stop the import.`,
  ...
  marketo-engage-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  marketo-engage-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | marketo-engage-pp-cli import <resource> --input -`,
