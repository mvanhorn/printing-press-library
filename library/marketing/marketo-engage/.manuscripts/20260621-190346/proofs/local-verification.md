# Local verification for marketo-engage-pp-cli
...
- `go vet ./...`: passed
- `go build ./...`: passed
- `marketo-engage-pp-cli --help`: passed
- `marketo-engage-pp-cli version`: passed
- `marketo-engage-pp-cli doctor --json`: passed with expected no-credentials diagnostics
- `marketo-engage-pp-mcp --help`: passed
