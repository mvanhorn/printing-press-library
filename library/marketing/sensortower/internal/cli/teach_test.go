...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("SENSORTOWER_STATE_DIR", "")
	t.Setenv("SENSORTOWER_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"sensortower-pp-cli auth login",
		"sensortower-pp-cli doctor",
		"sensortower-pp-cli help items",
		"sensortower-pp-cli sync",
		"sensortower-pp-cli profile list",
		"sensortower-pp-cli feedback list",
		"sensortower-pp-cli which",
		"sensortower-pp-cli agent-context",
		"sensortower-pp-cli completion bash",
		"sensortower-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"sensortower-pp-cli recall",
		"sensortower-pp-cli learnings",
		"sensortower-pp-cli teach-pattern",
		"sensortower-pp-cli teach-lookup",
		"sensortower-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("sensortower-pp-cli")); err == nil {
