...
large datasets as it has no memory pressure.`,
  ...
  sensortower-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  sensortower-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  sensortower-pp-cli export <resource> --format jsonl | jq '.id'`,
