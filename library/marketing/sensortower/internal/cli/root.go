...
type rootFlags struct {
	...
	// invocation. Mirrors the SENSORTOWER_NO_LEARN env var.
	noLearn       bool
	selectFields  string
	configPath    string
	homePath      string
...
Health check: run 'sensortower-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("sensortower-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'sensortower-pp-cli profile list')")
	...
	rootCmd.AddCommand(newNovelDivergenceCmd(flags))
	rootCmd.AddCommand(newNovelMoversCmd(flags))
	rootCmd.AddCommand(newNovelTeardownCmd(flags))
