...
func resetCredentialEnv(t *testing.T) (home, configPath string) {
	...
	for _, name := range []string{
		"SENSORTOWER_CONFIG",
		"SENSORTOWER_CONFIG_DIR",
		"SENSORTOWER_DATA_DIR",
		"SENSORTOWER_STATE_DIR",
	...
	return home, filepath.Join(home, ".config", "sensortower-pp-cli", "config.toml")
}
...
func TestCorruptCredentialsFallsBackToLegacyConfig(t *testing.T) {
	...
	credentialsPath := filepath.Join(home, ".local", "share", "sensortower-pp-cli", "credentials.toml")
...
func TestAuthWriteScrubsLegacyConfigWhenRelocated(t *testing.T) {
	...
	activeConfigPath := filepath.Join(newConfigDir, "sensortower-pp-cli", "config.toml")
	...
	credsPath := filepath.Join(newDataDir, "sensortower-pp-cli", "credentials.toml")
