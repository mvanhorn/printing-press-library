---
name: pp-attentive
description: "Printing Press CLI for Attentive. For any questions, reach out to your Attentive point of contact (if applicable) or [api@attentivemobile."
...
```bash
attentive-pp-cli segments list --limit 10 --json
```

### Check bulk import completion
