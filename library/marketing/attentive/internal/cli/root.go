...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "attentive-pp-cli",
		Short: "Manage attentive resources via the attentive API",
		Long: `Manage attentive resources via the attentive API.
...
Run 'attentive-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("attentive-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'attentive-pp-cli profile list')")
