...
but do not stop the import.`,
  ...
  attentive-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  attentive-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | attentive-pp-cli import <resource> --input -`,
