...
Resource scoping:
  ...
  attentive-pp-cli sync

  # Sync specific resources only
  attentive-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  attentive-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  attentive-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  attentive-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  attentive-pp-cli sync --latest-only`,
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/attentive-pp-cli/data.db)")
