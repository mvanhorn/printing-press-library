# TikTok Creative Center Printed CLI Agent Guide

This directory is a generated `tiktok-creative-center-pp-cli` printed CLI. It was produced by [CLI Printing Press](https://github.com/mvanhorn/cli-printing-press), so treat systemic fixes as upstream Printing Press fixes first. Keep local edits narrow and document why a generated-tree patch belongs here.
...
```bash
tiktok-creative-center-pp-cli doctor --json
tiktok-creative-center-pp-cli agent-context --pretty
```

Use runtime discovery instead of relying on a copied command list:

```bash
tiktok-creative-center-pp-cli which "<capability>" --json
tiktok-creative-center-pp-cli <command> --help
```
...
```bash
tiktok-creative-center-pp-cli <command> --agent
```
...
```bash
tiktok-creative-center-pp-cli <command> --help
tiktok-creative-center-pp-cli <command> --dry-run --agent
```
