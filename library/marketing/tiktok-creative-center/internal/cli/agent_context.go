...
func buildAgentContext(rootCmd *cobra.Command) agentContext {
	...
	return agentContext{
		...
		CLI: agentContextCLI{
			Name:        "tiktok-creative-center-pp-cli",
...
func buildAgentDiscoveryContext() *agentContextDiscovery {
	return &agentContextDiscovery{
		...
		TargetURL:     "https://accounts.google.com/v3/signin/_/AccountsSignInUi/browserinfo",
		EntryCount:    2047,
		APIEntryCount: 783,
		...
		AuthCandidates: []string{
			"api_key — query: key, msToken, tcc_key, token",
		},
		Protections: []string{},
		...
		CandidateCommands: []string{
			"create_GetHashtagDetail — Derived from observed POST /CreativeOne/KnowledgeAPI/GetHashtagDetail traffic.",
			"create_GetHashtagList — Derived from observed POST /CreativeOne/KnowledgeAPI/GetHashtagList traffic.",
			"create_abtest_config — Derived from observed POST /service/{service_id}/abtest_config/ traffic.",
			"create_act — Derived from observed POST /api/v2/pixel/act traffic.",
			"create_batch — Derived from observed POST /monitor_browser/collect/batch/ traffic.",
			"create_batchexecute — Derived from observed POST /v3/signin/_/AccountsSignInUi/data/batchexecute traffic.",
			"create_browserinfo — Derived from observed POST /v3/signin/_/AccountsSignInUi/browserinfo traffic.",
			"create_check — Derived from observed POST /api/v3/self_serve/feature_gating/check/ traffic.",
		},
	}
}
