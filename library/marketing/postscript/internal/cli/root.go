...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "postscript-pp-cli",
		Short: "Manage postscript resources via the postscript API",
		Long: `Manage postscript resources via the postscript API.
...
Run 'postscript-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("postscript-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'postscript-pp-cli profile list')")
