...
but do not stop the import.`,
  ...
  postscript-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  postscript-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | postscript-pp-cli import <resource> --input -`,
