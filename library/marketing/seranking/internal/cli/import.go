...
but do not stop the import.`,
  ...
  seranking-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  seranking-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | seranking-pp-cli import <resource> --input -`,
