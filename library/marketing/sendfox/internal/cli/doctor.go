		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if cfg != nil {
				...
				if header == "" {
					...
					report["auth_hint"] = "export SENDFOX_TOKEN=<your-key>"
				} else {
					authConfigured = true
			...
			if os.Getenv("SENDFOX_TOKEN") != "" {
				authEnvSet = append(authEnvSet, "SENDFOX_TOKEN")
				...
				authEnvRequiredMissing = append(authEnvRequiredMissing, "SENDFOX_TOKEN")
			}
			switch {
