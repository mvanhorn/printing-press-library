...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "sendfox-pp-cli",
		Short: `The only SendFox CLI. AI-write and send newsletters from the terminal.`,
		Long: `The only SendFox CLI. AI-write and send newsletters from the terminal.
...
See README.md or the bundled SKILL.md for recipes.`,
	...
	// Add clone subcommand to campaigns
	campaignsCmd := newCampaignsCmd(flags)
	campaignsCmd.AddCommand(newCampaignsCloneCmd(flags))
	...
	rootCmd.AddCommand(newWriteCmd(flags))
