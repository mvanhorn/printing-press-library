...
large datasets as it has no memory pressure.`,
  ...
  pinterest-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  pinterest-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  pinterest-pp-cli export <resource> --format jsonl | jq '.id'`,
