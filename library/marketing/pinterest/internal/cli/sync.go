...
Resource scoping:
  ...
  pinterest-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  pinterest-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  pinterest-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  pinterest-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  pinterest-pp-cli sync --latest-only`,
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/pinterest-pp-cli/data.db)")
...
func resourceSupportsPagination(resource string) bool {
	...
	case "user-account":
		return true
	case "user-account-followers":
		return true
	case "user-account-following":
		return true
	case "user-account-following-boards":
		return true
	}
	return false
}
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	switch resource {
	case "ad-accounts":
		return db.UpsertAdAccounts(data)
	case "ad_groups":
		return db.UpsertAdGroups(data)
	case "ad_previews":
		return db.UpsertAdPreviews(data)
	case "ads":
		return db.UpsertAds(data)
	case "ads_credit":
		return db.UpsertAdsCredit(data)
	case "ad_accounts_analytics":
		return db.UpsertAdAccountsAnalytics(data)
	case "audience_insights":
		return db.UpsertAudienceInsights(data)
	case "audiences":
		return db.UpsertAudiences(data)
	case "bid_floor":
		return db.UpsertBidFloor(data)
	case "billing_profiles":
		return db.UpsertBillingProfiles(data)
	case "bulk":
		return db.UpsertBulk(data)
	case "campaigns":
		return db.UpsertCampaigns(data)
	case "conversion_tags":
		return db.UpsertConversionTags(data)
	case "customer_lists":
		return db.UpsertCustomerLists(data)
	case "events":
	...
	case "lead_forms":
		return db.UpsertLeadForms(data)
	case "leads":
		return db.UpsertLeads(data)
	case "mmm_reports":
		return db.UpsertMmmReports(data)
	case "order_lines":
		return db.UpsertOrderLines(data)
	case "product_group_promotions":
		return db.UpsertProductGroupPromotions(data)
	case "product_groups":
		return db.UpsertProductGroups(data)
	case "reports":
		return db.UpsertReports(data)
	case "sandbox":
		return db.UpsertSandbox(data)
	case "ssio":
		return db.UpsertSsio(data)
	case "targeting_analytics":
		return db.UpsertTargetingAnalytics(data)
	case "templates":
	...
	case "boards_pins":
		return db.UpsertBoardsPins(data)
	case "sections":
		return db.UpsertSections(data)
	case "catalogs":
		return db.UpsertCatalogs(data)
	case "integrations":
	...
	case "pins_analytics":
		return db.UpsertPinsAnalytics(data)
	case "save":
		return db.UpsertSave(data)
	case "pinterest-search":
		return db.UpsertPinterestSearch(data)
	case "resources":
	...
	case "user-account":
		return db.UpsertUserAccount(data)
	case "interests":
		return db.UpsertInterests(data)
	default:
...
func defaultSyncResources() []string {
	return []string{
		...
		"pinterest-search",
		"resources",
		"resources-ad-account-countries",
		"user-account",
		"user-account-businesses",
		"user-account-followers",
		"user-account-following",
		"user-account-following-boards",
	}
}
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		...
		"boards":                         "/boards",
		"catalogs":                       "/catalogs",
		"catalogs-feeds":                 "/catalogs/feeds",
		"catalogs-product-groups":        "/catalogs/product_groups",
		"integrations":                   "/integrations",
		"media":                          "/media",
		"pins":                           "/pins",
		"pinterest-search":               "/search/boards",
		"resources":                      "/resources/delivery_metrics",
		"resources-ad-account-countries": "/resources/ad_account_countries",
		"user-account":                   "/user_account/websites",
		"user-account-businesses":        "/user_account/businesses",
		"user-account-followers":         "/user_account/followers",
		"user-account-following":         "/user_account/following",
		"user-account-following-boards":  "/user_account/following/boards",
	}
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "ad_groups", ParentTable: "ad-accounts", ParentIDParam: "ad_account_id", PathTemplate: "/ad_accounts/{ad_account_id}/ad_groups", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "ad_account_id", Field: "id"},
		}},
		{Name: "ads", ParentTable: "ad-accounts", ParentIDParam: "ad_account_id", PathTemplate: "/ad_accounts/{ad_account_id}/ads", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "ad_account_id", Field: "id"},
		}},
		{Name: "ads_credit", ParentTable: "ad-accounts", ParentIDParam: "ad_account_id", PathTemplate: "/ad_accounts/{ad_account_id}/ads_credit/discounts", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "ad_account_id", Field: "id"},
		}},
		{Name: "audiences", ParentTable: "ad-accounts", ParentIDParam: "ad_account_id", PathTemplate: "/ad_accounts/{ad_account_id}/audiences", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "ad_account_id", Field: "id"},
		}},
		{Name: "billing_profiles", ParentTable: "ad-accounts", ParentIDParam: "ad_account_id", PathTemplate: "/ad_accounts/{ad_account_id}/billing_profiles", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "ad_account_id", Field: "id"},
		}},
		{Name: "boards_pins", ParentTable: "boards", ParentIDParam: "board_id", PathTemplate: "/boards/{board_id}/pins", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "board_id", Field: "id"},
		}},
		{Name: "campaigns", ParentTable: "ad-accounts", ParentIDParam: "ad_account_id", PathTemplate: "/ad_accounts/{ad_account_id}/campaigns", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "ad_account_id", Field: "id"},
		}},
		{Name: "conversion_tags", ParentTable: "ad-accounts", ParentIDParam: "ad_account_id", PathTemplate: "/ad_accounts/{ad_account_id}/conversion_tags/page_visit", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "ad_account_id", Field: "id"},
		}},
		{Name: "customer_lists", ParentTable: "ad-accounts", ParentIDParam: "ad_account_id", PathTemplate: "/ad_accounts/{ad_account_id}/customer_lists", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "ad_account_id", Field: "id"},
		}},
		{Name: "keywords", ParentTable: "ad-accounts", ParentIDParam: "ad_account_id", PathTemplate: "/ad_accounts/{ad_account_id}/keywords", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "ad_account_id", Field: "id"},
		}},
		{Name: "lead_forms", ParentTable: "ad-accounts", ParentIDParam: "ad_account_id", PathTemplate: "/ad_accounts/{ad_account_id}/lead_forms", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "ad_account_id", Field: "id"},
		}},
		{Name: "leads", ParentTable: "ad-accounts", ParentIDParam: "ad_account_id", PathTemplate: "/ad_accounts/{ad_account_id}/leads/subscriptions", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "ad_account_id", Field: "id"},
		}},
		{Name: "order_lines", ParentTable: "ad-accounts", ParentIDParam: "ad_account_id", PathTemplate: "/ad_accounts/{ad_account_id}/order_lines", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "ad_account_id", Field: "id"},
		}},
		{Name: "product_group_promotions", ParentTable: "ad-accounts", ParentIDParam: "ad_account_id", PathTemplate: "/ad_accounts/{ad_account_id}/product_group_promotions", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "ad_account_id", Field: "id"},
		}},
		{Name: "sections", ParentTable: "boards", ParentIDParam: "board_id", PathTemplate: "/boards/{board_id}/sections", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "board_id", Field: "id"},
		}},
		{Name: "ssio", ParentTable: "ad-accounts", ParentIDParam: "ad_account_id", PathTemplate: "/ad_accounts/{ad_account_id}/ssio/insertion_orders/status", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "ad_account_id", Field: "id"},
		}},
		{Name: "ssio", ParentTable: "ad-accounts", ParentIDParam: "ad_account_id", PathTemplate: "/ad_accounts/{ad_account_id}/ssio/order_lines", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "ad_account_id", Field: "id"},
		}},
		{Name: "templates", ParentTable: "ad-accounts", ParentIDParam: "ad_account_id", PathTemplate: "/ad_accounts/{ad_account_id}/templates", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "ad_account_id", Field: "id"},
		}},
		{Name: "sections_pins", ParentTable: "sections", ParentIDParam: "section_id", PathTemplate: "/boards/{board_id}/sections/{section_id}/pins", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "board_id", Field: "boards_id"},
			{Param: "section_id", Field: "id"},
		}},
	}
}
