...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "pinterest-pp-cli",
		Short: `Pinterest CLI — Every Pinterest board, pin, and ad — plus offline analytics no other tool can answer in a single command.`,
		Long: `Pinterest CLI — Every Pinterest board, pin, and ad — plus offline analytics no other tool can answer in a single command.
...
Health check: run 'pinterest-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("pinterest-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'pinterest-pp-cli profile list')")
	...
	rootCmd.AddCommand(newAdAccountsCmd(flags))
	...
	rootCmd.AddCommand(newPinterestSearchCmd(flags))
	...
	rootCmd.AddCommand(newNovelTimingCmd(flags))
	rootCmd.AddCommand(newNovelTopBoardsCmd(flags))
