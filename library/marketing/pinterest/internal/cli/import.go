...
but do not stop the import.`,
  ...
  pinterest-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  pinterest-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | pinterest-pp-cli import <resource> --input -`,
