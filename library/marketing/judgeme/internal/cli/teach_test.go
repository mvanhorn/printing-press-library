...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"judgeme-pp-cli auth login",
		"judgeme-pp-cli doctor",
		"judgeme-pp-cli help items",
		"judgeme-pp-cli sync",
		"judgeme-pp-cli profile list",
		"judgeme-pp-cli feedback list",
		"judgeme-pp-cli which",
		"judgeme-pp-cli agent-context",
		"judgeme-pp-cli completion bash",
		"judgeme-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"judgeme-pp-cli recall",
		"judgeme-pp-cli learnings",
		"judgeme-pp-cli teach-pattern",
		"judgeme-pp-cli teach-lookup",
		"judgeme-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("judgeme-pp-cli")); err == nil {
