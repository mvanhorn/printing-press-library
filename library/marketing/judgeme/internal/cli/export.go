...
large datasets as it has no memory pressure.`,
  ...
  judgeme-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  judgeme-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  judgeme-pp-cli export <resource> --format jsonl | jq '.id'`,
