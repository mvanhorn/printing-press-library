...
but do not stop the import.`,
  ...
  judgeme-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  judgeme-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | judgeme-pp-cli import <resource> --input -`,
