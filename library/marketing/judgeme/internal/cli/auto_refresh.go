...
var readCommandResources = map[string][]string{
	"judgeme-pp-cli reviews":                           {"reviews"},
	"judgeme-pp-cli reviews list":                      {"reviews"},
	"judgeme-pp-cli reviews get":                       {"reviews"},
	"judgeme-pp-cli reviews search":                    {"reviews"},
	"judgeme-pp-cli settings":                          {"settings"},
	"judgeme-pp-cli settings list":                     {"settings"},
	"judgeme-pp-cli settings get":                      {"settings"},
	"judgeme-pp-cli settings search":                   {"settings"},
	"judgeme-pp-cli webhooks":                          {"webhooks"},
	"judgeme-pp-cli webhooks list":                     {"webhooks"},
	"judgeme-pp-cli webhooks get":                      {"webhooks"},
	"judgeme-pp-cli webhooks search":                   {"webhooks"},
	"judgeme-pp-cli widgets":                           {"widgets"},
	"judgeme-pp-cli widgets list":                      {"widgets"},
	"judgeme-pp-cli widgets get":                       {"widgets"},
	"judgeme-pp-cli widgets search":                    {"widgets"},
	"judgeme-pp-cli widgets-all-reviews-count":         {"widgets-all-reviews-count"},
	"judgeme-pp-cli widgets-all-reviews-count list":    {"widgets-all-reviews-count"},
	"judgeme-pp-cli widgets-all-reviews-count get":     {"widgets-all-reviews-count"},
	"judgeme-pp-cli widgets-all-reviews-count search":  {"widgets-all-reviews-count"},
	"judgeme-pp-cli widgets-all-reviews-page":          {"widgets-all-reviews-page"},
	"judgeme-pp-cli widgets-all-reviews-page list":     {"widgets-all-reviews-page"},
	"judgeme-pp-cli widgets-all-reviews-page get":      {"widgets-all-reviews-page"},
	"judgeme-pp-cli widgets-all-reviews-page search":   {"widgets-all-reviews-page"},
	"judgeme-pp-cli widgets-all-reviews-rating":        {"widgets-all-reviews-rating"},
	"judgeme-pp-cli widgets-all-reviews-rating list":   {"widgets-all-reviews-rating"},
	"judgeme-pp-cli widgets-all-reviews-rating get":    {"widgets-all-reviews-rating"},
	"judgeme-pp-cli widgets-all-reviews-rating search": {"widgets-all-reviews-rating"},
	"judgeme-pp-cli widgets-product-review":            {"widgets-product-review"},
	"judgeme-pp-cli widgets-product-review list":       {"widgets-product-review"},
	"judgeme-pp-cli widgets-product-review get":        {"widgets-product-review"},
	"judgeme-pp-cli widgets-product-review search":     {"widgets-product-review"},
}
...
func cachePolicy() cliutil.Policy {
	...
	envOptOut := "JUDGEME_NO_AUTO_REFRESH"
...
func refreshTimeout() time.Duration {
	if d, err := time.ParseDuration("120s"); err == nil {
		return d
	}
...
func autoRefreshIfStale(ctx context.Context, flags *rootFlags, resources []string) (meta cliutil.FreshnessMeta) {
	...
	if err := runAutoRefresh(refreshCtx, flags, db, resources); err != nil {
		fmt.Fprintf(os.Stderr, "warning: using stale judgeme-pp-cli cache (refresh failed: %v)\n", err)
