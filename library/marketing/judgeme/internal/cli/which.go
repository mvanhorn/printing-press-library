...
var whichIndex = []whichEntry{
	{Command: "sync", Description: "Mirror the complete review corpus and refuse success when unique IDs do not equal Judge.me's live count.", Group: "Verified local corpus", WhyItMatters: "Use this before any analysis that depends on corpus completeness."},
	{Command: "reviews export", Description: "Export explicit published, hidden, pending, or all populations as JSON or CSV.", Group: "Verified local corpus", WhyItMatters: "Use this to hand a bounded, provenance-labeled review slice to downstream analysis tools."},
	{Command: "reviews populations", Description: "Count storefront-visible and internal moderation populations with unambiguous labels.", Group: "Population integrity", WhyItMatters: "Use this whenever published-vs-hidden population differences affect a report or decision."},
	{Command: "reviews syndication", Description: "Find identical normalized review bodies attached to multiple products.", Group: "Population integrity", WhyItMatters: "Use this before attributing customer language to a specific SKU or product."},
	{Command: "reviews unique-bodies", Description: "Return one deterministic representative per normalized review body while retaining source row counts.", Group: "Population integrity", WhyItMatters: "Use this when independent customer voices matter more than API row count."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  judgeme-pp-cli which "stale tickets"
  judgeme-pp-cli which "bottleneck"
  judgeme-pp-cli which --limit 1 "send message"
  judgeme-pp-cli which                                # list the full capability index`,
