...
func TestDeclaredAPISurfaceReachable(t *testing.T) {
	expected := []string{
		...
		"widgets checkout-comments",
		"widgets featured-carousel",
		"widgets html-miracle",
		"widgets preview-badge",
		"widgets product-review",
		"widgets reviews-tab",
		"widgets settings",
		"widgets shop-reviews-count",
		"widgets shop-reviews-rating",
		"widgets verified-badge",
	}
