...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("EVERBEE_STATE_DIR", "")
	t.Setenv("EVERBEE_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"everbee-pp-cli auth login",
		"everbee-pp-cli doctor",
		"everbee-pp-cli help items",
		"everbee-pp-cli sync",
		"everbee-pp-cli profile list",
		"everbee-pp-cli feedback list",
		"everbee-pp-cli which",
		"everbee-pp-cli agent-context",
		"everbee-pp-cli completion bash",
		"everbee-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"everbee-pp-cli recall",
		"everbee-pp-cli learnings",
		"everbee-pp-cli teach-pattern",
		"everbee-pp-cli teach-lookup",
		"everbee-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("everbee-pp-cli")); err == nil {
