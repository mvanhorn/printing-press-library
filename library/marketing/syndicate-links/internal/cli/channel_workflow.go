...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  syndicate-links-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  syndicate-links-pp-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"affiliate", "affiliate-dashboard-earnings-chart", "affiliate-dashboard-summary", "affiliate-events", "affiliate-me-payouts", "affiliate-partnerships", "affiliate-programs", "affiliate-programs-mine", "affiliate-reports-clicks", "affiliate-reports-conversions", "affiliate-reports-earnings", "merchant", "merchant-affiliates", "merchant-conversions", "merchant-payouts", "merchant-products", "merchant-programs", "merchant-settings", "merchant-stripe-status", "merchant-webhooks",  }
			totalSynced := 0
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  syndicate-links-pp-cli workflow status

  # Show status as JSON
  syndicate-links-pp-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("syndicate-links-pp-cli")
			}
