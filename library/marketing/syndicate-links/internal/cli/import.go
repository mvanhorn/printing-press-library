...
but do not stop the import.`,
  ...
  syndicate-links-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  syndicate-links-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | syndicate-links-pp-cli import <resource> --input -`,
