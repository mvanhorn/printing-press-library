...
func buildAgentContext(rootCmd *cobra.Command) agentContext {
	envVars := []agentContextAuthEnvVar{
		{
			Name:      "SYNDICATE_LINKS_BEARER_AUTH",
			Kind:      "per_call",
			Required:  true,
			Sensitive: true,
	...
	return agentContext{
		...
		CLI: agentContextCLI{
			Name:        "syndicate-links-pp-cli",
			Description: "Attribution and commission infrastructure for AI-driven commerce. Two-sided: merchants publish programs + products;...",
