...
import (
	...
	"sync/atomic"
	"time"
	"github.com/mvanhorn/printing-press-library/library/marketing/syndicate-links/internal/store"
...
Exit codes & warnings:
  ...
  syndicate-links-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  syndicate-links-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  syndicate-links-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  syndicate-links-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  syndicate-links-pp-cli sync --latest-only`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if dbPath == "" {
				dbPath = defaultDBPath("syndicate-links-pp-cli")
			}
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/syndicate-links-pp-cli/data.db)")
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	switch resource {
	case "affiliate":
		return db.UpsertAffiliate(data)
	case "merchant":
		return db.UpsertMerchant(data)
	default:
...
func defaultSyncResources() []string {
	return []string{
		"affiliate",
		"affiliate-dashboard-earnings-chart",
		"affiliate-dashboard-summary",
		"affiliate-events",
		"affiliate-me-payouts",
		"affiliate-partnerships",
		"affiliate-programs",
		"affiliate-programs-mine",
		"affiliate-reports-clicks",
		"affiliate-reports-conversions",
		"affiliate-reports-earnings",
		"merchant",
		"merchant-affiliates",
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		...
		"affiliate-dashboard-earnings-chart": "/affiliate/dashboard/earnings-chart",
		"affiliate-dashboard-summary": "/affiliate/dashboard/summary",
		"affiliate-events": "/affiliate/events",
		"affiliate-me-payouts": "/affiliate/me/payouts",
		"affiliate-partnerships": "/affiliate/partnerships",
		"affiliate-programs": "/affiliate/programs",
		"affiliate-programs-mine": "/affiliate/programs/mine",
		"affiliate-reports-clicks": "/affiliate/reports/clicks",
		"affiliate-reports-conversions": "/affiliate/reports/conversions",
		"affiliate-reports-earnings": "/affiliate/reports/earnings",
		"merchant": "/merchant/billing",
		"merchant-affiliates": "/merchant/affiliates",
		"merchant-conversions": "/merchant/conversions",
		"merchant-payouts": "/merchant/payouts",
		"merchant-products": "/merchant/products",
		"merchant-programs": "/merchant/programs",
		"merchant-settings": "/merchant/settings",
		"merchant-stripe-status": "/merchant/stripe/status",
