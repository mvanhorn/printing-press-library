...
native streaming instead of polling.`,
  ...
  syndicate-links-pp-cli tail --interval 10s

  # Tail a specific resource
  syndicate-links-pp-cli tail messages --interval 5s

  # Pipe to jq for filtering
  syndicate-links-pp-cli tail events --interval 30s | jq 'select(.type == "error")'`,
