...
func TestRecipeIntentHandlerBuildsRecipeArgs(t *testing.T) {
	...
	result, err := handleFindTheDeadWeight(context.Background(), req)
	if err != nil {
...
func TestRecipeIntentHandlerOverridesParams(t *testing.T) {
	...
	if strings.Contains(got, "--never-opened") {
		t.Fatalf("boolean false override should suppress --never-opened: %q", got)
	}
}
