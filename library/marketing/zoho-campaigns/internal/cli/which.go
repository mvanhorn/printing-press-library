...
var whichIndex = []whichEntry{
	{Command: "delta", Description: "See how one campaign's opens, clicks, bounces, and unsubscribes changed between snapshots — the trajectory Zoho never shows.", Group: "Report history that compounds", WhyItMatters: "Reach for this when asked whether a campaign's performance is still moving or has plateaued; needs at least two digest-written snapshots in the window — no instant trajectory on a fresh install."},
	{Command: "digest", Description: "One-shot rollup of everything sent in a window: aggregate open/click/bounce rates, list totals, and biggest movers.", Group: "Report history that compounds", WhyItMatters: "The single command to call when refreshing a marketing dashboard or writing a daily brief; --since 24h gives the overnight change feed."},
	{Command: "growth", Description: "Per-list subscriber, unsubscribe, and bounce trend lines over time — is the list growing or bleeding.", Group: "Report history that compounds", WhyItMatters: "Use for questions about list health over time rather than a point-in-time count; trends appear only after 'digest' has run at least twice over time."},
	{Command: "engagement", Description: "Rank contacts by engagement across ALL campaigns — most engaged, or dead weight that never opens.", Group: "Cross-campaign contact intelligence", WhyItMatters: "Answers who the hottest contacts are before outreach, or who to prune, without opening 44 campaign reports."},
	{Command: "bounce-audit", Description: "Bounced contacts joined to current list membership — deliverability cleanup candidates, pipeable into do-not-mail.", Group: "Cross-campaign contact intelligence", WhyItMatters: "Run after event imports or before big sends to protect sender reputation."},
	{Command: "journey", Description: "One contact's chronological history across every campaign — what they received, opened, and clicked.", Group: "Cross-campaign contact intelligence", WhyItMatters: "Sales-prep lookup before a call: what marketing a contact has actually seen — reads actions cached by 'engagement' or 'bounce-audit', so run one of those first."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  zoho-campaigns-pp-cli which "stale tickets"
  zoho-campaigns-pp-cli which "bottleneck"
  zoho-campaigns-pp-cli which --limit 1 "send message"
  zoho-campaigns-pp-cli which                                # list the full capability index`,
