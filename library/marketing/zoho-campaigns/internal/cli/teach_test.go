...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("ZOHO_CAMPAIGNS_STATE_DIR", "")
	t.Setenv("ZOHO_CAMPAIGNS_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"zoho-campaigns-pp-cli auth login",
		"zoho-campaigns-pp-cli doctor",
		"zoho-campaigns-pp-cli help items",
		"zoho-campaigns-pp-cli sync",
		"zoho-campaigns-pp-cli profile list",
		"zoho-campaigns-pp-cli feedback list",
		"zoho-campaigns-pp-cli which",
		"zoho-campaigns-pp-cli agent-context",
		"zoho-campaigns-pp-cli completion bash",
		"zoho-campaigns-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"zoho-campaigns-pp-cli recall",
		"zoho-campaigns-pp-cli learnings",
		"zoho-campaigns-pp-cli teach-pattern",
		"zoho-campaigns-pp-cli teach-lookup",
		"zoho-campaigns-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("zoho-campaigns-pp-cli")); err == nil {
