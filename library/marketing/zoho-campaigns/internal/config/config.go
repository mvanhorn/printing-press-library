...
type Config struct {
	...
	ZohoCampaignsClientId     string          `toml:"campaigns_client_id"`
	ZohoCampaignsClientSecret string          `toml:"campaigns_client_secret"`
	ZohoCampaignsRefreshToken string          `toml:"campaigns_refresh_token"`
}
...
func Load(configPath string) (*Config, error) {
	...
	// Env var overrides
	if v := os.Getenv("ZOHO_CAMPAIGNS_CLIENT_ID"); v != "" {
		cfg.ZohoCampaignsClientId = v
		cfg.markEnvOverride("ZohoCampaignsClientId")
		cfg.AuthSource = "env:ZOHO_CAMPAIGNS_CLIENT_ID"
		cfg.CredentialSource = "env:ZOHO_CAMPAIGNS_CLIENT_ID"
	}
	if v := os.Getenv("ZOHO_CAMPAIGNS_CLIENT_SECRET"); v != "" {
		cfg.ZohoCampaignsClientSecret = v
		cfg.markEnvOverride("ZohoCampaignsClientSecret")
		cfg.AuthSource = "env:ZOHO_CAMPAIGNS_CLIENT_SECRET"
		cfg.CredentialSource = "env:ZOHO_CAMPAIGNS_CLIENT_SECRET"
	}
	if v := os.Getenv("ZOHO_CAMPAIGNS_REFRESH_TOKEN"); v != "" {
		cfg.ZohoCampaignsRefreshToken = v
		cfg.markEnvOverride("ZohoCampaignsRefreshToken")
		cfg.AuthSource = "env:ZOHO_CAMPAIGNS_REFRESH_TOKEN"
		cfg.CredentialSource = "env:ZOHO_CAMPAIGNS_REFRESH_TOKEN"
	}
	...
	if v := os.Getenv("ZOHO_CAMPAIGNS_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	if v := os.Getenv("ZOHO_CAMPAIGNS_TOKEN_URL"); v != "" {
		cfg.TokenURL = v
	}
	// Env-var-only headless auth: promote flow-input credentials to the OAuth
	// fields the refresh path reads (see zoho_campaigns_env.go).
	cfg.applyZohoCampaignsFlowInputs()
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("ZOHO_CAMPAIGNS_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "zoho-campaigns-pp-cli", "config.toml"), nil
}
...
func (c *Config) hasCredentialFields() bool {
	...
	if c.ZohoCampaignsClientId != "" {
		return true
	}
	if c.ZohoCampaignsClientSecret != "" {
		return true
	}
	if c.ZohoCampaignsRefreshToken != "" {
		return true
	}
	return false
}
...
func (c *Config) clearCredentialFields() {
	...
	c.ClientID = ""
	c.ClientSecret = ""
	c.ZohoCampaignsClientId = ""
	c.ZohoCampaignsClientSecret = ""
	c.ZohoCampaignsRefreshToken = ""
}
...
func (c *Config) credentials() *cliutil.Credentials {
	return &cliutil.Credentials{
		...
		ZohoCampaignsClientId:     c.ZohoCampaignsClientId,
		ZohoCampaignsClientSecret: c.ZohoCampaignsClientSecret,
		ZohoCampaignsRefreshToken: c.ZohoCampaignsRefreshToken,
	}
}
...
func (c *Config) applyCredentials(creds *cliutil.Credentials) {
	...
	c.ZohoCampaignsClientId = creds.ZohoCampaignsClientId
	c.ZohoCampaignsClientSecret = creds.ZohoCampaignsClientSecret
	c.ZohoCampaignsRefreshToken = creds.ZohoCampaignsRefreshToken
}
...
func (c *Config) ClearTokens() error {
	...
	c.updateFileConfigField("ClientSecret")
	c.ZohoCampaignsClientId = ""
	delete(c.envOverrides, "ZohoCampaignsClientId")
	c.updateFileConfigField("ZohoCampaignsClientId")
	c.ZohoCampaignsClientSecret = ""
	delete(c.envOverrides, "ZohoCampaignsClientSecret")
	c.updateFileConfigField("ZohoCampaignsClientSecret")
	c.ZohoCampaignsRefreshToken = ""
	delete(c.envOverrides, "ZohoCampaignsRefreshToken")
	c.updateFileConfigField("ZohoCampaignsRefreshToken")
	if c.AgentcookieManagedByExternalStore() {
		c.markAgentcookieManaged()
...
func (c *Config) configForSave() Config {
	out := *c
	if c.fileConfig != nil {
		if c.envOverrides["ZohoCampaignsClientId"] {
			out.ZohoCampaignsClientId = c.fileConfig.ZohoCampaignsClientId
		}
		if c.envOverrides["ZohoCampaignsClientSecret"] {
			out.ZohoCampaignsClientSecret = c.fileConfig.ZohoCampaignsClientSecret
		}
		if c.envOverrides["ZohoCampaignsRefreshToken"] {
			out.ZohoCampaignsRefreshToken = c.fileConfig.ZohoCampaignsRefreshToken
		}
	}
...
func (c *Config) updateFileConfigField(field string) {
	...
	case "ZohoCampaignsClientId":
		c.fileConfig.ZohoCampaignsClientId = c.ZohoCampaignsClientId
	case "ZohoCampaignsClientSecret":
		c.fileConfig.ZohoCampaignsClientSecret = c.ZohoCampaignsClientSecret
	case "ZohoCampaignsRefreshToken":
		c.fileConfig.ZohoCampaignsRefreshToken = c.ZohoCampaignsRefreshToken
	}
}
