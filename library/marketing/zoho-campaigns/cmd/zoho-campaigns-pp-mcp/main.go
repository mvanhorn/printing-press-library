...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/marketing/zoho-campaigns/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "zoho-campaigns-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
