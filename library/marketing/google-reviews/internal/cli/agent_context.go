...
func buildAgentDiscoveryContext() *agentContextDiscovery {
	return &agentContextDiscovery{
		...
		TargetURL:     "https://www.google.com/maps/preview/review/listentitiesreviews",
		EntryCount:    2,
		APIEntryCount: 2,
		...
		CandidateCommands: []string{
			"list_listentitiesreviews — Derived from observed GET /maps/preview/review/listentitiesreviews traffic.",
			"list_place — Derived from observed GET /maps/preview/place traffic.",
		},
	}
}
