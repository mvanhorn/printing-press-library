...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/marketing/google-reviews/internal/cliutil"
...
Resource scoping:
  ...
  google-reviews-pp-cli sync

  # Sync specific resources only
  google-reviews-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  google-reviews-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  google-reviews-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  google-reviews-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  google-reviews-pp-cli sync --latest-only`,
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/google-reviews-pp-cli/data.db)")
...
func defaultSyncResources() []string {
	return []string{
		"maps",
		"maps-preview-review-listentitiesreviews",
	}
}
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"maps": "/maps/preview/place",
		"maps-preview-review-listentitiesreviews": "/maps/preview/review/listentitiesreviews",
	}
