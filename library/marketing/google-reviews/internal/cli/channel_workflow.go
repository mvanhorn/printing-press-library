...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  google-reviews-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  google-reviews-pp-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"maps", "maps-preview-review-listentitiesreviews"}
			totalSynced := 0
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  google-reviews-pp-cli workflow status

  # Show status as JSON
  google-reviews-pp-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("google-reviews-pp-cli")
			}
