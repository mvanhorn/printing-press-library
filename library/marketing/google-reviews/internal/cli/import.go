...
but do not stop the import.`,
  ...
  google-reviews-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  google-reviews-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | google-reviews-pp-cli import <resource> --input -`,
