...
func newCampaignManagementDeleteCampaignsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:       "delete_campaigns",
		Example:     "  bing-ads-pp-cli campaign-management delete-campaigns",
		Annotations: map[string]string{"pp:endpoint": "campaign-management.delete-campaigns", "pp:method": "DELETE", "pp:path": "/CampaignManagement/v13/Campaigns"},
