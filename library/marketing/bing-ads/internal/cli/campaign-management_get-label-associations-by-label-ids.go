...
func newCampaignManagementGetLabelAssociationsByLabelIdsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-label-associations-by-label-ids",
		Short:       "get_label_associations_by_label_ids",
		Example:     "  bing-ads-pp-cli campaign-management get-label-associations-by-label-ids",
		Annotations: map[string]string{"pp:endpoint": "campaign-management.get-label-associations-by-label-ids", "pp:method": "POST", "pp:path": "/CampaignManagement/v13/LabelAssociations/QueryByLabelIds", "mcp:read-only": "true"},
