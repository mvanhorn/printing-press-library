...
func newCampaignManagementAppealEditorialRejectionsCmd(flags *rootFlags) *cobra.Command {
	var bodyEntityIdToParentIdAssociations string
	var bodyEntityType string
	var bodyJustificationText string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "appeal-editorial-rejections",
		Short:       "appeal_editorial_rejections",
		Example:     "  bing-ads-pp-cli campaign-management appeal-editorial-rejections",
		Annotations: map[string]string{"pp:endpoint": "campaign-management.appeal-editorial-rejections", "pp:method": "POST", "pp:path": "/CampaignManagement/v13/EditorialRejections/Appeal"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if stdinBody {
				...
				if cmd.Flags().Changed("justification-text") || bodyJustificationText != "" {
					bodyMap["JustificationText"] = bodyJustificationText
				}
			}
	...
	cmd.Flags().StringVar(&bodyJustificationText, "justification-text", "", "Justification text")
