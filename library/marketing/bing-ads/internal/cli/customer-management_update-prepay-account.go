...
func newCustomerManagementUpdatePrepayAccountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "update-prepay-account",
		Short:       "update_prepay_account",
		Example:     "  bing-ads-pp-cli customer-management update-prepay-account",
		Annotations: map[string]string{"pp:endpoint": "customer-management.update-prepay-account", "pp:method": "PUT", "pp:path": "/CustomerManagement/v13/PrepayAccount"},
