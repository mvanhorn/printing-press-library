...
func newCustomerManagementDeleteCustomerCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "delete-customer",
		Short:       "delete_customer",
		Example:     "  bing-ads-pp-cli customer-management delete-customer",
		Annotations: map[string]string{"pp:endpoint": "customer-management.delete-customer", "pp:method": "DELETE", "pp:path": "/CustomerManagement/v13/Customer"},
