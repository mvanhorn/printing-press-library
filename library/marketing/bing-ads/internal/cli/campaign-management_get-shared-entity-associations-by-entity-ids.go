...
func newCampaignManagementGetSharedEntityAssociationsByEntityIdsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-shared-entity-associations-by-entity-ids",
		Short:       "get_shared_entity_associations_by_entity_ids",
		Example:     "  bing-ads-pp-cli campaign-management get-shared-entity-associations-by-entity-ids",
		Annotations: map[string]string{"pp:endpoint": "campaign-management.get-shared-entity-associations-by-entity-ids", "pp:method": "POST", "pp:path": "/CampaignManagement/v13/SharedEntityAssociations/QueryByEntityIds", "mcp:read-only": "true"},
