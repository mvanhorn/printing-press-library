...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"bing-ads-pp-cli auth login",
		"bing-ads-pp-cli doctor",
		"bing-ads-pp-cli help items",
		"bing-ads-pp-cli sync",
		"bing-ads-pp-cli profile list",
		"bing-ads-pp-cli feedback list",
		"bing-ads-pp-cli which",
		"bing-ads-pp-cli agent-context",
		"bing-ads-pp-cli completion bash",
		"bing-ads-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"bing-ads-pp-cli recall",
		"bing-ads-pp-cli learnings",
		"bing-ads-pp-cli teach-pattern",
		"bing-ads-pp-cli teach-lookup",
		"bing-ads-pp-cli items list",
	}
