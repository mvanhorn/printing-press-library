...
func newCustomerManagementDeleteAccountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  bing-ads-pp-cli customer-management delete-account",
		Annotations: map[string]string{"pp:endpoint": "customer-management.delete-account", "pp:method": "DELETE", "pp:path": "/CustomerManagement/v13/Account"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if stdinBody {
				...
				if cmd.Flags().Changed("time-stamp") || bodyTimeStamp != "" {
	...
	cmd.Flags().StringVar(&bodyTimeStamp, "time-stamp", "", "Time stamp")
