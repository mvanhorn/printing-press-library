...
func newCampaignManagementDeleteKeywordsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "delete-keywords",
		Short:       "delete_keywords",
		Example:     "  bing-ads-pp-cli campaign-management delete-keywords",
		Annotations: map[string]string{"pp:endpoint": "campaign-management.delete-keywords", "pp:method": "DELETE", "pp:path": "/CampaignManagement/v13/Keywords"},
