...
func newCampaignManagementDeleteAdGroupCriterionsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "delete-ad-group-criterions",
		Short:       "delete_ad_group_criterions",
		Example:     "  bing-ads-pp-cli campaign-management delete-ad-group-criterions",
		Annotations: map[string]string{"pp:endpoint": "campaign-management.delete-ad-group-criterions", "pp:method": "DELETE", "pp:path": "/CampaignManagement/v13/AdGroupCriterions"},
