...
but do not stop the import.`,
  ...
  bing-ads-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  bing-ads-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | bing-ads-pp-cli import <resource> --input -`,
