...
func newCustomerManagementAddAccountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:       "add_account",
		Example:     "  bing-ads-pp-cli customer-management add-account",
		Annotations: map[string]string{"pp:endpoint": "customer-management.add-account", "pp:method": "POST", "pp:path": "/CustomerManagement/v13/Account"},
