...
import (
	...
	platform2 "github.com/mvanhorn/printing-press-library/library/marketing/bing-ads/internal/platform"
...
type rootFlags struct {
	...
	platformSession         *platform2.Session
	platformResolver        platform2.CredentialResolver
	platformResolverReady   bool
	platformAnalytics       *platform2.AnalyticsDeclaration
	platformGateError       error
	platformMetadataWriter  io.Writer
	receiptEnabled          bool
	receiptFile             string
	auditDir                string
	receiptWriter           *platform2.ReceiptWriter
...
Run 'bing-ads-pp-cli doctor' to verify auth and connectivity.`,
	...
	rootCmd.PersistentPreRunE = func(cmd *cobra.Command, args []string) error {
		...
		if _, err := cliutil2.SetHomeOverride(flags.homePath); err != nil {
			return err
		}
		...
		if platformCommandNeedsGate(cmd) {
			...
			cmd.SetContext(platform2.ContextWithSession(cmd.Context(), flags.platformSession))
