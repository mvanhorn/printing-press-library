...
import (
	...
	client2 "github.com/mvanhorn/printing-press-library/library/marketing/bing-ads/internal/client"
	...
	config2 "github.com/mvanhorn/printing-press-library/library/marketing/bing-ads/internal/config"
...
func newDoctorCmd(flags *rootFlags) *cobra.Command {
  ...
  bing-ads-pp-cli doctor --fail-on stale`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			// Check config
			cfg, err := config2.Load(flags.configPath)
			if err != nil {
			...
			if cfg != nil && cfg.BaseURL != "" {
				...
				if clientErr != nil {
					...
					var reachAPIErr *client2.APIError
					switch {
					case reachErr == nil:
			...
			if cliutil2.IsVerifyEnv() {
				if cliutil2.IsVerifyLiveHTTPEnv() {
