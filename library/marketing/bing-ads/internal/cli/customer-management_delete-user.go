...
func newCustomerManagementDeleteUserCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "delete-user",
		Short:       "delete_user",
		Example:     "  bing-ads-pp-cli customer-management delete-user",
		Annotations: map[string]string{"pp:endpoint": "customer-management.delete-user", "pp:method": "DELETE", "pp:path": "/CustomerManagement/v13/User"},
