...
func newCampaignManagementDeleteExperimentsCmd(flags *rootFlags) *cobra.Command {
	var bodyExperimentIds string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "delete-experiments",
		Short:       "delete_experiments",
		Example:     "  bing-ads-pp-cli campaign-management delete-experiments",
		Annotations: map[string]string{"pp:endpoint": "campaign-management.delete-experiments", "pp:method": "DELETE", "pp:path": "/CampaignManagement/v13/Experiments"},
