...
func newCampaignManagementDeleteAdGroupsCmd(flags *rootFlags) *cobra.Command {
	var bodyAdGroupIds string
	var bodyCampaignId string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "delete-ad-groups",
		Short:       "delete_ad_groups",
		Example:     "  bing-ads-pp-cli campaign-management delete-ad-groups",
		Annotations: map[string]string{"pp:endpoint": "campaign-management.delete-ad-groups", "pp:method": "DELETE", "pp:path": "/CampaignManagement/v13/AdGroups"},
