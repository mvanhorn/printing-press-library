			...
			if stdinBody {
				...
				body = bodyMap
				{
					...
					if cmd.Flags().Changed("asset-group-final-mobile-urls") {
						parsedAssetGroupFinalMobileUrls, parseErr := cliutil2.ParseStringList(bodyAssetGroupFinalMobileUrls)
						if parseErr != nil {
					...
					if cmd.Flags().Changed("asset-group-final-urls") {
						parsedAssetGroupFinalUrls, parseErr := cliutil2.ParseStringList(bodyAssetGroupFinalUrls)
						if parseErr != nil {
