...
func newCampaignManagementDeleteCampaignCriterionsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "delete-campaign-criterions",
		Short:       "delete_campaign_criterions",
		Example:     "  bing-ads-pp-cli campaign-management delete-campaign-criterions",
		Annotations: map[string]string{"pp:endpoint": "campaign-management.delete-campaign-criterions", "pp:method": "DELETE", "pp:path": "/CampaignManagement/v13/CampaignCriterions"},
