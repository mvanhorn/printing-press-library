...
func newCampaignManagementGetAssetGroupsByCampaignIdCmd(flags *rootFlags) *cobra.Command {
	var bodyCampaignId string
	var bodyReturnAdditionalFields string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "get-asset-groups-by-campaign-id",
		Short:       "get_asset_groups_by_campaign_id",
		Example:     "  bing-ads-pp-cli campaign-management get-asset-groups-by-campaign-id",
		Annotations: map[string]string{"pp:endpoint": "campaign-management.get-asset-groups-by-campaign-id", "pp:method": "POST", "pp:path": "/CampaignManagement/v13/AssetGroups/QueryByCampaignId", "mcp:read-only": "true"},
