...
func learnResourceTypeFields() map[string][]string {
	return map[string][]string{
		"ad-insight":          {"name", "title", "display_name", "full_name", "short_name", "label", "slug", "key", "code", "id", "address"},
		"bulk":                {"name", "title", "display_name", "full_name", "short_name", "label", "slug", "key", "code", "id", "address"},
		"campaign-management": {"name", "title", "display_name", "full_name", "short_name", "label", "slug", "key", "code", "id", "address"},
		"customer-billing":    {"name", "title", "display_name", "full_name", "short_name", "label", "slug", "key", "code", "id", "address"},
		"customer-management": {"name", "title", "display_name", "full_name", "short_name", "label", "slug", "key", "code", "id", "address"},
