...
func newCampaignManagementDeleteAdsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "delete-ads",
		Short:       "delete_ads",
		Example:     "  bing-ads-pp-cli campaign-management delete-ads",
		Annotations: map[string]string{"pp:endpoint": "campaign-management.delete-ads", "pp:method": "DELETE", "pp:path": "/CampaignManagement/v13/Ads"},
