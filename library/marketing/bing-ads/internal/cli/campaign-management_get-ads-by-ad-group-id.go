...
func newCampaignManagementGetAdsByAdGroupIdCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-ads-by-ad-group-id",
		Short:       "get_ads_by_ad_group_id",
		Example:     "  bing-ads-pp-cli campaign-management get-ads-by-ad-group-id",
		Annotations: map[string]string{"pp:endpoint": "campaign-management.get-ads-by-ad-group-id", "pp:method": "POST", "pp:path": "/CampaignManagement/v13/Ads/QueryByAdGroupId", "mcp:read-only": "true"},
