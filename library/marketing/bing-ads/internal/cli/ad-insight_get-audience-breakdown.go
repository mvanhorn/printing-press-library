			...
			if stdinBody {
				...
				body = bodyMap
				{
					...
					if cmd.Flags().Changed("age-excludes") {
						parsedAgeExcludes, parseErr := cliutil2.ParseStringList(bodyAgeExcludes)
						if parseErr != nil {
					...
					if cmd.Flags().Changed("age-includes") {
						parsedAgeIncludes, parseErr := cliutil2.ParseStringList(bodyAgeIncludes)
						if parseErr != nil {
				...
				}
				{
					...
					if cmd.Flags().Changed("audience-excludes") {
						parsedAudienceExcludes, parseErr := cliutil2.ParseStringList(bodyAudienceExcludes)
						if parseErr != nil {
					...
					if cmd.Flags().Changed("audience-includes") {
						parsedAudienceIncludes, parseErr := cliutil2.ParseStringList(bodyAudienceIncludes)
						if parseErr != nil {
				...
				}
				{
					...
					if cmd.Flags().Changed("company-excludes") {
						parsedCompanyExcludes, parseErr := cliutil2.ParseStringList(bodyCompanyExcludes)
						if parseErr != nil {
					...
					if cmd.Flags().Changed("company-includes") {
						parsedCompanyIncludes, parseErr := cliutil2.ParseStringList(bodyCompanyIncludes)
						if parseErr != nil {
				...
				}
				{
					...
					if cmd.Flags().Changed("device-excludes") {
						parsedDeviceExcludes, parseErr := cliutil2.ParseStringList(bodyDeviceExcludes)
						if parseErr != nil {
					...
					if cmd.Flags().Changed("device-includes") {
						parsedDeviceIncludes, parseErr := cliutil2.ParseStringList(bodyDeviceIncludes)
						if parseErr != nil {
				...
				}
				{
					...
					if cmd.Flags().Changed("gender-excludes") {
						parsedGenderExcludes, parseErr := cliutil2.ParseStringList(bodyGenderExcludes)
						if parseErr != nil {
					...
					if cmd.Flags().Changed("gender-includes") {
						parsedGenderIncludes, parseErr := cliutil2.ParseStringList(bodyGenderIncludes)
						if parseErr != nil {
				...
				}
				{
					...
					if cmd.Flags().Changed("industry-excludes") {
						parsedIndustryExcludes, parseErr := cliutil2.ParseStringList(bodyIndustryExcludes)
						if parseErr != nil {
					...
					if cmd.Flags().Changed("industry-includes") {
						parsedIndustryIncludes, parseErr := cliutil2.ParseStringList(bodyIndustryIncludes)
						if parseErr != nil {
				...
				}
				{
					...
					if cmd.Flags().Changed("job-function-excludes") {
						parsedJobFunctionExcludes, parseErr := cliutil2.ParseStringList(bodyJobFunctionExcludes)
						if parseErr != nil {
					...
					if cmd.Flags().Changed("job-function-includes") {
						parsedJobFunctionIncludes, parseErr := cliutil2.ParseStringList(bodyJobFunctionIncludes)
						if parseErr != nil {
				...
				}
				{
					...
					if cmd.Flags().Changed("location-excludes") {
						parsedLocationExcludes, parseErr := cliutil2.ParseStringList(bodyLocationExcludes)
						if parseErr != nil {
					...
					if cmd.Flags().Changed("location-includes") {
						parsedLocationIncludes, parseErr := cliutil2.ParseStringList(bodyLocationIncludes)
						if parseErr != nil {
				...
				}
				{
					...
					if cmd.Flags().Changed("placement-excludes") {
						parsedPlacementExcludes, parseErr := cliutil2.ParseStringList(bodyPlacementExcludes)
						if parseErr != nil {
					...
					if cmd.Flags().Changed("placement-includes") {
						parsedPlacementIncludes, parseErr := cliutil2.ParseStringList(bodyPlacementIncludes)
						if parseErr != nil {
				...
				}
				{
					...
					if cmd.Flags().Changed("topic-excludes") {
						parsedTopicExcludes, parseErr := cliutil2.ParseStringList(bodyTopicExcludes)
						if parseErr != nil {
					...
					if cmd.Flags().Changed("topic-includes") {
						parsedTopicIncludes, parseErr := cliutil2.ParseStringList(bodyTopicIncludes)
						if parseErr != nil {
