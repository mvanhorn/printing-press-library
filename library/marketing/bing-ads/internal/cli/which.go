...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  bing-ads-pp-cli which "stale tickets"
  bing-ads-pp-cli which "bottleneck"
  bing-ads-pp-cli which --limit 1 "send message"
  bing-ads-pp-cli which                                # list the full capability index`,
