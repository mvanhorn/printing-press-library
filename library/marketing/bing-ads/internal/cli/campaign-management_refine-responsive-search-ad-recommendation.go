			...
			if stdinBody {
				...
				body = bodyMap
				{
					...
					if cmd.Flags().Changed("responsive-search-ad-final-mobile-urls") {
						parsedResponsiveSearchAdFinalMobileUrls, parseErr := cliutil2.ParseStringList(bodyResponsiveSearchAdFinalMobileUrls)
						if parseErr != nil {
					...
					if cmd.Flags().Changed("responsive-search-ad-final-urls") {
						parsedResponsiveSearchAdFinalUrls, parseErr := cliutil2.ParseStringList(bodyResponsiveSearchAdFinalUrls)
						if parseErr != nil {
