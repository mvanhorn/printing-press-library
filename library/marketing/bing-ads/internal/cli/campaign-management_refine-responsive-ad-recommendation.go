			...
			if stdinBody {
				...
				}
				{
					...
					if cmd.Flags().Changed("responsive-ad-final-mobile-urls") {
						parsedResponsiveAdFinalMobileUrls, parseErr := cliutil2.ParseStringList(bodyResponsiveAdFinalMobileUrls)
						if parseErr != nil {
					...
					if cmd.Flags().Changed("responsive-ad-final-urls") {
						parsedResponsiveAdFinalUrls, parseErr := cliutil2.ParseStringList(bodyResponsiveAdFinalUrls)
						if parseErr != nil {
					...
					if cmd.Flags().Changed("responsive-ad-impression-tracking-urls") {
						parsedResponsiveAdImpressionTrackingUrls, parseErr := cliutil2.ParseStringList(bodyResponsiveAdImpressionTrackingUrls)
						if parseErr != nil {
