...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("SCREENCLOUD_STATE_DIR", "")
	t.Setenv("SCREENCLOUD_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"screencloud-pp-cli auth login",
		"screencloud-pp-cli doctor",
		"screencloud-pp-cli help items",
		"screencloud-pp-cli sync",
		"screencloud-pp-cli profile list",
		"screencloud-pp-cli feedback list",
		"screencloud-pp-cli which",
		"screencloud-pp-cli agent-context",
		"screencloud-pp-cli completion bash",
		"screencloud-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"screencloud-pp-cli recall",
		"screencloud-pp-cli learnings",
		"screencloud-pp-cli teach-pattern",
		"screencloud-pp-cli teach-lookup",
		"screencloud-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("screencloud-pp-cli")); err == nil {
