...
func buildAgentDiscoveryContext() *agentContextDiscovery {
	return &agentContextDiscovery{
		...
		TargetURL:     "https://studio.us.screencloud.com/apps/REDACTED/REDACTED",
		EntryCount:    8,
		APIEntryCount: 7,
		...
		AuthCandidates: []string{
			"in_app_browser_session_plus_api_key_replay",
		},
		Protections:     []string{},
		...
		CandidateCommands: []string{
			...
			"list_REDACTED — Derived from observed GET /data/REDACTED traffic.",
			"list_templates — Derived from observed GET /templates traffic.",
		},
	}
}
