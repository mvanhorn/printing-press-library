...
var whichIndex = []whichEntry{
	...
	{Command: "playgrounds create-reconcile", Description: "Turn a partial create receipt into a resume or cleanup plan; a no-op conclusion requires live verification.", Group: "Safe recovery", WhyItMatters: "Use this after an interrupted two-service create workflow instead of guessing which mutation is safe to repeat."},
