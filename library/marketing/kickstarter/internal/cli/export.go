...
large datasets as it has no memory pressure.`,
  ...
  kickstarter-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  kickstarter-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  kickstarter-pp-cli export <resource> --format jsonl | jq '.id'`,
