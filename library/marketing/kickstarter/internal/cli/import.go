...
but do not stop the import.`,
  ...
  kickstarter-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  kickstarter-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | kickstarter-pp-cli import <resource> --input -`,
