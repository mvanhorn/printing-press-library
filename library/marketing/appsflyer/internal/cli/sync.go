...
Exit codes & warnings:
  ...
  appsflyer-pp-cli sync

  # Sync specific resources only
  appsflyer-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  appsflyer-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  appsflyer-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  appsflyer-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  appsflyer-pp-cli sync --latest-only`,
