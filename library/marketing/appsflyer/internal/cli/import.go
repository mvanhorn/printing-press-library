...
but do not stop the import.`,
  ...
  appsflyer-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  appsflyer-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | appsflyer-pp-cli import <resource> --input -`,
