...
large datasets as it has no memory pressure.`,
  ...
  bookclicker-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  bookclicker-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  bookclicker-pp-cli export <resource> --format jsonl | jq '.id'`,
