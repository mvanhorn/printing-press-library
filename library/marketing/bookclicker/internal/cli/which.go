...
var whichIndex = []whichEntry{
	{Command: "plan", Description: "Find every newsletter that can run your book in a date window, ranked by fit.", Group: "Launch planning", WhyItMatters: "Reach for this instead of paging the marketplace: it answers 'who can promote this book, when, for how much' in one call."},
	{Command: "search", Description: "Full-text search every synced newsletter by name, pen name, or genre in milliseconds.", Group: "Launch planning", WhyItMatters: "Use for any 'which lists cover X' question rather than walking paginated API results."},
	{Command: "plan", Description: "Rank candidate lists by estimated opens per dollar instead of raw subscriber count.", Group: "Launch planning", WhyItMatters: "Biggest list is rarely the best value; this is the ranking the UI cannot express."},
	{Command: "swap-balance", Description: "See which swap partners agreed to a swap and then cancelled or declined.", Group: "Partner intelligence", WhyItMatters: "Use before rebooking a partner: it surfaces repeat cancellers that the product never flags."},
	{Command: "partner-roi", Description: "Rank past promo partners by delivered reach against what they cost.", Group: "Partner intelligence", WhyItMatters: "Use when deciding who to rebook; needs at least one prior sync of history."},
	{Command: "drift", Description: "Show newsletters whose open or click rate has decayed since earlier syncs.", Group: "Partner intelligence", WhyItMatters: "Catches decaying lists before you spend a launch slot on them."},
	{Command: "confirm-due", Description: "List every promo awaiting your confirmation, oldest first.", Group: "Operations", WhyItMatters: "This is the product's recurring manual chore; run it before confirming promos."},
	{Command: "launch health", Description: "Show which dates in a book's launch window still have no promo booked.", Group: "Operations", WhyItMatters: "Answers 'is this launch actually covered' without reading a calendar by eye."},
	{Command: "capacity", Description: "Show remaining Solo, Feature and Mention slots per newsletter per date.", Group: "Operations", WhyItMatters: "Use before sending an offer to confirm the slot type is actually available."},
	{Command: "stale", Description: "List pending offers that have gone unanswered the longest.", Group: "Operations", WhyItMatters: "Surfaces offers worth cancelling and rebooking elsewhere."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  bookclicker-pp-cli which "stale tickets"
  bookclicker-pp-cli which "bottleneck"
  bookclicker-pp-cli which --limit 1 "send message"
  bookclicker-pp-cli which                                # list the full capability index`,
