...
func TestDeclaredAPISurfaceReachable(t *testing.T) {
	expected := []string{
		...
		"calendars",
		"confirm-promos",
		"confirm-promos create",
		"confirm-promos options",
		"conversations",
		"external-reservations",
		"external-reservations create",
		"external-reservations update",
		"integrations",
		"inventories",
		"inventories get",
		"inventories set",
		...
		"reservations",
		"reservations accept",
		"reservations buyer-cancel",
		"reservations buyer-cancel-all",
		"reservations buyer-refund",
		"reservations decline",
		"reservations dismiss",
		"reservations refund-request",
		"reservations request-confirmation",
		"reservations seller-cancel",
		"reservations seller-cancel-all",
		"reservations seller-refund",
	}
