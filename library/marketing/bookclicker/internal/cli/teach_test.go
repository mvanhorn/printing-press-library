...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"bookclicker-pp-cli auth login",
		"bookclicker-pp-cli doctor",
		"bookclicker-pp-cli help items",
		"bookclicker-pp-cli sync",
		"bookclicker-pp-cli profile list",
		"bookclicker-pp-cli feedback list",
		"bookclicker-pp-cli which",
		"bookclicker-pp-cli agent-context",
		"bookclicker-pp-cli completion bash",
		"bookclicker-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"bookclicker-pp-cli recall",
		"bookclicker-pp-cli learnings",
		"bookclicker-pp-cli teach-pattern",
		"bookclicker-pp-cli teach-lookup",
		"bookclicker-pp-cli items list",
	}
