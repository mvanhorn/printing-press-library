...
but do not stop the import.`,
  ...
  bookclicker-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  bookclicker-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | bookclicker-pp-cli import <resource> --input -`,
