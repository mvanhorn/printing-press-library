...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/marketing/bookclicker/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("BOOKCLICKER_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "bookclicker-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
