...
func newMeGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get",
		Short:       "Current auth context: user, share token",
		Example:     "  umami-pp-cli me get",
		Annotations: map[string]string{"pp:endpoint": "me.get", "pp:method": "GET", "pp:path": "/api/me", "mcp:read-only": "true"},
