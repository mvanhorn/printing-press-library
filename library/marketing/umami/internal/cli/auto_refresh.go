...
var readCommandResources = map[string][]string{
	"umami-pp-cli admin":                 {"admin"},
	"umami-pp-cli admin list":            {"admin"},
	"umami-pp-cli admin get":             {"admin"},
	"umami-pp-cli admin search":          {"admin"},
	"umami-pp-cli admin-users":           {"admin-users"},
	"umami-pp-cli admin-users list":      {"admin-users"},
	"umami-pp-cli admin-users get":       {"admin-users"},
	"umami-pp-cli admin-users search":    {"admin-users"},
	"umami-pp-cli admin-websites":        {"admin-websites"},
	"umami-pp-cli admin-websites list":   {"admin-websites"},
	"umami-pp-cli admin-websites get":    {"admin-websites"},
	"umami-pp-cli admin-websites search": {"admin-websites"},
	"umami-pp-cli boards":                {"boards"},
	"umami-pp-cli boards list":           {"boards"},
	"umami-pp-cli boards get":            {"boards"},
	"umami-pp-cli boards search":         {"boards"},
	"umami-pp-cli links":                 {"links"},
	"umami-pp-cli links list":            {"links"},
	"umami-pp-cli links get":             {"links"},
	"umami-pp-cli links search":          {"links"},
	"umami-pp-cli me":                    {"me"},
	"umami-pp-cli me list":               {"me"},
	"umami-pp-cli me get":                {"me"},
	"umami-pp-cli me search":             {"me"},
	"umami-pp-cli me-websites":           {"me-websites"},
	"umami-pp-cli me-websites list":      {"me-websites"},
	"umami-pp-cli me-websites get":       {"me-websites"},
	"umami-pp-cli me-websites search":    {"me-websites"},
	"umami-pp-cli pixels":                {"pixels"},
	"umami-pp-cli pixels list":           {"pixels"},
	"umami-pp-cli pixels get":            {"pixels"},
	"umami-pp-cli pixels search":         {"pixels"},
	"umami-pp-cli reports":               {"reports"},
	"umami-pp-cli reports list":          {"reports"},
	"umami-pp-cli reports get":           {"reports"},
	"umami-pp-cli reports search":        {"reports"},
	"umami-pp-cli teams":                 {"teams"},
	"umami-pp-cli teams list":            {"teams"},
	"umami-pp-cli teams get":             {"teams"},
	"umami-pp-cli teams search":          {"teams"},
	"umami-pp-cli websites":              {"websites"},
	"umami-pp-cli websites list":         {"websites"},
	"umami-pp-cli websites get":          {"websites"},
	"umami-pp-cli websites search":       {"websites"},
}
...
func cachePolicy() cliutil.Policy {
	...
	envOptOut := "UMAMI_NO_AUTO_REFRESH"
...
func autoRefreshIfStale(ctx context.Context, flags *rootFlags, resources []string) (meta cliutil.FreshnessMeta) {
	...
	if err := runAutoRefresh(refreshCtx, flags, db, resources); err != nil {
		fmt.Fprintf(os.Stderr, "warning: using stale umami-pp-cli cache (refresh failed: %v)\n", err)
