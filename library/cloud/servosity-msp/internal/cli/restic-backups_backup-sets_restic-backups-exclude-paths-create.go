...
func newResticBackupsBackupSetsResticBackupsExcludePathsCreateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  servosity-msp-cli restic-backups backup-sets restic-backups-exclude-paths-create example-value example-value --path example-value",
