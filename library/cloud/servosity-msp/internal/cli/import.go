...
but do not stop the import.`,
  ...
  servosity-msp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  servosity-msp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | servosity-msp-cli import <resource> --input -`,
