...
func newCompanyNotesCreateCmd(flags *rootFlags) *cobra.Command {
	var bodyCompany int
	...
	cmd := &cobra.Command{
		Use:         "create",
		Short:       "Create",
		Example:     "  servosity-msp-cli company-notes create",
		Annotations: map[string]string{"pp:endpoint": "company-notes.create", "pp:method": "POST", "pp:path": "/company-notes/"},
