...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/cloud/servosity/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "servosity-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
