...
but do not stop the import.`,
  ...
  servosity-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  servosity-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | servosity-pp-cli import <resource> --input -`,
