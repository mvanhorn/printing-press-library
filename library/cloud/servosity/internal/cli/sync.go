...
Exit codes & warnings:
  ...
  servosity-pp-cli sync

  # Sync specific resources only
  servosity-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  servosity-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  servosity-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  servosity-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  servosity-pp-cli sync --latest-only`,
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/servosity-pp-cli/data.db)")
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "agent-login":
		return db.UpsertAgentLogin(data)
	case "agent-sessions":
		return db.UpsertAgentSessions(data)
	case "agent_logs":
		return db.UpsertAgentLogs(data)
	case "install_imagemanager":
		return db.UpsertInstallImagemanager(data)
	case "install_spx":
		return db.UpsertInstallSpx(data)
	case "push_imagemanager_notify_settings":
		return db.UpsertPushImagemanagerNotifySettings(data)
	case "push_spx_notify_settings":
		return db.UpsertPushSpxNotifySettings(data)
	case "push_spx_smtp_settings":
		return db.UpsertPushSpxSmtpSettings(data)
	case "restart_imagemanager":
		return db.UpsertRestartImagemanager(data)
	case "restart_spx":
		return db.UpsertRestartSpx(data)
	case "agent_sessions_restic_interrupt":
		return db.UpsertAgentSessionsResticInterrupt(data)
	case "spx_activate":
		return db.UpsertSpxActivate(data)
	case "update_beta":
		return db.UpsertUpdateBeta(data)
	case "update_latest":
		return db.UpsertUpdateLatest(data)
	case "backup-plans":
		return db.UpsertBackupPlans(data)
	case "backup-sets":
		return db.UpsertBackupSets(data)
	case "backups":
		return db.UpsertBackups(data)
	case "config_ini":
		return db.UpsertConfigIni(data)
	case "backups_encryption_key":
		return db.UpsertBackupsEncryptionKey(data)
	case "backups_encryption_key_versions":
		return db.UpsertBackupsEncryptionKeyVersions(data)
	case "backups_guarantee_eligible":
		return db.UpsertBackupsGuaranteeEligible(data)
	case "backups_guaranteed_recovery_point":
		return db.UpsertBackupsGuaranteedRecoveryPoint(data)
	case "login":
		return db.UpsertLogin(data)
	case "migrate_dr":
		return db.UpsertMigrateDr(data)
	case "password":
		return db.UpsertPassword(data)
	case "backups_reissue_spx_key":
		return db.UpsertBackupsReissueSpxKey(data)
	case "unlock":
		return db.UpsertUnlock(data)
	case "companies":
		return db.UpsertCompanies(data)
	case "companies_agent_session":
		return db.UpsertCompaniesAgentSession(data)
	case "companies_agents":
		return db.UpsertCompaniesAgents(data)
	case "backup_set_templates":
		return db.UpsertBackupSetTemplates(data)
	case "backup_stores":
		return db.UpsertBackupStores(data)
	case "c2c":
		return db.UpsertC2c(data)
	case "cloud_to_cloud_dashboard":
		return db.UpsertCloudToCloudDashboard(data)
	case "connectwise_download_url":
		return db.UpsertConnectwiseDownloadUrl(data)
	case "dr_snapshots":
		return db.UpsertDrSnapshots(data)
	case "dr_upload":
		return db.UpsertDrUpload(data)
	case "draas":
		return db.UpsertDraas(data)
	case "companies_email_report_subscription_delete":
		return db.UpsertCompaniesEmailReportSubscriptionDelete(data)
	case "companies_email_report_subscriptions":
		return db.UpsertCompaniesEmailReportSubscriptions(data)
	case "fully_managed_ng":
		return db.UpsertFullyManagedNg(data)
	case "fully_managed_setup_stage":
		return db.UpsertFullyManagedSetupStage(data)
	case "fully_managed_status":
		return db.UpsertFullyManagedStatus(data)
	case "imagemanager_info":
		return db.UpsertImagemanagerInfo(data)
	case "companies_issues":
		return db.UpsertCompaniesIssues(data)
	case "log_upload":
		return db.UpsertLogUpload(data)
	case "log_upload_list":
		return db.UpsertLogUploadList(data)
	case "companies_notes":
		return db.UpsertCompaniesNotes(data)
	case "other_info":
		return db.UpsertOtherInfo(data)
	case "recent_success":
		return db.UpsertRecentSuccess(data)
	case "restic_backup_failures":
		return db.UpsertResticBackupFailures(data)
	case "restic_snapshots":
		return db.UpsertResticSnapshots(data)
	case "restore_queues":
		return db.UpsertRestoreQueues(data)
	case "servosity_one":
		return db.UpsertServosityOne(data)
	case "servosity_one_conversion_request":
		return db.UpsertServosityOneConversionRequest(data)
	case "spx_backup_failures":
		return db.UpsertSpxBackupFailures(data)
	case "company-notes":
	...
	case "current-user":
		return db.UpsertCurrentUser(data)
	case "dr-backups":
		return db.UpsertDrBackups(data)
	case "dr_backups_agent_session":
		return db.UpsertDrBackupsAgentSession(data)
	case "dr_backups_agent_token":
		return db.UpsertDrBackupsAgentToken(data)
	case "dr_backups_encryption_key":
		return db.UpsertDrBackupsEncryptionKey(data)
	case "dr_backups_encryption_key_versions":
		return db.UpsertDrBackupsEncryptionKeyVersions(data)
	case "dr_backups_failures":
		return db.UpsertDrBackupsFailures(data)
	case "dr_backups_guarantee_eligible":
		return db.UpsertDrBackupsGuaranteeEligible(data)
	case "dr_backups_guaranteed_recovery_point":
		return db.UpsertDrBackupsGuaranteedRecoveryPoint(data)
	case "dr_backups_issues":
		return db.UpsertDrBackupsIssues(data)
	case "latest_offsite":
		return db.UpsertLatestOffsite(data)
	case "dr_backups_latest_success":
		return db.UpsertDrBackupsLatestSuccess(data)
	case "reboot_events":
		return db.UpsertRebootEvents(data)
	case "dr_backups_reissue_spx_key":
		return db.UpsertDrBackupsReissueSpxKey(data)
	case "selected_volumes":
		return db.UpsertSelectedVolumes(data)
	case "snapshot":
		return db.UpsertSnapshot(data)
	case "snapshot_chkdsk_results":
		return db.UpsertSnapshotChkdskResults(data)
	case "dr_backups_snapshots":
		return db.UpsertDrBackupsSnapshots(data)
	case "dr_backups_tunnel":
		return db.UpsertDrBackupsTunnel(data)
	case "issue-comments":
		return db.UpsertIssueComments(data)
	case "issues":
	...
	case "ignore":
		return db.UpsertIgnore(data)
	case "reactivate":
		return db.UpsertReactivate(data)
	case "report-subscriptions":
		return db.UpsertReportSubscriptions(data)
	case "reverify":
		return db.UpsertReverify(data)
	case "reseller-notes":
		return db.UpsertResellerNotes(data)
	case "resellers":
		return db.UpsertResellers(data)
	case "agent_install_token":
		return db.UpsertAgentInstallToken(data)
	case "resellers_agents":
		return db.UpsertResellersAgents(data)
	case "bill":
		return db.UpsertBill(data)
	case "billing_info":
		return db.UpsertBillingInfo(data)
	case "resellers_contracts":
		return db.UpsertResellersContracts(data)
	case "resellers_email_report_subscription_delete":
		return db.UpsertResellersEmailReportSubscriptionDelete(data)
	case "resellers_email_report_subscriptions":
		return db.UpsertResellersEmailReportSubscriptions(data)
	case "resellers_issues":
		return db.UpsertResellersIssues(data)
	case "resellers_notes":
		return db.UpsertResellersNotes(data)
	case "postmark_rotate":
		return db.UpsertPostmarkRotate(data)
	case "prices":
		return db.UpsertPrices(data)
	case "subscriptions":
		return db.UpsertSubscriptions(data)
	case "restic-backups":
		return db.UpsertResticBackups(data)
	case "agent_service_stop":
		return db.UpsertAgentServiceStop(data)
	case "agent_service_stop_error":
		return db.UpsertAgentServiceStopError(data)
	case "restic_backups_agent_session":
		return db.UpsertResticBackupsAgentSession(data)
	case "restic_backups_agent_token":
		return db.UpsertResticBackupsAgentToken(data)
	case "restic_backups_backup_sets":
		return db.UpsertResticBackupsBackupSets(data)
	case "restic_backups_encryption_key":
		return db.UpsertResticBackupsEncryptionKey(data)
	case "restic_backups_encryption_key_versions":
		return db.UpsertResticBackupsEncryptionKeyVersions(data)
	case "restic_backups_failures":
		return db.UpsertResticBackupsFailures(data)
	case "restic_backups_guarantee_eligible":
		return db.UpsertResticBackupsGuaranteeEligible(data)
	case "restic_backups_guaranteed_recovery_point":
		return db.UpsertResticBackupsGuaranteedRecoveryPoint(data)
	case "restic_backups_issues":
		return db.UpsertResticBackupsIssues(data)
	case "restic_backups_latest_success":
		return db.UpsertResticBackupsLatestSuccess(data)
	case "restic_check":
		return db.UpsertResticCheck(data)
	case "restic_env":
		return db.UpsertResticEnv(data)
	case "restic_backups_restic_interrupt":
		return db.UpsertResticBackupsResticInterrupt(data)
	case "restic_migrate":
		return db.UpsertResticMigrate(data)
	case "restic_prune":
		return db.UpsertResticPrune(data)
	case "restic_repair_index":
		return db.UpsertResticRepairIndex(data)
	case "restic_repair_snapshots":
		return db.UpsertResticRepairSnapshots(data)
	case "restic_unlock":
		return db.UpsertResticUnlock(data)
	case "snapshot_ls":
		return db.UpsertSnapshotLs(data)
	case "restic_backups_snapshots":
		return db.UpsertResticBackupsSnapshots(data)
	case "start_backup":
		return db.UpsertStartBackup(data)
	case "start_restore":
		return db.UpsertStartRestore(data)
	case "restic_backups_tunnel":
		return db.UpsertResticBackupsTunnel(data)
	case "users":
...
func defaultSyncResources() []string {
	return []string{
		...
		"admin-attention",
		"admin-dirty-repos",
		"admin-draas-in-progress",
		"admin-maxio-price-points",
		"admin-servosity-one-worker-token",
		"admin-support-staff",
		"admin-worker-agents",
		"admin-worker-run",
		"agent-login",
		...
		"current-user-start-mfa",
		"current-user-verified-mfa",
		"download",
		"dr-backups",
		"issues",
		"issues-archived",
		...
		"reports-clients",
		"reports-dr-from-email",
		"reports-maxio-price-points",
		"reports-product",
		"reports-stale-backup-sets",
		"reports-user-profiles",
		"reseller-notes",
		"resellers",
		"resellers-summary",
		"restic-backups",
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"admin":                            "/admin/users/",
		"admin-attention":                  "/admin/attention/",
		"admin-dirty-repos":                "/admin/dirty-repos/",
		"admin-draas-in-progress":          "/admin/draas-in-progress/",
		"admin-maxio-price-points":         "/admin/maxio-price-points/",
		"admin-servosity-one-worker-token": "/admin/servosity-one-worker-token/",
		"admin-support-staff":              "/admin/support-staff/",
		"admin-worker-agents":              "/admin/worker-agents/",
		"admin-worker-run":                 "/admin/worker-run/",
		"agent-login":                      "/agent-login/",
		"backup-plans":                     "/backup-plans/",
		"backup-search":                    "/backup-search/",
		"backups":                          "/backups/",
		"backups-mfa-codes":                "/backups/mfa_codes/",
		"companies":                        "/companies/",
		"companies-fully-managed":          "/companies/fully-managed/",
		"companies-fully-managed-ng":       "/companies/fully-managed-ng/",
		"companies-summary":                "/companies/summary/",
		"companies-summary-ng":             "/companies/summary-ng/",
		"company-notes":                    "/company-notes/",
		"components":                       "/components/",
		"contracts":                        "/contracts/",
		"contracts-signatures":             "/contracts/signatures/",
		"credentials":                      "/credentials/",
		"current-user":                     "/current-user/",
		"current-user-api-token":           "/current-user/api-token/",
		"current-user-groups":              "/current-user/groups/",
		"current-user-mfa-backup-codes":    "/current-user/mfa-backup-codes/",
		"current-user-notifications":       "/current-user/notifications/",
		"current-user-profile":             "/current-user/profile/",
		"current-user-start-mfa":           "/current-user/start-mfa/",
		"current-user-verified-mfa":        "/current-user/verified-mfa/",
		...
		"reports-dr-from-email":            "/reports/dr-from-email/",
		"reports-maxio-price-points":       "/reports/maxio-price-points/",
		"reports-product":                  "/reports/product/",
		"reports-stale-backup-sets":        "/reports/stale-backup-sets/",
		"reports-user-profiles":            "/reports/user-profiles/",
		"reseller-notes":                   "/reseller-notes/",
		"resellers":                        "/resellers/",
		"resellers-summary":                "/resellers/summary/",
		"restic-backups":                   "/restic-backups/",
		"restore-queue-web-login":          "/restore-queue-web-login/",
		"stats":                            "/stats/",
