...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  clickhouse-cloud-pp-cli which "stale tickets"
  clickhouse-cloud-pp-cli which "bottleneck"
  clickhouse-cloud-pp-cli which --limit 1 "send message"
  clickhouse-cloud-pp-cli which                                # list the full capability index`,
