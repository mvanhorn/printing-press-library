...
func newRolesCmd(flags *rootFlags) *cobra.Command {
	cmd := &cobra.Command{
		Use:         "roles",
		Short:       "Get, create, update, and delete roles",
		Hidden:      true,
	...
	cmd.AddCommand(newRolesGetListCmd(flags))
	cmd.AddCommand(newRolesPatchCmd(flags))
	cmd.AddCommand(newRolesPostCmd(flags))
	return cmd
}
