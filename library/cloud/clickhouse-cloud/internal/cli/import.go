...
but do not stop the import.`,
  ...
  clickhouse-cloud-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  clickhouse-cloud-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | clickhouse-cloud-pp-cli import <resource> --input -`,
