...
native streaming instead of polling.`,
  ...
  clickhouse-cloud-pp-cli tail --interval 10s

  # Tail a specific resource
  clickhouse-cloud-pp-cli tail messages --interval 5s

  # Pipe to jq for filtering
  clickhouse-cloud-pp-cli tail events --interval 30s | jq 'select(.type == "error")'`,
