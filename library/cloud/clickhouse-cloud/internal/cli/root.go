...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "clickhouse-cloud-pp-cli",
		Short: "Manage clickhouse-cloud resources via the clickhouse-cloud API",
		Long: `Manage clickhouse-cloud resources via the clickhouse-cloud API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'clickhouse-cloud-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("clickhouse-cloud-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'clickhouse-cloud-pp-cli profile list')")
	...
	rootCmd.AddCommand(newByocInfrastructureCmd(flags))
	...
	rootCmd.AddCommand(newPrivateEndpointConfigPromotedCmd(flags))
	rootCmd.AddCommand(newPrometheusPromotedCmd(flags))
	rootCmd.AddCommand(newUsageCostPromotedCmd(flags))
