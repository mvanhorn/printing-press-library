...
large datasets as it has no memory pressure.`,
  ...
  wpengine-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  wpengine-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  wpengine-pp-cli export <resource> --format jsonl | jq '.id'`,
