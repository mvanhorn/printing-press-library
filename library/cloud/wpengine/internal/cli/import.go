...
but do not stop the import.`,
  ...
  wpengine-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  wpengine-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | wpengine-pp-cli import <resource> --input -`,
