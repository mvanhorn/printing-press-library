...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("WPENGINE_STATE_DIR", "")
	t.Setenv("WPENGINE_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"wpengine-pp-cli auth login",
		"wpengine-pp-cli doctor",
		"wpengine-pp-cli help items",
		"wpengine-pp-cli sync",
		"wpengine-pp-cli profile list",
		"wpengine-pp-cli feedback list",
		"wpengine-pp-cli which",
		"wpengine-pp-cli agent-context",
		"wpengine-pp-cli completion bash",
		"wpengine-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"wpengine-pp-cli recall",
		"wpengine-pp-cli learnings",
		"wpengine-pp-cli teach-pattern",
		"wpengine-pp-cli teach-lookup",
		"wpengine-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("wpengine-pp-cli")); err == nil {
