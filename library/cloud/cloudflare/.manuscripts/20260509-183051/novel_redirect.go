...
The from-pattern is a URL pattern (e.g. "mitlæge.dk/*"). The to-template is a URL with
$1 / $2 backreferences for the wildcards (e.g. "https://klinikalarm.dk/$1").`,
		Example: `  cloudflare-pp-cli redirect set "mitlæge.dk/*" "https://klinikalarm.dk/$1" --zone mitlæge.dk --status 301`,
