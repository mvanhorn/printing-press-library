...
// resolveZoneID resolves a zone name (e.g. "klinikalarm.dk") to its zone ID.
...
Safe to run repeatedly with the same arguments — useful from scripts or agents.`,
		Example: `  cloudflare-pp-cli dns apply --zone klinikalarm.dk --type A --name @ --content 157.173.102.165 --proxied=false`,
	...
	cmd.Flags().StringVar(&zone, "zone", "", "Zone name or ID (e.g. klinikalarm.dk)")
