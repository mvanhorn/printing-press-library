...
but do not stop the import.`,
  ...
  google-cloud-run-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  google-cloud-run-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | google-cloud-run-pp-cli import <resource> --input -`,
