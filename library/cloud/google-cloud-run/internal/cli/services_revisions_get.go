...
func newServicesRevisionsGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  google-cloud-run-pp-cli services revisions get example-resource",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolveReadWithStrategy(cmd.Context(), c, flags, "auto", "revisions", false, path, params, nil, cmd.ErrOrStderr())
			if err != nil {
