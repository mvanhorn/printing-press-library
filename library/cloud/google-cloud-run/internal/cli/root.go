...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "google-cloud-run-pp-cli",
		Short: `Google Cloud Run CLI — Every Cloud Run service, job, and revision -- plus a deployment gate, exposure audit, and config diff that gcloud never…`,
		Long: `Google Cloud Run CLI — Every Cloud Run service, job, and revision -- plus a deployment gate, exposure audit, and config diff that gcloud never…
...
Health check: run 'google-cloud-run-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("google-cloud-run-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'google-cloud-run-pp-cli profile list')")
	...
	rootCmd.AddCommand(newNovelIamCmd(flags))
