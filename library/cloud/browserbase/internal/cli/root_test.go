...
func TestDeclaredAPISurfaceReachable(t *testing.T) {
	expected := []string{
		...
		"fetch",
		"functions",
		"functions builds-get",
		"functions builds-get-logs",
		"functions builds-list",
		"functions get",
		"functions invocations-get",
		"functions invocations-get-logs",
		"functions invoke",
		"functions invoke functions",
		"functions list",
		"functions versions",
		"functions versions functions-list",
		"functions versions-get",
		"functions versions-list-invocations",
		"projects",
		"projects get",
		"projects list",
		"projects usage",
		...
		"sessions create",
		"sessions debug",
		"sessions debug sessions-get",
		"sessions get",
		"sessions list",
		"sessions logs",
		"sessions logs sessions-get",
		"sessions recording",
		"sessions recording sessions-create-downloads",
		"sessions recording sessions-get",
		"sessions recording sessions-list-downloads",
		"sessions replays",
		"sessions replays sessions-get",
		"sessions replays sessions-get-page",
		"sessions update",
		"sessions uploads",
		"sessions uploads sessions-file",
		"websearch",
	}
