...
but do not stop the import.`,
  ...
  browserbase-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  browserbase-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | browserbase-pp-cli import <resource> --input -`,
