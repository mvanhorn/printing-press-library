...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"browserbase-pp-cli auth login",
		"browserbase-pp-cli doctor",
		"browserbase-pp-cli help items",
		"browserbase-pp-cli sync",
		"browserbase-pp-cli profile list",
		"browserbase-pp-cli feedback list",
		"browserbase-pp-cli which",
		"browserbase-pp-cli agent-context",
		"browserbase-pp-cli completion bash",
		"browserbase-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"browserbase-pp-cli recall",
		"browserbase-pp-cli learnings",
		"browserbase-pp-cli teach-pattern",
		"browserbase-pp-cli teach-lookup",
		"browserbase-pp-cli items list",
	}
