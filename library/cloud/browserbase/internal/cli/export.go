...
large datasets as it has no memory pressure.`,
  ...
  browserbase-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  browserbase-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  browserbase-pp-cli export <resource> --format jsonl | jq '.id'`,
