...
large datasets as it has no memory pressure.`,
  ...
  netlify-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  netlify-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  netlify-pp-cli export <resource> --format jsonl | jq '.id'`,
