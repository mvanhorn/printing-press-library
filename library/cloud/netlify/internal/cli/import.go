...
but do not stop the import.`,
  ...
  netlify-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  netlify-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | netlify-pp-cli import <resource> --input -`,
