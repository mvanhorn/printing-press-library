...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "netlify-pp-cli",
		Short: `Netlify CLI — Every Netlify API endpoint, plus a local SQLite mirror of your whole account so you can search, diff, and audit across …`,
		Long: `Netlify CLI — Every Netlify API endpoint, plus a local SQLite mirror of your whole account so you can search, diff, and audit across …
...
Health check: run 'netlify-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("netlify-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'netlify-pp-cli profile list')")
	...
	rootCmd.AddCommand(newAgentRunnersCmd(flags))
	rootCmd.AddCommand(newDeployKeysCmd(flags))
	rootCmd.AddCommand(newDeploysCmd(flags))
	rootCmd.AddCommand(newDnsZonesCmd(flags))
	...
	rootCmd.AddCommand(newNovelDeployDiffCmd(flags))
	rootCmd.AddCommand(newNovelDnsAuditCmd(flags))
	rootCmd.AddCommand(newNovelEnvDriftCmd(flags))
	rootCmd.AddCommand(newNovelOverviewCmd(flags))
	rootCmd.AddCommand(newNovelSinceCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newAiGatewayPromotedCmd(flags))
	rootCmd.AddCommand(newBillingPromotedCmd(flags))
	rootCmd.AddCommand(newBuildsPromotedCmd(flags))
	rootCmd.AddCommand(newPurgePromotedCmd(flags))
