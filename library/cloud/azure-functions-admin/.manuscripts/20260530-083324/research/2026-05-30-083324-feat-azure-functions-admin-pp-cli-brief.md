...
- This CLI is the Azure analog to the user's real production app (`example-ai-classifier`) and to the existing `cloud-run-admin` library entry — the user runs workloads on both Cloud Run and Azure Functions.
