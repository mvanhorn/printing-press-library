...
Resource scoping:
  ...
  azure-functions-admin-pp-cli sync --latest-only`,
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/github.com/mvanhorn/printing-press-library/library/cloud/azure-functions-admin/data.db)")
