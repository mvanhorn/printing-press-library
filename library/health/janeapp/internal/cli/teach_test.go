...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("JANEAPP_STATE_DIR", "")
	t.Setenv("JANEAPP_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"janeapp-pp-cli auth login",
		"janeapp-pp-cli doctor",
		"janeapp-pp-cli help items",
		"janeapp-pp-cli sync",
		"janeapp-pp-cli profile list",
		"janeapp-pp-cli feedback list",
		"janeapp-pp-cli which",
		"janeapp-pp-cli agent-context",
		"janeapp-pp-cli completion bash",
		"janeapp-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"janeapp-pp-cli recall",
		"janeapp-pp-cli learnings",
		"janeapp-pp-cli teach-pattern",
		"janeapp-pp-cli teach-lookup",
		"janeapp-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("janeapp-pp-cli")); err == nil {
