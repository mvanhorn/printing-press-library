# monthly.ps1  --  Monthly NEJM report (last 30 days)
#
# One-command workflow: fetch the last 30 days of NEJM articles through
...
# --- Report window / output configuration (the only difference vs weekly.ps1) ---
$WindowDays  = 30
$WindowLabel = 'last 30 days'
$ReportTitle = 'MONTHLY'
$BaseName    = 'monthly_articles'
