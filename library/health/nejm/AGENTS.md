# New England Journal of Medicine Printed CLI Agent Guide

This directory is a generated `nejm-pp-cli` printed CLI. It was produced by [CLI Printing Press](https://github.com/mvanhorn/cli-printing-press), so treat systemic fixes as upstream Printing Press fixes first. Keep local edits narrow and document why a generated-tree patch belongs here.
...
nejm-pp-cli agent-context --pretty
```

Use runtime discovery instead of relying on a copied command list:

```bash
nejm-pp-cli which "<capability>" --json
nejm-pp-cli <command> --help
```
...
```bash
nejm-pp-cli <command> --help
nejm-pp-cli <command> --dry-run --agent
```
