...
func looksLikeHTMLChallenge(title string, raw string) bool {
	...
	markers := []string{
		...
		"cf-mitigated",
		"_cf_chl_",
		// "challenge-platform" removed: CF injects /cdn-cgi/challenge-platform/scripts/jsd/main.js
		// into ALL pages (including real NEJM content), not just challenge pages. The other markers
		// (_cf_chl_, cf-challenge, etc.) are sufficient to detect genuine CF interstitials.
