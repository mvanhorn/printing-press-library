...
func TestMCPPathResolutionMatchesCLIResolverWithHomeEnv(t *testing.T) {
	...
	t.Setenv("CLINICAL_TRIALS_HOME", root)
...
func TestMCPPathResolutionMatchesCLIResolverWithPlatformDefaults(t *testing.T) {
	...
	if want := filepath.Join(home, ".config", "clinical-trials-pp-cli", "config.toml"); cfg.Path != want {
	...
	if want := filepath.Join(home, ".local", "share", "clinical-trials-pp-cli", "data.db"); gotDB != want {
...
func resetMCPPathEnv(t *testing.T) string {
	...
	for _, name := range []string{
		...
		"CLINICAL_TRIALS_CONFIG_DIR",
		"CLINICAL_TRIALS_DATA_DIR",
		"CLINICAL_TRIALS_STATE_DIR",
		"CLINICAL_TRIALS_CACHE_DIR",
		"CLINICAL_TRIALS_HOME",
		"XDG_CONFIG_HOME",
		"XDG_DATA_HOME",
		"XDG_STATE_HOME",
		"XDG_CACHE_HOME",
