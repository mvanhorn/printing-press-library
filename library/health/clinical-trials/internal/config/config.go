...
func Load(configPath string) (*Config, error) {
	...
	if v := os.Getenv("CLINICAL_TRIALS_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("CLINICAL_TRIALS_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "clinical-trials-pp-cli", "config.toml"), nil
}
