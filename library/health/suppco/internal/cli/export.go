...
large datasets as it has no memory pressure.`,
  ...
  suppco-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  suppco-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  suppco-pp-cli export <resource> --format jsonl | jq '.id'`,
