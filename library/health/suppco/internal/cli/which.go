...
var whichIndex = []whichEntry{
	{Command: "regimen snapshot", Description: "Combines the current stack and one dated provider schedule into deterministic JSON while preserving nutrient relationships and separate observation times.", Group: "Private provider normalization", WhyItMatters: "Use this when an agent needs a bounded import candidate rather than raw SuppCo account payloads."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  suppco-pp-cli which "stale tickets"
  suppco-pp-cli which "bottleneck"
  suppco-pp-cli which --limit 1 "send message"
  suppco-pp-cli which                                # list the full capability index`,
