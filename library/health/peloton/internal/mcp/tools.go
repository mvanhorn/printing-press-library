...
func handleContext(_ context.Context, _ mcplib.CallToolRequest) (*mcplib.CallToolResult, error) {
	...
	ctx := map[string]any{
		...
		"query_tips": []string{
			...
			"offline_workout nests output under detail/history, and any offline command that returns a caveat wraps its result under result -- use dotted --select paths (e.g. --select detail.title, --select result.segments) to reach fields that aren't at the top level.",
