...
### Clear an external-hours backlog

```bash
dreaming external import weeks-of-podcasts.csv --preview
```

Bulk-logs date,minutes,description rows the web app would force you to enter one at a time (drop --preview to actually write).
