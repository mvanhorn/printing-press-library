...
func newUserPromotedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "user",
		Short:       "Get your account stats (hours, daily goal, subscription)",
		Long:        "Get your account stats (hours, daily goal, subscription)",
		Example:     "  dreaming-pp-cli user",
	...
	cmd.Flags().StringVar(&flagTimezone, "timezone", "", "IANA timezone (e.g. America/New_York) for day boundaries")
