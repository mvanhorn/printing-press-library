...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "dreaming-pp-cli",
		Short: `Dreaming CLI — Every Dreaming Spanish and French tracking feature in one offline-first CLI - roadmap math, catalog search, and bulk ho…`,
		Long: `Dreaming CLI — Every Dreaming Spanish and French tracking feature in one offline-first CLI - roadmap math, catalog search, and bulk ho…
