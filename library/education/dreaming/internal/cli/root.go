...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "dreaming-pp-cli",
		Short: `Dreaming CLI — Every Dreaming Spanish and French tracking feature in one offline-first CLI - roadmap math, catalog search, and bulk hour-logging`,
		Long: `Dreaming CLI — Every Dreaming Spanish and French tracking feature in one offline-first CLI - roadmap math, catalog search, and bulk hour-logging
...
See README.md or the bundled SKILL.md for recipes.`,
	...
	rootCmd.SetVersionTemplate("dreaming-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'dreaming-pp-cli profile list')")
	...
	rootCmd.AddCommand(newExternalTimeCmd(flags))
	...
	rootCmd.AddCommand(newNovelConcordanceCmd(flags))
	rootCmd.AddCommand(newNovelDietCmd(flags))
	rootCmd.AddCommand(newNovelExternalCmd(flags))
	rootCmd.AddCommand(newNovelNextCmd(flags))
	rootCmd.AddCommand(newNovelRoadmapCmd(flags))
	rootCmd.AddCommand(newNovelTranscriptCmd(flags))
	...
	rootCmd.AddCommand(newDayWatchedTimePromotedCmd(flags))
	rootCmd.AddCommand(newInspectExternalVideoPromotedCmd(flags))
	rootCmd.AddCommand(newPlaylistPromotedCmd(flags))
	rootCmd.AddCommand(newSignInPromotedCmd(flags))
	rootCmd.AddCommand(newUserPromotedCmd(flags))
	rootCmd.AddCommand(newVideoPromotedCmd(flags))
	rootCmd.AddCommand(newVideosPromotedCmd(flags))
