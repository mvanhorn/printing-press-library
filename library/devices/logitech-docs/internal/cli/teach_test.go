...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/devices/logitech-docs/internal/cliutil/testenv"
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"logitech-docs-pp-cli auth login",
		"logitech-docs-pp-cli doctor",
		"logitech-docs-pp-cli help items",
		"logitech-docs-pp-cli sync",
		"logitech-docs-pp-cli profile list",
		"logitech-docs-pp-cli feedback list",
		"logitech-docs-pp-cli which",
		"logitech-docs-pp-cli agent-context",
		"logitech-docs-pp-cli completion bash",
		"logitech-docs-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"logitech-docs-pp-cli recall",
		"logitech-docs-pp-cli learnings",
		"logitech-docs-pp-cli teach-pattern",
		"logitech-docs-pp-cli teach-lookup",
		"logitech-docs-pp-cli items list",
	}
