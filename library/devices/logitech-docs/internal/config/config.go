...
func Load(configPath string) (*Config, error) {
	cfg := &Config{
		BaseURL: "https://support.logi.com",
	}
	...
	if v := os.Getenv("LOGITECH_DOCS_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("LOGITECH_DOCS_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "logitech-docs-pp-cli", "config.json"), nil
}
