...
but do not stop the import.`,
  ...
  synology-router-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  synology-router-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | synology-router-pp-cli import <resource> --input -`,
