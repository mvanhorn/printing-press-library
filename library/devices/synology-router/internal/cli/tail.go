...
native streaming instead of polling.`,
  ...
  synology-router-pp-cli tail --interval 10s

  # Tail a specific resource
  synology-router-pp-cli tail messages --interval 5s

  # Pipe to jq for filtering
  synology-router-pp-cli tail events --interval 30s | jq 'select(.type == "error")'`,
	...
	cmd.Flags().StringVar(&resource, "resource", "", "Resource type to tail for real-time updates (e.g. traffic, devices)")
