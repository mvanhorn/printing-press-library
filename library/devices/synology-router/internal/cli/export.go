...
large datasets as it has no memory pressure.`,
  ...
  synology-router-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  synology-router-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  synology-router-pp-cli export <resource> --format jsonl | jq '.id'`,
