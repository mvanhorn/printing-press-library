...
Data must be synced first with the sync command.`,
  ...
  synology-router-pp-cli analytics --type messages

  # Group by a field
  synology-router-pp-cli analytics --type messages --group-by author_id

  # Top 10 most frequent values
  synology-router-pp-cli analytics --type messages --group-by channel_id --limit 10 --json`,
	...
	cmd.Flags().StringVar(&resourceType, "type", "", "Resource type to analyze from the synced database (e.g. devices, traffic, firewall)")
