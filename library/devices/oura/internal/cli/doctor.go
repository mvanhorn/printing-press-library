		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if cfg != nil {
				...
				if header == "" {
					...
					report["auth_hint"] = "export OURA_ACCESS_TOKEN=<your-key>"
				} else {
					authConfigured = true
			...
			if os.Getenv("OURA_ACCESS_TOKEN") != "" {
				authEnvSet = append(authEnvSet, "OURA_ACCESS_TOKEN")
				...
				authEnvRequiredMissing = append(authEnvRequiredMissing, "OURA_ACCESS_TOKEN")
			}
			switch {
			...
			if cfg != nil && cfg.BaseURL != "" {
				...
				if clientErr != nil {
					...
					healthPath := "/v2/usercollection/personal_info"
