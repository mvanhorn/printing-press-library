...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  oura-pp-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"daily-activity", "daily-readiness", "daily-resilience", "daily-sleep", "daily-spo2", "daily-stress", "enhanced-tag", "rest-mode-period", "ring-configuration", "session", "sleep", "sleep-time", "webhook-subscription", "workout"}
			totalSynced := 0
