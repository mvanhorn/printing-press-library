...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "oura-pp-cli",
		Short: `Oura CLI — The only Oura Ring CLI that remembers everything: sync all metrics to local SQLite, correlate habits with scores, detec…`,
		Long: `Oura CLI — The only Oura Ring CLI that remembers everything: sync all metrics to local SQLite, correlate habits with scores, detec…
...
Health check: run 'oura-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
	...
	rootCmd.AddCommand(newEnhancedTagCmd(flags))
	rootCmd.AddCommand(newWebhookSubscriptionCmd(flags))
	...
	rootCmd.AddCommand(newNovelAlertCmd(flags))
	rootCmd.AddCommand(newNovelAnomaliesCmd(flags))
	rootCmd.AddCommand(newNovelBaselineCmd(flags))
	...
	rootCmd.AddCommand(newNovelEventCmd(flags))
	rootCmd.AddCommand(newNovelGapsCmd(flags))
	rootCmd.AddCommand(newNovelHrvTrendCmd(flags))
	rootCmd.AddCommand(newNovelSleepStagesCmd(flags))
	rootCmd.AddCommand(newNovelTrainingLoadCmd(flags))
	rootCmd.AddCommand(newNovelWebhookCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newDailyActivityPromotedCmd(flags))
	rootCmd.AddCommand(newDailyCardiovascularAgePromotedCmd(flags))
	rootCmd.AddCommand(newDailyReadinessPromotedCmd(flags))
	rootCmd.AddCommand(newDailyResiliencePromotedCmd(flags))
	rootCmd.AddCommand(newDailySleepPromotedCmd(flags))
	rootCmd.AddCommand(newDailySpo2PromotedCmd(flags))
	rootCmd.AddCommand(newDailyStressPromotedCmd(flags))
	rootCmd.AddCommand(newHeartratePromotedCmd(flags))
	rootCmd.AddCommand(newPersonalInfoPromotedCmd(flags))
	rootCmd.AddCommand(newRestModePeriodPromotedCmd(flags))
	rootCmd.AddCommand(newRingConfigurationPromotedCmd(flags))
	rootCmd.AddCommand(newSessionPromotedCmd(flags))
	rootCmd.AddCommand(newSleepPromotedCmd(flags))
	rootCmd.AddCommand(newSleepTimePromotedCmd(flags))
	rootCmd.AddCommand(newWorkoutPromotedCmd(flags))
