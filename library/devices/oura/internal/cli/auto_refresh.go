...
var readCommandResources = map[string][]string{
	"oura-pp-cli daily-activity":                  {"daily-activity"},
	"oura-pp-cli daily-activity list":             {"daily-activity"},
	"oura-pp-cli daily-activity get":              {"daily-activity"},
	"oura-pp-cli daily-activity search":           {"daily-activity"},
	"oura-pp-cli daily-cardiovascular-age":        {"daily-cardiovascular-age"},
	"oura-pp-cli daily-cardiovascular-age list":   {"daily-cardiovascular-age"},
	"oura-pp-cli daily-cardiovascular-age get":    {"daily-cardiovascular-age"},
	"oura-pp-cli daily-cardiovascular-age search": {"daily-cardiovascular-age"},
	"oura-pp-cli daily-readiness":                 {"daily-readiness"},
	"oura-pp-cli daily-readiness list":            {"daily-readiness"},
	"oura-pp-cli daily-readiness get":             {"daily-readiness"},
	"oura-pp-cli daily-readiness search":          {"daily-readiness"},
	"oura-pp-cli daily-resilience":                {"daily-resilience"},
	"oura-pp-cli daily-resilience list":           {"daily-resilience"},
	"oura-pp-cli daily-resilience get":            {"daily-resilience"},
	"oura-pp-cli daily-resilience search":         {"daily-resilience"},
	"oura-pp-cli daily-sleep":                     {"daily-sleep"},
	"oura-pp-cli daily-sleep list":                {"daily-sleep"},
	"oura-pp-cli daily-sleep get":                 {"daily-sleep"},
	"oura-pp-cli daily-sleep search":              {"daily-sleep"},
	"oura-pp-cli daily-spo2":                      {"daily-spo2"},
	"oura-pp-cli daily-spo2 list":                 {"daily-spo2"},
	"oura-pp-cli daily-spo2 get":                  {"daily-spo2"},
	"oura-pp-cli daily-spo2 search":               {"daily-spo2"},
	"oura-pp-cli daily-stress":                    {"daily-stress"},
	"oura-pp-cli daily-stress list":               {"daily-stress"},
	"oura-pp-cli daily-stress get":                {"daily-stress"},
	"oura-pp-cli daily-stress search":             {"daily-stress"},
	"oura-pp-cli enhanced-tag":                    {"enhanced-tag"},
	"oura-pp-cli enhanced-tag list":               {"enhanced-tag"},
	"oura-pp-cli enhanced-tag get":                {"enhanced-tag"},
	"oura-pp-cli enhanced-tag search":             {"enhanced-tag"},
	"oura-pp-cli heartrate":                       {"heartrate"},
	"oura-pp-cli heartrate list":                  {"heartrate"},
	"oura-pp-cli heartrate get":                   {"heartrate"},
	"oura-pp-cli heartrate search":                {"heartrate"},
	"oura-pp-cli rest-mode-period":                {"rest-mode-period"},
	"oura-pp-cli rest-mode-period list":           {"rest-mode-period"},
	"oura-pp-cli rest-mode-period get":            {"rest-mode-period"},
	"oura-pp-cli rest-mode-period search":         {"rest-mode-period"},
	"oura-pp-cli ring-configuration":              {"ring-configuration"},
	"oura-pp-cli ring-configuration list":         {"ring-configuration"},
	"oura-pp-cli ring-configuration get":          {"ring-configuration"},
	"oura-pp-cli ring-configuration search":       {"ring-configuration"},
	"oura-pp-cli session":                         {"session"},
	"oura-pp-cli session list":                    {"session"},
	"oura-pp-cli session get":                     {"session"},
	"oura-pp-cli session search":                  {"session"},
	"oura-pp-cli sleep":                           {"sleep"},
	"oura-pp-cli sleep list":                      {"sleep"},
	"oura-pp-cli sleep get":                       {"sleep"},
	"oura-pp-cli sleep search":                    {"sleep"},
	"oura-pp-cli sleep-time":                      {"sleep-time"},
	"oura-pp-cli sleep-time list":                 {"sleep-time"},
	"oura-pp-cli sleep-time get":                  {"sleep-time"},
	"oura-pp-cli sleep-time search":               {"sleep-time"},
	"oura-pp-cli webhook-subscription":            {"webhook-subscription"},
	"oura-pp-cli webhook-subscription list":       {"webhook-subscription"},
	"oura-pp-cli webhook-subscription get":        {"webhook-subscription"},
	"oura-pp-cli webhook-subscription search":     {"webhook-subscription"},
	"oura-pp-cli workout":                         {"workout"},
	"oura-pp-cli workout list":                    {"workout"},
	"oura-pp-cli workout get":                     {"workout"},
	"oura-pp-cli workout search":                  {"workout"},
}
...
func cachePolicy() cliutil.Policy {
	...
	envOptOut := "OURA_NO_AUTO_REFRESH"
...
func autoRefreshIfStale(ctx context.Context, flags *rootFlags, resources []string) (meta cliutil.FreshnessMeta) {
	...
	if err := runAutoRefresh(refreshCtx, flags, db, resources); err != nil {
		fmt.Fprintf(os.Stderr, "warning: using stale oura-pp-cli cache (refresh failed: %v)\n", err)
