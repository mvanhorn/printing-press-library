...
but do not stop the import.`,
  ...
  synology-dsm-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  synology-dsm-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | synology-dsm-pp-cli import <resource> --input -`,
