...
func newWebapiStartContainerCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  synology-dsm-pp-cli webapi start-container --name example-resource",
		Annotations: map[string]string{"pp:endpoint": "webapi.start-container", "pp:method": "POST", "pp:path": "/webapi/entry.cgi/docker/container/start"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "/webapi/entry.cgi/docker/container/start"
	...
	cmd.Flags().StringVar(&bodyMethod, "method", "start", "API method (constant: start)")
