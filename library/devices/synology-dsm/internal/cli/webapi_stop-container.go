...
func newWebapiStopContainerCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  synology-dsm-pp-cli webapi stop-container --name example-resource",
		Annotations: map[string]string{"pp:endpoint": "webapi.stop-container", "pp:method": "POST", "pp:path": "/webapi/entry.cgi/docker/container/stop"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "/webapi/entry.cgi/docker/container/stop"
