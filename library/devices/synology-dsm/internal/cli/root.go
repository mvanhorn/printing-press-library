...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "synology-dsm-pp-cli",
		Short: "Manage synology-dsm resources via the synology-dsm API",
		Long: `Manage synology-dsm resources via the synology-dsm API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'synology-dsm-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("synology-dsm-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'synology-dsm-pp-cli profile list')")
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("synology-dsm-pp-cli %s\n", version)
		},
	}
}
