...
func newWebapiRestartContainerCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  synology-dsm-pp-cli webapi restart-container --name example-resource",
		Annotations: map[string]string{"pp:endpoint": "webapi.restart-container", "pp:method": "POST", "pp:path": "/webapi/entry.cgi/docker/container/restart"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "/webapi/entry.cgi/docker/container/restart"
	...
	cmd.Flags().StringVar(&bodyMethod, "method", "restart", "API method (constant: restart)")
