...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"extron-pp-cli auth login",
		"extron-pp-cli doctor",
		"extron-pp-cli help items",
		"extron-pp-cli sync",
		"extron-pp-cli profile list",
		"extron-pp-cli feedback list",
		"extron-pp-cli which",
		"extron-pp-cli agent-context",
		"extron-pp-cli completion bash",
		"extron-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"extron-pp-cli teach",
		"extron-pp-cli recall",
		"extron-pp-cli learnings",
		"extron-pp-cli teach-pattern",
		"extron-pp-cli teach-lookup",
		"extron-pp-cli items list",
	}
