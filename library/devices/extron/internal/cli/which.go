...
var whichIndex = []whichEntry{
	{Command: "literature updates", Description: "See which downloaded spec sheets and manuals have a newer revision available upstream, so project shares never run stale docs.", Group: "Local catalog that compounds", WhyItMatters: "Use this before commissioning or re-quoting to catch docs superseded since the last sync."},
	{Command: "catalog completeness", Description: "Per-model gap report across Brochure, Declaration of Conformity, Design Guide, Product Guide, Manual, and Revit BIM — see which doc types each model is missing.", Group: "Local catalog that compounds", WhyItMatters: "Use it before a bid submittal or commissioning checklist to catch missing compliance or reference docs."},
	{Command: "literature recent", Description: "Newest Extron literature across the whole library, ordered by date, filterable by category and age.", Group: "Local catalog that compounds", WhyItMatters: "Use it to track manual/firmware-doc releases without re-checking the website."},
	{Command: "literature rack", Description: "Assemble the full official doc set for every model in a rack bill of materials — report or batch-download in one pass.", Group: "Project-driven assembly", WhyItMatters: "Use it when a project's doc binder must match the exact gear list on the job."},
	{Command: "literature family", Description: "Browse every document for a product family (DTP, MAV, IPL, DVS, ...) across all alphabetical letters at once.", Group: "Local catalog that compounds", WhyItMatters: "Use it to pull every doc for a family before writing control code or a design guide review."},
	{Command: "catalog verify", Description: "Compare local PDF sizes against the download ledger to flag truncated or mismatched downloads.", Group: "Local catalog that compounds", WhyItMatters: "Use it after a batch download or sync to confirm every PDF landed complete and current."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  extron-pp-cli which "stale tickets"
  extron-pp-cli which "bottleneck"
  extron-pp-cli which --limit 1 "send message"
  extron-pp-cli which                                # list the full capability index`,
