...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"qsys-pp-cli auth login",
		"qsys-pp-cli doctor",
		"qsys-pp-cli help items",
		"qsys-pp-cli sync",
		"qsys-pp-cli profile list",
		"qsys-pp-cli feedback list",
		"qsys-pp-cli which",
		"qsys-pp-cli agent-context",
		"qsys-pp-cli completion bash",
		"qsys-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"qsys-pp-cli teach",
		"qsys-pp-cli recall",
		"qsys-pp-cli learnings",
		"qsys-pp-cli teach-pattern",
		"qsys-pp-cli teach-lookup",
		"qsys-pp-cli items list",
	}
