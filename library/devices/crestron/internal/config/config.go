...
func Load(configPath string) (*Config, error) {
	cfg := &Config{
		BaseURL: "https://www.crestron.com",
	}
	...
	if v := os.Getenv("CRESTRON_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("CRESTRON_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "crestron-pp-cli", "config.toml"), nil
}
