...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/devices/crestron/internal/cliutil/testenv"
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"crestron-pp-cli auth login",
		"crestron-pp-cli doctor",
		"crestron-pp-cli help items",
		"crestron-pp-cli sync",
		"crestron-pp-cli profile list",
		"crestron-pp-cli feedback list",
		"crestron-pp-cli which",
		"crestron-pp-cli agent-context",
		"crestron-pp-cli completion bash",
		"crestron-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"crestron-pp-cli recall",
		"crestron-pp-cli learnings",
		"crestron-pp-cli teach-pattern",
		"crestron-pp-cli teach-lookup",
		"crestron-pp-cli items list",
	}
