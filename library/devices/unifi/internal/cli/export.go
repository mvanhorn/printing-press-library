...
large datasets as it has no memory pressure.`,
  ...
  unifi-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  unifi-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  unifi-pp-cli export <resource> --format jsonl | jq '.id'`,
