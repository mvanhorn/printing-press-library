...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"unifi-pp-cli auth login",
		"unifi-pp-cli doctor",
		"unifi-pp-cli help items",
		"unifi-pp-cli sync",
		"unifi-pp-cli profile list",
		"unifi-pp-cli feedback list",
		"unifi-pp-cli which",
		"unifi-pp-cli agent-context",
		"unifi-pp-cli completion bash",
		"unifi-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"unifi-pp-cli teach",
		"unifi-pp-cli recall",
		"unifi-pp-cli learnings",
		"unifi-pp-cli teach-pattern",
		"unifi-pp-cli teach-lookup",
		"unifi-pp-cli items list",
	}
