...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/devices/unifi/internal/learn/lookups"
...
Resource scoping:
  ...
  unifi-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  unifi-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  unifi-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  unifi-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  unifi-pp-cli sync --latest-only`,
...
func determinePaginationDefaults(resource string) paginationDefaults {
	...
	case "sites/traffic_matching_lists":
		return paginationDefaults{
			cursorParam: "offset",
			cursorType:  "offset",
			limitParam:  "limit",
	...
	case "sites/v1_sites_firewall_policies":
		return paginationDefaults{
			cursorParam: "offset",
			cursorType:  "offset",
			limitParam:  "limit",
	...
	case "sites/v1_sites_firewall_zones":
		return paginationDefaults{
			cursorParam: "offset",
			cursorType:  "offset",
			limitParam:  "limit",
	...
	case "sites/v1_sites_switching_lags":
		return paginationDefaults{
			cursorParam: "offset",
			cursorType:  "offset",
			limitParam:  "limit",
	...
	case "sites/v1_sites_switching_mc_lag_domains":
		return paginationDefaults{
			cursorParam: "offset",
			cursorType:  "offset",
			limitParam:  "limit",
	...
	case "sites/v1_sites_switching_switch_stacks":
		return paginationDefaults{
			cursorParam: "offset",
			cursorType:  "offset",
			limitParam:  "limit",
	...
	case "sites/v1_sites_vpn_servers":
		return paginationDefaults{
			cursorParam: "offset",
			cursorType:  "offset",
			limitParam:  "limit",
	...
	case "sites/v1_sites_vpn_site_to_site_tunnels":
		return paginationDefaults{
			cursorParam: "offset",
			cursorType:  "offset",
			limitParam:  "limit",
...
func resourceSupportsPagination(resource string) bool {
	...
	case "traffic_matching_lists":
		return true
	case "v1_sites_firewall_policies":
		return true
	case "v1_sites_firewall_zones":
		return true
	case "v1_sites_switching_lags":
		return true
	case "v1_sites_switching_mc_lag_domains":
		return true
	case "v1_sites_switching_switch_stacks":
		return true
	case "v1_sites_vpn_servers":
		return true
	case "v1_sites_vpn_site_to_site_tunnels":
		return true
	case "wans":
		return true
	case "wifi":
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	switch resource {
	case "acl_rules":
		return db.UpsertAclRules(data)
	case "clients":
		return db.UpsertClients(data)
	case "device_tags":
		return db.UpsertDeviceTags(data)
	case "devices":
		return db.UpsertDevices(data)
	case "dns":
		return db.UpsertDns(data)
	case "firewall":
		return db.UpsertFirewall(data)
	case "hotspot":
		return db.UpsertHotspot(data)
	case "networks":
		return db.UpsertNetworks(data)
	case "radius":
		return db.UpsertRadius(data)
	case "switching":
		return db.UpsertSwitching(data)
	case "traffic_matching_lists":
		return db.UpsertTrafficMatchingLists(data)
	case "vpn":
		return db.UpsertVpn(data)
	case "wans":
		return db.UpsertWans(data)
	case "wifi":
		return db.UpsertWifi(data)
	default:
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{ // #nosec G101 -- endpoint paths, not credentials.
		...
		"dpi":              "/v1/dpi/categories",
		"dpi-applications": "/v1/dpi/applications",
		"pending-devices":  "/v1/pending-devices",
		"sites":            "/v1/sites",
	}
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "acl_rules", ParentTable: "sites", ParentIDParam: "siteId", PathTemplate: "/v1/sites/{siteId}/acl-rules", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.site", PathParams: []dependentPathParamDef{
			{Param: "siteId", Field: "id"},
		}},
		{Name: "clients", ParentTable: "sites", ParentIDParam: "siteId", PathTemplate: "/v1/sites/{siteId}/clients", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.site", PathParams: []dependentPathParamDef{
			{Param: "siteId", Field: "id"},
		}},
		{Name: "device_tags", ParentTable: "sites", ParentIDParam: "siteId", PathTemplate: "/v1/sites/{siteId}/device-tags", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.site", PathParams: []dependentPathParamDef{
			{Param: "siteId", Field: "id"},
		}},
		{Name: "devices", ParentTable: "sites", ParentIDParam: "siteId", PathTemplate: "/v1/sites/{siteId}/devices", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.site", PathParams: []dependentPathParamDef{
			{Param: "siteId", Field: "id"},
		}},
		{Name: "dns", ParentTable: "sites", ParentIDParam: "siteId", PathTemplate: "/v1/sites/{siteId}/dns/policies", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.site", PathParams: []dependentPathParamDef{
			{Param: "siteId", Field: "id"},
		}},
		{Name: "hotspot", ParentTable: "sites", ParentIDParam: "siteId", PathTemplate: "/v1/sites/{siteId}/hotspot/vouchers", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.site", PathParams: []dependentPathParamDef{
			{Param: "siteId", Field: "id"},
		}},
		{Name: "networks", ParentTable: "sites", ParentIDParam: "siteId", PathTemplate: "/v1/sites/{siteId}/networks", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.site", PathParams: []dependentPathParamDef{
			{Param: "siteId", Field: "id"},
		}},
		{Name: "radius", ParentTable: "sites", ParentIDParam: "siteId", PathTemplate: "/v1/sites/{siteId}/radius/profiles", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.site", PathParams: []dependentPathParamDef{
			{Param: "siteId", Field: "id"},
		}},
		{Name: "traffic_matching_lists", ParentTable: "sites", ParentIDParam: "siteId", PathTemplate: "/v1/sites/{siteId}/traffic-matching-lists", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.site", PathParams: []dependentPathParamDef{
			{Param: "siteId", Field: "id"},
		}},
		{Name: "v1_sites_firewall_policies", ParentTable: "sites", ParentIDParam: "siteId", PathTemplate: "/v1/sites/{siteId}/firewall/policies", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.site", PathParams: []dependentPathParamDef{
			{Param: "siteId", Field: "id"},
		}},
		{Name: "v1_sites_firewall_zones", ParentTable: "sites", ParentIDParam: "siteId", PathTemplate: "/v1/sites/{siteId}/firewall/zones", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.site", PathParams: []dependentPathParamDef{
			{Param: "siteId", Field: "id"},
		}},
		{Name: "v1_sites_switching_lags", ParentTable: "sites", ParentIDParam: "siteId", PathTemplate: "/v1/sites/{siteId}/switching/lags", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.site", PathParams: []dependentPathParamDef{
			{Param: "siteId", Field: "id"},
		}},
		{Name: "v1_sites_switching_mc_lag_domains", ParentTable: "sites", ParentIDParam: "siteId", PathTemplate: "/v1/sites/{siteId}/switching/mc-lag-domains", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.site", PathParams: []dependentPathParamDef{
			{Param: "siteId", Field: "id"},
		}},
		{Name: "v1_sites_switching_switch_stacks", ParentTable: "sites", ParentIDParam: "siteId", PathTemplate: "/v1/sites/{siteId}/switching/switch-stacks", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.site", PathParams: []dependentPathParamDef{
			{Param: "siteId", Field: "id"},
		}},
		{Name: "v1_sites_vpn_servers", ParentTable: "sites", ParentIDParam: "siteId", PathTemplate: "/v1/sites/{siteId}/vpn/servers", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.site", PathParams: []dependentPathParamDef{
			{Param: "siteId", Field: "id"},
		}},
		{Name: "v1_sites_vpn_site_to_site_tunnels", ParentTable: "sites", ParentIDParam: "siteId", PathTemplate: "/v1/sites/{siteId}/vpn/site-to-site-tunnels", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.site", PathParams: []dependentPathParamDef{
			{Param: "siteId", Field: "id"},
		}},
		{Name: "wans", ParentTable: "sites", ParentIDParam: "siteId", PathTemplate: "/v1/sites/{siteId}/wans", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.site", PathParams: []dependentPathParamDef{
			{Param: "siteId", Field: "id"},
		}},
		{Name: "wifi", ParentTable: "sites", ParentIDParam: "siteId", PathTemplate: "/v1/sites/{siteId}/wifi/broadcasts", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.site", PathParams: []dependentPathParamDef{
			{Param: "siteId", Field: "id"},
		}},
	}
}
...
func responsePathForResource(resource, path string) []string {
	...
	case "countries\x00/v1/countries":
		return []string{"data"}
	case "dpi\x00/v1/dpi/categories":
		return []string{"data"}
	case "dpi\x00/v1/dpi/applications":
		return []string{"data"}
	case "pending-devices\x00/v1/pending-devices":
		return []string{"data"}
	case "sites\x00/v1/sites":
		return []string{"data"}
	}
	return nil
}
