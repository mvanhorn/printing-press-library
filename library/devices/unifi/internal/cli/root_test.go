...
func TestDeclaredAPISurfaceReachable(t *testing.T) {
	expected := []string{
		"countries",
		"dpi",
		"dpi get-application-categories",
		"dpi get-applications",
		"info",
		"pending-devices",
		"sites",
		"sites acl-rules",
		"sites acl-rules create",
		"sites acl-rules delete",
		"sites acl-rules get",
		"sites acl-rules get-ordering",
		"sites acl-rules get-page",
		"sites acl-rules update",
		"sites acl-rules update-ordering",
		"sites clients",
		"sites clients execute-connected-action",
		"sites clients get-connected-details",
		"sites clients get-connected-overview-page",
		"sites device-tags",
		"sites device-tags get-page",
		"sites devices",
		"sites devices adopt",
		"sites devices execute-adopted-action",
		"sites devices execute-port-action",
		"sites devices get-adopted-details",
		"sites devices get-adopted-latest-statistics",
		"sites devices get-adopted-overview-page",
		"sites devices remove",
		"sites dns",
		"sites dns create-policy",
		"sites dns delete-policy",
		"sites dns get-policy",
		"sites dns get-policy-page",
		"sites dns update-policy",
		"sites firewall",
		"sites firewall create-policy",
		"sites firewall create-zone",
		"sites firewall delete-policy",
		"sites firewall delete-zone",
		"sites firewall get-policies",
		"sites firewall get-policy",
		"sites firewall get-policy-ordering",
		"sites firewall get-zone",
		"sites firewall get-zones",
		"sites firewall patch-policy",
		"sites firewall update-policy",
		"sites firewall update-policy-ordering",
		"sites firewall update-zone",
		"sites hotspot",
		"sites hotspot create-vouchers",
		"sites hotspot delete-voucher",
		"sites hotspot delete-vouchers",
		"sites hotspot get-voucher",
		"sites hotspot get-vouchers",
		"sites networks",
		"sites networks create",
		"sites networks delete",
		"sites networks get-details",
		"sites networks get-overview-page",
		"sites networks get-references",
		"sites networks update",
		"sites radius",
		"sites radius get-profile-overview-page",
		"sites switching",
		"sites switching get-lag",
		"sites switching get-lag-page",
		"sites switching get-mc-lag-domain",
		"sites switching get-mc-lag-domain-page",
		"sites switching get-switch-stack",
		"sites switching get-switch-stack-page",
		"sites traffic-matching-lists",
		"sites traffic-matching-lists create",
		"sites traffic-matching-lists delete",
		"sites traffic-matching-lists get",
		"sites traffic-matching-lists get-sites",
		"sites traffic-matching-lists update",
		"sites vpn",
		"sites vpn get-server-page",
		"sites vpn get-site-to-site-tunnel-page",
		"sites wans",
		"sites wans get-overview-page",
		"sites wifi",
		"sites wifi create-broadcast",
		"sites wifi delete-broadcast",
		"sites wifi get-broadcast-details",
		"sites wifi get-broadcast-page",
		"sites wifi update-broadcast",
	}
