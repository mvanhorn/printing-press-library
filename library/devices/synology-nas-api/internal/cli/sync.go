...
Resource scoping:
  ...
  synology-nas-api-pp-cli sync

  # Sync specific resources only
  synology-nas-api-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  synology-nas-api-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  synology-nas-api-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  synology-nas-api-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  synology-nas-api-pp-cli sync --latest-only`,
