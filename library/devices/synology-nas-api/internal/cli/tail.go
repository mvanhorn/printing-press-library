...
native streaming instead of polling.`,
  ...
  synology-nas-api-pp-cli tail --interval 10s

  # Tail a specific resource
  synology-nas-api-pp-cli tail messages --interval 5s

  # Pipe to jq for filtering
  synology-nas-api-pp-cli tail events --interval 30s | jq 'select(.type == "error")'`,
