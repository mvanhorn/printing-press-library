...
but do not stop the import.`,
  ...
  synology-nas-api-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  synology-nas-api-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | synology-nas-api-pp-cli import <resource> --input -`,
