...
func newWebapiListContainersCmd(flags *rootFlags) *cobra.Command {
	var flagApi string
	...
	cmd := &cobra.Command{
		Use:         "list-containers",
		Short:       "List all Docker containers with running status and image",
		Example:     "  synology-nas-api-pp-cli webapi list-containers",
		Annotations: map[string]string{"pp:endpoint": "webapi.list-containers", "pp:method": "GET", "pp:path": "/webapi/entry.cgi/docker/container/list", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			if cmd.Flags().Changed("type") {
				allowedType := []string{"all", "running", "stopped"}
				validType := false
			...
			path := "/webapi/entry.cgi/docker/container/list"
	...
	cmd.Flags().StringVar(&flagType, "type", "all", "Filter by container state (one of: all, running, stopped)")
