...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "synology-nas-api-pp-cli",
		Short: "Manage synology-nas-api resources via the synology-nas-api API",
		Long: `Manage synology-nas-api resources via the synology-nas-api API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'synology-nas-api-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("synology-nas-api-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'synology-nas-api-pp-cli profile list')")
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("synology-nas-api-pp-cli %s\n", version)
		},
	}
}
