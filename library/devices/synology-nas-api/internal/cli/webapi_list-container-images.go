...
func newWebapiListContainerImagesCmd(flags *rootFlags) *cobra.Command {
	var flagApi string
	...
	cmd := &cobra.Command{
		...
		Short:       "List all downloaded Docker images",
		Example:     "  synology-nas-api-pp-cli webapi list-container-images",
		Annotations: map[string]string{"pp:endpoint": "webapi.list-container-images", "pp:method": "GET", "pp:path": "/webapi/entry.cgi/docker/image/list", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "/webapi/entry.cgi/docker/image/list"
	...
	cmd.Flags().StringVar(&flagApi, "api", "SYNO.Docker.Image", "DSM API name (constant: SYNO.Docker.Image)")
