...
func newWebapiGetContainerCmd(flags *rootFlags) *cobra.Command {
	var flagApi string
	...
	cmd := &cobra.Command{
		Use:         "get-container",
		Short:       "Get detailed configuration and status for a specific container",
		Example:     "  synology-nas-api-pp-cli webapi get-container --name example-resource",
		Annotations: map[string]string{"pp:endpoint": "webapi.get-container", "pp:method": "GET", "pp:path": "/webapi/entry.cgi/docker/container/get", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "/webapi/entry.cgi/docker/container/get"
