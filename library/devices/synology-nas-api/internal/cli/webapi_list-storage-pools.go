...
func newWebapiListStoragePoolsCmd(flags *rootFlags) *cobra.Command {
	var flagApi string
	...
	cmd := &cobra.Command{
		...
		Short:       "List all storage pools (RAID groups) with health and usage",
		Example:     "  synology-nas-api-pp-cli webapi list-storage-pools",
		Annotations: map[string]string{"pp:endpoint": "webapi.list-storage-pools", "pp:method": "GET", "pp:path": "/webapi/entry.cgi/storage/pool/list", "mcp:read-only": "true"},
