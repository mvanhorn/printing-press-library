...
func newWebapiStopContainerCmd(flags *rootFlags) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "stop-container",
		Short: "Stop a running container gracefully",
...
Use the SSH-based CLI instead:
  synology-nas-ssh-pp-cli containers stop <name>`,
		DisableFlagParsing: true,
		Annotations: map[string]string{"pp:endpoint": "webapi.stop-container", "pp:method": "POST", "pp:stub": "true"},
