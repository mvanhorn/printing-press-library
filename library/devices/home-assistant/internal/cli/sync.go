...
Resource scoping:
  ...
  home-assistant-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  home-assistant-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  home-assistant-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  home-assistant-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  home-assistant-pp-cli sync --latest-only`,
