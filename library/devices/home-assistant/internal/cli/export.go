...
large datasets as it has no memory pressure.`,
  ...
  home-assistant-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  home-assistant-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  home-assistant-pp-cli export <resource> --format jsonl | jq '.id'`,
