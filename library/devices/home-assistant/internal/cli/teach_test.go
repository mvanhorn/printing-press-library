...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("HOME_ASSISTANT_STATE_DIR", "")
	t.Setenv("HOME_ASSISTANT_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"home-assistant-pp-cli auth login",
		"home-assistant-pp-cli doctor",
		"home-assistant-pp-cli help items",
		"home-assistant-pp-cli sync",
		"home-assistant-pp-cli profile list",
		"home-assistant-pp-cli feedback list",
		"home-assistant-pp-cli which",
		"home-assistant-pp-cli agent-context",
		"home-assistant-pp-cli completion bash",
		"home-assistant-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"home-assistant-pp-cli recall",
		"home-assistant-pp-cli learnings",
		"home-assistant-pp-cli teach-pattern",
		"home-assistant-pp-cli teach-lookup",
		"home-assistant-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("home-assistant-pp-cli")); err == nil {
