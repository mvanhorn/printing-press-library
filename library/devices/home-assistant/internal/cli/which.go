...
var whichIndex = []whichEntry{
	{Command: "mode run", Description: "Preview a scene or script, run it, and verify every resulting entity state.", Group: "Safe household action", WhyItMatters: "Use this when an agent must change several household devices safely instead of firing an unverified scene or service call."},
	{Command: "house check", Description: "See open windows, unlocked locks, lights left on, low batteries, and unavailable safety devices in one answer.", Group: "Household awareness", WhyItMatters: "Use this for immediate household safety and comfort questions that span several entity domains."},
	{Command: "routine why", Description: "Reconstruct why an automation or script failed from traces, state changes, logbook entries, and errors.", Group: "Routine intelligence", WhyItMatters: "Use this when an agent needs evidence for one failed routine instead of dumping an opaque trace."},
	{Command: "routine lint", Description: "Find missing entities, unavailable services, disabled dependencies, ambiguous names, and stale routine references.", Group: "Routine intelligence", WhyItMatters: "Use this before configuration changes or upgrades to catch deterministic breakage before Home Assistant executes a routine."},
	{Command: "routine impact", Description: "See every automation, script, scene, helper, and service target affected by changing one entity or routine.", Group: "Routine intelligence", WhyItMatters: "Use this before renaming, disabling, or removing something that other household routines may depend on."},
	{Command: "house recap", Description: "Review factual household activity, routine failures, presence changes, openings, and unavailable time for a recent period.", Group: "Household awareness", WhyItMatters: "Use this for a compact, evidence-based household summary that remains useful offline."},
	{Command: "health hotspots", Description: "Group recurring unavailable, stale, low-battery, and disconnecting entities into device, room, integration, and radio hotspots.", Group: "Self-hosted maintenance", WhyItMatters: "Use this when many entity symptoms may share one failing device, integration, room, or radio network."},
	{Command: "energy standby", Description: "Find devices drawing persistent power during explicit periods when related household states show inactivity.", Group: "Self-hosted maintenance", WhyItMatters: "Use this to turn household energy history into a short list of actionable standby loads."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  home-assistant-pp-cli which "stale tickets"
  home-assistant-pp-cli which "bottleneck"
  home-assistant-pp-cli which --limit 1 "send message"
  home-assistant-pp-cli which                                # list the full capability index`,
