...
but do not stop the import.`,
  ...
  home-assistant-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  home-assistant-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | home-assistant-pp-cli import <resource> --input -`,
