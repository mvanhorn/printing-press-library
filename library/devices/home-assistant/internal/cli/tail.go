...
native streaming instead of polling.`,
  ...
  home-assistant-pp-cli tail --interval 10s

  # Tail a specific resource
  home-assistant-pp-cli tail messages --interval 5s

  # Pipe to jq for filtering
  home-assistant-pp-cli tail events --interval 30s | jq 'select(.type == "error")'`,
