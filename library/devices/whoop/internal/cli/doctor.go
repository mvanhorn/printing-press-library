		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if cfg != nil {
				...
				if header == "" {
					...
					report["auth_hint"] = "export WHOOP_OAUTH2=<your-key>"
				} else {
					authConfigured = true
			...
			if os.Getenv("WHOOP_OAUTH2") != "" {
				authEnvSet = append(authEnvSet, "WHOOP_OAUTH2")
				...
				authEnvRequiredMissing = append(authEnvRequiredMissing, "WHOOP_OAUTH2")
			}
			switch {
