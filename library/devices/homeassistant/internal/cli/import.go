...
but do not stop the import.`,
  ...
  homeassistant-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  homeassistant-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | homeassistant-pp-cli import <resource> --input -`,
