...
Exit codes & warnings:
  ...
  homeassistant-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  homeassistant-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  homeassistant-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  homeassistant-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  homeassistant-pp-cli sync --latest-only`,
