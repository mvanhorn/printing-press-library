...
Run 'homeassistant-pp-cli doctor' to verify auth and connectivity.`,
	...
	rootCmd.SetVersionTemplate("homeassistant-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'homeassistant-pp-cli profile list')")
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("homeassistant-pp-cli %s\n", version)
		},
	}
}
