...
native streaming instead of polling.`,
  ...
  homeassistant-pp-cli tail --interval 10s

  # Tail a specific resource
  homeassistant-pp-cli tail messages --interval 5s

  # Pipe to jq for filtering
  homeassistant-pp-cli tail events --interval 30s | jq 'select(.type == "error")'`,
