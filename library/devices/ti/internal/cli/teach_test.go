...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"ti-pp-cli auth login",
		"ti-pp-cli doctor",
		"ti-pp-cli help items",
		"ti-pp-cli sync",
		"ti-pp-cli profile list",
		"ti-pp-cli feedback list",
		"ti-pp-cli which",
		"ti-pp-cli agent-context",
		"ti-pp-cli completion bash",
		"ti-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"ti-pp-cli recall",
		"ti-pp-cli learnings",
		"ti-pp-cli teach-pattern",
		"ti-pp-cli teach-lookup",
		"ti-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("ti-pp-cli")); err == nil {
