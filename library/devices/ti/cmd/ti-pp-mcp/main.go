...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/devices/ti/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("TI_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "ti-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
