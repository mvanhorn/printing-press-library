...
large datasets as it has no memory pressure.`,
  ...
  tessie-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  tessie-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  tessie-pp-cli export <resource> --format jsonl | jq '.id'`,
