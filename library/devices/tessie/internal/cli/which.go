...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  tessie-pp-cli which "stale tickets"
  tessie-pp-cli which "bottleneck"
  tessie-pp-cli which --limit 1 "send message"
  tessie-pp-cli which                                # list the full capability index`,
