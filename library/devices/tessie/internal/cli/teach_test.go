...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"tessie-pp-cli auth login",
		"tessie-pp-cli doctor",
		"tessie-pp-cli help items",
		"tessie-pp-cli sync",
		"tessie-pp-cli profile list",
		"tessie-pp-cli feedback list",
		"tessie-pp-cli which",
		"tessie-pp-cli agent-context",
		"tessie-pp-cli completion bash",
		"tessie-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"tessie-pp-cli teach",
		"tessie-pp-cli recall",
		"tessie-pp-cli learnings",
		"tessie-pp-cli teach-pattern",
		"tessie-pp-cli teach-lookup",
		"tessie-pp-cli items list",
	}
