# Zaptec Printed CLI Agent Guide

This directory is a generated `zaptec-pp-cli` printed CLI. It was produced by [CLI Printing Press](https://github.com/mvanhorn/cli-printing-press), so treat systemic fixes as upstream Printing Press fixes first. Keep local edits narrow and document why a generated-tree patch belongs here.
...
zaptec-pp-cli agent-context --pretty
```

Use runtime discovery instead of relying on a copied command list:

```bash
zaptec-pp-cli which "<capability>" --json
zaptec-pp-cli <command> --help
```
...
```bash
zaptec-pp-cli <command> --help
zaptec-pp-cli <command> --dry-run --agent
```
