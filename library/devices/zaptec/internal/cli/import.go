...
but do not stop the import.`,
  ...
  zaptec-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  zaptec-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | zaptec-pp-cli import <resource> --input -`,
