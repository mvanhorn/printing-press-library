...
but do not stop the import.`,
  ...
  juneoven-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  juneoven-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | juneoven-pp-cli import <resource> --input -`,
