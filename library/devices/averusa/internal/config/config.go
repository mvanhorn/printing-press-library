...
func Load(configPath string) (*Config, error) {
	cfg := &Config{
		BaseURL: "https://averusa.my.site.com/support/s",
	}
	...
	if v := os.Getenv("AVERUSA_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("AVERUSA_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "averusa-pp-cli", "config.toml"), nil
}
