...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/devices/averusa/internal/cliutil/testenv"
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"averusa-pp-cli auth login",
		"averusa-pp-cli doctor",
		"averusa-pp-cli help items",
		"averusa-pp-cli sync",
		"averusa-pp-cli profile list",
		"averusa-pp-cli feedback list",
		"averusa-pp-cli which",
		"averusa-pp-cli agent-context",
		"averusa-pp-cli completion bash",
		"averusa-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"averusa-pp-cli recall",
		"averusa-pp-cli learnings",
		"averusa-pp-cli teach-pattern",
		"averusa-pp-cli teach-lookup",
		"averusa-pp-cli items list",
	}
