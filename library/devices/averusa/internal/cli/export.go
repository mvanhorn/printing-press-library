...
large datasets as it has no memory pressure.`,
  ...
  averusa-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  averusa-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  averusa-pp-cli export <resource> --format jsonl | jq '.id'`,
