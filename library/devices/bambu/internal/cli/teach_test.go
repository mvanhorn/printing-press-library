...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"bambu-pp-cli auth login",
		"bambu-pp-cli doctor",
		"bambu-pp-cli help items",
		"bambu-pp-cli sync",
		"bambu-pp-cli profile list",
		"bambu-pp-cli feedback list",
		"bambu-pp-cli which",
		"bambu-pp-cli agent-context",
		"bambu-pp-cli completion bash",
		"bambu-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"bambu-pp-cli teach",
		"bambu-pp-cli recall",
		"bambu-pp-cli learnings",
		"bambu-pp-cli teach-pattern",
		"bambu-pp-cli teach-lookup",
		"bambu-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("bambu-pp-cli")); err == nil {
