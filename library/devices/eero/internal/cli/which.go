...
var whichIndex = []whichEntry{
	{Command: "network", Description: "One agent-friendly read combines network status, speed summary, client count, node count, DNS, and feature settings.", Group: "Read-first network operations", WhyItMatters: "Use this first when diagnosing whether an eero network is healthy before drilling into a node or client."},
	{Command: "eero list", Description: "List all eero nodes in a network with compact agent-friendly output.", Group: "Read-first network operations", WhyItMatters: "Use it to identify the node to inspect when coverage or topology is the problem."},
	{Command: "device list", Description: "List connected client devices for a network, with filters and compact JSON for downstream automation.", Group: "Read-first network operations", WhyItMatters: "Use it to answer which clients are connected before investigating one device in detail."},
	{Command: "diagnostics", Description: "Fetch the latest diagnostic report for a network through the same authenticated CLI surface.", Group: "Read-first network operations", WhyItMatters: "Use it when the health snapshot shows a problem and you need the provider's latest diagnostic signal."},
	{Command: "speed-test", Description: "Read the latest available speed-test results for a network as structured output.", Group: "Read-first network operations", WhyItMatters: "Use it to distinguish topology or client issues from an upstream throughput problem."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  eero-pp-cli which "stale tickets"
  eero-pp-cli which "bottleneck"
  eero-pp-cli which --limit 1 "send message"
  eero-pp-cli which                                # list the full capability index`,
