...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"eero-pp-cli auth login",
		"eero-pp-cli doctor",
		"eero-pp-cli help items",
		"eero-pp-cli sync",
		"eero-pp-cli profile list",
		"eero-pp-cli feedback list",
		"eero-pp-cli which",
		"eero-pp-cli agent-context",
		"eero-pp-cli completion bash",
		"eero-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"eero-pp-cli teach",
		"eero-pp-cli recall",
		"eero-pp-cli learnings",
		"eero-pp-cli teach-pattern",
		"eero-pp-cli teach-lookup",
		"eero-pp-cli items list",
	}
