...
but do not stop the import.`,
  ...
  gemini-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  gemini-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | gemini-pp-cli import <resource> --input -`,
