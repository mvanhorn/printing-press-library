...
large datasets as it has no memory pressure.`,
  ...
  gemini-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  gemini-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  gemini-pp-cli export <resource> --format jsonl | jq '.id'`,
