...
func newDoctorCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `  operon-pp-cli doctor
  operon-pp-cli doctor --json
  operon-pp-cli doctor --fail-on warn`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if cfg != nil {
				...
				if header == "" {
					...
					report["auth_hint"] = "export OPERON_AD_NETWORK_BEARER_AUTH=<your-key>"
					report["auth_docs_url"] = "https://operon.so"
				} else {
					authConfigured = true
			...
			if os.Getenv("OPERON_AD_NETWORK_BEARER_AUTH") != "" {
				authEnvSet = append(authEnvSet, "OPERON_AD_NETWORK_BEARER_AUTH")
				...
				authEnvRequiredMissing = append(authEnvRequiredMissing, "OPERON_AD_NETWORK_BEARER_AUTH")
			}
			switch {
