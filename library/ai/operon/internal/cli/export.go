...
large datasets as it has no memory pressure.`,
  ...
  operon-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  operon-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  operon-pp-cli export <resource> --format jsonl | jq '.id'`,
