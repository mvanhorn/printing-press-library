...
but do not stop the import.`,
  ...
  operon-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  operon-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | operon-pp-cli import <resource> --input -`,
