...
but do not stop the import.`,
  ...
  openrouter-image-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  openrouter-image-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | openrouter-image-pp-cli import <resource> --input -`,
