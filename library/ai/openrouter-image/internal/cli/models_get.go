...
func newModelsGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  openrouter-image-pp-cli models get",
	...
	cmd.Flags().StringVar(&flagRegion, "region", "", "Filter to models with endpoints in the given data region. Currently only 'eu' is supported. (one of: eu)")
