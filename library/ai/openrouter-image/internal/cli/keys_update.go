...
func newKeysUpdateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  openrouter-image-pp-cli keys update f01d52606dc8f0a8303a7b5cc3fa07109c2e346cec7c0a16b40de462992ce943",
	...
	cmd.Flags().IntVar(&bodyLimit, "limit", 0, "New spending limit for the API key in USD")
