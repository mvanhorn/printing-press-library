...
native streaming instead of polling.`,
  ...
  openrouter-image-pp-cli tail --interval 10s

  # Tail a specific resource
  openrouter-image-pp-cli tail messages --interval 5s

  # Pipe to jq for filtering
  openrouter-image-pp-cli tail events --interval 30s | jq 'select(.type == "error")'`,
