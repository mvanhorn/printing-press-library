...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("OPENROUTER_IMAGE_STATE_DIR", "")
	t.Setenv("OPENROUTER_IMAGE_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"openrouter-image-pp-cli auth login",
		"openrouter-image-pp-cli doctor",
		"openrouter-image-pp-cli help items",
		"openrouter-image-pp-cli sync",
		"openrouter-image-pp-cli profile list",
		"openrouter-image-pp-cli feedback list",
		"openrouter-image-pp-cli which",
		"openrouter-image-pp-cli agent-context",
		"openrouter-image-pp-cli completion bash",
		"openrouter-image-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"openrouter-image-pp-cli recall",
		"openrouter-image-pp-cli learnings",
		"openrouter-image-pp-cli teach-pattern",
		"openrouter-image-pp-cli teach-lookup",
		"openrouter-image-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("openrouter-image-pp-cli")); err == nil {
