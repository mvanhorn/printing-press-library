...
large datasets as it has no memory pressure.`,
  ...
  openrouter-image-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  openrouter-image-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  openrouter-image-pp-cli export <resource> --format jsonl | jq '.id'`,
