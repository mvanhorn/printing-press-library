...
func TestMigrate_AddsColumnsOnUpgrade_Guardrails(t *testing.T) {
	...
	// The migration must have added every generated column.
	rows, err := s.DB().Query(`PRAGMA table_info("guardrails")`)
	if err != nil {
		t.Fatalf("table_info: %v", err)
	}
	defer rows.Close()
...
func TestMigrate_AddsColumnsOnUpgrade_Presets(t *testing.T) {
	...
	// The migration must have added every generated column.
	rows, err := s.DB().Query(`PRAGMA table_info("presets")`)
	if err != nil {
		t.Fatalf("table_info: %v", err)
	}
	defer rows.Close()
...
func TestMigrate_AddsColumnsOnUpgrade_PresetsChat(t *testing.T) {
	...
	// The migration must have added every generated column.
	rows, err := s.DB().Query(`PRAGMA table_info("presets_chat")`)
	if err != nil {
		t.Fatalf("table_info: %v", err)
	}
	defer rows.Close()
...
func TestMigrate_AddsColumnsOnUpgrade_PresetsMessages(t *testing.T) {
	...
	// The migration must have added every generated column.
	rows, err := s.DB().Query(`PRAGMA table_info("presets_messages")`)
	if err != nil {
		t.Fatalf("table_info: %v", err)
	}
	defer rows.Close()
...
func TestMigrate_AddsColumnsOnUpgrade_PresetsResponses(t *testing.T) {
	...
	// The migration must have added every generated column.
	rows, err := s.DB().Query(`PRAGMA table_info("presets_responses")`)
	if err != nil {
		t.Fatalf("table_info: %v", err)
	}
	defer rows.Close()
