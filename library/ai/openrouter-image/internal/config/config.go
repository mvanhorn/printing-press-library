...
func Load(configPath string) (*Config, error) {
	...
	if v := os.Getenv("OPENROUTER_IMAGE_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("OPENROUTER_IMAGE_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "openrouter-image-pp-cli", "config.toml"), nil
}
