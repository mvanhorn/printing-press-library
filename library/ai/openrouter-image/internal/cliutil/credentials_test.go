...
func resetCredentialEnv(t *testing.T) (home, configPath string) {
	...
	for _, name := range []string{
		...
		"OPENROUTER_IMAGE_CONFIG_DIR",
		"OPENROUTER_IMAGE_DATA_DIR",
		"OPENROUTER_IMAGE_STATE_DIR",
		"OPENROUTER_IMAGE_CACHE_DIR",
		"OPENROUTER_IMAGE_HOME",
		"XDG_CONFIG_HOME",
		"XDG_DATA_HOME",
		"XDG_STATE_HOME",
		"XDG_CACHE_HOME",
	...
	return home, filepath.Join(home, ".config", "openrouter-image-pp-cli", "config.toml")
}
...
func TestCorruptCredentialsFallsBackToLegacyConfig(t *testing.T) {
	...
	credentialsPath := filepath.Join(home, ".local", "share", "openrouter-image-pp-cli", "credentials.toml")
...
func TestAuthWriteScrubsLegacyConfigWhenRelocated(t *testing.T) {
	...
	activeConfigPath := filepath.Join(newConfigDir, "openrouter-image-pp-cli", "config.toml")
	...
	credsPath := filepath.Join(newDataDir, "openrouter-image-pp-cli", "credentials.toml")
