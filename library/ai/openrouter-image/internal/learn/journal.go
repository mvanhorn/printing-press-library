...
const (
	journalSessionEnvVar   = "OPENROUTER_IMAGE_LEARN_SESSION"
	journalNoLearnEnvVar   = "OPENROUTER_IMAGE_NO_LEARN"
	journalNoCaptureEnvVar = "OPENROUTER_IMAGE_LEARN_NO_CAPTURE"
)
