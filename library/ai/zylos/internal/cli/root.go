...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "zylos-pp-cli",
		Short: `Zylos CLI — Every Zylos conversation, from the terminal — with offline search, analytics, and streaming no other tool offers.`,
		Long: `Zylos CLI — Every Zylos conversation, from the terminal — with offline search, analytics, and streaming no other tool offers.
...
Health check: run 'zylos-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("zylos-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'zylos-pp-cli profile list')")
	...
	rootCmd.AddCommand(newLatencyCmd(flags))
