...
metadata:
  openclaw:
    ...
    install:
      - kind: go
        bins: [v0-pp-cli]
        module: github.com/mvanhorn/printing-press-library/library/ai/vzero/cmd/v0-pp-cli
---
...
```bash
go install github.com/mvanhorn/printing-press-library/library/ai/vzero/cmd/v0-pp-cli@latest
```
...
1. Install the MCP server:
   ```bash
   go install github.com/mvanhorn/printing-press-library/library/ai/vzero/cmd/v0-pp-mcp@latest
   ```
