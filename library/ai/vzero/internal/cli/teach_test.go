...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"v0-pp-cli auth login",
		"v0-pp-cli doctor",
		"v0-pp-cli help items",
		"v0-pp-cli sync",
		"v0-pp-cli profile list",
		"v0-pp-cli feedback list",
		"v0-pp-cli which",
		"v0-pp-cli agent-context",
		"v0-pp-cli completion bash",
		"v0-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"v0-pp-cli recall",
		"v0-pp-cli learnings",
		"v0-pp-cli teach-pattern",
		"v0-pp-cli teach-lookup",
		"v0-pp-cli items list",
	}
