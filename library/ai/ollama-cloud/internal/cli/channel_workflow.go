...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  ollama-cloud-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  ollama-cloud-pp-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"models", "ps", "tags",  }
			totalSynced := 0
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  ollama-cloud-pp-cli workflow status

  # Show status as JSON
  ollama-cloud-pp-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("ollama-cloud-pp-cli")
			}
