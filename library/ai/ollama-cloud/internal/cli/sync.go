...
Exit codes & warnings:
  ...
  ollama-cloud-pp-cli sync

  # Sync specific resources only
  ollama-cloud-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  ollama-cloud-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  ollama-cloud-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  ollama-cloud-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  ollama-cloud-pp-cli sync --latest-only`,
