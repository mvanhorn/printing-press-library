...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		...
		Short: `Ollama Cloud CLI — Routes every prompt to the right hosted Ollama model. Wraps chat, embeddings, catalog, and the OpenAI-compatible mirror…`,
		Long: `Ollama Cloud CLI — Routes every prompt to the right hosted Ollama model. Wraps chat, embeddings, catalog, and the OpenAI-compatible mirror…
...
Health check: run 'ollama-cloud-pp-cli doctor' to verify auth and connectivity.
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("ollama-cloud-pp-cli %s\n", version)
		},
	}
}
