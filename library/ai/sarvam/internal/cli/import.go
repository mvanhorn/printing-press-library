...
but do not stop the import.`,
  ...
  sarvam-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  sarvam-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | sarvam-pp-cli import <resource> --input -`,
