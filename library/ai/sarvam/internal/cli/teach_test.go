...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"sarvam-pp-cli auth login",
		"sarvam-pp-cli doctor",
		"sarvam-pp-cli help items",
		"sarvam-pp-cli sync",
		"sarvam-pp-cli profile list",
		"sarvam-pp-cli feedback list",
		"sarvam-pp-cli which",
		"sarvam-pp-cli agent-context",
		"sarvam-pp-cli completion bash",
		"sarvam-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"sarvam-pp-cli teach",
		"sarvam-pp-cli recall",
		"sarvam-pp-cli learnings",
		"sarvam-pp-cli teach-pattern",
		"sarvam-pp-cli teach-lookup",
		"sarvam-pp-cli items list",
	}
