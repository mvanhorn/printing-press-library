...
func TestDeclaredAPISurfaceReachable(t *testing.T) {
	expected := []string{
		...
		"speech-to-text stt-job-download",
		"speech-to-text stt-job-initiate",
		"speech-to-text stt-job-start",
		"speech-to-text stt-job-status",
		"speech-to-text stt-job-upload",
		"text-lid",
		"text-to-speech",
		"text-to-speech create-pronunciation-dictionary",
		"text-to-speech delete-pronunciation-dictionary",
		"text-to-speech get-pronunciation-dictionary",
		"text-to-speech list-pronunciation-dictionaries",
		"text-to-speech stream",
		"text-to-speech text-to-speech",
		"text-to-speech update-pronunciation-dictionary",
		"translate",
		"transliterate",
	}
