...
but do not stop the import.`,
  ...
  higgsfield-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  higgsfield-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | higgsfield-pp-cli import <resource> --input -`,
