...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "higgsfield-pp-cli",
		Short: `Drive Higgsfield image and video generation, train Soul IDs, fan out across models, and search past prompts — with a local SQLite store no other Higgsfield tool has.`,
		Long: `Drive Higgsfield image and video generation, train Soul IDs, fan out across models, and search past prompts — with a local SQLite store no other Higgsfield tool has.
...
Health check: run 'higgsfield-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("higgsfield-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'higgsfield-pp-cli profile list')")
	...
	rootCmd.AddCommand(newSoulIdsCmd(flags))
	...
	// PATCH(novel-features-wiring): register the hand-coded fanout transcendence
	// command tree at root. See .printing-press-patches.json.
	rootCmd.AddCommand(newFanoutCmd(flags))
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("higgsfield-pp-cli %s\n", version)
		},
	}
}
