...
but do not stop the import.`,
  ...
  artistly-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  artistly-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | artistly-pp-cli import <resource> --input -`,
