...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/ai/perplexity/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "perplexity-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
