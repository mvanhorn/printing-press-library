...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "perplexity-pp-cli",
		Short: `Browse and export Perplexity research traces from the terminal.`,
		Long: `Browse and export Perplexity research traces from the terminal.
...
Run 'perplexity-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("perplexity-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'perplexity-pp-cli profile list')")
