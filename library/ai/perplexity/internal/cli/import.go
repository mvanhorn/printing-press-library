...
but do not stop the import.`,
  ...
  perplexity-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  perplexity-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | perplexity-pp-cli import <resource> --input -`,
