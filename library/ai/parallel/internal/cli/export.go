...
large datasets as it has no memory pressure.`,
  ...
  parallel-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  parallel-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  parallel-pp-cli export <resource> --format jsonl | jq '.id'`,
