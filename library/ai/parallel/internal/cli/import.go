...
but do not stop the import.`,
  ...
  parallel-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  parallel-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | parallel-pp-cli import <resource> --input -`,
