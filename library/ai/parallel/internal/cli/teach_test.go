...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("PARALLEL_STATE_DIR", "")
	t.Setenv("PARALLEL_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"parallel-pp-cli auth login",
		"parallel-pp-cli doctor",
		"parallel-pp-cli help items",
		"parallel-pp-cli sync",
		"parallel-pp-cli profile list",
		"parallel-pp-cli feedback list",
		"parallel-pp-cli which",
		"parallel-pp-cli agent-context",
		"parallel-pp-cli completion bash",
		"parallel-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"parallel-pp-cli recall",
		"parallel-pp-cli learnings",
		"parallel-pp-cli teach-pattern",
		"parallel-pp-cli teach-lookup",
		"parallel-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("parallel-pp-cli")); err == nil {
