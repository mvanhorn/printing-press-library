...
large datasets as it has no memory pressure.`,
  ...
  flowiseai-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  flowiseai-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  flowiseai-pp-cli export <resource> --format jsonl | jq '.id'`,
