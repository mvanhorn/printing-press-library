...
but do not stop the import.`,
  ...
  flowiseai-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  flowiseai-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | flowiseai-pp-cli import <resource> --input -`,
