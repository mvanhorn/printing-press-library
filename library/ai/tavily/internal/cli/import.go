...
but do not stop the import.`,
  ...
  tavily-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  tavily-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | tavily-pp-cli import <resource> --input -`,
