...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "tavily-pp-cli",
		Short: `Web search, content extraction, site crawling, URL mapping, and deep research from the command line — with offline search, credit tracking, and agent-native output.`,
		Long: `Web search, content extraction, site crawling, URL mapping, and deep research from the command line — with offline search, credit tracking, and agent-native output.
