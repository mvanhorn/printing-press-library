...
large datasets as it has no memory pressure.`,
  ...
  tavily-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  tavily-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  tavily-pp-cli export <resource> --format jsonl | jq '.id'`,
