...
// Decision is the outcome of a freshness check.
type Decision int
...
// FreshnessMeta is attached to JSON provenance under meta.freshness.
...
// Policy configures cache freshness thresholds.
type Policy struct {
...
// EnsureFresh inspects sync_state and returns whether a refresh is needed.
