...
var whichIndex = []whichEntry{
	{Command: "spend", Description: "Aggregate v0 credit cost and token usage from the synced message mirror, grouped by chat, day, or model.", Group: "Cost intelligence", WhyItMatters: "Use this when an agent needs to know where v0 credits went, which chats are expensive, or a daily burn rate."},
	{Command: "chats stream", Description: "Create a chat and stream the SSE response live, rendering each event and recording model attribution for spend analytics.", Group: "Streaming", WhyItMatters: "Use this when an agent needs to see generation progress live or capture the event stream for later analysis."},
	{Command: "messages tail", Description: "Poll a chat until the newest assistant message finishes, with --follow for continuous watching.", Group: "Streaming", WhyItMatters: "Use this when an agent kicked off an async generation and needs to wait for it deterministically."},
	{Command: "chats files", Description: "Render a chat's generated source files as an indented directory tree.", Group: "Files", WhyItMatters: "Use this when an agent needs to understand a generated app's layout before editing."},
	{Command: "chats preview", Description: "Print only the live preview URL for a chat, ready for embedding or scripting.", Group: "Files", WhyItMatters: "Use this when an agent needs the preview URL for CI, screenshots, or quick checks."},
	{Command: "search", Description: "Full-text search over synced chats and messages without hitting the API.", Group: "Offline", WhyItMatters: "Use this when an agent needs to find a past chat or message without paging the API."},
	{Command: "sync", Description: "Cursor-paginated sync of chats and messages into a local SQLite mirror for offline search and spend analytics.", Group: "Offline", WhyItMatters: "Run once before offline search or spend commands."},
	{Command: "doctor", Description: "Validate V0_API_KEY and API reachability with a live check.", Group: "Ops", WhyItMatters: "Use this when a script 401s and you need to know why."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  v0-pp-cli which "stale tickets"
  v0-pp-cli which "bottleneck"
  v0-pp-cli which --limit 1 "send message"
  v0-pp-cli which                                # list the full capability index`,
