...
func TestDeclaredAPISurfaceReachable(t *testing.T) {
	expected := []string{
		"chats",
		"chats connect-status",
		"chats create",
		"chats create-async",
		"chats create-from-files",
		"chats create-from-repo",
		"chats create-from-zip",
		"chats create-stream",
		"chats create-vercel-project",
		"chats delete",
		"chats deploy",
		"chats download-files",
		"chats duplicate",
		"chats files",
		"chats get",
		"chats list",
		"chats preview",
		"chats restore-message",
		"chats resume-stream",
		"chats update",
		"chats update-files",
		"hooks",
		...
		"messages resolve-task-async",
		"messages resolve-task-stream",
		"messages send",
		"messages send-async",
		"messages send-stream",
		"messages stop",
		"settings",
		"settings preview-hosts",
		"settings set-preview-hosts",
	}
