...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"pinecone-pp-cli auth login",
		"pinecone-pp-cli doctor",
		"pinecone-pp-cli help items",
		"pinecone-pp-cli sync",
		"pinecone-pp-cli profile list",
		"pinecone-pp-cli feedback list",
		"pinecone-pp-cli which",
		"pinecone-pp-cli agent-context",
		"pinecone-pp-cli completion bash",
		"pinecone-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"pinecone-pp-cli recall",
		"pinecone-pp-cli learnings",
		"pinecone-pp-cli teach-pattern",
		"pinecone-pp-cli teach-lookup",
		"pinecone-pp-cli items list",
	}
