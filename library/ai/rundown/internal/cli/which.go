...
var whichIndex = []whichEntry{
	{Command: "top", Description: "Rank the highest-upvoted workflows inside a time window like 7d or 30d.", Group: "Local state that compounds", WhyItMatters: "This is the answer to 'bring me the best workflows this week' in one call instead of paging the feed and eyeballing dates."},
	{Command: "use-cases", Description: "Answer 'are there any workflows for X' by blending the server's semantic search with local full-text search, then ranking by upvotes.", Group: "Search that actually finds things", WhyItMatters: "Reach for this whenever someone asks whether the community has already solved a problem, before designing a workflow from scratch."},
	{Command: "show", Description: "Print one workflow in full - body, tools, industries, author and comments - in a single call.", Group: "Search that actually finds things", WhyItMatters: "Use this after search to actually read a workflow instead of returning a truncated feed card."},
	{Command: "digest", Description: "Summarise a time window: how many workflows landed, the top posts, the most-used tools and the busiest authors.", Group: "Local state that compounds", WhyItMatters: "Use this for a standing 'what happened in the community' check rather than scrolling the feed."},
	{Command: "tools rank", Description: "Rank AI tools by how often they appear in workflows and by the upvotes those workflows earned.", Group: "Local state that compounds", WhyItMatters: "Use this to see which tools the community actually builds with, as opposed to which ones merely exist in the dropdown."},
	{Command: "stack", Description: "Show which other tools appear alongside a given tool, so you can see the stacks people really run.", Group: "Local state that compounds", WhyItMatters: "Use this when picking complementary tooling, or to answer 'what do people pair with X'."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  rundown-pp-cli which "stale tickets"
  rundown-pp-cli which "bottleneck"
  rundown-pp-cli which --limit 1 "send message"
  rundown-pp-cli which                                # list the full capability index`,
