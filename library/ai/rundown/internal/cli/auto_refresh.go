...
var readCommandResources = map[string][]string{
	"rundown-pp-cli leaderboard":        {"leaderboard"},
	"rundown-pp-cli leaderboard list":   {"leaderboard"},
	"rundown-pp-cli leaderboard get":    {"leaderboard"},
	"rundown-pp-cli leaderboard search": {"leaderboard"},
	"rundown-pp-cli posts":              {"posts"},
	"rundown-pp-cli posts list":         {"posts"},
	"rundown-pp-cli posts get":          {"posts"},
	"rundown-pp-cli posts search":       {"posts"},
	"rundown-pp-cli tools":              {"tools"},
	"rundown-pp-cli tools list":         {"tools"},
	"rundown-pp-cli tools get":          {"tools"},
	"rundown-pp-cli tools search":       {"tools"},
}
...
func cachePolicy() cliutil.Policy {
	...
	envOptOut := "RUNDOWN_NO_AUTO_REFRESH"
...
func autoRefreshIfStale(ctx context.Context, flags *rootFlags, resources []string) (meta cliutil.FreshnessMeta) {
	...
	if err := runAutoRefresh(refreshCtx, flags, db, resources); err != nil {
		fmt.Fprintf(os.Stderr, "warning: using stale rundown-pp-cli cache (refresh failed: %v)\n", err)
