...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/ai/rundown/internal/cliutil/testenv"
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"rundown-pp-cli auth login",
		"rundown-pp-cli doctor",
		"rundown-pp-cli help items",
		"rundown-pp-cli sync",
		"rundown-pp-cli profile list",
		"rundown-pp-cli feedback list",
		"rundown-pp-cli which",
		"rundown-pp-cli agent-context",
		"rundown-pp-cli completion bash",
		"rundown-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"rundown-pp-cli recall",
		"rundown-pp-cli learnings",
		"rundown-pp-cli teach-pattern",
		"rundown-pp-cli teach-lookup",
		"rundown-pp-cli items list",
	}
