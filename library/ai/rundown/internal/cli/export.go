...
large datasets as it has no memory pressure.`,
  ...
  rundown-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  rundown-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  rundown-pp-cli export <resource> --format jsonl | jq '.id'`,
