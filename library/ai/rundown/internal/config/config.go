...
func Load(configPath string) (*Config, error) {
	cfg := &Config{
		BaseURL: "https://app.therundown.ai/api/community",
	}
	...
	if v := os.Getenv("RUNDOWN_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("RUNDOWN_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "rundown-pp-cli", "config.toml"), nil
}
