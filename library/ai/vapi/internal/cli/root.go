...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "vapi-pp-cli",
		Short: "Manage vapi resources via the vapi API",
		Long: `Manage vapi resources via the vapi API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'vapi-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	...
	rootCmd.AddCommand(newDialCmd(flags))
	rootCmd.AddCommand(newJunoCmd(flags))
