...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "assistant_recording":
		return db.UpsertAssistantRecording(data)
	case "call_logs":
		return db.UpsertCallLogs(data)
	case "customer_recording":
		return db.UpsertCustomerRecording(data)
	case "mono_recording":
		return db.UpsertMonoRecording(data)
	case "pcap":
		return db.UpsertPcap(data)
	case "stereo_recording":
		return db.UpsertStereoRecording(data)
	case "video_recording":
		return db.UpsertVideoRecording(data)
	case "campaign":
