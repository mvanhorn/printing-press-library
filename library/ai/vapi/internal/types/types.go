...
type BooleanComparatorScorecardMetricCondition struct {
...
type CustomerSpeechTimeoutOptions struct {
	...
	TriggerResetMode string  `json:"triggerResetMode"`
}
...
type FallbackXaiTranscriber struct {
	Language string `json:"language"`
	Model    string `json:"model"`
	Provider string `json:"provider"`
}

type FallbackXaiVoice struct {
	CachingEnabled bool    `json:"cachingEnabled"`
	ChunkPlan      string  `json:"chunkPlan"`
	Language       string  `json:"language"`
	Provider       string  `json:"provider"`
...
type NumberComparatorScorecardMetricCondition struct {
	Comparator string  `json:"comparator"`
	Points     float64 `json:"points"`
	Type       string  `json:"type"`
	Value      float64 `json:"value"`
...
type PhoneNumberFindAllPaginatedItem struct {
	AssistantId            string          `json:"assistantId"`
	Authentication         string          `json:"authentication"`
	CreatedAt              string          `json:"createdAt"`
	CredentialId           string          `json:"credentialId"`
...
type VapiSipTransport struct {
	CallSid          string  `json:"callSid"`
	ConversationType string  `json:"conversationType"`
	DialTimeout      float64 `json:"dialTimeout"`
	Provider         string  `json:"provider"`
	SbcCallSid       string  `json:"sbcCallSid"`
}
...
type VapiWebCallTransport struct {
	CallSipUri                   string `json:"callSipUri"`
...
type VapiWebsocketTransport struct {
