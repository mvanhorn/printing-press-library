...
but do not stop the import.`,
  ...
  cartesia-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  cartesia-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | cartesia-pp-cli import <resource> --input -`,
