...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "cartesia-pp-cli",
		Short: `Cartesia CLI — Manage Cartesia voice agents, deployments, calls, metrics, and voices from the terminal — with a local SQLite mirror th…`,
		Long: `Cartesia CLI — Manage Cartesia voice agents, deployments, calls, metrics, and voices from the terminal — with a local SQLite mirror th…
...
Health check: run 'cartesia-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage:  true,
		SilenceErrors: true,
		Version:       version,
	}
	rootCmd.SetVersionTemplate("cartesia-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'cartesia-pp-cli profile list')")
	...
	rootCmd.AddCommand(newFineTunesCmd(flags))
	rootCmd.AddCommand(newPronunciationDictsCmd(flags))
	rootCmd.AddCommand(newTtsCmd(flags))
	rootCmd.AddCommand(newVoiceChangerCmd(flags))
	...
	rootCmd.AddCommand(newInfillPromotedCmd(flags))
	rootCmd.AddCommand(newSttPromotedCmd(flags))
