...
large datasets as it has no memory pressure.`,
  ...
  cartesia-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  cartesia-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  cartesia-pp-cli export <resource> --format jsonl | jq '.id'`,
