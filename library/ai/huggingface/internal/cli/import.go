...
but do not stop the import.`,
  ...
  huggingface-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  huggingface-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | huggingface-pp-cli import <resource> --input -`,
