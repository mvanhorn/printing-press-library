...
but do not stop the import.`,
  ...
  artyfacts-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  artyfacts-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | artyfacts-pp-cli import <resource> --input -`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			for scanner.Scan() {
				...
				// POST /artifacts requires aah_version + artifact envelope with a client ID.
