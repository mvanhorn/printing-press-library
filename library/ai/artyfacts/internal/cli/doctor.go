...
func newDoctorCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `  artyfacts-pp-cli doctor
  artyfacts-pp-cli doctor --json
  artyfacts-pp-cli doctor --fail-on warn`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if cfg != nil {
				...
				if header == "" {
					...
					report["auth_hint"] = "export ARTYFACTS_API_KEY=<your-key>"
				} else {
					authConfigured = true
			...
			if os.Getenv("ARTYFACTS_API_KEY") != "" {
				authEnvSet = append(authEnvSet, "ARTYFACTS_API_KEY")
				...
				authEnvRequiredMissing = append(authEnvRequiredMissing, "ARTYFACTS_API_KEY")
			}
			switch {
