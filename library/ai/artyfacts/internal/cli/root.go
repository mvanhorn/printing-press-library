...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "artyfacts-pp-cli",
		Short: "Manage artyfacts resources via the artyfacts API",
		Long: `Manage artyfacts resources via the artyfacts API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'artyfacts-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("artyfacts-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'artyfacts-pp-cli profile list')")
	...
	rootCmd.AddCommand(newOrgPromotedCmd(flags))
	rootCmd.AddCommand(newVersionCliCmd())
	rootCmd.AddCommand(newSyncCmd(flags))
	rootCmd.AddCommand(newOfflineSearchCmd(flags))
