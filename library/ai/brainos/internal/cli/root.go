...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "brainos-pp-cli",
		Short: `Brainos CLI — Your AI infrastructure CLI: offline analytics across trading, memory, agents, and MCP — all from one binary.`,
		Long: `Brainos CLI — Your AI infrastructure CLI: offline analytics across trading, memory, agents, and MCP — all from one binary.
...
Health check: run 'brainos-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("brainos-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'brainos-pp-cli profile list')")
	...
	rootCmd.AddCommand(newActiveMemoryCmd(flags))
	rootCmd.AddCommand(newAgentMessagesCmd(flags))
	rootCmd.AddCommand(newBrainConfigCmd(flags))
	rootCmd.AddCommand(newBrainEmailCaptureLogCmd(flags))
	rootCmd.AddCommand(newBrainProjectStatusCmd(flags))
	rootCmd.AddCommand(newBrokerConfigCmd(flags))
	rootCmd.AddCommand(newCronJobsCmd(flags))
	rootCmd.AddCommand(newDocumentsCmd(flags))
	rootCmd.AddCommand(newExecutorBriefsCmd(flags))
	rootCmd.AddCommand(newMarginLogCmd(flags))
	rootCmd.AddCommand(newMcpActivityLogsCmd(flags))
	rootCmd.AddCommand(newMcpApiKeysCmd(flags))
	rootCmd.AddCommand(newMcpAuthErrorsCmd(flags))
	rootCmd.AddCommand(newMcpOauthStatesCmd(flags))
	rootCmd.AddCommand(newMcpServersCmd(flags))
	rootCmd.AddCommand(newMcpSessionsCmd(flags))
	rootCmd.AddCommand(newMcpToolsCmd(flags))
	rootCmd.AddCommand(newMcpapikeysCmd(flags))
	rootCmd.AddCommand(newMcpsessionsCmd(flags))
	rootCmd.AddCommand(newNatureosAgentCheckpointsCmd(flags))
	rootCmd.AddCommand(newNatureosAgentMemoryCmd(flags))
	rootCmd.AddCommand(newNatureosAllowlistCmd(flags))
	rootCmd.AddCommand(newNatureosDualModelTasksCmd(flags))
	rootCmd.AddCommand(newNatureosTaskQueueCmd(flags))
	rootCmd.AddCommand(newRpcCmd(flags))
	rootCmd.AddCommand(newSharedStateCmd(flags))
	rootCmd.AddCommand(newSkillsCmd(flags))
	rootCmd.AddCommand(newThoughtsCmd(flags))
	rootCmd.AddCommand(newTradingCalibrationCmd(flags))
	rootCmd.AddCommand(newTradingPostmortemsCmd(flags))
	rootCmd.AddCommand(newTradingPremortemsCmd(flags))
	rootCmd.AddCommand(newTradingRegimeLogCmd(flags))
	rootCmd.AddCommand(newTradingSessionsCmd(flags))
	rootCmd.AddCommand(newWebauthnCredentialsCmd(flags))
	...
	rootCmd.AddCommand(newAgentMessagesStatusSummaryPromotedCmd(flags))
	rootCmd.AddCommand(newToolUsageStatsPromotedCmd(flags))
	rootCmd.AddCommand(newVersionCliCmd())

	// Novel transcendence commands
	rootCmd.AddCommand(newTradingNovelCmd(flags))
	rootCmd.AddCommand(newMcpNovelCmd(flags))
	rootCmd.AddCommand(newMemoryNovelCmd(flags))
	rootCmd.AddCommand(newBrainNovelCmd(flags))
	rootCmd.AddCommand(newAgentsNovelCmd(flags))

	// skills gap subcommand
	for _, c := range rootCmd.Commands() {
		if c.Use == "skills" {
			c.AddCommand(newSkillsGapCmd(flags))
			break
		}
	}
