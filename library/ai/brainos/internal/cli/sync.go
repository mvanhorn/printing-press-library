...
Exit codes & warnings:
  ...
  brainos-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  brainos-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  brainos-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  brainos-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  brainos-pp-cli sync --latest-only

  # Sync historical data for a date range
  brainos-pp-cli sync --dates 20250101-20250131`,
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/brainos-pp-cli/data.db)")
	...
	cmd.Flags().StringVar(&dates, "dates", "", "Date or date range to sync (passed as date_range query parameter)")
...
func syncResourceSinceParam(resource string) string {
	...
	case "mcpapikeys":
		return "updated_at"
	case "natureos-agent-checkpoints":
		return "updated_at"
	case "natureos-agent-memory":
		return "updated_at"
	case "natureos-dual-model-tasks":
		return "updated_at"
	case "shared-state":
		return "updated_at"
	case "skills":
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		...
		"agent-messages-status-summary": "/agent_messages_status_summary",
		"brain-config":                  "/brain_config",
		"brain-email-capture-log":       "/brain_email_capture_log",
		"brain-project-status":          "/brain_project_status",
		"broker-config":                 "/broker_config",
		"cron-jobs":                     "/cron_jobs",
		"documents":                     "/documents",
		"executor-briefs":               "/executor_briefs",
		"margin-log":                    "/margin_log",
		"mcp-activity-logs":             "/mcp_activity_logs",
		"mcp-api-keys":                  "/mcp_api_keys",
		"mcp-auth-errors":               "/mcp_auth_errors",
		"mcp-oauth-states":              "/mcp_oauth_states",
		"mcp-servers":                   "/mcp_servers",
		"mcp-sessions":                  "/mcp_sessions",
		"mcp-tools":                     "/mcp_tools",
		"mcpapikeys":                    "/mcpapikeys",
		"mcpsessions":                   "/mcpsessions",
		"natureos-agent-checkpoints":    "/natureos_agent_checkpoints",
		"natureos-agent-memory":         "/natureos_agent_memory",
		"natureos-allowlist":            "/natureos_allowlist",
		"natureos-dual-model-tasks":     "/natureos_dual_model_tasks",
		"natureos-task-queue":           "/natureos_task_queue",
		"rpc":                           "/rpc/show_limit",
		"shared-state":                  "/shared_state",
		"skills":                        "/skills",
		"thoughts":                      "/thoughts",
		"tool-usage-stats":              "/tool_usage_stats",
		"trading-calibration":           "/trading_calibration",
		"trading-postmortems":           "/trading_postmortems",
		"trading-premortems":            "/trading_premortems",
		"trading-regime-log":            "/trading_regime_log",
