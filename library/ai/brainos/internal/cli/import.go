...
but do not stop the import.`,
  ...
  brainos-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  brainos-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | brainos-pp-cli import <resource> --input -`,
