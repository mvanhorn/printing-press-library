...
large datasets as it has no memory pressure.`,
  ...
  brainos-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  brainos-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  brainos-pp-cli export <resource> --format jsonl | jq '.id'`,
