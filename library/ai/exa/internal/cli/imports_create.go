...
func newImportsCreateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "create",
		Short:       "Creates a new import to upload your data into Websets.",
		Example:     "  exa-pp-cli imports create",
		Annotations: map[string]string{"pp:endpoint": "imports.create", "pp:method": "POST", "pp:path": "https://api.exa.ai/websets/v0/imports"},
