...
func TestDeclaredAPISurfaceReachable(t *testing.T) {
	expected := []string{
		...
		"monitors batch",
		"monitors create",
		"monitors create-endpoint",
		"monitors delete",
		"monitors delete-id",
		"monitors get",
		"monitors get-id",
		"monitors list",
		"monitors list-endpoint",
		"monitors runs",
		"monitors runs get",
		"monitors runs list",
		"monitors runs monitors-get",
		"monitors runs monitors-list",
		"monitors trigger",
		"monitors trigger monitor",
		"monitors update",
		"monitors update-id",
		"teams",
		"webhooks",
		"webhooks attempts",
		"webhooks attempts webhooks-list",
		"webhooks create",
		"webhooks delete",
		"webhooks get",
		"webhooks list",
		...
		"websets",
		"websets cancel",
		"websets cancel websets",
		"websets create",
		"websets delete",
		"websets enrichments",
		"websets enrichments websets-cancel",
		"websets enrichments websets-create",
		"websets enrichments websets-delete",
		"websets enrichments websets-get",
		"websets enrichments websets-update",
		"websets get",
		"websets items",
		"websets items websets-delete",
		"websets items websets-get",
		"websets items websets-list",
		"websets list",
		"websets preview",
		"websets searches",
		"websets searches websets-cancel",
		"websets searches websets-create",
		"websets searches websets-get",
		"websets update",
	}
