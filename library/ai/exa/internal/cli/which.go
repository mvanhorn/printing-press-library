...
var whichIndex = []whichEntry{
	{Command: "spend", Description: "See cumulative API spend across every Exa call, broken down by day and resource.", Group: "Local state that compounds", WhyItMatters: "Agents should reach for this when they need to know how much Exa usage costs before running another batch."},
	{Command: "monitor diff", Description: "Compare two synced monitor runs and see exactly which URLs are new, gone, or unchanged.", Group: "Local state that compounds", WhyItMatters: "Reach for this to see what a scheduled search found since the last run instead of re-reading entire run outputs."},
	{Command: "entity report", Description: "Build a first-seen / last-seen / mention-count timeline for any company or person across your synced searches and webset items.", Group: "Local state that compounds", WhyItMatters: "Reach for this to track when an entity first appeared and how often it shows up across all your research surfaces."},
	{Command: "webset new", Description: "List items added to a live webset since your last sync, so you only see what changed.", Group: "Local state that compounds", WhyItMatters: "Reach for this for the weekly what's-new sweep over a curated set instead of re-listing every item."},
}
