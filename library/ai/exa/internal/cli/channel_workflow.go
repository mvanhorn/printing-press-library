...
func newWorkflowCmd(flags *rootFlags) *cobra.Command {
	...
	// Transcendence: SQLite-native intelligence.
	cmd.AddCommand(newWorkflowDriftCmd(flags))
	cmd.AddCommand(newWorkflowEntitiesCmd(flags))
	cmd.AddCommand(newWorkflowMonitorDigestCmd(flags))
	cmd.AddCommand(newWorkflowVelocityCmd(flags))
	cmd.AddCommand(newWorkflowContradictionCmd(flags))
	cmd.AddCommand(newWorkflowTemplateCmd(flags))
	cmd.AddCommand(newWorkflowBudgetCmd(flags))
	cmd.AddCommand(newWorkflowIntersectCmd(flags))
...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  exa-pp-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"agent", "events", "imports", "monitors", "research", "webhooks", "websets"}
			totalSynced := 0
