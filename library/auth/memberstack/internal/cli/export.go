...
large datasets as it has no memory pressure.`,
  ...
  memberstack-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  memberstack-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  memberstack-pp-cli export <resource> --format jsonl | jq '.id'`,
