...
but do not stop the import.`,
  ...
  memberstack-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  memberstack-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | memberstack-pp-cli import <resource> --input -`,
