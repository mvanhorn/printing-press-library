...
large datasets as it has no memory pressure.`,
  ...
  amazon-jobs-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  amazon-jobs-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  amazon-jobs-pp-cli export <resource> --format jsonl | jq '.id'`,
