...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("AMAZON_JOBS_STATE_DIR", "")
	t.Setenv("AMAZON_JOBS_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"amazon-jobs-pp-cli auth login",
		"amazon-jobs-pp-cli doctor",
		"amazon-jobs-pp-cli help items",
		"amazon-jobs-pp-cli sync",
		"amazon-jobs-pp-cli profile list",
		"amazon-jobs-pp-cli feedback list",
		"amazon-jobs-pp-cli which",
		"amazon-jobs-pp-cli agent-context",
		"amazon-jobs-pp-cli completion bash",
		"amazon-jobs-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"amazon-jobs-pp-cli recall",
		"amazon-jobs-pp-cli learnings",
		"amazon-jobs-pp-cli teach-pattern",
		"amazon-jobs-pp-cli teach-lookup",
		"amazon-jobs-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("amazon-jobs-pp-cli")); err == nil {
