...
func buildAgentDiscoveryContext() *agentContextDiscovery {
	return &agentContextDiscovery{
		...
		TargetURL:     "https://mobbin.com/discover/apps/web/latest",
		EntryCount:    2103,
		APIEntryCount: 71,
		...
		CandidateCommands: []string{
			"create_fetch_dictionary_definitions — Derived from observed POST /api/filter-tags/fetch-dictionary-definitions traffic.",
			"create_fetch_discover_page_apps — Derived from observed POST /api/discover/fetch-discover-page-apps traffic.",
			"create_fetch_popular_apps_with_preview_screens — Derived from observed POST /api/popular-apps/fetch-popular-apps-with-preview-screens traffic.",
			"create_fetch_searchable_sites — Derived from observed POST /api/search-bar/fetch-searchable-sites traffic.",
			"create_fetch_trending_apps — Derived from observed POST /api/search-bar/fetch-trending-apps traffic.",
			"create_fetch_trending_filter_tags — Derived from observed POST /api/search-bar/fetch-trending-filter-tags traffic.",
			"create_fetch_trending_sites — Derived from observed POST /api/search-bar/fetch-trending-sites traffic.",
			"create_fetch_trending_text_in_screenshot_keywords — Derived from observed POST /api/search-bar/fetch-trending-text-in-screenshot-keywords traffic.",
		},
	}
}
