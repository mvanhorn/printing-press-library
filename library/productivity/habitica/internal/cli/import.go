...
but do not stop the import.`,
  ...
  habitica-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  habitica-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | habitica-pp-cli import <resource> --input -`,
