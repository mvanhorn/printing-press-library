...
large datasets as it has no memory pressure.`,
  ...
  habitica-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  habitica-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  habitica-pp-cli export <resource> --format jsonl | jq '.id'`,
