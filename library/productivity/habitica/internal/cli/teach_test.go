...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"habitica-pp-cli auth login",
		"habitica-pp-cli doctor",
		"habitica-pp-cli help items",
		"habitica-pp-cli sync",
		"habitica-pp-cli profile list",
		"habitica-pp-cli feedback list",
		"habitica-pp-cli which",
		"habitica-pp-cli agent-context",
		"habitica-pp-cli completion bash",
		"habitica-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"habitica-pp-cli recall",
		"habitica-pp-cli learnings",
		"habitica-pp-cli teach-pattern",
		"habitica-pp-cli teach-lookup",
		"habitica-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("habitica-pp-cli")); err == nil {
