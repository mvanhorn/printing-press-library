...
var whichIndex = []whichEntry{
	{Command: "today", Description: "Turn today’s dailies, due to-dos, and character state into one actionable quest queue.", Group: "Daily ritual", WhyItMatters: "Use this before planning the day instead of issuing separate task and profile calls."},
	{Command: "plan chores", Description: "Preview a chore batch as Habitica quests and create it only after an explicit apply confirmation.", Group: "Daily ritual", WhyItMatters: "Use this to turn a prepared chore list into quests while retaining a complete mutation preview."},
	{Command: "reward afford", Description: "Check whether a reward fits current gold while preserving a chosen reserve for later goals.", Group: "Reward decisions", WhyItMatters: "Use this before spending gold when a generic purchase request cannot explain the tradeoff."},
	{Command: "tag load", Description: "Compare active, due, overdue, and checklist-blocked work across Habitica tags.", Group: "Workload insight", WhyItMatters: "Use this to rebalance chores by category rather than scanning individual tasks."},
	{Command: "week review", Description: "Review seven-day overdue, stalled, and completed-task trends from real local snapshots.", Group: "Workload insight", WhyItMatters: "Use this in weekly review to see whether the Habitica system is improving or accumulating debt."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  habitica-pp-cli which "stale tickets"
  habitica-pp-cli which "bottleneck"
  habitica-pp-cli which --limit 1 "send message"
  habitica-pp-cli which                                # list the full capability index`,
