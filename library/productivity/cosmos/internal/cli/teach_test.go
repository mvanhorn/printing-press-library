...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"cosmos-pp-cli auth login",
		"cosmos-pp-cli doctor",
		"cosmos-pp-cli help items",
		"cosmos-pp-cli sync",
		"cosmos-pp-cli profile list",
		"cosmos-pp-cli feedback list",
		"cosmos-pp-cli which",
		"cosmos-pp-cli agent-context",
		"cosmos-pp-cli completion bash",
		"cosmos-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"cosmos-pp-cli teach",
		"cosmos-pp-cli recall",
		"cosmos-pp-cli learnings",
		"cosmos-pp-cli teach-pattern",
		"cosmos-pp-cli teach-lookup",
		"cosmos-pp-cli items list",
	}
