...
var whichIndex = []whichEntry{
	{Command: "review", Description: "Turn recent saves, unfiled elements, duplicate connections, AI flags, and missing attribution into a deterministic maintenance queue.", Group: "Local state that compounds", WhyItMatters: "Use it before a weekly curation session to see exactly what needs attention."},
	{Command: "collection overlap", Description: "Compare two collections and report shared elements, duplicate media, and references unique to each side.", Group: "Cross-collection intelligence", WhyItMatters: "Use it to keep project moodboards distinct and avoid recycling the same references."},
	{Command: "collection coverage", Description: "Compare live Cosmos search results with live collection membership and return promising references that are not already saved.", Group: "Cross-collection intelligence", WhyItMatters: "Use it when a board feels repetitive and you need genuinely new references."},
	{Command: "provenance audit", Description: "Report missing source URLs or authors and show source concentration from live collection elements.", Group: "Trustworthy creative archives", WhyItMatters: "Use it before publishing or handing off a moodboard so references remain attributable."},
	{Command: "element trail", Description: "Walk visual similarity results to a bounded depth and emit a deduplicated, source-aware graph.", Group: "Discovery that compounds", WhyItMatters: "Use it to explore a visual direction without losing the path back to the seed reference."},
	{Command: "snapshot diff", Description: "Compare historical collection membership and show added, removed, and moved elements.", Group: "Trustworthy creative archives", WhyItMatters: "Use it to audit a team's curation changes or reproduce an earlier moodboard state."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  cosmos-pp-cli which "stale tickets"
  cosmos-pp-cli which "bottleneck"
  cosmos-pp-cli which --limit 1 "send message"
  cosmos-pp-cli which                                # list the full capability index`,
