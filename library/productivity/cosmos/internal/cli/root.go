...
type rootFlags struct {
	...
	// invocation. Mirrors the COSMOS_NO_LEARN env var.
	noLearn bool
...
func Execute() (retErr error) {
	ensureCosmosPlatformRegistered()
	var flags rootFlags
...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "cosmos-pp-cli",
		Short: `Cosmos CLI — Search, organize, export, and audit your Cosmos inspiration library from the terminal.`,
		Long: `Cosmos CLI — Search, organize, export, and audit your Cosmos inspiration library from the terminal.
...
Health check: run 'cosmos-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("cosmos-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.runProfileName, "profile", "", "Apply values from a saved run profile; this does not select a client (see 'cosmos-pp-cli profile list')")
	...
	rootCmd.AddCommand(newAllsCmd(flags))
	rootCmd.AddCommand(newClustersCmd(flags))
	rootCmd.AddCommand(newElementsCmd(flags))
	rootCmd.AddCommand(newForsCmd(flags))
	rootCmd.AddCommand(newGlobalsCmd(flags))
	...
	rootCmd.AddCommand(newActivesPromotedCmd(flags))
	rootCmd.AddCommand(newActivitiesPromotedCmd(flags))
	rootCmd.AddCommand(newConnectablesPromotedCmd(flags))
	rootCmd.AddCommand(newDidsPromotedCmd(flags))
	rootCmd.AddCommand(newHasPromotedCmd(flags))
	rootCmd.AddCommand(newLoadersPromotedCmd(flags))
	rootCmd.AddCommand(newProfilesPromotedCmd(flags))
	rootCmd.AddCommand(newQuicksPromotedCmd(flags))
	rootCmd.AddCommand(newRecentliesPromotedCmd(flags))
	rootCmd.AddCommand(newRecentsPromotedCmd(flags))
	rootCmd.AddCommand(newRemembersPromotedCmd(flags))
	rootCmd.AddCommand(newSimilarsPromotedCmd(flags))
	rootCmd.AddCommand(newSubclustersPromotedCmd(flags))
	...
	addNovelCommandIfAbsent(rootCmd, newNovelCollectionCmd(flags))
	addNovelCommandIfAbsent(rootCmd, newNovelElementCmd(flags))
	addNovelCommandIfAbsent(rootCmd, newNovelProvenanceCmd(flags))
	addNovelCommandIfAbsent(rootCmd, newNovelReviewCmd(flags))
	addNovelCommandIfAbsent(rootCmd, newNovelSnapshotCmd(flags))
