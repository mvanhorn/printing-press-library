...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/productivity/zenodo/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("ZENODO_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "zenodo-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
