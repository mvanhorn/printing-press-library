...
type rootFlags struct {
	...
	// invocation. Mirrors the ZENODO_NO_LEARN env var.
	noLearn bool
...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "zenodo-pp-cli",
		Short: "Manage zenodo resources via the zenodo API",
		Long: `Manage zenodo resources via the zenodo API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'zenodo-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("zenodo-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'zenodo-pp-cli profile list')")
	...
	rootCmd.AddCommand(newDepositCmd(flags))
	...
	rootCmd.AddCommand(newGrantsPromotedCmd(flags))
	rootCmd.AddCommand(newLicensesPromotedCmd(flags))
	rootCmd.AddCommand(newRecordsPromotedCmd(flags))
