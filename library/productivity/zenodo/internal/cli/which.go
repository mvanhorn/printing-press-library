...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  zenodo-pp-cli which "stale tickets"
  zenodo-pp-cli which "bottleneck"
  zenodo-pp-cli which --limit 1 "send message"
  zenodo-pp-cli which                                # list the full capability index`,
