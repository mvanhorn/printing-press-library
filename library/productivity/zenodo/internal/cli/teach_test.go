...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("ZENODO_STATE_DIR", "")
	t.Setenv("ZENODO_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"zenodo-pp-cli auth login",
		"zenodo-pp-cli doctor",
		"zenodo-pp-cli help items",
		"zenodo-pp-cli sync",
		"zenodo-pp-cli profile list",
		"zenodo-pp-cli feedback list",
		"zenodo-pp-cli which",
		"zenodo-pp-cli agent-context",
		"zenodo-pp-cli completion bash",
		"zenodo-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"zenodo-pp-cli teach",
		"zenodo-pp-cli recall",
		"zenodo-pp-cli learnings",
		"zenodo-pp-cli teach-pattern",
		"zenodo-pp-cli teach-lookup",
		"zenodo-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("zenodo-pp-cli")); err == nil {
