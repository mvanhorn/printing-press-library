...
but do not stop the import.`,
  ...
  zenodo-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  zenodo-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | zenodo-pp-cli import <resource> --input -`,
