...
large datasets as it has no memory pressure.`,
  ...
  zenodo-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  zenodo-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  zenodo-pp-cli export <resource> --format jsonl | jq '.id'`,
