...
func Load(configPath string) (*Config, error) {
	...
	// Env var overrides
	if v := os.Getenv("ZENODO_ACCESS_TOKEN"); v != "" {
		cfg.AccessToken = v
		cfg.markEnvOverride("AccessToken")
		cfg.AuthSource = "env:ZENODO_ACCESS_TOKEN"
		cfg.CredentialSource = "env:ZENODO_ACCESS_TOKEN"
	}
	...
	if v := os.Getenv("ZENODO_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("ZENODO_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "zenodo-pp-cli", "config.toml"), nil
}
