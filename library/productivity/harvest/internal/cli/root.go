...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "harvest-pp-cli",
		Short: `Harvest CLI — Every Harvest CLI feature, plus a local SQLite store and offline FTS no other tool has.`,
		Long: `Harvest CLI — Every Harvest CLI feature, plus a local SQLite store and offline FTS no other tool has.
...
Health check: run 'harvest-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("harvest-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'harvest-pp-cli profile list')")
	...
	rootCmd.AddCommand(newEstimateItemCategoriesCmd(flags))
	rootCmd.AddCommand(newEstimatesCmd(flags))
	rootCmd.AddCommand(newExpenseCategoriesCmd(flags))
	rootCmd.AddCommand(newExpensesCmd(flags))
	rootCmd.AddCommand(newInvoiceItemCategoriesCmd(flags))
	...
	timeEntriesCmd := newTimeEntriesCmd(flags)
	timeEntriesCmd.AddCommand(newTimeEntriesRepeatCmd(flags))
	...
	rootCmd.AddCommand(newTaskAssignmentsPromotedCmd(flags))
	rootCmd.AddCommand(newUserAssignmentsPromotedCmd(flags))
	...
	rootCmd.AddCommand(newUtilizationCmd(flags))
	rootCmd.AddCommand(newDayCmd(flags))
