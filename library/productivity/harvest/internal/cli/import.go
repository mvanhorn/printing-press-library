...
but do not stop the import.`,
  ...
  harvest-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  harvest-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | harvest-pp-cli import <resource> --input -`,
