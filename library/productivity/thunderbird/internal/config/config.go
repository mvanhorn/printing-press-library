...
func Load(configPath string) (*Config, error) {
	...
	if v := cliutil.EnvOverride("THUNDERBIRD_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("THUNDERBIRD_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "thunderbird-pp-cli", "config.json"), nil
}
