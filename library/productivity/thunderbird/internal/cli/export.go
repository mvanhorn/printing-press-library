...
func newExportCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Long: `Export a resource (messages, contacts, folders, accounts or filters) to a
local file. Supports JSONL (one JSON object per line, streaming-friendly) and
JSON (array). JSONL is recommended for large datasets as it has no memory
pressure.`,
		Example: `  # Export all messages as JSONL (streaming, recommended for large datasets)
  ...
  thunderbird-pp-cli export contacts --format jsonl | jq '.id'`,
