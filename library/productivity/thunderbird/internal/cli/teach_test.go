...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"thunderbird-pp-cli auth login",
		"thunderbird-pp-cli doctor",
		"thunderbird-pp-cli help items",
		"thunderbird-pp-cli sync",
		"thunderbird-pp-cli profile list",
		"thunderbird-pp-cli feedback list",
		"thunderbird-pp-cli which",
		"thunderbird-pp-cli agent-context",
		"thunderbird-pp-cli completion bash",
		"thunderbird-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"thunderbird-pp-cli recall",
		"thunderbird-pp-cli learnings",
		"thunderbird-pp-cli teach-pattern",
		"thunderbird-pp-cli teach-lookup",
		"thunderbird-pp-cli items list",
	}
