...
but do not stop the import.`,
  ...
  bonusly-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  bonusly-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | bonusly-pp-cli import <resource> --input -`,
