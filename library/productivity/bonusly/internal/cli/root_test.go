...
func TestDeclaredAPISurfaceReachable(t *testing.T) {
	// pp:hand-edit bonusly-remove-broken-commands — awards, groups,
	// incentives, and meetings removed from the expected surface: no
	// working endpoint could be found for any of them (see
	...
	expected := []string{
		...
		"recognition get",
		"recognition given",
		"recognition group-count",
		"recognition last-given",
		"recognition list-types",
		"recognition received",
		"recognition update",
		"redemptions",
		"redemptions get",
		"redemptions list-mine",
		"users",
		"users get",
		"users get-bulk",
		"users me",
