...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"bonusly-pp-cli auth login",
		"bonusly-pp-cli doctor",
		"bonusly-pp-cli help items",
		"bonusly-pp-cli sync",
		"bonusly-pp-cli profile list",
		"bonusly-pp-cli feedback list",
		"bonusly-pp-cli which",
		"bonusly-pp-cli agent-context",
		"bonusly-pp-cli completion bash",
		"bonusly-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"bonusly-pp-cli recall",
		"bonusly-pp-cli learnings",
		"bonusly-pp-cli teach-pattern",
		"bonusly-pp-cli teach-lookup",
		"bonusly-pp-cli items list",
	}
