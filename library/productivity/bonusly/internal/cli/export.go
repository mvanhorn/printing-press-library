...
large datasets as it has no memory pressure.`,
  ...
  bonusly-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  bonusly-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  bonusly-pp-cli export <resource> --format jsonl | jq '.id'`,
