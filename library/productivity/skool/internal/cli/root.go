...
Highlights (not in the official API docs):
  ...
  • classroom import-course   Import local markdown courses as private drafts (api2 write; safety gated).
...
See README.md or the bundled SKILL.md for recipes.`,
	...
	rootCmd.AddCommand(newCourseRootCmd(flags))
	rootCmd.AddCommand(newLessonRootCmd(flags))
	...
	rootCmd.AddCommand(newImportCourseTopCmd(flags))
	rootCmd.AddCommand(newVerifyImportTopCmd(flags))
