...
but do not stop the import.`,
  ...
  canvas-lms-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  canvas-lms-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | canvas-lms-pp-cli import <resource> --input -`,
