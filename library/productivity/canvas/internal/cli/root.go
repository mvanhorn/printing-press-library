...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "canvas-lms-pp-cli",
		Short: `Canvas LMS CLI — The first Canvas CLI that handles pagination, works across all your courses at once, and tells you what to work on next.`,
		Long: `Canvas LMS CLI — The first Canvas CLI that handles pagination, works across all your courses at once, and tells you what to work on next.
...
Health check: run 'canvas-lms-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("canvas-lms-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'canvas-lms-pp-cli profile list')")
	...
	rootCmd.AddCommand(newTemporaryEnrollmentStatusPromotedCmd(flags))
	rootCmd.AddCommand(newVersionCliCmd())
	rootCmd.AddCommand(newPressureCmd(flags))
	rootCmd.AddCommand(newImpactCmd(flags))
	rootCmd.AddCommand(newDriftCmd(flags))
	rootCmd.AddCommand(newGoingDarkCmd(flags))
	rootCmd.AddCommand(newLateWindowCmd(flags))
	rootCmd.AddCommand(newForecastCmd(flags))
	rootCmd.AddCommand(newHeadsUpCmd(flags))
	rootCmd.AddCommand(newGapsCmd(flags))
	rootCmd.AddCommand(newDigestCmd(flags))
	rootCmd.AddCommand(newCheckTypeCmd(flags))
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("canvas-lms-pp-cli %s\n", version)
		},
	}
}
