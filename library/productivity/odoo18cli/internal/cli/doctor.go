...
func newDoctorCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `  odoo18cli-pp-cli doctor
  odoo18cli-pp-cli doctor --json
  odoo18cli-pp-cli doctor --fail-on warn`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if cfg != nil {
				...
				if header == "" {
					...
					report["auth_hint"] = "export ODOO_API_KEY=<your-key>"
				} else {
					authConfigured = true
			...
			if os.Getenv("ODOO_API_KEY") != "" {
				authEnvSet = append(authEnvSet, "ODOO_API_KEY")
				...
				authEnvRequiredMissing = append(authEnvRequiredMissing, "ODOO_API_KEY")
			}
			switch {
