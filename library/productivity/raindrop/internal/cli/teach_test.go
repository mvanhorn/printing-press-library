...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"raindrop-pp-cli auth login",
		"raindrop-pp-cli doctor",
		"raindrop-pp-cli help items",
		"raindrop-pp-cli sync",
		"raindrop-pp-cli profile list",
		"raindrop-pp-cli feedback list",
		"raindrop-pp-cli which",
		"raindrop-pp-cli agent-context",
		"raindrop-pp-cli completion bash",
		"raindrop-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"raindrop-pp-cli recall",
		"raindrop-pp-cli learnings",
		"raindrop-pp-cli teach-pattern",
		"raindrop-pp-cli teach-lookup",
		"raindrop-pp-cli items list",
	}
