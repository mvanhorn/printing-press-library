...
var whichIndex = []whichEntry{
	{Command: "sync", Description: "Mirror bookmarks, collections, tags and highlights for instant offline search.", Group: "Local state that compounds", WhyItMatters: "Use before local analysis or when repeated remote scans would waste rate limit."},
	{Command: "inbox review", Description: "Process Unsorted bookmarks in resumable, bounded review sessions.", Group: "Safe organization", WhyItMatters: "Use for safe inbox-zero organization without repeated prompts."},
	{Command: "changes", Description: "Show field-level bookmark changes between sync snapshots.", Group: "Local state that compounds", WhyItMatters: "Use to audit automation and discover recent library edits."},
	{Command: "tag health", Description: "Discover case variants, near-duplicates, singleton tags and merge candidates.", Group: "Safe organization", WhyItMatters: "Use before bulk tag cleanup instead of guessing merge targets."},
	{Command: "duplicates plan", Description: "Choose canonical bookmarks while preserving tags, notes and highlights.", Group: "Safe organization", WhyItMatters: "Use when duplicate cleanup must not discard richer metadata."},
	{Command: "revisit", Description: "Resurface useful forgotten bookmarks without repeating recent suggestions.", Group: "Knowledge workflows", WhyItMatters: "Use to turn a bookmark archive back into an active reading system."},
	{Command: "related", Description: "Find explainable related bookmarks offline using text, tags and domains.", Group: "Knowledge workflows", WhyItMatters: "Use for research synthesis without a hosted semantic-search dependency."},
	{Command: "highlights digest", Description: "Create deduplicated Markdown or JSONL study digests from highlights.", Group: "Knowledge workflows", WhyItMatters: "Use to turn annotations into portable research output."},
	{Command: "workflow status", Description: "Run crash-safe bounded triage queues with retry and manual-review states.", Group: "Automation safety", WhyItMatters: "Use for unattended agents that must resume safely after failures."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  raindrop-pp-cli which "stale tickets"
  raindrop-pp-cli which "bottleneck"
  raindrop-pp-cli which --limit 1 "send message"
  raindrop-pp-cli which                                # list the full capability index`,
