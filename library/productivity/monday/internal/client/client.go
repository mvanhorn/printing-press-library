...
func (c *Client) cacheKey(path string, params map[string]string) string {
	key := path
	// PATCH: sort query params before hashing so identical GET requests share
	// one deterministic cache file regardless of Go map iteration order.
...
func (c *Client) authHeader() (string, error) {
	...
	// PATCH: monday.com uses non-expiring API tokens for this printed CLI, so
	// do not run the generated OAuth refresh branch with an empty token URL.
