...
but do not stop the import.`,
  ...
  monday-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  monday-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | monday-pp-cli import <resource> --input -`,
