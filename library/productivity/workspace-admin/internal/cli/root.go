...
Highlights (not in the official API docs):
  • workflow offboard   Run a departing user's entire lifecycle in one command — suspend, reset password, sign out, revoke OAuth tokens, transfer Drive ownership, set Gmail delegation and forwarding, wipe devices, remove fr…
