...
func newUsersMeetingsMeetingsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if cmd.Flags().Changed("type") {
				allowedType := []string{"scheduled", "live", "upcoming"}
				validType := false
			...
			data, prov, err := resolvePaginatedReadWithStrategy(cmd.Context(), c, flags, "live", "meetings", path, map[string]string{
	...
	cmd.Flags().StringVar(&flagType, "type", "live", "The meeting type (one of: scheduled, live, upcoming)")
