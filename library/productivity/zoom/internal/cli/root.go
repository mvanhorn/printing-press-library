...
type rootFlags struct {
	...
	// invocation. Mirrors the ZOOM_NO_LEARN env var.
	noLearn bool
...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "zoom-pp-cli",
		Short: `Zoom CLI — The first Zoom CLI that joins your local desktop app, your on-disk recordings, and your cloud account into one…`,
		Long: `Zoom CLI — The first Zoom CLI that joins your local desktop app, your on-disk recordings, and your cloud account into one agent-native surface.
...
See README.md or the bundled SKILL.md for recipes.`,
	...
	rootCmd.PersistentFlags().StringVar(&flags.runProfileName, "profile", "", "Apply values from a saved run profile; this does not select a client (see 'zoom-pp-cli profile list')")
	...
	attachZoomS2SAuth(authCmd, flags)
	...
	rootCmd.AddCommand(newZoomNextCmd(flags))
