...
func newImChatSessionsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "chat-sessions",
		Aliases:     []string{"list"},
		Short:       "Retrieve IM Chat sessions for a specified period This API only supports oauth2.",
		Example:     "  zoom-pp-cli im chat-sessions --from 2026-01-15 --to 2026-01-15",
