...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/productivity/zoom/internal/learn/lookups"
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "past-meetings":
		return db.UpsertPastMeetings(data)
	...
	case "tracking-fields":
		return db.UpsertTrackingFields(data)
	case "tsp":
		return db.UpsertTsp(data)
	case "users":
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{ // #nosec G101 -- endpoint paths, not credentials.
		...
		"h323":              "/h323/devices",
		"im":                "/im/groups",
		"im-chat-sessions":  "/im/chat/sessions",
		"metrics":           "/metrics/im",
		"metrics-crc":       "/metrics/crc",
		"metrics-meetings":  "/metrics/meetings",
		"metrics-webinars":  "/metrics/webinars",
		"metrics-zoomrooms": "/metrics/zoomrooms",
		"participants":      "/past_meetings/{meetingUUID}/participants",
		"registrants":       "/meetings/{meetingId}/registrants",
		"report":            "/report/daily",
		"report-telephone":  "/report/telephone",
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "im", ParentTable: "groups", ParentIDParam: "groupId", PathTemplate: "/im/groups/{groupId}/members", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "groupId", Field: "id"},
		}},
		{Name: "members", ParentTable: "groups", ParentIDParam: "groupId", PathTemplate: "/groups/{groupId}/members", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "groupId", Field: "id"},
		}},
		{Name: "report", ParentTable: "users", ParentIDParam: "userId", PathTemplate: "/report/users/{userId}/meetings", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "userId", Field: "id"},
		}},
		{Name: "users_meetings", ParentTable: "users", ParentIDParam: "userId", PathTemplate: "/users/{userId}/meetings", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "userId", Field: "id"},
		}},
		{Name: "users_recordings", ParentTable: "users", ParentIDParam: "userId", PathTemplate: "/users/{userId}/recordings", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "userId", Field: "id"},
		}},
		{Name: "users_webinars", ParentTable: "users", ParentIDParam: "userId", PathTemplate: "/users/{userId}/webinars", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "userId", Field: "id"},
		}},
	}
}
...
var reconcileTypedTables = map[string]string{
	...
	"meetings":                "meetings",
	"meetings_polls":          "meetings_polls",
	"meetings_recordings":     "meetings_recordings",
	"meetings_registrants":    "meetings_registrants",
	...
	"past_meetings_instances": "past_meetings_instances",
	"past_webinars_instances": "past_webinars_instances",
	...
	"tsp":                     "tsp",
	"users":                   "users",
	"users_meetings":          "users_meetings",
	"users_recordings":        "users_recordings",
	"users_settings":          "users_settings",
	"users_status":            "users_status",
	"users_tsp":               "users_tsp",
	"users_webinars":          "users_webinars",
	"webhooks":                "webhooks",
	"webinars":                "webinars",
	"webinars_polls":          "webinars_polls",
	"webinars_registrants":    "webinars_registrants",
	"webinars_status":         "webinars_status",
}
...
func responsePathForResource(resource, path string) []string {
	...
	case "groups\x00/groups":
		return []string{"groups"}
	case "report\x00/report/daily":
		return []string{"dates"}
	case "report\x00/report/meetings/{meetingId}":
		return []string{"tracking_fields"}
	case "report\x00/report/meetings/{meetingId}/polls":
		return []string{"questions"}
	case "report\x00/report/webinars/{webinarId}":
		return []string{"tracking_fields"}
	case "report\x00/report/webinars/{webinarId}/polls":
		return []string{"questions"}
	case "report\x00/report/webinars/{webinarId}/qa":
		return []string{"questions"}
	case "tsp\x00/tsp":
		return []string{"dial_in_numbers"}
	}
	return nil
}
