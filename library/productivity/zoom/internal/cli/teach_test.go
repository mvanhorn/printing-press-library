...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"zoom-pp-cli auth login",
		"zoom-pp-cli doctor",
		"zoom-pp-cli help items",
		"zoom-pp-cli sync",
		"zoom-pp-cli profile list",
		"zoom-pp-cli feedback list",
		"zoom-pp-cli which",
		"zoom-pp-cli agent-context",
		"zoom-pp-cli completion bash",
		"zoom-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"zoom-pp-cli teach",
		"zoom-pp-cli recall",
		"zoom-pp-cli learnings",
		"zoom-pp-cli teach-pattern",
		"zoom-pp-cli teach-lookup",
		"zoom-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("zoom-pp-cli")); err == nil {
