...
func newMetricsDashboardWebinarsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  zoom-pp-cli metrics dashboard-webinars --from 2026-01-15 --to 2026-01-15",
	...
	cmd.Flags().StringVar(&flagType, "type", "live", "The webinar type (one of: past, pastOne, live)")
