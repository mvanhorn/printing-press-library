...
but do not stop the import.`,
  ...
  sigma-computing-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  sigma-computing-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | sigma-computing-pp-cli import <resource> --input -`,
