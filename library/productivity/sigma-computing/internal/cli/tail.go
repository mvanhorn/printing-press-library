...
native streaming instead of polling.`,
  ...
  sigma-computing-pp-cli tail --interval 10s

  # Tail a specific resource
  sigma-computing-pp-cli tail messages --interval 5s

  # Pipe to jq for filtering
  sigma-computing-pp-cli tail events --interval 30s | jq 'select(.type == "error")'`,
