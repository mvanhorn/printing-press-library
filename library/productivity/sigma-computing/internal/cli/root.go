...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "sigma-computing-pp-cli",
		Short: `Sigma Computing CLI — The first full-featured CLI for the Sigma Computing API, plus a local mirror, offline search, and governance audits no …`,
		Long: `Sigma Computing CLI — The first full-featured CLI for the Sigma Computing API, plus a local mirror, offline search, and governance audits no …
...
Health check: run 'sigma-computing-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("sigma-computing-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'sigma-computing-pp-cli profile list')")
	...
	rootCmd.AddCommand(newAccountTypesCmd(flags))
	rootCmd.AddCommand(newApiConnectorsCmd(flags))
	rootCmd.AddCommand(newApiCredentialsCmd(flags))
	rootCmd.AddCommand(newConnectionCmd(flags))
	rootCmd.AddCommand(newConnectionsCmd(flags))
	rootCmd.AddCommand(newCredentialsCmd(flags))
	rootCmd.AddCommand(newDataModelsCmd(flags))
	rootCmd.AddCommand(newDatasetsCmd(flags))
	rootCmd.AddCommand(newDeploymentPoliciesCmd(flags))
	...
	rootCmd.AddCommand(newSamlCmd(flags))
	rootCmd.AddCommand(newSharedTemplatesCmd(flags))
	rootCmd.AddCommand(newSourceSwapPoliciesCmd(flags))
	...
	rootCmd.AddCommand(newTranslationsCmd(flags))
	rootCmd.AddCommand(newUserAttributesCmd(flags))
	rootCmd.AddCommand(newWorkbooksCmd(flags))
	...
	rootCmd.AddCommand(newNovelGrantCmd(flags))
	rootCmd.AddCommand(newNovelMemberCmd(flags))
	rootCmd.AddCommand(newNovelWorkbookCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newAllowedIpsPromotedCmd(flags))
	rootCmd.AddCommand(newAllowedIpsBatchCreatePromotedCmd(flags))
	rootCmd.AddCommand(newAllowedIpsBatchDeletePromotedCmd(flags))
	rootCmd.AddCommand(newOrganizationsPromotedCmd(flags))
	rootCmd.AddCommand(newSigmaComputingPublicAuthPromotedCmd(flags))
