...
func newWorkspacesListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  sigma-computing-pp-cli workspaces list",
		Annotations: map[string]string{"pp:endpoint": "workspaces.list", "pp:method": "GET", "pp:path": "/v2/workspaces", "mcp:read-only": "true"},
