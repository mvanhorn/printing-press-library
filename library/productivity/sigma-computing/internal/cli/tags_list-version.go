...
func newTagsListVersionCmd(flags *rootFlags) *cobra.Command {
	var flagPage string
	var flagLimit int
	...
	cmd := &cobra.Command{
		Use:         "list-version",
		Aliases:     []string{"list"},
		Short:       "Get a list of version tags.",
		Example:     "  sigma-computing-pp-cli tags list-version",
		Annotations: map[string]string{"pp:endpoint": "tags.list-version", "pp:method": "GET", "pp:path": "/v2/tags", "mcp:read-only": "true"},
