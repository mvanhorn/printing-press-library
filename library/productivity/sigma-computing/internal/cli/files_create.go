...
func newFilesCreateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "create",
		Short:       "Create an empty workspace, folder, workbook, or report in Sigma.",
		Example:     "  sigma-computing-pp-cli files create",
		Annotations: map[string]string{"pp:endpoint": "files.create", "pp:method": "POST", "pp:path": "/v2/files"},
