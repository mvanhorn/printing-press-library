...
Resource scoping:
  ...
  sigma-computing-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  sigma-computing-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  sigma-computing-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  sigma-computing-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  sigma-computing-pp-cli sync --latest-only`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if dbPath == "" {
				dbPath = defaultDBPath("sigma-computing-pp-cli")
			}
...
func resourceSupportsPagination(resource string) bool {
	...
	case "deployment-policies":
		return true
	case "deployment-policies-tenants":
		return true
	...
	case "workbooks_elements":
		return true
	case "workbooks_elements_columns":
		return true
	case "workbooks_elements_query":
		return true
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "allowed-ips-batch-create":
		return db.UpsertAllowedIpsBatchCreate(data)
	case "api-connectors":
		return db.UpsertApiConnectors(data)
	case "api-credentials":
		return db.UpsertApiCredentials(data)
	case "lookup":
		return db.UpsertLookup(data)
	case "connections":
		return db.UpsertConnections(data)
	case "dbt_artifacts":
		return db.UpsertDbtArtifacts(data)
	case "connections_grants":
		return db.UpsertConnectionsGrants(data)
	case "sync":
	...
	case "data-models":
		return db.UpsertDataModels(data)
	case "data_models_columns":
		return db.UpsertDataModelsColumns(data)
	case "data_models_elements":
		return db.UpsertDataModelsElements(data)
	case "data_models_lineage":
		return db.UpsertDataModelsLineage(data)
	case "data_models_materialization_schedules":
		return db.UpsertDataModelsMaterializationSchedules(data)
	case "data_models_materializations":
		return db.UpsertDataModelsMaterializations(data)
	case "data_models_sources":
		return db.UpsertDataModelsSources(data)
	case "data_models_spec":
		return db.UpsertDataModelsSpec(data)
	case "data_models_swap_sources":
		return db.UpsertDataModelsSwapSources(data)
	case "data_models_tags":
		return db.UpsertDataModelsTags(data)
	case "datasets":
		return db.UpsertDatasets(data)
	case "datasets_grants":
		return db.UpsertDatasetsGrants(data)
	case "materialization":
		return db.UpsertMaterialization(data)
	case "migrate":
		return db.UpsertMigrate(data)
	case "datasets_sources":
		return db.UpsertDatasetsSources(data)
	case "deployment-policies":
		return db.UpsertDeploymentPolicies(data)
	case "deployment_policies_files":
		return db.UpsertDeploymentPoliciesFiles(data)
	case "deployment_policies_tenants":
		return db.UpsertDeploymentPoliciesTenants(data)
	case "favorites":
		return db.UpsertFavorites(data)
	case "files":
	...
	case "members_files":
		return db.UpsertMembersFiles(data)
	case "members_schedules":
		return db.UpsertMembersSchedules(data)
	case "members_teams":
		return db.UpsertMembersTeams(data)
	case "plugins":
	...
	case "reports_copy":
		return db.UpsertReportsCopy(data)
	case "reports_export":
		return db.UpsertReportsExport(data)
	case "reports_schedules":
		return db.UpsertReportsSchedules(data)
	case "reports_send":
		return db.UpsertReportsSend(data)
	case "reports_sources":
		return db.UpsertReportsSources(data)
	case "saml":
		return db.UpsertSaml(data)
	case "shared-templates":
		return db.UpsertSharedTemplates(data)
	case "source-swap-policies":
		return db.UpsertSourceSwapPolicies(data)
	case "tags":
		return db.UpsertTags(data)
	case "tags_workbooks":
		return db.UpsertTagsWorkbooks(data)
	case "teams":
		return db.UpsertTeams(data)
	case "assigned_user_attributes":
		return db.UpsertAssignedUserAttributes(data)
	case "teams_members":
		return db.UpsertTeamsMembers(data)
	case "teams_user_attributes":
		return db.UpsertTeamsUserAttributes(data)
	case "templates":
		return db.UpsertTemplates(data)
	case "templates_swap_sources":
		return db.UpsertTemplatesSwapSources(data)
	case "tenants":
		return db.UpsertTenants(data)
	case "capabilities":
		return db.UpsertCapabilities(data)
	case "tenants_workbooks":
		return db.UpsertTenantsWorkbooks(data)
	case "translations":
		return db.UpsertTranslations(data)
	case "user-attributes":
		return db.UpsertUserAttributes(data)
	case "user_attributes_teams":
		return db.UpsertUserAttributesTeams(data)
	case "user_attributes_tenants":
		return db.UpsertUserAttributesTenants(data)
	case "users":
		return db.UpsertUsers(data)
	case "workbooks":
		return db.UpsertWorkbooks(data)
	case "bookmarks":
		return db.UpsertBookmarks(data)
	case "workbooks_columns":
		return db.UpsertWorkbooksColumns(data)
	case "controls":
		return db.UpsertControls(data)
	case "workbooks_copy":
		return db.UpsertWorkbooksCopy(data)
	case "workbooks_elements":
		return db.UpsertWorkbooksElements(data)
	case "embeds":
		return db.UpsertEmbeds(data)
	case "workbooks_export":
		return db.UpsertWorkbooksExport(data)
	case "workbooks_grants":
		return db.UpsertWorkbooksGrants(data)
	case "workbooks_lineage":
		return db.UpsertWorkbooksLineage(data)
	case "workbooks_materialization_schedules":
		return db.UpsertWorkbooksMaterializationSchedules(data)
	case "workbooks_materializations":
		return db.UpsertWorkbooksMaterializations(data)
	case "pages":
		return db.UpsertPages(data)
	case "queries":
		return db.UpsertQueries(data)
	case "save_template":
		return db.UpsertSaveTemplate(data)
	case "workbooks_schedules":
		return db.UpsertWorkbooksSchedules(data)
	case "schema":
		return db.UpsertSchema(data)
	case "workbooks_send":
		return db.UpsertWorkbooksSend(data)
	case "share_cross_org":
		return db.UpsertShareCrossOrg(data)
	case "workbooks_sources":
		return db.UpsertWorkbooksSources(data)
	case "workbooks_spec":
		return db.UpsertWorkbooksSpec(data)
	case "workbooks_swap_sources":
		return db.UpsertWorkbooksSwapSources(data)
	case "tag":
		return db.UpsertTag(data)
	case "workbooks_tags":
		return db.UpsertWorkbooksTags(data)
	case "version_history":
		return db.UpsertVersionHistory(data)
	case "workspaces":
		return db.UpsertWorkspaces(data)
	case "workspaces_grants":
		return db.UpsertWorkspacesGrants(data)
	default:
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"account-types":               "/v2/accountTypes",
		"allowed-ips":                 "/v3alpha/allowedIps",
		"api-connectors":              "/v2/api-connectors",
		"api-credentials":             "/v2/api-credentials",
		"connections":                 "/v2/connections",
		"connections-paths":           "/v2/connections/paths",
		"data-models":                 "/v2/dataModels",
		"datasets":                    "/v2/datasets",
		"deployment-policies":         "/v2/deploymentPolicies",
		"deployment-policies-tenants": "/v2/deploymentPolicies/tenants",
		"files":                       "/v2/files",
		"grants":                      "/v2/grants",
		"members":                     "/v2/members",
		"plugins":                     "/v2/plugins",
		"reports":                     "/v2/reports",
		"saml":                        "/v2/saml/service-providers",
		...
		"user-attributes":             "/v2/user-attributes",
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "bookmarks", ParentTable: "workbooks", ParentIDParam: "workbookId", PathTemplate: "/v2/workbooks/{workbookId}/bookmarks", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "workbookId", Field: "id"},
		}},
		{Name: "capabilities", ParentTable: "tenants", ParentIDParam: "tenantOrganizationId", PathTemplate: "/v2/tenants/{tenantOrganizationId}/capabilities/deployments", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "tenantOrganizationId", Field: "id"},
		}},
		{Name: "connections_grants", ParentTable: "connections", ParentIDParam: "connectionId", PathTemplate: "/v2/connections/{connectionId}/grants", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "connectionId", Field: "id"},
		}},
		{Name: "controls", ParentTable: "workbooks", ParentIDParam: "workbookId", PathTemplate: "/v2/workbooks/{workbookId}/controls", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "workbookId", Field: "id"},
		}},
		{Name: "data_models_columns", ParentTable: "data-models", ParentIDParam: "dataModelId", PathTemplate: "/v2/dataModels/{dataModelId}/columns", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "dataModelId", Field: "id"},
		}},
		{Name: "data_models_elements", ParentTable: "data-models", ParentIDParam: "dataModelId", PathTemplate: "/v2/dataModels/{dataModelId}/elements", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "dataModelId", Field: "id"},
		}},
		{Name: "data_models_lineage", ParentTable: "data-models", ParentIDParam: "dataModelId", PathTemplate: "/v2/dataModels/{dataModelId}/lineage", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "dataModelId", Field: "id"},
		}},
		{Name: "data_models_materialization_schedules", ParentTable: "data-models", ParentIDParam: "dataModelId", PathTemplate: "/v2/dataModels/{dataModelId}/materializationSchedules", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "dataModelId", Field: "id"},
		}},
		{Name: "data_models_sources", ParentTable: "data-models", ParentIDParam: "dataModelId", PathTemplate: "/v2/dataModels/{dataModelId}/sources", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "dataModelId", Field: "id"},
		}},
		{Name: "data_models_tags", ParentTable: "data-models", ParentIDParam: "dataModelId", PathTemplate: "/v2/dataModels/{dataModelId}/tags", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "dataModelId", Field: "id"},
		}},
		{Name: "datasets_grants", ParentTable: "datasets", ParentIDParam: "datasetId", PathTemplate: "/v2/datasets/{datasetId}/grants", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "datasetId", Field: "id"},
		}},
		{Name: "deployment_policies_files", ParentTable: "deployment-policies", ParentIDParam: "deploymentPolicyId", PathTemplate: "/v2/deploymentPolicies/{deploymentPolicyId}/files", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "deploymentPolicyId", Field: "id"},
		}},
		{Name: "deployment_policies_tenants", ParentTable: "deployment-policies", ParentIDParam: "deploymentPolicyId", PathTemplate: "/v2/deploymentPolicies/{deploymentPolicyId}/tenants", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "deploymentPolicyId", Field: "id"},
		}},
		{Name: "embeds", ParentTable: "workbooks", ParentIDParam: "workbookId", PathTemplate: "/v2/workbooks/{workbookId}/embeds", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "workbookId", Field: "id"},
		}},
		{Name: "favorites", ParentTable: "members", ParentIDParam: "memberId", PathTemplate: "/v2/favorites/member/{memberId}", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "memberId", Field: "member_id"},
		}},
		{Name: "materialization", ParentTable: "datasets", ParentIDParam: "datasetId", PathTemplate: "/v2/datasets/{datasetId}/materialization", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "datasetId", Field: "id"},
		}},
		{Name: "members_files", ParentTable: "members", ParentIDParam: "memberId", PathTemplate: "/v2/members/{memberId}/files/favorites", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "memberId", Field: "id"},
		}},
		{Name: "members_files", ParentTable: "members", ParentIDParam: "memberId", PathTemplate: "/v2/members/{memberId}/files/recents", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "memberId", Field: "id"},
		}},
		{Name: "members_files", ParentTable: "members", ParentIDParam: "memberId", PathTemplate: "/v2/members/{memberId}/files", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "memberId", Field: "id"},
		}},
		{Name: "members_schedules", ParentTable: "members", ParentIDParam: "memberId", PathTemplate: "/v2/members/{memberId}/schedules", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "memberId", Field: "id"},
		}},
		{Name: "members_teams", ParentTable: "members", ParentIDParam: "memberId", PathTemplate: "/v2/members/{memberId}/teams", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "memberId", Field: "id"},
		}},
		{Name: "pages", ParentTable: "workbooks", ParentIDParam: "workbookId", PathTemplate: "/v2/workbooks/{workbookId}/pages", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "workbookId", Field: "id"},
		}},
		{Name: "queries", ParentTable: "workbooks", ParentIDParam: "workbookId", PathTemplate: "/v2/workbooks/{workbookId}/queries", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "workbookId", Field: "id"},
		}},
		{Name: "reports_schedules", ParentTable: "reports", ParentIDParam: "reportId", PathTemplate: "/v2/reports/{reportId}/schedules", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "reportId", Field: "id"},
		}},
		{Name: "tags_bookmarks", ParentTable: "tags", ParentIDParam: "workbookId", PathTemplate: "/v2/workbooks/{workbookId}/tags/{tagName}/bookmarks", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "workbookId", Field: "workbooks_id"},
			{Param: "tagName", Field: "name"},
		}},
		{Name: "tags_workbooks", ParentTable: "tags", ParentIDParam: "tagId", PathTemplate: "/v2/tags/{tagId}/workbooks", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "tagId", Field: "id"},
		}},
		{Name: "teams_members", ParentTable: "teams", ParentIDParam: "teamId", PathTemplate: "/v2/teams/{teamId}/members", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "teamId", Field: "id"},
		}},
		{Name: "teams_user_attributes", ParentTable: "teams", ParentIDParam: "teamId", PathTemplate: "/v2/teams/{teamId}/user-attributes", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "teamId", Field: "id"},
		}},
		{Name: "user_attributes_teams", ParentTable: "user-attributes", ParentIDParam: "userAttributeId", PathTemplate: "/v2/user-attributes/{userAttributeId}/teams", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "userAttributeId", Field: "id"},
		}},
		{Name: "user_attributes_tenants", ParentTable: "user-attributes", ParentIDParam: "userAttributeId", PathTemplate: "/v2/user-attributes/{userAttributeId}/tenants", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "userAttributeId", Field: "id"},
		}},
		{Name: "users", ParentTable: "user-attributes", ParentIDParam: "userAttributeId", PathTemplate: "/v2/user-attributes/{userAttributeId}/users", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "userAttributeId", Field: "id"},
		}},
		{Name: "version_history", ParentTable: "workbooks", ParentIDParam: "workbookId", PathTemplate: "/v2/workbooks/{workbookId}/version-history", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "workbookId", Field: "id"},
		}},
		{Name: "workbooks_columns", ParentTable: "workbooks", ParentIDParam: "workbookId", PathTemplate: "/v2/workbooks/{workbookId}/columns", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "workbookId", Field: "id"},
		}},
		{Name: "workbooks_elements", ParentTable: "workbooks", ParentIDParam: "workbookId", PathTemplate: "/v2/workbooks/{workbookId}/elements", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "workbookId", Field: "id"},
		}},
		{Name: "workbooks_lineage", ParentTable: "workbooks", ParentIDParam: "workbookId", PathTemplate: "/v2/workbooks/{workbookId}/lineage", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "workbookId", Field: "id"},
		}},
		{Name: "workbooks_materialization_schedules", ParentTable: "workbooks", ParentIDParam: "workbookId", PathTemplate: "/v2.1/workbooks/{workbookId}/materialization-schedules", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "workbookId", Field: "id"},
		}},
		{Name: "workbooks_materialization_schedules", ParentTable: "workbooks", ParentIDParam: "workbookId", PathTemplate: "/v2/workbooks/{workbookId}/materialization-schedules", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "workbookId", Field: "id"},
		}},
		{Name: "workbooks_schedules", ParentTable: "workbooks", ParentIDParam: "workbookId", PathTemplate: "/v2/workbooks/{workbookId}/schedules", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "workbookId", Field: "id"},
		}},
		{Name: "workbooks_schedules", ParentTable: "workbooks", ParentIDParam: "workbookId", PathTemplate: "/v2.1/workbooks/{workbookId}/schedules", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "workbookId", Field: "id"},
		}},
		{Name: "workbooks_tags", ParentTable: "workbooks", ParentIDParam: "workbookId", PathTemplate: "/v2/workbooks/{workbookId}/tags", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "workbookId", Field: "id"},
		}},
		{Name: "workspaces_grants", ParentTable: "workspaces", ParentIDParam: "workspaceId", PathTemplate: "/v2/workspaces/{workspaceId}/grants", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "workspaceId", Field: "id"},
		}},
		{Name: "pages_elements", ParentTable: "pages", ParentIDParam: "pageId", PathTemplate: "/v2/workbooks/{workbookId}/pages/{pageId}/elements", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "workbookId", Field: "workbooks_id"},
			{Param: "pageId", Field: "id"},
		}},
		{Name: "workbooks_elements_columns", ParentTable: "workbooks_elements", ParentIDParam: "elementId", PathTemplate: "/v2/workbooks/{workbookId}/elements/{elementId}/columns", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "workbookId", Field: "workbooks_id"},
			{Param: "elementId", Field: "id"},
		}},
		{Name: "workbooks_elements_query", ParentTable: "workbooks_elements", ParentIDParam: "elementId", PathTemplate: "/v2/workbooks/{workbookId}/elements/{elementId}/query", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "workbookId", Field: "workbooks_id"},
			{Param: "elementId", Field: "id"},
		}},
	}
