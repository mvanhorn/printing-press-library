...
func resetCredentialEnv(t *testing.T) (home, configPath string) {
	...
	for _, name := range []string{
		"SIGMA_COMPUTING_CONFIG",
		"SIGMA_COMPUTING_CONFIG_DIR",
		"SIGMA_COMPUTING_DATA_DIR",
		"SIGMA_COMPUTING_STATE_DIR",
		"SIGMA_COMPUTING_CACHE_DIR",
		"SIGMA_COMPUTING_HOME",
		"XDG_CONFIG_HOME",
		"XDG_DATA_HOME",
		"XDG_STATE_HOME",
		"XDG_CACHE_HOME",
		"SIGMA_COMPUTING_CLIENT_ID",
		"SIGMA_COMPUTING_CLIENT_SECRET",
	} {
		t.Setenv(name, "")
	}
	...
	return home, filepath.Join(home, ".config", "sigma-computing-pp-cli", "config.toml")
}
...
func TestCorruptCredentialsFallsBackToLegacyConfig(t *testing.T) {
	...
	credentialsPath := filepath.Join(home, ".local", "share", "sigma-computing-pp-cli", "credentials.toml")
...
func TestAuthWriteScrubsLegacyConfigWhenRelocated(t *testing.T) {
	...
	activeConfigPath := filepath.Join(newConfigDir, "sigma-computing-pp-cli", "config.toml")
	...
	credsPath := filepath.Join(newDataDir, "sigma-computing-pp-cli", "credentials.toml")
