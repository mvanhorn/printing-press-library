...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/productivity/sigma-computing/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "sigma-computing-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
