...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		...
		"gmail-pp-cli doctor",
		"gmail-pp-cli help items",
		"gmail-pp-cli sync",
		"gmail-pp-cli profile list",
		"gmail-pp-cli feedback list",
		"gmail-pp-cli which",
		"gmail-pp-cli agent-context",
		"gmail-pp-cli completion bash",
		"gmail-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"gmail-pp-cli teach",
		"gmail-pp-cli recall",
		"gmail-pp-cli learnings",
		"gmail-pp-cli teach-pattern",
		"gmail-pp-cli teach-lookup",
		"gmail-pp-cli items list",
	}
