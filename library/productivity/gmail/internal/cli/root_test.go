...
func TestDeclaredAPISurfaceReachable(t *testing.T) {
	expected := []string{
		...
		"messages untrash",
		"messages untrash messages",
		"settings",
		"settings create",
		"settings create-gmail",
		"settings create-gmail-2",
		"settings create-gmail-3",
		"settings create-gmail-4",
		"settings create-gmail-5",
		"settings delete",
		"settings delete-gmail",
		"settings delete-gmail-2",
		"settings delete-gmail-3",
		"settings delete-gmail-4",
		"settings delete-gmail-5",
		"settings disable",
		"settings enable",
		"settings get",
		"settings get-auto-forwarding",
		"settings get-gmail",
		"settings get-gmail-2",
		"settings get-gmail-3",
		"settings get-gmail-4",
		"settings get-gmail-5",
		"settings get-gmail-6",
		"settings get-imap",
		...
		"settings list",
		"settings list-gmail",
		"settings list-gmail-2",
		"settings list-gmail-3",
		"settings list-gmail-4",
		"settings list-gmail-5",
		"settings list-gmail-6",
		"settings obliterate",
		"settings patch",
		"settings patch-gmail",
		...
		"threads list",
		"threads modify",
		"threads modify threads",
		"threads trash",
		"threads trash threads",
		"threads untrash",
		"threads untrash threads",
		"users-profile",
		"watch",
	}
