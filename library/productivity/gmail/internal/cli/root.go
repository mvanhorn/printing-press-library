...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "gmail-pp-cli",
		Short: `Gmail CLI — Your entire Gmail mailbox in a local SQLite database — searchable offline, queryable with SQL, and pipeline-ready for a…`,
		Long: `Gmail CLI — Your entire Gmail mailbox in a local SQLite database — searchable offline, queryable with SQL, and pipeline-ready for a…
...
See README.md or the bundled SKILL.md for recipes.`,
	...
	rootCmd.AddCommand(newGmailProfilePromotedCmd(flags))
