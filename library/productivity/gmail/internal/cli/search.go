...
Run sync first to populate the local search index.`,
  ...
  gmail-pp-cli search "status"

  # Force local search explicitly
  gmail-pp-cli search "status" --data-source local
  # Search a specific resource type locally
  gmail-pp-cli search "status" --type history --data-source local
  # JSON output for piping
  gmail-pp-cli search "status" --json --limit 20`,
