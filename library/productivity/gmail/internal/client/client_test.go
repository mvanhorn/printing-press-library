...
func TestGetWithHeadersValuesPreservesRepeatedQueryParams(t *testing.T) {
	...
	// Path must be an allowlisted shape: the transport allowlist (R3-C6)
	// refuses anything else before dialing.
	if _, err := c.GetWithHeadersValues(context.Background(), "/gmail/v1/users/me/messages", params, nil); err != nil {
