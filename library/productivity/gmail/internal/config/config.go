...
type Config struct {
	...
	GmailOauth2c string          `toml:"oauth2c"`
...
func Load(configPath string) (*Config, error) {
	...
	// Env var overrides
	if v := os.Getenv("GMAIL_OAUTH2C"); v != "" {
		cfg.GmailOauth2c = v
		cfg.markEnvOverride("GmailOauth2c")
		cfg.AuthSource = "env:GMAIL_OAUTH2C"
		cfg.CredentialSource = "env:GMAIL_OAUTH2C"
	}
	...
	if v := os.Getenv("GMAIL_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	if v := os.Getenv("GMAIL_AUTHORIZATION_URL"); v != "" {
		cfg.AuthorizationURL = v
	}
	if v := os.Getenv("GMAIL_TOKEN_URL"); v != "" {
		cfg.TokenURL = v
	}
	...
	if v := strings.TrimSpace(os.Getenv("GMAIL_USER_ID")); v != "" {
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("GMAIL_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "gmail-pp-cli", "config.toml"), nil
}
...
func (c *Config) AuthHeader() string {
	...
	// A directly-held bearer in GMAIL_OAUTH2C (a pasted access token, or a
...
func (c *Config) applyCredentials(creds *cliutil.Credentials) {
	...
	c.GmailOauth2c = creds.GmailOauth2c
}
...
func (c *Config) ClearTokens() error {
	...
	c.updateFileConfigField("ClientSecret")
	c.GmailOauth2c = ""
	delete(c.envOverrides, "GmailOauth2c")
	c.updateFileConfigField("GmailOauth2c")
	if c.AgentcookieManagedByExternalStore() {
		c.markAgentcookieManaged()
...
func (c *Config) configForSave() Config {
	out := *c
	if c.fileConfig != nil {
		if c.envOverrides["GmailOauth2c"] {
			out.GmailOauth2c = c.fileConfig.GmailOauth2c
		}
	}
...
func (c *Config) updateFileConfigField(field string) {
	...
	case "GmailOauth2c":
		c.fileConfig.GmailOauth2c = c.GmailOauth2c
	}
}
