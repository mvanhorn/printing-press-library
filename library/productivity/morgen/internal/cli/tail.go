...
native streaming instead of polling.`,
  ...
  morgen-pp-cli tail --interval 10s

  # Tail a specific resource
  morgen-pp-cli tail messages --interval 5s

  # Pipe to jq for filtering
  morgen-pp-cli tail events --interval 30s | jq 'select(.type == "error")'`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			// --follow=false performs a single poll and exits.
			if !follow {
				return nil
			}
