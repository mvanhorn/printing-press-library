...
but do not stop the import.`,
  ...
  seykota-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  seykota-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | seykota-pp-cli import <resource> --input -`,
