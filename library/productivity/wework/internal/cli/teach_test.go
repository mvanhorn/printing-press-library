...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"wework-pp-cli auth login",
		"wework-pp-cli doctor",
		"wework-pp-cli help items",
		"wework-pp-cli sync",
		"wework-pp-cli profile list",
		"wework-pp-cli feedback list",
		"wework-pp-cli which",
		"wework-pp-cli agent-context",
		"wework-pp-cli completion bash",
		"wework-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"wework-pp-cli teach",
		"wework-pp-cli recall",
		"wework-pp-cli learnings",
		"wework-pp-cli teach-pattern",
		"wework-pp-cli teach-lookup",
		"wework-pp-cli items list",
	}
