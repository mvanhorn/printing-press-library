...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/productivity/wework/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("WEWORK_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "wework-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
