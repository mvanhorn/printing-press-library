...
but do not stop the import.`,
  ...
  plaud-web-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  plaud-web-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | plaud-web-pp-cli import <resource> --input -`,
