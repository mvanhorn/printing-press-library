...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "plaud-web-pp-cli",
		Short: "Manage plaud-web resources via the plaud-web API",
		Long: `Plaud Web CLI
...
Health check: run 'plaud-web-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("plaud-web-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'plaud-web-pp-cli profile list')")
	...
	rootCmd.AddCommand(newFiletagCmd(flags))
	...
	rootCmd.AddCommand(newNovelBatchRenameCmd(flags))
	rootCmd.AddCommand(newNovelExportAudioCmd(flags))
	rootCmd.AddCommand(newNovelMoveCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newGsearchPromotedCmd(flags))
	rootCmd.AddCommand(newSpeakerPromotedCmd(flags))
