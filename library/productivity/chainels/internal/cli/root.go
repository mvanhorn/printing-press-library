...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "chainels-pp-cli",
		Short: `Chainels CLI — Every Chainels endpoint as a typed command, plus the cross-community search, turnover variance, and stale-issue digests…`,
		Long: `Chainels CLI — Every Chainels endpoint as a typed command, plus the cross-community search, turnover variance, and stale-issue digests…
...
Health check: run 'chainels-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("chainels-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'chainels-pp-cli profile list')")
	...
	rootCmd.AddCommand(newAlamsCmd(flags))
	rootCmd.AddCommand(newAlarmsCmd(flags))
	rootCmd.AddCommand(newBansCmd(flags))
	rootCmd.AddCommand(newBookingCmd(flags))
	...
	rootCmd.AddCommand(newInviteTemplatesCmd(flags))
	...
	rootCmd.AddCommand(newRepliesCmd(flags))
	...
	rootCmd.AddCommand(newDrivePromotedCmd(flags))
	rootCmd.AddCommand(newStorebanPromotedCmd(flags))
