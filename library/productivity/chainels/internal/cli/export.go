...
large datasets as it has no memory pressure.`,
  ...
  chainels-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  chainels-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  chainels-pp-cli export <resource> --format jsonl | jq '.id'`,
