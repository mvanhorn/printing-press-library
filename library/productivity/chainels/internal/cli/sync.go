...
Exit codes & warnings:
  ...
  chainels-pp-cli sync

  # Sync specific resources only
  chainels-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  chainels-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  chainels-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  chainels-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  chainels-pp-cli sync --latest-only`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			// Dry-run short-circuit: per-resource "missing id" / "no parent"
			// validation errors fire before the HTTP layer's dry-run interceptor
			// would have returned, so the success counter is always 0 in dry-run
			// mode and branch 3 below would otherwise exit non-zero. For a
			// dry-run that printed every planned request, exit 0 unconditionally.
			if flags.dryRun {
				return nil
			}
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/chainels-pp-cli/data.db)")
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "accounts_entities":
		return db.UpsertAccountsEntities(data)
	case "agreements":
		return db.UpsertAgreements(data)
	case "agreements_accounts":
		return db.UpsertAgreementsAccounts(data)
	case "items":
		return db.UpsertItems(data)
	case "alams_replies":
		return db.UpsertAlamsReplies(data)
	case "alarms":
		return db.UpsertAlarms(data)
	case "close":
		return db.UpsertClose(data)
	case "onmyway":
		return db.UpsertOnmyway(data)
	case "read":
		return db.UpsertRead(data)
	case "bans":
		return db.UpsertBans(data)
	case "bans_bans":
		return db.UpsertBansBans(data)
	case "terms":
		return db.UpsertTerms(data)
	case "booking":
		return db.UpsertBooking(data)
	case "bookables":
		return db.UpsertBookables(data)
	case "bookings":
		return db.UpsertBookings(data)
	case "categories":
		return db.UpsertCategories(data)
	case "communities_agreements":
		return db.UpsertCommunitiesAgreements(data)
	case "communities_invoices":
		return db.UpsertCommunitiesInvoices(data)
	case "communities_payments":
		return db.UpsertCommunitiesPayments(data)
	case "communities_service_accounts":
		return db.UpsertCommunitiesServiceAccounts(data)
	case "communities_spaces":
		return db.UpsertCommunitiesSpaces(data)
	case "companies":
		return db.UpsertCompanies(data)
	case "companies_accounts":
		return db.UpsertCompaniesAccounts(data)
	case "ai":
		return db.UpsertAi(data)
	case "companies_bans":
		return db.UpsertCompaniesBans(data)
	case "channels":
		return db.UpsertChannels(data)
	case "companies_discounts":
		return db.UpsertCompaniesDiscounts(data)
	case "companies_drive":
		return db.UpsertCompaniesDrive(data)
	case "energy":
		return db.UpsertEnergy(data)
	case "events":
		return db.UpsertEvents(data)
	case "fields":
		return db.UpsertFields(data)
	case "footfall":
		return db.UpsertFootfall(data)
	case "companies_issues":
		return db.UpsertCompaniesIssues(data)
	case "companies_members":
		return db.UpsertCompaniesMembers(data)
	case "companies_messages":
		return db.UpsertCompaniesMessages(data)
	case "signup":
		return db.UpsertSignup(data)
	case "supplies":
		return db.UpsertSupplies(data)
	case "targets":
		return db.UpsertTargets(data)
	case "timeline":
		return db.UpsertTimeline(data)
	case "companies_turnover":
		return db.UpsertCompaniesTurnover(data)
	case "users":
		return db.UpsertUsers(data)
	case "discounts":
		return db.UpsertDiscounts(data)
	case "discounts_discounts":
		return db.UpsertDiscountsDiscounts(data)
	case "discounts_submissions":
		return db.UpsertDiscountsSubmissions(data)
	case "entities_invite_templates":
		return db.UpsertEntitiesInviteTemplates(data)
	case "invite_templates":
		return db.UpsertInviteTemplates(data)
	case "invoices":
	...
	case "external_issue":
		return db.UpsertExternalIssue(data)
	case "rating":
		return db.UpsertRating(data)
	case "issues_replies":
		return db.UpsertIssuesReplies(data)
	case "issues_status":
		return db.UpsertIssuesStatus(data)
	case "event":
		return db.UpsertEvent(data)
	case "followers":
		return db.UpsertFollowers(data)
	case "presences":
		return db.UpsertPresences(data)
	case "messages_replies":
		return db.UpsertMessagesReplies(data)
	case "messages_status":
		return db.UpsertMessagesStatus(data)
	case "survey":
		return db.UpsertSurvey(data)
	case "chart":
		return db.UpsertChart(data)
	case "insights":
		return db.UpsertInsights(data)
	case "metrics_reports":
		return db.UpsertMetricsReports(data)
	case "zones":
		return db.UpsertZones(data)
	case "payments":
		return db.UpsertPayments(data)
	case "replies_replies":
		return db.UpsertRepliesReplies(data)
	case "reporting":
		return db.UpsertReporting(data)
	case "reporting_members":
		return db.UpsertReportingMembers(data)
	case "reporting_reports":
		return db.UpsertReportingReports(data)
	case "schemes":
		return db.UpsertSchemes(data)
	case "requests":
		return db.UpsertRequests(data)
	case "forms":
		return db.UpsertForms(data)
	case "requests_submissions":
		return db.UpsertRequestsSubmissions(data)
	case "service_accounts":
		return db.UpsertServiceAccounts(data)
	case "clients":
		return db.UpsertClients(data)
	case "spaces":
		return db.UpsertSpaces(data)
	case "storeban":
		return db.UpsertStoreban(data)
	case "turnover":
		return db.UpsertTurnover(data)
	default:
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"alarms": "/alarms",
		"alarms-recipients": "/alarms/recipients",
		"bans": "/bans/communities",
		"service-accounts": "/service-accounts/clients/scopes",
		"storeban": "/storeban/communities",
	}
