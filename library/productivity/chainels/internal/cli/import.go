...
but do not stop the import.`,
  ...
  chainels-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  chainels-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | chainels-pp-cli import <resource> --input -`,
