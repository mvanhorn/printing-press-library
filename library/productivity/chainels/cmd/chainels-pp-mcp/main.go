...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/productivity/chainels/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "chainels-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
