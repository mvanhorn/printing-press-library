...
but do not stop the import.`,
  ...
  trello-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  trello-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | trello-pp-cli import <resource> --input -`,
