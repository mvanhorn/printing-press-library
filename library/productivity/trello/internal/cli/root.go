...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "trello-pp-cli",
		Short: `Trello CLI — Every Trello feature, plus a local SQLite mirror, offline search, and cross-board analytics no other Trello tool has.`,
		Long: `Trello CLI — Every Trello feature, plus a local SQLite mirror, offline search, and cross-board analytics no other Trello tool has.
...
Health check: run 'trello-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("trello-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'trello-pp-cli profile list')")
	...
	rootCmd.AddCommand(newNovelBlockedCmd(flags))
	rootCmd.AddCommand(newNovelBottleneckCmd(flags))
	rootCmd.AddCommand(newNovelChurnCmd(flags))
	rootCmd.AddCommand(newNovelCycletimeCmd(flags))
	...
	rootCmd.AddCommand(newNovelChecklistProgressCmd(flags))
	rootCmd.AddCommand(newTrelloSyncCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newBatchPromotedCmd(flags))
	rootCmd.AddCommand(newTypesResourcePromotedCmd(flags))
