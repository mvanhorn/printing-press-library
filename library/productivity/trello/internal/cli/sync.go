...
`,
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/trello-pp-cli/data.db)")
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "actions_display":
		return db.UpsertActionsDisplay(data)
	case "actions_entities":
		return db.UpsertActionsEntities(data)
	case "actions_list":
	...
	case "boards_closed":
		return db.UpsertBoardsClosed(data)
	case "boards_deltas":
		return db.UpsertBoardsDeltas(data)
	case "boards_desc":
		return db.UpsertBoardsDesc(data)
	case "email_key":
		return db.UpsertEmailKey(data)
	case "id_organization":
		return db.UpsertIdOrganization(data)
	case "label_names":
		return db.UpsertLabelNames(data)
	case "boards_labels":
		return db.UpsertBoardsLabels(data)
	case "boards_lists":
		return db.UpsertBoardsLists(data)
	case "mark_as_viewed":
		return db.UpsertMarkAsViewed(data)
	case "boards_members":
		return db.UpsertBoardsMembers(data)
	case "boards_members_invited":
		return db.UpsertBoardsMembersInvited(data)
	case "boards_memberships":
		return db.UpsertBoardsMemberships(data)
	case "my_prefs":
		return db.UpsertMyPrefs(data)
	case "boards_name":
		return db.UpsertBoardsName(data)
	case "boards_organization":
		return db.UpsertBoardsOrganization(data)
	case "power_ups":
		return db.UpsertPowerUps(data)
	case "boards_prefs":
		return db.UpsertBoardsPrefs(data)
	case "boards_subscribed":
		return db.UpsertBoardsSubscribed(data)
	case "cards_actions":
	...
	case "cards_closed":
		return db.UpsertCardsClosed(data)
	case "cards_desc":
		return db.UpsertCardsDesc(data)
	case "due":
		return db.UpsertDue(data)
	case "id_attachment_cover":
		return db.UpsertIdAttachmentCover(data)
	case "cards_id_board":
		return db.UpsertCardsIdBoard(data)
	case "id_labels":
		return db.UpsertIdLabels(data)
	case "id_list":
		return db.UpsertIdList(data)
	case "id_members":
	...
	case "cards_name":
		return db.UpsertCardsName(data)
	case "cards_pos":
		return db.UpsertCardsPos(data)
	case "stickers":
		return db.UpsertStickers(data)
	case "cards_subscribed":
		return db.UpsertCardsSubscribed(data)
	...
	case "id_card":
		return db.UpsertIdCard(data)
	case "checklists_name":
		return db.UpsertChecklistsName(data)
	case "checklists_pos":
		return db.UpsertChecklistsPos(data)
	case "labels_board":
		return db.UpsertLabelsBoard(data)
	case "color":
		return db.UpsertColor(data)
	case "labels_name":
		return db.UpsertLabelsName(data)
	case "lists_actions":
	...
	case "lists_closed":
		return db.UpsertListsClosed(data)
	case "lists_id_board":
		return db.UpsertListsIdBoard(data)
	case "move_all_cards":
		return db.UpsertMoveAllCards(data)
	case "lists_name":
		return db.UpsertListsName(data)
	case "lists_pos":
		return db.UpsertListsPos(data)
	case "lists_subscribed":
		return db.UpsertListsSubscribed(data)
	case "members_actions":
		return db.UpsertMembersActions(data)
	case "avatar":
		return db.UpsertAvatar(data)
	case "avatar_source":
		return db.UpsertAvatarSource(data)
	case "bio":
		return db.UpsertBio(data)
	...
	case "members_deltas":
		return db.UpsertMembersDeltas(data)
	case "full_name":
		return db.UpsertFullName(data)
	case "initials":
		return db.UpsertInitials(data)
	...
	case "notifications_display":
		return db.UpsertNotificationsDisplay(data)
	case "notifications_entities":
		return db.UpsertNotificationsEntities(data)
	...
	case "organizations_deltas":
		return db.UpsertOrganizationsDeltas(data)
	case "organizations_desc":
		return db.UpsertOrganizationsDesc(data)
	case "display_name":
		return db.UpsertDisplayName(data)
	case "logo":
	...
	case "organizations_members_invited":
		return db.UpsertOrganizationsMembersInvited(data)
	case "organizations_memberships":
		return db.UpsertOrganizationsMemberships(data)
	case "organizations_name":
		return db.UpsertOrganizationsName(data)
	case "organizations_prefs":
		return db.UpsertOrganizationsPrefs(data)
	case "website":
		return db.UpsertWebsite(data)
	case "status":
	...
	case "active":
		return db.UpsertActive(data)
	case "callback_url":
		return db.UpsertCallbackUrl(data)
	case "description":
		return db.UpsertDescription(data)
	case "id_model":
		return db.UpsertIdModel(data)
	default:
