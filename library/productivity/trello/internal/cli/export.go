...
large datasets as it has no memory pressure.`,
  ...
  trello-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  trello-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  trello-pp-cli export <resource> --format jsonl | jq '.id'`,
