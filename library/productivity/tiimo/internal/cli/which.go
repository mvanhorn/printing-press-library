...
var whichIndex = []whichEntry{
	{Command: "export", Description: "Stream a paginated resource straight to JSON or JSONL. Use backup for a whole-planner snapshot and feed for calendar or spreadsheet formats.", Group: "Your data, out of the app", WhyItMatters: "Reach for this to pull one resource as a stream; for everything at once use backup, and for a calendar file use feed."},
	{Command: "feed", Description: "Generate a subscribable read-only iCalendar file of your Tiimo activities.", Group: "Your data, out of the app", WhyItMatters: "Use this to make Tiimo activities visible inside any calendar client without giving that client write access."},
	{Command: "backup", Description: "Write every mirrored record - activities, to-dos, tags, routines, calendars - to one portable JSON snapshot. This is the whole-planner export Tiimo does not offer.", Group: "Your data, out of the app", WhyItMatters: "This is the command to reach for when the user says they want their Tiimo data out. Use it before any bulk change, or on a schedule."},
	{Command: "drift", Description: "Show which activities consistently start late, overrun, or spend the most time paused.", Group: "Plan versus reality", WhyItMatters: "Reach for this when the user asks why their schedule never holds, or which task always blows its estimate."},
	{Command: "stalls", Description: "Find the exact checklist step where a multi-step routine tends to break down.", Group: "Plan versus reality", WhyItMatters: "Use when a routine keeps failing and the user does not know which step is the blocker."},
	{Command: "adherence", Description: "Completion rate for each recurring activity over a window.", Group: "Plan versus reality", WhyItMatters: "Use to answer how reliably a habit is actually being kept, rather than whether it exists on the calendar."},
	{Command: "overlaps", Description: "List activities that are double-booked against each other.", Group: "Timeline intelligence", WhyItMatters: "Use before committing to a plan, or when the user suspects their day is over-scheduled."},
	{Command: "gaps", Description: "Find the unscheduled windows in a day that are at least a given length.", Group: "Timeline intelligence", WhyItMatters: "Use when fitting something new into an existing day without opening the app."},
	{Command: "rolling", Description: "A true rolling multi-day view starting from today.", Group: "Timeline intelligence", WhyItMatters: "Use for a forward-looking view that does not reset at an arbitrary week boundary."},
	{Command: "capacity", Description: "Committed versus free minutes per day, broken down by time-of-day bucket.", Group: "Timeline intelligence", WhyItMatters: "Use to judge whether a day has real room left before agreeing to add something to it."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  tiimo-pp-cli which "stale tickets"
  tiimo-pp-cli which "bottleneck"
  tiimo-pp-cli which --limit 1 "send message"
  tiimo-pp-cli which                                # list the full capability index`,
