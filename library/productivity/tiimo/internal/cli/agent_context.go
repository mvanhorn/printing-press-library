...
func buildAgentDiscoveryContext() *agentContextDiscovery {
	return &agentContextDiscovery{
		...
		TargetURL:     "https://webapp.tiimoapp.com/home",
		EntryCount:    15,
		APIEntryCount: 15,
		...
		CandidateCommands: []string{
			"create_activities — Derived from observed POST /api/profiles/{profile_id}/activities traffic.",
			"delete_activities — Derived from observed DELETE /api/profiles/{profile_id}/activities/{activity_id} traffic.",
			"get_activities — Derived from observed GET /api/externalCalendar/profiles/{profile_id}/externalCalendars/{externalcalendar_id}/activities traffic.",
			"get_linkedCalendars — Derived from observed GET /api/externalCalendar/profiles/{profile_id}/linkedCalendars traffic.",
			"get_profiles — Derived from observed GET /api/profiles/{profile_id} traffic.",
			"get_routines — Derived from observed GET /api/profiles/{profile_id}/routines traffic.",
			"get_tags — Derived from observed GET /api/profiles/{profile_id}/tags traffic.",
			"get_todo_task_lists — Derived from observed GET /api/profiles/{profile_id}/todo-task-lists traffic.",
		},
	}
}
