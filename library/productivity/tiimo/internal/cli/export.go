...
large datasets as it has no memory pressure.`,
  ...
  tiimo-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  tiimo-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  tiimo-pp-cli export <resource> --format jsonl | jq '.id'`,
