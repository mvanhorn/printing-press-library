...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"tiimo-pp-cli auth login",
		"tiimo-pp-cli doctor",
		"tiimo-pp-cli help items",
		"tiimo-pp-cli sync",
		"tiimo-pp-cli profile list",
		"tiimo-pp-cli feedback list",
		"tiimo-pp-cli which",
		"tiimo-pp-cli agent-context",
		"tiimo-pp-cli completion bash",
		"tiimo-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"tiimo-pp-cli teach",
		"tiimo-pp-cli recall",
		"tiimo-pp-cli learnings",
		"tiimo-pp-cli teach-pattern",
		"tiimo-pp-cli teach-lookup",
		"tiimo-pp-cli items list",
	}
