...
func newAuthSetupCmd(_ *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: "  figma-pp-cli auth setup\n  figma-pp-cli auth setup --launch",
		RunE: func(cmd *cobra.Command, args []string) error {
			w := cmd.OutOrStdout()
			fmt.Fprintln(w, "See API docs: https://developers.figma.com/docs/rest-api/")
			fmt.Fprintln(w, "")
			fmt.Fprintln(w, "Then set:")
			fmt.Fprintln(w, "  export FIGMA_ACCESS_TOKEN=\"<your-token>\"")
			fmt.Fprintln(w, "  export FIGMA_API_TOKEN=\"<your-token>\"")
			fmt.Fprintln(w, "  export FIGMA_API_KEY=\"<your-token>\"")
			fmt.Fprintln(w, "  figma-pp-cli auth set-token <token>")
			if !launch {
				return nil
			}
			launchURL := "https://developers.figma.com/docs/rest-api/"
...
func newAuthStatusCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		Example: "  figma-pp-cli auth status",
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !authed {
				...
				fmt.Fprintln(w, "  export FIGMA_ACCESS_TOKEN=\"your-token-here\"")
				fmt.Fprintln(w, "  export FIGMA_API_TOKEN=\"your-token-here\"")
				fmt.Fprintln(w, "  export FIGMA_API_KEY=\"your-token-here\"")
				fmt.Fprintf(w, "  figma-pp-cli auth set-token <token>\n")
				return authErr(fmt.Errorf("no credentials configured"))
			}
...
func newAuthSetTokenCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		Example: "  figma-pp-cli auth set-token YOUR_TOKEN_HERE",
...
func newAuthLogoutCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		Example: "  figma-pp-cli auth logout",
		RunE: func(cmd *cobra.Command, args []string) error {
			cfg, err := config.Load(flags.configPath)
			if err != nil {
				return configErr(err)
			...
			envStillSet := ""
			if envStillSet == "" && os.Getenv("FIGMA_ACCESS_TOKEN") != "" {
				envStillSet = "FIGMA_ACCESS_TOKEN"
			}
			if envStillSet == "" && os.Getenv("FIGMA_API_TOKEN") != "" {
				envStillSet = "FIGMA_API_TOKEN"
			}
			if envStillSet == "" && os.Getenv("FIGMA_API_KEY") != "" {
				envStillSet = "FIGMA_API_KEY"
			}
