...
func Load(configPath string) (*Config, error) {
	cfg := &Config{
		BaseURL: "https://app.iclasspro.com/api/open/v1",
	}
	...
	if v := os.Getenv("ICLASSPRO_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("ICLASSPRO_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "iclasspro-pp-cli", "config.toml"), nil
}
