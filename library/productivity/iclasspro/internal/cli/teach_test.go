...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/productivity/iclasspro/internal/cliutil/testenv"
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"iclasspro-pp-cli auth login",
		"iclasspro-pp-cli doctor",
		"iclasspro-pp-cli help items",
		"iclasspro-pp-cli sync",
		"iclasspro-pp-cli profile list",
		"iclasspro-pp-cli feedback list",
		"iclasspro-pp-cli which",
		"iclasspro-pp-cli agent-context",
		"iclasspro-pp-cli completion bash",
		"iclasspro-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"iclasspro-pp-cli recall",
		"iclasspro-pp-cli learnings",
		"iclasspro-pp-cli teach-pattern",
		"iclasspro-pp-cli teach-lookup",
		"iclasspro-pp-cli items list",
	}
