...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/productivity/ihatepdf-cv/internal/cliutil/testenv"
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"ihatepdf-cv-pp-cli auth login",
		"ihatepdf-cv-pp-cli doctor",
		"ihatepdf-cv-pp-cli help items",
		"ihatepdf-cv-pp-cli sync",
		"ihatepdf-cv-pp-cli profile list",
		"ihatepdf-cv-pp-cli feedback list",
		"ihatepdf-cv-pp-cli which",
		"ihatepdf-cv-pp-cli agent-context",
		"ihatepdf-cv-pp-cli completion bash",
		"ihatepdf-cv-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"ihatepdf-cv-pp-cli recall",
		"ihatepdf-cv-pp-cli learnings",
		"ihatepdf-cv-pp-cli teach-pattern",
		"ihatepdf-cv-pp-cli teach-lookup",
		"ihatepdf-cv-pp-cli items list",
	}
