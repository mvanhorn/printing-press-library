...
func newMessagesSendEmailCmd(flags *rootFlags) *cobra.Command {
	var bodyBcc string
	var bodyBody string
	var bodyCc string
	var bodyFrom string
	...
	cmd := &cobra.Command{
		...
		Short:       "Send an email",
		Example:     "  pushpress-pp-cli messages send-email --body example-value",
		Annotations: map[string]string{"pp:endpoint": "messages.send-email", "pp:method": "POST", "pp:path": "/messages/email/send"},
