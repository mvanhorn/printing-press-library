...
large datasets as it has no memory pressure.`,
  ...
  pushpress-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  pushpress-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  pushpress-pp-cli export <resource> --format jsonl | jq '.id'`,
