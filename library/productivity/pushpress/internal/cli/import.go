...
but do not stop the import.`,
  ...
  pushpress-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  pushpress-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | pushpress-pp-cli import <resource> --input -`,
