...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/productivity/pushpress/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "pushpress-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
