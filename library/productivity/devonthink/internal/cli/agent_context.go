...
reading source. Schema is versioned via schema_version.`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			ctx.CLI.LocalOnly = localOnly || ctx.CLI.LocalOnly
	...
	cmd.Flags().BoolVar(&localOnly, "local-only", false, "assert that DEVONthink access must stay on this Mac or the user's own LAN")
