...
but do not stop the import.`,
  ...
  devonthink-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  devonthink-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | devonthink-pp-cli import <resource> --input -`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if inputFile == "-" || inputFile == "" {
				...
				f, err := os.Open(inputFile) // #nosec G304 -- import intentionally reads a user-selected local file.
				if err != nil {
