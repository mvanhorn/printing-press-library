# Affine Printed CLI Agent Guide

This directory is a generated `affine-pp-cli` printed CLI. It was produced by [CLI Printing Press](https://github.com/mvanhorn/cli-printing-press), so treat systemic fixes as upstream Printing Press fixes first. Keep local edits narrow and document why a generated-tree patch belongs here.
...
affine-pp-cli agent-context --pretty
```

Use runtime discovery instead of relying on a copied command list:

```bash
affine-pp-cli which "<capability>" --json
affine-pp-cli <command> --help
```
...
```bash
affine-pp-cli <command> --help
affine-pp-cli <command> --dry-run --agent
```
