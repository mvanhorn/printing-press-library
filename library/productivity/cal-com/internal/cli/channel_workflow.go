...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  cal-com-pp-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"bookings", "calendars", "calendars-connections", "calendars-ics-feed-check", "conferencing", "conferencing-default", "event-types", "me", "oauth-clients", "schedules", "stripe", "stripe-connect", "verified-resources", "verified-resources-phones", "webhooks"}
			totalSynced := 0
