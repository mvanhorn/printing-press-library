...
func newVerifiedResourcesUserGetVerifiedPhoneByIdCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"pp:endpoint": "verified-resources.user-get-verified-phone-by-id", "pp:method": "GET", "pp:path": "/v2/verified-resources/phones/{id}", "mcp:read-only": "true"},
