...
func newAuthCmd(flags *rootFlags) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "auth",
		Short: "Manage authentication for Cal Com",
	}
...
func newAuthSetupCmd(_ *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: "  cal-com-pp-cli auth setup\n  cal-com-pp-cli auth setup --launch",
		RunE: func(cmd *cobra.Command, args []string) error {
			w := cmd.OutOrStdout()
			fmt.Fprintln(w, "No setup URL is configured for this CLI; check the API's docs.")
			fmt.Fprintln(w, "")
			fmt.Fprintln(w, "Then set:")
			fmt.Fprintln(w, "  export CAL_COM_API_KEY=\"<your-token>\"")
			fmt.Fprintln(w, "  export CAL_API_KEY=\"<your-token>\"")
			fmt.Fprintln(w, "  cal-com-pp-cli auth set-token <token>")
			if !launch {
				return nil
			}
	...
	return &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !authed {
				...
				fmt.Fprintln(w, "  export CAL_COM_API_KEY=\"your-token-here\"")
				fmt.Fprintln(w, "  export CAL_API_KEY=\"your-token-here\"")
...
func newAuthSetTokenCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		Example: "  cal-com-pp-cli auth set-token YOUR_TOKEN_HERE",
...
func newAuthLogoutCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			envStillSet := ""
			if envStillSet == "" && os.Getenv("CAL_COM_API_KEY") != "" {
				envStillSet = "CAL_COM_API_KEY"
			}
			if envStillSet == "" && os.Getenv("CAL_API_KEY") != "" {
				envStillSet = "CAL_API_KEY"
			}
