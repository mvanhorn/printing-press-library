...
func newOauthClientsUsersOauthClientForceRefreshCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"pp:endpoint": "users.oauth-client-force-refresh", "pp:method": "POST", "pp:path": "/v2/oauth-clients/{clientId}/users/{userId}/force-refresh"},
