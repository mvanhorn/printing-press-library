...
func newOauthClientsUsersOauthClientGetByIdCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"pp:endpoint": "users.oauth-client-get-by-id", "pp:method": "GET", "pp:path": "/v2/oauth-clients/{clientId}/users/{userId}", "mcp:read-only": "true"},
