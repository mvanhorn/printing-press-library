...
func newEventTypesPrivateLinksEventTypesGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"pp:endpoint": "private-links.event-types-get", "pp:method": "GET", "pp:path": "/v2/event-types/{eventTypeId}/private-links", "mcp:read-only": "true"},
