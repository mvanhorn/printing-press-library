...
func newCalendarsSaveCalendarsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  cal-com-pp-cli calendars save calendars --state example-value --code example-value",
		Annotations: map[string]string{"pp:endpoint": "save.calendars", "pp:method": "GET", "pp:path": "/v2/calendars/{calendar}/save", "mcp:read-only": "true"},
