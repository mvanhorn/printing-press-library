...
func newBookingsConferencingSessionsBookingsGetVideoSessionsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"pp:endpoint": "conferencing-sessions.bookings-get-video-sessions", "pp:method": "GET", "pp:path": "/v2/bookings/{bookingUid}/conferencing-sessions", "mcp:read-only": "true"},
