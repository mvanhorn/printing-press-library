...
func newVerifiedResourcesUserRequestPhoneVerificationCodeCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"pp:endpoint": "verified-resources.user-request-phone-verification-code", "pp:method": "POST", "pp:path": "/v2/verified-resources/phones/verification-code/request"},
