...
func newConferencingOauthConferencingSaveCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  cal-com-pp-cli conferencing oauth conferencing-save --state example-value --code example-value",
		Annotations: map[string]string{"pp:endpoint": "oauth.conferencing-save", "pp:method": "GET", "pp:path": "/v2/conferencing/{app}/oauth/callback", "mcp:read-only": "true"},
