...
func newVerifiedResourcesUserGetVerifiedEmailsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"pp:endpoint": "verified-resources.user-get-verified-emails", "pp:method": "GET", "pp:path": "/v2/verified-resources/emails", "mcp:read-only": "true"},
