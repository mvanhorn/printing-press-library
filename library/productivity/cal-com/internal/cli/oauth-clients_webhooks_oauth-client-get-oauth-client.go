...
func newOauthClientsWebhooksOauthClientGetOauthClientCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"pp:endpoint": "webhooks.oauth-client-get-oauth-client", "pp:method": "GET", "pp:path": "/v2/oauth-clients/{clientId}/webhooks", "mcp:read-only": "true"},
