...
func newOauthClientsWebhooksOauthClientUpdateOauthClientCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"pp:endpoint": "webhooks.oauth-client-update-oauth-client", "pp:method": "PATCH", "pp:path": "/v2/oauth-clients/{clientId}/webhooks/{webhookId}"},
