...
func newCalComAuthOauth2TokenCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  cal-com-pp-cli cal-com-auth oauth2-token",
		Annotations: map[string]string{"pp:endpoint": "cal-com-auth.oauth2-token", "pp:method": "POST", "pp:path": "/v2/auth/oauth2/token"},
