...
func newBookingsAttendeesBookingGetBookingBookingsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"pp:endpoint": "attendees.booking-get-booking-bookings", "pp:method": "GET", "pp:path": "/v2/bookings/{bookingUid}/attendees/{attendeeId}", "mcp:read-only": "true"},
