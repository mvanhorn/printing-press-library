...
func newVerifiedResourcesUserGetVerifiedPhoneNumbersCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"pp:endpoint": "verified-resources.user-get-verified-phone-numbers", "pp:method": "GET", "pp:path": "/v2/verified-resources/phones", "mcp:read-only": "true"},
