...
func newCalendarsConnectCalendarsRedirectCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  cal-com-pp-cli calendars connect calendars-redirect --is-dry-run true",
		Annotations: map[string]string{"pp:endpoint": "connect.calendars-redirect", "pp:method": "GET", "pp:path": "/v2/calendars/{calendar}/connect", "mcp:read-only": "true"},
