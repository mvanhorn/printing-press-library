...
func newOauthClientsUsersOauthClientUpdateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"pp:endpoint": "users.oauth-client-update", "pp:method": "PATCH", "pp:path": "/v2/oauth-clients/{clientId}/users/{userId}"},
	...
	cmd.Flags().StringVar(&bodyMetadata, "metadata", "", "You can store any additional data you want here. Metadata must have at most 50 keys, each key up to 40 characters,...")
