...
func newBookingsTranscriptsBookingsGetBookingCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"pp:endpoint": "transcripts.bookings-get-booking", "pp:method": "GET", "pp:path": "/v2/bookings/{bookingUid}/transcripts", "mcp:read-only": "true"},
