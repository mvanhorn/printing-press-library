...
func newCalendarsFreebusyCalUnifiedCalendarsGetFreeBusyCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  cal-com-pp-cli calendars freebusy cal-unified-calendars-get-free-busy --from example-value --to example-value",
		Annotations: map[string]string{"pp:endpoint": "freebusy.cal-unified-calendars-get-free-busy", "pp:method": "GET", "pp:path": "/v2/calendars/{calendar}/freebusy", "mcp:read-only": "true"},
