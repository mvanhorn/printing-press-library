...
func newVerifiedResourcesUserGetVerifiedEmailByIdCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"pp:endpoint": "verified-resources.user-get-verified-email-by-id", "pp:method": "GET", "pp:path": "/v2/verified-resources/emails/{id}", "mcp:read-only": "true"},
