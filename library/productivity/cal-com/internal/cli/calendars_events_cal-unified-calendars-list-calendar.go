...
func newCalendarsEventsCalUnifiedCalendarsListCalendarCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  cal-com-pp-cli calendars events cal-unified-calendars-list-calendar --from example-value --to example-value",
		Annotations: map[string]string{"pp:endpoint": "events.cal-unified-calendars-list-calendar", "pp:method": "GET", "pp:path": "/v2/calendars/{calendar}/events", "mcp:read-only": "true"},
