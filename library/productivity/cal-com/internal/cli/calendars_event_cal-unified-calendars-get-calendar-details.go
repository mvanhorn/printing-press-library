...
func newCalendarsEventCalUnifiedCalendarsGetCalendarDetailsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"pp:endpoint": "event.cal-unified-calendars-get-calendar-details", "pp:method": "GET", "pp:path": "/v2/calendars/{calendar}/event/{eventUid}", "mcp:read-only": "true"},
