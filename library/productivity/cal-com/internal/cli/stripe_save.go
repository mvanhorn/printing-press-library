...
func newStripeSaveCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  cal-com-pp-cli stripe save --state example-value --code example-value",
		Annotations: map[string]string{"pp:endpoint": "stripe.save", "pp:method": "GET", "pp:path": "/v2/stripe/save", "mcp:read-only": "true"},
