...
func newOauthClientsWebhooksOauthClientGetOauthClientOauthclientsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"pp:endpoint": "webhooks.oauth-client-get-oauth-client-oauthclients", "pp:method": "GET", "pp:path": "/v2/oauth-clients/{clientId}/webhooks/{webhookId}", "mcp:read-only": "true"},
