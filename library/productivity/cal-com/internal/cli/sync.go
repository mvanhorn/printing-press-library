...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "calendars_connect":
		return db.UpsertCalendarsConnect(data)
	case "credentials":
		return db.UpsertCredentials(data)
	case "calendars_disconnect":
		return db.UpsertCalendarsDisconnect(data)
	case "event":
	...
	case "conferencing":
		return db.UpsertConferencing(data)
	case "conferencing_connect":
		return db.UpsertConferencingConnect(data)
	case "default":
		return db.UpsertDefault(data)
	case "conferencing_disconnect":
		return db.UpsertConferencingDisconnect(data)
	case "conferencing_oauth":
		return db.UpsertConferencingOauth(data)
	case "private_links":
		return db.UpsertPrivateLinks(data)
	case "event_types_webhooks":
		return db.UpsertEventTypesWebhooks(data)
	case "me":
	...
	case "oauth_clients_webhooks":
		return db.UpsertOauthClientsWebhooks(data)
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		...
		"calendars-connections":     "/v2/calendars/connections",
		"calendars-ics-feed-check":  "/v2/calendars/ics-feed/check",
		"conferencing":              "/v2/conferencing",
		"conferencing-default":      "/v2/conferencing/default",
		"event-types":               "/v2/event-types",
		"me":                        "/v2/me",
		"oauth-clients":             "/v2/oauth-clients",
		"schedules":                 "/v2/schedules",
		"stripe":                    "/v2/stripe/check",
		"stripe-connect":            "/v2/stripe/connect",
		"verified-resources":        "/v2/verified-resources/emails",
		"verified-resources-phones": "/v2/verified-resources/phones",
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "users", ParentTable: "oauth-clients", ParentIDParam: "clientId", PathTemplate: "/v2/oauth-clients/{clientId}/users", KeyField: ""},
	}
}
