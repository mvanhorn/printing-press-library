...
func newEventTypesWebhooksEventTypeGetEventTypeCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"pp:endpoint": "webhooks.event-type-get-event-type", "pp:method": "GET", "pp:path": "/v2/event-types/{eventTypeId}/webhooks", "mcp:read-only": "true"},
