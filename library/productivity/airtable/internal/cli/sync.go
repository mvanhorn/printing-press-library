...
Resource scoping:
  ...
  airtable-pp-cli sync

  # Sync specific resources only
  airtable-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  airtable-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  airtable-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  airtable-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  airtable-pp-cli sync --latest-only`,
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "comments", ParentTable: "bases", ParentIDParam: "baseId", PathTemplate: "/{baseId}/{tableIdOrName}/{recordId}/comments", KeyField: ""},
		{Name: "records", ParentTable: "bases", ParentIDParam: "baseId", PathTemplate: "/{baseId}/{tableIdOrName}", KeyField: ""},
		{Name: "webhooks", ParentTable: "bases", ParentIDParam: "baseId", PathTemplate: "/bases/{baseId}/webhooks/{webhookId}/payloads", KeyField: ""},
	}
}
