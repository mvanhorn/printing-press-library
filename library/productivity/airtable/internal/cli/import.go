...
but do not stop the import.`,
  ...
  airtable-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  airtable-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | airtable-pp-cli import <resource> --input -`,
