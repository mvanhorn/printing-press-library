...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/productivity/airtable/internal/mcp"
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "airtable-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
