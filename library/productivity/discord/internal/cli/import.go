...
but do not stop the import.`,
  ...
  discord-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  discord-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | discord-pp-cli import <resource> --input -`,
