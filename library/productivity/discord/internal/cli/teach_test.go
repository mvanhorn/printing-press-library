...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"discord-pp-cli auth login",
		"discord-pp-cli doctor",
		"discord-pp-cli help items",
		"discord-pp-cli sync",
		"discord-pp-cli profile list",
		"discord-pp-cli feedback list",
		"discord-pp-cli which",
		"discord-pp-cli agent-context",
		"discord-pp-cli completion bash",
		"discord-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"discord-pp-cli recall",
		"discord-pp-cli learnings",
		"discord-pp-cli teach-pattern",
		"discord-pp-cli teach-lookup",
		"discord-pp-cli items list",
	}
