...
func newUsersListMyGuildsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  discord-pp-cli users list-my-guilds",
		Annotations: map[string]string{"pp:endpoint": "users.list-my-guilds", "pp:method": "GET", "pp:path": "/users/@me/guilds", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolvePaginatedReadWithStrategy(cmd.Context(), c, flags, "auto", "users", path, map[string]string{
				...
				"with_counts": formatCLIParamValue(flagWithCounts),
