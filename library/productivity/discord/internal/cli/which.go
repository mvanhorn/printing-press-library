...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  discord-pp-cli which "stale tickets"
  discord-pp-cli which "bottleneck"
  discord-pp-cli which --limit 1 "send message"
  discord-pp-cli which                                # list the full capability index`,
