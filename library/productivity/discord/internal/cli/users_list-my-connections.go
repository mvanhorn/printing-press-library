...
func newUsersListMyConnectionsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  discord-pp-cli users list-my-connections",
		Annotations: map[string]string{"pp:endpoint": "users.list-my-connections", "pp:method": "GET", "pp:path": "/users/@me/connections", "mcp:read-only": "true"},
