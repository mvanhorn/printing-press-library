...
large datasets as it has no memory pressure.`,
  ...
  discord-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  discord-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  discord-pp-cli export <resource> --format jsonl | jq '.id'`,
		Args: cobra.RangeArgs(1, 2),
		RunE: func(cmd *cobra.Command, args []string) (err error) {
			validResources := map[string]bool{
				"oauth2":                    true,
				"soundboard-default-sounds": true,
				"sticker-packs":             true,
				"users":                     true,
				"voice":                     true,
			}
