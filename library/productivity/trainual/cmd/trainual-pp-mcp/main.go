...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/productivity/trainual/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "trainual-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
