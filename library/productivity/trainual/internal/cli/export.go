...
large datasets as it has no memory pressure.`,
		Example: `  # Export all users as JSONL (streaming, recommended for large datasets)
  trainual-pp-cli export users --format jsonl --output users.jsonl

  # Export with limit
  trainual-pp-cli export subjects --format jsonl --limit 100

  # Pipe to another tool
  trainual-pp-cli export users --format jsonl | jq '.email'`,
