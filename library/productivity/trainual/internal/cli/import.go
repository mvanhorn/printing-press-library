...
but do not stop the import.`,
  ...
  trainual-pp-cli import users --input users.jsonl

  # Dry-run to preview without sending
  trainual-pp-cli import users --input users.jsonl --dry-run

  # Import from stdin
  cat users.jsonl | trainual-pp-cli import users --input -`,
