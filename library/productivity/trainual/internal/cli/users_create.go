...
func newUsersCreateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "create",
		Short:       "Invite a new user (triggers invitation email, consumes seat)",
		Example:     "  trainual-pp-cli users create --email user@example.com",
	...
	cmd.Flags().StringVar(&bodyFirstName, "first-name", "", "User first name")
	cmd.Flags().StringVar(&bodyLastName, "last-name", "", "User last name")
	cmd.Flags().StringVar(&bodyTitle, "title", "", "Job title")
	cmd.Flags().StringVar(&bodyDepartment, "department", "", "Department name")
	cmd.Flags().StringVar(&bodyRole, "role", "", "Role name")
