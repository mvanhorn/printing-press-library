...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "trainual-pp-cli",
		Short: `Trainual CLI — Every Trainual feature plus compliance audit, assignment gap detection, and training analytics no other tool provides.`,
		Long: `Trainual CLI — Every Trainual feature plus compliance audit, assignment gap detection, and training analytics no other tool provides.
...
Health check: run 'trainual-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("trainual-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'trainual-pp-cli profile list')")
	...
	rootCmd.AddCommand(newTestsCmd(flags))
	...
	rootCmd.AddCommand(newComplianceAuditCmd(flags))
	rootCmd.AddCommand(newAssignmentGapsCmd(flags))
	rootCmd.AddCommand(newContentAuditCmd(flags))
	rootCmd.AddCommand(newOnboardingStatusCmd(flags))
	rootCmd.AddCommand(newCoverageMatrixCmd(flags))
	rootCmd.AddCommand(newRoleCompletionCmd(flags))
	rootCmd.AddCommand(newCompletionTrendCmd(flags))
	rootCmd.AddCommand(newBulkAssignCmd(flags))
