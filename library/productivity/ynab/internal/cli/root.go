...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "ynab-pp-cli",
		Short: "Manage ynab resources via the ynab API",
		Long: `Manage ynab resources via the ynab API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'ynab-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'ynab-pp-cli profile list')")
