...
large datasets as it has no memory pressure.`,
  ...
  ynab-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  ynab-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  ynab-pp-cli export <resource> --format jsonl | jq '.id'`,
