...
Resource scoping:
  ...
  productive-pp-cli sync

  # Sync specific resources only
  productive-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  productive-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  productive-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  productive-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  productive-pp-cli sync --latest-only`,
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "contact_entries":
		return db.UpsertContactEntries(data)
	case "custom_fields":
		return db.UpsertCustomFields(data)
	case "deal_statuses":
		return db.UpsertDealStatuses(data)
	case "deals":
	...
	case "holiday_calendars":
		return db.UpsertHolidayCalendars(data)
	case "holidays":
		return db.UpsertHolidays(data)
	case "invoice_attributions":
		return db.UpsertInvoiceAttributions(data)
	case "invoices":
		return db.UpsertInvoices(data)
	case "line_items":
		return db.UpsertLineItems(data)
	case "memberships":
	...
	case "proposals":
		return db.UpsertProposals(data)
	case "reports":
		return db.UpsertReports(data)
	case "roles":
		return db.UpsertRoles(data)
	case "service_types":
		return db.UpsertServiceTypes(data)
	case "services":
		return db.UpsertServices(data)
	case "subsidiaries":
		return db.UpsertSubsidiaries(data)
	case "task_lists":
		return db.UpsertTaskLists(data)
	case "tasks":
		return db.UpsertTasks(data)
	case "tax_rates":
		return db.UpsertTaxRates(data)
	case "teams":
	...
	case "workflow_statuses":
		return db.UpsertWorkflowStatuses(data)
	case "workflows":
...
func defaultSyncResources() []string {
	return []string{
		...
		"reports-financial-item-reports",
		"reports-invoice-reports",
		"reports-line-item-reports",
		"reports-payment-reports",
		"reports-project-reports",
		"reports-task-reports",
		"reports-time-entry-reports",
		"roles",
		"service_types",
		"services",
		"subsidiaries",
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		...
		"projects":                       "/projects",
		"proposals":                      "/proposals",
		"reports":                        "/reports/deal_reports",
		"reports-booking-reports":        "/reports/booking_reports",
		"reports-budget-reports":         "/reports/budget_reports",
		"reports-expense-reports":        "/reports/expense_reports",
		"reports-financial-item-reports": "/reports/financial_item_reports",
		"reports-invoice-reports":        "/reports/invoice_reports",
		"reports-line-item-reports":      "/reports/line_item_reports",
		"reports-payment-reports":        "/reports/payment_reports",
		"reports-project-reports":        "/reports/project_reports",
		"reports-task-reports":           "/reports/task_reports",
		"reports-time-entry-reports":     "/reports/time_entry_reports",
		"roles":                          "/roles",
...
func responsePathForResource(resource, path string) []string {
	...
	case "activities\x00/activities/{id}":
		return []string{"data"}
	case "activities\x00/activities":
		return []string{"data"}
	case "attachments\x00/attachments/{id}":
		return []string{"data"}
	case "attachments\x00/attachments":
		return []string{"data"}
	case "bookings\x00/bookings/{id}":
		return []string{"data"}
	case "bookings\x00/bookings":
		return []string{"data"}
	case "comments\x00/comments/{id}":
		return []string{"data"}
	case "comments\x00/comments":
		return []string{"data"}
	case "companies\x00/companies/{id}":
		return []string{"data"}
	case "companies\x00/companies":
		return []string{"data"}
	case "contact_entries\x00/contact_entries/{id}":
		return []string{"data"}
	case "contact_entries\x00/contact_entries":
		return []string{"data"}
	case "custom_fields\x00/custom_fields/{id}":
		return []string{"data"}
	case "custom_fields\x00/custom_fields":
		return []string{"data"}
	case "deal_statuses\x00/deal_statuses/{id}":
		return []string{"data"}
	case "deal_statuses\x00/deal_statuses":
		return []string{"data"}
	case "deals\x00/deals/{id}":
		return []string{"data"}
	case "deals\x00/deals":
		return []string{"data"}
	case "events\x00/events/{id}":
		return []string{"data"}
	case "events\x00/events":
		return []string{"data"}
	case "expenses\x00/expenses/{id}":
		return []string{"data"}
	case "expenses\x00/expenses":
		return []string{"data"}
	case "filters\x00/filters/{id}":
		return []string{"data"}
	case "filters\x00/filters":
		return []string{"data"}
	case "folders\x00/folders/{id}":
		return []string{"data"}
	case "folders\x00/folders":
		return []string{"data"}
	case "holiday_calendars\x00/holiday_calendars/{id}":
		return []string{"data"}
	case "holiday_calendars\x00/holiday_calendars":
		return []string{"data"}
	case "holidays\x00/holidays/{id}":
		return []string{"data"}
	case "holidays\x00/holidays":
		return []string{"data"}
	case "invoice_attributions\x00/invoice_attributions/{id}":
		return []string{"data"}
	case "invoice_attributions\x00/invoice_attributions":
		return []string{"data"}
	case "invoices\x00/invoices/{id}":
		return []string{"data"}
	case "invoices\x00/invoices":
		return []string{"data"}
	case "line_items\x00/line_items/{id}":
		return []string{"data"}
	case "line_items\x00/line_items":
		return []string{"data"}
	case "memberships\x00/memberships/{id}":
		return []string{"data"}
	case "memberships\x00/memberships":
		return []string{"data"}
	case "pages\x00/pages/{id}":
		return []string{"data"}
	case "pages\x00/pages":
		return []string{"data"}
	case "payments\x00/payments/{id}":
		return []string{"data"}
	case "payments\x00/payments":
		return []string{"data"}
	case "people\x00/people/{id}":
		return []string{"data"}
	case "people\x00/people":
		return []string{"data"}
	case "pipelines\x00/pipelines/{id}":
		return []string{"data"}
	case "pipelines\x00/pipelines":
		return []string{"data"}
	case "projects\x00/projects/{id}":
		return []string{"data"}
	case "projects\x00/projects":
		return []string{"data"}
	case "proposals\x00/proposals/{id}":
		return []string{"data"}
	case "proposals\x00/proposals":
		return []string{"data"}
	case "reports\x00/reports/booking_reports":
		return []string{"data"}
	case "reports\x00/reports/budget_reports":
		return []string{"data"}
	case "reports\x00/reports/deal_reports":
		return []string{"data"}
	case "reports\x00/reports/expense_reports":
		return []string{"data"}
	case "reports\x00/reports/financial_item_reports":
		return []string{"data"}
	case "reports\x00/reports/invoice_reports":
		return []string{"data"}
	case "reports\x00/reports/line_item_reports":
		return []string{"data"}
	case "reports\x00/reports/payment_reports":
		return []string{"data"}
	case "reports\x00/reports/project_reports":
		return []string{"data"}
	case "reports\x00/reports/task_reports":
		return []string{"data"}
	case "reports\x00/reports/time_entry_reports":
		return []string{"data"}
	case "roles\x00/roles/{id}":
		return []string{"data"}
	case "roles\x00/roles":
		return []string{"data"}
	case "service_types\x00/service_types/{id}":
		return []string{"data"}
	case "service_types\x00/service_types":
		return []string{"data"}
	case "services\x00/services/{id}":
		return []string{"data"}
	case "services\x00/services":
		return []string{"data"}
	case "subsidiaries\x00/subsidiaries/{id}":
		return []string{"data"}
	case "subsidiaries\x00/subsidiaries":
		return []string{"data"}
	case "task_lists\x00/task_lists/{id}":
		return []string{"data"}
	case "task_lists\x00/task_lists":
		return []string{"data"}
	case "tasks\x00/tasks/{id}":
		return []string{"data"}
	case "tasks\x00/tasks":
		return []string{"data"}
	case "tax_rates\x00/tax_rates/{id}":
		return []string{"data"}
	case "tax_rates\x00/tax_rates":
		return []string{"data"}
	case "teams\x00/teams/{id}":
		return []string{"data"}
	case "teams\x00/teams":
		return []string{"data"}
	case "time_entries\x00/time_entries/{id}":
		return []string{"data"}
	case "time_entries\x00/time_entries":
		return []string{"data"}
	case "todos\x00/todos/{id}":
		return []string{"data"}
	case "todos\x00/todos":
		return []string{"data"}
	case "workflow_statuses\x00/workflow_statuses/{id}":
		return []string{"data"}
	case "workflow_statuses\x00/workflow_statuses":
		return []string{"data"}
	case "workflows\x00/workflows/{id}":
		return []string{"data"}
	case "workflows\x00/workflows":
		return []string{"data"}
	}
	return nil
}
