...
func TestRecipeIntentHandlerBuildsRecipeArgs(t *testing.T) {
	...
	req := mcplib.CallToolRequest{Params: mcplib.CallToolParams{Arguments: map[string]any{
		"months": "required-value",
	}}}
	result, err := handleAgendaMonth(context.Background(), req)
	if err != nil {
...
func TestRecipeIntentHandlerOverridesParams(t *testing.T) {
	...
	if !strings.Contains(got, "--months") || !strings.Contains(got, "required-value") {
		t.Fatalf("string override for --months missing from %q", got)
	}
}
