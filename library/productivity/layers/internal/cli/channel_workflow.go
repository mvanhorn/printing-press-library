...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  layers-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  layers-pp-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"context", "home", "home-get-home-info-layers-agenda", "home-get-home-info-layers-atendimentos", "home-get-home-info-layers-comunicados", "me", "media", "media-app-layers-atendimentos-icon", "media-app-layers-comunicados-icon", "notification-badge", "preferences", "sso"}
			archiveMaxPages := 100
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  layers-pp-cli workflow status

  # Show status as JSON
  layers-pp-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("layers-pp-cli")
			}
