...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/productivity/layers/internal/learn/lookups"
...
Resource scoping:
  ...
  layers-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  layers-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  layers-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  layers-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  layers-pp-cli sync --latest-only`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if dbPath == "" {
				dbPath = defaultDBPath("layers-pp-cli")
			}
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "post-delivery":
		return db.UpsertPostDelivery(data)
	case "view":
...
func defaultSyncResources() []string {
	return []string{
		"context",
		"home",
		"home-get-home-info-layers-agenda",
		"home-get-home-info-layers-atendimentos",
		"home-get-home-info-layers-comunicados",
		"me",
		"media",
		"media-app-layers-atendimentos-icon",
		"media-app-layers-comunicados-icon",
		"notification-badge",
		"preferences",
		"sso",
	}
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{ // #nosec G101 -- endpoint paths, not credentials.
		"context":                                "/v1/context",
		"home":                                   "/v1/home/discover",
		"home-get-home-info-layers-agenda":       "/v1/home/getHomeInfo/layers-agenda",
		"home-get-home-info-layers-atendimentos": "/v1/home/getHomeInfo/layers-atendimentos",
		"home-get-home-info-layers-comunicados":  "/v1/home/getHomeInfo/layers-comunicados",
		"me":                                     "/v1/me",
		"media":                                  "/v1/media/app/layers-agenda/icon",
		"media-app-layers-atendimentos-icon":     "/v1/media/app/layers-atendimentos/icon",
		"media-app-layers-comunicados-icon":      "/v1/media/app/layers-comunicados/icon",
		"notification-badge":                     "/v2/notification-badge",
		"preferences":                            "/v2/preferences",
		"sso":                                    "/v1/sso/account/me",
	}
...
func responsePathForResource(resource, path string) []string {
	...
	case "me\x00/v1/me":
		return []string{"agendas"}
	case "post-delivery\x00/api/v2/post-delivery/paginate":
		return []string{"hits"}
	case "view\x00/v1/view/events/sync":
		return []string{"hits"}
	}
	return nil
}
