...
but do not stop the import.`,
  ...
  layers-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  layers-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | layers-pp-cli import <resource> --input -`,
