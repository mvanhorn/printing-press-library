...
large datasets as it has no memory pressure.`,
  ...
  layers-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  layers-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  layers-pp-cli export <resource> --format jsonl | jq '.id'`,
