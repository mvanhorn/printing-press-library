...
var whichIndex = []whichEntry{
	{Command: "search", Description: "Search previously synchronized school data across Layers services from one local, pipeable index.", Group: "Local state that compounds", WhyItMatters: "Use this when an agent needs a fast cross-service lookup without repeatedly downloading verbose portal responses."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  layers-pp-cli which "stale tickets"
  layers-pp-cli which "bottleneck"
  layers-pp-cli which --limit 1 "send message"
  layers-pp-cli which                                # list the full capability index`,
