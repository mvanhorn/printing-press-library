...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/productivity/layers/internal/cliutil/testenv"
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"layers-pp-cli auth login",
		"layers-pp-cli doctor",
		"layers-pp-cli help items",
		"layers-pp-cli sync",
		"layers-pp-cli profile list",
		"layers-pp-cli feedback list",
		"layers-pp-cli which",
		"layers-pp-cli agent-context",
		"layers-pp-cli completion bash",
		"layers-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"layers-pp-cli teach",
		"layers-pp-cli recall",
		"layers-pp-cli learnings",
		"layers-pp-cli teach-pattern",
		"layers-pp-cli teach-lookup",
		"layers-pp-cli items list",
	}
