...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "plaud-pp-cli",
		Short: `Every conversation, queryable — your transcripts as a searchable history, not a feed.`,
		Long: `Every conversation, queryable — your transcripts as a searchable history, not a feed.
...
Health check: run 'plaud-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("plaud-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'plaud-pp-cli profile list')")
	...
	rootCmd.AddCommand(newFiletagsPromotedCmd(flags))
	rootCmd.AddCommand(newUsersPromotedCmd(flags))
	// Plaud transcendence + escape-hatch commands (hand-authored).
	...
	rootCmd.AddCommand(newForgottenCmd(flags))
	rootCmd.AddCommand(newThemesCmd(flags))
	rootCmd.AddCommand(newCrossMeetingCmd(flags))
	rootCmd.AddCommand(newSilenceCmd(flags))
	rootCmd.AddCommand(newMentionedMeCmd(flags))
	rootCmd.AddCommand(newSyncTranscriptsCmd(flags))
