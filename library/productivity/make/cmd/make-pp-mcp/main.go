...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/productivity/make/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "make-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
