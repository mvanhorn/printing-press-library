...
large datasets as it has no memory pressure.`,
  ...
  make-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  make-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  make-pp-cli export <resource> --format jsonl | jq '.id'`,
