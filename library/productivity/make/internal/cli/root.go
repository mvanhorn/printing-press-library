...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "make-pp-cli",
		Short: `Manage Make.com scenarios, connections, webhooks, data stores, and run scenarios synchronously from the terminal.`,
		Long: `Manage Make.com scenarios, connections, webhooks, data stores, and run scenarios synchronously from the terminal.
...
Health check: run 'make-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("make-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'make-pp-cli profile list')")
	...
	rootCmd.AddCommand(newDataStoresCmd(flags))
	rootCmd.AddCommand(newDataStructuresCmd(flags))
	rootCmd.AddCommand(newDevicesCmd(flags))
	rootCmd.AddCommand(newDlqsCmd(flags))
	...
	rootCmd.AddCommand(newScenariosCmd(flags))
	rootCmd.AddCommand(newSdkAppsCmd(flags))
	...
	rootCmd.AddCommand(newNovelBlueprintCmd(flags))
	rootCmd.AddCommand(newNovelDlqCmd(flags))
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		Use:   "version",
		Short: "Print the make-pp-cli binary name and semver tag",
