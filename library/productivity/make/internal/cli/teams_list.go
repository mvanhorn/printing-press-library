...
func newTeamsListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  make-pp-cli teams list --organization-id 42",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolveReadWithStrategy(cmd.Context(), c, flags, "auto", "teams", true, path, params, nil, cmd.ErrOrStderr())
			if err != nil {
