...
type Config struct {
	...
	SlackBotToken    string          `toml:"bot_token"`
	SlackUserToken   string          `toml:"user_token"`
}
...
func Load(configPath string) (*Config, error) {
	...
	if v := os.Getenv("SLACK_BOT_TOKEN"); v != "" {
		cfg.SlackBotToken = v
		cfg.markEnvOverride("SlackBotToken")
		cfg.AuthSource = "env:SLACK_BOT_TOKEN"
		cfg.CredentialSource = "env:SLACK_BOT_TOKEN"
	}
	if v := os.Getenv("SLACK_USER_TOKEN"); v != "" {
		cfg.SlackUserToken = v
		cfg.markEnvOverride("SlackUserToken")
		cfg.AuthSource = "env:SLACK_USER_TOKEN"
		cfg.CredentialSource = "env:SLACK_USER_TOKEN"
	}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("SLACK_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "slack-pp-cli", "config.toml"), nil
}
...
func (c *Config) AuthHeader() string {
	...
	if c.SlackBotToken != "" {
		if c.AuthSource == "" {
			c.AuthSource = "env:SLACK_BOT_TOKEN"
		}
...
func (c *Config) applyCredentials(creds *cliutil.Credentials) {
	...
	c.SlackBotToken = creds.SlackBotToken
	c.SlackUserToken = creds.SlackUserToken
}
...
func (c *Config) ClearTokens() error {
	...
	c.updateFileConfigField("ClientSecret")
	c.SlackBotToken = ""
	delete(c.envOverrides, "SlackBotToken")
	c.updateFileConfigField("SlackBotToken")
	c.SlackUserToken = ""
	delete(c.envOverrides, "SlackUserToken")
	c.updateFileConfigField("SlackUserToken")
	if c.AgentcookieManagedByExternalStore() {
		c.markAgentcookieManaged()
...
func (c *Config) configForSave() Config {
	out := *c
	if c.fileConfig != nil {
		if c.envOverrides["SlackBotToken"] {
			out.SlackBotToken = c.fileConfig.SlackBotToken
		}
		if c.envOverrides["SlackUserToken"] {
			out.SlackUserToken = c.fileConfig.SlackUserToken
		}
	}
...
func (c *Config) updateFileConfigField(field string) {
	...
	case "SlackBotToken":
		c.fileConfig.SlackBotToken = c.SlackBotToken
	case "SlackUserToken":
		c.fileConfig.SlackUserToken = c.SlackUserToken
	}
}
