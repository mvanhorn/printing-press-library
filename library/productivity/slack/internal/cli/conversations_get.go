...
func newConversationsGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  slack-pp-cli conversations get --channel example-value",
		Annotations: map[string]string{"pp:endpoint": "conversations.get", "pp:method": "GET", "pp:path": "/conversations.info", "mcp:read-only": "true"},
