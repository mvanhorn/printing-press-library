...
func newPinsAddCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"pp:endpoint": "pins.add", "pp:method": "POST", "pp:path": "/pins.add"},
	...
	cmd.Flags().StringVar(&bodyTimestamp, "timestamp", "", "Message timestamp to pin")
