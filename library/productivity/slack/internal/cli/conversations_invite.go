...
func newConversationsInviteCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  slack-pp-cli conversations invite --channel example-value",
		Annotations: map[string]string{"pp:endpoint": "conversations.invite", "pp:method": "POST", "pp:path": "/conversations.invite"},
	...
	cmd.Flags().StringVar(&bodyUsers, "users", "", "Comma-separated list of user IDs to invite")
