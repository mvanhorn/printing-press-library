...
func newRemindersCompleteCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  slack-pp-cli reminders complete --reminder example-value",
		Annotations: map[string]string{"pp:endpoint": "reminders.complete", "pp:method": "POST", "pp:path": "/reminders.complete"},
	...
	cmd.Flags().StringVar(&bodyReminder, "reminder", "", "Reminder ID")
