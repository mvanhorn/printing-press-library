...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "stars":
		return db.UpsertStars(data)
	case "team-integration-logs":
		return db.UpsertTeamIntegrationLogs(data)
	case "usergroups":
...
func knownSyncResourceNames() []string {
	names := []string{
		...
		"usergroups",
		"usergroups-usergroups-users-list",
		"users",
		"users-conversations",
		"users-identity",
	}
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{ // #nosec G101 -- endpoint paths, not credentials.
		...
		"usergroups-usergroups-users-list": "/usergroups.users.list",
		"users":                            "/users.list",
...
var reconcileTypedTables = map[string]string{
	...
	"reminders":             "reminders",
	"stars":                 "stars",
	"team-integration-logs": "team_integration_logs",
...
func responsePathForResource(resource, path string) []string {
	...
	case "conversations\x00/conversations.list":
		return []string{"channels"}
	case "conversations-join\x00/conversations.join":
		return []string{"channel"}
	case "conversations-open\x00/conversations.open":
		return []string{"channel"}
	case "conversations-rename\x00/conversations.rename":
		return []string{"channel"}
	case "files\x00/files.list":
		return []string{"files"}
	case "reactions\x00/reactions.list":
		return []string{"items"}
	case "reminders\x00/reminders.list":
		return []string{"reminders"}
	case "stars\x00/stars.list":
		return []string{"items"}
	case "team-integration-logs\x00/team.integrationLogs":
		return []string{"logs"}
	case "usergroups\x00/usergroups.list":
		return []string{"usergroups"}
	case "users\x00/users.list":
		return []string{"members"}
	case "users-conversations\x00/users.conversations":
		return []string{"channels"}
	}
	return nil
}
