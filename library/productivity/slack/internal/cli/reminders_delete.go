...
func newRemindersDeleteCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  slack-pp-cli reminders delete --reminder example-value",
		Annotations: map[string]string{"pp:endpoint": "reminders.delete", "pp:method": "POST", "pp:path": "/reminders.delete"},
