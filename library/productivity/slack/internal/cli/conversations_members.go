...
func newConversationsMembersCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  slack-pp-cli conversations members --channel example-value",
		Annotations: map[string]string{"pp:endpoint": "conversations.members", "pp:method": "GET", "pp:path": "/conversations.members", "mcp:read-only": "true"},
	...
	cmd.Flags().IntVar(&flagLimit, "limit", 0, "Maximum members to return")
