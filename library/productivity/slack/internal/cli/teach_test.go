...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"slack-pp-cli auth login",
		"slack-pp-cli doctor",
		"slack-pp-cli help items",
		"slack-pp-cli sync",
		"slack-pp-cli profile list",
		"slack-pp-cli feedback list",
		"slack-pp-cli which",
		"slack-pp-cli agent-context",
		"slack-pp-cli completion bash",
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"slack-pp-cli teach",
		"slack-pp-cli recall",
		"slack-pp-cli learnings",
		"slack-pp-cli teach-pattern",
		"slack-pp-cli teach-lookup",
		"slack-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("slack-pp-cli")); err == nil {
