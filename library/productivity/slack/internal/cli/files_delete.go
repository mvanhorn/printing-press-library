...
func newFilesDeleteCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  slack-pp-cli files delete --file example-value",
		Annotations: map[string]string{"pp:endpoint": "files.delete", "pp:method": "POST", "pp:path": "/files.delete"},
	...
	cmd.Flags().StringVar(&bodyFile, "file", "", "File ID to delete")
