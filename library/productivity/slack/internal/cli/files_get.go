...
func newFilesGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  slack-pp-cli files get --file example-value",
		Annotations: map[string]string{"pp:endpoint": "files.get", "pp:method": "GET", "pp:path": "/files.info", "mcp:read-only": "true"},
