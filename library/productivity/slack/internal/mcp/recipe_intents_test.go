...
func TestRecipeIntentHandlerBuildsRecipeArgs(t *testing.T) {
	...
	result, err := handleFindArchiveCandidatesWithoutAdminAccess(context.Background(), req)
	if err != nil {
...
func TestRecipeIntentHandlerOverridesParams(t *testing.T) {
	...
	if strings.Contains(got, "--dying") {
		t.Fatalf("boolean false override should suppress --dying: %q", got)
	}
}
