...
large datasets as it has no memory pressure.`,
  ...
  agilix-dawn-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  agilix-dawn-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  agilix-dawn-pp-cli export <resource> --format jsonl | jq '.id'`,
