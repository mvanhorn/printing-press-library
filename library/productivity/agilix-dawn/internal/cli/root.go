...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "agilix-dawn-pp-cli",
		Short: `Agilix Dawn CLI — The only CLI for the modern Agilix Dawn API — render a course's full structure, export curriculum and rosters, and mirr…`,
		Long: `Agilix Dawn CLI — The only CLI for the modern Agilix Dawn API — render a course's full structure, export curriculum and rosters, and mirr…
...
Health check: run 'agilix-dawn-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("agilix-dawn-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'agilix-dawn-pp-cli profile list')")
	...
	rootCmd.AddCommand(newConceptCmd(flags))
