...
Run sync first to populate the local search index.`,
  ...
  google-calendar-pp-cli search "status"

  # Force local search explicitly
  google-calendar-pp-cli search "status" --data-source local
  # Search a specific resource type locally
  google-calendar-pp-cli search "status" --type calendars --data-source local
  # JSON output for piping
  google-calendar-pp-cli search "status" --json --limit 20`,
