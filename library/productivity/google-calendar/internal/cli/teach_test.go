...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		...
		"google-calendar-pp-cli help items",
		"google-calendar-pp-cli sync",
		"google-calendar-pp-cli profile list",
		"google-calendar-pp-cli feedback list",
		"google-calendar-pp-cli which",
		"google-calendar-pp-cli agent-context",
		"google-calendar-pp-cli completion bash",
		"google-calendar-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"google-calendar-pp-cli recall",
		"google-calendar-pp-cli learnings",
		"google-calendar-pp-cli teach-pattern",
		"google-calendar-pp-cli teach-lookup",
		"google-calendar-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("google-calendar-pp-cli")); err == nil {
