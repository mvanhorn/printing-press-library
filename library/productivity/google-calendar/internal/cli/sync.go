...
func syncResourceFieldSelector(resource string) (string, string) {
	switch resource {
	case "users":
		return "syncToken", "id,etag,kind,value"
	case "users-me-calendar-list":
		return "syncToken", "id,accessRole,backgroundColor,colorId,deleted,description,etag,foregroundColor,hidden,kind,location,primary,selected,summary,summaryOverride,timeZone"
	}
	return "", ""
}
