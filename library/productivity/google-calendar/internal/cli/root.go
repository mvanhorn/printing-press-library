...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		...
		Short: `Google Calendar CLI — Every gcalcli and MCP feature, plus a local SQLite mirror that makes free-time search, conflict detection, and 'what ch…`,
		Long: `Google Calendar CLI — Every gcalcli and MCP feature, plus a local SQLite mirror that makes free-time search, conflict detection, and 'what ch…
...
See README.md or the bundled SKILL.md for recipes.`,
	...
	rootCmd.AddCommand(newACLAuditCmd(flags))
	rootCmd.AddCommand(newRSVPStatusCmd(flags))
