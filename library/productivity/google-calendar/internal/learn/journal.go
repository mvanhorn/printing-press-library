...
const (
	journalSessionEnvVar   = "GOOGLE_CALENDAR_LEARN_SESSION"
	journalNoLearnEnvVar   = "GOOGLE_CALENDAR_NO_LEARN"
	journalNoCaptureEnvVar = "GOOGLE_CALENDAR_LEARN_NO_CAPTURE"
)
