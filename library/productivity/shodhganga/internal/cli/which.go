...
var whichIndex = []whichEntry{
	{Command: "harvest", Description: "Mirror a research area's theses into a local database so you can search and analyze offline without re-hitting the site.", Group: "Local state that compounds", WhyItMatters: "Reach for this first when an agent will run many follow-up queries over the same research area — harvest once, then everything else is instant and offline."},
	{Command: "guide", Description: "List every thesis supervised by a given research guide across the harvested corpus.", Group: "Local state that compounds", WhyItMatters: "Use when mapping a supervisor's body of work or building academic-lineage graphs the site can't produce."},
	{Command: "university stats", Description: "Aggregate a university's theses in the local store into a profile: thesis count, subject spread, and year range.", Group: "Corpus analytics", WhyItMatters: "Use to compare institutions' doctoral output or profile a university's research strengths."},
	{Command: "trends", Description: "Show how thesis counts for a subject change over completion year across the harvested corpus.", Group: "Corpus analytics", WhyItMatters: "Use to spot rising or declining research areas in Indian doctoral output."},
	{Command: "similar", Description: "Find theses in the local store that share the most subject keywords with a given thesis.", Group: "Corpus analytics", WhyItMatters: "Use to expand a literature review outward from one relevant thesis."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  shodhganga-pp-cli which "stale tickets"
  shodhganga-pp-cli which "bottleneck"
  shodhganga-pp-cli which --limit 1 "send message"
  shodhganga-pp-cli which                                # list the full capability index`,
