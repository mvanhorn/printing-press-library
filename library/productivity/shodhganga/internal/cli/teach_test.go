...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("SHODHGANGA_STATE_DIR", "")
	t.Setenv("SHODHGANGA_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"shodhganga-pp-cli auth login",
		"shodhganga-pp-cli doctor",
		"shodhganga-pp-cli help items",
		"shodhganga-pp-cli sync",
		"shodhganga-pp-cli profile list",
		"shodhganga-pp-cli feedback list",
		"shodhganga-pp-cli which",
		"shodhganga-pp-cli agent-context",
		"shodhganga-pp-cli completion bash",
		"shodhganga-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"shodhganga-pp-cli recall",
		"shodhganga-pp-cli learnings",
		"shodhganga-pp-cli teach-pattern",
		"shodhganga-pp-cli teach-lookup",
		"shodhganga-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("shodhganga-pp-cli")); err == nil {
