...
Resource scoping:
  ...
  shodhganga-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  shodhganga-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  shodhganga-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  shodhganga-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  shodhganga-pp-cli sync --latest-only`,
