...
func Load(configPath string) (*Config, error) {
	cfg := &Config{
		BaseURL: "https://shodhganga.inflibnet.ac.in",
	}
	...
	if v := os.Getenv("SHODHGANGA_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("SHODHGANGA_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "shodhganga-pp-cli", "config.toml"), nil
}
