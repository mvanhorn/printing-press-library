...
func TestMCPPathResolutionMatchesCLIResolverWithPlatformDefaults(t *testing.T) {
	...
	if want := filepath.Join(home, ".config", "shodhganga-pp-cli", "config.toml"); cfg.Path != want {
	...
	if want := filepath.Join(home, ".local", "share", "shodhganga-pp-cli", "data.db"); gotDB != want {
...
func resetMCPPathEnv(t *testing.T) string {
	...
	for _, name := range []string{
		"SHODHGANGA_CONFIG",
		"SHODHGANGA_CONFIG_DIR",
		"SHODHGANGA_DATA_DIR",
		"SHODHGANGA_STATE_DIR",
		"SHODHGANGA_CACHE_DIR",
		"SHODHGANGA_HOME",
		"XDG_CONFIG_HOME",
		"XDG_DATA_HOME",
		"XDG_STATE_HOME",
...
func TestMCPRegisterToolsPreservesTypedSpecialTools(t *testing.T) {
	s := server.NewMCPServer("shodhganga", "test")
	RegisterTools(s)
