...
metadata:
  openclaw:
    ...
    install:
      - kind: go
        bins: [shodhganga-pp-cli]
        module: github.com/mvanhorn/printing-press-library/library/productivity/shodhganga/cmd/shodhganga-pp-cli
---
...
1. Check if installed: `which shodhganga-pp-cli`
