...
func Load(configPath string) (*Config, error) {
	cfg := &Config{
		BaseURL: "https://www-us2.api.concursolutions.com",
	}
	...
	// Env var overrides
	if v := strings.ToLower(strings.TrimSpace(os.Getenv("CONCUR_SKIP_TLS_VERIFY"))); v == "1" || v == "true" || v == "yes" || v == "on" {
	...
	if v := os.Getenv("CONCUR_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("CONCUR_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "concur-pp-cli", "config.toml"), nil
}
