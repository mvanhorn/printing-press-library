...
var whichIndex = []whichEntry{
	{Command: "expenses scan-duplicates", Description: "Find potential double-entered charges across all of your synced expenses.", Group: "Local state that compounds", WhyItMatters: "Run this before submitting a batch of reports if you suspect a corporate-card charge and a manually-entered cash expense might be the same transaction."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  concur-pp-cli which "stale tickets"
  concur-pp-cli which "bottleneck"
  concur-pp-cli which --limit 1 "send message"
  concur-pp-cli which                                # list the full capability index`,
