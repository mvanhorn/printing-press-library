...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/productivity/concur/internal/cliutil/testenv"
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"concur-pp-cli auth login",
		"concur-pp-cli doctor",
		"concur-pp-cli help items",
		"concur-pp-cli sync",
		"concur-pp-cli profile list",
		"concur-pp-cli feedback list",
		"concur-pp-cli which",
		"concur-pp-cli agent-context",
		"concur-pp-cli completion bash",
		"concur-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"concur-pp-cli teach",
		"concur-pp-cli recall",
		"concur-pp-cli learnings",
		"concur-pp-cli teach-pattern",
		"concur-pp-cli teach-lookup",
		"concur-pp-cli items list",
	}
