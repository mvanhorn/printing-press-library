...
large datasets as it has no memory pressure.`,
  ...
  concur-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  concur-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  concur-pp-cli export <resource> --format jsonl | jq '.id'`,
