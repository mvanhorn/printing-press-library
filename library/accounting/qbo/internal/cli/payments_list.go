...
func newPaymentsListCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "list",
		Short: "List QBO accounting Payment records from a fixture.",
		Args:  cobra.ArbitraryArgs,
		RunE: func(cmd *cobra.Command, args []string) error {
			return printQBORead("payments", fixture, "/query?query=select%20*%20from%20Payment", tokenFile, companyID, baseURL)
		},
	}
