...
func newAccountsListCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "list",
		Short: "List chart-of-accounts records from a fixture.",
		Args:  cobra.ArbitraryArgs,
		RunE: func(cmd *cobra.Command, args []string) error {
			return printQBORead("accounts", fixture, "/query?query=select%20*%20from%20Account", tokenFile, companyID, baseURL)
		},
	}
