...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"lever-pp-cli auth login",
		"lever-pp-cli doctor",
		"lever-pp-cli help items",
		"lever-pp-cli sync",
		"lever-pp-cli profile list",
		"lever-pp-cli feedback list",
		"lever-pp-cli which",
		"lever-pp-cli agent-context",
		"lever-pp-cli completion bash",
		"lever-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"lever-pp-cli teach",
		"lever-pp-cli recall",
		"lever-pp-cli learnings",
		"lever-pp-cli teach-pattern",
		"lever-pp-cli teach-lookup",
		"lever-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("lever-pp-cli")); err == nil {
