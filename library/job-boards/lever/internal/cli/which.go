...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  lever-pp-cli which "stale tickets"
  lever-pp-cli which "bottleneck"
  lever-pp-cli which --limit 1 "send message"
  lever-pp-cli which                                # list the full capability index`,
