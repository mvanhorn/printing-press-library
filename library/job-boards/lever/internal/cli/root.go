...
type rootFlags struct {
	...
	// invocation. Mirrors the LEVER_NO_LEARN env var.
	noLearn       bool
	selectFields  string
	configPath    string
	homePath      string
...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "lever-pp-cli",
		Short: "Manage lever resources via the lever API",
		Long: `Manage lever resources via the lever API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'lever-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("lever-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'lever-pp-cli profile list')")
