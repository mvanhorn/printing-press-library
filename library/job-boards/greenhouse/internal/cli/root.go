...
type rootFlags struct {
	...
	// invocation. Mirrors the GREENHOUSE_NO_LEARN env var.
	noLearn       bool
	selectFields  string
	configPath    string
	homePath      string
...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "greenhouse-pp-cli",
		Short: "Manage greenhouse resources via the greenhouse API",
		Long: `Manage greenhouse resources via the greenhouse API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'greenhouse-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("greenhouse-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'greenhouse-pp-cli profile list')")
	...
	rootCmd.AddCommand(newOfficesPromotedCmd(flags))
