...
func newDoctorCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `  greenhouse-pp-cli doctor
  greenhouse-pp-cli doctor --json
  greenhouse-pp-cli doctor --fail-on warn
  greenhouse-pp-cli doctor --fail-on stale`,
			...
			if cfg != nil && cfg.BaseURL != "" {
				...
				if clientErr != nil {
					...
					if authHeader == "" {
						...
						if suggestion != "" {
							report["credentials"] = fmt.Sprintf("present, not verified. Run `%s %s` to confirm the token works end-to-end.", "greenhouse-pp-cli", suggestion)
						} else {
