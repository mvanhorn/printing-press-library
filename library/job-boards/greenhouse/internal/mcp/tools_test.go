...
func TestMCPPathResolutionMatchesCLIResolverWithPlatformDefaults(t *testing.T) {
	...
	if want := filepath.Join(home, ".config", "greenhouse-pp-cli", "config.toml"); cfg.Path != want {
	...
	if want := filepath.Join(home, ".local", "share", "greenhouse-pp-cli", "data.db"); gotDB != want {
...
func resetMCPPathEnv(t *testing.T) string {
	...
	if runtime.GOOS == "windows" {
		...
		// otherwise the real user store leaks into these tests.
	...
	for _, name := range []string{
		"GREENHOUSE_CONFIG",
		"GREENHOUSE_CONFIG_DIR",
		"GREENHOUSE_DATA_DIR",
		"GREENHOUSE_STATE_DIR",
		"GREENHOUSE_CACHE_DIR",
		"GREENHOUSE_HOME",
		"XDG_CONFIG_HOME",
		"XDG_DATA_HOME",
		"XDG_STATE_HOME",
...
func TestMCPRegisterToolsPreservesTypedSpecialTools(t *testing.T) {
	s := server.NewMCPServer("greenhouse", "test")
	RegisterTools(s)
