...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("PRINTGOAT_STATE_DIR", "")
	t.Setenv("PRINTGOAT_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"printgoat-pp-cli auth login",
		"printgoat-pp-cli doctor",
		"printgoat-pp-cli help items",
		"printgoat-pp-cli sync",
		"printgoat-pp-cli profile list",
		"printgoat-pp-cli feedback list",
		"printgoat-pp-cli which",
		"printgoat-pp-cli agent-context",
		"printgoat-pp-cli completion bash",
		"printgoat-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"printgoat-pp-cli recall",
		"printgoat-pp-cli learnings",
		"printgoat-pp-cli teach-pattern",
		"printgoat-pp-cli teach-lookup",
		"printgoat-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("printgoat-pp-cli")); err == nil {
