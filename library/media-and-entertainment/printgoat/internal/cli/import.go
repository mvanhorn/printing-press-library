...
but do not stop the import.`,
  ...
  printgoat-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  printgoat-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | printgoat-pp-cli import <resource> --input -`,
