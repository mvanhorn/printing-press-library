...
large datasets as it has no memory pressure.`,
  ...
  printgoat-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  printgoat-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  printgoat-pp-cli export <resource> --format jsonl | jq '.id'`,
