...
// EpisodeRow is the typed view of one episodes row.
...
// SegmentHit is one segment from a quote search.
...
// ClearBySource removes cached episodes for one source.
