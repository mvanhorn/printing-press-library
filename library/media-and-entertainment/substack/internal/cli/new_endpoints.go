...
named by --subdomain. Works for any public publication, not just your own.`,
		Example:     "  substack-pp-cli posts archive --subdomain mypub --limit 20 --json",
...
publication named by --subdomain.`,
		Example:     "  substack-pp-cli posts ranked-authors --subdomain mypub --json",
...
publication named by --subdomain.`,
		Example:     "  substack-pp-cli publications authors --subdomain mypub --json",
...
user via --user-id (numeric) or pass a handle via --handle to resolve it first.`,
		Example: `  substack-pp-cli profiles posts --user-id 12345 --limit 10 --json
  substack-pp-cli profiles posts --handle someone --json`,
...
LinkedIn presence.`,
		Example:     "  substack-pp-cli profiles from-linkedin someone --json",
...
Notes as comments under the hood, so this endpoint works for Note IDs too.`,
		Example:     "  substack-pp-cli comments get 12345 --json",
