...
func newReviewsPromotedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "reviews",
		Short: "List public reviews, optionally for a product",
		Long:  "Shortcut for 'reviews list'. List public reviews, optionally for a product",
		Example: "  drivethrurpg-pp-cli reviews",
	...
	cmd.Flags().StringVar(&flagProductId, "product-id", "", "Product id to filter reviews by.")
