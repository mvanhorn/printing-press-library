...
but do not stop the import.`,
  ...
  drivethrurpg-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  drivethrurpg-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | drivethrurpg-pp-cli import <resource> --input -`,
