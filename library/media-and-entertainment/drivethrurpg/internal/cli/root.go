...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "github.com/mvanhorn/printing-press-library/library/media-and-entertainment/drivethrurpg",
		Short: "Manage drivethrurpg resources via the drivethrurpg API",
		Long: `Drivethrurpg CLI
...
Health check: run 'drivethrurpg-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("drivethrurpg-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'drivethrurpg-pp-cli profile list')")
	...
	rootCmd.AddCommand(newNovelOrderProductsCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newAuthKeyPromotedCmd(flags))
	rootCmd.AddCommand(newOrderProductsPromotedCmd(flags))
	rootCmd.AddCommand(newPublishersPromotedCmd(flags))
	rootCmd.AddCommand(newReviewsPromotedCmd(flags))
	rootCmd.AddCommand(newSearchAheadPromotedCmd(flags))
	rootCmd.AddCommand(newSpecialOffersPromotedCmd(flags))
