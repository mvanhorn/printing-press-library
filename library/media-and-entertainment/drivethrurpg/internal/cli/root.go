...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "drivethrurpg-pp-cli",
		Short: "Search DriveThruRPG and download purchases from your library",
...
Run 'drivethrurpg-pp-cli doctor' to verify auth and connectivity.`,
	...
	rootCmd.PersistentPreRunE = func(cmd *cobra.Command, args []string) error {
		...
		if err := autoRefreshIfStale(cmd.Context(), flags, cmd); err != nil {
			return err
		}
		return nil
	}
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("drivethrurpg-pp-cli %s\n", version)
		},
	}
}
