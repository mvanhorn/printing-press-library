...
func newProductsGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get <productId>",
		Short:       "Get public product details",
		Example:     "  drivethrurpg-pp-cli products get 42",
		Annotations: map[string]string{"pp:endpoint": "products.get", "pp:method": "GET", "pp:path": "/products/{productId}", "mcp:read-only": "true"},
