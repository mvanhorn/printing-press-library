...
large datasets as it has no memory pressure.`,
  ...
  drivethrurpg-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  drivethrurpg-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  drivethrurpg-pp-cli export <resource> --format jsonl | jq '.id'`,
