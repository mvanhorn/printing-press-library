...
func feedbackFilePath() (string, error) {
	...
	dir := filepath.Join(home, ".drivethrurpg-pp-cli")
...
func postFeedback(url string, entry FeedbackEntry) error {
	...
	req.Header.Set("User-Agent", "drivethrurpg-pp-cli/feedback")
...
func newFeedbackCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Long: `Feedback is captured locally first at ~/.drivethrurpg-pp-cli/feedback.jsonl.
