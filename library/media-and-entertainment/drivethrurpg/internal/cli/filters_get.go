...
func newFiltersGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get <filterId>",
		Short:       "Get public filter details",
		Example:     "  drivethrurpg-pp-cli filters get 42",
		Annotations: map[string]string{"pp:endpoint": "filters.get", "pp:method": "GET", "pp:path": "/filters/{filterId}", "mcp:read-only": "true"},
