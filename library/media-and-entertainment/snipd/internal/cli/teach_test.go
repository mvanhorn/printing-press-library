...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"snipd-pp-cli auth login",
		"snipd-pp-cli doctor",
		"snipd-pp-cli help items",
		"snipd-pp-cli sync",
		"snipd-pp-cli profile list",
		"snipd-pp-cli feedback list",
		"snipd-pp-cli which",
		"snipd-pp-cli agent-context",
		"snipd-pp-cli completion bash",
		"snipd-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"snipd-pp-cli teach",
		"snipd-pp-cli recall",
		"snipd-pp-cli learnings",
		"snipd-pp-cli teach-pattern",
		"snipd-pp-cli teach-lookup",
		"snipd-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("snipd-pp-cli")); err == nil {
