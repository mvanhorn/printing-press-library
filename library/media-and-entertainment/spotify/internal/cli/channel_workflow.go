...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  spotify-web-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  spotify-web-pp-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"browse", "markets", "me", "recommendations", "search",  }
			totalSynced := 0
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  spotify-web-pp-cli workflow status

  # Show status as JSON
  spotify-web-pp-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("spotify-web-pp-cli")
			}
