...
Exit codes & warnings:
  ...
  spotify-web-pp-cli sync

  # Sync specific resources only
  spotify-web-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  spotify-web-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  spotify-web-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  spotify-web-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  spotify-web-pp-cli sync --latest-only`,
