...
func newAudioFeaturesGetSeveralCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "get-several",
		Aliases: []string{"list"},
		Short: "Get Tracks' Audio Features",
		Example: "  spotify-web-pp-cli audio-features get-several",
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolveRead(c, flags, "audio-features", false, path, params)
			if err != nil {
