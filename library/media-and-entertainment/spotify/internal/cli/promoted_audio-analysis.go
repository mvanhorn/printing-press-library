...
func newAudioAnalysisPromotedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Long:  "Shortcut for 'audio-analysis get'. Get Track's Audio Analysis",
		Example: "  spotify-web-pp-cli audio-analysis",
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolveRead(c, flags, "audio-analysis", false, path, params)
			if err != nil {
