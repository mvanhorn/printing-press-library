...
var whichIndex = []whichEntry{
	...
	{Command: "events presales", Description: "Query real Ticketmaster presale windows and classify each as upcoming, open, ended, or unknown.", Group: "Tour & on-sale tracking", WhyItMatters: "When the user wants the next actionable presale window rather than the public on-sale date."},
	{Command: "events checkout", Description: "Select an official presale or public purchase URL and print it unless --launch is explicitly set.", Group: "Tour & on-sale tracking", WhyItMatters: "When the user is ready to continue in Ticketmaster without allowing unattended purchasing."},
