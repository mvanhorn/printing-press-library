...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "tv-time-pp-cli",
		Short: `Every TV Time feature, plus an offline watch-history mirror and agenda/backlog/stats queries no TV Time tool has.`,
		Long: `Every TV Time feature, plus an offline watch-history mirror and agenda/backlog/stats queries no TV Time tool has.
...
Health check: run 'tv-time-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("tv-time-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'tv-time-pp-cli profile list')")
	...
	rootCmd.AddCommand(newNovelBingeCmd(flags))
