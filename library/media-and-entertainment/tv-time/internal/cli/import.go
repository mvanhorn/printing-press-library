...
but do not stop the import.`,
  ...
  tv-time-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  tv-time-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | tv-time-pp-cli import <resource> --input -`,
