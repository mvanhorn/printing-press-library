...
# 2. Sync all your events, tickets, orders, returns, transfers, and fans
#    to a local SQLite database (one full pass, then incremental afterwards)
dice-fm-pp-cli sync --full

# 3. Financial report across all events this year — the headline workflow
