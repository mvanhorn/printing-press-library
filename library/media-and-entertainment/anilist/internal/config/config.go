...
type Config struct {
	...
	AnilistToken     string          `toml:"token"`
}
...
func Load(configPath string) (*Config, error) {
	...
	// Env var overrides
	if v := os.Getenv("ANILIST_TOKEN"); v != "" {
		cfg.AnilistToken = v
		cfg.markEnvOverride("AnilistToken")
		cfg.AuthSource = "env:ANILIST_TOKEN"
		cfg.CredentialSource = "env:ANILIST_TOKEN"
	}
	...
	if v := os.Getenv("ANILIST_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("ANILIST_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "anilist-pp-cli", "config.toml"), nil
}
...
func (c *Config) AuthHeader() string {
	...
	if c.AnilistToken != "" {
		if c.AuthSource == "" {
			c.AuthSource = "env:ANILIST_TOKEN"
		}
		return "Bearer " + c.AnilistToken
	}
	if c.AccessToken != "" {
...
func (c *Config) applyCredentials(creds *cliutil.Credentials) {
	...
	c.AnilistToken = creds.AnilistToken
}
...
func (c *Config) ClearTokens() error {
	...
	c.updateFileConfigField("ClientSecret")
	c.AnilistToken = ""
	delete(c.envOverrides, "AnilistToken")
	c.updateFileConfigField("AnilistToken")
	if c.AgentcookieManagedByExternalStore() {
		c.markAgentcookieManaged()
...
func (c *Config) configForSave() Config {
	out := *c
	if c.fileConfig != nil {
		if c.envOverrides["AnilistToken"] {
			out.AnilistToken = c.fileConfig.AnilistToken
		}
	}
...
func (c *Config) updateFileConfigField(field string) {
	...
	case "AnilistToken":
		c.fileConfig.AnilistToken = c.AnilistToken
	}
}
