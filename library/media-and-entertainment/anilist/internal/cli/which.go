...
var whichIndex = []whichEntry{
	{Command: "schedule tonight", Description: "See only episodes from your current anime list that air in your local day.", Group: "Watch routine", WhyItMatters: "Use this instead of a raw airing query when the request is about the user’s followed shows."},
	{Command: "progress check-in", Description: "Preview the next watched-episode update before explicitly applying it to AniList.", Group: "Watch routine", WhyItMatters: "Use this for an account mutation that must be checked before it is sent."},
	{Command: "backlog pick", Description: "Choose a realistically short anime from your Planning list using deterministic personal ranking.", Group: "Backlog decisions", WhyItMatters: "Use this when the request is to decide what the user can finish soon."},
	{Command: "progress catch-up", Description: "Find followed shows with aired episodes beyond your recorded progress.", Group: "Watch routine", WhyItMatters: "Use this when the user asks what they are behind on rather than what airs tonight."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  anilist-pp-cli which "stale tickets"
  anilist-pp-cli which "bottleneck"
  anilist-pp-cli which --limit 1 "send message"
  anilist-pp-cli which                                # list the full capability index`,
