...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("ANILIST_STATE_DIR", "")
	t.Setenv("ANILIST_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"anilist-pp-cli auth login",
		"anilist-pp-cli doctor",
		"anilist-pp-cli help items",
		"anilist-pp-cli sync",
		"anilist-pp-cli profile list",
		"anilist-pp-cli feedback list",
		"anilist-pp-cli which",
		"anilist-pp-cli agent-context",
		"anilist-pp-cli completion bash",
		"anilist-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"anilist-pp-cli recall",
		"anilist-pp-cli learnings",
		"anilist-pp-cli teach-pattern",
		"anilist-pp-cli teach-lookup",
		"anilist-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("anilist-pp-cli")); err == nil {
