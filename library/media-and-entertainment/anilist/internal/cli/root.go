...
type rootFlags struct {
	...
	// invocation. Mirrors the ANILIST_NO_LEARN env var.
	noLearn bool
...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "anilist-pp-cli",
		Short: `Anilist CLI — Your AniList data, plus safe progress updates and personal watch decisions no raw wrapper makes for you.`,
		Long: `Anilist CLI — Your AniList data, plus safe progress updates and personal watch decisions no raw wrapper makes for you.
...
Health check: run 'anilist-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("anilist-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'anilist-pp-cli profile list')")
	...
	rootCmd.AddCommand(newNovelProgressCmd(flags))
	rootCmd.AddCommand(newNovelScheduleCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newAniChartUsersPromotedCmd(flags))
	rootCmd.AddCommand(newNotificationOptionsPromotedCmd(flags))
	rootCmd.AddCommand(newPagesPromotedCmd(flags))
