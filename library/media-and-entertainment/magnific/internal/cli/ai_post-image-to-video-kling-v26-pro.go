...
func newAiPostImageToVideoKlingV26ProCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "post-image-to-video-kling-v26-pro",
		Short:       "Kling 2.6 Pro - Create video from text or image",
		Example:     "  magnific-pp-cli ai post-image-to-video-kling-v26-pro",
		Annotations: map[string]string{"pp:endpoint": "ai.post-image-to-video-kling-v26-pro", "pp:method": "POST", "pp:path": "/v1/ai/image-to-video/kling-v2-6-pro"},
