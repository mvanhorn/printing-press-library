...
but do not stop the import.`,
  ...
  magnific-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  magnific-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | magnific-pp-cli import <resource> --input -`,
