...
Resource scoping:
  ...
  magnific-pp-cli sync

  # Sync specific resources only
  magnific-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  magnific-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  magnific-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  magnific-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  magnific-pp-cli sync --latest-only`,
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	switch resource {
	case "icons_download":
		return db.UpsertIconsDownload(data)
	case "music":
		return db.UpsertMusic(data)
	case "music_download":
		return db.UpsertMusicDownload(data)
	case "resources_download":
		return db.UpsertResourcesDownload(data)
	case "sound-effects":
		return db.UpsertSoundEffects(data)
	case "sound_effects_download":
		return db.UpsertSoundEffectsDownload(data)
	case "videos":
		return db.UpsertVideos(data)
	case "videos_download":
		return db.UpsertVideosDownload(data)
	case "options":
...
func defaultSyncResources() []string {
	return []string{
		...
		"ai-ideogram-image-edit",
		"ai-image-change-camera",
		"ai-image-expand-flux-pro",
		"ai-image-expand-ideogram",
		"ai-image-expand-seedream-v4-5",
		"ai-image-relight",
		"ai-image-style-transfer",
		"ai-image-to-prompt",
		"ai-image-to-video-kling-elements-pro",
		"ai-image-to-video-kling-elements-std",
		"ai-image-to-video-kling-o1",
		"ai-image-to-video-kling-pro",
		"ai-image-to-video-kling-std",
		"ai-image-to-video-kling-v2",
		"ai-image-to-video-kling-v2-1-master",
		"ai-image-to-video-kling-v2-1-pro",
		"ai-image-to-video-kling-v2-1-std",
		"ai-image-to-video-kling-v2-5-pro",
		"ai-image-to-video-kling-v2-6",
		"ai-image-to-video-ltx-2-fast",
		"ai-image-to-video-ltx-2-pro",
		"ai-image-to-video-minimax-hailuo-02-1080p",
		"ai-image-to-video-minimax-hailuo-02-768p",
		"ai-image-to-video-minimax-hailuo-2-3-1080p",
		"ai-image-to-video-minimax-hailuo-2-3-1080p-fast",
		"ai-image-to-video-minimax-hailuo-2-3-768p",
		"ai-image-to-video-minimax-hailuo-2-3-768p-fast",
		"ai-image-to-video-minimax-live",
		"ai-image-to-video-pixverse-v5",
		"ai-image-to-video-pixverse-v5-5",
		"ai-image-to-video-pixverse-v5-transition",
		"ai-image-to-video-pixverse-v6",
		"ai-image-to-video-runway-4-5",
		"ai-image-to-video-runway-gen4-turbo",
		"ai-image-to-video-seedance-lite-1080p",
		"ai-image-to-video-seedance-lite-480p",
		"ai-image-to-video-seedance-lite-720p",
		"ai-image-to-video-seedance-pro-1080p",
		"ai-image-to-video-seedance-pro-480p",
		"ai-image-to-video-seedance-pro-720p",
		"ai-image-to-video-veo-3-1",
		"ai-image-to-video-veo-3-1-fast",
		"ai-image-to-video-wan-2-5-i2v-1080p",
		"ai-image-to-video-wan-2-5-i2v-480p",
		"ai-image-to-video-wan-2-5-i2v-720p",
		"ai-image-to-video-wan-2-7",
		"ai-image-to-video-wan-v2-2-480p",
		"ai-image-to-video-wan-v2-2-580p",
		"ai-image-to-video-wan-v2-2-720p",
		"ai-image-to-video-wan-v2-6-1080p",
		"ai-image-to-video-wan-v2-6-720p",
		"ai-image-upscaler",
		"ai-image-upscaler-precision",
		"ai-image-upscaler-precision-v2",
		"ai-improve-prompt",
		"ai-lip-sync-latent-sync",
		"ai-lip-sync-veed-fabric-1-0",
		"ai-lip-sync-veed-fabric-1-0-fast",
		"ai-loras",
		"ai-me-apps",
		"ai-music-generation",
		"ai-mystic",
		"ai-reference-to-video-kling-v3-omni",
		"ai-reference-to-video-veo-3-1",
		"ai-reference-to-video-wan-2-7",
		"ai-skin-enhancer",
		"ai-sound-effects",
		"ai-text-to-image-flux-2-klein",
		"ai-text-to-image-flux-2-pro",
		"ai-text-to-image-flux-2-turbo",
		"ai-text-to-image-flux-dev",
		"ai-text-to-image-flux-kontext-pro",
		"ai-text-to-image-flux-pro-v1-1",
		"ai-text-to-image-hyperflux",
		"ai-text-to-image-imagen3",
		"ai-text-to-image-imagen4-fast",
		"ai-text-to-image-imagen4-ultra",
		"ai-text-to-image-nano-banana-pro",
		"ai-text-to-image-nano-banana-pro-flash",
		"ai-text-to-image-runway",
		"ai-text-to-image-seedream",
		"ai-text-to-image-seedream-v4",
		"ai-text-to-image-seedream-v4-5",
		"ai-text-to-image-seedream-v4-5-edit",
		"ai-text-to-image-seedream-v4-edit",
		"ai-text-to-image-seedream-v5-lite",
		"ai-text-to-image-seedream-v5-lite-edit",
		"ai-text-to-image-z-image",
		"ai-text-to-video-ltx-2-fast",
		"ai-text-to-video-ltx-2-pro",
		"ai-text-to-video-runway-4-5",
		"ai-text-to-video-veo-3-1",
		"ai-text-to-video-veo-3-1-fast",
		"ai-text-to-video-wan-2-5-t2v-1080p",
		"ai-text-to-video-wan-2-5-t2v-480p",
		"ai-text-to-video-wan-2-5-t2v-720p",
		"ai-text-to-video-wan-2-7",
		"ai-text-to-video-wan-v2-6-1080p",
		"ai-text-to-video-wan-v2-6-720p",
		"ai-video-edit-wan-2-7",
		"ai-video-kling-4k-i2v",
		"ai-video-kling-4k-t2v",
		"ai-video-kling-advanced-custom-elements",
		"ai-video-kling-v3",
		"ai-video-kling-v3-motion-control-pro",
		"ai-video-kling-v3-motion-control-std",
		"ai-video-kling-v3-omni",
		"ai-video-omni-human-1-5",
		"ai-video-runway-act-two",
		"ai-video-seedance-1-5-pro-1080p",
		"ai-video-seedance-1-5-pro-480p",
		"ai-video-seedance-1-5-pro-720p",
		"ai-video-upscaler",
		"ai-video-upscaler-precision",
		"ai-video-vfx",
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"ai":                                              "/v1/ai/apps",
		"ai-audio-isolation":                              "/v1/ai/audio-isolation",
		"ai-gemini-2-5-flash-image-preview":               "/v1/ai/gemini-2-5-flash-image-preview",
		"ai-ideogram-image-edit":                          "/v1/ai/ideogram-image-edit",
		"ai-image-change-camera":                          "/v1/ai/image-change-camera",
		"ai-image-expand-flux-pro":                        "/v1/ai/image-expand/flux-pro",
		"ai-image-expand-ideogram":                        "/v1/ai/image-expand/ideogram",
		"ai-image-expand-seedream-v4-5":                   "/v1/ai/image-expand/seedream-v4-5",
		"ai-image-relight":                                "/v1/ai/image-relight",
		"ai-image-style-transfer":                         "/v1/ai/image-style-transfer",
		"ai-image-to-prompt":                              "/v1/ai/image-to-prompt",
		"ai-image-to-video-kling-elements-pro":            "/v1/ai/image-to-video/kling-elements-pro",
		"ai-image-to-video-kling-elements-std":            "/v1/ai/image-to-video/kling-elements-std",
		"ai-image-to-video-kling-o1":                      "/v1/ai/image-to-video/kling-o1",
		"ai-image-to-video-kling-pro":                     "/v1/ai/image-to-video/kling-pro",
		"ai-image-to-video-kling-std":                     "/v1/ai/image-to-video/kling-std",
		"ai-image-to-video-kling-v2":                      "/v1/ai/image-to-video/kling-v2",
		"ai-image-to-video-kling-v2-1-master":             "/v1/ai/image-to-video/kling-v2-1-master",
		"ai-image-to-video-kling-v2-1-pro":                "/v1/ai/image-to-video/kling-v2-1-pro",
		"ai-image-to-video-kling-v2-1-std":                "/v1/ai/image-to-video/kling-v2-1-std",
		"ai-image-to-video-kling-v2-5-pro":                "/v1/ai/image-to-video/kling-v2-5-pro",
		"ai-image-to-video-kling-v2-6":                    "/v1/ai/image-to-video/kling-v2-6",
		"ai-image-to-video-ltx-2-fast":                    "/v1/ai/image-to-video/ltx-2-fast",
		"ai-image-to-video-ltx-2-pro":                     "/v1/ai/image-to-video/ltx-2-pro",
		"ai-image-to-video-minimax-hailuo-02-1080p":       "/v1/ai/image-to-video/minimax-hailuo-02-1080p",
		"ai-image-to-video-minimax-hailuo-02-768p":        "/v1/ai/image-to-video/minimax-hailuo-02-768p",
		"ai-image-to-video-minimax-hailuo-2-3-1080p":      "/v1/ai/image-to-video/minimax-hailuo-2-3-1080p",
		"ai-image-to-video-minimax-hailuo-2-3-1080p-fast": "/v1/ai/image-to-video/minimax-hailuo-2-3-1080p-fast",
		"ai-image-to-video-minimax-hailuo-2-3-768p":       "/v1/ai/image-to-video/minimax-hailuo-2-3-768p",
		"ai-image-to-video-minimax-hailuo-2-3-768p-fast":  "/v1/ai/image-to-video/minimax-hailuo-2-3-768p-fast",
		"ai-image-to-video-minimax-live":                  "/v1/ai/image-to-video/minimax-live",
		"ai-image-to-video-pixverse-v5":                   "/v1/ai/image-to-video/pixverse-v5",
		"ai-image-to-video-pixverse-v5-5":                 "/v1/ai/image-to-video/pixverse-v5-5",
		"ai-image-to-video-pixverse-v5-transition":        "/v1/ai/image-to-video/pixverse-v5-transition",
		"ai-image-to-video-pixverse-v6":                   "/v1/ai/image-to-video/pixverse-v6",
		"ai-image-to-video-runway-4-5":                    "/v1/ai/image-to-video/runway-4-5",
		"ai-image-to-video-runway-gen4-turbo":             "/v1/ai/image-to-video/runway-gen4-turbo",
		"ai-image-to-video-seedance-lite-1080p":           "/v1/ai/image-to-video/seedance-lite-1080p",
		"ai-image-to-video-seedance-lite-480p":            "/v1/ai/image-to-video/seedance-lite-480p",
		"ai-image-to-video-seedance-lite-720p":            "/v1/ai/image-to-video/seedance-lite-720p",
		"ai-image-to-video-seedance-pro-1080p":            "/v1/ai/image-to-video/seedance-pro-1080p",
		"ai-image-to-video-seedance-pro-480p":             "/v1/ai/image-to-video/seedance-pro-480p",
		"ai-image-to-video-seedance-pro-720p":             "/v1/ai/image-to-video/seedance-pro-720p",
		"ai-image-to-video-veo-3-1":                       "/v1/ai/image-to-video/veo-3-1",
		"ai-image-to-video-veo-3-1-fast":                  "/v1/ai/image-to-video/veo-3-1-fast",
		"ai-image-to-video-wan-2-5-i2v-1080p":             "/v1/ai/image-to-video/wan-2-5-i2v-1080p",
		"ai-image-to-video-wan-2-5-i2v-480p":              "/v1/ai/image-to-video/wan-2-5-i2v-480p",
		"ai-image-to-video-wan-2-5-i2v-720p":              "/v1/ai/image-to-video/wan-2-5-i2v-720p",
		"ai-image-to-video-wan-2-7":                       "/v1/ai/image-to-video/wan-2-7",
		"ai-image-to-video-wan-v2-2-480p":                 "/v1/ai/image-to-video/wan-v2-2-480p",
		"ai-image-to-video-wan-v2-2-580p":                 "/v1/ai/image-to-video/wan-v2-2-580p",
		"ai-image-to-video-wan-v2-2-720p":                 "/v1/ai/image-to-video/wan-v2-2-720p",
		"ai-image-to-video-wan-v2-6-1080p":                "/v1/ai/image-to-video/wan-v2-6-1080p",
		"ai-image-to-video-wan-v2-6-720p":                 "/v1/ai/image-to-video/wan-v2-6-720p",
		"ai-image-upscaler":                               "/v1/ai/image-upscaler",
		"ai-image-upscaler-precision":                     "/v1/ai/image-upscaler-precision",
		"ai-image-upscaler-precision-v2":                  "/v1/ai/image-upscaler-precision-v2",
		"ai-improve-prompt":                               "/v1/ai/improve-prompt",
		"ai-lip-sync-latent-sync":                         "/v1/ai/lip-sync/latent-sync",
		"ai-lip-sync-veed-fabric-1-0":                     "/v1/ai/lip-sync/veed-fabric-1-0",
		"ai-lip-sync-veed-fabric-1-0-fast":                "/v1/ai/lip-sync/veed-fabric-1-0-fast",
		"ai-loras":                                        "/v1/ai/loras",
		"ai-me-apps":                                      "/v1/ai/me/apps",
		"ai-music-generation":                             "/v1/ai/music-generation",
		"ai-mystic":                                       "/v1/ai/mystic",
		"ai-reference-to-video-kling-v3-omni":             "/v1/ai/reference-to-video/kling-v3-omni",
		"ai-reference-to-video-veo-3-1":                   "/v1/ai/reference-to-video/veo-3-1",
		"ai-reference-to-video-wan-2-7":                   "/v1/ai/reference-to-video/wan-2-7",
		"ai-skin-enhancer":                                "/v1/ai/skin-enhancer",
		"ai-sound-effects":                                "/v1/ai/sound-effects",
		"ai-text-to-image-flux-2-klein":                   "/v1/ai/text-to-image/flux-2-klein",
		"ai-text-to-image-flux-2-pro":                     "/v1/ai/text-to-image/flux-2-pro",
		"ai-text-to-image-flux-2-turbo":                   "/v1/ai/text-to-image/flux-2-turbo",
		"ai-text-to-image-flux-dev":                       "/v1/ai/text-to-image/flux-dev",
		"ai-text-to-image-flux-kontext-pro":               "/v1/ai/text-to-image/flux-kontext-pro",
		"ai-text-to-image-flux-pro-v1-1":                  "/v1/ai/text-to-image/flux-pro-v1-1",
		"ai-text-to-image-hyperflux":                      "/v1/ai/text-to-image/hyperflux",
		"ai-text-to-image-imagen3":                        "/v1/ai/text-to-image/imagen3",
		"ai-text-to-image-imagen4-fast":                   "/v1/ai/text-to-image/imagen4-fast",
		"ai-text-to-image-imagen4-ultra":                  "/v1/ai/text-to-image/imagen4-ultra",
		"ai-text-to-image-nano-banana-pro":                "/v1/ai/text-to-image/nano-banana-pro",
		"ai-text-to-image-nano-banana-pro-flash":          "/v1/ai/text-to-image/nano-banana-pro-flash",
		"ai-text-to-image-runway":                         "/v1/ai/text-to-image/runway",
		"ai-text-to-image-seedream":                       "/v1/ai/text-to-image/seedream",
		"ai-text-to-image-seedream-v4":                    "/v1/ai/text-to-image/seedream-v4",
		"ai-text-to-image-seedream-v4-5":                  "/v1/ai/text-to-image/seedream-v4-5",
		"ai-text-to-image-seedream-v4-5-edit":             "/v1/ai/text-to-image/seedream-v4-5-edit",
		"ai-text-to-image-seedream-v4-edit":               "/v1/ai/text-to-image/seedream-v4-edit",
		"ai-text-to-image-seedream-v5-lite":               "/v1/ai/text-to-image/seedream-v5-lite",
		"ai-text-to-image-seedream-v5-lite-edit":          "/v1/ai/text-to-image/seedream-v5-lite-edit",
		"ai-text-to-image-z-image":                        "/v1/ai/text-to-image/z-image",
		"ai-text-to-video-ltx-2-fast":                     "/v1/ai/text-to-video/ltx-2-fast",
		"ai-text-to-video-ltx-2-pro":                      "/v1/ai/text-to-video/ltx-2-pro",
		"ai-text-to-video-runway-4-5":                     "/v1/ai/text-to-video/runway-4-5",
		"ai-text-to-video-veo-3-1":                        "/v1/ai/text-to-video/veo-3-1",
		"ai-text-to-video-veo-3-1-fast":                   "/v1/ai/text-to-video/veo-3-1-fast",
		"ai-text-to-video-wan-2-5-t2v-1080p":              "/v1/ai/text-to-video/wan-2-5-t2v-1080p",
		"ai-text-to-video-wan-2-5-t2v-480p":               "/v1/ai/text-to-video/wan-2-5-t2v-480p",
		"ai-text-to-video-wan-2-5-t2v-720p":               "/v1/ai/text-to-video/wan-2-5-t2v-720p",
		"ai-text-to-video-wan-2-7":                        "/v1/ai/text-to-video/wan-2-7",
		"ai-text-to-video-wan-v2-6-1080p":                 "/v1/ai/text-to-video/wan-v2-6-1080p",
		"ai-text-to-video-wan-v2-6-720p":                  "/v1/ai/text-to-video/wan-v2-6-720p",
		"ai-video-edit-wan-2-7":                           "/v1/ai/video-edit/wan-2-7",
		"ai-video-kling-4k-i2v":                           "/v1/ai/video/kling-4k-i2v",
		"ai-video-kling-4k-t2v":                           "/v1/ai/video/kling-4k-t2v",
		"ai-video-kling-advanced-custom-elements":         "/v1/ai/video/kling-advanced-custom-elements",
		"ai-video-kling-v3":                               "/v1/ai/video/kling-v3",
		"ai-video-kling-v3-motion-control-pro":            "/v1/ai/video/kling-v3-motion-control-pro",
		"ai-video-kling-v3-motion-control-std":            "/v1/ai/video/kling-v3-motion-control-std",
		"ai-video-kling-v3-omni":                          "/v1/ai/video/kling-v3-omni",
		"ai-video-omni-human-1-5":                         "/v1/ai/video/omni-human-1-5",
		"ai-video-runway-act-two":                         "/v1/ai/video/runway-act-two",
		"ai-video-seedance-1-5-pro-1080p":                 "/v1/ai/video/seedance-1-5-pro-1080p",
		"ai-video-seedance-1-5-pro-480p":                  "/v1/ai/video/seedance-1-5-pro-480p",
		"ai-video-seedance-1-5-pro-720p":                  "/v1/ai/video/seedance-1-5-pro-720p",
		"ai-video-upscaler":                               "/v1/ai/video-upscaler",
		"ai-video-upscaler-precision":                     "/v1/ai/video-upscaler-precision",
		"ai-video-vfx":                                    "/v1/ai/video/vfx",
		"ai-voiceover-elevenlabs-turbo-v2-5":              "/v1/ai/voiceover/elevenlabs-turbo-v2-5",
		"icons":                                           "/v1/icons",
		"music":                                           "/v1/music",
		"resources":                                       "/v1/resources",
		"sound-effects":                                   "/v1/sound-effects",
	}
