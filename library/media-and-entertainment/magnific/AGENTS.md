# Magnific Printed CLI Agent Guide

This directory is a generated `magnific-pp-cli` printed CLI. It was produced by [CLI Printing Press](https://github.com/mvanhorn/cli-printing-press), so treat systemic fixes as upstream Printing Press fixes first. Keep local edits narrow and document why a generated-tree patch belongs here.
...
magnific-pp-cli agent-context --pretty
```

Use runtime discovery instead of relying on a copied command list:

```bash
magnific-pp-cli which "<capability>" --json
magnific-pp-cli <command> --help
```
...
```bash
magnific-pp-cli <command> --help
magnific-pp-cli <command> --dry-run --agent
```
