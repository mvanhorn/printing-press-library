...
func postFeedback(url string, entry FeedbackEntry) error {
	...
	req.Header.Set("User-Agent", "youtube-creator-analytics-pp-cli/feedback")
...
func newFeedbackCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Long: `Feedback is captured locally first at ~/.youtube-creator-analytics-pp-cli/feedback.jsonl.
...
maintainer sees it.`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			entry := FeedbackEntry{
				Text:      text,
				CLI:       "youtube-creator-analytics-pp-cli",
				Version:   version,
...
func newFeedbackListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `  youtube-creator-analytics-pp-cli feedback list
  youtube-creator-analytics-pp-cli feedback list --limit 5
  youtube-creator-analytics-pp-cli feedback list --json`,
