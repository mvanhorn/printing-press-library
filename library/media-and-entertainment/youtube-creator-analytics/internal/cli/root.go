...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "youtube-creator-analytics-pp-cli",
...
Run 'youtube-creator-analytics-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("youtube-creator-analytics-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'youtube-creator-analytics-pp-cli profile list')")
	...
	// Novel features (Phase 1.5 transcendence — see SKILL.md "Unique Capabilities").
	rootCmd.AddCommand(newDecayCmd(flags))
	rootCmd.AddCommand(newRetentionLeaderboardCmd(flags))
	rootCmd.AddCommand(newSubVelocityCmd(flags))
	rootCmd.AddCommand(newCTRCohortCmd(flags))
	rootCmd.AddCommand(newPostingCadenceCmd(flags))
	rootCmd.AddCommand(newCompetitorDiffCmd(flags))
	rootCmd.AddCommand(newTranscriptCmd(flags))
	rootCmd.AddCommand(newCommentFAQCmd(flags))
	rootCmd.AddCommand(newThemeMineCmd(flags))
	rootCmd.AddCommand(newTopicClusterCmd(flags))
	rootCmd.AddCommand(newSyncPlanCmd(flags))
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("youtube-creator-analytics-pp-cli %s\n", version)
		},
	}
}
