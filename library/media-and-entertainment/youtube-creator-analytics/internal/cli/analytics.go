...
Data must be synced first with the sync command.`,
  ...
  youtube-creator-analytics-pp-cli analytics --type messages

  # Group by a field
  youtube-creator-analytics-pp-cli analytics --type messages --group-by author_id

  # Top 10 most frequent values
  youtube-creator-analytics-pp-cli analytics --type messages --group-by channel_id --limit 10 --json`,
