...
but do not stop the import.`,
  ...
  youtube-creator-analytics-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  youtube-creator-analytics-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | youtube-creator-analytics-pp-cli import <resource> --input -`,
