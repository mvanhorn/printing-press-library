...
Resource scoping:
  ...
  youtube-creator-analytics-pp-cli sync

  # Sync specific resources only
  youtube-creator-analytics-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  youtube-creator-analytics-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  youtube-creator-analytics-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  youtube-creator-analytics-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  youtube-creator-analytics-pp-cli sync --latest-only`,
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/youtube-creator-analytics-pp-cli/data.db)")
