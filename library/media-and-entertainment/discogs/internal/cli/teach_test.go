...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("DISCOGS_STATE_DIR", "")
	t.Setenv("DISCOGS_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"discogs-pp-cli auth login",
		"discogs-pp-cli doctor",
		"discogs-pp-cli help items",
		"discogs-pp-cli sync",
		"discogs-pp-cli profile list",
		"discogs-pp-cli feedback list",
		"discogs-pp-cli which",
		"discogs-pp-cli agent-context",
		"discogs-pp-cli completion bash",
		"discogs-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"discogs-pp-cli recall",
		"discogs-pp-cli learnings",
		"discogs-pp-cli teach-pattern",
		"discogs-pp-cli teach-lookup",
		"discogs-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("discogs-pp-cli")); err == nil {
