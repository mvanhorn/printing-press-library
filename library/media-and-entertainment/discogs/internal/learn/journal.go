...
const (
	journalSessionEnvVar   = "DISCOGS_LEARN_SESSION"
	journalNoLearnEnvVar   = "DISCOGS_NO_LEARN"
	journalNoCaptureEnvVar = "DISCOGS_LEARN_NO_CAPTURE"
)
...
func AppendJournalEntry(entry JournalEntry) error {
	...
	line, err := json.Marshal(entry) // #nosec G117 -- JSON key naming is intentional and internal
	if err != nil {
	...
	if _, err := f.Write(append(line, '\n')); err != nil {
		f.Close() // #nosec G104 -- best-effort journal write; error intentionally ignored
