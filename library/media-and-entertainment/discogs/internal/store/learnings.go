...
func (s *Store) ForgetLearnings(ctx context.Context, f ForgetLearningsFilter) (int64, error) {
	...
	q := "DELETE FROM search_learnings WHERE " + strings.Join(clauses, " AND ") // #nosec G202 -- clauses are built from a fixed internal allowlist, not user input; values are parameterized
