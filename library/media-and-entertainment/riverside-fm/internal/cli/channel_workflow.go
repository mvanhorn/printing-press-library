...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  riverside-fm-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  riverside-fm-pp-cli workflow archive --full`,
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  riverside-fm-pp-cli workflow status

  # Show status as JSON
  riverside-fm-pp-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("riverside-fm-pp-cli")
			}
