...
but do not stop the import.`,
  ...
  riverside-fm-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  riverside-fm-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | riverside-fm-pp-cli import <resource> --input -`,
