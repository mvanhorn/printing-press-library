...
large datasets as it has no memory pressure.`,
  ...
  atom-tickets-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  atom-tickets-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  atom-tickets-pp-cli export <resource> --format jsonl | jq '.id'`,
