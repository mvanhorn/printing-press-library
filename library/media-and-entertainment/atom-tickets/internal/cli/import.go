...
but do not stop the import.`,
  ...
  atom-tickets-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  atom-tickets-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | atom-tickets-pp-cli import <resource> --input -`,
