...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"atom-tickets-pp-cli auth login",
		"atom-tickets-pp-cli doctor",
		"atom-tickets-pp-cli help items",
		"atom-tickets-pp-cli sync",
		"atom-tickets-pp-cli profile list",
		"atom-tickets-pp-cli feedback list",
		"atom-tickets-pp-cli which",
		"atom-tickets-pp-cli agent-context",
		"atom-tickets-pp-cli completion bash",
		"atom-tickets-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"atom-tickets-pp-cli recall",
		"atom-tickets-pp-cli learnings",
		"atom-tickets-pp-cli teach-pattern",
		"atom-tickets-pp-cli teach-lookup",
		"atom-tickets-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("atom-tickets-pp-cli")); err == nil {
