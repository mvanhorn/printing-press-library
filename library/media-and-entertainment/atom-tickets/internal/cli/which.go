...
var whichIndex = []whichEntry{
	{Command: "movie-plan", Description: "Rank bookable nearby showtimes by distance, start time, price, format, rating, and runtime.", Group: "Plan a movie night", WhyItMatters: "Use it when an agent must turn raw Atom inventory into a balanced shortlist."},
	{Command: "deal-finder", Description: "Find the lowest advertised ticket offers across nearby supported venues.", Group: "Compare bookable options", WhyItMatters: "Use it when lowest advertised price is the primary decision."},
	{Command: "accessible-showtimes", Description: "Return only bookable nearby showtimes matching required accessibility or seating attributes.", Group: "Compare bookable options", WhyItMatters: "Use it when an accommodation such as captions or descriptive video is mandatory."},
	{Command: "family-fit", Description: "Rank showtimes satisfying advisory-rating, runtime, ending-time, distance, and budget constraints.", Group: "Plan a movie night", WhyItMatters: "Use it for family suitability and schedule constraints rather than an unconstrained recommendation."},
	{Command: "preorder-radar", Description: "Surface upcoming preorder days across nearby venues with production and venue names resolved.", Group: "Opening-weekend discovery", WhyItMatters: "Use it to discover opening-weekend inventory without repeatedly checking theater pages."},
	{Command: "last-call", Description: "Find soon-starting showtimes that still report inventory and provide direct checkout URLs.", Group: "Opening-weekend discovery", WhyItMatters: "Use it when plans form at the last minute and the user needs immediately bookable choices."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  atom-tickets-pp-cli which "stale tickets"
  atom-tickets-pp-cli which "bottleneck"
  atom-tickets-pp-cli which --limit 1 "send message"
  atom-tickets-pp-cli which                                # list the full capability index`,
