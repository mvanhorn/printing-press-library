...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/media-and-entertainment/atom-tickets/internal/learn/lookups"
...
Resource scoping:
  ...
  atom-tickets-pp-cli sync

  # Sync specific resources only
  atom-tickets-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  atom-tickets-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  atom-tickets-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  atom-tickets-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  atom-tickets-pp-cli sync --latest-only`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if dbPath == "" {
				dbPath = defaultDBPath("atom-tickets-pp-cli")
			}
...
func determinePaginationDefaults(resource string) paginationDefaults {
	switch resource {
	case "partner-v1-venue-details-by-location":
...
func knownSyncResourceNames() []string {
	names := []string{
		"partner",
		"partner-v1-production-search-by-name",
		"partner-v1-venue-details-by-location",
	}
	return names
}
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{ // #nosec G101 -- endpoint paths, not credentials.
		"partner":                              "/partner/ping",
		"partner-v1-production-search-by-name": "/partner/v1/production/search/byName",
		"partner-v1-venue-details-by-location": "/partner/v1/venue/details/byLocation",
	}
...
var resourceIDFieldOverrides = map[string]string{
	"partner-v1-production-search-by-name": "id",
	"partner-v1-venue-details-by-location": "id",
}
...
func responsePathForResource(resource, path string) []string {
	...
	case "partner\x00/partner/v1/productions/byVendorProductionId/{vendorProductionId}":
		return []string{"productions"}
	case "partner\x00/partner/v1/production/details/byIds":
		return []string{"productions"}
	case "partner\x00/partner/v1/production/ids/byVenue/{venueId}":
		return []string{"productionIds"}
	case "partner\x00/partner/v1/showtime/details/forVenues":
		return []string{"productions"}
	case "partner\x00/partner/v1/venues/byVendorVenueId/{vendorVenueId}":
		return []string{"venues"}
	case "partner\x00/partner/v1/venue/details/byIds":
		return []string{"venues"}
	case "partner\x00/partner/v1/venue/details/byLocation":
		return []string{"venues"}
	case "partner\x00/partner/v1/production/search/byName":
		return []string{"productions"}
	case "partner\x00/partner/v1/venue/details/search":
		return []string{"venues"}
	}
	return nil
}
