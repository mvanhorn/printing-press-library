...
func TestDeclaredAPISurfaceReachable(t *testing.T) {
	expected := []string{
		"partner",
		"partner get-production-by-vendor-id",
		"partner get-production-details-by-ids",
		"partner get-production-ids-by-venue",
		"partner get-showtime-by-vendor-showtime-id",
		"partner get-showtime-by-vendor-venue-and-showtime-ids",
		"partner get-showtimes-by-ids",
		"partner get-showtimes-by-venue",
		"partner get-showtimes-for-venues",
		"partner get-venue-by-vendor-id",
		"partner get-venue-details-by-ids",
		"partner get-venue-details-by-location",
		"partner ping",
		"partner search-productions-by-name",
		"partner search-venues-by-name",
	}
