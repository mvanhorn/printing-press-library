...
func Load(configPath string) (*Config, error) {
	...
	if v := os.Getenv("CRATE_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	...
	if v := strings.TrimSpace(os.Getenv("CRATE_ARTIST_ID")); v != "" {
		cfg.TemplateVars["artist_id"] = v
	} else if verifyMode {
		cfg.TemplateVars["artist_id"] = "artist_id_placeholder"
	}
	if v := strings.TrimSpace(os.Getenv("CRATE_FOLDER_ID")); v != "" {
		cfg.TemplateVars["folder_id"] = v
	} else if verifyMode {
		cfg.TemplateVars["folder_id"] = "folder_id_placeholder"
	}
	if v := strings.TrimSpace(os.Getenv("CRATE_LABEL_ID")); v != "" {
		cfg.TemplateVars["label_id"] = v
	} else if verifyMode {
		cfg.TemplateVars["label_id"] = "label_id_placeholder"
	}
	if v := strings.TrimSpace(os.Getenv("CRATE_MASTER_ID")); v != "" {
		cfg.TemplateVars["master_id"] = v
	} else if verifyMode {
		cfg.TemplateVars["master_id"] = "master_id_placeholder"
	}
	if v := strings.TrimSpace(os.Getenv("CRATE_USERNAME")); v != "" {
		cfg.TemplateVars["username"] = v
	} else if verifyMode {
		cfg.TemplateVars["username"] = "username_placeholder"
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("CRATE_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "crate-pp-cli", "config.toml"), nil
}
