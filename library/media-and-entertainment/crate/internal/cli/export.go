...
large datasets as it has no memory pressure.`,
  ...
  crate-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  crate-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  crate-pp-cli export <resource> --format jsonl | jq '.id'`,
