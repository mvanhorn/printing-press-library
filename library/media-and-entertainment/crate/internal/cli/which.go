...
var whichIndex = []whichEntry{
	{Command: "spin", Description: "Chooses a record off your own shelf to play tonight, with filters for genre, decade, or label, and says why it picked that one.", Group: "Local state that compounds", WhyItMatters: "Reach for this when someone wants something to listen to from records they already own, rather than a recommendation to buy."},
	{Command: "dig", Description: "Given a label, genre, style, or year, lists records matching it that you do NOT already own.", Group: "Local state that compounds", WhyItMatters: "Reach for this before someone goes record shopping, or when they ask what to look for from a label or genre."},
	{Command: "floor", Description: "Totals the lowest current asking price across your collection, stated explicitly as a floor rather than an appraisal.", Group: "Honest pricing", WhyItMatters: "Reach for this when someone asks what their records are worth, but report it as a floor on asking prices, never as a valuation."},
	{Command: "deals", Description: "Cross-references your wantlist against current marketplace listings to show which wanted records are cheap and available right now.", Group: "Honest pricing", WhyItMatters: "Reach for this when someone asks what to buy now, or wants their wantlist prioritised by price and availability."},
	{Command: "shelf", Description: "Breaks your collection down by decade, genre, style, label, and format to show what you actually collect.", Group: "Local state that compounds", WhyItMatters: "Reach for this for questions about collecting patterns, blind spots, or how a collection has changed over time."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  crate-pp-cli which "stale tickets"
  crate-pp-cli which "bottleneck"
  crate-pp-cli which --limit 1 "send message"
  crate-pp-cli which                                # list the full capability index`,
