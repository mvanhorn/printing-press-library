...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"crate-pp-cli auth login",
		"crate-pp-cli doctor",
		"crate-pp-cli help items",
		"crate-pp-cli sync",
		"crate-pp-cli profile list",
		"crate-pp-cli feedback list",
		"crate-pp-cli which",
		"crate-pp-cli agent-context",
		"crate-pp-cli completion bash",
		"crate-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"crate-pp-cli teach",
		"crate-pp-cli recall",
		"crate-pp-cli learnings",
		"crate-pp-cli teach-pattern",
		"crate-pp-cli teach-lookup",
		"crate-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("crate-pp-cli")); err == nil {
