...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  scryfall-pp-cli which "stale tickets"
  scryfall-pp-cli which "bottleneck"
  scryfall-pp-cli which --limit 1 "send message"
  scryfall-pp-cli which                                # list the full capability index`,
