...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("SCRYFALL_STATE_DIR", "")
	t.Setenv("SCRYFALL_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"scryfall-pp-cli auth login",
		"scryfall-pp-cli doctor",
		"scryfall-pp-cli help items",
		"scryfall-pp-cli sync",
		"scryfall-pp-cli profile list",
		"scryfall-pp-cli feedback list",
		"scryfall-pp-cli which",
		"scryfall-pp-cli agent-context",
		"scryfall-pp-cli completion bash",
		"scryfall-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"scryfall-pp-cli recall",
		"scryfall-pp-cli learnings",
		"scryfall-pp-cli teach-pattern",
		"scryfall-pp-cli teach-lookup",
		"scryfall-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("scryfall-pp-cli")); err == nil {
