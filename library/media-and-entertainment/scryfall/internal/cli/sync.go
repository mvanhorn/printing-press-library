...
Resource scoping:
  ...
  scryfall-pp-cli sync

  # Sync specific resources only
  scryfall-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  scryfall-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  scryfall-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  scryfall-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  scryfall-pp-cli sync --latest-only`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if dbPath == "" {
				dbPath = defaultDBPath("scryfall-pp-cli")
			}
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{ // #nosec G101 -- endpoint paths, not credentials.
		...
		"catalog":                    "/catalog/powers",
		"catalog-artifact-types":     "/catalog/artifact-types",
		"catalog-card-names":         "/catalog/card-names",
		"catalog-creature-types":     "/catalog/creature-types",
		"catalog-enchantment-types":  "/catalog/enchantment-types",
		"catalog-land-types":         "/catalog/land-types",
		"catalog-loyalties":          "/catalog/loyalties",
		"catalog-planeswalker-types": "/catalog/planeswalker-types",
		"catalog-spell-types":        "/catalog/spell-types",
		"catalog-toughnesses":        "/catalog/toughnesses",
		"catalog-watermarks":         "/catalog/watermarks",
		"catalog-word-bank":          "/catalog/word-bank",
		"sets":                       "/sets",
		"symbology":                  "/symbology",
	}
...
var itemHydrationPaths = map[string]itemHydrationConfig{
	"cards-autocomplete":         {path: "/cards/{id}", idParam: "id"},
	"catalog":                    {path: "/sets/{id}", idParam: "id"},
	"catalog-artifact-types":     {path: "/sets/{id}", idParam: "id"},
	"catalog-card-names":         {path: "/sets/{id}", idParam: "id"},
	"catalog-creature-types":     {path: "/sets/{id}", idParam: "id"},
	"catalog-enchantment-types":  {path: "/sets/{id}", idParam: "id"},
	"catalog-land-types":         {path: "/sets/{id}", idParam: "id"},
	"catalog-loyalties":          {path: "/sets/{id}", idParam: "id"},
	"catalog-planeswalker-types": {path: "/sets/{id}", idParam: "id"},
	"catalog-spell-types":        {path: "/sets/{id}", idParam: "id"},
	"catalog-toughnesses":        {path: "/sets/{id}", idParam: "id"},
	"catalog-watermarks":         {path: "/sets/{id}", idParam: "id"},
	"catalog-word-bank":          {path: "/sets/{id}", idParam: "id"},
}
...
func responsePathForResource(resource, path string) []string {
	...
	case "bulk-data\x00/bulk-data":
		return []string{"data"}
	case "cards\x00/cards/autocomplete":
		return []string{"data"}
	case "cards\x00/cards":
		return []string{"data"}
	case "cards\x00/cards/collection":
		return []string{"data"}
	case "cards\x00/cards/mtgo/{id}/rulings":
		return []string{"data"}
	case "cards\x00/cards/multiverse/{id}/rulings":
		return []string{"data"}
	case "cards\x00/cards/search":
		return []string{"data"}
	case "catalog\x00/catalog/artifact-types":
		return []string{"data"}
	case "catalog\x00/catalog/card-names":
		return []string{"data"}
	case "catalog\x00/catalog/creature-types":
		return []string{"data"}
	case "catalog\x00/catalog/enchantment-types":
		return []string{"data"}
	case "catalog\x00/catalog/land-types":
		return []string{"data"}
	case "catalog\x00/catalog/loyalties":
		return []string{"data"}
	case "catalog\x00/catalog/planeswalker-types":
		return []string{"data"}
	case "catalog\x00/catalog/powers":
		return []string{"data"}
	case "catalog\x00/catalog/spell-types":
		return []string{"data"}
	case "catalog\x00/catalog/toughnesses":
		return []string{"data"}
	case "catalog\x00/catalog/watermarks":
		return []string{"data"}
	case "catalog\x00/catalog/word-bank":
		return []string{"data"}
	case "sets\x00/sets":
		return []string{"data"}
	case "symbology\x00/symbology":
		return []string{"data"}
	}
	return nil
}
