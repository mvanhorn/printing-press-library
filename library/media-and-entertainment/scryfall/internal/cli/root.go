...
type rootFlags struct {
	...
	// invocation. Mirrors the SCRYFALL_NO_LEARN env var.
	noLearn bool
...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "scryfall-pp-cli",
		Short: "Manage scryfall resources via the scryfall API",
		Long: `Manage scryfall resources via the scryfall API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'scryfall-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("scryfall-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'scryfall-pp-cli profile list')")
	...
	rootCmd.AddCommand(newSymbologyCmd(flags))
	...
	rootCmd.AddCommand(newBulkDataPromotedCmd(flags))
