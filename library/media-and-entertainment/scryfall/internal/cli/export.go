...
large datasets as it has no memory pressure.`,
  ...
  scryfall-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  scryfall-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  scryfall-pp-cli export <resource> --format jsonl | jq '.id'`,
