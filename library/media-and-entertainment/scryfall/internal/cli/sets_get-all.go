...
func newSetsGetAllCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-all",
		Aliases:     []string{"list"},
		Short:       "Returns a List object of all Sets on Scryfall",
		Example:     "  scryfall-pp-cli sets get-all",
		Annotations: map[string]string{"pp:endpoint": "sets.get-all", "pp:method": "GET", "pp:path": "/sets", "mcp:read-only": "true"},
