...
but do not stop the import.`,
  ...
  scryfall-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  scryfall-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | scryfall-pp-cli import <resource> --input -`,
