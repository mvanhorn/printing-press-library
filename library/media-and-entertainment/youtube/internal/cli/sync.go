...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/media-and-entertainment/youtube/internal/learn/lookups"
...
Once synced, use the 'search' command for instant full-text…`,
		Example: `  # Sync all resources
  youtube-pp-cli sync
  # Sync specific resources only
  youtube-pp-cli sync --resources youtube,youtube-v3-captions
  ...
  youtube-pp-cli sync --latest-only`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if len(resources) == 0 {
				if humanFriendly {
					fmt.Fprintln(os.Stderr, "youtube-pp-cli sync: no default sync resources in spec; use --resources for explicit sync targets or populate the store via single-fetch commands.")
				} else {
...
func determinePaginationDefaults(resource string) paginationDefaults {
	...
	case "youtube-v3-comment-threads":
		return paginationDefaults{
			cursorParam:    "pageToken",
			cursorType:     "page_token",
			nextCursorPath: "nextPageToken",
	...
	case "youtube-v3-playlist-items":
		return paginationDefaults{
			cursorParam:    "pageToken",
			cursorType:     "page_token",
			nextCursorPath: "nextPageToken",
...
func knownSyncResourceNames() []string {
	names := []string{
		"youtube",
		"youtube-v3-captions",
		"youtube-v3-channel-sections",
		"youtube-v3-channels",
		"youtube-v3-comment-threads",
		"youtube-v3-i18n-languages",
		"youtube-v3-i18n-regions",
		"youtube-v3-playlist-items",
		"youtube-v3-playlists",
		"youtube-v3-video-categories",
		"youtube-v3-videos",
	}
	return names
}
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{ // #nosec G101 -- endpoint paths, not credentials.
		...
		"youtube-v3-captions":         "/youtube/v3/captions",
		"youtube-v3-channel-sections": "/youtube/v3/channelSections",
		"youtube-v3-channels":         "/youtube/v3/channels",
		"youtube-v3-comment-threads":  "/youtube/v3/commentThreads",
		"youtube-v3-i18n-languages":   "/youtube/v3/i18nLanguages",
		"youtube-v3-i18n-regions":     "/youtube/v3/i18nRegions",
		"youtube-v3-playlist-items":   "/youtube/v3/playlistItems",
		"youtube-v3-playlists":        "/youtube/v3/playlists",
		"youtube-v3-video-categories": "/youtube/v3/videoCategories",
...
var flatReconcileModes = map[string]string{
	"youtube":                     "flat_global",
	"youtube-v3-captions":         "flat_global",
	"youtube-v3-channel-sections": "flat_global",
	"youtube-v3-channels":         "flat_global",
	"youtube-v3-comment-threads":  "flat_global",
	"youtube-v3-i18n-languages":   "flat_global",
	"youtube-v3-i18n-regions":     "flat_global",
	"youtube-v3-playlist-items":   "flat_global",
	"youtube-v3-playlists":        "flat_global",
	"youtube-v3-video-categories": "flat_global",
	"youtube-v3-videos":           "flat_global",
}
...
func responsePathForResource(resource, path string) []string {
	...
	case "youtube\x00/youtube/v3/activities":
		return []string{"items"}
	case "youtube\x00/youtube/v3/captions":
		return []string{"items"}
	case "youtube\x00/youtube/v3/channelSections":
		return []string{"items"}
	case "youtube\x00/youtube/v3/channels":
		return []string{"items"}
	case "youtube\x00/youtube/v3/commentThreads":
		return []string{"items"}
	case "youtube\x00/youtube/v3/i18nLanguages":
		return []string{"items"}
	case "youtube\x00/youtube/v3/i18nRegions":
		return []string{"items"}
	case "youtube\x00/youtube/v3/playlistItems":
		return []string{"items"}
	case "youtube\x00/youtube/v3/playlists":
		return []string{"items"}
	case "youtube\x00/youtube/v3/search":
		return []string{"items"}
	case "youtube\x00/youtube/v3/videoCategories":
		return []string{"items"}
	case "youtube\x00/youtube/v3/videos":
		return []string{"items"}
	}
	return nil
}
