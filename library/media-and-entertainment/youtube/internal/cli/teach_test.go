...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		...
		"youtube-pp-cli help items",
		"youtube-pp-cli sync",
		"youtube-pp-cli profile list",
		"youtube-pp-cli feedback list",
		"youtube-pp-cli which",
		"youtube-pp-cli agent-context",
		"youtube-pp-cli completion bash",
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"youtube-pp-cli recall",
		"youtube-pp-cli learnings",
		"youtube-pp-cli teach-pattern",
		"youtube-pp-cli teach-lookup",
		"youtube-pp-cli items list",
	}
