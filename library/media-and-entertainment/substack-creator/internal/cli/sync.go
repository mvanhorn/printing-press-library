...
Exit codes & warnings:
  ...
  substack-creator-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  substack-creator-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  substack-creator-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  substack-creator-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  substack-creator-pp-cli sync --latest-only`,
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		...
		"drafts":             "/post_management/drafts",
		"feed":               "/feed",
		"me":                 "/me/follows",
		"me-recommendations": "/me/recommendations",
		"me-subscriptions":   "/me/subscriptions",
		"notes":              "/notes",
		"posts":              "/posts",
		"subscribers":        "/free_subscribers/export",
		"subscribers-export": "/paid_subscribers/export",
	}
