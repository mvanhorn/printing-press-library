...
func newPostsGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  substack-creator-pp-cli posts get example-value",
		Annotations: map[string]string{"pp:endpoint": "posts.get", "pp:method": "GET", "pp:path": "/posts/{slug}", "mcp:read-only": "true"},
