...
func newProfilesMeCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "me",
		Short:       "Get your own profile and publications.",
		Example:     "  substack-creator-pp-cli profiles me",
		Annotations: map[string]string{"pp:endpoint": "profiles.me", "pp:method": "GET", "pp:path": "/profile", "mcp:read-only": "true"},
