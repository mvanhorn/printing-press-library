...
large datasets as it has no memory pressure.`,
  ...
  substack-creator-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  substack-creator-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  substack-creator-pp-cli export <resource> --format jsonl | jq '.id'`,
