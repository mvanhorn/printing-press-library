...
but do not stop the import.`,
  ...
  substack-creator-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  substack-creator-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | substack-creator-pp-cli import <resource> --input -`,
