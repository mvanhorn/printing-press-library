...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  substack-creator-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  substack-creator-pp-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"categories", "drafts", "feed", "me", "me-recommendations", "me-subscriptions", "notes", "posts", "subscribers", "subscribers-export"}
			totalSynced := 0
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  substack-creator-pp-cli workflow status

  # Show status as JSON
  substack-creator-pp-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("substack-creator-pp-cli")
			}
