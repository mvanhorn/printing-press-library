...
Exit codes & warnings:
  ...
  cricapi-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  cricapi-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  cricapi-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  cricapi-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  cricapi-pp-cli sync --latest-only`,
