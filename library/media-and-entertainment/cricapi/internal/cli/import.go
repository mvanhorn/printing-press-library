...
but do not stop the import.`,
  ...
  cricapi-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  cricapi-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | cricapi-pp-cli import <resource> --input -`,
