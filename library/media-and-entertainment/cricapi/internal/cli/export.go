...
large datasets as it has no memory pressure.`,
  ...
  cricapi-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  cricapi-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  cricapi-pp-cli export <resource> --format jsonl | jq '.id'`,
