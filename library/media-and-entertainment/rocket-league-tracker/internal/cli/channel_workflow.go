...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  rocket-league-tracker-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  rocket-league-tracker-pp-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"announcements", "shop", "tournaments",  }
			totalSynced := 0
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  rocket-league-tracker-pp-cli workflow status

  # Show status as JSON
  rocket-league-tracker-pp-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("rocket-league-tracker-pp-cli")
			}
