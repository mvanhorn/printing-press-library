...
but do not stop the import.`,
  ...
  rocket-league-tracker-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  rocket-league-tracker-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | rocket-league-tracker-pp-cli import <resource> --input -`,
