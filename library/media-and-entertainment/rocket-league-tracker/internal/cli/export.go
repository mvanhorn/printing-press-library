...
large datasets as it has no memory pressure.`,
  ...
  rocket-league-tracker-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  rocket-league-tracker-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  rocket-league-tracker-pp-cli export <resource> --format jsonl | jq '.id'`,
