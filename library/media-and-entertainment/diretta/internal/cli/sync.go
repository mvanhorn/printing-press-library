...
Exit codes & warnings:
  ...
  diretta-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  diretta-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  diretta-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  diretta-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  diretta-pp-cli sync --latest-only`,
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/diretta-pp-cli/data.db)")
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"matches_today":     "/x/feed/f_1_0_3_it_1",
		"matches_yesterday": "/x/feed/f_1_-1_3_it_1",
		"matches_tomorrow":  "/x/feed/f_1_1_3_it_1",
		"sports":            "/x/feed/f_2_0_3_it_1",
	}
