...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "diretta-pp-cli",
		Short: `Risultati sportivi live, classifiche e statistiche da Diretta.it — zero setup, dati offline, MCP pronto.`,
		Long: `Risultati sportivi live, classifiche e statistiche da Diretta.it — zero setup, dati offline, MCP pronto.
...
Health check: run 'diretta-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("diretta-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'diretta-pp-cli profile list')")
	...
	rootCmd.AddCommand(newOddsPromotedCmd(flags))
	rootCmd.AddCommand(newSportsPromotedCmd(flags))
	rootCmd.AddCommand(newStandingsPromotedCmd(flags))
	rootCmd.AddCommand(newVersionCliCmd())
	// Novel commands
	rootCmd.AddCommand(newInsightsCmd(flags))
	rootCmd.AddCommand(newFormCmd(flags))
	rootCmd.AddCommand(newH2HCmd(flags))
	rootCmd.AddCommand(newExportCmd(flags))
	rootCmd.AddCommand(newPregameCmd(flags))
	rootCmd.AddCommand(newStandingsTrendCmd(flags))
	rootCmd.AddCommand(newSyncStatusCmd(flags))
	rootCmd.AddCommand(newTeamCompetitionsCmd(flags))
