...
but do not stop the import.`,
  ...
  diretta-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  diretta-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | diretta-pp-cli import <resource> --input -`,
