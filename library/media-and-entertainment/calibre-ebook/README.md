...
```bash
npx -y @mvanhorn/printing-press install calibre-ebook
```
...
```bash
npx -y @mvanhorn/printing-press install calibre-ebook --skill-only
```

To constrain the skill install to one or more specific agents (repeatable — agent names match the [`skills`](https://github.com/vercel-labs/skills) CLI):

```bash
npx -y @mvanhorn/printing-press install calibre-ebook --agent claude-code
npx -y @mvanhorn/printing-press install calibre-ebook --agent claude-code --agent codex
```
