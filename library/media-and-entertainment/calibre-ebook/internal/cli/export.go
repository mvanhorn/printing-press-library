...
large datasets as it has no memory pressure.`,
  ...
  calibre-ebook-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  calibre-ebook-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  calibre-ebook-pp-cli export <resource> --format jsonl | jq '.id'`,
