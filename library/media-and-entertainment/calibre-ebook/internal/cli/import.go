...
but do not stop the import.`,
  ...
  calibre-ebook-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  calibre-ebook-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | calibre-ebook-pp-cli import <resource> --input -`,
