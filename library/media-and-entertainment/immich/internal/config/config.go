...
type Config struct {
	...
	ImmichApiKey     string          `toml:"api_key"`
}
...
func Load(configPath string) (*Config, error) {
	...
	if v := os.Getenv("IMMICH_API_KEY"); v != "" {
		cfg.ImmichApiKey = v
		cfg.markEnvOverride("ImmichApiKey")
		cfg.AuthSource = "env:IMMICH_API_KEY"
		cfg.CredentialSource = "env:IMMICH_API_KEY"
	}
	...
	if v := os.Getenv("IMMICH_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	if v := os.Getenv("IMMICH_BASE_PATH"); v != "" {
		cfg.BasePath = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("IMMICH_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "immich-pp-cli", "config.toml"), nil
}
...
func (c *Config) applyCredentials(creds *cliutil.Credentials) {
	...
	c.ImmichApiKey = creds.ImmichApiKey
}
...
func (c *Config) SaveCredential(token string) error {
	...
	c.updateFileConfigField("AccessToken")
	c.ImmichApiKey = token
	delete(c.envOverrides, "ImmichApiKey")
	c.updateFileConfigField("ImmichApiKey")
	if err := c.saveCredentialsFirst(); err != nil {
		return err
	}
	return c.save()
...
func (c *Config) configForSave() Config {
	out := *c
	if c.fileConfig != nil {
		if c.envOverrides["ImmichApiKey"] {
			out.ImmichApiKey = c.fileConfig.ImmichApiKey
		}
	}
...
func (c *Config) updateFileConfigField(field string) {
	...
	case "ImmichApiKey":
		c.fileConfig.ImmichApiKey = c.ImmichApiKey
	}
}
