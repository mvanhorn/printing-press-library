...
var whichIndex = []whichEntry{
	{Command: "album event", Description: "Create or update a reviewable shared event album from explicit Immich search filters.", Group: "Shared events", WhyItMatters: "Use it when an agent needs to make a shareable event collection without manually copying asset IDs."},
	{Command: "duplicates plan", Description: "Preview native duplicate groups and a deterministic keeper proposal without changing assets.", Group: "Safe cleanup", WhyItMatters: "Use it before any destructive duplicate cleanup."},
	{Command: "duplicates apply", Description: "Resolve selected native duplicate groups only after an explicit apply confirmation.", Group: "Safe cleanup", WhyItMatters: "Use it only after reviewing a duplicate plan."},
	{Command: "people july", Description: "Find one or two people across past Julys using real people and metadata search endpoints.", Group: "Family archive", WhyItMatters: "Use it for questions such as photos of me and Dad from past Julys."},
	{Command: "memories review", Description: "List recent native memories with their dates and asset counts for an intentional review.", Group: "Family archive", WhyItMatters: "Use it to revisit what Immich surfaced without paging through the web UI."},
	{Command: "library review", Description: "Review bounded favorite and archived asset search results without mutating the library.", Group: "Library curation", WhyItMatters: "Use it to curate favorites and archived material deliberately."},
	{Command: "stacks review", Description: "Inspect native stacks for empty, singleton, and unusually large groups without changing them.", Group: "Library curation", WhyItMatters: "Use it to understand burst and RAW/JPEG grouping before editing a stack."},
	{Command: "library health", Description: "Report partner-sharing and worker-queue facts from the configured Immich server.", Group: "Self-hosted maintenance", WhyItMatters: "Use it when a self-hosted photo library feels stale or a shared library is not behaving as expected."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  immich-pp-cli which "stale tickets"
  immich-pp-cli which "bottleneck"
  immich-pp-cli which --limit 1 "send message"
  immich-pp-cli which                                # list the full capability index`,
