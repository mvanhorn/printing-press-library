...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("IMMICH_STATE_DIR", "")
	t.Setenv("IMMICH_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"immich-pp-cli auth login",
		"immich-pp-cli doctor",
		"immich-pp-cli help items",
		"immich-pp-cli sync",
		"immich-pp-cli profile list",
		"immich-pp-cli feedback list",
		"immich-pp-cli which",
		"immich-pp-cli agent-context",
		"immich-pp-cli completion bash",
		"immich-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"immich-pp-cli teach",
		"immich-pp-cli recall",
		"immich-pp-cli learnings",
		"immich-pp-cli teach-pattern",
		"immich-pp-cli teach-lookup",
		"immich-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("immich-pp-cli")); err == nil {
