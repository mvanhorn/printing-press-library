...
type rootFlags struct {
	...
	// invocation. Mirrors the IMMICH_NO_LEARN env var.
	noLearn bool
...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "immich-pp-cli",
		Short: `Immich CLI — Agent-native control and careful personal-library rituals for a self-hosted Immich instance.`,
		Long: `Immich CLI — Agent-native control and careful personal-library rituals for a self-hosted Immich instance.
...
Run 'immich-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("immich-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'immich-pp-cli profile list')")
	...
	rootCmd.AddCommand(newFacesCmd(flags))
	rootCmd.AddCommand(newImmichAuthCmd(flags))
	rootCmd.AddCommand(newImmichJobsCmd(flags))
	rootCmd.AddCommand(newImmichSearchCmd(flags))
	rootCmd.AddCommand(newImmichSyncCmd(flags))
	rootCmd.AddCommand(newLibrariesCmd(flags))
	rootCmd.AddCommand(newMapCmd(flags))
	...
	rootCmd.AddCommand(newSharedLinksCmd(flags))
	rootCmd.AddCommand(newStacksCmd(flags))
	rootCmd.AddCommand(newSystemConfigCmd(flags))
	rootCmd.AddCommand(newSystemMetadataCmd(flags))
	rootCmd.AddCommand(newTagsCmd(flags))
	rootCmd.AddCommand(newTimelineCmd(flags))
	rootCmd.AddCommand(newTrashCmd(flags))
