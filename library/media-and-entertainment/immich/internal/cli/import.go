...
but do not stop the import.`,
  ...
  immich-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  immich-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | immich-pp-cli import <resource> --input -`,
