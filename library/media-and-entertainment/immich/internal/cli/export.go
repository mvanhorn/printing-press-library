...
large datasets as it has no memory pressure.`,
  ...
  immich-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  immich-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  immich-pp-cli export <resource> --format jsonl | jq '.id'`,
