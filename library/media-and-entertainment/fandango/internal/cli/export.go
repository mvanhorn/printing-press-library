...
large datasets as it has no memory pressure.`,
  ...
  fandango-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  fandango-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  fandango-pp-cli export <resource> --format jsonl | jq '.id'`,
