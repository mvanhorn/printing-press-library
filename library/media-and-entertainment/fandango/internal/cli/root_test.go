...
func TestDeclaredAPISurfaceReachable(t *testing.T) {
	expected := []string{
		"fandango",
		"fandango get-geo-location-city-geo-location-by-city-get",
		"fandango get-geo-location-postal-code-geo-location-by-postal-code-get",
		"fandango get-movie-by-id-movie-by-id-get",
		"fandango get-movie-display-dates-moviedisplay-dates-get",
		"fandango get-movie-showtime-groupings-movieshowtime-groupings-get",
		"fandango get-movies-movies-get",
		"fandango get-showtime-by-id-showtime-by-id-get",
		"fandango get-showtimes-showtimes-get",
		"fandango get-theater-display-dates-theaterdisplay-dates-get",
		"fandango get-theater-showtime-groupings-theatershowtime-groupings-get",
		"fandango get-theater-theater-by-id-get",
		"fandango get-theaters-theaters-get",
	}
