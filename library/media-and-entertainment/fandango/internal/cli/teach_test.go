...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"fandango-pp-cli auth login",
		"fandango-pp-cli doctor",
		"fandango-pp-cli help items",
		"fandango-pp-cli sync",
		"fandango-pp-cli profile list",
		"fandango-pp-cli feedback list",
		"fandango-pp-cli which",
		"fandango-pp-cli agent-context",
		"fandango-pp-cli completion bash",
		"fandango-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"fandango-pp-cli recall",
		"fandango-pp-cli learnings",
		"fandango-pp-cli teach-pattern",
		"fandango-pp-cli teach-lookup",
		"fandango-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("fandango-pp-cli")); err == nil {
