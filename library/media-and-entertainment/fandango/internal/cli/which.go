...
var whichIndex = []whichEntry{
	{Command: "movie-plan", Description: "Rank practical nearby screenings inside a date and time window and return purchase links.", Group: "Plan a movie night", WhyItMatters: "Use it when an agent must turn raw inventory into a short list of bookable plans."},
	{Command: "starting-soon", Description: "Find nearby screenings beginning within an immediate time window.", Group: "Plan a movie night", WhyItMatters: "Use it when the user asks what they can still make tonight."},
	{Command: "format-find", Description: "Compare a movie's available presentation formats across nearby theaters.", Group: "Compare screenings", WhyItMatters: "Use it for IMAX, premium-format, or amenity-first decisions."},
	{Command: "theater-compare", Description: "Compare theaters by movie coverage, showtime density, operating span, and ticket-link coverage.", Group: "Compare screenings", WhyItMatters: "Use it when the venue is the decision rather than a particular screening."},
	{Command: "movie-availability", Description: "Show where and when one movie is playing, grouped by theater and display date.", Group: "Compare screenings", WhyItMatters: "Use it when an agent needs every usable option for one title."},
	{Command: "watchlist-showtimes", Description: "Match a local movie watchlist against currently bookable nearby showtimes.", Group: "Personal movie routine", WhyItMatters: "Use it for recurring personalized checks that a one-off endpoint cannot answer."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  fandango-pp-cli which "stale tickets"
  fandango-pp-cli which "bottleneck"
  fandango-pp-cli which --limit 1 "send message"
  fandango-pp-cli which                                # list the full capability index`,
