...
large datasets as it has no memory pressure.`,
  ...
  spotify-web-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  spotify-web-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  spotify-web-pp-cli export <resource> --format jsonl | jq '.id'`,
