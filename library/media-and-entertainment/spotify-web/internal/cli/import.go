...
but do not stop the import.`,
  ...
  spotify-web-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  spotify-web-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | spotify-web-pp-cli import <resource> --input -`,
