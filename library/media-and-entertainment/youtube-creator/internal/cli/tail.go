...
native streaming instead of polling.`,
  ...
  youtube-creator-pp-cli tail --interval 10s

  # Tail a specific resource
  youtube-creator-pp-cli tail messages --interval 5s

  # Pipe to jq for filtering
  youtube-creator-pp-cli tail events --interval 30s | jq 'select(.type == "error")'`,
