...
type GdataCompositeMedia struct {
	...
	Blobstore2Info       json.RawMessage `json:"blobstore2Info"`
	CosmoBinaryReference string          `json:"cosmoBinaryReference"`
	Crc32cHash           int             `json:"crc32cHash"`
...
type GdataDiffChecksumsResponse struct {
	ChecksumsLocation json.RawMessage `json:"checksumsLocation"`
	ChunkSizeBytes    string          `json:"chunkSizeBytes"`
	ObjectLocation    json.RawMessage `json:"objectLocation"`
...
type GdataDiffUploadRequest struct {
	ChecksumsInfo json.RawMessage `json:"checksumsInfo"`
	ObjectInfo    json.RawMessage `json:"objectInfo"`
	ObjectVersion string          `json:"objectVersion"`
}

type GdataDiffUploadResponse struct {
	ObjectVersion  string          `json:"objectVersion"`
	OriginalObject json.RawMessage `json:"originalObject"`
}
...
type GdataMedia struct {
	...
	BlobRef               string          `json:"blobRef"`
	Blobstore2Info        json.RawMessage `json:"blobstore2Info"`
	CompositeMedia        json.RawMessage `json:"compositeMedia"`
	ContentType           string          `json:"contentType"`
	ContentTypeInfo       json.RawMessage `json:"contentTypeInfo"`
	CosmoBinaryReference  string          `json:"cosmoBinaryReference"`
	Crc32cHash            int             `json:"crc32cHash"`
	DiffChecksumsResponse json.RawMessage `json:"diffChecksumsResponse"`
	DiffDownloadResponse  json.RawMessage `json:"diffDownloadResponse"`
	DiffUploadRequest     json.RawMessage `json:"diffUploadRequest"`
	DiffUploadResponse    json.RawMessage `json:"diffUploadResponse"`
	DiffVersionResponse   json.RawMessage `json:"diffVersionResponse"`
	DownloadParameters    json.RawMessage `json:"downloadParameters"`
...
type ListReportTypesResponse struct {
	NextPageToken string          `json:"nextPageToken"`
	ReportTypes   json.RawMessage `json:"reportTypes"`
}
