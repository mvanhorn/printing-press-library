...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "yt-studio-pp-cli",
		Short: `Hybrid YouTube Data API + Analytics API + Studio Innertube creator analytics CLI with offline SQLite, framework-audit, retention/CTR/demographics commands, and competitor watchlist.`,
		Long: `Hybrid YouTube Data API + Analytics API + Studio Innertube creator analytics CLI with offline SQLite, framework-audit, retention/CTR/demographics commands, and competitor watchlist.
...
Health check: run 'yt-studio-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("yt-studio-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'yt-studio-pp-cli profile list')")
	...
	rootCmd.AddCommand(newCommentsPromotedCmd(flags))
	rootCmd.AddCommand(newDiscoverPromotedCmd(flags))
	rootCmd.AddCommand(newPlaylistItemsPromotedCmd(flags))
	rootCmd.AddCommand(newVersionCliCmd())

	rootCmd.AddCommand(newLoginCmd(flags))
	rootCmd.AddCommand(newRetentionCmd(flags))
	rootCmd.AddCommand(newRetentionCohortCmd(flags))
	rootCmd.AddCommand(newCtrDecayCmd(flags))
	rootCmd.AddCommand(newVsWatchlistCmd(flags))
	rootCmd.AddCommand(newTitlePatternsCmd(flags))
	rootCmd.AddCommand(newIdeaGapCmd(flags))
	rootCmd.AddCommand(newFrameworkAuditCmd(flags))
	rootCmd.AddCommand(newScriptLinkCmd(flags))
	rootCmd.AddCommand(newWatchlistCmd(flags))
	rootCmd.AddCommand(newQuotaCmd(flags))
	rootCmd.AddCommand(newSniffDoctorCmd(flags))
