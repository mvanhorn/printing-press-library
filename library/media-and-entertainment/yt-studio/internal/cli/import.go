...
but do not stop the import.`,
  ...
  yt-studio-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  yt-studio-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | yt-studio-pp-cli import <resource> --input -`,
