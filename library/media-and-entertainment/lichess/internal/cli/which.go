...
var whichIndex = []whichEntry{
	{Command: "challenge ten", Description: "Create an explicit 10+0 Lichess challenge for a named player only after --send is supplied.", Group: "", WhyItMatters: ""},
	{Command: "loss-patterns", Description: "Mechanically group official completed-game judgments by opening, performance, and phase.", Group: "", WhyItMatters: ""},
	{Command: "training-brief", Description: "Combine official puzzle-theme performance with local loss-pattern evidence while preserving the absence of a causal mapping.", Group: "", WhyItMatters: ""},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  lichess-pp-cli which "stale tickets"
  lichess-pp-cli which "bottleneck"
  lichess-pp-cli which --limit 1 "send message"
  lichess-pp-cli which                                # list the full capability index`,
