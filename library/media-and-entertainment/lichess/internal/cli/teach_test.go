...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("LICHESS_STATE_DIR", "")
	t.Setenv("LICHESS_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"lichess-pp-cli auth login",
		"lichess-pp-cli doctor",
		"lichess-pp-cli help items",
		"lichess-pp-cli sync",
		"lichess-pp-cli profile list",
		"lichess-pp-cli feedback list",
		"lichess-pp-cli which",
		"lichess-pp-cli agent-context",
		"lichess-pp-cli completion bash",
		"lichess-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"lichess-pp-cli recall",
		"lichess-pp-cli learnings",
		"lichess-pp-cli teach-pattern",
		"lichess-pp-cli teach-lookup",
		"lichess-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("lichess-pp-cli")); err == nil {
