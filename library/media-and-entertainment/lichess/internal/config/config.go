...
type Config struct {
	...
	LichessOauth2 string          `toml:"oauth2"`
}
...
func Load(configPath string) (*Config, error) {
	...
	// Env var overrides
	if v := os.Getenv("LICHESS_OAUTH2"); v != "" {
		cfg.LichessOauth2 = v
		cfg.markEnvOverride("LichessOauth2")
		cfg.AuthSource = "env:LICHESS_OAUTH2"
		cfg.CredentialSource = "env:LICHESS_OAUTH2"
	}
	...
	if v := os.Getenv("LICHESS_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	if v := os.Getenv("LICHESS_AUTHORIZATION_URL"); v != "" {
		cfg.AuthorizationURL = v
	}
	if v := os.Getenv("LICHESS_TOKEN_URL"); v != "" {
		cfg.TokenURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("LICHESS_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "lichess-pp-cli", "config.toml"), nil
}
...
func (c *Config) AuthHeader() string {
	...
	// A directly-held bearer in LICHESS_OAUTH2 (a pasted access token, or a
...
func (c *Config) applyCredentials(creds *cliutil.Credentials) {
	...
	c.LichessOauth2 = creds.LichessOauth2
}
...
func (c *Config) ClearTokens() error {
	...
	c.updateFileConfigField("ClientSecret")
	c.LichessOauth2 = ""
	delete(c.envOverrides, "LichessOauth2")
	c.updateFileConfigField("LichessOauth2")
	if c.AgentcookieManagedByExternalStore() {
		c.markAgentcookieManaged()
...
func (c *Config) configForSave() Config {
	out := *c
	if c.fileConfig != nil {
		if c.envOverrides["LichessOauth2"] {
			out.LichessOauth2 = c.fileConfig.LichessOauth2
		}
	}
...
func (c *Config) updateFileConfigField(field string) {
	...
	case "LichessOauth2":
		c.fileConfig.LichessOauth2 = c.LichessOauth2
	}
}
