...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("BOOK_GOAT_STATE_DIR", "")
	t.Setenv("BOOK_GOAT_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"passage-pp-cli auth login",
		"passage-pp-cli doctor",
		"passage-pp-cli help items",
		"passage-pp-cli sync",
		"passage-pp-cli profile list",
		"passage-pp-cli feedback list",
		"passage-pp-cli which",
		"passage-pp-cli agent-context",
		"passage-pp-cli completion bash",
		"passage-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"passage-pp-cli recall",
		"passage-pp-cli learnings",
		"passage-pp-cli teach-pattern",
		"passage-pp-cli teach-lookup",
		"passage-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("passage-pp-cli")); err == nil {
