...
type rootFlags struct {
	...
	// invocation. Mirrors the BOOK_GOAT_NO_LEARN env var.
	noLearn       bool
	selectFields  string
	configPath    string
	homePath      string
...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "passage-pp-cli",
		Short: `Passage CLI — A contemplative daily reading practice — open book APIs as your library, real public-domain passages to sit with, and…`,
		Long: `Passage CLI — A contemplative daily reading practice — open book APIs as your library, real public-domain passages to sit with, and a reading journal that's yours.
...
Health check: run 'passage-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("passage-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'passage-pp-cli profile list')")
	...
	rootCmd.AddCommand(newNovelSitCmd(flags))
	...
	rootCmd.AddCommand(newAuthorsPromotedCmd(flags))
	rootCmd.AddCommand(newSearchJsonPromotedCmd(flags))
	rootCmd.AddCommand(newWorksPromotedCmd(flags))
