---
name: pp-passage
description: "A contemplative daily reading practice — open book APIs as your library, real public-domain passages to sit with, and a reading journal that's yours. Trigger phrases: `what should I read today`, `find me a book`, `sit with a passage`, `add to my reading list`, `my reading journal`, `use passage`, `run passage`."
author: "justinwfu"
license: "Apache-2.0"
...
1. Check if installed: `which passage-pp-cli`
