...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "vibe-signal-pp-cli",
		Short: `Vibe Signal CLI — One question, every low-friction source: a recency-aware, cited signal report instead of ten raw source dumps.`,
		Long: `Vibe Signal CLI — One question, every low-friction source: a recency-aware, cited signal report instead of ten raw source dumps.
...
Health check: run 'vibe-signal-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("vibe-signal-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'vibe-signal-pp-cli profile list')")
	...
	rootCmd.AddCommand(newHnCmd(flags))
	...
	rootCmd.AddCommand(newNovelSourcesCmd(flags))
