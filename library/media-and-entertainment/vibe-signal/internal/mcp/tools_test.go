...
func TestMCPPathResolutionMatchesCLIResolverWithHomeEnv(t *testing.T) {
	...
	t.Setenv("VIBE_SIGNAL_HOME", root)
...
func TestMCPPathResolutionMatchesCLIResolverWithPlatformDefaults(t *testing.T) {
	...
	if want := filepath.Join(home, ".config", "vibe-signal-pp-cli", "config.json"); cfg.Path != want {
	...
	if want := filepath.Join(home, ".local", "share", "vibe-signal-pp-cli", "data.db"); gotDB != want {
...
func resetMCPPathEnv(t *testing.T) string {
	...
	for _, name := range []string{
		"VIBE_SIGNAL_CONFIG",
		"VIBE_SIGNAL_CONFIG_DIR",
		"VIBE_SIGNAL_DATA_DIR",
		"VIBE_SIGNAL_STATE_DIR",
		"VIBE_SIGNAL_CACHE_DIR",
		"VIBE_SIGNAL_HOME",
		"XDG_CONFIG_HOME",
		"XDG_DATA_HOME",
		"XDG_STATE_HOME",
...
func TestMCPRegisterToolsPreservesTypedSpecialTools(t *testing.T) {
	s := server.NewMCPServer("vibe-signal", "test")
	RegisterTools(s)
