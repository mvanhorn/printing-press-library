...
large datasets as it has no memory pressure.`,
  ...
  movieglu-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  movieglu-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  movieglu-pp-cli export <resource> --format jsonl | jq '.id'`,
		Args: cobra.RangeArgs(1, 2),
		RunE: func(cmd *cobra.Command, args []string) error {
			validResources := map[string]bool{
				"cinema-show-times": true,
				"cinemas-nearby":    true,
				"closest-showing":   true,
				"film-show-times":   true,
				"films-now-showing": true,
			}
