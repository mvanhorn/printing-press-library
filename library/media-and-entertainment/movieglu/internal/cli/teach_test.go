...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"movieglu-pp-cli auth login",
		"movieglu-pp-cli doctor",
		"movieglu-pp-cli help items",
		"movieglu-pp-cli sync",
		"movieglu-pp-cli profile list",
		"movieglu-pp-cli feedback list",
		"movieglu-pp-cli which",
		"movieglu-pp-cli agent-context",
		"movieglu-pp-cli completion bash",
		"movieglu-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"movieglu-pp-cli recall",
		"movieglu-pp-cli learnings",
		"movieglu-pp-cli teach-pattern",
		"movieglu-pp-cli teach-lookup",
		"movieglu-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("movieglu-pp-cli")); err == nil {
