...
var whichIndex = []whichEntry{
	{Command: "movie-night", Description: "Resolve a film name, rank nearby showtimes, and optionally return the cinema booking handoff.", Group: "Movie planning", WhyItMatters: "Agents can answer the user’s actual movie-night question without manually joining IDs and showtime objects."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  movieglu-pp-cli which "stale tickets"
  movieglu-pp-cli which "bottleneck"
  movieglu-pp-cli which --limit 1 "send message"
  movieglu-pp-cli which                                # list the full capability index`,
