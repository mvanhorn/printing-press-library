...
but do not stop the import.`,
  ...
  openfoodfacts-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  openfoodfacts-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | openfoodfacts-pp-cli import <resource> --input -`,
