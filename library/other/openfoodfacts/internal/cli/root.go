...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "openfoodfacts-pp-cli",
		Short: `Openfoodfacts CLI — Every Open Food Facts read endpoint, plus a local calorie/macro diary, product compare, and offline search no other Ope…`,
		Long: `Openfoodfacts CLI — Every Open Food Facts read endpoint, plus a local calorie/macro diary, product compare, and offline search no other Ope…
...
Health check: run 'openfoodfacts-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("openfoodfacts-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'openfoodfacts-pp-cli profile list')")
	...
	rootCmd.AddCommand(newCgiCmd(flags))
	...
	rootCmd.AddCommand(newNovelAllergensCmd(flags))
	rootCmd.AddCommand(newNovelBudgetCmd(flags))
	rootCmd.AddCommand(newNovelCompareCmd(flags))
	rootCmd.AddCommand(newNovelDiaryCmd(flags))
	rootCmd.AddCommand(newNovelRankCmd(flags))
	rootCmd.AddCommand(newNovelRecipeCmd(flags))
	rootCmd.AddCommand(newNovelSwapCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newAttributeGroupsPromotedCmd(flags))
	rootCmd.AddCommand(newFindPromotedCmd(flags))
	rootCmd.AddCommand(newPreferencesPromotedCmd(flags))
