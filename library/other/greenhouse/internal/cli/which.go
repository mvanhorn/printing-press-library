...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  greenhouse-pp-cli which "stale tickets"
  greenhouse-pp-cli which "bottleneck"
  greenhouse-pp-cli which --limit 1 "send message"
  greenhouse-pp-cli which                                # list the full capability index`,
