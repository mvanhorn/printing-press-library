...
but do not stop the import.`,
  ...
  bse-filings-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  bse-filings-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | bse-filings-pp-cli import <resource> --input -`,
