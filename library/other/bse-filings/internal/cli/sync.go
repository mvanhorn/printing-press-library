...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "corp_actions":
		return db.UpsertCorpActions(data)
	case "quote":
		return db.UpsertQuote(data)
	case "results_calendar":
		return db.UpsertResultsCalendar(data)
	default:
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		...
		"corp_actions":     "/DefaultData/w",
		"results_calendar": "/Corpforthresults/w",
		"results_snapshot": "/TabResults_PAR/w",
		"scrips":           "/PeerSmartSearch/w",
	}
