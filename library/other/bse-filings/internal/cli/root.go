...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "bse-filings-pp-cli",
		Short: `Mirror BSE corporate filings into a local store and grep concalls, detect thesis drift, and track results across your holdings.`,
		Long: `Mirror BSE corporate filings into a local store and grep concalls, detect thesis drift, and track results across your holdings.
...
Health check: run 'bse-filings-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("bse-filings-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'bse-filings-pp-cli profile list')")
	...
	rootCmd.AddCommand(newBSESyncCmd(flags))
	rootCmd.AddCommand(newWorkflowCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newAnnouncementsPromotedCmd(flags))
	rootCmd.AddCommand(newCorpActionsPromotedCmd(flags))
	rootCmd.AddCommand(newQuotePromotedCmd(flags))
	rootCmd.AddCommand(newResultsCalendarPromotedCmd(flags))
	rootCmd.AddCommand(newResultsSnapshotPromotedCmd(flags))
	rootCmd.AddCommand(newScripsPromotedCmd(flags))
	rootCmd.AddCommand(newVersionCliCmd())

	// Hand-written novel commands (Phase 3).
	rootCmd.AddCommand(newHoldingsCmd(flags))
	rootCmd.AddCommand(newConcallCmd(flags))
	rootCmd.AddCommand(newConcallGrepCmd(flags))
	rootCmd.AddCommand(newThesisDriftCmd(flags))
	rootCmd.AddCommand(newCrossCmd(flags))
	rootCmd.AddCommand(newDueSoonCmd(flags))
	rootCmd.AddCommand(newOutcomesCmd(flags))
	rootCmd.AddCommand(newStaleCmd(flags))
	rootCmd.AddCommand(newCriticalCmd(flags))
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("bse-filings-pp-cli %s\n", version)
		},
	}
}
