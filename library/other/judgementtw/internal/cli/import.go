...
but do not stop the import.`,
  ...
  judgementtw-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  judgementtw-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | judgementtw-pp-cli import <resource> --input -`,
