...
but do not stop the import.`,
  ...
  aol-puglia-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  aol-puglia-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | aol-puglia-pp-cli import <resource> --input -`,
