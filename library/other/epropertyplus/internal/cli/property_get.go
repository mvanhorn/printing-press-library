...
func newPropertyGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "/property/getPublishedProperty"
	...
	cmd.Flags().StringVar(&flagPropertyId, "property-id", "", "Property id from listProperties rows[].id")
