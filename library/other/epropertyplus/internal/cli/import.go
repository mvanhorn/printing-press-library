...
but do not stop the import.`,
  ...
  epropertyplus-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  epropertyplus-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | epropertyplus-pp-cli import <resource> --input -`,
