...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/other/epropertyplus/internal/mcp"
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "epropertyplus-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
