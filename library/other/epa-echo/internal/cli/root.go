...
type rootFlags struct {
	...
	// invocation. Mirrors the EPA_ECHO_NO_LEARN env var.
	noLearn       bool
	selectFields  string
	configPath    string
	homePath      string
...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "epa-echo-pp-cli",
		Short: "Resolve EPA-regulated facilities, inspect transparent compliance evidence, and retain change history without opaque scores.",
		Long: `Epa Echo CLI
...
Health check: run 'epa-echo-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("epa-echo-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'epa-echo-pp-cli profile list')")
	...
	rootCmd.AddCommand(newNovelEffluentCmd(flags))
	rootCmd.AddCommand(newNovelEnforcementCmd(flags))
	...
	rootCmd.AddCommand(newDfrRestServicesGetDfrPromotedCmd(flags))
	rootCmd.AddCommand(newEchoRestServicesGetFacilitiesPromotedCmd(flags))
	rootCmd.AddCommand(newEchoRestServicesGetQidPromotedCmd(flags))
