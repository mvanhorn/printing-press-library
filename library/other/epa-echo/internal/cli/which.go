...
var whichIndex = []whichEntry{
	{Command: "resolve facility", Description: "Rank bounded facility matches while preserving FRS identifiers, addresses, program status fields, and query provenance.", Group: "", WhyItMatters: ""},
	{Command: "dossier diff", Description: "Compare a live detailed facility report with the prior local snapshot and list changed ECHO sections without assigning a score.", Group: "", WhyItMatters: ""},
	{Command: "watch", Description: "Fetch a bounded CSV portfolio of facility IDs and atomically report changed detailed-report sections since the prior run.", Group: "", WhyItMatters: ""},
	{Command: "nearby explain", Description: "List facilities within an EPA-supported radius and expose the compliance, inspection, action, and penalty fields behind each concern.", Group: "", WhyItMatters: ""},
	{Command: "effluent trend", Description: "Return ECHO's reported Clean Water Act effluent compliance and exceedance records for one stable facility identifier.", Group: "", WhyItMatters: ""},
	{Command: "enforcement timeline", Description: "Collect dated inspection, violation, formal-action, and enforcement sections from a detailed facility report without causal inference.", Group: "", WhyItMatters: ""},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  epa-echo-pp-cli which "stale tickets"
  epa-echo-pp-cli which "bottleneck"
  epa-echo-pp-cli which --limit 1 "send message"
  epa-echo-pp-cli which                                # list the full capability index`,
