...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("EPA_ECHO_STATE_DIR", "")
	t.Setenv("EPA_ECHO_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"epa-echo-pp-cli auth login",
		"epa-echo-pp-cli doctor",
		"epa-echo-pp-cli help items",
		"epa-echo-pp-cli sync",
		"epa-echo-pp-cli profile list",
		"epa-echo-pp-cli feedback list",
		"epa-echo-pp-cli which",
		"epa-echo-pp-cli agent-context",
		"epa-echo-pp-cli completion bash",
		"epa-echo-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"epa-echo-pp-cli recall",
		"epa-echo-pp-cli learnings",
		"epa-echo-pp-cli teach-pattern",
		"epa-echo-pp-cli teach-lookup",
		"epa-echo-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("epa-echo-pp-cli")); err == nil {
