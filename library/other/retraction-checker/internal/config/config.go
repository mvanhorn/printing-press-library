...
func Load(configPath string) (*Config, error) {
	...
	if v := os.Getenv("RETRACTION_CHECKER_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("RETRACTION_CHECKER_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "retraction-checker-pp-cli", "config.toml"), nil
}
