...
func TestMCPPathResolutionMatchesCLIResolverWithHomeEnv(t *testing.T) {
	...
	t.Setenv("RETRACTION_CHECKER_HOME", root)
...
func TestMCPPathResolutionMatchesCLIResolverWithPlatformDefaults(t *testing.T) {
	...
	if want := filepath.Join(home, ".config", "retraction-checker-pp-cli", "config.toml"); cfg.Path != want {
	...
	if want := filepath.Join(home, ".local", "share", "retraction-checker-pp-cli", "data.db"); gotDB != want {
...
func resetMCPPathEnv(t *testing.T) string {
	...
	for _, name := range []string{
		"RETRACTION_CHECKER_CONFIG",
		"RETRACTION_CHECKER_CONFIG_DIR",
		"RETRACTION_CHECKER_DATA_DIR",
		"RETRACTION_CHECKER_STATE_DIR",
		"RETRACTION_CHECKER_CACHE_DIR",
		"RETRACTION_CHECKER_HOME",
		"XDG_CONFIG_HOME",
		"XDG_DATA_HOME",
		"XDG_STATE_HOME",
		"XDG_CACHE_HOME",
