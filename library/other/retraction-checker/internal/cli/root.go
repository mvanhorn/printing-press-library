...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "retraction-checker-pp-cli",
		Short: `Retraction Checker CLI — Check whether a paper is retracted, why, and what the current research says now — keyless, over Crossref and OpenAlex.`,
		Long: `Retraction Checker CLI — Check whether a paper is retracted, why, and what the current research says now — keyless, over Crossref and OpenAlex.
...
See README.md or the bundled SKILL.md for recipes.`,
	...
	rootCmd.SetVersionTemplate("retraction-checker-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'retraction-checker-pp-cli profile list')")
	...
	rootCmd.AddCommand(newNovelCheckCmd(flags))
	rootCmd.AddCommand(newNovelScanCmd(flags))
	rootCmd.AddCommand(newNovelSupersededCmd(flags))
