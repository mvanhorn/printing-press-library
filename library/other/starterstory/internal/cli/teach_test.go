...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("STARTERSTORY_STATE_DIR", "")
	t.Setenv("STARTERSTORY_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"starterstory-pp-cli auth login",
		"starterstory-pp-cli doctor",
		"starterstory-pp-cli help items",
		"starterstory-pp-cli sync",
		"starterstory-pp-cli profile list",
		"starterstory-pp-cli feedback list",
		"starterstory-pp-cli which",
		"starterstory-pp-cli agent-context",
		"starterstory-pp-cli completion bash",
		"starterstory-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"starterstory-pp-cli recall",
		"starterstory-pp-cli learnings",
		"starterstory-pp-cli teach-pattern",
		"starterstory-pp-cli teach-lookup",
		"starterstory-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("starterstory-pp-cli")); err == nil {
