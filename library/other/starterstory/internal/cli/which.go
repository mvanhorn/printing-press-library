...
var whichIndex = []whichEntry{
	{Command: "top-revenue", Description: "Rank founder case studies by monthly revenue parsed from their titles.", Group: "Local index that compounds", WhyItMatters: "Pick this to find the highest-revenue proven case studies without scrolling the site."},
	{Command: "whats-new", Description: "Diff the sitemap against your last sync to surface newly published stories, ideas, and businesses.", Group: "Local index that compounds", WhyItMatters: "Track the StarterStory feed offline between syncs."},
	{Command: "hunt", Description: "Full-text search the local index with section and minimum-revenue filters (hunt = filtered search).", Group: "Local index that compounds", WhyItMatters: "Reach for this instead of the weak on-site search when you need filtered, structured results."},
	{Command: "grep", Description: "Keyword-filter across all indexed idea and story slugs offline.", Group: "Local index that compounds", WhyItMatters: "Fast local keyword scan across the whole idea corpus."},
	{Command: "stats", Description: "Counts by section plus the revenue distribution across the case-study corpus.", Group: "Local index that compounds", WhyItMatters: "Understand the shape of the StarterStory corpus at a glance."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  starterstory-pp-cli which "stale tickets"
  starterstory-pp-cli which "bottleneck"
  starterstory-pp-cli which --limit 1 "send message"
  starterstory-pp-cli which                                # list the full capability index`,
