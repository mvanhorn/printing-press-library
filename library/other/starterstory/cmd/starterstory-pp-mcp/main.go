...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/other/starterstory/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("STARTERSTORY_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "starterstory-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
