...
See README.md or the bundled SKILL.md for recipes.`,
	...
	rootCmd.AddCommand(newNovelLatestCmd(flags))
	rootCmd.AddCommand(newNovelSeriesCmd(flags))
	rootCmd.AddCommand(newNovelWorkbooksCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newTransparencyPromotedCmd(flags))
