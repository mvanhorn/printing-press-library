...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("FPI_INDIA_STATE_DIR", "")
	t.Setenv("FPI_INDIA_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"fpi-india-pp-cli auth login",
		"fpi-india-pp-cli doctor",
		"fpi-india-pp-cli help items",
		"fpi-india-pp-cli sync",
		"fpi-india-pp-cli profile list",
		"fpi-india-pp-cli feedback list",
		"fpi-india-pp-cli which",
		"fpi-india-pp-cli agent-context",
		"fpi-india-pp-cli completion bash",
		"fpi-india-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"fpi-india-pp-cli recall",
		"fpi-india-pp-cli learnings",
		"fpi-india-pp-cli teach-pattern",
		"fpi-india-pp-cli teach-lookup",
		"fpi-india-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("fpi-india-pp-cli")); err == nil {
