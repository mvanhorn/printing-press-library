...
type rootFlags struct {
	...
	// invocation. Mirrors the FPI_INDIA_NO_LEARN env var.
	noLearn       bool
	selectFields  string
	configPath    string
	homePath      string
...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "fpi-india-pp-cli",
		Short: `Fpi India CLI — The full history of Foreign Portfolio Investor flows into India, synced locally and queryable offline — something neither NSDL nor CDSL offers today.`,
		Long: `Fpi India CLI — The full history of Foreign Portfolio Investor flows into India, synced locally and queryable offline — something neither NSDL nor CDSL offers today.
...
Health check: run 'fpi-india-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("fpi-india-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'fpi-india-pp-cli profile list')")
	...
	rootCmd.AddCommand(newAucCmd(flags))
	rootCmd.AddCommand(newCdslReportsCmd(flags))
	rootCmd.AddCommand(newNetInvestmentCmd(flags))
	rootCmd.AddCommand(newRegistryCmd(flags))
	rootCmd.AddCommand(newTradesCmd(flags))
	...
	rootCmd.AddCommand(newNovelCdslCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newLimitsPromotedCmd(flags))
	rootCmd.AddCommand(newSectorPromotedCmd(flags))
