...
func Load(configPath string) (*Config, error) {
	cfg := &Config{
		BaseURL: "https://www.fpi.nsdl.co.in",
	}
	...
	if v := os.Getenv("FPI_INDIA_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("FPI_INDIA_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "fpi-india-pp-cli", "config.json"), nil
}
