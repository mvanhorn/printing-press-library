...
but do not stop the import.`,
  ...
  catasto-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  catasto-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | catasto-pp-cli import <resource> --input -`,
