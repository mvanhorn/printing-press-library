...
const (
	journalSessionEnvVar   = "CFPB_COMPLAINTS_LEARN_SESSION"
	journalNoLearnEnvVar   = "CFPB_COMPLAINTS_NO_LEARN"
	journalNoCaptureEnvVar = "CFPB_COMPLAINTS_LEARN_NO_CAPTURE"
)
