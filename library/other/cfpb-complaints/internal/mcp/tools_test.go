...
func TestMCPPathResolutionMatchesCLIResolverWithHomeEnv(t *testing.T) {
	...
	t.Setenv("CFPB_COMPLAINTS_HOME", root)
...
func TestMCPPathResolutionMatchesCLIResolverWithPlatformDefaults(t *testing.T) {
	...
	if want := filepath.Join(home, ".config", "cfpb-complaints-pp-cli", "config.toml"); cfg.Path != want {
	...
	if want := filepath.Join(home, ".local", "share", "cfpb-complaints-pp-cli", "data.db"); gotDB != want {
...
func resetMCPPathEnv(t *testing.T) string {
	...
	for _, name := range []string{
		"CFPB_COMPLAINTS_CONFIG",
		"CFPB_COMPLAINTS_CONFIG_DIR",
		"CFPB_COMPLAINTS_DATA_DIR",
		"CFPB_COMPLAINTS_STATE_DIR",
		"CFPB_COMPLAINTS_CACHE_DIR",
		"CFPB_COMPLAINTS_HOME",
		"XDG_CONFIG_HOME",
		"XDG_DATA_HOME",
		"XDG_STATE_HOME",
		"XDG_CACHE_HOME",
...
func TestMCPRegisterToolsPreservesTypedSpecialTools(t *testing.T) {
	s := server.NewMCPServer("cfpb-complaints", "test")
	RegisterTools(s)
