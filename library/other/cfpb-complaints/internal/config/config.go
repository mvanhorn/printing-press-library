...
func Load(configPath string) (*Config, error) {
	...
	if v := os.Getenv("CFPB_COMPLAINTS_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("CFPB_COMPLAINTS_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "cfpb-complaints-pp-cli", "config.toml"), nil
}
