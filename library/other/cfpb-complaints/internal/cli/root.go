...
type rootFlags struct {
	...
	// invocation. Mirrors the CFPB_COMPLAINTS_NO_LEARN env var.
	noLearn       bool
	selectFields  string
	configPath    string
	homePath      string
...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "cfpb-complaints-pp-cli",
		Short: "Manage cfpb-complaints resources via the cfpb-complaints API",
		Long: `Cfpb Complaints CLI
...
Health check: run 'cfpb-complaints-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("cfpb-complaints-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'cfpb-complaints-pp-cli profile list')")
	...
	rootCmd.AddCommand(newNovelNarrativesCmd(flags))
	rootCmd.AddCommand(newNovelWatchCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newDataResearchPromotedCmd(flags))
