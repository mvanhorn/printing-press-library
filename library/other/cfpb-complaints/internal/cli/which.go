...
var whichIndex = []whichEntry{
	{Command: "company pulse", Description: "Summarize complaint volume, products, issues, responses, timeliness, narrative availability, and a prior-window delta for one company.", Group: "", WhyItMatters: ""},
	{Command: "compare companies", Description: "Compare companies inside one explicit cohort while labeling counts as non-market-adjusted complaint volume.", Group: "", WhyItMatters: ""},
	{Command: "emerging themes", Description: "Rank mechanical product and issue count changes between current and baseline windows without semantic or causal claims.", Group: "", WhyItMatters: ""},
	{Command: "narratives packet", Description: "Select a newest-first bounded packet of published narratives with complaint IDs, exact cohort dates, and availability caveats.", Group: "", WhyItMatters: ""},
	{Command: "watch changes", Description: "Compare the latest bounded cohort with a locally persisted prior observation and report newly observed complaint IDs and categories.", Group: "", WhyItMatters: ""},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  cfpb-complaints-pp-cli which "stale tickets"
  cfpb-complaints-pp-cli which "bottleneck"
  cfpb-complaints-pp-cli which --limit 1 "send message"
  cfpb-complaints-pp-cli which                                # list the full capability index`,
