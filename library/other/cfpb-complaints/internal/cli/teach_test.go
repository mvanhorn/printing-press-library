...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("CFPB_COMPLAINTS_STATE_DIR", "")
	t.Setenv("CFPB_COMPLAINTS_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"cfpb-complaints-pp-cli auth login",
		"cfpb-complaints-pp-cli doctor",
		"cfpb-complaints-pp-cli help items",
		"cfpb-complaints-pp-cli sync",
		"cfpb-complaints-pp-cli profile list",
		"cfpb-complaints-pp-cli feedback list",
		"cfpb-complaints-pp-cli which",
		"cfpb-complaints-pp-cli agent-context",
		"cfpb-complaints-pp-cli completion bash",
		"cfpb-complaints-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"cfpb-complaints-pp-cli recall",
		"cfpb-complaints-pp-cli learnings",
		"cfpb-complaints-pp-cli teach-pattern",
		"cfpb-complaints-pp-cli teach-lookup",
		"cfpb-complaints-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("cfpb-complaints-pp-cli")); err == nil {
