...
native streaming instead of polling.`,
  ...
  bloomest-laundry-manager-pp-cli tail --interval 10s

  # Tail a specific resource
  bloomest-laundry-manager-pp-cli tail messages --interval 5s

  # Pipe to jq for filtering
  bloomest-laundry-manager-pp-cli tail events --interval 30s | jq 'select(.type == "error")'`,
