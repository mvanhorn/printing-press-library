...
but do not stop the import.`,
  ...
  bloomest-laundry-manager-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  bloomest-laundry-manager-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | bloomest-laundry-manager-pp-cli import <resource> --input -`,
