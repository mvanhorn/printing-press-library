...
large datasets as it has no memory pressure.`,
  ...
  bloomest-laundry-manager-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  bloomest-laundry-manager-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  bloomest-laundry-manager-pp-cli export <resource> --format jsonl | jq '.id'`,
