...
Exit codes & warnings:
  ...
  bloomest-laundry-manager-pp-cli sync

  # Sync specific resources only
  bloomest-laundry-manager-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  bloomest-laundry-manager-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  bloomest-laundry-manager-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  bloomest-laundry-manager-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  bloomest-laundry-manager-pp-cli sync --latest-only`,
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/bloomest-laundry-manager-pp-cli/data.db)")
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"accesses":                         "/accesses",
		"alarms":                           "/alarms",
		"bloomest-laundry-manager-version": "/version",
		"cashbox-updates":                  "/cashboxUpdates",
		"comments":                         "/comments",
		"contacts":                         "/contacts",
		"laundries":                        "/laundries",
		"loyalties":                        "/loyalties",
		...
		"policy":                           "/policy",
		"reservationsconf":                 "/reservationsconf",
		"users":                            "/users",
	}
