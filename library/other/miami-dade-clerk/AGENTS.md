# Miami-Dade Clerk Official Records Printed CLI Agent Guide

This directory is a generated `miami-dade-clerk-pp-cli` printed CLI. It was produced by [CLI Printing Press](https://github.com/mvanhorn/cli-printing-press), so treat systemic fixes as upstream Printing Press fixes first. Keep local edits narrow and document why a generated-tree patch belongs here.
...
```bash
miami-dade-clerk-pp-cli doctor --json
miami-dade-clerk-pp-cli agent-context --pretty
```

Use runtime discovery instead of relying on a copied command list:

```bash
miami-dade-clerk-pp-cli which "<capability>" --json
miami-dade-clerk-pp-cli <command> --help
```
...
```bash
miami-dade-clerk-pp-cli <command> --agent
```
...
```bash
miami-dade-clerk-pp-cli <command> --help
miami-dade-clerk-pp-cli <command> --dry-run --agent
```
