...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  miami-dade-clerk-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  miami-dade-clerk-pp-cli workflow archive --full`,
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  miami-dade-clerk-pp-cli workflow status

  # Show status as JSON
  miami-dade-clerk-pp-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("miami-dade-clerk-pp-cli")
			}
