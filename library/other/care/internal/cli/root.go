...
type rootFlags struct {
	...
	// invocation. Mirrors the CARE_NO_LEARN env var.
	noLearn bool
...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "care-pp-cli",
		Short: "Manage care resources via the care API",
		Long: `Manage care resources via the care API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'care-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("care-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'care-pp-cli profile list')")
	...
	rootCmd.AddCommand(newCareJobsCmd(flags))
	rootCmd.AddCommand(newCaregiversCmd(flags))
	...
	rootCmd.AddCommand(newSeekersCmd(flags))
	rootCmd.AddCommand(newDoctorCmd(flags))
	rootCmd.AddCommand(newAuthCmd(flags))
	// care.com friendly commands (hand-authored, see care_*.go)
	rootCmd.AddCommand(newCareFindCmd(flags))
	rootCmd.AddCommand(newCareRecommendCmd(flags))
	rootCmd.AddCommand(newCareOutreachCmd(flags))
	rootCmd.AddCommand(newCareJobCmd(flags))
	rootCmd.AddCommand(newCareCaregiverCmd(flags))
	rootCmd.AddCommand(newCareSyncCmd(flags))
	rootCmd.AddCommand(newCareFavoriteCmd(flags))
	rootCmd.AddCommand(newCareUnfavoriteCmd(flags))
	...
	rootCmd.AddCommand(newAvailabilitiesPromotedCmd(flags))
	rootCmd.AddCommand(newCalendarsPromotedCmd(flags))
	rootCmd.AddCommand(newConversationsPromotedCmd(flags))
	rootCmd.AddCommand(newMembershipsPromotedCmd(flags))
	// Stream-backed messages inbox (deviation) replaces the generated stub,
	// which only returned a thread id. See care_messages.go.
	rootCmd.AddCommand(newCareMessagesCmd(flags))
	rootCmd.AddCommand(newRevieweesPromotedCmd(flags))
	rootCmd.AddCommand(newZipcodesPromotedCmd(flags))
