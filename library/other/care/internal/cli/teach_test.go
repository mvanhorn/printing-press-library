...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"care-pp-cli auth login",
		"care-pp-cli doctor",
		"care-pp-cli help items",
		"care-pp-cli sync",
		"care-pp-cli profile list",
		"care-pp-cli feedback list",
		"care-pp-cli which",
		"care-pp-cli agent-context",
		"care-pp-cli completion bash",
		"care-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"care-pp-cli teach",
		"care-pp-cli recall",
		"care-pp-cli learnings",
		"care-pp-cli teach-pattern",
		"care-pp-cli teach-lookup",
		"care-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("care-pp-cli")); err == nil {
