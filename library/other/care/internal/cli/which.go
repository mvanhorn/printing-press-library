...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  care-pp-cli which "stale tickets"
  care-pp-cli which "bottleneck"
  care-pp-cli which --limit 1 "send message"
  care-pp-cli which                                # list the full capability index`,
