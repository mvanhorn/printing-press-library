...
var whichIndex = []whichEntry{
	{Command: "docket", Description: "Join one authenticated docket with bounded entries, documents, parties, and counsel in source chronology.", Group: "", WhyItMatters: ""},
	{Command: "new-filings", Description: "Persist a bounded newest-first search observation and report newly observed CourtListener result IDs.", Group: "", WhyItMatters: ""},
	{Command: "party", Description: "Query authenticated party records by exact supplied name while preserving docket and API identifiers.", Group: "", WhyItMatters: ""},
	{Command: "counsel", Description: "Query authenticated attorney records by supplied name and retain observed docket and party relationships.", Group: "", WhyItMatters: ""},
	{Command: "judge", Description: "Return sourced judge/person metadata and clearly prohibit outcome prediction or causal scoring.", Group: "", WhyItMatters: ""},
	{Command: "recap-gaps", Description: "Classify bounded docket document records by CourtListener availability fields without implying complete PACER coverage.", Group: "", WhyItMatters: ""},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  courtlistener-pp-cli which "stale tickets"
  courtlistener-pp-cli which "bottleneck"
  courtlistener-pp-cli which --limit 1 "send message"
  courtlistener-pp-cli which                                # list the full capability index`,
