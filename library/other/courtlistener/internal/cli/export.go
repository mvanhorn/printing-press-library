...
large datasets as it has no memory pressure.`,
  ...
  courtlistener-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  courtlistener-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  courtlistener-pp-cli export <resource> --format jsonl | jq '.id'`,
