...
Resource scoping:
  ...
  courtlistener-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  courtlistener-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  courtlistener-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  courtlistener-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  courtlistener-pp-cli sync --latest-only`,
