...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("COURTLISTENER_STATE_DIR", "")
	t.Setenv("COURTLISTENER_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"courtlistener-pp-cli auth login",
		"courtlistener-pp-cli doctor",
		"courtlistener-pp-cli help items",
		"courtlistener-pp-cli sync",
		"courtlistener-pp-cli profile list",
		"courtlistener-pp-cli feedback list",
		"courtlistener-pp-cli which",
		"courtlistener-pp-cli agent-context",
		"courtlistener-pp-cli completion bash",
		"courtlistener-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"courtlistener-pp-cli recall",
		"courtlistener-pp-cli learnings",
		"courtlistener-pp-cli teach-pattern",
		"courtlistener-pp-cli teach-lookup",
		"courtlistener-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("courtlistener-pp-cli")); err == nil {
