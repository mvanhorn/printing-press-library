...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/other/courtlistener/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("COURTLISTENER_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "courtlistener-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
