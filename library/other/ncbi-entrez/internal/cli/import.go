...
but do not stop the import.`,
  ...
  ncbi-entrez-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  ncbi-entrez-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | ncbi-entrez-pp-cli import <resource> --input -`,
