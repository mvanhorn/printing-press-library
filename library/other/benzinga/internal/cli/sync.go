...
Resource scoping:
  ...
  benzinga-pp-cli sync

  # Sync specific resources only
  benzinga-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  benzinga-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  benzinga-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  benzinga-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  benzinga-pp-cli sync --latest-only`,
...
func determinePaginationDefaults(resource string) paginationDefaults {
	...
	case "calendar-conference-calls":
		return paginationDefaults{
			cursorParam: "page",
			cursorType:  "page",
			limitParam:  "pagesize",
	...
	case "calendar-ratings-analysts":
		return paginationDefaults{
			cursorParam: "page",
			cursorType:  "page",
			limitParam:  "pageSize",
	...
	case "earnings-call-transcripts":
		return paginationDefaults{
			cursorParam: "page",
			cursorType:  "page",
			limitParam:  "pagesize",
	...
	case "earnings-call-transcripts-audio":
		return paginationDefaults{
			cursorParam: "page",
			cursorType:  "page",
			limitParam:  "pagesize",
	...
	case "gov-usa-congress-trades-reports":
		return paginationDefaults{
			cursorParam: "page",
			cursorType:  "page",
			limitParam:  "pageSize",
...
func defaultSyncResources() []string {
	return []string{
		...
		"erx-gaps",
		"gov",
		"gov-usa-congress-trades-reports",
		"market",
		"news",
		"news-channels",
		"news-removed",
...
func knownSyncResourceNames() []string {
	names := []string{
		...
		"fundamentals-earning-reports",
		"fundamentals-income-statement",
		"fundamentals-operation-ratios",
		"fundamentals-share-class",
		"fundamentals-share-class-profile",
		"gov",
		"gov-usa-congress-trades-reports",
		"logos",
		"market",
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"analyst":                          "/api/v1/analyst/insights",
		"bars":                             "/api/v2/bars",
		"bulls-bears-say":                  "/api/v1/bulls_bears_say",
		"calendar":                         "/api/v2.1/calendar/ma",
		"calendar-conference-calls":        "/api/v2.1/calendar/conference-calls",
		"calendar-dividends":               "/api/v2.1/calendar/dividends",
		"calendar-earnings":                "/api/v2.1/calendar/earnings",
		"calendar-economics":               "/api/v2.1/calendar/economics",
		"calendar-fda":                     "/api/v2.1/calendar/fda",
		"calendar-guidance":                "/api/v2.1/calendar/guidance",
		"calendar-ipos":                    "/api/v2/calendar/ipos",
		"calendar-offerings":               "/api/v2.1/calendar/offerings",
		"calendar-ratings":                 "/api/v2.1/calendar/ratings",
		"calendar-ratings-analysts":        "/api/v2.1/calendar/ratings/analysts",
		"calendar-ratings-firms":           "/api/v2.1/calendar/ratings/firms",
		"calendar-removed":                 "/api/v2.1/calendar-removed/",
		"calendar-splits":                  "/api/v2.1/calendar/splits",
		"consensus-ratings":                "/api/v1/consensus-ratings",
		"earnings-call-transcripts":        "/api/v1/earnings-call-transcripts",
		"earnings-call-transcripts-audio":  "/api/v1/earnings-call-transcripts/audio",
		"erx-gaps":                         "/api/v1/erx_gaps",
		"fundamentals":                     "/api/v2/fundamentals",
		"fundamentals-company":             "/api/v2.1/fundamentals/company",
		"fundamentals-company-profile":     "/api/v2.1/fundamentals/companyProfile",
		"fundamentals-earning-reports":     "/api/v2.1/fundamentals/earningReports",
		"fundamentals-income-statement":    "/api/v3/fundamentals/income-statement",
		"fundamentals-operation-ratios":    "/api/v2/fundamentals/operationRatios",
		"fundamentals-share-class":         "/api/v2.1/fundamentals/shareClass",
		"fundamentals-share-class-profile": "/api/v2.1/fundamentals/shareClassProfile",
		"gov":                              "/api/v1/gov/usa/congress/trades",
		"gov-usa-congress-trades-reports":  "/api/v1/gov/usa/congress/trades/reports",
		"logos":                            "/api/v2.1/logos/sync",
		"market":                           "/api/v1/market/movers",
		"news":                             "/api/v2/news",
		"news-channels":                    "/api/v2.1/news/channels",
		"news-removed":                     "/api/v2/news-removed",
		"sec":                              "/api/v1/sec/insider_transactions/owners",
		"shortinterest":                    "/api/v1/shortinterest",
		"signal":                           "/api/v1/signal/block_trade",
		"signal-halt-resume":               "/api/v1/signal/halt_resume",
		"signal-option-activity":           "/api/v1/signal/option_activity",
		"trending-tickers":                 "/api/v1/trending-tickers",
	}
...
func responsePathForResource(resource, path string) []string {
	...
	case "analyst\x00/api/v1/analyst/insights":
		return []string{"analyst-insights"}
	case "bulls-bears-say\x00/api/v1/bulls_bears_say":
		return []string{"bulls-say-bears-say"}
	case "calendar\x00/api/v2.1/calendar/conference-calls":
		return []string{"conference-calls"}
	case "calendar\x00/api/v2.1/calendar/dividends":
		return []string{"dividends"}
	case "calendar\x00/api/v2.2/calendar/dividends":
		return []string{"dividends"}
	case "calendar\x00/api/v2.1/calendar/earnings":
		return []string{"earnings"}
	case "calendar\x00/api/v2.1/calendar/economics":
		return []string{"economics"}
	case "calendar\x00/api/v2/calendar/events":
		return []string{"events"}
	case "calendar\x00/api/v2.1/calendar/fda":
		return []string{"fda"}
	case "calendar\x00/api/v2.1/calendar/guidance":
		return []string{"guidance"}
	case "calendar\x00/api/v2/calendar/ipos":
		return []string{"ipos"}
	case "calendar\x00/api/v2.1/calendar/ipos":
		return []string{"ipos"}
	case "calendar\x00/api/v2.1/calendar/ma":
		return []string{"ma"}
	case "calendar\x00/api/v2.1/calendar/offerings":
		return []string{"offerings"}
	case "calendar\x00/api/v2.1/calendar/ratings":
		return []string{"ratings"}
	case "calendar\x00/api/v2.1/calendar/splits":
		return []string{"splits"}
	case "calendar-removed\x00/api/v2.1/calendar-removed/":
		return []string{"removed"}
	case "gov\x00/api/v1/gov/usa/congress/trades/reports":
		return []string{"data"}
	case "gov\x00/api/v1/gov/usa/congress/trades":
		return []string{"data"}
	case "logos\x00/api/v2.1/logos/sync":
		return []string{"errors"}
	case "logos\x00/api/v2/logos/search":
		return []string{"errors"}
	case "sec\x00/api/v1/sec/insider_transactions/{view_type}":
		return []string{"data"}
	case "sec\x00/api/v1/sec/insider_transactions/owners":
		return []string{"data"}
	case "signal\x00/api/v1/signal/block_trade":
		return []string{"block-trade"}
	case "trending-tickers\x00/api/v1/trending-tickers":
		return []string{"data"}
	case "trending-tickers\x00/api/v1/trending-tickers/list":
		return []string{"data"}
	}
	return nil
}
