...
Exit codes & warnings:
  ...
  ibkr-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  ibkr-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  ibkr-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  ibkr-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  ibkr-pp-cli sync --latest-only`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if dbPath == "" {
				dbPath = defaultDBPath("ibkr-pp-cli")
			}
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/ibkr-pp-cli/data.db)")
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "signatures_and_owners":
		return db.UpsertSignaturesAndOwners(data)
	case "fa":
		return db.UpsertFa(data)
	case "fyi":
		return db.UpsertFyi(data)
	case "gw":
		return db.UpsertGw(data)
	case "iserver":
		return db.UpsertIserver(data)
	case "oauth":
		return db.UpsertOauth(data)
	case "oauth2":
		return db.UpsertOauth2(data)
	case "allocation":
		return db.UpsertAllocation(data)
	case "combo":
		return db.UpsertCombo(data)
	case "ledger":
	...
	case "portfolio_positions":
		return db.UpsertPortfolioPositions(data)
	case "summary":
		return db.UpsertSummary(data)
	case "portfolio2_positions":
		return db.UpsertPortfolio2Positions(data)
	case "trsrv":
		return db.UpsertTrsrv(data)
	default:
...
func defaultSyncResources() []string {
	return []string{
		...
		"gw-api-v1-tax-vouchers-active-countries",
		"gw-api-v1-tax-vouchers-years",
		"iserver",
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"forecast": "/forecast/category/tree",
		"fyi": "/fyi/settings",
		"fyi-unreadnumber": "/fyi/unreadnumber",
		"gw": "/gw/api/v1/forms",
		"gw-api-v1-accounts": "/gw/api/v1/accounts",
		"gw-api-v1-echo-https": "/gw/api/v1/echo/https",
		"gw-api-v1-tax-vouchers-active-countries": "/gw/api/v1/tax-vouchers/active-countries",
		"gw-api-v1-tax-vouchers-years": "/gw/api/v1/tax-vouchers/years",
		"iserver": "/iserver/accounts",
		"iserver-account-allocation-accounts": "/iserver/account/allocation/accounts",
		"iserver-account-allocation-group": "/iserver/account/allocation/group",
		"iserver-account-allocation-presets": "/iserver/account/allocation/presets",
		"iserver-account-orders": "/iserver/account/orders",
		"iserver-account-pnl-partitioned": "/iserver/account/pnl/partitioned",
		"iserver-account-trades": "/iserver/account/trades",
		"iserver-marketdata-unsubscribeall": "/iserver/marketdata/unsubscribeall",
		"iserver-secdef-info": "/iserver/secdef/info",
		"iserver-watchlists": "/iserver/watchlists",
		"portfolio": "/portfolio/accounts",
		"portfolio-subaccounts": "/portfolio/subaccounts",
		"portfolio-subaccounts2": "/portfolio/subaccounts2",
		"sso": "/sso/validate",
	}
