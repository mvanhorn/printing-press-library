...
large datasets as it has no memory pressure.`,
  ...
  ibkr-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  ibkr-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  ibkr-pp-cli export <resource> --format jsonl | jq '.id'`,
