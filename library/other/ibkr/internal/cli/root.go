...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "ibkr-pp-cli",
		Short: "Manage ibkr resources via the ibkr API",
		Long: `Ibkr CLI
...
Health check: run 'ibkr-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("ibkr-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'ibkr-pp-cli profile list')")
	...
	rootCmd.AddCommand(newAceswsCmd(flags))
	rootCmd.AddCommand(newFaCmd(flags))
	rootCmd.AddCommand(newForecastCmd(flags))
	rootCmd.AddCommand(newFyiCmd(flags))
	rootCmd.AddCommand(newGwCmd(flags))
	rootCmd.AddCommand(newIserverCmd(flags))
	rootCmd.AddCommand(newOauthCmd(flags))
	rootCmd.AddCommand(newPaCmd(flags))
	rootCmd.AddCommand(newPortfolioCmd(flags))
	rootCmd.AddCommand(newPortfolio2Cmd(flags))
	rootCmd.AddCommand(newTrsrvCmd(flags))
	...
	rootCmd.AddCommand(newContractPromotedCmd(flags))
	rootCmd.AddCommand(newLogoutPromotedCmd(flags))
	rootCmd.AddCommand(newOauth2PromotedCmd(flags))
	rootCmd.AddCommand(newSsoPromotedCmd(flags))
	rootCmd.AddCommand(newTicklePromotedCmd(flags))
	rootCmd.AddCommand(newWsPromotedCmd(flags))
