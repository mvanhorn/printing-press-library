...
var whichIndex = []whichEntry{
	{Command: "inventory-check", Description: "Screen a bounded CSV inventory against CPSC product fields and expose exact identifiers and token-overlap evidence for every candidate.", Group: "", WhyItMatters: ""},
	{Command: "watch changes", Description: "Compare a bounded brand or product recall observation with its prior local snapshot and report new or materially changed records.", Group: "", WhyItMatters: ""},
	{Command: "hazard-pulse", Description: "Flatten recent hazard, remedy, injury, and product relationships while keeping recall counts distinct from incident rates.", Group: "", WhyItMatters: ""},
	{Command: "packet", Description: "Join one recall's affected products, remedy, contact, images, incidents, and official URL into an action packet.", Group: "", WhyItMatters: ""},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  cpsc-recalls-pp-cli which "stale tickets"
  cpsc-recalls-pp-cli which "bottleneck"
  cpsc-recalls-pp-cli which --limit 1 "send message"
  cpsc-recalls-pp-cli which                                # list the full capability index`,
