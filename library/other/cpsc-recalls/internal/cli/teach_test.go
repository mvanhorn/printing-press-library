...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("CPSC_RECALLS_STATE_DIR", "")
	t.Setenv("CPSC_RECALLS_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"cpsc-recalls-pp-cli auth login",
		"cpsc-recalls-pp-cli doctor",
		"cpsc-recalls-pp-cli help items",
		"cpsc-recalls-pp-cli sync",
		"cpsc-recalls-pp-cli profile list",
		"cpsc-recalls-pp-cli feedback list",
		"cpsc-recalls-pp-cli which",
		"cpsc-recalls-pp-cli agent-context",
		"cpsc-recalls-pp-cli completion bash",
		"cpsc-recalls-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"cpsc-recalls-pp-cli recall",
		"cpsc-recalls-pp-cli learnings",
		"cpsc-recalls-pp-cli teach-pattern",
		"cpsc-recalls-pp-cli teach-lookup",
		"cpsc-recalls-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("cpsc-recalls-pp-cli")); err == nil {
