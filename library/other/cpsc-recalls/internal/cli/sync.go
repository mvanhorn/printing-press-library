...
Resource scoping:
  ...
  cpsc-recalls-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  cpsc-recalls-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  cpsc-recalls-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  cpsc-recalls-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  cpsc-recalls-pp-cli sync --latest-only`,
