...
large datasets as it has no memory pressure.`,
  ...
  cpsc-recalls-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  cpsc-recalls-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  cpsc-recalls-pp-cli export <resource> --format jsonl | jq '.id'`,
		Args: cobra.RangeArgs(1, 2),
		RunE: func(cmd *cobra.Command, args []string) error {
			validResources := map[string]bool{
				"cpsc-recall-retrieval-recall": true,
			}
