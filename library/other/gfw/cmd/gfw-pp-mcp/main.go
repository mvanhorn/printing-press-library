...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/other/gfw/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "gfw-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
