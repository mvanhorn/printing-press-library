...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"ynab-pp-cli auth login",
		"ynab-pp-cli doctor",
		"ynab-pp-cli help items",
		"ynab-pp-cli sync",
		"ynab-pp-cli profile list",
		"ynab-pp-cli feedback list",
		"ynab-pp-cli which",
		"ynab-pp-cli agent-context",
		"ynab-pp-cli completion bash",
		"ynab-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"ynab-pp-cli teach",
		"ynab-pp-cli recall",
		"ynab-pp-cli learnings",
		"ynab-pp-cli teach-pattern",
		"ynab-pp-cli teach-lookup",
		"ynab-pp-cli items list",
	}
