...
var whichIndex = []whichEntry{
	{Command: "export balances", Description: "One-shot export of current account balances reshaped into ProjectionLab's expected schema, ready to sync into a net-worth projection tool.", Group: "Agent-native plumbing", WhyItMatters: "Use this to feed another finance tool's import step; it's the direct replacement for a hand-maintained account-mapping script."},
	{Command: "accounts reconcile", Description: "Diff the local cleared-transaction total against a bank statement balance and surface the transaction(s) most likely responsible for the gap.", Group: "Local state that compounds", WhyItMatters: "Use this monthly instead of eyeballing a statement line by line."},
	{Command: "payees profile", Description: "Aggregated monthly spend stats, average transaction size, and typical categories for a single payee.", Group: "Local state that compounds", WhyItMatters: "Use this to understand a recurring payee's spend pattern rather than scanning raw transaction lists."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  ynab-pp-cli which "stale tickets"
  ynab-pp-cli which "bottleneck"
  ynab-pp-cli which --limit 1 "send message"
  ynab-pp-cli which                                # list the full capability index`,
