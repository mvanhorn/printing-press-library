...
func TestDeclaredAPISurfaceReachable(t *testing.T) {
	expected := []string{
		...
		"accounts transactions get-by-account",
		"categories",
		"categories create-category",
		"categories get",
		"categories get-category-by-id",
		"categories transactions",
		"categories transactions get-by-category",
		...
		"months",
		"months categories",
		"months categories get-month-category-by-id",
		"months categories update-month-category",
		"months get-plan",
		"months get-plan-plans",
		"months money-movement-groups",
		"months money-movement-groups get-by-month",
		"months money-movements",
		"months money-movements get-by-month",
		"months transactions",
		"months transactions get-by-month",
		"payee-locations",
		"payee-locations get",
		"payee-locations get-by-id",
		"payees",
		"payees create",
		"payees get",
		"payees get-by-id",
		"payees payee-locations",
		"payees payee-locations get-by-payee",
		"payees transactions",
		"payees transactions get-by-payee",
		"payees update",
		"plans",
		"plans get",
		"plans get-by-id",
		...
		"scheduled-transactions get-by-id",
