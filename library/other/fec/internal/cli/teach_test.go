...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"fec-pp-cli auth login",
		"fec-pp-cli doctor",
		"fec-pp-cli help items",
		"fec-pp-cli sync",
		"fec-pp-cli profile list",
		"fec-pp-cli feedback list",
		"fec-pp-cli which",
		"fec-pp-cli agent-context",
		"fec-pp-cli completion bash",
		"fec-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"fec-pp-cli teach",
		"fec-pp-cli recall",
		"fec-pp-cli learnings",
		"fec-pp-cli teach-pattern",
		"fec-pp-cli teach-lookup",
		"fec-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("fec-pp-cli")); err == nil {
