...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  fec-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  fec-pp-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"audit-case", "audit-category", "audit-primary-category", "calendar-dates", "calendar-dates-export", "candidates", "candidates-totals", "candidates-totals-aggregates", "committees", "communication-costs", "communication-costs-aggregates", "communication-costs-by-candidate", "communication-costs-totals-by-candidate", "efile", "efile-filings", "efile-form2", "efile-reports-house-senate", "efile-reports-pac-party", "efile-reports-presidential", "election-dates", "electioneering", "electioneering-aggregates", "electioneering-by-candidate", "electioneering-totals-by-candidate", "filings", "national-party", "national-party-schedule-a", "national-party-schedule-b", "operations-log", "presidential", "presidential-contributions-by-candidate", "presidential-contributions-by-size", "presidential-contributions-by-state", "presidential-financial-summary", "rad-analyst", "reporting-dates", "schedules", "schedules-schedule-a-by-employer", "schedules-schedule-a-by-occupation", "schedules-schedule-a-by-size", "schedules-schedule-a-by-state", "schedules-schedule-a-by-state-totals", "schedules-schedule-a-by-zip", "schedules-schedule-a-efile", "schedules-schedule-a-form5", "schedules-schedule-b", "schedules-schedule-b-by-purpose", "schedules-schedule-b-by-recipient", "schedules-schedule-b-by-recipient-id", "schedules-schedule-b-efile", "schedules-schedule-c", "schedules-schedule-d", "schedules-schedule-e", "schedules-schedule-e-by-candidate", "schedules-schedule-e-efile", "schedules-schedule-e-totals-by-candidate", "schedules-schedule-f", "schedules-schedule-h4", "schedules-schedule-h4-efile", "totals-inaugural-committees-by-contributor"}
			totalSynced := 0
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  fec-pp-cli workflow status

  # Show status as JSON
  fec-pp-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("fec-pp-cli")
			}
