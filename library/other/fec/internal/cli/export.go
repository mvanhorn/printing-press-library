...
large datasets as it has no memory pressure.`,
  ...
  fec-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  fec-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  fec-pp-cli export <resource> --format jsonl | jq '.id'`,
		Args: cobra.RangeArgs(1, 2),
		RunE: func(cmd *cobra.Command, args []string) error {
			validResources := map[string]bool{
				"audit-case":             true,
				"audit-category":         true,
				"audit-primary-category": true,
				"calendar-dates":         true,
				"candidates":             true,
				"committees":             true,
				"communication-costs":    true,
				"efile":                  true,
				"election-dates":         true,
				"electioneering":         true,
				"elections":              true,
				...
				"presidential":           true,
				"rad-analyst":            true,
				"reporting-dates":        true,
				"rulemaking":             true,
				"schedules":              true,
				"state-election-office":  true,
				"totals":                 true,
			}
