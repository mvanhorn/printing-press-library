...
type rootFlags struct {
	...
	// invocation. Mirrors the FEC_NO_LEARN env var.
	noLearn       bool
	selectFields  string
	configPath    string
	homePath      string
...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "fec-pp-cli",
		Short: "Manage fec resources via the fec API",
		Long: `Manage fec resources via the fec API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'fec-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("fec-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'fec-pp-cli profile list')")
	...
	rootCmd.AddCommand(newCalendarDatesCmd(flags))
	rootCmd.AddCommand(newCandidatesCmd(flags))
	rootCmd.AddCommand(newCommunicationCostsCmd(flags))
	rootCmd.AddCommand(newEfileCmd(flags))
	rootCmd.AddCommand(newElectioneeringCmd(flags))
	rootCmd.AddCommand(newElectionsCmd(flags))
	rootCmd.AddCommand(newLegalCmd(flags))
	rootCmd.AddCommand(newNamesCmd(flags))
	rootCmd.AddCommand(newNationalPartyCmd(flags))
	rootCmd.AddCommand(newPresidentialCmd(flags))
	rootCmd.AddCommand(newSchedulesCmd(flags))
	rootCmd.AddCommand(newTotalsCmd(flags))
	...
	rootCmd.AddCommand(newAuditCasePromotedCmd(flags))
	rootCmd.AddCommand(newAuditCategoryPromotedCmd(flags))
	rootCmd.AddCommand(newAuditPrimaryCategoryPromotedCmd(flags))
	rootCmd.AddCommand(newCandidatePromotedCmd(flags))
	rootCmd.AddCommand(newCommitteePromotedCmd(flags))
	rootCmd.AddCommand(newCommitteesPromotedCmd(flags))
	rootCmd.AddCommand(newElectionDatesPromotedCmd(flags))
	rootCmd.AddCommand(newFilingsPromotedCmd(flags))
	rootCmd.AddCommand(newOperationsLogPromotedCmd(flags))
	rootCmd.AddCommand(newRadAnalystPromotedCmd(flags))
	rootCmd.AddCommand(newReportingDatesPromotedCmd(flags))
	rootCmd.AddCommand(newReportsPromotedCmd(flags))
	rootCmd.AddCommand(newRulemakingPromotedCmd(flags))
	rootCmd.AddCommand(newStateElectionOfficePromotedCmd(flags))
