...
type rootFlags struct {
	...
	// invocation. Mirrors the INDMONEY_NO_LEARN env var.
	noLearn                 bool
	selectFields            string
	configPath              string
	homePath                string
...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "indmoney-pp-cli",
		Short: `Scrape your INDmoney US stock portfolio, holdings, P&L, and full buy/sell order history.`,
		Long: `Scrape your INDmoney US stock portfolio, holdings, P&L, and full buy/sell order history.
...
Health check: run 'indmoney-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("indmoney-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.runProfileName, "profile", "", "Apply values from a saved run profile; this does not select a client (see 'indmoney-pp-cli profile list')")
