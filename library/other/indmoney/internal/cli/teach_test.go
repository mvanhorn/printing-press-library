...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"indmoney-pp-cli auth login",
		"indmoney-pp-cli doctor",
		"indmoney-pp-cli help items",
		"indmoney-pp-cli sync",
		"indmoney-pp-cli profile list",
		"indmoney-pp-cli feedback list",
		"indmoney-pp-cli which",
		"indmoney-pp-cli agent-context",
		"indmoney-pp-cli completion bash",
		"indmoney-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"indmoney-pp-cli recall",
		"indmoney-pp-cli learnings",
		"indmoney-pp-cli teach-pattern",
		"indmoney-pp-cli teach-lookup",
		"indmoney-pp-cli items list",
	}
