...
large datasets as it has no memory pressure.`,
  ...
  indmoney-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  indmoney-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  indmoney-pp-cli export <resource> --format jsonl | jq '.id'`,
