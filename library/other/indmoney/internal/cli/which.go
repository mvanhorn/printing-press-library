...
var whichIndex = []whichEntry{
	{Command: "portfolio summary", Description: "See your total invested value, current value, overall P&L, and day change across all US stock holdings.", Group: "Portfolio visibility", WhyItMatters: "Get instant portfolio overview without opening the INDmoney app."},
	{Command: "portfolio holdings", Description: "List every stock you hold with quantity, avg price, current value, unrealised gains, and day P&L.", Group: "Portfolio visibility", WhyItMatters: "Filter and sort holdings by any field without the INDmoney UI's fixed views."},
	{Command: "orders list", Description: "Every buy and sell order you have placed, with transaction type, quantity, avg price, and status.", Group: "Trade history", WhyItMatters: "Export your full trade history for tax reporting or analysis in one command."},
	{Command: "sync", Description: "Download all portfolio data and order history into a local SQLite database for offline analysis.", Group: "Local state that compounds", WhyItMatters: "Build a local historical record of your portfolio snapshots and query it with SQL."},
	{Command: "indices list", Description: "Live prices for Nasdaq, S&P 500, Dow Jones, and other US indices with market status.", Group: "Market context", WhyItMatters: "Quick market context before making trading decisions."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  indmoney-pp-cli which "stale tickets"
  indmoney-pp-cli which "bottleneck"
  indmoney-pp-cli which --limit 1 "send message"
  indmoney-pp-cli which                                # list the full capability index`,
