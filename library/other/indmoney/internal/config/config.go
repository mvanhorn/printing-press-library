...
type Config struct {
	...
	IndmoneyToken    string          `json:"token"`
}

func Load(configPath string) (*Config, error) {
	cfg := &Config{
		BaseURL: "https://apixt-us.indmoney.com/us-stock-broker/us",
	}
	...
	// Env var overrides
	if v := os.Getenv("INDMONEY_TOKEN"); v != "" {
		cfg.IndmoneyToken = v
		cfg.markEnvOverride("IndmoneyToken")
		cfg.AuthSource = "env:INDMONEY_TOKEN"
		cfg.CredentialSource = "env:INDMONEY_TOKEN"
	}
	...
	if v := os.Getenv("INDMONEY_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("INDMONEY_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "indmoney-pp-cli", "config.json"), nil
}
...
func (c *Config) AuthHeader() string {
	...
	if c.IndmoneyToken != "" {
		if c.AuthSource == "" {
			c.AuthSource = "env:INDMONEY_TOKEN"
		}
		return "Bearer " + c.IndmoneyToken
	}
	if c.AccessToken != "" {
...
func (c *Config) applyCredentials(creds *cliutil.Credentials) {
	...
	if c.IndmoneyToken == "" {
		c.IndmoneyToken = creds.IndmoneyToken
	}
}
...
func (c *Config) ClearTokens() error {
	...
	c.updateFileConfigField("ClientSecret")
	c.IndmoneyToken = ""
	delete(c.envOverrides, "IndmoneyToken")
	c.updateFileConfigField("IndmoneyToken")
	if c.AgentcookieManagedByExternalStore() {
		c.markAgentcookieManaged()
...
func (c *Config) configForSave() Config {
	out := *c
	if c.fileConfig != nil {
		if c.envOverrides["IndmoneyToken"] {
			out.IndmoneyToken = c.fileConfig.IndmoneyToken
		}
	}
...
func (c *Config) updateFileConfigField(field string) {
	...
	case "IndmoneyToken":
		c.fileConfig.IndmoneyToken = c.IndmoneyToken
	}
}
