...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/other/indmoney/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("INDMONEY_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "indmoney-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
