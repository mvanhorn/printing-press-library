...
but do not stop the import.`,
  ...
  peloton-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  peloton-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | peloton-pp-cli import <resource> --input -`,
