...
func Load(configPath string) (*Config, error) {
	...
	if v := os.Getenv("NONPROFIT_EXPLORER_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("NONPROFIT_EXPLORER_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "nonprofit-explorer-pp-cli", "config.toml"), nil
}
