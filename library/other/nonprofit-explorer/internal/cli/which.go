...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  nonprofit-explorer-pp-cli which "stale tickets"
  nonprofit-explorer-pp-cli which "bottleneck"
  nonprofit-explorer-pp-cli which --limit 1 "send message"
  nonprofit-explorer-pp-cli which                                # list the full capability index`,
