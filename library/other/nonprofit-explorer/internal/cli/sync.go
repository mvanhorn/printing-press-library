...
Resource scoping:
  ...
  nonprofit-explorer-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  nonprofit-explorer-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  nonprofit-explorer-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  nonprofit-explorer-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  nonprofit-explorer-pp-cli sync --latest-only`,
