...
//
// Hand-authored embedded NTEE-CC code table (recorded in
// .printing-press-patches/ext-nonprofit-commands.md). Source: Urban Institute
// NCCS National Taxonomy of Exempt Entities (NTEE-CC) classification table.
// Used by ext_nonprofit.go to render human names for full 3-char NTEE codes
// (e.g. T23 -> "Private Operating Foundations"); the letter-only major-group
// fallback lives in nteeMajor.

package cli

// nteeCodeNames maps full NTEE-CC codes to their standard names.
var nteeCodeNames = map[string]string{
