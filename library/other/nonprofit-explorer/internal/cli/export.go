...
large datasets as it has no memory pressure.`,
  ...
  nonprofit-explorer-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  nonprofit-explorer-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  nonprofit-explorer-pp-cli export <resource> --format jsonl | jq '.id'`,
