...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("NONPROFIT_EXPLORER_STATE_DIR", "")
	t.Setenv("NONPROFIT_EXPLORER_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"nonprofit-explorer-pp-cli auth login",
		"nonprofit-explorer-pp-cli doctor",
		"nonprofit-explorer-pp-cli help items",
		"nonprofit-explorer-pp-cli sync",
		"nonprofit-explorer-pp-cli profile list",
		"nonprofit-explorer-pp-cli feedback list",
		"nonprofit-explorer-pp-cli which",
		"nonprofit-explorer-pp-cli agent-context",
		"nonprofit-explorer-pp-cli completion bash",
		"nonprofit-explorer-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"nonprofit-explorer-pp-cli recall",
		"nonprofit-explorer-pp-cli learnings",
		"nonprofit-explorer-pp-cli teach-pattern",
		"nonprofit-explorer-pp-cli teach-lookup",
		"nonprofit-explorer-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("nonprofit-explorer-pp-cli")); err == nil {
