...
const (
	journalSessionEnvVar   = "NONPROFIT_EXPLORER_LEARN_SESSION"
	journalNoLearnEnvVar   = "NONPROFIT_EXPLORER_NO_LEARN"
	journalNoCaptureEnvVar = "NONPROFIT_EXPLORER_LEARN_NO_CAPTURE"
)
