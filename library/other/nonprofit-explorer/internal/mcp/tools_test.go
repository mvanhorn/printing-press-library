...
func TestMCPPathResolutionMatchesCLIResolverWithHomeEnv(t *testing.T) {
	...
	t.Setenv("NONPROFIT_EXPLORER_HOME", root)
...
func TestMCPPathResolutionMatchesCLIResolverWithPlatformDefaults(t *testing.T) {
	...
	if want := filepath.Join(home, ".config", "nonprofit-explorer-pp-cli", "config.toml"); cfg.Path != want {
	...
	if want := filepath.Join(home, ".local", "share", "nonprofit-explorer-pp-cli", "data.db"); gotDB != want {
...
func resetMCPPathEnv(t *testing.T) string {
	...
	for _, name := range []string{
		"NONPROFIT_EXPLORER_CONFIG",
		"NONPROFIT_EXPLORER_CONFIG_DIR",
		"NONPROFIT_EXPLORER_DATA_DIR",
		"NONPROFIT_EXPLORER_STATE_DIR",
		"NONPROFIT_EXPLORER_CACHE_DIR",
		"NONPROFIT_EXPLORER_HOME",
		"XDG_CONFIG_HOME",
		"XDG_DATA_HOME",
		"XDG_STATE_HOME",
		"XDG_CACHE_HOME",
...
func TestMCPRegisterToolsPreservesTypedSpecialTools(t *testing.T) {
	s := server.NewMCPServer("nonprofit-explorer", "test")
	RegisterTools(s)
