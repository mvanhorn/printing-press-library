...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/other/nonprofit-explorer/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("NONPROFIT_EXPLORER_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "nonprofit-explorer-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
