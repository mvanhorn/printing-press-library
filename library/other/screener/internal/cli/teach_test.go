...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"screener-pp-cli auth login",
		"screener-pp-cli doctor",
		"screener-pp-cli help items",
		"screener-pp-cli sync",
		"screener-pp-cli profile list",
		"screener-pp-cli feedback list",
		"screener-pp-cli which",
		"screener-pp-cli agent-context",
		"screener-pp-cli completion bash",
		"screener-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"screener-pp-cli recall",
		"screener-pp-cli learnings",
		"screener-pp-cli teach-pattern",
		"screener-pp-cli teach-lookup",
		"screener-pp-cli items list",
	}
