...
var readCommandResources = map[string][]string{
	"screener-pp-cli explore":                 {"explore"},
	"screener-pp-cli explore list":            {"explore"},
	"screener-pp-cli explore get":             {"explore"},
	"screener-pp-cli explore search":          {"explore"},
	"screener-pp-cli filings":                 {"filings"},
	"screener-pp-cli filings list":            {"filings"},
	"screener-pp-cli filings get":             {"filings"},
	"screener-pp-cli filings search":          {"filings"},
	"screener-pp-cli full_text_search":        {"full_text_search"},
	"screener-pp-cli full_text_search list":   {"full_text_search"},
	"screener-pp-cli full_text_search get":    {"full_text_search"},
	"screener-pp-cli full_text_search search": {"full_text_search"},
	"screener-pp-cli ipo":                     {"ipo"},
	"screener-pp-cli ipo list":                {"ipo"},
	"screener-pp-cli ipo get":                 {"ipo"},
	"screener-pp-cli ipo search":              {"ipo"},
	"screener-pp-cli screens":                 {"screens"},
	"screener-pp-cli screens list":            {"screens"},
	"screener-pp-cli screens get":             {"screens"},
	"screener-pp-cli screens search":          {"screens"},
}
...
func cachePolicy() cliutil.Policy {
	...
	envOptOut := "SCREENER_NO_AUTO_REFRESH"
...
func autoRefreshIfStale(ctx context.Context, flags *rootFlags, resources []string) (meta cliutil.FreshnessMeta) {
	...
	if err := runAutoRefresh(refreshCtx, flags, db, resources); err != nil {
		fmt.Fprintf(os.Stderr, "warning: using stale screener-pp-cli cache (refresh failed: %v)\n", err)
