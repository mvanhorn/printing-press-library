...
large datasets as it has no memory pressure.`,
  ...
  screener-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  screener-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  screener-pp-cli export <resource> --format jsonl | jq '.id'`,
