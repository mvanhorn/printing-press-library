# AGENTS.md — using insurance-finder programmatically
...
insurance-finder --agent --profile ./acme.json match
...
insurance-finder --agent --profile ./acme.json answersheet insurance-canopy
```
...
`insurance-finder checklist <id>` returns these per provider as JSON.
