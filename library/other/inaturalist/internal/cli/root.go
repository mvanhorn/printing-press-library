...
type rootFlags struct {
	...
	// invocation. Mirrors the INATURALIST_NO_LEARN env var.
	noLearn bool
...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "inaturalist-pp-cli",
		Short: `Inaturalist CLI — Explore iNaturalist's full API, plus privacy-safe field briefings and identification progress that ordinary endpoint…`,
		Long: `Inaturalist CLI — Explore iNaturalist's full API, plus privacy-safe field briefings and identification progress that ordinary endpoint wrappers miss.
...
Health check: run 'inaturalist-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("inaturalist-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'inaturalist-pp-cli profile list')")
	...
	rootCmd.AddCommand(newColoredHeatmapCmd(flags))
	rootCmd.AddCommand(newCommentsCmd(flags))
	rootCmd.AddCommand(newControlledTermsCmd(flags))
	rootCmd.AddCommand(newFlagsCmd(flags))
	rootCmd.AddCommand(newGridCmd(flags))
	rootCmd.AddCommand(newHeatmapCmd(flags))
	rootCmd.AddCommand(newIdentificationsCmd(flags))
	rootCmd.AddCommand(newMessagesCmd(flags))
	rootCmd.AddCommand(newObservationFieldValuesCmd(flags))
	rootCmd.AddCommand(newObservationPhotosCmd(flags))
	rootCmd.AddCommand(newObservationsCmd(flags))
	rootCmd.AddCommand(newPlacesCmd(flags))
	rootCmd.AddCommand(newPointsCmd(flags))
	rootCmd.AddCommand(newPostsCmd(flags))
	rootCmd.AddCommand(newProjectObservationsCmd(flags))
	rootCmd.AddCommand(newProjectsCmd(flags))
	rootCmd.AddCommand(newSubscriptionsCmd(flags))
	rootCmd.AddCommand(newTaxaCmd(flags))
	rootCmd.AddCommand(newTaxonPlacesCmd(flags))
	rootCmd.AddCommand(newTaxonRangesCmd(flags))
	rootCmd.AddCommand(newUsersCmd(flags))
	rootCmd.AddCommand(newVotesCmd(flags))
	...
	rootCmd.AddCommand(newNovelHuntCmd(flags))
	rootCmd.AddCommand(newNovelNearbyCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newPhotosPromotedCmd(flags))
	rootCmd.AddCommand(newSiteSearchPromotedCmd(flags))
