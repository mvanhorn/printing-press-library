...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("INATURALIST_STATE_DIR", "")
	t.Setenv("INATURALIST_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"inaturalist-pp-cli auth login",
		"inaturalist-pp-cli doctor",
		"inaturalist-pp-cli help items",
		"inaturalist-pp-cli sync",
		"inaturalist-pp-cli profile list",
		"inaturalist-pp-cli feedback list",
		"inaturalist-pp-cli which",
		"inaturalist-pp-cli agent-context",
		"inaturalist-pp-cli completion bash",
		"inaturalist-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"inaturalist-pp-cli recall",
		"inaturalist-pp-cli learnings",
		"inaturalist-pp-cli teach-pattern",
		"inaturalist-pp-cli teach-lookup",
		"inaturalist-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("inaturalist-pp-cli")); err == nil {
