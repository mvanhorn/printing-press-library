...
var whichIndex = []whichEntry{
	{Command: "nearby highlights", Description: "Get a transparent, recent wildlife briefing for an area without exposing observation coordinates.", Group: "Privacy-safe field briefings", WhyItMatters: "Use this when an agent needs an explanation-backed local wildlife overview rather than a raw observation list."},
	{Command: "hunt create", Description: "Create a factual, balanced nature scavenger-hunt checklist from taxa actually observed nearby.", Group: "Privacy-safe field briefings", WhyItMatters: "Use this to turn local biodiversity evidence into a safe field activity with traceable taxa."},
	{Command: "observations id-status", Description: "See which of an observer's recent observations are identified, need IDs, disagree, or have no taxon.", Group: "Identification progress", WhyItMatters: "Use this for a current identification-progress answer instead of manually filtering raw observations."},
	{Command: "observations id-changes", Description: "Report observations that became identified, changed, withdrew, or still need IDs since a previous privacy-safe sync.", Group: "Identification progress", WhyItMatters: "Use this to find identification progress since the last check without fabricating history."},
	{Command: "nearby seasonal-shift", Description: "Compare two field windows and surface taxa that newly appeared, returned, or changed materially.", Group: "Privacy-safe field briefings", WhyItMatters: "Use this to answer how local wildlife changed between explicit time windows."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  inaturalist-pp-cli which "stale tickets"
  inaturalist-pp-cli which "bottleneck"
  inaturalist-pp-cli which --limit 1 "send message"
  inaturalist-pp-cli which                                # list the full capability index`,
