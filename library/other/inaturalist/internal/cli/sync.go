...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/other/inaturalist/internal/learn/lookups"
...
Resource scoping:
  ...
  inaturalist-pp-cli sync

  # Sync specific resources only
  inaturalist-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  inaturalist-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  inaturalist-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  inaturalist-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  inaturalist-pp-cli sync --latest-only`,
...
func determinePaginationDefaults(resource string) paginationDefaults {
	...
	case "identifications-categories":
		return paginationDefaults{
			cursorParam: "page",
			cursorType:  "page",
			limitParam:  "per_page",
	...
	case "identifications-identifiers":
		return paginationDefaults{
			cursorParam: "page",
			cursorType:  "page",
			limitParam:  "per_page",
	...
	case "identifications-observers":
		return paginationDefaults{
			cursorParam: "page",
			cursorType:  "page",
			limitParam:  "per_page",
	...
	case "identifications-recent-taxa":
		return paginationDefaults{
			cursorParam: "page",
			cursorType:  "page",
			limitParam:  "per_page",
	...
	case "identifications-species-counts":
		return paginationDefaults{
			cursorParam: "page",
			cursorType:  "page",
			limitParam:  "per_page",
	...
	case "observations-species-counts":
		return paginationDefaults{
			cursorParam: "page",
			cursorType:  "page",
			limitParam:  "per_page",
...
func syncResourceSinceParam(resource string) string {
	switch resource {
	case "identifications-similar-species":
		return "updated_since"
	case "observations":
		return "updated_since"
	case "observations-deleted":
		return "since"
	case "observations-histogram":
		return "updated_since"
	case "observations-identifiers":
		return "updated_since"
	case "observations-observers":
		return "updated_since"
	case "observations-popular-field-values":
		return "updated_since"
	case "observations-species-counts":
		return "updated_since"
	case "observations-updates":
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "colored_heatmap_y_grid_json":
		return db.UpsertColoredHeatmapYGridJson(data)
	case "colored_heatmap_y_png":
		return db.UpsertColoredHeatmapYPng(data)
	case "grid_y_grid_json":
		return db.UpsertGridYGridJson(data)
	case "grid_y_png":
		return db.UpsertGridYPng(data)
	case "heatmap_y_grid_json":
		return db.UpsertHeatmapYGridJson(data)
	case "heatmap_y_png":
		return db.UpsertHeatmapYPng(data)
	case "identifications":
		return db.UpsertIdentifications(data)
	case "messages":
		return db.UpsertMessages(data)
	case "observations":
		return db.UpsertObservations(data)
	case "fave":
		return db.UpsertFave(data)
	case "quality":
		return db.UpsertQuality(data)
	case "review":
		return db.UpsertReview(data)
	case "observations_subscriptions":
		return db.UpsertObservationsSubscriptions(data)
	case "taxon_summary":
		return db.UpsertTaxonSummary(data)
	case "unfave":
		return db.UpsertUnfave(data)
	case "viewed_updates":
		return db.UpsertViewedUpdates(data)
	case "places":
		return db.UpsertPlaces(data)
	case "places_y_png":
		return db.UpsertPlacesYPng(data)
	case "points_y_grid_json":
		return db.UpsertPointsYGridJson(data)
	case "points_y_png":
		return db.UpsertPointsYPng(data)
	case "projects":
	...
	case "remove":
		return db.UpsertRemove(data)
	case "projects_subscriptions":
		return db.UpsertProjectsSubscriptions(data)
	case "taxa":
		return db.UpsertTaxa(data)
	case "taxon_places_y_png":
		return db.UpsertTaxonPlacesYPng(data)
	case "taxon_ranges_y_png":
		return db.UpsertTaxonRangesYPng(data)
	case "mute":
		return db.UpsertMute(data)
	case "users_projects":
		return db.UpsertUsersProjects(data)
	default:
...
func knownSyncResourceNames() []string {
	names := []string{
		...
		"identifications-recent-taxa",
		"identifications-similar-species",
		"identifications-species-counts",
		"messages",
		"messages-unread",
		"observations",
		"observations-deleted",
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{ // #nosec G101 -- endpoint paths, not credentials.
		...
		"controlled-terms-for-taxon":        "/controlled_terms/for_taxon",
		"identifications":                   "/identifications",
		"identifications-categories":        "/identifications/categories",
		"identifications-identifiers":       "/identifications/identifiers",
		"identifications-observers":         "/identifications/observers",
		"identifications-recent-taxa":       "/identifications/recent_taxa",
		"identifications-similar-species":   "/identifications/similar_species",
		"identifications-species-counts":    "/identifications/species_counts",
		"messages":                          "/messages",
		"messages-unread":                   "/messages/unread",
		"observations":                      "/observations",
		"observations-deleted":              "/observations/deleted",
		"observations-histogram":            "/observations/histogram",
		"observations-identifiers":          "/observations/identifiers",
		"observations-observers":            "/observations/observers",
		"observations-popular-field-values": "/observations/popular_field_values",
		"observations-species-counts":       "/observations/species_counts",
		"observations-updates":              "/observations/updates",
		"places":                            "/places/nearby",
		"places-autocomplete":               "/places/autocomplete",
		"posts":                             "/posts",
		"posts-for-user":                    "/posts/for_user",
		"projects":                          "/projects",
		"projects-autocomplete":             "/projects/autocomplete",
		"site_search":                       "/search",
		"taxa":                              "/taxa",
		"taxa-autocomplete":                 "/taxa/autocomplete",
		"users":                             "/users/me",
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "members", ParentTable: "projects", ParentIDParam: "id", PathTemplate: "/projects/{id}/members", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "users_projects", ParentTable: "users", ParentIDParam: "id", PathTemplate: "/users/{id}/projects", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
	}
}
...
var reconcileTypedTables = map[string]string{
	"add":                         "add",
	"colored_heatmap_y_grid_json": "colored_heatmap_y_grid_json",
	"colored_heatmap_y_png":       "colored_heatmap_y_png",
	"fave":                        "fave",
	"grid_y_grid_json":            "grid_y_grid_json",
	"grid_y_png":                  "grid_y_png",
	"heatmap_y_grid_json":         "heatmap_y_grid_json",
	"heatmap_y_png":               "heatmap_y_png",
	"identifications":             "identifications",
	"join":                        "join",
	"leave":                       "leave",
	"members":                     "members",
	...
	"mute":                        "mute",
	"observations":                "observations",
	"observations_subscriptions":  "observations_subscriptions",
	"places":                      "places",
	"places_y_png":                "places_y_png",
	"points_y_grid_json":          "points_y_grid_json",
	"points_y_png":                "points_y_png",
	"projects":                    "projects",
	"projects_subscriptions":      "projects_subscriptions",
	"quality":                     "quality",
	"remove":                      "remove",
	"review":                      "review",
	"taxa":                        "taxa",
	"taxon_places_y_png":          "taxon_places_y_png",
	"taxon_ranges_y_png":          "taxon_ranges_y_png",
...
func responsePathForResource(resource, path string) []string {
	...
	case "messages\x00/messages":
		return []string{"thread_flags"}
	case "messages\x00/messages/{id}":
