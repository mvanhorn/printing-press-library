...
large datasets as it has no memory pressure.`,
  ...
  inaturalist-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  inaturalist-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  inaturalist-pp-cli export <resource> --format jsonl | jq '.id'`,
		Args: cobra.RangeArgs(1, 2),
		RunE: func(cmd *cobra.Command, args []string) error {
			validResources := map[string]bool{
				"controlled-terms": true,
