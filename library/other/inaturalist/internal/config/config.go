...
type Config struct {
	...
	InaturalistApiToken string          `toml:"api_token"`
}
...
func Load(configPath string) (*Config, error) {
	...
	// Env var overrides
	if v := os.Getenv("INATURALIST_API_TOKEN"); v != "" {
		cfg.InaturalistApiToken = v
		cfg.markEnvOverride("InaturalistApiToken")
		cfg.AuthSource = "env:INATURALIST_API_TOKEN"
		cfg.CredentialSource = "env:INATURALIST_API_TOKEN"
	}
	...
	if v := os.Getenv("INATURALIST_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("INATURALIST_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "inaturalist-pp-cli", "config.toml"), nil
}
...
func (c *Config) AuthHeader() string {
	...
	token := c.InaturalistApiToken
	if token == "" {
		return ""
	}
	if c.InaturalistApiToken == "" {
		return ""
	}
	return token
}
...
func (c *Config) credentials() *cliutil.Credentials {
	return &cliutil.Credentials{
		...
		InaturalistApiToken: c.InaturalistApiToken,
	}
}
...
func (c *Config) applyCredentials(creds *cliutil.Credentials) {
	...
	c.InaturalistApiToken = creds.InaturalistApiToken
}
...
func (c *Config) SaveCredential(token string) error {
	...
	c.updateFileConfigField("AccessToken")
	c.InaturalistApiToken = token
	delete(c.envOverrides, "InaturalistApiToken")
	c.updateFileConfigField("InaturalistApiToken")
	if err := c.saveCredentialsFirst(); err != nil {
		return err
	}
	return c.save()
...
func (c *Config) configForSave() Config {
	out := *c
	if c.fileConfig != nil {
		if c.envOverrides["InaturalistApiToken"] {
			out.InaturalistApiToken = c.fileConfig.InaturalistApiToken
		}
	}
...
func (c *Config) updateFileConfigField(field string) {
	...
	case "InaturalistApiToken":
		c.fileConfig.InaturalistApiToken = c.InaturalistApiToken
	}
}
