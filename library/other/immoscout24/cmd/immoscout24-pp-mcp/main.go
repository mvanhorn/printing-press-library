...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/other/immoscout24/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "immoscout24-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
