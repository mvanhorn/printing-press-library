...
but do not stop the import.`,
  ...
  rippling-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  rippling-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | rippling-pp-cli import <resource> --input -`,
