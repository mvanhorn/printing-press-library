...
Exit codes & warnings:
  ...
  rippling-pp-cli sync

  # Sync specific resources only
  rippling-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  rippling-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  rippling-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  rippling-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  rippling-pp-cli sync --latest-only`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if dbPath == "" {
				dbPath = defaultDBPath("rippling-pp-cli")
			}
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/rippling-pp-cli/data.db)")
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	switch resource {
	case "break_types":
		return db.UpsertBreakTypes(data)
	case "business_partner_groups":
		return db.UpsertBusinessPartnerGroups(data)
	case "business_partners":
		return db.UpsertBusinessPartners(data)
	case "company_legal_entities":
		return db.UpsertCompanyLegalEntities(data)
	case "company_legal_entity_workers":
		return db.UpsertCompanyLegalEntityWorkers(data)
	case "compensation_bands_details":
		return db.UpsertCompensationBandsDetails(data)
	case "compensations":
		return db.UpsertCompensations(data)
	case "custom_apps":
		return db.UpsertCustomApps(data)
	case "custom_objects":
		return db.UpsertCustomObjects(data)
	case "fields":
		return db.UpsertFields(data)
	case "records":
		return db.UpsertRecords(data)
	case "custom_pages":
		return db.UpsertCustomPages(data)
	case "custom_settings":
		return db.UpsertCustomSettings(data)
	case "departments":
		return db.UpsertDepartments(data)
	case "earnings_inputs":
		return db.UpsertEarningsInputs(data)
	case "employment_types":
		return db.UpsertEmploymentTypes(data)
	case "files":
	...
	case "dev_bundles":
		return db.UpsertDevBundles(data)
	case "executions":
		return db.UpsertExecutions(data)
	case "headcount_positions":
		return db.UpsertHeadcountPositions(data)
	case "headcount_priorities":
		return db.UpsertHeadcountPriorities(data)
	case "job_assignments":
		return db.UpsertJobAssignments(data)
	case "change_log":
		return db.UpsertChangeLog(data)
	case "job_codes":
		return db.UpsertJobCodes(data)
	case "job_dimensions":
		return db.UpsertJobDimensions(data)
	case "job_functions":
		return db.UpsertJobFunctions(data)
	case "job_pay_rate_exceptions":
		return db.UpsertJobPayRateExceptions(data)
	case "job_requisitions_write":
		return db.UpsertJobRequisitionsWrite(data)
	case "kiosk_badges":
		return db.UpsertKioskBadges(data)
	case "leave_accruals":
		return db.UpsertLeaveAccruals(data)
	case "leave_balances":
		return db.UpsertLeaveBalances(data)
	case "leave_requests":
		return db.UpsertLeaveRequests(data)
	case "leave_types":
		return db.UpsertLeaveTypes(data)
	case "legal_entities":
		return db.UpsertLegalEntities(data)
	case "levels":
		return db.UpsertLevels(data)
	case "location_factors":
		return db.UpsertLocationFactors(data)
	case "object_categories":
		return db.UpsertObjectCategories(data)
	case "payroll_runs":
		return db.UpsertPayrollRuns(data)
	case "worker_payroll_records":
		return db.UpsertWorkerPayrollRecords(data)
	case "report_runs":
		return db.UpsertReportRuns(data)
	case "available_filters":
		return db.UpsertAvailableFilters(data)
	case "scheduled_job_assignments":
		return db.UpsertScheduledJobAssignments(data)
	case "schedules":
		return db.UpsertSchedules(data)
	case "shift_inputs":
		return db.UpsertShiftInputs(data)
	case "shiftassignments":
		return db.UpsertShiftassignments(data)
	case "customfields":
		return db.UpsertCustomfields(data)
	case "software_deployments":
		return db.UpsertSoftwareDeployments(data)
	case "supergroups":
		return db.UpsertSupergroups(data)
	case "exclusion_members":
		return db.UpsertExclusionMembers(data)
	case "inclusion_members":
		return db.UpsertInclusionMembers(data)
	case "members":
		return db.UpsertMembers(data)
	case "teams":
		return db.UpsertTeams(data)
	case "time_cards":
		return db.UpsertTimeCards(data)
	case "time_entries":
		return db.UpsertTimeEntries(data)
	case "titles":
		return db.UpsertTitles(data)
	case "tracks":
		return db.UpsertTracks(data)
	case "unassignedshifts":
		return db.UpsertUnassignedshifts(data)
	case "assign":
		return db.UpsertAssign(data)
	case "users":
		return db.UpsertUsers(data)
	case "work_locations":
		return db.UpsertWorkLocations(data)
	case "worker_time_splits":
		return db.UpsertWorkerTimeSplits(data)
	case "workers":
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		...
		"business-partner-groups": "/business-partner-groups/",
		"business-partners": "/business-partners/",
		"candidate-applications": "/candidate-applications/",
		"candidates": "/candidates/",
		"companies": "/companies/",
		"company-legal-entities": "/company-legal-entities/",
		"company-legal-entity-workers": "/company-legal-entity-workers/",
		"compensation-bands-details": "/compensation-bands-details/",
		...
		"earnings-inputs": "/earnings-inputs/",
		"employment-types": "/employment-types/",
		"entitlements": "/entitlements/",
		"functions": "/functions/",
		"headcount-positions": "/headcount-positions/",
		"headcount-priorities": "/headcount-priorities/",
		"job-assignments": "/job-assignments/",
		"job-codes": "/job-codes/",
		"job-dimensions": "/job-dimensions/",
		"job-functions": "/job-functions/",
		"job-pay-rate-exceptions": "/job-pay-rate-exceptions/",
		"job-requisitions": "/job-requisitions/",
		"kiosk-badges": "/kiosk-badges/",
		"leave-accruals": "/leave-accruals/",
		...
		"scheduled-job-assignments": "/scheduled-job-assignments/",
		"schedules": "/schedules/",
		...
		"worker-time-splits": "/worker-time-splits/",
		"workers": "/workers/",
	}
