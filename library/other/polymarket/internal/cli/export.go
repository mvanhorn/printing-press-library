...
large datasets as it has no memory pressure.`,
  ...
  polymarket-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  polymarket-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  polymarket-pp-cli export <resource> --format jsonl | jq '.id'`,
