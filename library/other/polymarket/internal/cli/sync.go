...
Resource scoping:
  ...
  polymarket-pp-cli sync

  # Sync specific resources only
  polymarket-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  polymarket-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  polymarket-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  polymarket-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  polymarket-pp-cli sync --latest-only`,
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/polymarket-pp-cli/data.db)")
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"api_keys": "https://clob.polymarket.com/auth/api-keys",
		"comments": "/comments",
		"events":   "/events",
		"markets":  "/markets",
		"orders":   "https://clob.polymarket.com/data/orders",
		"rewards":  "https://clob.polymarket.com/rewards/markets",
		"series":   "/series",
		"tags":     "/tags",
		"trades":   "https://clob.polymarket.com/data/trades",
	}
