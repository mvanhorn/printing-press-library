...
but do not stop the import.`,
  ...
  polymarket-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  polymarket-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | polymarket-pp-cli import <resource> --input -`,
