...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		...
		Short: `Indian market news and quotes without the scraping — offline-searchable and agent-native.`,
		Long: `Indian market news and quotes without the scraping — offline-searchable and agent-native.
...
See README.md or the bundled SKILL.md for recipes.`,
	...
	addNovelCommandIfAbsent(rootCmd, newNovelMarketWrapCmd(flags))
	addNovelCommandIfAbsent(rootCmd, newNovelNewsCmd(flags))
	addNovelCommandIfAbsent(rootCmd, newNovelNewsForCmd(flags))
	addNovelCommandIfAbsent(rootCmd, newNovelSinceCmd(flags))
	addNovelCommandIfAbsent(rootCmd, newNovelStockWatchCmd(flags))
