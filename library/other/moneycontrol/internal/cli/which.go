...
var whichIndex = []whichEntry{
	{Command: "market-wrap", Description: "One-command end-of-day view: indices, top gainers, top losers, and the latest market headlines in a single read.", Group: "Compound views", WhyItMatters: "Use this when you want the day's market snapshot without running four commands or loading a browser."},
	{Command: "stock-watch", Description: "Full picture for one ticker: live quote plus the most recent news tagged to that stock.", Group: "Compound views", WhyItMatters: "Reach for this instead of the raw quote or news commands when you want context alongside price."},
	{Command: "news digest", Description: "Top market headlines plus brief recaps, deduplicated, ready to skim.", Group: "Compound views", WhyItMatters: "The fastest path to 'what moved today' for the Indian market."},
	{Command: "since", Description: "Articles synced to the local store newer than N hours, with stock-symbol filter.", Group: "Local state that compounds", WhyItMatters: "Use this after a sync to answer 'what did I miss about my holdings since I last looked'."},
	{Command: "news-for", Description: "Latest tagged news for several stocks at once, fetched in parallel.", Group: "Compound views", WhyItMatters: "Use this for a quick portfolio-news sweep across your watchlist in one call."},
}
