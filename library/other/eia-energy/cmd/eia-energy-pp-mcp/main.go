...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/other/eia-energy/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("EIA_ENERGY_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "eia-energy-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
