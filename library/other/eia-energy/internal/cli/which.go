...
var whichIndex = []whichEntry{
	{Command: "grid pulse", Description: "Fetch recent balancing-authority measures and show per-type latest values, units, freshness, and transparent trailing means.", Group: "", WhyItMatters: ""},
	{Command: "state compare", Description: "Compare explicitly selected state series only when route, data column, frequency, periods, and units align.", Group: "", WhyItMatters: ""},
	{Command: "spread", Description: "Align two facet series by period and refuse subtraction when reported units differ.", Group: "", WhyItMatters: ""},
	{Command: "anomaly", Description: "Compute deterministic mean and standard-deviation deviations from exact bounded EIA source rows without forecasting.", Group: "", WhyItMatters: ""},
	{Command: "watch run", Description: "Evaluate a bounded JSON rule set once for thresholds, freshness, missing data, and changes while retaining source rows.", Group: "", WhyItMatters: ""},
	{Command: "revisions", Description: "Compare a bounded route/facet snapshot with the prior local observation and report changed period-value-unit keys.", Group: "", WhyItMatters: ""},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  eia-energy-pp-cli which "stale tickets"
  eia-energy-pp-cli which "bottleneck"
  eia-energy-pp-cli which --limit 1 "send message"
  eia-energy-pp-cli which                                # list the full capability index`,
