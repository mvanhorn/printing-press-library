...
large datasets as it has no memory pressure.`,
  ...
  eia-energy-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  eia-energy-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  eia-energy-pp-cli export <resource> --format jsonl | jq '.id'`,
