...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("EIA_ENERGY_STATE_DIR", "")
	t.Setenv("EIA_ENERGY_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"eia-energy-pp-cli auth login",
		"eia-energy-pp-cli doctor",
		"eia-energy-pp-cli help items",
		"eia-energy-pp-cli sync",
		"eia-energy-pp-cli profile list",
		"eia-energy-pp-cli feedback list",
		"eia-energy-pp-cli which",
		"eia-energy-pp-cli agent-context",
		"eia-energy-pp-cli completion bash",
		"eia-energy-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"eia-energy-pp-cli recall",
		"eia-energy-pp-cli learnings",
		"eia-energy-pp-cli teach-pattern",
		"eia-energy-pp-cli teach-lookup",
		"eia-energy-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("eia-energy-pp-cli")); err == nil {
