...
Resource scoping:
  ...
  eia-energy-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  eia-energy-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  eia-energy-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  eia-energy-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  eia-energy-pp-cli sync --latest-only`,
