...
func Load(configPath string) (*Config, error) {
	...
	if v := os.Getenv("EIA_ENERGY_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("EIA_ENERGY_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "eia-energy-pp-cli", "config.toml"), nil
}
...
func (c *Config) configForSave() Config {
	out := *c
	if c.fileConfig != nil {
		if c.envOverrides["EiaApiKey"] {
			out.EiaApiKey = c.fileConfig.EiaApiKey
		}
	}
...
func (c *Config) updateFileConfigField(field string) {
	...
	case "EiaApiKey":
		c.fileConfig.EiaApiKey = c.EiaApiKey
	}
}
