...
func Load(configPath string) (*Config, error) {
	cfg := &Config{
		BaseURL: "https://files.zillowstatic.com/research/public_csvs",
	}
	...
	if v := os.Getenv("ZILLOW_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("ZILLOW_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "zillow-pp-cli", "config.toml"), nil
}
