...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("ZILLOW_STATE_DIR", "")
	t.Setenv("ZILLOW_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"zillow-pp-cli auth login",
		"zillow-pp-cli doctor",
		"zillow-pp-cli help items",
		"zillow-pp-cli sync",
		"zillow-pp-cli profile list",
		"zillow-pp-cli feedback list",
		"zillow-pp-cli which",
		"zillow-pp-cli agent-context",
		"zillow-pp-cli completion bash",
		"zillow-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"zillow-pp-cli teach",
		"zillow-pp-cli recall",
		"zillow-pp-cli learnings",
		"zillow-pp-cli teach-pattern",
		"zillow-pp-cli teach-lookup",
		"zillow-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("zillow-pp-cli")); err == nil {
