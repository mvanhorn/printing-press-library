...
var whichIndex = []whichEntry{
	{Command: "affordability gap", Description: "Compare household income with Zillow's regional homeowner-income-needed estimate.", Group: "Client decisions", WhyItMatters: "Use when an agent must turn a generic affordability estimate into a client-specific answer."},
	{Command: "yield-proxy", Description: "Join ZORI and ZHVI on a common date for a transparent gross rent-to-value proxy.", Group: "Client decisions", WhyItMatters: "Use for quick, explainable rent-versus-value comparisons without pretending the proxy is net yield."},
	{Command: "supply-ratio", Description: "Join inventory and sales nowcast into an approximate months-of-inventory ratio.", Group: "Market structure", WhyItMatters: "Use when an agent needs a compact supply-balance signal with its approximation stated."},
	{Command: "turning-points", Description: "Find dated slope sign reversals across temperature, inventory, days pending, and ZHVI.", Group: "Market structure", WhyItMatters: "Use when an agent must identify when a market changed direction, not merely its current level."},
	{Command: "shortlist", Description: "Rank regions with explicit user weights and visible min-max-normalized components.", Group: "Regional screening", WhyItMatters: "Use for relocation or market-screening work where ranking criteria must remain auditable."},
	{Command: "quality audit", Description: "Detect missing observations, duplicate regions, coverage gaps, and large monthly jumps.", Group: "Evidence quality", WhyItMatters: "Use before analysis when freshness, gaps, or anomalous changes could invalidate a conclusion."},
	{Command: "breadth", Description: "Measure rising, falling, and unchanged regions by state or geography type.", Group: "Regional screening", WhyItMatters: "Use when an agent needs to tell whether a trend is broad or isolated."},
	{Command: "buy-vs-rent", Description: "Run a visible-assumption ownership-versus-rent cash-flow scenario.", Group: "Client decisions", WhyItMatters: "Use when an agent needs an inspectable scenario rather than a black-box recommendation."},
	{Command: "negotiation", Description: "Combine price cuts, sale-to-list ratio, days pending, and inventory into an explainable score.", Group: "Client decisions", WhyItMatters: "Use for buyer preparation when every score component must be shown."},
	{Command: "tier-spread", Description: "Compare bottom-, middle-, and top-tier ZHVI growth.", Group: "Market structure", WhyItMatters: "Use when affordability tiers may be moving differently from the headline market."},
	{Command: "demand-pressure", Description: "Combine rental demand and for-sale market momentum with component-level evidence.", Group: "Market structure", WhyItMatters: "Use when an agent must compare rental and ownership demand in one sourced view."},
	{Command: "new-build-gap", Description: "Compare new-construction pricing and sales activity with typical regional home value.", Group: "Market structure", WhyItMatters: "Use when an agent needs to quantify the new-build premium and activity context."},
	{Command: "client-brief", Description: "Compose deterministic Markdown or JSON briefs from sourced regional metrics.", Group: "Agent delivery", WhyItMatters: "Use when an agent must hand a human a concise brief without inventing narrative facts."},
	{Command: "explain", Description: "Show formulas, datasets, freshness behavior, and caveats for compound commands.", Group: "Evidence quality", WhyItMatters: "Use before relying on a compound score or scenario in consequential work."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  zillow-pp-cli which "stale tickets"
  zillow-pp-cli which "bottleneck"
  zillow-pp-cli which --limit 1 "send message"
  zillow-pp-cli which                                # list the full capability index`,
