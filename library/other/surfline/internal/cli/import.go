...
but do not stop the import.`,
  ...
  surfline-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  surfline-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | surfline-pp-cli import <resource> --input -`,
