...
large datasets as it has no memory pressure.`,
  ...
  surfline-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  surfline-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  surfline-pp-cli export <resource> --format jsonl | jq '.id'`,
