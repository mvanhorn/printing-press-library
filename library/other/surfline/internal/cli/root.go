...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "surfline-pp-cli",
		Short: `Every Surfline forecast, scriptable from your terminal — plus multi-spot ranking, a local forecast journal, and cron-able alerts no Surfline tool has.`,
		Long: `Every Surfline forecast, scriptable from your terminal — plus multi-spot ranking, a local forecast journal, and cron-able alerts no Surfline tool has.
...
Health check: run 'surfline-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("surfline-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'surfline-pp-cli profile list')")
	...
	rootCmd.AddCommand(newSpotsCmd(flags))
	...
	rootCmd.AddCommand(newNovelBuoyCheckCmd(flags))
	rootCmd.AddCommand(newNovelJournalCmd(flags))
	rootCmd.AddCommand(newNovelNowCmd(flags))
	rootCmd.AddCommand(newNovelRankCmd(flags))
	rootCmd.AddCommand(newNovelRawCmd(flags))
	rootCmd.AddCommand(newNovelSearchCmd(flags))
	rootCmd.AddCommand(newNovelWindowsCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newBuoysPromotedCmd(flags))
	rootCmd.AddCommand(newRegionsPromotedCmd(flags))
	rootCmd.AddCommand(newTaxonomyPromotedCmd(flags))
