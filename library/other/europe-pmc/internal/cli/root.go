...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "europe-pmc-pp-cli",
		Short: `Europe PMC CLI with preprint tracking, citation graphs, systematic review dedup, and text-mined annotation mining`,
		Long: `Europe PMC CLI with preprint tracking, citation graphs, systematic review dedup, and text-mined annotation mining
...
Health check: run 'europe-pmc-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("europe-pmc-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'europe-pmc-pp-cli profile list')")
	...
	rootCmd.AddCommand(newCitationsPromotedCmd(flags))
	rootCmd.AddCommand(newDatabaseLinksPromotedCmd(flags))
	rootCmd.AddCommand(newDatalinksPromotedCmd(flags))
	rootCmd.AddCommand(newEvaluationsPromotedCmd(flags))
	rootCmd.AddCommand(newFieldsPromotedCmd(flags))
	rootCmd.AddCommand(newFulltextPromotedCmd(flags))
	rootCmd.AddCommand(newLabsLinksPromotedCmd(flags))
	rootCmd.AddCommand(newReferencesPromotedCmd(flags))
	rootCmd.AddCommand(newSourceProfilePromotedCmd(flags))
	rootCmd.AddCommand(newTrackPreprintCmd(flags))
	rootCmd.AddCommand(newMineRelationsCmd(flags))
	rootCmd.AddCommand(newCiteGraphCmd(flags))
	rootCmd.AddCommand(newSystematicReviewCmd(flags))
	rootCmd.AddCommand(newSectionSearchCmd(flags))
	rootCmd.AddCommand(newPatentLitCmd(flags))
	rootCmd.AddCommand(newGrantImpactCmd(flags))
	rootCmd.AddCommand(newPPRIntelCmd(flags))
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("europe-pmc-pp-cli %s\n", version)
		},
	}
}
