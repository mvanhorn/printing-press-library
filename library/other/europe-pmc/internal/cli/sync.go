...
Exit codes & warnings:
  ...
  europe-pmc-pp-cli sync

  # Sync specific resources only
  europe-pmc-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  europe-pmc-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  europe-pmc-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  europe-pmc-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  europe-pmc-pp-cli sync --latest-only`,
