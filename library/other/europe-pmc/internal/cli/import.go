...
but do not stop the import.`,
  ...
  europe-pmc-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  europe-pmc-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | europe-pmc-pp-cli import <resource> --input -`,
