...
large datasets as it has no memory pressure.`,
  ...
  europe-pmc-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  europe-pmc-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  europe-pmc-pp-cli export <resource> --format jsonl | jq '.id'`,
