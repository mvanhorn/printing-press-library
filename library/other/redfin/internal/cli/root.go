...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "redfin-pp-cli",
		Short: `Redfin CLI — Every Redfin property, market stat, and price history — synced locally, queryable offline, and built for agents.`,
		Long: `Redfin CLI — Every Redfin property, market stat, and price history — synced locally, queryable offline, and built for agents.
...
See README.md or the bundled SKILL.md for recipes.`,
	...
	rootCmd.AddCommand(newComparablesCmd(flags))
	rootCmd.AddCommand(newListingsCmd(flags))
	rootCmd.AddCommand(newNeighborhoodCmd(flags))
	rootCmd.AddCommand(newPropertiesCmd(flags))
	rootCmd.AddCommand(newValuationCmd(flags))
	...
	rootCmd.AddCommand(newCompScoreCmd(flags))
	rootCmd.AddCommand(newPriceTrendCmd(flags))
	rootCmd.AddCommand(newDealScoreCmd(flags))
	rootCmd.AddCommand(newSellerPulseCmd(flags))
	rootCmd.AddCommand(newMarketHeatCmd(flags))
	rootCmd.AddCommand(newDomDistributionCmd(flags))
