...
but do not stop the import.`,
  ...
  squire-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  squire-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | squire-pp-cli import <resource> --input -`,
