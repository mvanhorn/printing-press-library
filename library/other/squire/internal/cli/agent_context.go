...
func buildAgentDiscoveryContext() *agentContextDiscovery {
	return &agentContextDiscovery{
		...
		TargetURL:     "https://api.getsquire.com/v1/search/public",
		EntryCount:    9,
		APIEntryCount: 9,
		...
		CandidateCommands: []string{
			"get_details — Derived from observed GET /v1/shop/{shop_id}/details traffic.",
			"get_next_available_time — Derived from observed GET /v1/shop/{shop_id}/barber/{barber_id}/next-available-time traffic.",
			"get_professional — Derived from observed GET /v1/shop/{shop_id}/details/professional traffic.",
			"get_service — Derived from observed GET /v2/shop/{shop_id}/barber/{barber_id}/service traffic.",
			"get_shop — Derived from observed GET /v1/reviews/shop/{shop_id} traffic.",
			"list_city — Derived from observed GET /discover/api/city traffic.",
			"list_public — Derived from observed GET /v1/search/public traffic.",
			"list_shops — Derived from observed GET /discover/api/shops traffic.",
		},
	}
}
