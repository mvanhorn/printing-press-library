...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "squire-pp-cli",
		Short: `Squire CLI — Every barbershop on Squire, queryable from the terminal — cross-shop price compare, soonest-available barber, and revie…`,
		Long: `Squire CLI — Every barbershop on Squire, queryable from the terminal — cross-shop price compare, soonest-available barber, and revie…
...
Health check: run 'squire-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("squire-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'squire-pp-cli profile list')")
	...
	rootCmd.AddCommand(newNovelSoonestCmd(flags))
