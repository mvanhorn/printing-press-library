...
native streaming instead of polling.`,
  ...
  servicetitan-salestech-pp-cli tail --interval 10s

  # Tail a specific resource
  servicetitan-salestech-pp-cli tail messages --interval 5s

  # Pipe to jq for filtering
  servicetitan-salestech-pp-cli tail events --interval 30s | jq 'select(.type == "error")'`,
