...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "servicetitan-salestech-pp-cli",
		Short: `Servicetitan Salestech CLI — Every ServiceTitan Sales/Estimates feature, plus a local mirror that answers the cross-cutting questions the ST web UI …`,
		Long: `Servicetitan Salestech CLI — Every ServiceTitan Sales/Estimates feature, plus a local mirror that answers the cross-cutting questions the ST web UI …
...
Health check: run 'servicetitan-salestech-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("servicetitan-salestech-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'servicetitan-salestech-pp-cli profile list')")
	...
	rootCmd.AddCommand(newSalesEstimatesExportPromotedCmd(flags))
	rootCmd.AddCommand(newStatusPromotedCmd(flags))
	// PATCH: salestech-novel-roots — hand-built transcendence top-level commands.
	...
	rootCmd.AddCommand(newSyncItemsCmd(flags))
	rootCmd.AddCommand(newSyncStatusChangesCmd(flags))
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("servicetitan-salestech-pp-cli %s\n", version)
		},
	}
}
