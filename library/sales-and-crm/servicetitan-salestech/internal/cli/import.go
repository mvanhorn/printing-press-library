...
but do not stop the import.`,
  ...
  servicetitan-salestech-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  servicetitan-salestech-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | servicetitan-salestech-pp-cli import <resource> --input -`,
