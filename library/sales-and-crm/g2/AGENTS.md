# G2 Printed CLI Agent Guide

This directory is a generated `g2-pp-cli` printed CLI. It was produced by [CLI Printing Press](https://github.com/mvanhorn/cli-printing-press), so treat systemic fixes as upstream Printing Press fixes first. Keep local edits narrow and document why a generated-tree patch belongs here.
...
```bash
g2-pp-cli doctor --json
g2-pp-cli agent-context --pretty
```

Use runtime discovery instead of relying on a copied command list:

```bash
g2-pp-cli which "<capability>" --json
g2-pp-cli <command> --help
```
...
```bash
g2-pp-cli <command> --help
g2-pp-cli <command> --dry-run --agent
```
