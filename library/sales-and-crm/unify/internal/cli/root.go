...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "unify-pp-cli",
		Short: `Unify CLI — The read layer Unify's API doesn't ship. Local search, SQL, and coverage reports over a CRM that has no list-records en…`,
		Long: `Unify CLI — The read layer Unify's API doesn't ship. Local search, SQL, and coverage reports over a CRM that has no list-records en…
...
Health check: run 'unify-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("unify-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'unify-pp-cli profile list')")
	...
	// Novel features: the read layer the Unify Data API doesn't ship.
	...
	rootCmd.AddCommand(newVetCmd(flags))
	rootCmd.AddCommand(newCoverageCmd(flags))
	rootCmd.AddCommand(newAuditScoresCmd(flags))
	rootCmd.AddCommand(newTraceCmd(flags))
