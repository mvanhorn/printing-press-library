...
func newDoctorCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `  unify-pp-cli doctor
  unify-pp-cli doctor --json
  unify-pp-cli doctor --fail-on warn`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if cfg != nil {
				...
				if header == "" {
					...
					report["auth_hint"] = "export UNIFY_API_KEY=<your-key>"
					report["auth_docs_url"] = "https://www.unifygtm.com/support"
				} else {
					authConfigured = true
			...
			if os.Getenv("UNIFY_API_KEY") != "" {
				authEnvSet = append(authEnvSet, "UNIFY_API_KEY")
				...
				authEnvRequiredMissing = append(authEnvRequiredMissing, "UNIFY_API_KEY")
			}
			switch {
