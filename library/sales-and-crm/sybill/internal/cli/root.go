...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "sybill-pp-cli",
		Short: `Sybill CLI — The first CLI for Sybill: every conversation, deal, and account in your terminal, plus a local store that answers cross…`,
		Long: `Sybill CLI — The first CLI for Sybill: every conversation, deal, and account in your terminal, plus a local store that answers cross…
...
Health check: run 'sybill-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("sybill-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'sybill-pp-cli profile list')")
	...
	rootCmd.AddCommand(newObjectTypesCmd(flags))
	rootCmd.AddCommand(newRowsCmd(flags))
	...
	rootCmd.AddCommand(newNovelActivityCmd(flags))
	rootCmd.AddCommand(newNovelCrmAutofillCmd(flags))
	rootCmd.AddCommand(newNovelDigestCmd(flags))
	rootCmd.AddCommand(newNovelPatternsCmd(flags))
