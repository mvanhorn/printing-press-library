...
but do not stop the import.`,
  ...
  sybill-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  sybill-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | sybill-pp-cli import <resource> --input -`,
