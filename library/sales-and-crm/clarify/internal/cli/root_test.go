...
func TestDeclaredAPISurfaceReachable(t *testing.T) {
	expected := []string{
		...
		"layouts get-by-id",
		"layouts reset",
		"layouts reset layout",
		"layouts update",
		"lists",
		"meetings",
		"meetings recording",
		"meetings recording disable",
		"meetings recording enable",
		"meetings recordings",
		"meetings recordings confirm-media-upload",
		"meetings recordings get-artifacts",
		"meetings recordings init-media-upload",
		"meetings recordings upload-transcript",
		"meetings transcript",
		"meetings transcript upload",
		"objects",
		"objects access",
		"objects access get-object",
		"objects access give-object",
		"objects access revoke-object",
		"objects lists",
		"objects lists create",
		"objects lists delete",
		"objects lists get",
		"objects lists get-resources",
		"objects lists get-rows-csv",
		"objects lists get-workspaces",
		"objects lists publish",
		"objects lists unpublish",
		"objects lists update",
		"objects records",
		"objects records add-attachment",
		"objects records create",
		"objects records create-bulk",
		"objects records create-grant",
		"objects records create-grants-bulk",
		"objects records delete",
		"objects records delete-attachment",
		"objects records delete-relationship",
		"objects records delete-workspaces",
		"objects records get",
		"objects records get-activities",
		"objects records get-attachment",
		"objects records get-grants",
		"objects records get-relationships",
		"objects records get-signed-url-for-attachment-upload",
		"objects records list-attachments",
		"objects records merge",
		"objects records revoke-grant",
		"objects records update",
		"objects records update-grant",
		"objects records update-relationship",
		"objects records update-workspaces",
		"objects resources",
		"objects resources create",
		"objects resources get",
		"objects resources get-workspaces",
		"schemas",
		"schemas activities",
		"schemas activities get-schema",
		"schemas create-custom-object",
		"schemas delete-custom-object",
		"schemas fields-order",
		"schemas fields-order update-schema-property-order",
		"schemas fields-visibility",
		"schemas fields-visibility update-schema-property-visibility",
		"schemas get",
		"schemas patch-enum-field-values",
		"schemas properties",
		"schemas properties create-schema",
		"schemas relationships",
		"schemas relationships create-schema-properties",
		"schemas relationships delete-schema-property",
		"schemas update-entity",
		"settings",
		"settings delete-workspace",
		"settings read-all-workspace",
		"settings read-workspace",
		"settings write-workspace",
		"users",
		"users get",
		"users get-workspaces",
		"workflows",
		"workflows create",
		"workflows delete",
		"workflows get",
		"workflows get-workspaces",
		"workflows update",
	}
