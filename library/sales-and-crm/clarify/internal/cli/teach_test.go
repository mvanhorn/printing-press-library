...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"clarify-pp-cli auth login",
		"clarify-pp-cli doctor",
		"clarify-pp-cli help items",
		"clarify-pp-cli sync",
		"clarify-pp-cli profile list",
		"clarify-pp-cli feedback list",
		"clarify-pp-cli which",
		"clarify-pp-cli agent-context",
		"clarify-pp-cli completion bash",
		"clarify-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"clarify-pp-cli recall",
		"clarify-pp-cli learnings",
		"clarify-pp-cli teach-pattern",
		"clarify-pp-cli teach-lookup",
		"clarify-pp-cli items list",
	}
