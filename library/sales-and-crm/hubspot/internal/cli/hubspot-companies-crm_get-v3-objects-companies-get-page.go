...
func newHubspotCompaniesCrmGetV3ObjectsCompaniesGetPageCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  hubspot-pp-cli hubspot-companies-crm get-v3-objects-companies-get-page",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolvePaginatedReadWithStrategy(cmd.Context(), c, flags, "auto", "hubspot-companies-crm", path, map[string]string{
