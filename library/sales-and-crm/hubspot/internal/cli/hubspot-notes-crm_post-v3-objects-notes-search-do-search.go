...
func newHubspotNotesCrmPostV3ObjectsNotesSearchDoSearchCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  hubspot-pp-cli hubspot-notes-crm post-v3-objects-notes-search-do-search --after example-value",
