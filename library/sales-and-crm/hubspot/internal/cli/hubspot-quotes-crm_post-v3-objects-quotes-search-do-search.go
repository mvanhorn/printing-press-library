...
func newHubspotQuotesCrmPostV3ObjectsQuotesSearchDoSearchCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  hubspot-pp-cli hubspot-quotes-crm post-v3-objects-quotes-search-do-search --after example-value",
