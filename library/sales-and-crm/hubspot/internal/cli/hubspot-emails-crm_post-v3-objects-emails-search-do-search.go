...
func newHubspotEmailsCrmPostV3ObjectsEmailsSearchDoSearchCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  hubspot-pp-cli hubspot-emails-crm post-v3-objects-emails-search-do-search --after example-value",
