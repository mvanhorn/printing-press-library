...
func newHubspotObjectsCrmGetV3ObjectsObjectTypeGetPageCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  hubspot-pp-cli hubspot-objects-crm get-v3-objects-object-type-get-page example-value",
