...
func newHubspotTicketsCrmGetV3ObjectsTicketsGetPageCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  hubspot-pp-cli hubspot-tickets-crm get-v3-objects-tickets-get-page",
