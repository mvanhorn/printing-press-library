...
func newHubspotImportsCrmGetV3ImportsImportIdErrorsV3ImportsImportIdErrorsCmd(flags *rootFlags) *cobra.Command {
	var flagAfter string
	var flagIncludeErrorMessage bool
	var flagIncludeRowData bool
	var flagLimit int
	var flagAll bool
	...
	cmd := &cobra.Command{
		...
		Example:     "  hubspot-pp-cli hubspot-imports-crm get-v3-imports-import-id-errors-v3-imports-import-id-errors 42",
	...
	cmd.Flags().BoolVar(&flagIncludeErrorMessage, "include-error-message", false, "Include error message")
	cmd.Flags().BoolVar(&flagIncludeRowData, "include-row-data", false, "Include row data")
	cmd.Flags().IntVar(&flagLimit, "limit", 0, "The maximum number of results to display per page.")
