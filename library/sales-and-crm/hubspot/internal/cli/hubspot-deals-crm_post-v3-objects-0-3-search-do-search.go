...
func newHubspotDealsCrmPostV3Objects03SearchDoSearchCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  hubspot-pp-cli hubspot-deals-crm post-v3-objects-0-3-search-do-search --after example-value",
