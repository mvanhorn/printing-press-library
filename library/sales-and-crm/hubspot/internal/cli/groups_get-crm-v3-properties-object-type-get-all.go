...
func newGroupsGetCrmV3PropertiesObjectTypeGetAllCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  hubspot-pp-cli groups get-crm-v3-properties-object-type-get-all example-value",
