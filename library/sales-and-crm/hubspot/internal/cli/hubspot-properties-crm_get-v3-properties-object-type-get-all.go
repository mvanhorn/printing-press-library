...
func newHubspotPropertiesCrmGetV3PropertiesObjectTypeGetAllCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  hubspot-pp-cli hubspot-properties-crm get-v3-properties-object-type-get-all example-value",
