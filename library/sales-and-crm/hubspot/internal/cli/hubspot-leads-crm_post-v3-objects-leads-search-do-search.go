...
func newHubspotLeadsCrmPostV3ObjectsLeadsSearchDoSearchCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  hubspot-pp-cli hubspot-leads-crm post-v3-objects-leads-search-do-search --after example-value",
