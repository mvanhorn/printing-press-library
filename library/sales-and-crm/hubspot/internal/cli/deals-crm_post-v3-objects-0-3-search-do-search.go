...
func newDealsCrmPostV3Objects03SearchDoSearchCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  hubspot-pp-cli deals-crm post-v3-objects-0-3-search-do-search --after example-value",
		Annotations: map[string]string{"pp:endpoint": "deals-crm.post-v3-objects-0-3-search-do-search", "pp:method": "POST", "pp:path": "/crm/v3/objects/0-3/search"},
