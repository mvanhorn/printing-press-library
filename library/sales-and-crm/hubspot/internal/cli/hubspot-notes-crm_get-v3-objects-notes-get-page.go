...
func newHubspotNotesCrmGetV3ObjectsNotesGetPageCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  hubspot-pp-cli hubspot-notes-crm get-v3-objects-notes-get-page",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolvePaginatedReadWithStrategy(cmd.Context(), c, flags, "auto", "hubspot-notes-crm", path, map[string]string{
