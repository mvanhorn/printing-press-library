...
func newEmailsCrmPostV3ObjectsEmailsSearchDoSearchCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  hubspot-pp-cli emails-crm post-v3-objects-emails-search-do-search --after example-value",
		Annotations: map[string]string{"pp:endpoint": "emails-crm.post-v3-objects-emails-search-do-search", "pp:method": "POST", "pp:path": "/crm/v3/objects/emails/search"},
