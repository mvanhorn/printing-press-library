...
func newHubspotContactsCrmPostV3ObjectsContactsSearchCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  hubspot-pp-cli hubspot-contacts-crm post-v3-objects-contacts-search --after example-value",
	...
	cmd.Flags().StringVar(&bodyAfter, "after", "", "After")
	cmd.Flags().StringVar(&bodyFilterGroups, "filter-groups", "", "Filter groups")
