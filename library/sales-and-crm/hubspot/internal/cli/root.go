...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "hubspot-pp-cli",
		Short: `HubSpot CLI — Every HubSpot CRM endpoint, plus a local SQLite mirror that answers compound pre-sale queries no other HubSpot tool can…`,
		Long: `HubSpot CLI — Every HubSpot CRM endpoint, plus a local SQLite mirror that answers compound pre-sale queries no other HubSpot tool can…
...
See README.md or the bundled SKILL.md for recipes.`,
	...
	rootCmd.AddCommand(newAssociationsCrmCmd(flags))
	rootCmd.AddCommand(newBatchCmd(flags))
	rootCmd.AddCommand(newCallsCrmCmd(flags))
	rootCmd.AddCommand(newCompaniesCrmCmd(flags))
	rootCmd.AddCommand(newCrmCmd(flags))
	rootCmd.AddCommand(newCrmListsCrmCmd(flags))
	rootCmd.AddCommand(newCrmOwnersCrmCmd(flags))
	rootCmd.AddCommand(newDealsCrmCmd(flags))
	rootCmd.AddCommand(newEmailsCrmCmd(flags))
	rootCmd.AddCommand(newGroupsCmd(flags))
	rootCmd.AddCommand(newLeadsCrmCmd(flags))
	rootCmd.AddCommand(newMeetingsCrmCmd(flags))
	rootCmd.AddCommand(newNotesCrmCmd(flags))
	rootCmd.AddCommand(newPipelinesCrmCmd(flags))
	rootCmd.AddCommand(newPropertiesCrmCmd(flags))
	rootCmd.AddCommand(newTasksCrmCmd(flags))
	...
	// PATCH: Add local read-only HubSpot transcendence commands backed by the synced SQLite mirror.
	rootCmd.AddCommand(newStaleLeadsCmd(flags))
	rootCmd.AddCommand(newPipelineHealthCmd(flags))
	rootCmd.AddCommand(newRecentIntakeCmd(flags))
	rootCmd.AddCommand(newDedupCmd(flags))
	rootCmd.AddCommand(newClosedWonHandoffCmd(flags))
	rootCmd.AddCommand(newEngagementDecayCmd(flags))
	rootCmd.AddCommand(newLeadTraceCmd(flags))
	rootCmd.AddCommand(newUtmCohortCmd(flags))
