...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "hubspot-pp-cli",
		Short: `Hubspot CLI — Read-only contact analytics for HubSpot CRM — score drift, engagement decay, source ROI, and a daily digest, with a loc…`,
		Long: `Hubspot CLI — Read-only contact analytics for HubSpot CRM — score drift, engagement decay, source ROI, and a daily digest, with a loc…
...
See README.md or the bundled SKILL.md for recipes.`,
	...
	rootCmd.AddCommand(newNovelDailyDigestCmd(flags))
	rootCmd.AddCommand(newNovelDuplicateSuspectsCmd(flags))
	rootCmd.AddCommand(newNovelEngagementDecayCmd(flags))
	rootCmd.AddCommand(newNovelLifecycleStuckCmd(flags))
	rootCmd.AddCommand(newNovelOwnerOverloadCmd(flags))
	rootCmd.AddCommand(newNovelScoreDriftCmd(flags))
	rootCmd.AddCommand(newNovelSilentAfterFirstTouchCmd(flags))
	rootCmd.AddCommand(newNovelSourceRoiCmd(flags))
	rootCmd.AddCommand(newNovelStaleButValuableCmd(flags))
