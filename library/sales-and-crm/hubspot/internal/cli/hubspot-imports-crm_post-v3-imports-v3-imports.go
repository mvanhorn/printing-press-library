...
func newHubspotImportsCrmPostV3ImportsV3ImportsCmd(flags *rootFlags) *cobra.Command {
	var bodyFiles string
	var bodyImportRequest string

	cmd := &cobra.Command{
		Use:         "post-v3-imports-v3-imports",
		Short:       "Post v3 imports v3 imports",
		Example:     "  hubspot-pp-cli hubspot-imports-crm post-v3-imports-v3-imports",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !flags.dryRun && statusCode >= 200 && statusCode < 300 {
				...
				if partialFailure != nil {
					fmt.Fprintf(os.Stderr, "warning: partial failure detected in %s response: %s\n", "hubspot-imports-crm", partialFailure.Message)
			...
			if !flags.dryRun && statusCode >= 200 && statusCode < 300 && (partialFailure == nil || flags.allowPartialFailure) {
				writeMutationResponseToStore(cmd.Context(), "hubspot-imports-crm", data, "")
			}
	...
	cmd.Flags().StringVar(&bodyImportRequest, "import-request", "", "Import request")
