		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if cfg != nil {
				...
				if header == "" {
					...
					report["auth_hint"] = "export HUBSPOT_TOKEN=<your-key>"
			...
			if os.Getenv("HUBSPOT_TOKEN") != "" {
				authEnvSet = append(authEnvSet, "HUBSPOT_TOKEN")
				...
				authEnvRequiredMissing = append(authEnvRequiredMissing, "HUBSPOT_TOKEN")
			}
			switch {
