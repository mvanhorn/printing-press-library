...
func newGroupsDeleteCrmV3PropertiesObjectTypeNameArchiveCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  hubspot-pp-cli groups delete-crm-v3-properties-object-type-name-archive example-resource example-value",
