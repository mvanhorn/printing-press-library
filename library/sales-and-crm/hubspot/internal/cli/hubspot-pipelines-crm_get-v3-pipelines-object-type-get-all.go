...
func newHubspotPipelinesCrmGetV3PipelinesObjectTypeGetAllCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  hubspot-pp-cli hubspot-pipelines-crm get-v3-pipelines-object-type-get-all example-value",
