...
func newHubspotListsCrmGetV3ListsFoldersV3ListsFoldersCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  hubspot-pp-cli hubspot-lists-crm get-v3-lists-folders-v3-lists-folders",
