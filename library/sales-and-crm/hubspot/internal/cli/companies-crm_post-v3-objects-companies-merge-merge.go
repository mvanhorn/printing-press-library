...
func newCompaniesCrmPostV3ObjectsCompaniesMergeMergeCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  hubspot-pp-cli companies-crm post-v3-objects-companies-merge-merge --object-id-to-merge example-value",
		Annotations: map[string]string{"pp:endpoint": "companies-crm.post-v3-objects-companies-merge-merge", "pp:method": "POST", "pp:path": "/crm/v3/objects/companies/merge"},
	...
	cmd.Flags().StringVar(&bodyPrimaryObjectId, "primary-object-id", "", "The ID of the primary company, which the other will merge into.")
