...
func newCrmPostV4AssociationsFromObjectTypeToObjectTypeBatchCreateCreateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  hubspot-pp-cli crm post-v4-associations-from-object-type-to-object-type-batch-create-create example-value example-value",
