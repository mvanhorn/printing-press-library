...
func newHubspotProductsCrmGetV3ObjectsProductsGetPageCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  hubspot-pp-cli hubspot-products-crm get-v3-objects-products-get-page",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolvePaginatedReadWithStrategy(cmd.Context(), c, flags, "auto", "hubspot-products-crm", path, map[string]string{
