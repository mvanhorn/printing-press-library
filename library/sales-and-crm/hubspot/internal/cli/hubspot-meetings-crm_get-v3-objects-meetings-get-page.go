...
func newHubspotMeetingsCrmGetV3ObjectsMeetingsGetPageCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  hubspot-pp-cli hubspot-meetings-crm get-v3-objects-meetings-get-page",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolvePaginatedReadWithStrategy(cmd.Context(), c, flags, "auto", "hubspot-meetings-crm", path, map[string]string{
