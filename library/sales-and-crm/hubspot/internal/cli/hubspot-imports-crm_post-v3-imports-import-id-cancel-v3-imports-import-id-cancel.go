...
func newHubspotImportsCrmPostV3ImportsImportIdCancelV3ImportsImportIdCancelCmd(flags *rootFlags) *cobra.Command {
	var stdinBody bool
	...
	cmd := &cobra.Command{
		...
		Example:     "  hubspot-pp-cli hubspot-imports-crm post-v3-imports-import-id-cancel-v3-imports-import-id-cancel 42",
