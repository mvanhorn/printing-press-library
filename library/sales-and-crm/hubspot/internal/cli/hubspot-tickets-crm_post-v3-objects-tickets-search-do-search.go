...
func newHubspotTicketsCrmPostV3ObjectsTicketsSearchDoSearchCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  hubspot-pp-cli hubspot-tickets-crm post-v3-objects-tickets-search-do-search --after example-value",
