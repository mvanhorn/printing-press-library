...
func newCrmPostV4AssociationsFromObjectTypeToObjectTypeBatchAssociateDefaultCreateDefaultCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  hubspot-pp-cli crm post-v4-associations-from-object-type-to-object-type-batch-associate-default-create-default example-value example-value",
