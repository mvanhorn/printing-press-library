...
func newHubspotEmailsCrmGetV3ObjectsEmailsGetPageCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  hubspot-pp-cli hubspot-emails-crm get-v3-objects-emails-get-page",
