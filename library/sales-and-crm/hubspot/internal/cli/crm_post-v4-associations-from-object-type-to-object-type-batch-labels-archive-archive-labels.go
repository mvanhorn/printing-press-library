...
func newCrmPostV4AssociationsFromObjectTypeToObjectTypeBatchLabelsArchiveArchiveLabelsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  hubspot-pp-cli crm post-v4-associations-from-object-type-to-object-type-batch-labels-archive-archive-labels example-value example-value",
