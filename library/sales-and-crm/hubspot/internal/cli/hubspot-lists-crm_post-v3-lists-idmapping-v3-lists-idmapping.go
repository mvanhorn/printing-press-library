...
func newHubspotListsCrmPostV3ListsIdmappingV3ListsIdmappingCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "post-v3-lists-idmapping-v3-lists-idmapping",
		Short:       "Post v3 lists idmapping v3 lists idmapping",
		Example:     "  hubspot-pp-cli hubspot-lists-crm post-v3-lists-idmapping-v3-lists-idmapping",
		Annotations: map[string]string{"pp:endpoint": "hubspot-lists-crm.post-v3-lists-idmapping-v3-lists-idmapping", "pp:method": "POST", "pp:path": "/crm/v3/lists/idmapping"},
