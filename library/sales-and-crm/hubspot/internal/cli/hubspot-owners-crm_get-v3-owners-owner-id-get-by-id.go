...
func newHubspotOwnersCrmGetV3OwnersOwnerIdGetByIdCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  hubspot-pp-cli hubspot-owners-crm get-v3-owners-owner-id-get-by-id 42",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if cmd.Flags().Changed("id-property") {
				...
				if !validIdProperty {
					return fmt.Errorf("invalid value %q for --%s: must be one of %v", flagIdProperty, "id-property", allowedIdProperty)
				}
			}
