...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  hubspot-pp-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"calls-crm", "companies-crm", "crm", "crm-lists-crm", "crm-lists-crm-folders", "crm-lists-crm-idmapping", "crm-owners-crm", "deals-crm", "emails-crm", "leads-crm", "meetings-crm", "notes-crm", "tasks-crm"}
			totalSynced := 0
