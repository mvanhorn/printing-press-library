...
func newHubspotCompaniesCrmPostV3ObjectsCompaniesMergeMergeCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  hubspot-pp-cli hubspot-companies-crm post-v3-objects-companies-merge-merge --object-id-to-merge example-value",
