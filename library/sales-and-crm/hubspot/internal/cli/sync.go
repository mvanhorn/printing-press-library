...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	switch resource {
	case "calls-crm":
		return db.UpsertCallsCrm(data)
	case "companies-crm":
		return db.UpsertCompaniesCrm(data)
	case "crm":
		return db.UpsertCrm(data)
	case "crm-lists-crm":
		return db.UpsertCrmListsCrm(data)
	case "crm-owners-crm":
		return db.UpsertCrmOwnersCrm(data)
	case "deals-crm":
		return db.UpsertDealsCrm(data)
	case "emails-crm":
		return db.UpsertEmailsCrm(data)
	case "groups":
		return db.UpsertGroups(data)
	case "leads-crm":
		return db.UpsertLeadsCrm(data)
	case "meetings-crm":
		return db.UpsertMeetingsCrm(data)
	case "notes-crm":
		return db.UpsertNotesCrm(data)
	case "pipelines-crm":
		return db.UpsertPipelinesCrm(data)
	case "properties-crm":
		return db.UpsertPropertiesCrm(data)
	case "tasks-crm":
		return db.UpsertTasksCrm(data)
	default:
...
func defaultSyncResources() []string {
	return []string{
		...
		"crm",
		"crm-lists-crm",
		"crm-lists-crm-folders",
		"crm-lists-crm-idmapping",
		"crm-owners-crm",
		"deals-crm",
		"emails-crm",
		"leads-crm",
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"calls-crm":               "/crm/v3/objects/calls",
		"companies-crm":           "/crm/v3/objects/companies",
		"crm":                     "/crm/v3/objects/contacts",
		"crm-lists-crm":           "/crm/v3/lists",
		"crm-lists-crm-folders":   "/crm/v3/lists/folders",
		"crm-lists-crm-idmapping": "/crm/v3/lists/idmapping",
		"crm-owners-crm":          "/crm/v3/owners",
		"deals-crm":               "/crm/v3/objects/0-3",
		"emails-crm":              "/crm/v3/objects/emails",
		"leads-crm":               "/crm/v3/objects/leads",
		"meetings-crm":            "/crm/v3/objects/meetings",
		"notes-crm":               "/crm/v3/objects/notes",
		"tasks-crm":               "/crm/v3/objects/tasks",
	}
