...
func newCrmListsCrmPostV3ListsV3ListsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  hubspot-pp-cli crm-lists-crm post-v3-lists-v3-lists --name example-resource",
		Annotations: map[string]string{"pp:endpoint": "crm-lists-crm.post-v3-lists-v3-lists", "pp:method": "POST", "pp:path": "/crm/v3/lists"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if stdinBody {
				...
				}
				{
					...
					if bodyMembershipSettingsIncludeUnassigned != false {
						nestedMembershipSettings["includeUnassigned"] = bodyMembershipSettingsIncludeUnassigned
					}
					if bodyMembershipSettingsMembershipTeamId != 0 {
	...
	cmd.Flags().IntVar(&bodyListFolderId, "list-folder-id", 0, "The ID of the folder that the list should be created in. If left blank, then the list will be created in the root of...")
