...
func newHubspotCompaniesCrmPostV3ObjectsCompaniesBatchArchiveArchiveCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  hubspot-pp-cli hubspot-companies-crm post-v3-objects-companies-batch-archive-archive",
