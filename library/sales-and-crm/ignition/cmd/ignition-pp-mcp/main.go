...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/sales-and-crm/ignition/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("IGNITION_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "ignition-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
