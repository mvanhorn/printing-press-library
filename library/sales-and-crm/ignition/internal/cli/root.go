...
type rootFlags struct {
	...
	// invocation. Mirrors the IGNITION_NO_LEARN env var.
	noLearn bool
...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "ignition-pp-cli",
		Short: `Ignition CLI — A read-only, agent-native CLI for Ignition proposals, invoices, billing, clients, and payments, with a local SQLite…`,
		Long: `Ignition CLI — A read-only, agent-native CLI for Ignition proposals, invoices, billing, clients, and payments, with a local SQLite mirror and invoicing analytics the web UI does not offer.
...
Health check: run 'ignition-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("ignition-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'ignition-pp-cli profile list')")
	...
	rootCmd.AddCommand(newCurrentsCmd(flags))
	rootCmd.AddCommand(newSearchIndexCmd(flags))
	...
	rootCmd.AddCommand(newNovelClientBillingCmd(flags))
	rootCmd.AddCommand(newNovelOutstandingCmd(flags))
	rootCmd.AddCommand(newNovelPipelineCmd(flags))
	rootCmd.AddCommand(newNovelRejectedPaymentsCmd(flags))
	rootCmd.AddCommand(newNovelUnbilledCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newAcknowledgementsPromotedCmd(flags))
	rootCmd.AddCommand(newAddsPromotedCmd(flags))
	rootCmd.AddCommand(newAppsPromotedCmd(flags))
	rootCmd.AddCommand(newAuthApiPromotedCmd(flags))
	rootCmd.AddCommand(newBillingsPromotedCmd(flags))
	rootCmd.AddCommand(newBrandingsPromotedCmd(flags))
	rootCmd.AddCommand(newCodesPromotedCmd(flags))
	rootCmd.AddCommand(newCompliancesPromotedCmd(flags))
	...
	rootCmd.AddCommand(newPreferredsPromotedCmd(flags))
	rootCmd.AddCommand(newProposalsPromotedCmd(flags))
	rootCmd.AddCommand(newSitePromotedCmd(flags))
	rootCmd.AddCommand(newSolosPromotedCmd(flags))
	rootCmd.AddCommand(newUnseensPromotedCmd(flags))
