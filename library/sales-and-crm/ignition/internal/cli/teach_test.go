...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("IGNITION_STATE_DIR", "")
	t.Setenv("IGNITION_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"ignition-pp-cli auth login",
		"ignition-pp-cli doctor",
		"ignition-pp-cli help items",
		"ignition-pp-cli sync",
		"ignition-pp-cli profile list",
		"ignition-pp-cli feedback list",
		"ignition-pp-cli which",
		"ignition-pp-cli agent-context",
		"ignition-pp-cli completion bash",
		"ignition-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"ignition-pp-cli recall",
		"ignition-pp-cli learnings",
		"ignition-pp-cli teach-pattern",
		"ignition-pp-cli teach-lookup",
		"ignition-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("ignition-pp-cli")); err == nil {
