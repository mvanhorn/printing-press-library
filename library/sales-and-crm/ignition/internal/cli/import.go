...
but do not stop the import.`,
  ...
  ignition-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  ignition-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | ignition-pp-cli import <resource> --input -`,
