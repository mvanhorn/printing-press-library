...
func newClientsSummaryRejectedPaymentsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "summary-rejected-payments",
		Short:       "Fetch clients summary rejected payments",
		Example:     "  ignition-pp-cli clients summary-rejected-payments --operation-name example-resource",
		Annotations: map[string]string{"pp:endpoint": "clients.summary_rejected_payments", "pp:method": "POST", "pp:path": "/graphql"},
