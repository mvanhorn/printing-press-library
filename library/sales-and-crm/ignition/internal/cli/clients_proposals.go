...
func newClientsProposalsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "proposals",
		Short:       "Fetch clients proposals",
		Example:     "  ignition-pp-cli clients proposals --operation-name example-resource",
		Annotations: map[string]string{"pp:endpoint": "clients.proposals", "pp:method": "POST", "pp:path": "/graphql"},
