...
but do not stop the import.`,
  ...
  zapmail-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  zapmail-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | zapmail-pp-cli import <resource> --input -`,
