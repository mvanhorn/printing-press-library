...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "zapmail-pp-cli",
		Short: `Every Zapmail dashboard action, plus an offline SQLite mirror of your whole mailbox and domain fleet, with deliverability rollups and renewal-cost forecasting no other Zapmail tool ships.`,
		Long: `Every Zapmail dashboard action, plus an offline SQLite mirror of your whole mailbox and domain fleet, with deliverability rollups and renewal-cost forecasting no other Zapmail tool ships.
...
Health check: run 'zapmail-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("zapmail-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'zapmail-pp-cli profile list')")
	...
	rootCmd.AddCommand(newWalletPromotedCmd(flags))
