...
but do not stop the import.`,
  ...
  email-bison-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  email-bison-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | email-bison-pp-cli import <resource> --input -`,
