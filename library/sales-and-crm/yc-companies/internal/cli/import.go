...
but do not stop the import.`,
  ...
  yc-companies-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  yc-companies-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | yc-companies-pp-cli import <resource> --input -`,
