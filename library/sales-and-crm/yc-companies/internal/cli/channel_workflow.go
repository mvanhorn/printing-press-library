...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  yc-companies-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  yc-companies-pp-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"companies", "companies-black-founded-json", "companies-hiring-json", "companies-hispanic-latino-founded-json", "companies-nonprofit-json", "companies-top-json", "companies-women-founded-json"}
			totalSynced := 0
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  yc-companies-pp-cli workflow status

  # Show status as JSON
  yc-companies-pp-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("yc-companies-pp-cli")
			}
