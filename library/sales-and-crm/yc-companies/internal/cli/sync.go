...
Exit codes & warnings:
  ...
  yc-companies-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  yc-companies-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  yc-companies-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  yc-companies-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  yc-companies-pp-cli sync --latest-only`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if dbPath == "" {
				dbPath = defaultDBPath("yc-companies-pp-cli")
			}
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/yc-companies-pp-cli/data.db)")
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "industries":
		return db.UpsertIndustries(data)
	case "meta":
...
func defaultSyncResources() []string {
	return []string{
		...
		"companies-hispanic-latino-founded-json",
		"companies-nonprofit-json",
		"companies-top-json",
		"companies-women-founded-json",
	}
}
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"companies":                              "/companies/all.json",
		"companies-black-founded-json":           "/companies/black-founded.json",
		"companies-hiring-json":                  "/companies/hiring.json",
		"companies-hispanic-latino-founded-json": "/companies/hispanic-latino-founded.json",
		"companies-nonprofit-json":               "/companies/nonprofit.json",
		"companies-top-json":                     "/companies/top.json",
		"companies-women-founded-json":           "/companies/women-founded.json",
	}
