...
but do not stop the import.`,
  ...
  prospeo-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  prospeo-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | prospeo-pp-cli import <resource> --input -`,
