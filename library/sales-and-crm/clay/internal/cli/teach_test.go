...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/sales-and-crm/clay/internal/cliutil/testenv"
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"clay-pp-cli auth login",
		"clay-pp-cli doctor",
		"clay-pp-cli help items",
		"clay-pp-cli sync",
		"clay-pp-cli profile list",
		"clay-pp-cli feedback list",
		"clay-pp-cli which",
		"clay-pp-cli agent-context",
		"clay-pp-cli completion bash",
		"clay-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"clay-pp-cli teach",
		"clay-pp-cli recall",
		"clay-pp-cli learnings",
		"clay-pp-cli teach-pattern",
		"clay-pp-cli teach-lookup",
		"clay-pp-cli items list",
	}
