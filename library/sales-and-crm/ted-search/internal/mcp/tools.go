...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/sales-and-crm/ted-search/internal/cli"
	"github.com/mvanhorn/printing-press-library/library/sales-and-crm/ted-search/internal/client"
	"github.com/mvanhorn/printing-press-library/library/sales-and-crm/ted-search/internal/config"
	"github.com/mvanhorn/printing-press-library/library/sales-and-crm/ted-search/internal/mcp/cobratree"
)
		...
		if err != nil {
			...
			case strings.Contains(msg, "HTTP 401"):
				return mcplib.NewToolResultError("authentication failed: " + msg +
					...
					"\n      Run 'ted-search-pp-cli doctor' to check auth status."), nil
...
func newMCPClient() (*client.Client, error) {
	...
	cfgPath := filepath.Join(home, ".config", "ted-search-pp-cli", "config.toml")
...
func dbPath() string {
	home, _ := os.UserHomeDir()
	return filepath.Join(home, ".local", "share", "ted-search-pp-cli", "data.db")
}
...
func handleContext(_ context.Context, _ mcplib.CallToolRequest) (*mcplib.CallToolResult, error) {
	ctx := map[string]any{
		...
		"tool_surface": "MCP exposes typed endpoint tools plus a runtime mirror of user-facing CLI commands. Endpoint tools keep typed schemas; command-mirror tools shell out to the companion ted-search-pp-cli binary.",
