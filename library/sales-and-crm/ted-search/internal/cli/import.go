...
but do not stop the import.`,
  ...
  ted-search-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  ted-search-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | ted-search-pp-cli import <resource> --input -`,
