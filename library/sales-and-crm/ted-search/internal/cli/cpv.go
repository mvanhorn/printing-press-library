...
Examples:
  ted-search-pp-cli cpv search software
  ted-search-pp-cli cpv search construction
  ted-search-pp-cli cpv search "health services" --json`,
		Annotations: map[string]string{
			"mcp:read-only": "true",
		},
...
Examples:
  ted-search-pp-cli cpv get 72000000
  ted-search-pp-cli cpv get 45`,
		Annotations: map[string]string{
			"mcp:read-only": "true",
		},
		RunE: func(cmd *cobra.Command, args []string) error {
