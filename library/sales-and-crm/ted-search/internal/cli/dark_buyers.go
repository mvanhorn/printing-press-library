...
Examples:
  ted-search-pp-cli dark-buyers --country DEU --cpv 72
  ted-search-pp-cli dark-buyers --country FRA --min-calls 5 --since 2023-01-01`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			q += fmt.Sprintf(" GROUP BY buyer_name HAVING COUNT(*) >= %d\n), buyer_awards AS (\n", minCalls)
			...
			FROM buyer_calls c LEFT JOIN buyer_awards a ON c.buyer_name=a.buyer_name
