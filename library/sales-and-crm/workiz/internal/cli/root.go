...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "workiz-pp-cli",
		Short: `Workiz CLI — Every Workiz dispatch and pipeline workflow, plus crew utilization, revenue, and conversion views no other Workiz tool …`,
		Long: `Workiz CLI — Every Workiz dispatch and pipeline workflow, plus crew utilization, revenue, and conversion views no other Workiz tool …
...
See README.md or the bundled SKILL.md for recipes.`,
	...
	rootCmd.SetVersionTemplate("workiz-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'workiz-pp-cli profile list')")
	...
	rootCmd.AddCommand(newLeadCmd(flags))
