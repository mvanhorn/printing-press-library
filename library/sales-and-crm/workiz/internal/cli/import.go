...
but do not stop the import.`,
  ...
  workiz-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  workiz-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | workiz-pp-cli import <resource> --input -`,
