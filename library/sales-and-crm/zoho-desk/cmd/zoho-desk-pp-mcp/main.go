...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/sales-and-crm/zoho-desk/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "zoho-desk-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
