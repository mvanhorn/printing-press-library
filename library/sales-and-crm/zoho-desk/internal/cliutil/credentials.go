...
type Credentials struct {
	...
	ZohoDeskClientId     string    `toml:"desk_client_id,omitempty"`
	ZohoDeskClientSecret string    `toml:"desk_client_secret,omitempty"`
	ZohoDeskRefreshToken string    `toml:"desk_refresh_token,omitempty"`
}
