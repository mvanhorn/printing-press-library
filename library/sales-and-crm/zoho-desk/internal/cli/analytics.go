...
Data must be synced first with the sync command.`,
  ...
  zoho-desk-pp-cli analytics --type messages

  # Group by a field
  zoho-desk-pp-cli analytics --type messages --group-by author_id

  # Top 10 most frequent values
  zoho-desk-pp-cli analytics --type messages --group-by channel_id --limit 10 --json`,
