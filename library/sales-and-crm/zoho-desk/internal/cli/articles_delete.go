...
func newArticlesDeleteCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "delete",
		Short:       "This API moves articles to the Recycle Bin",
		Example:     "  zoho-desk-pp-cli articles delete",
		Annotations: map[string]string{"pp:endpoint": "articles.delete", "pp:method": "POST", "pp:path": "/api/v1/articles/moveToTrash"},
