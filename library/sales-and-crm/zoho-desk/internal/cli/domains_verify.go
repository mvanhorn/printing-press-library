...
func newDomainsVerifyCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "verify",
		Short:       "This API verifies a domain in your help desk.",
		Example:     "  zoho-desk-pp-cli domains verify --domain example-value",
		Annotations: map[string]string{"pp:endpoint": "domains.verify", "pp:method": "POST", "pp:path": "/api/v1/domains/verify"},
