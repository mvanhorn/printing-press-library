...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "ticketfields":
		return db.UpsertTicketfields(data)
	case "tickets":
		return db.UpsertTickets(data)
	case "tickets_search":
		return db.UpsertTicketsSearch(data)
	case "timeentries":
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		...
		"organizations-accessible-organizations": "/accessibleOrganizations",
		"products":                               "/products",
		"slas":                                   "/slas",
		"tags":                                   "/tags",
		"tasks":                                  "/tasks",
...
func responsePathForResource(resource, path string) []string {
	...
	case "accounts\x00/accounts/{account_id}/contacts":
		return []string{"data"}
	case "accounts\x00/accounts":
		return []string{"data"}
	case "accounts\x00/accounts/{account_id}/tickets":
		return []string{"data"}
	case "agents\x00/agents":
		return []string{"data"}
	case "articles\x00/articles":
		return []string{"data"}
	case "articles\x00/articles/search":
		return []string{"data"}
	case "comments\x00/tickets/{ticket_id}/comments":
		return []string{"data"}
	case "contacts\x00/contacts":
		return []string{"data"}
	case "contacts\x00/contacts/{contact_id}/tickets":
		return []string{"data"}
	case "departments\x00/departments":
		return []string{"data"}
	case "organizations\x00/accessibleOrganizations":
		return []string{"data"}
	case "organizations\x00/organizations":
		return []string{"data"}
	case "products\x00/products":
		return []string{"data"}
	case "slas\x00/slas":
		return []string{"data"}
	case "tags\x00/tags":
	...
	case "tasks\x00/tasks":
		return []string{"data"}
	case "teams\x00/teams/{team_id}/agents":
		return []string{"data"}
	case "teams\x00/teams":
		return []string{"data"}
	case "threads\x00/tickets/{ticket_id}/threads":
		return []string{"data"}
	case "ticketfields\x00/ticketFields":
		return []string{"data"}
	case "tickets\x00/tickets/{ticket_id}/History":
		return []string{"data"}
	case "tickets\x00/tickets":
		return []string{"data"}
	case "tickets_search\x00/tickets/search":
		return []string{"data"}
	case "timeentries\x00/tickets/{ticket_id}/timeEntry":
		return []string{"data"}
	}
	return nil
}
