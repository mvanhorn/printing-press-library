...
but do not stop the import.`,
  ...
  zoho-desk-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  zoho-desk-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | zoho-desk-pp-cli import <resource> --input -`,
