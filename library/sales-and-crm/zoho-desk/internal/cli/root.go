...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		...
		Short: `Zoho Desk CLI — The only scriptable, agent-native CLI for Zoho Desk: every ticket operation plus a local SQLite store, offline search, …`,
		Long: `Zoho Desk CLI — The only scriptable, agent-native CLI for Zoho Desk: every ticket operation plus a local SQLite store, offline search, …
...
See README.md or the bundled SKILL.md for recipes.`,
	...
	rootCmd.AddCommand(newNovelBreachHistoryCmd(flags))
	rootCmd.AddCommand(newNovelContact360Cmd(flags))
	rootCmd.AddCommand(newNovelMorningCmd(flags))
	rootCmd.AddCommand(newNovelRebalanceCmd(flags))
	rootCmd.AddCommand(newNovelSinceCmd(flags))
	rootCmd.AddCommand(newNovelSlaRadarCmd(flags))
	rootCmd.AddCommand(newNovelTriageCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newSlasPromotedCmd(flags))
	rootCmd.AddCommand(newTagsPromotedCmd(flags))
	rootCmd.AddCommand(newTicketfieldsPromotedCmd(flags))
	rootCmd.AddCommand(newTicketsSearchPromotedCmd(flags))
