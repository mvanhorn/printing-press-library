...
large datasets as it has no memory pressure.`,
  ...
  zoho-desk-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  zoho-desk-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  zoho-desk-pp-cli export <resource> --format jsonl | jq '.id'`,
