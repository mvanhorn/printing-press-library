...
func newOrganizationFieldsUpdateFieldCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:       "This API edits a field",
		Example:     "  zoho-desk-pp-cli organization-fields update-field 42",
		Annotations: map[string]string{"pp:endpoint": "organization-fields.update-field", "pp:method": "PATCH", "pp:path": "/api/v1/organizationFields/{fieldId}"},
