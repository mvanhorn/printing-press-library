...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  zoho-desk-pp-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"accounts", "agents", "articles", "contacts", "departments", "organizations", "organizations-accessible-organizations", "products", "slas", "tags", "tasks", "teams", "ticketfields", "tickets"}
			totalSynced := 0
