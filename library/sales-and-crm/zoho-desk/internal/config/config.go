...
func Load(configPath string) (*Config, error) {
	...
	path := configPath
	if path == "" {
		path = os.Getenv("ZOHO_DESK_CONFIG")
	}
	if path == "" {
		home, _ := os.UserHomeDir()
		path = filepath.Join(home, ".config", "zoho-desk-pp-cli", "config.toml")
	}
	cfg.Path = path
	...
	// Env var overrides
	if v := os.Getenv("ZOHODESK_REFRESH_TOKEN"); v != "" {
		cfg.RefreshToken = v
		cfg.AuthSource = "env:ZOHODESK_REFRESH_TOKEN"
	}
