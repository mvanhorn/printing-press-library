...
Exit codes & warnings:
  ...
  ghl-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  ghl-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  ghl-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  ghl-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  ghl-pp-cli sync --latest-only`,
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "templates", ParentTable: "locations", ParentIDParam: "locationId", PathTemplate: "/locations/{locationId}/templates", KeyField: ""},
	}
}
