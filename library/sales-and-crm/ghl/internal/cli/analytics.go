...
Data must be synced first with the sync command.`,
  ...
  ghl-pp-cli analytics --type messages

  # Group by a field
  ghl-pp-cli analytics --type messages --group-by author_id

  # Top 10 most frequent values
  ghl-pp-cli analytics --type messages --group-by channel_id --limit 10 --json`,
