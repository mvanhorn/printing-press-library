...
large datasets as it has no memory pressure.`,
  ...
  outreach-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  outreach-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  outreach-pp-cli export <resource> --format jsonl | jq '.id'`,
