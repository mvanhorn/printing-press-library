...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "outreach-pp-cli",
		Short: "Manage outreach resources via the outreach API",
		Long: `Manage outreach resources via the outreach API.
...
Run 'outreach-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("outreach-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'outreach-pp-cli profile list')")
	...
	rootCmd.AddCommand(newMailboxesPromotedCmd(flags))
	rootCmd.AddCommand(newMailingsPromotedCmd(flags))
	rootCmd.AddCommand(newOpportunitiesPromotedCmd(flags))
	rootCmd.AddCommand(newSequenceStatesPromotedCmd(flags))
	rootCmd.AddCommand(newSequencesPromotedCmd(flags))
