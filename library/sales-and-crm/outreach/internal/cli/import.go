...
but do not stop the import.`,
  ...
  outreach-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  outreach-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | outreach-pp-cli import <resource> --input -`,
