...
func newUsersPromotedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "users",
		Short:       "List Outreach users.",
		Long:        "List Outreach users.",
		Example:     "  outreach-pp-cli users",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "/users"
			data, prov, err := resolvePaginatedReadWithStrategy(cmd.Context(), c, flags, "auto", "users", path, map[string]string{}, nil, flagAll, "page[number]", "page", "page[size]", "", "", cmd.ErrOrStderr())
			if err != nil {
