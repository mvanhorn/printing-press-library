# Local verification for outreach-pp-cli
...
- `go vet ./...`: passed
- `go build ./...`: passed
- `outreach-pp-cli --help`: passed
- `outreach-pp-cli version`: passed
- `outreach-pp-cli doctor --json`: passed with expected no-credentials diagnostics
- `outreach-pp-mcp --help`: passed
