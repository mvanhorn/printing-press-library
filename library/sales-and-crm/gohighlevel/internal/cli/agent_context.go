...
// agent-context emits a structured reflection of this CLI's cobra tree —
// commands, flags, auth env vars. It intentionally has no API client call
// and no local-store access; agents read it to introspect the binary.
//
