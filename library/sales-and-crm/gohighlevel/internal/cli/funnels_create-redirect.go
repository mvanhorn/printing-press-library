...
func newFunnelsCreateRedirectCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:       "The 'Create Redirect' API Allows adding a new url redirect to the system. Use this endpoint to create a url redirect...",
		Example:     "  gohighlevel-pp-cli funnels create-redirect --action example-value",
		Annotations: map[string]string{"pp:endpoint": "funnels.create-redirect", "pp:method": "POST", "pp:path": "/funnels/lookup/redirect"},
