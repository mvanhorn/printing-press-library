...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "brand_boards":
		return db.UpsertBrandBoards(data)
	case "businesses":
		return db.UpsertBusinesses(data)
	case "calendars":
	...
	case "contacts_campaigns":
		return db.UpsertContactsCampaigns(data)
	...
	case "contacts_tasks":
		return db.UpsertContactsTasks(data)
	case "workflow":
	...
	case "late_fees_configuration":
		return db.UpsertLateFeesConfiguration(data)
	case "record_payment":
		return db.UpsertRecordPayment(data)
	case "send":
		return db.UpsertSend(data)
	case "void":
		return db.UpsertVoid(data)
	case "locations_custom_fields":
		return db.UpsertLocationsCustomFields(data)
	case "custom_values":
		return db.UpsertCustomValues(data)
	case "recurring_tasks":
		return db.UpsertRecurringTasks(data)
	case "locations_tags":
		return db.UpsertLocationsTags(data)
	case "locations_tasks":
		return db.UpsertLocationsTasks(data)
	case "templates":
		return db.UpsertTemplates(data)
	case "timezones":
		return db.UpsertTimezones(data)
	case "marketplace":
		return db.UpsertMarketplace(data)
	case "oauth":
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"ad-publishing":   "/ad-publishing/facebook/ad-accounts",
		"agent-studio":    "/agent-studio/agent",
		"associations":    "/associations/",
		"blogs":           "/blogs/authors",
		"businesses":      "/businesses/",
		"calendars":       "/calendars/schedules/search",
		"contacts":        "/contacts/",
		"conversation-ai": "/conversation-ai/agents/search",
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "affiliates", ParentTable: "locations", ParentIDParam: "locationId", PathTemplate: "/affiliate-manager/{locationId}/affiliates"},
		{Name: "brand_boards", ParentTable: "locations", ParentIDParam: "locationId", PathTemplate: "/brand-boards/{locationId}"},
		{Name: "categories", ParentTable: "locations", ParentIDParam: "locationId", PathTemplate: "/social-media-posting/{locationId}/categories"},
		{Name: "commissions", ParentTable: "locations", ParentIDParam: "locationId", PathTemplate: "/affiliate-manager/{locationId}/commissions"},
		{Name: "contacts", ParentTable: "businesses", ParentIDParam: "businessId", PathTemplate: "/contacts/business/{businessId}"},
		{Name: "csv", ParentTable: "locations", ParentIDParam: "locationId", PathTemplate: "/social-media-posting/{locationId}/csv"},
		{Name: "messages", ParentTable: "conversations", ParentIDParam: "conversationId", PathTemplate: "/conversations/{conversationId}/messages"},
		{Name: "notifications", ParentTable: "calendars", ParentIDParam: "calendarId", PathTemplate: "/calendars/{calendarId}/notifications"},
		{Name: "payouts", ParentTable: "locations", ParentIDParam: "locationId", PathTemplate: "/affiliate-manager/{locationId}/payouts"},
		{Name: "phone_system", ParentTable: "locations", ParentIDParam: "locationId", PathTemplate: "/phone-system/numbers/location/{locationId}"},
		{Name: "price", ParentTable: "products", ParentIDParam: "productId", PathTemplate: "/products/{productId}/price"},
		{Name: "social_media_posting_tags", ParentTable: "locations", ParentIDParam: "locationId", PathTemplate: "/social-media-posting/{locationId}/tags"},
		{Name: "templates", ParentTable: "locations", ParentIDParam: "locationId", PathTemplate: "/locations/{locationId}/templates"},
	}
}
