...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  gohighlevel-pp-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"ad-publishing", "agent-studio", "associations", "blogs", "businesses", "calendars", "contacts", "conversation-ai", "conversations", "custom-menus", "emails", "forms", "funnels", "invoices", "knowledge-bases", "links", "locations", "marketplace", "medias", "oauth", "opportunities", "payments", "phone-system", "products", "proposals", "store", "surveys", "users", "voice-ai"}
			totalSynced := 0
