		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if cfg != nil {
				...
				if header == "" {
					...
					report["auth_hint"] = "export HIGHLEVEL_TOKEN=<your-key>"
				} else {
			...
			if os.Getenv("HIGHLEVEL_TOKEN") != "" {
				authEnvSet = append(authEnvSet, "HIGHLEVEL_TOKEN")
			} else {
				authEnvRequiredMissing = append(authEnvRequiredMissing, "HIGHLEVEL_TOKEN")
			}
			switch {
			...
			if cfg != nil && cfg.BaseURL != "" {
				...
				if clientErr != nil {
					...
					if authHeader == "" {
						...
						authHeaders["Version"] = "2021-07-28"
						authHeaders["User-Agent"] = "gohighlevel-pp-cli"
