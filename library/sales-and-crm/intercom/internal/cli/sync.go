...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/sales-and-crm/intercom/internal/learn/lookups"
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{ // #nosec G101 -- endpoint paths, not credentials.
		"admins":                    "/admins",
		"admins-activity-logs":      "/admins/activity_logs",
...
var reconcileTypedTables = map[string]string{
	...
	"companies_segments":  "companies_segments",
	"contacts":            "contacts",
	"contacts_companies":  "contacts_companies",
	"contacts_notes":      "contacts_notes",
	"contacts_segments":   "contacts_segments",
	"contacts_tags":       "contacts_tags",
	"conversations":       "conversations",
	"conversations_reply": "conversations_reply",
	"conversations_tags":  "conversations_tags",
	"convert":             "convert",
	"customers":           "customers",
	"news":                "news",
	"parts":               "parts",
...
func responsePathForResource(resource, path string) []string {
	...
	case "admins\x00/admins":
		return []string{"admins"}
	case "admins\x00/admins/activity_logs":
		return []string{"activity_logs"}
	case "admins\x00/admins/{id}":
		return []string{"team_ids"}
	case "ai\x00/ai/content_import_sources":
		return []string{"data"}
	case "ai\x00/ai/external_pages":
		return []string{"data"}
	case "articles\x00/articles":
		return []string{"data"}
	case "companies\x00/companies/list":
		return []string{"data"}
	case "companies\x00/companies":
		return []string{"data"}
	case "companies\x00/companies/scroll":
		return []string{"data"}
	case "contacts\x00/contacts":
		return []string{"data"}
	case "contacts\x00/contacts/search":
		return []string{"data"}
	case "conversations\x00/conversations":
		return []string{"conversations"}
	case "conversations\x00/conversations/search":
		return []string{"conversations"}
	case "data-attributes\x00/data_attributes":
		return []string{"options"}
	case "data-attributes\x00/data_attributes/{id}":
		return []string{"options"}
	case "events\x00/events":
		return []string{"events"}
	case "help-center\x00/help_center/help_centers":
		return []string{"data"}
	case "help-center\x00/help_center/collections":
		return []string{"data"}
	case "internal-articles\x00/internal_articles":
		return []string{"data"}
	case "me\x00/me":
		return []string{"team_ids"}
	case "news\x00/news/news_items":
		return []string{"data"}
	case "news\x00/news/newsfeeds/{id}/items":
		return []string{"data"}
	case "news\x00/news/newsfeeds":
		return []string{"data"}
	case "segments\x00/segments":
		return []string{"segments"}
	case "subscription-types\x00/subscription_types":
		return []string{"data"}
	case "tags\x00/tags":
		return []string{"data"}
	...
	case "teams\x00/teams/{id}":
		return []string{"admin_ids"}
	case "ticket-states\x00/ticket_states":
		return []string{"data"}
	case "ticket-types\x00/ticket_types":
		return []string{"data"}
	case "tickets\x00/tickets/search":
