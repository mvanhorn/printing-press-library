...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("INTERCOM_STATE_DIR", "")
	t.Setenv("INTERCOM_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"intercom-pp-cli auth login",
		"intercom-pp-cli doctor",
		"intercom-pp-cli help items",
		"intercom-pp-cli sync",
		"intercom-pp-cli profile list",
		"intercom-pp-cli feedback list",
		"intercom-pp-cli which",
		"intercom-pp-cli agent-context",
		"intercom-pp-cli completion bash",
		"intercom-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"intercom-pp-cli recall",
		"intercom-pp-cli learnings",
		"intercom-pp-cli teach-pattern",
		"intercom-pp-cli teach-lookup",
		"intercom-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("intercom-pp-cli")); err == nil {
