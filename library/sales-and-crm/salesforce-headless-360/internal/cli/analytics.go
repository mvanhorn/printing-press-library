...
Data must be synced first with the sync command.`,
  ...
  salesforce-headless-360-pp-cli analytics --type messages

  # Group by a field
  salesforce-headless-360-pp-cli analytics --type messages --group-by author_id

  # Top 10 most frequent values
  salesforce-headless-360-pp-cli analytics --type messages --group-by channel_id --limit 10 --json`,
