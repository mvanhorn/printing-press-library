...
native streaming instead of polling.`,
  ...
  salesforce-headless-360-pp-cli tail --interval 10s

  # Tail a specific resource
  salesforce-headless-360-pp-cli tail messages --interval 5s

  # Pipe to jq for filtering
  salesforce-headless-360-pp-cli tail events --interval 30s | jq 'select(.type == "error")'`,
