...
large datasets as it has no memory pressure.`,
  ...
  salesforce-headless-360-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  salesforce-headless-360-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  salesforce-headless-360-pp-cli export <resource> --format jsonl | jq '.id'`,
