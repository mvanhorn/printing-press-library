...
but do not stop the import.`,
  ...
  salesforce-headless-360-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  salesforce-headless-360-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | salesforce-headless-360-pp-cli import <resource> --input -`,
