...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "iqos-pp-cli",
		Short: `Every IQOS product, store, and flavor across 30+ markets — synced locally, searchable offline.`,
		Long: `Every IQOS product, store, and flavor across 30+ markets — synced locally, searchable offline.
...
Health check: run 'iqos-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("iqos-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'iqos-pp-cli profile list')")
	...
	flavorsCmd := newFlavorsPromotedCmd(flags)
	flavorsCmd.AddCommand(newFlavorsFindCmd(flags))
	flavorsCmd.AddCommand(newFlavorsListCmd(flags))
	rootCmd.AddCommand(flavorsCmd)
