...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "continente-pp-cli",
		Short: "Query products on continente.pt",
		Long: `Query products on continente.pt.

Add --agent to any command for JSON output + non-interactive mode.
Run 'continente-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("continente-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.metaMode, "meta", "auto", "Metadata envelope policy for JSON output: auto, full, minimal, or none")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'continente-pp-cli profile list')")
	...
	rootCmd.PersistentPreRunE = func(cmd *cobra.Command, args []string) error {
		...
		switch flags.metaMode {
		case "auto", "full", "minimal", "none":
			// valid
		default:
			return fmt.Errorf("invalid --meta value %q: must be auto, full, minimal, or none", flags.metaMode)
		}
		return nil
	}
	rootCmd.AddCommand(newOnCmd(flags))
