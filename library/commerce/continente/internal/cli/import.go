...
but do not stop the import.`,
  ...
  continente-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  continente-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | continente-pp-cli import <resource> --input -`,
