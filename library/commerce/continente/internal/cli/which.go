...
var whichIndex = []whichEntry{
	{Command: "browse", Description: "Browse category or filtered storefront results with pagination and refinement metadata", Group: "shopping"},
	{Command: "alternatives", Description: "Find comparable product alternatives ranked by similarity and deal quality", Group: "shopping"},
	{Command: "compare", Description: "Compare two products side by side with pricing deltas", Group: "shopping"},
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  continente-pp-cli which "stale tickets"
  continente-pp-cli which "bottleneck"
  continente-pp-cli which --limit 1 "send message"
  continente-pp-cli which                                # list the full capability index`,
...
func renderWhich(cmd *cobra.Command, flags *rootFlags, matches []whichMatch) error {
	...
	if asJSON {
		...
		if flags.compact && flags.selectFields == "" {
			out["matches"] = compactWhichMatches(matches)
		}
...
func compactWhichMatches(matches []whichMatch) []map[string]any {
