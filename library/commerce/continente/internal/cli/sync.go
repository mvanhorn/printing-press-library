...
Resource scoping:
  ...
  continente-pp-cli sync

  # Sync specific resources only
  continente-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  continente-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  continente-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  continente-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  continente-pp-cli sync --latest-only`,
