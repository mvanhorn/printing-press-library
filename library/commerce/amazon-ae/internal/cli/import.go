...
but do not stop the import.`,
  ...
  amazon-ae-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  amazon-ae-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | amazon-ae-pp-cli import <resource> --input -`,
