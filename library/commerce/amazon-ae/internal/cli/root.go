...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "amazon-ae-pp-cli",
		Short: "Manage amazon-ae resources via the amazon-ae API",
		Long: `Manage amazon-ae resources via the amazon-ae API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'amazon-ae-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("amazon-ae-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'amazon-ae-pp-cli profile list')")
