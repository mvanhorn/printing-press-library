...
cd /home/hermes/projects/doordash-consumer-pp-cli/active-wrapper
...
cmds = [
  ('doctor', ['doordash-consumer-pp-cli','doctor','--json']),
  ('search_pizza', ['doordash-consumer-pp-cli','search','pizza','--json']),
  ('menu_pizza_hut', ['doordash-consumer-pp-cli','menu','--store-id','2418408','--json']),
  ('item_options_personal_pan', ['doordash-consumer-pp-cli','item-options','--store-id','2418408','--item-id','35292395509','--json']),
  ('convenience_search_cvs_milk', ['doordash-consumer-pp-cli','convenience-search','--store-id','23321373','milk','--json']),
  ('orders_recent', ['doordash-consumer-pp-cli','orders','recent','--limit','3','--json']),
  ('addresses_list', ['doordash-consumer-pp-cli','addresses','list','--json']),
  ('payment_methods_list', ['doordash-consumer-pp-cli','payment-methods','list','--json']),
  ('cart_show', ['doordash-consumer-pp-cli','cart','show','--json']),
]
summary={}
