...
func New(cfg *config.Config, timeout time.Duration, rateLimit float64) *Client {
	...
	cacheDir := filepath.Join(homeDir, ".cache", "doordash-consumer-pp-cli")
...
func (c *Client) do(method, path string, params map[string]string, body any, headerOverrides map[string]string) (json.RawMessage, int, error) {
	...
	for attempt := 0; attempt <= maxRetries; attempt++ {
		...
		if req.Header.Get("User-Agent") == "" {
			req.Header.Set("User-Agent", "doordash-consumer-pp-cli/0.1.0")
		}
...
func (c *Client) applyDoorDashBrowserHeaders(req *http.Request) {
	...
	// PATCH: DoorDash consumer GraphQL endpoints expect browser-context headers even when driven by a CLI.
