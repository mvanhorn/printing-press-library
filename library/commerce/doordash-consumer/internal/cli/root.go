...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "doordash-consumer-pp-cli",
		Short: "Manage doordash-consumer resources via the doordash-consumer API",
		Long: `Manage doordash-consumer resources via the doordash-consumer API.
...
Run 'doordash-consumer-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("doordash-consumer-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'doordash-consumer-pp-cli profile list')")
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("doordash-consumer-pp-cli %s\n", version)
		},
	}
}
