...
but do not stop the import.`,
  ...
  doordash-consumer-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  doordash-consumer-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | doordash-consumer-pp-cli import <resource> --input -`,
