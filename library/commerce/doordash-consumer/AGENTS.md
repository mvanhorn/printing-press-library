# Doordash Consumer Printed CLI Agent Guide

This directory is a generated `doordash-consumer-pp-cli` printed CLI. It was produced by [CLI Printing Press](https://github.com/mvanhorn/cli-printing-press), so treat systemic fixes as upstream Printing Press fixes first. Keep local edits narrow and document why a generated-tree patch belongs here.
...
```bash
/home/hermes/go/bin/doordash-consumer-pp-cli <command> --help
/home/hermes/go/bin/doordash-consumer-pp-cli <command> --dry-run --json
```
