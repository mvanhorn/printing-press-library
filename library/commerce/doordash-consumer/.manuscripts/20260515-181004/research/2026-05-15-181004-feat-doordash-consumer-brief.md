# DoorDash Consumer research brief

This promoted print packages a curated DoorDash consumer GraphQL surface discovered from browser-session traffic and normalized into safe CLI workflows.
