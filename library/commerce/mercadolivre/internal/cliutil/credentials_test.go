...
func resetCredentialEnv(t *testing.T) (home, configPath string) {
	...
	for _, name := range []string{
		...
		"MERCADOLIVRE_DATA_DIR",
		"MERCADOLIVRE_STATE_DIR",
		"MERCADOLIVRE_CACHE_DIR",
		"MERCADOLIVRE_HOME",
		"XDG_CONFIG_HOME",
		"XDG_DATA_HOME",
		"XDG_STATE_HOME",
	...
	return home, filepath.Join(home, ".config", "mercadolivre-pp-cli", "config.toml")
}
...
func TestCorruptCredentialsFallsBackToLegacyConfig(t *testing.T) {
	...
	credentialsPath := filepath.Join(home, ".local", "share", "mercadolivre-pp-cli", "credentials.toml")
...
func TestAuthWriteScrubsLegacyConfigWhenRelocated(t *testing.T) {
	...
	activeConfigPath := filepath.Join(newConfigDir, "mercadolivre-pp-cli", "config.toml")
	...
	credsPath := filepath.Join(newDataDir, "mercadolivre-pp-cli", "credentials.toml")
