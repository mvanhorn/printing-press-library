...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "mercadolivre-pp-cli",
		Short: `Mercadolivre CLI — Search Mercado Livre, compare prices and technical specs across listings, and build cotações — offline-persisted and ag…`,
		Long: `Mercadolivre CLI — Search Mercado Livre, compare prices and technical specs across listings, and build cotações — offline-persisted and ag…
...
Health check: run 'mercadolivre-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("mercadolivre-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'mercadolivre-pp-cli profile list')")
	...
	rootCmd.AddCommand(newNovelDispersionCmd(flags))
	rootCmd.AddCommand(newNovelPriceHistoryCmd(flags))
	rootCmd.AddCommand(newNovelStaleCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newAutosuggestPromotedCmd(flags))
	rootCmd.AddCommand(newDiscoveryPromotedCmd(flags))
