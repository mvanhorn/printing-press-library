...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("ZAMEEN_STATE_DIR", "")
	t.Setenv("ZAMEEN_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"zameen-pp-cli auth login",
		"zameen-pp-cli doctor",
		"zameen-pp-cli help items",
		"zameen-pp-cli sync",
		"zameen-pp-cli profile list",
		"zameen-pp-cli feedback list",
		"zameen-pp-cli which",
		"zameen-pp-cli agent-context",
		"zameen-pp-cli completion bash",
		"zameen-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"zameen-pp-cli teach",
		"zameen-pp-cli recall",
		"zameen-pp-cli learnings",
		"zameen-pp-cli teach-pattern",
		"zameen-pp-cli teach-lookup",
		"zameen-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("zameen-pp-cli")); err == nil {
