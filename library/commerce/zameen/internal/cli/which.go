...
var whichIndex = []whichEntry{
	{Command: "watch", Description: "Re-run a saved search and see exactly which listings are new and which dropped in price since last time.", Group: "Local state that compounds", WhyItMatters: "Reach for this to monitor a market over time instead of re-eyeballing search pages; it answers 'what changed since yesterday?' which no single fetch can."},
	{Command: "comps", Description: "Median price, price-per-Marla, and inventory count for an area or society, computed from your synced listings.", Group: "Local state that compounds", WhyItMatters: "Use for area-level comps sheets and market rollups before a pitch or an offer."},
	{Command: "deals", Description: "Ranks scanned listings by how far under the area's price-per-Marla they sit and flags below-market files.", Group: "Deal-finding", WhyItMatters: "Reach for this to surface underpriced plot files in Pakistan's plot-flipping market before another dealer grabs them."},
	{Command: "aging", Description: "Lists the longest-standing inventory by days-on-market, derived from each listing's update timestamp.", Group: "Deal-finding", WhyItMatters: "Use to find sellers likely to negotiate — inventory that has sat on the market longest."},
	{Command: "agencies", Description: "Ranks agencies by listing count and median asking price in an area, from your synced listings.", Group: "Local state that compounds", WhyItMatters: "Use to see who dominates supply in a society before choosing an agent or gauging market concentration."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  zameen-pp-cli which "stale tickets"
  zameen-pp-cli which "bottleneck"
  zameen-pp-cli which --limit 1 "send message"
  zameen-pp-cli which                                # list the full capability index`,
