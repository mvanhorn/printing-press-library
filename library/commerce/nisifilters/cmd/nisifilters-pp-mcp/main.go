...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/commerce/nisifilters/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("NISIFILTERS_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "nisifilters-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
