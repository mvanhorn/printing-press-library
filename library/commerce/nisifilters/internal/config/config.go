...
func Load(configPath string) (*Config, error) {
	cfg := &Config{
		BaseURL: "https://nisifilters.it/wp-json/wp/v2",
	}
	...
	if v := os.Getenv("NISIFILTERS_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("NISIFILTERS_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "nisifilters-pp-cli", "config.toml"), nil
}
