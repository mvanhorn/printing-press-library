...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/commerce/nisifilters/internal/cliutil/testenv"
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"nisifilters-pp-cli auth login",
		"nisifilters-pp-cli doctor",
		"nisifilters-pp-cli help items",
		"nisifilters-pp-cli sync",
		"nisifilters-pp-cli profile list",
		"nisifilters-pp-cli feedback list",
		"nisifilters-pp-cli which",
		"nisifilters-pp-cli agent-context",
		"nisifilters-pp-cli completion bash",
		"nisifilters-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"nisifilters-pp-cli teach",
		"nisifilters-pp-cli recall",
		"nisifilters-pp-cli learnings",
		"nisifilters-pp-cli teach-pattern",
		"nisifilters-pp-cli teach-lookup",
		"nisifilters-pp-cli items list",
	}
