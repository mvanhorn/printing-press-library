...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  restaurant365-odata-pp-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"company", "employee", "entity-deleted", "gl-account", "glaccount", "item", "job-title", "labor-detail", "location", "payroll-summary", "posemployee", "sales-detail", "sales-employee", "sales-payment", "transaction", "transaction-detail"}
			totalSynced := 0
