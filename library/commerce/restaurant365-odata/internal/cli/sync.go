...
func resourceSupportsPagination(resource string) bool {
	switch resource {
	case "company", "employee", "entity-deleted", "gl-account", "glaccount", "item", "job-title", "labor-detail", "location", "payroll-summary", "posemployee", "sales-detail", "sales-employee", "sales-payment", "transaction", "transaction-detail":
		return true
	}
	return false
}
