...
but do not stop the import.`,
  ...
  noon-ae-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  noon-ae-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | noon-ae-pp-cli import <resource> --input -`,
