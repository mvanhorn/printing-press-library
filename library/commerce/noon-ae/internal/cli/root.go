...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "noon-ae-pp-cli",
		Short: "Manage noon-ae resources via the noon-ae API",
		Long: `Manage noon-ae resources via the noon-ae API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'noon-ae-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("noon-ae-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'noon-ae-pp-cli profile list')")
