...
See README.md or the bundled SKILL.md for recipes.`,
	...
	// PATCH: hand-authored quote engine + transcendence commands
	...
	// PATCH: authenticated account surface (refresh-token auth + read commands)
