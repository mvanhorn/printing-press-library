...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("BLACKLANE_STATE_DIR", "")
	t.Setenv("BLACKLANE_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"blacklane-pp-cli auth login",
		"blacklane-pp-cli doctor",
		"blacklane-pp-cli help items",
		"blacklane-pp-cli sync",
		"blacklane-pp-cli profile list",
		"blacklane-pp-cli feedback list",
		"blacklane-pp-cli which",
		"blacklane-pp-cli agent-context",
		"blacklane-pp-cli completion bash",
		"blacklane-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"blacklane-pp-cli recall",
		"blacklane-pp-cli learnings",
		"blacklane-pp-cli teach-pattern",
		"blacklane-pp-cli teach-lookup",
		"blacklane-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("blacklane-pp-cli")); err == nil {
