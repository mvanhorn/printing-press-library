...
large datasets as it has no memory pressure.`,
  ...
  thevc-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  thevc-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  thevc-pp-cli export <resource> --format jsonl | jq '.id'`,
