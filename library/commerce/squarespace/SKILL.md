...
Use `squarespace-pp-cli account domain <subcommand> --name example.com --json` for these nested domain reads: `custom-records`, `email-forwarding`, `email-mx-conflicts`, `billing-eligibility`, and `billing-valid-terms`.
