...
large datasets as it has no memory pressure.`,
  ...
  goose-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  goose-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  goose-pp-cli export <resource> --format jsonl | jq '.id'`,
