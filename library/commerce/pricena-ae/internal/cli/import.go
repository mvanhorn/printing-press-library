...
but do not stop the import.`,
  ...
  pricena-ae-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  pricena-ae-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | pricena-ae-pp-cli import <resource> --input -`,
