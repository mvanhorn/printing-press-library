...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "pricena-ae-pp-cli",
		Short: "Manage pricena-ae resources via the pricena-ae API",
		Long: `Manage pricena-ae resources via the pricena-ae API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'pricena-ae-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("pricena-ae-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'pricena-ae-pp-cli profile list')")
