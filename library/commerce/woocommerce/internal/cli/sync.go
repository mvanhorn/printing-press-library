...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/commerce/woocommerce/internal/learn"
...
Resource scoping:
  ...
  woocommerce-pp-cli sync

  # Sync specific resources only
  woocommerce-pp-cli sync --resources orders,products

  # Full resync (ignore previous checkpoint)
  woocommerce-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  woocommerce-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  woocommerce-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  woocommerce-pp-cli sync --latest-only`,
...
func determinePaginationDefaults(resource string) paginationDefaults {
	...
	case "catalog-taxonomy-categories":
		return paginationDefaults{
			cursorParam: "page",
			cursorType:  "page",
			limitParam:  "per_page",
	...
	case "products-custom-fields-names":
		return paginationDefaults{
			cursorParam: "page",
			cursorType:  "page",
			limitParam:  "per_page",
	...
	case "products-suggested-products":
		return paginationDefaults{
			cursorParam: "page",
			cursorType:  "page",
			limitParam:  "per_page",
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "order-refunds":
		return db.UpsertOrderRefunds(data)
	case "orders":
		return db.UpsertOrders(data)
	case "products":
		return db.UpsertProducts(data)
	case "variations":
		return db.UpsertVariations(data)
	default:
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{ // #nosec G101 -- endpoint paths, not credentials.
		...
		"attribute-terms":              "/wc/v3/products/attributes/{attribute_id}/terms",
		"brands":                       "/wc/v3/products/brands",
		"catalog":                      "/wc/store/v1/products",
		"catalog-reviews":              "/wc/store/v1/products/reviews",
		"catalog-taxonomy":             "/wc/store/v1/products/tags",
		"catalog-taxonomy-attributes":  "/wc/store/v1/products/attributes",
		"catalog-taxonomy-brands":      "/wc/store/v1/products/brands",
		"catalog-taxonomy-categories":  "/wc/store/v1/products/categories",
		...
		"products-custom-fields-names": "/wc/v3/products/custom-fields/names",
		"products-suggested-products":  "/wc/v3/products/suggested-products",
		...
		"store-data-continents":        "/wc/v3/data/continents",
		"store-data-countries":         "/wc/v3/data/countries",
		"store-data-currencies":        "/wc/v3/data/currencies",
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "order_refunds", ParentTable: "orders", ParentIDParam: "order_id", PathTemplate: "/wc/v3/orders/{order_id}/refunds", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "order_id", Field: "id"},
		}},
		{Name: "variations", ParentTable: "products", ParentIDParam: "product_id", PathTemplate: "/wc/v3/products/{product_id}/variations", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "product_id", Field: "id"},
		}},
	}
}
