...
type rootFlags struct {
	...
	// invocation. Mirrors the WOOCOMMERCE_NO_LEARN env var.
	noLearn bool
...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "woocommerce-pp-cli",
		Short: `WooCommerce CLI — The only WooCommerce CLI with a local database - so it answers the compound questions the Reports API cannot, and…`,
		Long: `WooCommerce CLI — The only WooCommerce CLI with a local database - so it answers the compound questions the Reports API cannot, and reads any store on the internet without credentials.
...
Health check: run 'woocommerce-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("woocommerce-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'woocommerce-pp-cli profile list')")
	...
	rootCmd.AddCommand(newAttributeTermsCmd(flags))
	rootCmd.AddCommand(newBrandsCmd(flags))
	rootCmd.AddCommand(newCatalogCmd(flags))
	rootCmd.AddCommand(newCatalogTaxonomyCmd(flags))
	rootCmd.AddCommand(newCategoriesCmd(flags))
	rootCmd.AddCommand(newCouponsCmd(flags))
	rootCmd.AddCommand(newCustomersCmd(flags))
	rootCmd.AddCommand(newOrderNotesCmd(flags))
	rootCmd.AddCommand(newOrderRefundsCmd(flags))
	rootCmd.AddCommand(newOrdersCmd(flags))
	rootCmd.AddCommand(newPaymentGatewaysCmd(flags))
	rootCmd.AddCommand(newProductAttributesCmd(flags))
	...
	rootCmd.AddCommand(newShippingClassesCmd(flags))
	rootCmd.AddCommand(newShippingMethodsCmd(flags))
	rootCmd.AddCommand(newShippingZoneLocationsCmd(flags))
	rootCmd.AddCommand(newShippingZoneMethodsCmd(flags))
	rootCmd.AddCommand(newShippingZonesCmd(flags))
	rootCmd.AddCommand(newStoreDataCmd(flags))
	rootCmd.AddCommand(newSystemStatusCmd(flags))
	rootCmd.AddCommand(newTagsCmd(flags))
	rootCmd.AddCommand(newTaxClassesCmd(flags))
	rootCmd.AddCommand(newTaxesCmd(flags))
	rootCmd.AddCommand(newVariationsCmd(flags))
	...
	rootCmd.AddCommand(newNovelRefundRateCmd(flags))
	rootCmd.AddCommand(newNovelRevenueCmd(flags))
	rootCmd.AddCommand(newNovelStockCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newAllVariationsPromotedCmd(flags))
	rootCmd.AddCommand(newCatalogReviewsPromotedCmd(flags))
	rootCmd.AddCommand(newRefundsPromotedCmd(flags))
