...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("WOOCOMMERCE_STATE_DIR", "")
	t.Setenv("WOOCOMMERCE_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"woocommerce-pp-cli auth login",
		"woocommerce-pp-cli doctor",
		"woocommerce-pp-cli help items",
		"woocommerce-pp-cli sync",
		"woocommerce-pp-cli profile list",
		"woocommerce-pp-cli feedback list",
		"woocommerce-pp-cli which",
		"woocommerce-pp-cli agent-context",
		"woocommerce-pp-cli completion bash",
		"woocommerce-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"woocommerce-pp-cli recall",
		"woocommerce-pp-cli learnings",
		"woocommerce-pp-cli teach-pattern",
		"woocommerce-pp-cli teach-lookup",
		"woocommerce-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("woocommerce-pp-cli")); err == nil {
