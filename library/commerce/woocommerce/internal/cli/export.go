...
large datasets as it has no memory pressure.`,
  ...
  woocommerce-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  woocommerce-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  woocommerce-pp-cli export <resource> --format jsonl | jq '.id'`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			validResources := map[string]bool{
				...
				"brands":             true,
				"catalog":            true,
				"catalog-reviews":    true,
				"catalog-taxonomy":   true,
				"categories":         true,
				"coupons":            true,
				"customers":          true,
				"orders":             true,
