...
but do not stop the import.`,
  ...
  woocommerce-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  woocommerce-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | woocommerce-pp-cli import <resource> --input -`,
