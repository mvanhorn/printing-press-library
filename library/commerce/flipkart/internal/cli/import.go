...
but do not stop the import.`,
  ...
  flipkart-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  flipkart-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | flipkart-pp-cli import <resource> --input -`,
