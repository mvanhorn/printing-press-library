...
Resource scoping:
  ...
  home-goat-pp-cli sync

  # Sync specific resources only
  home-goat-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  home-goat-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  home-goat-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  home-goat-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  home-goat-pp-cli sync --latest-only`,
