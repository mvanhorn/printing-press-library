...
Data must be synced first with the sync command.`,
  ...
  home-goat-pp-cli analytics --type messages

  # Group by a field
  home-goat-pp-cli analytics --type messages --group-by author_id

  # Top 10 most frequent values
  home-goat-pp-cli analytics --type messages --group-by channel_id --limit 10 --json`,
