...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "home-goat-pp-cli",
		Short: `Multi-source home furnishing CLI combining 5 Tier 1 APIs: search, compare, stores, delivery, reviews, and deals — category-routed across Ferguson, West Elm, Rejuvenation, Article, and 5+ Shopify DTC …`,
		Long: `Multi-source home furnishing CLI combining 5 Tier 1 APIs: search, compare, stores, delivery, reviews, and deals — category-routed across Ferguson, West Elm, Rejuvenation, Article, and 5+ Shopify DTC …

Add --agent to any command for JSON output + non-interactive mode.
Run 'home-goat-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("home-goat-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'home-goat-pp-cli profile list')")
