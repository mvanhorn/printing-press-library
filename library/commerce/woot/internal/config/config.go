...
type Config struct {
	...
	D24qg5zsx8xdc4CloudfrontApiKey string          `toml:"cloudfront_api_key"`
}

func Load(configPath string) (*Config, error) {
	cfg := &Config{
		BaseURL: "https://d24qg5zsx8xdc4.cloudfront.net",
	}
	...
	// Env var overrides
	if v := os.Getenv("D24QG5ZSX8XDC4_CLOUDFRONT_API_KEY"); v != "" {
		cfg.D24qg5zsx8xdc4CloudfrontApiKey = v
		cfg.markEnvOverride("D24qg5zsx8xdc4CloudfrontApiKey")
		cfg.AuthSource = "env:D24QG5ZSX8XDC4_CLOUDFRONT_API_KEY"
		cfg.CredentialSource = "env:D24QG5ZSX8XDC4_CLOUDFRONT_API_KEY"
	}
	...
	if v := os.Getenv("WOOT_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("WOOT_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "woot-pp-cli", "config.toml"), nil
}
...
func (c *Config) AuthHeader() string {
	...
	token := c.D24qg5zsx8xdc4CloudfrontApiKey
	if token == "" {
		return ""
	}
	if c.D24qg5zsx8xdc4CloudfrontApiKey == "" {
		return ""
	}
	return token
}
...
func (c *Config) clearCredentialFields() {
	...
	c.ClientID = ""
	c.ClientSecret = ""
	c.D24qg5zsx8xdc4CloudfrontApiKey = ""
}
...
func (c *Config) credentials() *cliutil.Credentials {
	...
	creds.D24qg5zsx8xdc4CloudfrontApiKey = c.D24qg5zsx8xdc4CloudfrontApiKey
	return creds
}
...
func (c *Config) applyCredentials(creds *cliutil.Credentials) {
	...
	c.D24qg5zsx8xdc4CloudfrontApiKey = creds.D24qg5zsx8xdc4CloudfrontApiKey
}
...
func (c *Config) SaveCredential(token string) error {
	...
	c.updateFileConfigField("AccessToken")
	c.D24qg5zsx8xdc4CloudfrontApiKey = token
	delete(c.envOverrides, "D24qg5zsx8xdc4CloudfrontApiKey")
	c.updateFileConfigField("D24qg5zsx8xdc4CloudfrontApiKey")
	if err := c.saveCredentialsFirst(); err != nil {
		return err
	}
	return c.save()
...
func (c *Config) configForSave() Config {
	out := *c
	if c.fileConfig != nil {
		if c.envOverrides["D24qg5zsx8xdc4CloudfrontApiKey"] {
			out.D24qg5zsx8xdc4CloudfrontApiKey = c.fileConfig.D24qg5zsx8xdc4CloudfrontApiKey
		}
	}
...
func (c *Config) updateFileConfigField(field string) {
	...
	case "D24qg5zsx8xdc4CloudfrontApiKey":
		c.fileConfig.D24qg5zsx8xdc4CloudfrontApiKey = c.D24qg5zsx8xdc4CloudfrontApiKey
	}
}
