...
Run 'woot-pp-cli doctor' to verify auth and connectivity.`,
	...
	rootCmd.SetVersionTemplate("woot-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'woot-pp-cli profile list')")
