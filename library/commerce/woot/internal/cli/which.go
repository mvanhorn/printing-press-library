...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  woot-pp-cli which "stale tickets"
  woot-pp-cli which "bottleneck"
  woot-pp-cli which --limit 1 "send message"
  woot-pp-cli which                                # list the full capability index`,
