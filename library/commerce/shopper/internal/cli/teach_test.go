...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"shopper-pp-cli auth login",
		"shopper-pp-cli doctor",
		"shopper-pp-cli help items",
		"shopper-pp-cli sync",
		"shopper-pp-cli profile list",
		"shopper-pp-cli feedback list",
		"shopper-pp-cli which",
		"shopper-pp-cli agent-context",
		"shopper-pp-cli completion bash",
		"shopper-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"shopper-pp-cli recall",
		"shopper-pp-cli learnings",
		"shopper-pp-cli teach-pattern",
		"shopper-pp-cli teach-lookup",
		"shopper-pp-cli items list",
	}
