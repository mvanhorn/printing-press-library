...
var readCommandResources = map[string][]string{
	"shopper-pp-cli address":                       {"address"},
	"shopper-pp-cli address list":                  {"address"},
	"shopper-pp-cli address get":                   {"address"},
	"shopper-pp-cli address search":                {"address"},
	"shopper-pp-cli cart":                          {"cart"},
	"shopper-pp-cli cart list":                     {"cart"},
	"shopper-pp-cli cart get":                      {"cart"},
	"shopper-pp-cli cart search":                   {"cart"},
	"shopper-pp-cli catalog":                       {"catalog"},
	"shopper-pp-cli catalog list":                  {"catalog"},
	"shopper-pp-cli catalog get":                   {"catalog"},
	"shopper-pp-cli catalog search":                {"catalog"},
	"shopper-pp-cli catalog-departments":           {"catalog-departments"},
	"shopper-pp-cli catalog-departments list":      {"catalog-departments"},
	"shopper-pp-cli catalog-departments get":       {"catalog-departments"},
	"shopper-pp-cli catalog-departments search":    {"catalog-departments"},
	"shopper-pp-cli catalog-products-news":         {"catalog-products-news"},
	"shopper-pp-cli catalog-products-news list":    {"catalog-products-news"},
	"shopper-pp-cli catalog-products-news get":     {"catalog-products-news"},
	"shopper-pp-cli catalog-products-news search":  {"catalog-products-news"},
	"shopper-pp-cli catalog-search-suggest":        {"catalog-search-suggest"},
	"shopper-pp-cli catalog-search-suggest list":   {"catalog-search-suggest"},
	"shopper-pp-cli catalog-search-suggest get":    {"catalog-search-suggest"},
	"shopper-pp-cli catalog-search-suggest search": {"catalog-search-suggest"},
	"shopper-pp-cli delivery":                      {"delivery"},
	"shopper-pp-cli delivery list":                 {"delivery"},
	"shopper-pp-cli delivery get":                  {"delivery"},
	"shopper-pp-cli delivery search":               {"delivery"},
	"shopper-pp-cli delivery-v2-calendar":          {"delivery-v2-calendar"},
	"shopper-pp-cli delivery-v2-calendar list":     {"delivery-v2-calendar"},
	"shopper-pp-cli delivery-v2-calendar get":      {"delivery-v2-calendar"},
	"shopper-pp-cli delivery-v2-calendar search":   {"delivery-v2-calendar"},
	"shopper-pp-cli features":                      {"features"},
	"shopper-pp-cli features list":                 {"features"},
	"shopper-pp-cli features get":                  {"features"},
	"shopper-pp-cli features search":               {"features"},
	"shopper-pp-cli features-timer-tick":           {"features-timer-tick"},
	"shopper-pp-cli features-timer-tick list":      {"features-timer-tick"},
	"shopper-pp-cli features-timer-tick get":       {"features-timer-tick"},
	"shopper-pp-cli features-timer-tick search":    {"features-timer-tick"},
	"shopper-pp-cli features-toggle":               {"features-toggle"},
	"shopper-pp-cli features-toggle list":          {"features-toggle"},
	"shopper-pp-cli features-toggle get":           {"features-toggle"},
	"shopper-pp-cli features-toggle search":        {"features-toggle"},
	"shopper-pp-cli orders":                        {"orders"},
	"shopper-pp-cli orders list":                   {"orders"},
	"shopper-pp-cli orders get":                    {"orders"},
	"shopper-pp-cli orders search":                 {"orders"},
	"shopper-pp-cli session":                       {"session"},
	"shopper-pp-cli session list":                  {"session"},
	"shopper-pp-cli session get":                   {"session"},
	"shopper-pp-cli session search":                {"session"},
}
...
func cachePolicy() cliutil.Policy {
	...
	envOptOut := "SHOPPER_NO_AUTO_REFRESH"
...
func autoRefreshIfStale(ctx context.Context, flags *rootFlags, resources []string) (meta cliutil.FreshnessMeta) {
	...
	if err := runAutoRefresh(refreshCtx, flags, db, resources); err != nil {
		fmt.Fprintf(os.Stderr, "warning: using stale shopper-pp-cli cache (refresh failed: %v)\n", err)
