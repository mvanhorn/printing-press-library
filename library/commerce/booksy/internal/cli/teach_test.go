...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"booksy-pp-cli auth login",
		"booksy-pp-cli doctor",
		"booksy-pp-cli help items",
		"booksy-pp-cli sync",
		"booksy-pp-cli profile list",
		"booksy-pp-cli feedback list",
		"booksy-pp-cli which",
		"booksy-pp-cli agent-context",
		"booksy-pp-cli completion bash",
		"booksy-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"booksy-pp-cli teach",
		"booksy-pp-cli recall",
		"booksy-pp-cli learnings",
		"booksy-pp-cli teach-pattern",
		"booksy-pp-cli teach-lookup",
		"booksy-pp-cli items list",
	}
