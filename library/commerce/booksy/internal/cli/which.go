...
var whichIndex = []whichEntry{
	{Command: "book", Description: "Book an appointment end to end — it previews the exact service, staffer, time, and price first, and only sends the real booking when you pass --confirm.", Group: "Booking funnel", WhyItMatters: "This is the one command that turns 'find me a haircut' into an actual appointment; the dry-run-by-default guard means an agent can plan safely and the human confirms."},
	{Command: "availability", Description: "List open time slots for a service at a business over a date range, grouped by day. No login required.", Group: "Booking funnel", WhyItMatters: "Lets an agent answer 'when can I get in?' without loading the web calendar — no token needed."},
	{Command: "services", Description: "Flatten a business profile into a clean table of bookable services with price, duration, and the service-variant id you pass to book.", Group: "Booking funnel", WhyItMatters: "Surfaces the exact --service-variant id an agent needs for availability and booking, with prices to compare."},
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  booksy-pp-cli which "stale tickets"
  booksy-pp-cli which "bottleneck"
  booksy-pp-cli which --limit 1 "send message"
  booksy-pp-cli which                                # list the full capability index`,
