...
Resource scoping:
  ...
  booksy-pp-cli sync --resources businesses,discover

  # Full resync (ignore previous checkpoint)
  booksy-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  booksy-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  booksy-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  booksy-pp-cli sync --latest-only`,
...
func determinePaginationDefaults(resource string) paginationDefaults {
	switch resource {
	case "discover-recommended-treatments":
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{ // #nosec G101 -- endpoint paths, not credentials.
		...
		"discover-modern-query-hints":     "/core/v2/customer_api/search/modern_query_hints/",
		"discover-recommended-treatments": "/core/v2/customer_api/search/recommended_treatments/",
	}
...
func responsePathForResource(resource, path string) []string {
	...
	case "businesses\x00/core/v2/customer_api/businesses/{business_id}/":
		return []string{"business"}
	case "businesses\x00/core/v2/customer_api/businesses/{business_id}/reviews":
		return []string{"reviews"}
	case "businesses\x00/core/v2/customer_api/businesses":
		return []string{"businesses"}
	case "discover\x00/core/v2/customer_api/search/street_hints/":
		return []string{"hints"}
	case "discover\x00/core/v2/customer_api/search/modern_query_hints/":
		return []string{"suggestions"}
	case "discover\x00/core/v2/customer_api/search/recommended_treatments/":
		return []string{"treatments"}
	case "me\x00/core/v2/customer_api/me":
