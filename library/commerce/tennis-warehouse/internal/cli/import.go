...
but do not stop the import.`,
  ...
  tennis-warehouse-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  tennis-warehouse-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | tennis-warehouse-pp-cli import <resource> --input -`,
