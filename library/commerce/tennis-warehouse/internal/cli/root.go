...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "tennis-warehouse-pp-cli",
		Short: `Tennis Warehouse CLI — Every racquet Tennis Warehouse sells — new and used — searchable offline with spec compare, substitute finder, price-dr…`,
		Long: `Tennis Warehouse CLI — Every racquet Tennis Warehouse sells — new and used — searchable offline with spec compare, substitute finder, price-dr…
...
Health check: run 'tennis-warehouse-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("tennis-warehouse-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'tennis-warehouse-pp-cli profile list')")
	...
	rootCmd.AddCommand(newUsedCmd(flags))
	...
	rootCmd.AddCommand(newRacquetsPromotedCmd(flags))
	rootCmd.AddCommand(newVersionCliCmd())

	// Hand-authored novel commands for tennis-warehouse. Wired here so
	// regen-merge's lost-registration mechanism re-injects the call after
	// any future --force regen.
	registerTennisCommands(rootCmd, flags)
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("tennis-warehouse-pp-cli %s\n", version)
		},
	}
}
