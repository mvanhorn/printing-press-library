...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "perfumenz-pp-cli",
		Short: `Perfumenz CLI — The full authentic Perfume NZ catalog, with powerful note-based search and offline intelligence no website offers.`,
		Long: `Perfumenz CLI — The full authentic Perfume NZ catalog, with powerful note-based search and offline intelligence no website offers.
...
Health check: run 'perfumenz-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("perfumenz-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'perfumenz-pp-cli profile list')")
	...
	rootCmd.AddCommand(newNovelRecommendCmd(flags))
	...
	rootCmd.AddCommand(newCollectionsPromotedCmd(flags))
	rootCmd.AddCommand(newProductsPromotedCmd(flags))
	rootCmd.AddCommand(newProductsJsonPromotedCmd(flags))
