...
but do not stop the import.`,
  ...
  perfumenz-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  perfumenz-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | perfumenz-pp-cli import <resource> --input -`,
