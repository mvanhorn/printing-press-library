...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"square-pp-cli auth login",
		"square-pp-cli doctor",
		"square-pp-cli help items",
		"square-pp-cli sync",
		"square-pp-cli profile list",
		"square-pp-cli feedback list",
		"square-pp-cli which",
		"square-pp-cli agent-context",
		"square-pp-cli completion bash",
		"square-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"square-pp-cli teach",
		"square-pp-cli recall",
		"square-pp-cli learnings",
		"square-pp-cli teach-pattern",
		"square-pp-cli teach-lookup",
		"square-pp-cli items list",
	}
