...
func Load(configPath string) (*Config, error) {
	...
	// Env var overrides
	if v := os.Getenv("SQUARE_ACCESS_TOKEN"); v != "" {
		cfg.AccessToken = v
		cfg.markEnvOverride("AccessToken")
		cfg.AuthSource = "env:SQUARE_ACCESS_TOKEN"
		cfg.CredentialSource = "env:SQUARE_ACCESS_TOKEN"
	}
	...
	if v := os.Getenv("SQUARE_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("SQUARE_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "square-pp-cli", "config.toml"), nil
}
...
func (c *Config) AuthHeader() string {
	...
	if c.AccessToken != "" {
		if c.AuthSource == "" {
			c.AuthSource = "env:SQUARE_ACCESS_TOKEN"
		}
