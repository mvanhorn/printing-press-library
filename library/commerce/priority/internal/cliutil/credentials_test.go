...
func resetCredentialEnv(t *testing.T) (home, configPath string) {
	...
	return home, filepath.Join(home, ".config", "priority-pp-cli", "config.toml")
}
...
func TestCredentialsFileWinsWhenLegacyConfigAlsoHasSecrets(t *testing.T) {
	...
	if got := cfg.AuthHeader(); !authHeaderContains(got, "data-secret") || authHeaderContains(got, "legacy-secret") {
...
func TestCorruptCredentialsFallsBackToLegacyConfig(t *testing.T) {
	...
	credentialsPath := filepath.Join(home, ".local", "share", "priority-pp-cli", "credentials.toml")
	...
	stderr := captureCredentialStderr(t, func() {
		...
		if got := cfg.AuthHeader(); !authHeaderContains(got, "legacy-secret") {
...
func TestCorruptCredentialsFallsBackToEnvCredential(t *testing.T) {
	...
	stderr := captureCredentialStderr(t, func() {
		...
		if got := cfg.AuthHeader(); !authHeaderContains(got, "env-secret") {
...
func TestAuthWriteScrubsLegacyConfigWhenRelocated(t *testing.T) {
	...
	activeConfigPath := filepath.Join(newConfigDir, "priority-pp-cli", "config.toml")
	...
	credsPath := filepath.Join(newDataDir, "priority-pp-cli", "credentials.toml")
...
func configCredentialValue(cfg *config.Config) string {
	return cfg.PriorityApiUsername
}
...
func credentialValue(creds *cliutil.Credentials) string {
	return creds.PriorityApiUsername
}
