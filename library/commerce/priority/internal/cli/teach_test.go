...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("PRIORITY_STATE_DIR", "")
	t.Setenv("PRIORITY_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"priority-pp-cli auth login",
		"priority-pp-cli doctor",
		"priority-pp-cli help items",
		"priority-pp-cli sync",
		"priority-pp-cli profile list",
		"priority-pp-cli feedback list",
		"priority-pp-cli which",
		"priority-pp-cli agent-context",
		"priority-pp-cli completion bash",
		"priority-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"priority-pp-cli recall",
		"priority-pp-cli learnings",
		"priority-pp-cli teach-pattern",
		"priority-pp-cli teach-lookup",
		"priority-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("priority-pp-cli")); err == nil {
