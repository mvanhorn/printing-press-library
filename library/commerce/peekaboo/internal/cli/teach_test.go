...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("PEEKABOO_STATE_DIR", "")
	t.Setenv("PEEKABOO_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"peekaboo-pp-cli auth login",
		"peekaboo-pp-cli doctor",
		"peekaboo-pp-cli help items",
		"peekaboo-pp-cli sync",
		"peekaboo-pp-cli profile list",
		"peekaboo-pp-cli feedback list",
		"peekaboo-pp-cli which",
		"peekaboo-pp-cli agent-context",
		"peekaboo-pp-cli completion bash",
		"peekaboo-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"peekaboo-pp-cli recall",
		"peekaboo-pp-cli learnings",
		"peekaboo-pp-cli teach-pattern",
		"peekaboo-pp-cli teach-lookup",
		"peekaboo-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("peekaboo-pp-cli")); err == nil {
