	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if flags.dataSource == "local" || "auto" == "local" {
				data, prov, err = resolveLocal(cmd.Context(), flags, cmd.ErrOrStderr(), "customers", true, path, nil, "user_requested")
			} else {
				...
				if err != nil && flags.dataSource == "auto" && "auto" == "auto" && isNetworkError(err) {
					data, prov, err = resolveLocal(cmd.Context(), flags, cmd.ErrOrStderr(), "customers", true, path, nil, networkFallbackReason)
				} else if err == nil {
