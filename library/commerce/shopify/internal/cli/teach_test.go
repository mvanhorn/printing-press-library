...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("SHOPIFY_STATE_DIR", "")
	t.Setenv("SHOPIFY_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"shopify-pp-cli auth login",
		"shopify-pp-cli doctor",
		"shopify-pp-cli help items",
		"shopify-pp-cli sync",
		"shopify-pp-cli profile list",
		"shopify-pp-cli feedback list",
		"shopify-pp-cli which",
		"shopify-pp-cli agent-context",
		"shopify-pp-cli completion bash",
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"shopify-pp-cli recall",
		"shopify-pp-cli learnings",
		"shopify-pp-cli teach-pattern",
		"shopify-pp-cli teach-lookup",
		"shopify-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("shopify-pp-cli")); err == nil {
