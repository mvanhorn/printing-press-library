...
func newAuthCmd(flags *rootFlags) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "auth",
		Short: "Manage SHOPIFY_ACCESS_TOKEN credentials",
	}
...
func newAuthSetTokenCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		Example: "  shopify-pp-cli auth set-token sk_live_abc123",
	...
	return &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if os.Getenv("SHOPIFY_ACCESS_TOKEN") != "" {
				fmt.Fprintf(cmd.OutOrStdout(), "Config cleared. Note: SHOPIFY_ACCESS_TOKEN env var is still set.\n")
				return nil
			}
