...
large datasets as it has no memory pressure.`,
  ...
  shopify-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  shopify-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  shopify-pp-cli export <resource> --format jsonl | jq '.id'`,
