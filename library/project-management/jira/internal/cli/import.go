...
but do not stop the import.`,
  ...
  jira-cloud-platform-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  jira-cloud-platform-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | jira-cloud-platform-pp-cli import <resource> --input -`,
