...
// to ~/.jira-cloud-platform-pp-cli/jobs.jsonl; the latest row for a given JobID wins
...
~/.jira-cloud-platform-pp-cli/jobs.jsonl. This command lists, inspects, and prunes them.
