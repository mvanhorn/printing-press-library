...
but do not stop the import.`,
  ...
  clickup-2-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  clickup-2-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | clickup-2-pp-cli import <resource> --input -`,
