...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/project-management/clickup-2/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "clickup-2-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
