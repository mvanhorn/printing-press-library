...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/project-management/zoho-projects/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "zoho-projects-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
