...
but do not stop the import.`,
  ...
  zoho-projects-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  zoho-projects-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | zoho-projects-pp-cli import <resource> --input -`,
