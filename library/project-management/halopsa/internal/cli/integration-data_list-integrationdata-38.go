...
func newIntegrationDataListIntegrationdata38Cmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  halopsa-pp-cli integration-data list-integrationdata-38",
		Annotations: map[string]string{"pp:endpoint": "integration-data.list-integrationdata-38", "pp:method": "GET", "pp:path": "/IntegrationData/Get/GoogleWorkplace", "mcp:read-only": "true"},
