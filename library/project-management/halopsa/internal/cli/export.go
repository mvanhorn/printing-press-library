...
large datasets as it has no memory pressure.`,
  ...
  halopsa-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  halopsa-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  halopsa-pp-cli export <resource> --format jsonl | jq '.id'`,
