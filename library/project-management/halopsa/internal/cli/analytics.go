...
Data must be synced first with the sync command.`,
  ...
  halopsa-pp-cli analytics --type messages

  # Group by a field
  halopsa-pp-cli analytics --type messages --group-by author_id

  # Top 10 most frequent values
  halopsa-pp-cli analytics --type messages --group-by channel_id --limit 10 --json`,
