...
but do not stop the import.`,
  ...
  halopsa-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  halopsa-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | halopsa-pp-cli import <resource> --input -`,
