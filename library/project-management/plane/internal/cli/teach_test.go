...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"plane-pp-cli auth login",
		"plane-pp-cli doctor",
		"plane-pp-cli help items",
		"plane-pp-cli sync",
		"plane-pp-cli profile list",
		"plane-pp-cli feedback list",
		"plane-pp-cli which",
		"plane-pp-cli agent-context",
		"plane-pp-cli completion bash",
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"plane-pp-cli teach",
		"plane-pp-cli recall",
		"plane-pp-cli learnings",
		"plane-pp-cli teach-pattern",
		"plane-pp-cli teach-lookup",
		"plane-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("plane-pp-cli")); err == nil {
