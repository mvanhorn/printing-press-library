...
func newDoctorCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `  tag-helpdesk-pp-cli doctor
  tag-helpdesk-pp-cli doctor --json
  tag-helpdesk-pp-cli doctor --fail-on warn`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if cfg != nil {
				...
				if header == "" {
					...
					report["auth_hint"] = "export TAG_HELPDESK_API_KEY=<your-key>"
				} else {
					authConfigured = true
			...
			if os.Getenv("TAG_HELPDESK_API_KEY") != "" {
				authEnvSet = append(authEnvSet, "TAG_HELPDESK_API_KEY")
				...
				authEnvRequiredMissing = append(authEnvRequiredMissing, "TAG_HELPDESK_API_KEY")
			}
			switch {
