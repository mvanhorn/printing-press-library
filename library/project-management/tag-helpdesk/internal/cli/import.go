...
but do not stop the import.`,
  ...
  tag-helpdesk-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  tag-helpdesk-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | tag-helpdesk-pp-cli import <resource> --input -`,
