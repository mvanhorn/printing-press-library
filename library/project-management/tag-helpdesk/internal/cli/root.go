...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "tag-helpdesk-pp-cli",
		Short: "Manage tag-helpdesk resources via the tag-helpdesk API",
		Long: `Manage tag-helpdesk resources via the tag-helpdesk API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'tag-helpdesk-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("tag-helpdesk-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'tag-helpdesk-pp-cli profile list')")
	...
	rootCmd.AddCommand(newUnattendedCmd(flags))
	rootCmd.AddCommand(newOverdueCmd(flags))
	rootCmd.AddCommand(newByAgentCmd(flags))
	rootCmd.AddCommand(newByTeamCmd(flags))
	rootCmd.AddCommand(newByCategoryCmd(flags))
	rootCmd.AddCommand(newSummaryCmd(flags))
	rootCmd.AddCommand(newAnalyzeCmd(flags))
	rootCmd.AddCommand(newBulkAnalyzeCmd(flags))
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("tag-helpdesk-pp-cli %s\n", version)
		},
	}
}
