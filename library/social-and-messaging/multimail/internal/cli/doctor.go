		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if cfg != nil {
				...
				if header == "" {
					...
					report["auth_hint"] = "export MULTIMAIL_API_KEY=<your-key>"
				} else {
			...
			if os.Getenv("MULTIMAIL_API_KEY") != "" {
				authEnvSet = append(authEnvSet, "MULTIMAIL_API_KEY")
			} else {
				authEnvRequiredMissing = append(authEnvRequiredMissing, "MULTIMAIL_API_KEY")
			}
			switch {
