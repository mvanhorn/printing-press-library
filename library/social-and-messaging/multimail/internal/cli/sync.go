...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "oversight":
		return db.UpsertOversight(data)
	case "support":
		return db.UpsertSupport(data)
	case "unsubscribe":
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "emails", ParentTable: "mailboxes", ParentIDParam: "mailboxId", PathTemplate: "/v1/mailboxes/{mailboxId}/emails"},
	}
}
