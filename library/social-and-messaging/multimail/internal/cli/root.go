...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		...
		Short: `Multimail CLI — Every MultiMail feature from the terminal, plus inbox health, stale-thread detection, and offline search no other Multi…`,
		Long: `Multimail CLI — Every MultiMail feature from the terminal, plus inbox health, stale-thread detection, and offline search no other Multi…
...
See README.md or the bundled SKILL.md for recipes.`,
	...
	// Transcendence commands — compound features not in the API
