...
but do not stop the import.`,
  ...
  telegram-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  telegram-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | telegram-pp-cli import <resource> --input -`,
