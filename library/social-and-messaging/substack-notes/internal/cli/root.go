...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "substack-notes-pp-cli",
		Short: "Manage substack-notes resources via the substack-notes API",
		Long: `Manage substack-notes resources via the substack-notes API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'substack-notes-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("substack-notes-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'substack-notes-pp-cli profile list')")
