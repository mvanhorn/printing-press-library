# 3CX Printed CLI Agent Guide

This directory is a generated `3cx-xapi-pp-cli` printed CLI. It was produced by [CLI Printing Press](https://github.com/mvanhorn/cli-printing-press), so treat systemic fixes as upstream Printing Press fixes first. Keep local edits narrow and document why a generated-tree patch belongs here.
...
```bash
3cx-xapi-pp-cli doctor --json
3cx-xapi-pp-cli agent-context --pretty
```

Use runtime discovery instead of relying on a copied command list:

```bash
3cx-xapi-pp-cli which "<capability>" --json
3cx-xapi-pp-cli <command> --help
```
...
```bash
3cx-xapi-pp-cli <command> --help
3cx-xapi-pp-cli <command> --dry-run --agent
```
