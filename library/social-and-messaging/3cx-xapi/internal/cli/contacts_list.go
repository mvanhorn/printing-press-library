...
func newContactsListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list",
		Short:       "Get entities from Contacts",
		Example:     "  3cx-xapi-pp-cli contacts list",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolveReadWithStrategyAndResponsePath(cmd.Context(), c, flags, "auto", "contacts", true, path, params, nil, "", cmd.ErrOrStderr())
			if err != nil {
