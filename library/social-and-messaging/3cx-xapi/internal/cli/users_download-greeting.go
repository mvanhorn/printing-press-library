...
func newUsersDownloadGreetingCmd(flags *rootFlags) *cobra.Command {

	cmd := &cobra.Command{
		Use:         "download-greeting <userId> <fileName>",
		Aliases:     []string{"get"},
		Short:       "Invoke function DownloadGreeting",
		Example:     "  3cx-xapi-pp-cli users download-greeting 42 example-resource",
		Annotations: map[string]string{"pp:endpoint": "users.download-greeting", "pp:method": "GET", "pp:path": "/Users/Pbx.DownloadGreeting(userId={userId},fileName={fileName})", "mcp:read-only": "true"},
