...
Data must be synced first with the sync command.`,
  ...
  3cx-xapi-pp-cli analytics --type messages

  # Group by a field
  3cx-xapi-pp-cli analytics --type messages --group-by author_id

  # Top 10 most frequent values
  3cx-xapi-pp-cli analytics --type messages --group-by channel_id --limit 10 --json`,
