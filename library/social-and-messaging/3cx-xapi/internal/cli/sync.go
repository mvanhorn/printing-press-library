...
Resource scoping:
  ...
  3cx-xapi-pp-cli sync

  # Sync specific resources only
  3cx-xapi-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  3cx-xapi-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  3cx-xapi-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  3cx-xapi-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  3cx-xapi-pp-cli sync --latest-only`,
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "aisettings":
		return db.UpsertAisettings(data)
	case "backups":
		return db.UpsertBackups(data)
	case "call-flow-apps-id":
		return db.UpsertCallFlowAppsId(data)
	case "call-history-view":
		return db.UpsertCallHistoryView(data)
	case "chat-history-view":
		return db.UpsertChatHistoryView(data)
	case "chat-messages-history-view":
		return db.UpsertChatMessagesHistoryView(data)
	case "conference-settings":
		return db.UpsertConferenceSettings(data)
	case "contacts":
		return db.UpsertContacts(data)
	case "crm-integration":
		return db.UpsertCrmIntegration(data)
	case "defs":
		return db.UpsertDefs(data)
	case "dnproperties":
		return db.UpsertDnproperties(data)
	case "event-logs":
		return db.UpsertEventLogs(data)
	case "fax-server-settings":
		return db.UpsertFaxServerSettings(data)
	case "firewall":
		return db.UpsertFirewall(data)
	case "fxs-mac-address":
		return db.UpsertFxsMacAddress(data)
	case "inbound-rules":
		return db.UpsertInboundRules(data)
	case "microsoft365-integration":
		return db.UpsertMicrosoft365Integration(data)
	case "microsoft365-teams-integration":
		return db.UpsertMicrosoft365TeamsIntegration(data)
	case "my-user":
		return db.UpsertMyUser(data)
	case "network-settings":
		return db.UpsertNetworkSettings(data)
	case "outbound-rules":
		return db.UpsertOutboundRules(data)
	case "peers":
		return db.UpsertPeers(data)
	case "prompt-sets":
		return db.UpsertPromptSets(data)
	case "report-abandoned-chats-statistics":
		return db.UpsertReportAbandonedChatsStatistics(data)
	case "report-abandoned-queue-calls":
		return db.UpsertReportAbandonedQueueCalls(data)
	case "report-agent-login-history":
		return db.UpsertReportAgentLoginHistory(data)
	case "report-agents-in-queue-statistics":
		return db.UpsertReportAgentsInQueueStatistics(data)
	case "report-audit-log":
		return db.UpsertReportAuditLog(data)
	case "report-average-queue-waiting-time":
		return db.UpsertReportAverageQueueWaitingTime(data)
	case "report-breaches-sla":
		return db.UpsertReportBreachesSla(data)
	case "report-call-cost-by-extension-group":
		return db.UpsertReportCallCostByExtensionGroup(data)
	case "report-call-distribution":
		return db.UpsertReportCallDistribution(data)
	case "report-call-log-data":
		return db.UpsertReportCallLogData(data)
	case "report-chat-log":
		return db.UpsertReportChatLog(data)
	case "report-detailed-queue-statistics":
		return db.UpsertReportDetailedQueueStatistics(data)
	case "report-extension-statistics":
		return db.UpsertReportExtensionStatistics(data)
	case "report-extension-statistics-by-group":
		return db.UpsertReportExtensionStatisticsByGroup(data)
	case "report-extensions-statistics-by-ring-groups":
		return db.UpsertReportExtensionsStatisticsByRingGroups(data)
	case "report-inbound-calls":
		return db.UpsertReportInboundCalls(data)
	case "report-inbound-rules":
		return db.UpsertReportInboundRules(data)
	case "report-outbound-calls":
		return db.UpsertReportOutboundCalls(data)
	case "report-queue-agents-chat-statistics":
		return db.UpsertReportQueueAgentsChatStatistics(data)
	case "report-queue-agents-chat-statistics-totals":
		return db.UpsertReportQueueAgentsChatStatisticsTotals(data)
	case "report-queue-an-un-calls":
		return db.UpsertReportQueueAnUnCalls(data)
	case "report-queue-answered-calls-by-wait-time":
		return db.UpsertReportQueueAnsweredCallsByWaitTime(data)
	case "report-queue-callbacks":
		return db.UpsertReportQueueCallbacks(data)
	case "report-queue-chat-performance":
		return db.UpsertReportQueueChatPerformance(data)
	case "report-queue-failed-callbacks":
		return db.UpsertReportQueueFailedCallbacks(data)
	case "report-queue-performance-overview":
		return db.UpsertReportQueuePerformanceOverview(data)
	case "report-queue-performance-totals":
		return db.UpsertReportQueuePerformanceTotals(data)
	case "report-ring-group-statistics":
		return db.UpsertReportRingGroupStatistics(data)
	case "report-statistic-sla":
		return db.UpsertReportStatisticSla(data)
	case "report-team-queue-general-statistics":
		return db.UpsertReportTeamQueueGeneralStatistics(data)
	case "report-user-activity":
		return db.UpsertReportUserActivity(data)
	case "service-principals-id":
		return db.UpsertServicePrincipalsId(data)
	case "system-status":
		return db.UpsertSystemStatus(data)
	case "trunks-id":
		return db.UpsertTrunksId(data)
	case "users":
		return db.UpsertUsers(data)
	case "users-id":
		return db.UpsertUsersId(data)
	case "voicemail-settings":
		return db.UpsertVoicemailSettings(data)
	default:
...
func defaultSyncResources() []string {
	return []string{
		...
		"blocklist",
		"call-cost-settings",
		"call-cost-settings-pbx-export-call-costs()",
		"call-flow-apps",
		"call-flow-scripts",
		"call-history-view",
		"chat-history-view",
		...
		"contacts",
		"contacts-pbx-get-dir-search-settings()",
		"countries",
		"custom-prompts",
		"defs",
		"defs-gateway-parameter-values",
		"defs-gateway-parameters",
		"defs-time-zones",
		"device-infos",
		"did-numbers",
		"email-template",
		...
		"microsoft365-teams-integration-pbx-get-map-users-script()",
		"my-group",
		"my-group-members",
		"my-tokens",
		"my-user",
		"my-user-forwarding-profiles",
		"my-user-greetings",
		"network-interfaces",
		"office-hours",
		"outbound-rules",
...
func knownSyncResourceNames() []string {
	names := []string{
		...
		"call-flow-scripts",
		"call-history-view",
		"call-history-view-pbx-download-call-history()",
		"chat-history-view",
		"chat-messages-history-view",
		"contacts",
		"contacts-pbx-get-dir-search-settings()",
		...
		"holidays",
		"inbound-rules",
		"inbound-rules-pbx-export-caller-id-rules()",
		"last-cdr-and-chat-message-timestamp",
		"microsoft365-integration",
		"microsoft365-teams-integration",
		"microsoft365-teams-integration-pbx-get-map-users-script()",
...
func syncResourcePath(resource string) (string, error) {
	...
	switch resource {
	case "activity-log":
		return fmt.Sprintf("/ActivityLog/Pbx.GetLogs(startDate=%s,endDate=%s,extension=,call=,severity=)", from.Format("2006-01-02"), now.Format("2006-01-02")), nil
	case "report-abandoned-queue-calls":
		return fmt.Sprintf("/ReportAbandonedQueueCalls/Pbx.GetAbandonedQueueCallsData(periodFrom=%s,periodTo=%s,queueDns=,waitInterval=)", from.Format(time.RFC3339), now.Format(time.RFC3339)), nil
	case "report-breaches-sla":
		return fmt.Sprintf("/ReportBreachesSla/Pbx.GetBreachesSlaData(queueDnStr=,startDt=%s,endDt=%s,waitInterval=)", from.Format(time.RFC3339), now.Format(time.RFC3339)), nil
	case "report-detailed-queue-statistics":
		return fmt.Sprintf("/ReportDetailedQueueStatistics/Pbx.GetDetailedQueueStatisticsData(queueDnStr=,startDt=%s,endDt=%s,waitInterval=)", from.Format(time.RFC3339), now.Format(time.RFC3339)), nil
	case "report-queue-performance-overview":
		return fmt.Sprintf("/ReportQueuePerformanceOverview/Pbx.GetQueuePerformanceOverviewData(periodFrom=%s,periodTo=%s,queueDns=,waitInterval=)", from.Format(time.RFC3339), now.Format(time.RFC3339)), nil
	}
	paths := map[string]string{
		"active-calls":                "/ActiveCalls",
		"activity-log":                "/ActivityLog/Pbx.GetFilter()",
		"aisettings":                  "/AISettings/Pbx.GetVectorStoreFiles(id={id},limit={limit},after={after})",
		"amazon-integration-settings": "/AmazonIntegrationSettings/Pbx.GenerateIamPolicyFile()",
		"backups":                     "/Backups",
		"black-list-numbers":          "/BlackListNumbers",
		"blocklist":                   "/Blocklist",
		"call-cost-settings":          "/CallCostSettings",
		"call-cost-settings-pbx-export-call-costs()": "/CallCostSettings/Pbx.ExportCallCosts()",
		"call-flow-apps":    "/CallFlowApps",
		"call-flow-scripts": "/CallFlowScripts",
		"call-history-view": "/CallHistoryView",
		"call-history-view-pbx-download-call-history()": "/CallHistoryView/Pbx.DownloadCallHistory()",
		"chat-history-view":                             "/ChatHistoryView",
		"chat-messages-history-view":                    "/ChatMessagesHistoryView",
		"contacts":                                      "/Contacts",
		"contacts-pbx-get-dir-search-settings()":        "/Contacts/Pbx.GetDirSearchSettings()",
		"countries":                                     "/Countries",
		"custom-prompts":                                "/CustomPrompts",
		"defs":                                          "/Defs/Codecs",
		"defs-gateway-parameter-values":                 "/Defs/GatewayParameterValues",
		"defs-gateway-parameters":                       "/Defs/GatewayParameters",
		"defs-time-zones":                               "/Defs/TimeZones",
		"device-infos":                                  "/DeviceInfos",
		"did-numbers":                                   "/DidNumbers",
		"email-template":                                "/EmailTemplate",
		"emergency-geo-locations":                       "/EmergencyGeoLocations",
		"event-logs":                                    "/EventLogs",
		"fax":                                           "/Fax",
		"firewall":                                      "/Firewall",
		"firmwares":                                     "/Firmwares",
		"fxs":                                           "/Fxs",
		"fxs-templates":                                 "/FxsTemplates",
		"get-client-crm-updates":                        "/GetClientCrmUpdates()",
		"get-prompt-set-updates":                        "/GetPromptSetUpdates()",
		"get-server-crm-updates":                        "/GetServerCrmUpdates()",
		"get-updates":                                   "/GetUpdates()",
		"groups":                                        "/Groups",
		"holidays":                                      "/Holidays",
		"inbound-rules":                                 "/InboundRules",
		"inbound-rules-pbx-export-caller-id-rules()":                "/InboundRules/Pbx.ExportCallerIdRules()",
		"last-cdr-and-chat-message-timestamp":                       "/LastCdrAndChatMessageTimestamp",
		"microsoft365-integration":                                  "/Microsoft365Integration/Pbx.TestSubscription()",
		"microsoft365-teams-integration":                            "/Microsoft365TeamsIntegration/Pbx.GetDialPlanScript()",
		"microsoft365-teams-integration-pbx-get-map-users-script()": "/Microsoft365TeamsIntegration/Pbx.GetMapUsersScript()",
		"my-group":                     "/MyGroup/Rights",
		"my-group-members":             "/MyGroup/Members",
		"my-tokens":                    "/MyTokens",
		"my-user":                      "/MyUser/Groups",
		"my-user-forwarding-profiles":  "/MyUser/ForwardingProfiles",
		"my-user-greetings":            "/MyUser/Greetings",
		...
		"parkings":                     "/Parkings",
		"peers":                        "/Peers",
		"phone-logos":                  "/PhoneLogos",
		"phone-templates":              "/PhoneTemplates",
		"playlists":                    "/Playlists",
		"prompt-sets":                  "/PromptSets",
		"prompt-sets-pbx-get-active()": "/PromptSets/Pbx.GetActive()",
		"queues":                       "/Queues",
		"receptionists":                "/Receptionists",
		"recordings":                   "/Recordings",
		"report-audit-log":             "/ReportAuditLog/Pbx.GetAuditLogData()",
		"ring-groups":                  "/RingGroups",
		"sbcs":                         "/Sbcs",
		"scheduled-reports":            "/ScheduledReports",
		"security-tokens":              "/SecurityTokens",
		"service-principals":           "/ServicePrincipals",
		"services":                     "/Services",
		"sip-devices":                  "/SipDevices",
		"system-status":                "/SystemStatus",
		"tenant-properties":            "/TenantProperties",
		"trunk-templates":              "/TrunkTemplates",
		"trunks":                       "/Trunks",
		"users":                        "/Users",
...
// (DidNumber, other Number-keyed resources) key on Number via LookupFieldValue's
// Pascal-case fallback ("number" -> "Number"). Entities with an Id use it.
...
func responsePathForResource(resource, path string) []string {
	...
	case "activity-log\x00/ActivityLog/Pbx.GetFilter()":
		return []string{"Extensions"}
	case "console-restrictions\x00/ConsoleRestrictions":
		return []string{"IpWhitelist"}
	case "country-codes\x00/CountryCodes":
		return []string{"CountryCodes"}
	case "crm-integration\x00/CrmIntegration/Pbx.Test":
		return []string{"SearchResult"}
	case "crm-templates-name\x00/CrmTemplates({Name})":
		return []string{"Parameters"}
	case "firmwares\x00/Firmwares/Pbx.GetFirmwareState()":
		return []string{"FileNames"}
	case "get-client-crm-updates\x00/GetClientCrmUpdates()":
		return []string{"Entries"}
	case "get-prompt-set-updates\x00/GetPromptSetUpdates()":
		return []string{"Entries"}
	case "get-server-crm-updates\x00/GetServerCrmUpdates()":
		return []string{"Entries"}
	case "get-updates\x00/GetUpdates()":
		return []string{"Entries"}
	case "google-settings\x00/GoogleSettings/Pbx.GetGoogleUsers":
		return []string{"Users"}
	case "hotel-services\x00/HotelServices":
		return []string{"HotelGroups"}
	case "license-status\x00/LicenseStatus":
		return []string{"ActiveModules"}
	case "mail-settings\x00/MailSettings/Pbx.TestEmail":
		return []string{"Parameters"}
	case "microsoft365-integration\x00/Microsoft365Integration/Pbx.GetM365Groups":
		return []string{"Groups"}
	case "microsoft365-integration\x00/Microsoft365Integration/Pbx.GetM365Users":
		return []string{"Users"}
	case "office-hours\x00/OfficeHours":
		return []string{"OfficeHolidays"}
	case "playlists\x00/Playlists":
		return []string{"Files"}
	case "playlists-name\x00/Playlists({Name})":
		return []string{"Files"}
	case "prompt-sets-id\x00/PromptSets({Id})/Pbx.Copy":
		return []string{"Prompts"}
	case "prompt-sets-id\x00/PromptSets({Id})":
		return []string{"Prompts"}
	case "trunks\x00/Trunks/Pbx.GetProviderPhones":
		return []string{"Phones"}
	case "website-links\x00/WebsiteLinks":
		return []string{"Website"}
	case "website-links-link\x00/WebsiteLinks({Link})":
		return []string{"Website"}
	}
	return nil
}
