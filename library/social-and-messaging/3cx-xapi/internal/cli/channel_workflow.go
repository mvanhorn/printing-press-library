...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  3cx-xapi-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  3cx-xapi-pp-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"active-calls", "activity-log", "amazon-integration-settings", "backups", "black-list-numbers", "blocklist", "call-cost-settings", "call-cost-settings-pbx-export-call-costs()", "call-flow-apps", "call-flow-scripts", "call-history-view", "chat-history-view", "chat-messages-history-view", "contacts", "contacts-pbx-get-dir-search-settings()", "countries", "custom-prompts", "defs", "defs-gateway-parameter-values", "defs-gateway-parameters", "defs-time-zones", "device-infos", "did-numbers", "email-template", "emergency-geo-locations", "event-logs", "fax", "firmwares", "fxs", "fxs-templates", "get-client-crm-updates", "get-prompt-set-updates", "get-server-crm-updates", "get-updates", "groups", "holidays", "inbound-rules", "last-cdr-and-chat-message-timestamp", "microsoft365-integration", "microsoft365-teams-integration", "microsoft365-teams-integration-pbx-get-map-users-script()", "my-group", "my-group-members", "my-tokens", "my-user", "my-user-forwarding-profiles", "my-user-greetings", "network-interfaces", "office-hours", "outbound-rules", "parameters", "parkings", "peers", "phone-logos", "phone-templates", "playlists", "prompt-sets", "prompt-sets-pbx-get-active()", "queues", "receptionists", "recordings", "ring-groups", "sbcs", "scheduled-reports", "security-tokens", "service-principals", "services", "sip-devices", "tenant-properties", "trunk-templates", "trunks", "users", "website-links"}
			totalSynced := 0
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  3cx-xapi-pp-cli workflow status

  # Show status as JSON
  3cx-xapi-pp-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("3cx-xapi-pp-cli")
			}
