...
func newContactUpdateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  respondio-pp-cli contact update id:42 --lastName Smith",
		Annotations: map[string]string{"pp:endpoint": "contact.update", "pp:method": "PUT", "pp:path": "/contact/{identifier}", "pp:happy-args": "identifier=id:42"},
