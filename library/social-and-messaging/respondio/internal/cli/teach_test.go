...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"respondio-pp-cli auth login",
		"respondio-pp-cli doctor",
		"respondio-pp-cli help items",
		"respondio-pp-cli sync",
		"respondio-pp-cli profile list",
		"respondio-pp-cli feedback list",
		"respondio-pp-cli which",
		"respondio-pp-cli agent-context",
		"respondio-pp-cli completion bash",
		"respondio-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"respondio-pp-cli recall",
		"respondio-pp-cli learnings",
		"respondio-pp-cli teach-pattern",
		"respondio-pp-cli teach-lookup",
		"respondio-pp-cli items list",
	}
