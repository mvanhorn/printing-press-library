...
func newContactCreateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:       "Create a new contact (identifier must be email: or phone:)",
		Example:     "  respondio-pp-cli contact create email:user@example.com --firstName John --lastName Doe",
		Annotations: map[string]string{"pp:endpoint": "contact.create", "pp:method": "POST", "pp:path": "/contact/{identifier}", "pp:happy-args": "identifier=email:user@example.com;--firstName=John"},
