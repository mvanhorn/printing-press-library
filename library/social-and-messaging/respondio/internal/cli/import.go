...
but do not stop the import.`,
  ...
  respondio-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  respondio-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | respondio-pp-cli import <resource> --input -`,
