...
func newContactUpsertCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "upsert <identifier>",
		Short:       "Create or update a contact keyed by email/phone identifier",
		Example:     "  respondio-pp-cli contact upsert email:user@example.com --firstName John",
		Annotations: map[string]string{"pp:endpoint": "contact.upsert", "pp:method": "POST", "pp:path": "/contact/create_or_update/{identifier}", "pp:happy-args": "identifier=email:user@example.com"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if stdinBody {
				...
				if cmd.Flags().Changed("country-code") || bodyCountryCode != "" {
					bodyMap["countryCode"] = bodyCountryCode
				}
			}
	...
	cmd.Flags().StringVar(&bodyFirstName, "first-name", "", "firstName")
	cmd.Flags().StringVar(&bodyLastName, "last-name", "", "lastName")
	...
	cmd.Flags().StringVar(&bodyCountryCode, "country-code", "", "countryCode")
