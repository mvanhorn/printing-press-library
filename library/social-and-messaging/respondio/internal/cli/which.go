...
var whichIndex = []whichEntry{
	{Command: "overview", Description: "One-command summary of open conversations, unassigned contacts, per-agent distribution, and recent activity.", Group: "Local state that compounds", WhyItMatters: "Use instead of a dozen API calls when you need the current inbox load at a glance."},
	{Command: "report channel-mix", Description: "See which messaging channels (WhatsApp, Instagram, email...) your contacts actually use.", Group: "Segment & find", WhyItMatters: "Answer 'where do our customers talk to us' instantly from local data."},
	{Command: "report workload", Description: "Per-agent message and conversation handling volume from the synced workspace.", Group: "Local state that compounds", WhyItMatters: "Balance the team and spot overloaded agents without manual tallying."},
	{Command: "contact by-tag", Description: "List every contact that carries a given tag (VIP, unpaid, in-trial).", Group: "Segment & find", WhyItMatters: "Pull a whole segment for campaigns or support outreach in one command."},
	{Command: "contact field-gaps", Description: "Find contacts missing a custom field value (e.g. no orderId or region).", Group: "Segment & find", WhyItMatters: "Spot data quality gaps to drive clean-up or re-enrichment."},
	{Command: "contact idle", Description: "Find unassigned contacts with no recent activity worth working.", Group: "Segment & find", WhyItMatters: "Route idle work before it goes cold."},
	{Command: "contact search", Description: "Free-text search across synced contacts without hitting the API.", Group: "Agent-native plumbing", WhyItMatters: "Find a customer by name/email offline, fast, without api.respond.io."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  respondio-pp-cli which "stale tickets"
  respondio-pp-cli which "bottleneck"
  respondio-pp-cli which --limit 1 "send message"
  respondio-pp-cli which                                # list the full capability index`,
