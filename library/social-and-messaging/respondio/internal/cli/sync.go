...
Resource scoping:
  ...
  respondio-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  respondio-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  respondio-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  respondio-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  respondio-pp-cli sync --latest-only`,
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{ // #nosec G101 -- endpoint paths, not credentials.
		...
		"message":             "/contact/{identifier}/message/list",
		"space":               "/space/user",
		"space-channel":       "/space/channel",
		"space-closing-notes": "/space/closing_notes",
		"space-custom-field":  "/space/custom_field",
	}
