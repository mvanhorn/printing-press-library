...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "zulip-pp-cli",
		Short: "Manage zulip resources via the zulip API",
		Long: `Manage zulip resources via the zulip API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'zulip-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("zulip-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'zulip-pp-cli profile list')")
	...
	rootCmd.AddCommand(newBotStorageCmd(flags))
	rootCmd.AddCommand(newBotsCmd(flags))
	rootCmd.AddCommand(newCallsCmd(flags))
	rootCmd.AddCommand(newChannelFoldersCmd(flags))
	rootCmd.AddCommand(newDefaultStreamsCmd(flags))
	...
	rootCmd.AddCommand(newMobilePushCmd(flags))
	rootCmd.AddCommand(newNavigationViewsCmd(flags))
	rootCmd.AddCommand(newRealmCmd(flags))
	rootCmd.AddCommand(newRemindersCmd(flags))
	rootCmd.AddCommand(newSavedSnippetsCmd(flags))
	rootCmd.AddCommand(newScheduledMessagesCmd(flags))
	rootCmd.AddCommand(newStreamsCmd(flags))
	rootCmd.AddCommand(newUserGroupsCmd(flags))
	rootCmd.AddCommand(newUserUploadsCmd(flags))
	rootCmd.AddCommand(newUsersCmd(flags))
	rootCmd.AddCommand(newZulipExportCmd(flags))
	...
	rootCmd.AddCommand(newDevFetchApiKeyPromotedCmd(flags))
	rootCmd.AddCommand(newDevListUsersPromotedCmd(flags))
	rootCmd.AddCommand(newFetchApiKeyPromotedCmd(flags))
	rootCmd.AddCommand(newGetStreamIdPromotedCmd(flags))
	rootCmd.AddCommand(newJwtPromotedCmd(flags))
	rootCmd.AddCommand(newMarkAllAsReadPromotedCmd(flags))
	rootCmd.AddCommand(newMarkStreamAsReadPromotedCmd(flags))
	rootCmd.AddCommand(newMarkTopicAsReadPromotedCmd(flags))
	rootCmd.AddCommand(newRealTimePromotedCmd(flags))
	rootCmd.AddCommand(newRegisterPromotedCmd(flags))
	rootCmd.AddCommand(newRegisterClientDevicePromotedCmd(flags))
	rootCmd.AddCommand(newRemotesPromotedCmd(flags))
	rootCmd.AddCommand(newRemoveClientDevicePromotedCmd(flags))
	rootCmd.AddCommand(newRestErrorHandlingPromotedCmd(flags))
	rootCmd.AddCommand(newServerSettingsPromotedCmd(flags))
	rootCmd.AddCommand(newSettingsPromotedCmd(flags))
	rootCmd.AddCommand(newThumbnailPromotedCmd(flags))
	rootCmd.AddCommand(newTypingPromotedCmd(flags))
	rootCmd.AddCommand(newUserTopicsPromotedCmd(flags))
	rootCmd.AddCommand(newZulipOutgoingWebhookPromotedCmd(flags))
