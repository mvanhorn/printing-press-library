...
large datasets as it has no memory pressure.`,
  ...
  zulip-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  zulip-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  zulip-pp-cli export <resource> --format jsonl | jq '.id'`,
