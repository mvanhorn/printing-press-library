...
but do not stop the import.`,
  ...
  naver-blog-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  naver-blog-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | naver-blog-pp-cli import <resource> --input -`,
