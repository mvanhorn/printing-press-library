...
// newDefaultProbeClient builds the *http.Client used when ProbeReachable
// is invoked with a nil client. A package-level var so tests can swap
// it (e.g., for a mocked transport) without plumbing client construction
// through callers that don't otherwise care.
var newDefaultProbeClient = func() *http.Client {
