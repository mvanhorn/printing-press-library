		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if cfg != nil && cfg.BaseURL != "" {
				...
				if clientErr != nil {
					...
					healthPath := "/api/v1/users/web_profile_info/?username=instagram"
...
func browserSessionProofStatus(cfg *config.Config, authHeader string) (bool, string) {
	...
	if proof.APIName != "instagram" {
		return false, "proof belongs to a different CLI"
	}
	if proof.CookieDomain != ".instagram.com" {
		return false, "proof belongs to a different cookie domain"
	}
	if proof.ValidationPath != "/api/v1/accounts/current_user/" {
