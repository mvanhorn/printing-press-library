...
Run 'linq-pp-cli doctor' to verify auth and connectivity.`,
	...
	rootCmd.AddCommand(newInviteLinkCmd(flags))
	rootCmd.AddCommand(newWelcomeFlowCmd(flags))
	rootCmd.AddCommand(newGuardedSendCmd(flags))
	rootCmd.AddCommand(newSendPreflightCmd(flags))
	rootCmd.AddCommand(newSafeReplyDraftCmd(flags))
