...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("ROBLOX_STATE_DIR", "")
	t.Setenv("ROBLOX_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"roblox-pp-cli auth login",
		"roblox-pp-cli doctor",
		"roblox-pp-cli help items",
		"roblox-pp-cli sync",
		"roblox-pp-cli profile list",
		"roblox-pp-cli feedback list",
		"roblox-pp-cli which",
		"roblox-pp-cli agent-context",
		"roblox-pp-cli completion bash",
		"roblox-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"roblox-pp-cli teach",
		"roblox-pp-cli recall",
		"roblox-pp-cli learnings",
		"roblox-pp-cli teach-pattern",
		"roblox-pp-cli teach-lookup",
		"roblox-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("roblox-pp-cli")); err == nil {
