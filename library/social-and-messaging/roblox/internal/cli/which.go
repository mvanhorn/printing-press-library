...
var whichIndex = []whichEntry{
	{Command: "investigate user", Description: "Assemble a public Roblox user's identity, avatar, groups, badges, inventory visibility, and thumbnails in one result.", Group: "Cross-resource investigations", WhyItMatters: "Use this when an agent needs broad public context for one Roblox identity rather than a single record."},
	{Command: "investigate group", Description: "Resolve a Roblox group, its owner, roles, and other public context in one command.", Group: "Cross-resource investigations", WhyItMatters: "Use this for repeatable public ownership and affiliation checks on a Roblox group."},
	{Command: "catalog creator-footprint", Description: "Summarize a Roblox creator's public games, bundles, and catalog-facing identity in one result.", Group: "Cross-resource investigations", WhyItMatters: "Use this for creator or competitor research that spans more than one catalog endpoint."},
	{Command: "ecosystem game", Description: "Build a game-centered view of public universe details, creator context, media, and related badges.", Group: "Cross-resource investigations", WhyItMatters: "Use this for game or competitor research that spans more than a single universe response."},
	{Command: "network overlap", Description: "Find shared public groups and relationship records between two locally synced Roblox users.", Group: "Local relationship analysis", WhyItMatters: "Use this when comparing two Roblox identities and their observable public affiliations."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  roblox-pp-cli which "stale tickets"
  roblox-pp-cli which "bottleneck"
  roblox-pp-cli which --limit 1 "send message"
  roblox-pp-cli which                                # list the full capability index`,
