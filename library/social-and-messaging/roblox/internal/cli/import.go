...
but do not stop the import.`,
  ...
  roblox-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  roblox-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | roblox-pp-cli import <resource> --input -`,
