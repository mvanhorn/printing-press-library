...
func newUsersGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get <userId>",
		Short:       "Gets detailed user information by id.",
		Example:     "  roblox-pp-cli users get 1 --agent",
		Annotations: map[string]string{"pp:endpoint": "users.get", "pp:method": "GET", "pp:path": "/v1/users/{userId}", "mcp:read-only": "true"},
