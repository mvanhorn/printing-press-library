...
type rootFlags struct {
	...
	// invocation. Mirrors the ROBLOX_NO_LEARN env var.
	noLearn bool
...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "roblox-pp-cli",
		Short: `Roblox CLI — Investigate Roblox's fragmented public web data from one agent-friendly CLI.`,
		Long: `Roblox CLI — Investigate Roblox's fragmented public web data from one agent-friendly CLI.
...
Health check: run 'roblox-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("roblox-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'roblox-pp-cli profile list')")
	...
	rootCmd.AddCommand(newAvatar2Cmd(flags))
	rootCmd.AddCommand(newAvatarOutfitsCmd(flags))
	rootCmd.AddCommand(newAvatarUsersCmd(flags))
	rootCmd.AddCommand(newBadges2Cmd(flags))
	rootCmd.AddCommand(newBadgesUsersCmd(flags))
	rootCmd.AddCommand(newBirthdateCmd(flags))
	rootCmd.AddCommand(newCatalogAssetsCmd(flags))
	rootCmd.AddCommand(newCatalogUsersCmd(flags))
	rootCmd.AddCommand(newCollectibleItemsCmd(flags))
	rootCmd.AddCommand(newCollectionsCmd(flags))
	rootCmd.AddCommand(newDescriptionCmd(flags))
	rootCmd.AddCommand(newFavoritesCmd(flags))
	rootCmd.AddCommand(newFeaturedContentCmd(flags))
	rootCmd.AddCommand(newFriendsUsersCmd(flags))
	rootCmd.AddCommand(newGamesCmd(flags))
	rootCmd.AddCommand(newGames2Cmd(flags))
	rootCmd.AddCommand(newGamesUsersCmd(flags))
	rootCmd.AddCommand(newGenderCmd(flags))
	rootCmd.AddCommand(newGroups2Cmd(flags))
	rootCmd.AddCommand(newGroupsUserCmd(flags))
	rootCmd.AddCommand(newGroupsUsersCmd(flags))
	rootCmd.AddCommand(newInventoryAssetsCmd(flags))
	rootCmd.AddCommand(newInventoryUsersCmd(flags))
	rootCmd.AddCommand(newInventoryUsers2Cmd(flags))
	rootCmd.AddCommand(newMyCmd(flags))
	rootCmd.AddCommand(newOutfitsCmd(flags))
	rootCmd.AddCommand(newPackagesCmd(flags))
	rootCmd.AddCommand(newThumbnailsGamesCmd(flags))
	rootCmd.AddCommand(newThumbnailsUsersCmd(flags))
	rootCmd.AddCommand(newUniversesCmd(flags))
	...
	rootCmd.AddCommand(newNovelEcosystemCmd(flags))
	rootCmd.AddCommand(newNovelInvestigateCmd(flags))
	rootCmd.AddCommand(newNovelNetworkCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newAssetThumbnailAnimatedPromotedCmd(flags))
	rootCmd.AddCommand(newAssetToCategoryPromotedCmd(flags))
	rootCmd.AddCommand(newAssetToSubcategoryPromotedCmd(flags))
	rootCmd.AddCommand(newAssetsPromotedCmd(flags))
	rootCmd.AddCommand(newAssetsThumbnail3dPromotedCmd(flags))
	rootCmd.AddCommand(newAvatarRulesPromotedCmd(flags))
	rootCmd.AddCommand(newBadgesPromotedCmd(flags))
	rootCmd.AddCommand(newBadgesUserPromotedCmd(flags))
	rootCmd.AddCommand(newBatchPromotedCmd(flags))
	rootCmd.AddCommand(newBundlesPromotedCmd(flags))
	rootCmd.AddCommand(newCatalogPromotedCmd(flags))
	rootCmd.AddCommand(newCatalogBundlesPromotedCmd(flags))
	rootCmd.AddCommand(newCatalogSearchPromotedCmd(flags))
	rootCmd.AddCommand(newCategoriesPromotedCmd(flags))
	rootCmd.AddCommand(newDeveloperProductsPromotedCmd(flags))
	rootCmd.AddCommand(newDisplayNamesPromotedCmd(flags))
	rootCmd.AddCommand(newEconomyUserPromotedCmd(flags))
	rootCmd.AddCommand(newGamePassesPromotedCmd(flags))
	rootCmd.AddCommand(newGameStartInfoPromotedCmd(flags))
	...
	rootCmd.AddCommand(newPresencePromotedCmd(flags))
	rootCmd.AddCommand(newRolesPromotedCmd(flags))
	rootCmd.AddCommand(newSubcategoriesPromotedCmd(flags))
	rootCmd.AddCommand(newTopicPromotedCmd(flags))
	rootCmd.AddCommand(newUsernamesPromotedCmd(flags))
