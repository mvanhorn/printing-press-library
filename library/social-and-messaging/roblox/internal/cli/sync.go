...
Resource scoping:
  ...
  roblox-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  roblox-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  roblox-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  roblox-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  roblox-pp-cli sync --latest-only`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if dbPath == "" {
				dbPath = defaultDBPath("roblox-pp-cli")
			}
...
func determinePaginationDefaults(resource string) paginationDefaults {
	switch resource {
	case "assets/catalog_assets_bundles":
	...
	case "assets/inventory_assets_owners":
		return paginationDefaults{
			cursorParam: "cursor",
			cursorType:  "cursor",
			limitParam:  "limit",
	...
	case "groups-2/blocked_keywords":
		return paginationDefaults{
			cursorParam: "cursor",
			cursorType:  "cursor",
			limitParam:  "limit",
	...
	case "my-trusted-friends-requests":
		return paginationDefaults{
			cursorParam: "cursor",
			cursorType:  "cursor",
			limitParam:  "limit",
	...
	case "user/avatar_users_outfits":
		return paginationDefaults{
			cursorParam: "page",
			cursorType:  "page",
			limitParam:  "limit",
	...
	case "user/catalog_users_bundles":
		return paginationDefaults{
			cursorParam: "cursor",
			cursorType:  "cursor",
			limitParam:  "limit",
	...
	case "user/inventory_users_assets":
		return paginationDefaults{
			cursorParam: "cursor",
			cursorType:  "cursor",
			limitParam:  "limit",
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	switch resource {
	case "avatar-2":
		return db.UpsertAvatar2(data)
	case "avatar_users_avatar":
		return db.UpsertAvatarUsersAvatar(data)
	case "currently_wearing":
		return db.UpsertCurrentlyWearing(data)
	case "avatar_users_outfits":
		return db.UpsertAvatarUsersOutfits(data)
	case "icon":
		return db.UpsertIcon(data)
	case "badges_users_badges":
		return db.UpsertBadgesUsersBadges(data)
	case "catalog_assets_bundles":
		return db.UpsertCatalogAssetsBundles(data)
	case "catalog_bundles_details":
		return db.UpsertCatalogBundlesDetails(data)
	case "recommendations":
		return db.UpsertRecommendations(data)
	case "catalog_users_bundles":
		return db.UpsertCatalogUsersBundles(data)
	case "collectible_items_owners":
		return db.UpsertCollectibleItemsOwners(data)
	case "follow":
		return db.UpsertFollow(data)
	case "followers":
		return db.UpsertFollowers(data)
	case "followings":
		return db.UpsertFollowings(data)
	case "friends_users_friends":
		return db.UpsertFriendsUsersFriends(data)
	case "trusted_friends":
		return db.UpsertTrustedFriends(data)
	case "unfollow":
		return db.UpsertUnfollow(data)
	case "games_favorites":
		return db.UpsertGamesFavorites(data)
	case "games_media":
		return db.UpsertGamesMedia(data)
	case "servers":
		return db.UpsertServers(data)
	case "games_2_media":
		return db.UpsertGames2Media(data)
	case "favorite":
		return db.UpsertFavorite(data)
	case "games_users_games":
		return db.UpsertGamesUsersGames(data)
	case "audit_log":
		return db.UpsertAuditLog(data)
	case "bans":
		return db.UpsertBans(data)
	case "blocked_keywords":
		return db.UpsertBlockedKeywords(data)
	case "change_owner":
		return db.UpsertChangeOwner(data)
	case "claim_ownership":
		return db.UpsertClaimOwnership(data)
	case "community_feature_freezes":
		return db.UpsertCommunityFeatureFreezes(data)
	case "configuration":
		return db.UpsertConfiguration(data)
	case "groups_2_description":
		return db.UpsertGroups2Description(data)
	case "emotes":
		return db.UpsertEmotes(data)
	case "features":
		return db.UpsertFeatures(data)
	case "join_requests":
		return db.UpsertJoinRequests(data)
	case "membership":
		return db.UpsertMembership(data)
	case "name":
		return db.UpsertName(data)
	case "name_history":
		return db.UpsertNameHistory(data)
	case "notification_preference":
		return db.UpsertNotificationPreference(data)
	case "payout_restriction":
		return db.UpsertPayoutRestriction(data)
	case "payouts":
		return db.UpsertPayouts(data)
	case "relationships":
		return db.UpsertRelationships(data)
	case "groups_2_roles":
		return db.UpsertGroups2Roles(data)
	case "rolesets":
		return db.UpsertRolesets(data)
	case "settings":
		return db.UpsertSettings(data)
	case "social_links":
		return db.UpsertSocialLinks(data)
	case "status":
		return db.UpsertStatus(data)
	case "groups_2_users":
		return db.UpsertGroups2Users(data)
	case "groups_users_friends":
		return db.UpsertGroupsUsersFriends(data)
	case "groups_users_groups":
		return db.UpsertGroupsUsersGroups(data)
	case "inventory_assets_owners":
		return db.UpsertInventoryAssetsOwners(data)
	case "inventory_users_assets":
		return db.UpsertInventoryUsersAssets(data)
	case "can_view_inventory":
		return db.UpsertCanViewInventory(data)
	case "inventory_users_categories":
		return db.UpsertInventoryUsersCategories(data)
	case "items":
		return db.UpsertItems(data)
	case "inventory_users_places":
		return db.UpsertInventoryUsersPlaces(data)
	case "inventory_users_2_inventory":
		return db.UpsertInventoryUsers2Inventory(data)
	case "delete":
		return db.UpsertDelete(data)
	case "outfits_details":
		return db.UpsertOutfitsDetails(data)
	case "packages_assets":
		return db.UpsertPackagesAssets(data)
	case "presence":
		return db.UpsertPresence(data)
	case "thumbnails":
		return db.UpsertThumbnails(data)
	case "universes_badges":
		return db.UpsertUniversesBadges(data)
	case "free_badges_quota":
		return db.UpsertFreeBadgesQuota(data)
	case "multiget_are_friends":
		return db.UpsertMultigetAreFriends(data)
	case "users_display_names":
		return db.UpsertUsersDisplayNames(data)
	case "username_history":
		return db.UpsertUsernameHistory(data)
	default:
...
func defaultSyncResources() []string {
	return []string{
		...
		"my",
		"my-friends-requests",
		"my-new-friend-requests-count",
		"my-trusted-friends-count",
		"my-trusted-friends-requests",
		"subcategories",
		"user",
		"user-trusted-friend-requests-count",
		"users",
		"users-authenticated-age-bracket",
		"users-authenticated-country-code",
		"users-authenticated-roles",
	}
}
...
func knownSyncResourceNames() []string {
	names := []string{
		...
		"game-start-info",
		"games",
		"games-games-product-info",
		"games-multiget-place-details",
		"games-multiget-playability-status",
		"gender",
		"groups",
		"groups-2",
		"groups-2-metadata",
		...
		"subcategories",
		"thumbnails-games",
		"thumbnails-games-thumbnails",
		"thumbnails-users",
		"thumbnails-users-avatar-3d",
		"thumbnails-users-avatar-bust",
		"thumbnails-users-avatar-headshot",
		"thumbnails-users-outfit-3d",
		"thumbnails-users-outfits",
		"user",
		"user-trusted-friend-requests-count",
		"users",
		"users-authenticated-age-bracket",
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{ // #nosec G101 -- endpoint paths, not credentials.
		...
		"avatar-metadata":                    "/v1/avatar/metadata",
		...
		"followers":                          "/v1/users/{targetUserId}/followers",
		"followings":                         "/v1/users/{targetUserId}/followings",
		"game-passes":                        "/v1/game-passes",
		"game-start-info":                    "/v1/game-start-info",
		"games":                              "/v1/games",
		"games-games-product-info":           "/v1/games/games-product-info",
		"games-multiget-place-details":       "/v1/games/multiget-place-details",
		"games-multiget-playability-status":  "/v1/games/multiget-playability-status",
		"gender":                             "/v1/gender",
		"groups":                             "/v1/groups/icons",
		"groups-2":                           "/v1/groups/metadata",
		"groups-2-metadata":                  "/v1/groups/search/metadata",
		"groups-user":                        "/v1/user/groups/pending",
		"metadata":                           "/v1/metadata",
		"my":                                 "/v1/my/friends/count",
		"my-friends-requests":                "/v1/my/friends/requests",
		"my-new-friend-requests-count":       "/v1/my/new-friend-requests/count",
		"my-trusted-friends-count":           "/v1/my/trusted-friends/count",
		"my-trusted-friends-requests":        "/v1/my/trusted-friends/requests",
		"owners":                             "/v2/collectible-items/{collectibleItemId}/owners",
		"places":                             "/v1/places/gameicons",
		"roles":                              "/v1/roles",
		"subcategories":                      "/v1/subcategories",
		"thumbnails-games":                   "/v1/games/icons",
		"thumbnails-games-thumbnails":        "/v1/games/multiget/thumbnails",
		"thumbnails-users":                   "/v1/users/avatar",
		"thumbnails-users-avatar-3d":         "/v1/users/avatar-3d",
		"thumbnails-users-avatar-bust":       "/v1/users/avatar-bust",
		"thumbnails-users-avatar-headshot":   "/v1/users/avatar-headshot",
		"thumbnails-users-outfit-3d":         "/v1/users/outfit-3d",
		"thumbnails-users-outfits":           "/v1/users/outfits",
		"user":                               "/v1/user/friend-requests/count",
		"user-trusted-friend-requests-count": "/v1/user/trusted-friend-requests/count",
		"users":                              "/v1/users/authenticated",
		"users-authenticated-age-bracket":    "/v1/users/authenticated/age-bracket",
		"users-authenticated-country-code":   "/v1/users/authenticated/country-code",
		"users-authenticated-roles":          "/v1/users/authenticated/roles",
	}
...
var itemHydrationPaths = map[string]itemHydrationConfig{
	"groups-2-metadata":         {path: "/v1/groups/{groupId}", idParam: "groupId"},
	"users-authenticated-roles": {path: "/v1/users/{userId}", idParam: "userId"},
}
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "audit_log", ParentTable: "groups-2", ParentIDParam: "groupId", PathTemplate: "/v1/groups/{groupId}/audit-log", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "groupId", Field: "groups_id"},
		}},
		{Name: "avatar_2", ParentTable: "user", ParentIDParam: "userId", PathTemplate: "/v2/avatar/users/{userId}/outfits", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.user", PathParams: []dependentPathParamDef{
			{Param: "userId", Field: "users_id"},
		}},
		{Name: "avatar_users_outfits", ParentTable: "user", ParentIDParam: "userId", PathTemplate: "/v1/users/{userId}/outfits", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.user", PathParams: []dependentPathParamDef{
			{Param: "userId", Field: "users_id"},
		}},
		{Name: "badges_users_badges", ParentTable: "user", ParentIDParam: "userId", PathTemplate: "/v1/users/{userId}/badges", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.user", PathParams: []dependentPathParamDef{
			{Param: "userId", Field: "users_id"},
		}},
		{Name: "bans", ParentTable: "groups-2", ParentIDParam: "groupId", PathTemplate: "/v1/groups/{groupId}/bans", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "groupId", Field: "groups_id"},
		}},
		{Name: "blocked_keywords", ParentTable: "groups-2", ParentIDParam: "groupId", PathTemplate: "/v1/groups/{groupId}/blocked-keywords", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.groups-2", PathParams: []dependentPathParamDef{
			{Param: "groupId", Field: "groups_id"},
		}},
		{Name: "catalog_assets_bundles", ParentTable: "assets", ParentIDParam: "assetId", PathTemplate: "/v1/assets/{assetId}/bundles", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.asset", PathParams: []dependentPathParamDef{
			{Param: "assetId", Field: "assets_id"},
		}},
		{Name: "catalog_users_bundles", ParentTable: "user", ParentIDParam: "userId", PathTemplate: "/v1/users/{userId}/bundles", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.user", PathParams: []dependentPathParamDef{
			{Param: "userId", Field: "users_id"},
		}},
		{Name: "favorite", ParentTable: "user", ParentIDParam: "userId", PathTemplate: "/v2/users/{userId}/favorite/games", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.user", PathParams: []dependentPathParamDef{
			{Param: "userId", Field: "users_id"},
		}},
		{Name: "games_users_games", ParentTable: "user", ParentIDParam: "userId", PathTemplate: "/v2/users/{userId}/games", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.user", PathParams: []dependentPathParamDef{
			{Param: "userId", Field: "users_id"},
		}},
		{Name: "groups_2_users", ParentTable: "groups-2", ParentIDParam: "groupId", PathTemplate: "/v1/groups/{groupId}/users", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "groupId", Field: "groups_id"},
		}},
		{Name: "inventory_assets_owners", ParentTable: "assets", ParentIDParam: "assetId", PathTemplate: "/v2/assets/{assetId}/owners", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.asset", PathParams: []dependentPathParamDef{
			{Param: "assetId", Field: "assets_id"},
		}},
		{Name: "inventory_users_assets", ParentTable: "user", ParentIDParam: "userId", PathTemplate: "/v1/users/{userId}/assets/collectibles", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.user", PathParams: []dependentPathParamDef{
			{Param: "userId", Field: "users_id"},
		}},
		{Name: "join_requests", ParentTable: "groups-2", ParentIDParam: "groupId", PathTemplate: "/v1/groups/{groupId}/join-requests", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "groupId", Field: "groups_id"},
		}},
		{Name: "name_history", ParentTable: "groups-2", ParentIDParam: "groupId", PathTemplate: "/v1/groups/{groupId}/name-history", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.groups-2", PathParams: []dependentPathParamDef{
			{Param: "groupId", Field: "groups_id"},
		}},
		{Name: "roles_users", ParentTable: "roles", ParentIDParam: "roleSetId", PathTemplate: "/v1/groups/{groupId}/roles/{roleSetId}/users", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "groupId", Field: "id"},
			{Param: "roleSetId", Field: "id"},
		}},
		{Name: "user_assets", ParentTable: "user", ParentIDParam: "assetTypeId", PathTemplate: "/v1/favorites/users/{userId}/favorites/{assetTypeId}/assets", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "userId", Field: "users_id"},
			{Param: "assetTypeId", Field: "id"},
		}},
		{Name: "user_bundles", ParentTable: "user", ParentIDParam: "subtypeId", PathTemplate: "/v1/favorites/users/{userId}/favorites/{subtypeId}/bundles", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "userId", Field: "users_id"},
			{Param: "subtypeId", Field: "id"},
		}},
		{Name: "username_history", ParentTable: "users", ParentIDParam: "userId", PathTemplate: "/v1/users/{userId}/username-history", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.user", PathParams: []dependentPathParamDef{
...
var reconcileTypedTables = map[string]string{
	"audit_log":                   "audit_log",
	"avatar-2":                    "avatar_2",
	"avatar_users_avatar":         "avatar_users_avatar",
	"avatar_users_outfits":        "avatar_users_outfits",
	"badges_users_badges":         "badges_users_badges",
	"bans":                        "bans",
	"blocked_keywords":            "blocked_keywords",
	"can_view_inventory":          "can_view_inventory",
	"catalog_assets_bundles":      "catalog_assets_bundles",
	"catalog_bundles_details":     "catalog_bundles_details",
	"catalog_users_bundles":       "catalog_users_bundles",
	"change_owner":                "change_owner",
	"claim_ownership":             "claim_ownership",
	"collectible_items_owners":    "collectible_items_owners",
	"community_feature_freezes":   "community_feature_freezes",
	...
	"free_badges_quota":           "free_badges_quota",
	"friends_users_friends":       "friends_users_friends",
	"games_2_media":               "games_2_media",
	"games_favorites":             "games_favorites",
	"games_media":                 "games_media",
	"games_users_games":           "games_users_games",
	"groups_2_description":        "groups_2_description",
	"groups_2_roles":              "groups_2_roles",
	"groups_2_users":              "groups_2_users",
	"groups_users_friends":        "groups_users_friends",
	"groups_users_groups":         "groups_users_groups",
	"icon":                        "icon",
	"inventory_assets_owners":     "inventory_assets_owners",
	"inventory_users_2_inventory": "inventory_users_2_inventory",
	"inventory_users_assets":      "inventory_users_assets",
	"inventory_users_categories":  "inventory_users_categories",
	"inventory_users_places":      "inventory_users_places",
	"items":                       "items",
	"join_requests":               "join_requests",
	"membership":                  "membership",
	"multiget_are_friends":        "multiget_are_friends",
	"name":                        "name",
	"name_history":                "name_history",
	"notification_preference":     "notification_preference",
	"outfits_details":             "outfits_details",
	"packages_assets":             "packages_assets",
	...
	"unfollow":                    "unfollow",
	"universes_badges":            "universes_badges",
...
func responsePathForResource(resource, path string) []string {
	...
	case "avatar-2\x00/v2/avatar/users/{userId}/outfits":
		return []string{"data"}
	case "catalog\x00/v1/catalog/items/details":
		return []string{"data"}
	case "catalog-search\x00/v2/search/items/details":
		return []string{"data"}
	case "favorites\x00/v1/favorites/users/{userId}/favorites/{assetTypeId}/assets":
		return []string{"data"}
	case "favorites\x00/v1/favorites/users/{userId}/favorites/{subtypeId}/bundles":
		return []string{"favorites"}
	case "game-start-info\x00/v1/game-start-info":
		return []string{"universeAvatarAssetOverrides"}
	case "games\x00/v1/games/recommendations/game/{universeId}":
		return []string{"games"}
	case "games\x00/v1/games":
		return []string{"data"}
	case "games\x00/v1/games/games-product-info":
		return []string{"data"}
	case "groups-2\x00/v1/groups/policies":
		return []string{"groups"}
	case "groups-2\x00/v1/groups/search":
		return []string{"data"}
	case "groups-2\x00/v1/groups/search/lookup":
		return []string{"data"}
	case "groups-2\x00/v1/groups/search/metadata":
		return []string{"SuggestedGroupKeywords"}
	case "groups-user\x00/v1/user/groups/pending":
		return []string{"data"}
	case "my\x00/v1/my/friends/requests":
		return []string{"data"}
	case "my\x00/v1/my/trusted-friends/requests":
		return []string{"data"}
	case "presence\x00/v1/presence/users":
		return []string{"userPresences"}
	case "roles\x00/v1/roles":
		return []string{"data"}
	case "topic\x00/v1/topic/get-topics":
		return []string{"topics"}
	case "user\x00/v1/user/following-exists":
		return []string{"followings"}
	case "usernames\x00/v1/usernames/users":
		return []string{"data"}
	case "users\x00/v1/users":
		return []string{"data"}
	case "users\x00/v1/users/authenticated/roles":
		return []string{"roles"}
	case "users\x00/v1/users/search":
		return []string{"data"}
	}
	return nil
}
