...
func newUsersMeCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: "  product-hunt-pp-cli users me",
		Annotations: map[string]string{"pp:endpoint": "users.me", "pp:method": "GET", "pp:path": "/graphql/viewer", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			user, err := phc.GetViewer(cmd.Context())
			if err != nil {
