...
but do not stop the import.`,
  ...
  product-hunt-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  product-hunt-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | product-hunt-pp-cli import <resource> --input -`,
