...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "product-hunt-pp-cli",
		Short: `Product Hunt CLI — Every Product Hunt feature, plus launch-day momentum tracking, offline search, and a local database no other Product Hu…`,
		Long: `Product Hunt CLI — Every Product Hunt feature, plus launch-day momentum tracking, offline search, and a local database no other Product Hu…
...
Health check: run 'product-hunt-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("product-hunt-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'product-hunt-pp-cli profile list')")
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("product-hunt-pp-cli %s\n", version)
		},
	}
}
