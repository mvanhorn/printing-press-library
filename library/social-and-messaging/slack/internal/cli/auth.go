...
func newAuthCmd(flags *rootFlags) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "auth",
		Short: "Manage authentication for Slack Web",
	}
...
func newAuthSetupCmd(_ *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			w := cmd.OutOrStdout()
			fmt.Fprintln(w, "See API docs: https://api.slack.com/support")
			fmt.Fprintln(w, "")
			fmt.Fprintln(w, "Then set:")
			fmt.Fprintln(w, "  export SLACK_USER_TOKEN=\"<your-token>\"")
			fmt.Fprintln(w, "  export SLACK_BOT_TOKEN=\"<your-token>\"")
			fmt.Fprintln(w, "  slack-pp-cli auth set-token <token>")
			if !launch {
				return nil
			}
			launchURL := "https://api.slack.com/support"
