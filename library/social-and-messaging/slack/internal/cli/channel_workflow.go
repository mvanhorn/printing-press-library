...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  slack-pp-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"admin-conversations-search", "admin-invite-requests-approved-list", "admin-invite-requests-denied-list", "admin-invite-requests-list", "admin-teams-list", "apps-uninstall", "chat-scheduled-messages-list", "conversations-history", "conversations-list", "conversations-members", "conversations-replies", "files-info", "files-list", "files-remote-list", "reminders-list", "stars-list", "users-conversations", "users-identity", "users-list"}
			totalSynced := 0
