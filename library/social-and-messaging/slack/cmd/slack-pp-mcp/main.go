...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/social-and-messaging/slack/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "slack-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
