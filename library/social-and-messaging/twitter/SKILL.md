...
metadata: '{"openclaw":{"requires":{"bins":["twitter-pp-cli"]},"install":[{"id":"go","kind":"shell","command":"go install github.com/mvanhorn/printing-press-library/library/other/twitter-pp-cli/cmd/twitter-pp-cli@latest","bins":["twitter-pp-cli"],"label":"Install via go install"}]}}'
---
...
2. Install:
   ```bash
   go install github.com/mvanhorn/printing-press-library/library/other/twitter-pp-cli/cmd/twitter-pp-cli@latest
   ```
...
1. Install the MCP server:
   ```bash
   go install github.com/mvanhorn/printing-press-library/library/other/twitter-pp-cli/cmd/twitter-pp-mcp@latest
   ```
