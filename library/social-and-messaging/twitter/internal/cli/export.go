...
large datasets as it has no memory pressure.`,
  ...
  twitter-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  twitter-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  twitter-pp-cli export <resource> --format jsonl | jq '.id'`,
