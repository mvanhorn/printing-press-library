...
but do not stop the import.`,
  ...
  twitter-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  twitter-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | twitter-pp-cli import <resource> --input -`,
