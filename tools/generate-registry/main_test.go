...
// TestRegistryEntry_PrintingPressVersionRoundTrip pins the JSON contract:
// a set value round-trips, an empty value is omitted, and old registry entries
// without the field still unmarshal cleanly.
