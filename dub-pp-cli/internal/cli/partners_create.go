...
func newPartnersCreateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&bodyGroupId, "groupid", "", "The group ID to add the partner to. If not provided, the partner will be added to the default group.")
	...
	cmd.Flags().StringVar(&bodyTenantId, "tenantid", "", "The partner's unique ID in your system. Useful for retrieving the partner's links and stats later on. If not...")
