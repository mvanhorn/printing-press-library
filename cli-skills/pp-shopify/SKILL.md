...
2. Install:
   ...
   GOPRIVATE='github.com/mvanhorn/*' GOFLAGS=-mod=mod \
     go install github.com/mvanhorn/printing-press-library/library/commerce/shopify/cmd/shopify-pp-cli@main
   ```
3. Verify: `shopify-pp-cli --version`
...
1. Install the MCP server:
   ...
   # If `@latest` installs a stale build (Go module proxy cache lag), install from main:
   GOPRIVATE='github.com/mvanhorn/*' GOFLAGS=-mod=mod \
     go install github.com/mvanhorn/printing-press-library/library/commerce/shopify/cmd/shopify-pp-mcp@main
   ```
