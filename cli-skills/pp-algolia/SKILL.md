---
name: pp-algolia
description: "Every Algolia feature, plus offline search and a local database no other Algolia tool has. Trigger phrases: `search my Algolia index`, `list my Algolia indices`, `check Algolia API keys`, `find stale Algolia rules`, `compare Algolia index settings`."
...
metadata:
  openclaw:
    ...
    install:
      - kind: go
        bins: [algolia-pp-cli]
        module: github.com/mvanhorn/printing-press-library/library/developer-tools/algolia/cmd/algolia-pp-cli
---
<!-- GENERATED FILE — DO NOT EDIT.
     This file is a verbatim mirror of library/developer-tools/algolia/SKILL.md,
...
1. Check if installed: `which algolia-pp-cli`
